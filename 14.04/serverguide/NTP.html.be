...
<a class="nextlinks-prev" href="dhcp.html" title="Dynamic Host Configuration Protocol (DHCP)">Назад</a><a class="nextlinks-next" href="dm-multipath-chapter.html" title="DM-Multipath">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="NTP.html#timeservers" title="Настаўленьні">Настаўленьні</a></li>
