...
<a class="nextlinks-prev" href="dhcp.html" title="Πρωτόκολλο Δυναμικής Διαμόρφωσης Κεντρικού Υπολογιστή (Dynamic Host Configuration Protocol (DHCP))">Προηγούμενο</a><a class="nextlinks-next" href="dm-multipath-chapter.html" title="DM-Multipath">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="NTP.html#timeservers" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
