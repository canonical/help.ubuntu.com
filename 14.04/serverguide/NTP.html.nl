...
<a class="nextlinks-prev" href="dhcp.html" title="Dynamic Host Configuration Protocol (DHCP)">Vorige</a><a class="nextlinks-next" href="dm-multipath-chapter.html" title="DM-Multipath">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="NTP.html#timeservers" title="Configuratie">Configuratie</a></li>
