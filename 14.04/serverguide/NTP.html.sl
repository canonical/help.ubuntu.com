...
<a class="nextlinks-prev" href="dhcp.html" title="Dynamic Host Configuration Protocol (DHCP)">Nazaj</a><a class="nextlinks-next" href="dm-multipath-chapter.html" title="DM-Multipath">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="NTP.html#timeservers" title="Nastavljanje">Nastavljanje</a></li>
