...
<li class="list itemizedlist">
              <p class="para">Дополнительные сведения о <span class="app application">fdisk</span> смотрите в <a href="http://manpages.ubuntu.com/manpages/trusty/en/man8/fdisk.8.html" class="ulink" title="http://manpages.ubuntu.com/manpages/trusty/en/man8/fdisk.8.html">man-странице fdisk</a>.</p>
            </li>
</ul></div></div></div>
</div></div>
</div>
