...
<a class="nextlinks-prev" href="dpkg.html" title="dpkg">Назад</a><a class="nextlinks-next" href="aptitude.html" title="Aptitude">Наперад</a>
</div>
...
<p class="para">
        Some examples of popular uses for the <span class="app application">apt-get</span> utility:
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get upgrade</span>
		...
		<p class="para">
		For information on upgrading to a new Ubuntu release see <a class="xref" href="installing-upgrading.html" title="Абнаўленьне">Абнаўленьне</a>.
		</p>
                </li>
</ul></div>
        </p>
<p class="para">
        Actions of the <span class="app application">apt-get</span> command, such as installation and removal of packages, are logged in the /var/log/dpkg.log log file.
        </p>
