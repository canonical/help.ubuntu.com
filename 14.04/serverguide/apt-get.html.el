...
<a class="nextlinks-prev" href="dpkg.html" title="dpkg">Προηγούμενο</a><a class="nextlinks-next" href="aptitude.html" title="Aptitude">Επόμενο</a>
</div>
...
<p class="para">Μερικά παραδείγματα δημοφιλών χρήσεων της λειτουργίας <span class="app application">apt-get</span>: <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
                <p class="para">
                <span class="em em-bold emphasis">Install a Package</span>: Installation of packages using the <span class="app application">apt-get</span> tool is quite simple.  For example, to install the network scanner <span class="app application">nmap</span>, type the following:
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install nmap</span>
</pre></div>
                </p>
                </li>
<li class="list itemizedlist">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get remove nmap</span>
                ...
                <p class="para"><span class="em em-bold emphasis">Πολλαπλά Πακέτα</span>: Μπορείτε να προσδιορίσετε πολλαπλά πακέτα να εγκατασταθούν ή να αφαιρεθούν, χωρισμένα με κενά.</p>
                </div></div></div></div>
		<p class="para">
	        Also, adding the <span class="em emphasis">--purge</span> option to <span class="cmd command">apt-get remove</span> will remove the package 
...
<li class="list itemizedlist">
                <p class="para"><span class="em em-bold emphasis">Αναβάθμιση Πακέτων</span>: Σε πάροδο χρόνου, αναβαθμισμένες εκδόσεις πακέτων που είναι εγκαταστημένα στον υπολογιστή σας μπορεί να γίνουν διαθέσιμες από το πακέτο αποθετηρίων (για παράδειγμα ενημερώσεις ασφαλείας). Για να αναβαθμίσετε το σύσστημά σας, πρώτα ενημερώστε το ευρετήριο πακέτου όπως περιγράφεται παραπάνω, και μετά πληκτρολογήστε: <div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get upgrade</span>
</pre></div></p>
		<p class="para">Για πληροφορίες με το πως να αναβαθμίσετε μία καινούρια έκδοση Ubuntu δείτε <a class="xref" href="installing-upgrading.html" title="Αναβάθμιση">Αναβάθμιση</a>.</p>
                </li>
</ul></div></p>
<p class="para">Ενέργειες της εντολής <span class="app application">apt-get</span>, όπως εγκατάσταση και αφαίρεση πακέτων, καταγράφονται στο /var/log/dpkg.log αρχείο ιστορικού.</p>
