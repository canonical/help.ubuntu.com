...
<a class="nextlinks-prev" href="dpkg.html" title="dpkg">Previous</a><a class="nextlinks-next" href="aptitude.html" title="Aptitude">Next</a>
</div>
...
<p class="para">Неколку популарни примери за користење на алатката <span class="app application">apt-get</span>: <div class="list itemizedlist"><ul class="list itemizedlist">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get remove nmap</span>
                ...
                <p class="para"><span class="em em-bold emphasis">Multiple Packages</span>: You may specify multiple packages to be installed or removed, separated by spaces.  
                </p>
                </div></div></div></div>
		<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get upgrade</span>
</pre></div>
                </p>
		<p class="para">
		For information on upgrading to a new Ubuntu release see <a class="xref" href="installing-upgrading.html" title="Upgrading">Upgrading</a>.
		</p>
                </li>
</ul></div></p>
<p class="para">Акциите направени со <span class="app application">apt-get</span> командата, како што се инсталирање или бришење на пакети се запишуваат во датотеката со логови /var/log/dpkg.log.</p>
