...
<a class="nextlinks-prev" href="dpkg.html" title="dpkg">Nazaj</a><a class="nextlinks-next" href="aptitude.html" title="Aptitude">Naprej</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get upgrade</span>
		...
		<p class="para">
		For information on upgrading to a new Ubuntu release see <a class="xref" href="installing-upgrading.html" title="Nadgrajevanje">Nadgrajevanje</a>.
		</p>
                </li>
</ul></div>
        </p>
