...
<p class="para">Чтобы включить автоматические обновления, отредактируйте <span class="file filename">/etc/apt/apt.conf.d/10periodic</span> и задайте соответствующие конфигурационные параметры <span class="app application">apt</span>:</p>
<div class="code"><pre class="contents ">APT::Periodic::Update-Package-Lists "1";
APT::Periodic::Download-Upgradeable-Packages "1";
APT::Periodic::AutocleanInterval "7";
APT::Periodic::Unattended-Upgrade "1";
</pre></div>
<p class="para">Приведённая выше конфигурация обновляет список пакетов, скачивает и устанавливает доступные обновления каждый день. Локальный архив загрузок очищается каждую неделю.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
