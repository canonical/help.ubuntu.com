...
<li class="list itemizedlist">
          <p class="para">Για περισσότερες επιλογές ρυθμίσεων του <span class="em emphasis">Bacula</span> αναφερθείτε στο <a href="http://www.bacula.org/en/rel-manual/index.html" class="ulink" title="http://www.bacula.org/en/rel-manual/index.html">εγχειρίδιο χρήστη του Bacula</a></p>
        </li>
<li class="list itemizedlist">
