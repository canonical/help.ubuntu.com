...
<li class="list itemizedlist">
          <p class="para">Подробнее о опциях настройки <span class="em emphasis">Bacula</span> смотрите <a href="http://www.bacula.org/en/rel-manual/index.html" class="ulink" title="http://www.bacula.org/en/rel-manual/index.html">Руководство пользователя Bacula</a></p>
        </li>
<li class="list itemizedlist">
