...
<div class="region"><div class="contents"><p class="para">En un terminal, introduzca la siguiente orden para instalar <span class="app application">bzr</span>: <div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install bzr</span>
</pre></div></p></div></div>
</div></div>
