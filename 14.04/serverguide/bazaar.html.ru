...
<div class="region"><div class="contents"><p class="para">Чтобы установить <span class="app application">bzr</span>, введите в консоли следующую команду: <div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install bzr</span>
</pre></div></p></div></div>
</div></div>
