...
<a class="nextlinks-prev" href="apparmor.html" title="AppArmor">Anterior</a><a class="nextlinks-next" href="ecryptfs.html" title="eCryptfs">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="certificates-and-security.html#generating-a-csr" title="Generar una Petición de Firma de Certificado (Certificate Signing Request, CSR)">Generar una Petición de Firma de Certificado (Certificate Signing Request, CSR)</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html#creating-a-self-signed-certificate" title="Creación de un certificado auto-firmado">Creación de un certificado auto-firmado</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html#installing-the-certificate" title="Instalar el Certificado">Instalar el Certificado</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html#certificate-authority" title="Autoridad de certificación">Autoridad de certificación</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html#certificate-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<div class="code"><pre class="contents ">dir             = /etc/ssl/             # Donde se mantendrá todo
...
<li class="steps">
              ...
              <p class="para">Ahora todo está preparado para empezar a firmar certificados. Lo primero que necesita es una solicitud de firma de certificado (Certificate Signing Request, CSR). Consulte <a class="xref" href="certificates-and-security.html#generating-a-csr" title="Generar una Petición de Firma de Certificado (Certificate Signing Request, CSR)">Generar una Petición de Firma de Certificado (Certificate Signing Request, CSR)</a> para más información. Una vez que disponga de un CSR, introduzca lo siguiente para generar un certificado firmado por la CA:</p>    
