...
<a class="nextlinks-prev" href="libvirt.html" title="libvirt">Назад</a><a class="nextlinks-next" href="ubuntucloud.html" title="Облако Ubuntu">Вперёд</a>
</div>
...
<div class="region">
<div class="contents"><p class="para">Начиная с 14.04 LTS, утилита uvtool значительно упрощает задачу создания виртуальных машин (ВМ) с использованием облачных образов. <span class="app application">uvtool</span> предоставляет простой механизм синхронизации облачных образов с их локальными копиями и их использования для создания новых ВМ в течение нескольких минут.</p></div>
