...
<a class="nextlinks-prev" href="automatic-updates.html" title="Аўтаматычныя абнаўленьні">Назад</a><a class="nextlinks-next" href="package-management-references.html" title="Спасылкі">Наперад</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="configuration.html#extra-repositories" title="Extra Repositories">Extra Repositories</a></li></ul></div>
