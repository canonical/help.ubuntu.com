...
<a class="nextlinks-prev" href="user-management.html" title="User Management">Назад</a><a class="nextlinks-next" href="firewall.html" title="Брандмаўэр">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Console Security</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="console-security.html#disable-ctrl-alt-delete" title="Выключыць Ctrl+Alt+Delete">Выключыць Ctrl+Alt+Delete</a></li></ul></div>
<div class="sect2 sect" id="disable-ctrl-alt-delete"><div class="inner">
<div class="hgroup"><h2 class="title">Выключыць Ctrl+Alt+Delete</h2></div>
...
<div class="code"><pre class="contents ">#exec shutdown -r now "Control-Alt-Delete pressed"
</pre></div>
		</li></ul></div>
</div></div>
</div></div>
