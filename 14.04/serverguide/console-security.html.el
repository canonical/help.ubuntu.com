...
<a class="nextlinks-prev" href="user-management.html" title="Διαχείριση Χρηστών">Προηγούμενο</a><a class="nextlinks-next" href="firewall.html" title="Τείχος Προστασίας">Επόμενο</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="console-security.html#disable-ctrl-alt-delete" title="Απενεργοποίηση Ctrl+Alt+Delete">Απενεργοποίηση Ctrl+Alt+Delete</a></li></ul></div>
