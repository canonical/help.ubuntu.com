...
<a class="nextlinks-prev" href="user-management.html" title="Управление пользователями">Назад</a><a class="nextlinks-next" href="firewall.html" title="Брандмауэр">Вперёд</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="console-security.html#disable-ctrl-alt-delete" title="Отключение Ctrl+Alt+Delete">Отключение Ctrl+Alt+Delete</a></li></ul></div>
