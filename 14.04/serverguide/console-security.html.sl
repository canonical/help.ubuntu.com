...
<a class="nextlinks-prev" href="user-management.html" title="Upravljanje uporabnikov">Nazaj</a><a class="nextlinks-next" href="firewall.html" title="Požarni zid">Naprej</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="console-security.html#disable-ctrl-alt-delete" title="Onemogoči Ctrl+Alt+Delete">Onemogoči Ctrl+Alt+Delete</a></li></ul></div>
<div class="sect2 sect" id="disable-ctrl-alt-delete"><div class="inner">
<div class="hgroup"><h2 class="title">Onemogoči Ctrl+Alt+Delete</h2></div>
