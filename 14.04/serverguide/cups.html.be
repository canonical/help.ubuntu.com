...
<a class="nextlinks-prev" href="iscsi-initiator.html" title="iSCSI Initiator">Назад</a><a class="nextlinks-next" href="email-services.html" title="Email Services">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">CUPS - Сэрвер друку</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="cups.html#cups-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="cups.html#cups-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="cups.html#cups-web" title="Web Interface">Web Interface</a></li>
<li class="links"><a class="xref" href="cups.html#cups-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
<div class="sect2 sect" id="cups-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Усталёўка</h2></div>
<div class="region"><div class="contents">
<p class="para">
            To install CUPS on your Ubuntu computer, simply use <span class="app application">sudo</span> with the <span class="app application">apt-get</span> command and give the packages to install as the first parameter. A complete CUPS install has many package dependencies, but they may all be specified on the same command line.  Enter the following at a terminal prompt to install CUPS:
          </p>
<p class="para">
...
<div class="region"><div class="contents">
<p class="para">
        <a href="http://www.cups.org/" class="ulink" title="http://www.cups.org/">Вэб-старонка CUPS</a>
        </p>
<p class="para">
