...
<p class="para">Para instalar CUPS en su equipo Ubuntu, simplemente use <span class="app application">sudo</span> con el comando <span class="app application">apt-get</span> y proporcione como primer parámetro el nombre de los paquetes a instalar. Una instalación completa de CUPS tiene muchas dependencias de paquetes, pero pueden especificarse todas ellas en la misma línea de comandos. Introduzca lo siguiente en la línea de órdenes de una terminal para instalar CUPS:</p>
<p class="para">
