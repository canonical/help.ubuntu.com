...
<p class="para">Для того, чтобы установить CUPS на ваш компьютер, используйте <span class="app application">sudo</span> с командой <span class="app application">apt-get</span> указав в качестве первого параметра название пакета для установки. Полная установка CUPS зависит от множества пакетов, но все они могут быть указаны в той же командной строке. Для установки CUPS наберите в командной строке следующее:</p>
<p class="para">
