...
<a class="nextlinks-prev" href="dns-configuration.html" title="Nastavljanje">Nazaj</a><a class="nextlinks-next" href="dns-references.html" title="Sklici">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="dns-troubleshooting.html#dns-testing" title="Preizkušanje">Preizkušanje</a></li>
...
<p class="para">
	  ...
	  <span class="app application">BIND9</span> logging options.  For coverage of advanced options see <a class="xref" href="dns-references.html#dns-more-info" title="Več informacij">Več informacij</a>.
	  </p>
</div></div>
</div></div>
</div>
