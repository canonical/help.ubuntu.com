...
<a class="nextlinks-prev" href="exim4.html" title="Exim4">Nazaj</a><a class="nextlinks-next" href="mailman.html" title="Mailman">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="dovecot-server.html#dovecot-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="dovecot-server.html#dovecot-configuration" title="Nastavljanje">Nastavljanje</a></li>
...
<li class="links"><a class="xref" href="dovecot-server.html#dovecot-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="dovecot-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Namestitev</h2></div>
<div class="region"><div class="contents">
<p class="para">
            To install <span class="app application">dovecot</span>, run the following command in the
            command prompt:
	    </p>
...
<p class="para">
	  ...
	  Please
          refer to <a class="xref" href="certificates-and-security.html" title="Potrdila">Potrdila</a>
...
<li class="list itemizedlist">
              <p class="para">Za več podatkov si oglejte tudi stran <a href="https://help.ubuntu.com/community/Dovecot" class="ulink" title="https://help.ubuntu.com/community/Dovecot">Dovecot na Ubuntu Wiki</a>.</p>
            </li>
</ul></div></div></div>
</div></div>
</div>
