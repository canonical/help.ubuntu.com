...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="clustering.html" title="Кластеризация">Кластеризация</a> » </div></div>
...
<li class="list itemizedlist">
          <p class="para"><a href="http://manpages.ubuntu.com/manpages/trusty/en/man5/drbd.conf.5.html" class="ulink" title="http://manpages.ubuntu.com/manpages/trusty/en/man5/drbd.conf.5.html">Man-страница drbd.conf</a> содержит сведения о параметрах, не рассмотренных в данном руководстве.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">Смотрите также <a href="http://manpages.ubuntu.com/manpages/trusty/en/man8/drbdadm.8.html" class="ulink" title="http://manpages.ubuntu.com/manpages/trusty/en/man8/drbdadm.8.html">man-страницу drbdadm</a>.</p>
        </li>
<li class="list itemizedlist">
