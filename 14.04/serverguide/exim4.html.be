...
<a class="nextlinks-prev" href="postfix.html" title="Postfix">Назад</a><a class="nextlinks-next" href="dovecot-server.html" title="Сэрвер Dovecot">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="exim4.html#exim4-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="exim4.html#exim4-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="exim4.html#exim4-smtp-auth" title="SMTP Authentication">SMTP Authentication</a></li>
<li class="links"><a class="xref" href="exim4.html#exim4-sasl" title="Наладка SASL">Наладка SASL</a></li>
<li class="links"><a class="xref" href="exim4.html#exim4-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
<div class="sect2 sect" id="exim4-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Усталёўка</h2></div>
<div class="region"><div class="contents"><p class="para">Каб устанавіць <span class="app application">exim4</span>, увядзіце загад: <div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install exim4</span>
</pre></div></p></div></div>
</div></div>
...
<p class="para">Цяпер запусьціце сэрвіс <span class="app application">saslauthd</span>:</p>
...
<li class="list itemizedlist">
              <p class="para">Глядзіце <a href="http://www.exim.org/" class="ulink" title="http://www.exim.org/">exim.org</a> для больш зьмястоўнай інфармацыі.</p>
            </li>
<li class="list itemizedlist">
              <p class="para">Яшчэ даступная <a href="http://www.uit.co.uk/content/exim-smtp-mail-server" class="ulink" title="http://www.uit.co.uk/content/exim-smtp-mail-server">Кніга па Exim4</a>.</p>
            </li>
<li class="list itemizedlist">
              <p class="para">
