...
<a class="nextlinks-prev" href="postfix.html" title="Postfix">Προηγούμενο</a><a class="nextlinks-next" href="dovecot-server.html" title="Εξυπηρετητής Dovecot">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="exim4.html#exim4-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="exim4.html#exim4-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="exim4.html#exim4-smtp-auth" title="Πιστοποίηση SMTP">Πιστοποίηση SMTP</a></li>
<li class="links"><a class="xref" href="exim4.html#exim4-sasl" title="Ρύθμιση του SASL">Ρύθμιση του SASL</a></li>
<li class="links"><a class="xref" href="exim4.html#exim4-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
<div class="sect2 sect" id="exim4-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Εγκατάσταση</h2></div>
<div class="region"><div class="contents"><p class="para">Για να εγκαταστήσετε το <span class="app application">exim4</span>, εκτελέστε την ακόλουθη εντολή: <div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install exim4</span>
</pre></div></p></div></div>
</div></div>
