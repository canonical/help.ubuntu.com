...
<div class="region"><div class="contents"><p class="para">Para instalar <span class="app application">exim4</span>, ejecute la siguiente orden: <div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install exim4</span>
</pre></div></p></div></div>
</div></div>
