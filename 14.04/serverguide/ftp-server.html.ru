...
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-ftp-server-installation" title="vsftpd — установка FTP-сервера">vsftpd — установка FTP-сервера</a></li>
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-anonymous-configuration" title="Настройка анонимного доступа по FTP">Настройка анонимного доступа по FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-userauth-configuration" title="Настройка авторизованного доступа по FTP">Настройка авторизованного доступа по FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-security" title="Защита FTP">Защита FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<li class="list itemizedlist">
                      <p class="para">Более подробно о параметрах <span class="file filename">/etc/vsftpd.conf</span> читайте в <a href="http://manpages.ubuntu.com/manpages/trusty/en/man5/vsftpd.conf.5.html" class="ulink" title="http://manpages.ubuntu.com/manpages/trusty/en/man5/vsftpd.conf.5.html">man-странице vsftpd.conf</a>.</p>
                    </li>
</ul></div></div></div>
</div></div>
</div>
