...
<a class="nextlinks-prev" href="bazaar.html" title="Bazaar">Προηγούμενο</a><a class="nextlinks-next" href="subversion.html" title="Subversion">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="git.html#git-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="git.html#git-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
...
<p class="para">
        ...
        If you have not yet configured an SSH key, refer to <a class="xref" href="openssh-server.html#openssh-keys" title="Κλειδιά SSH">Κλειδιά SSH</a>
        </p>
