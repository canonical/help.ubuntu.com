...
<a class="nextlinks-prev" href="bazaar.html" title="Bazaar">Anterior</a><a class="nextlinks-next" href="subversion.html" title="Subversion">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="git.html#git-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="git.html#git-configuration" title="Configuración">Configuración</a></li>
...
<p class="para">
        ...
        If you have not yet configured an SSH key, refer to <a class="xref" href="openssh-server.html#openssh-keys" title="Claves SSH">Claves SSH</a>
        </p>
