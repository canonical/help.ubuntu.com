...
<a class="nextlinks-prev" href="web-servers.html" title="Διακομιστές Ιστού">Προηγούμενο</a><a class="nextlinks-next" href="php5.html" title="PHP5 - Γλώσσα Σεναρίου">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="httpd.html#http-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="httpd.html#http-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="httpd.html#https-configuration" title="Διαμόρφωση HTTPS">Διαμόρφωση HTTPS</a></li>
...
<li class="links"><a class="xref" href="httpd.html#http-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<p class="para">Μπορείτε να εγκαταστήσετε επιπρόσθετες υπομονάδες του Apache2 και να τις χρησιμοποιήσετε με τον διακομιστή Ιστού σας. Για παράδειγμα, τρέξτε την ακόλουθη εντολή από ένα τερματικό εντολών για να εγκαταστήσετε τηνυπομονάδα <span class="em emphasis">MySQL Authentication</span>:</p>
...
<p class="para">Η υπομονάδα <span class="app application">mod_ssl</span> είναι διαθέσιμη στο πακέτο <span class="app application">apache2-common</span>. Εκτελέστε την ακόλουθη εντολή από ένα τερματικό εντολών για να ενεργοποιήσετε την υπομονάδα <span class="app application">mod_ssl</span>:</p>
...
<p class="para">
          ...
          <a class="xref" href="certificates-and-security.html" title="Πιστοποιητικά">Πιστοποιητικά</a>
          </p>
