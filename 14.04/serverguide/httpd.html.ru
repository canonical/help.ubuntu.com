...
<a class="nextlinks-prev" href="web-servers.html" title="Веб-серверы">Назад</a><a class="nextlinks-next" href="php5.html" title="PHP5 — язык сценариев">Вперёд</a>
</div>
...
<p class="para">Вы можете установить дополнительные модули для Apache2 и использовать их на вашем веб-сервере. Например, запустите следующую команду из командной строки терминала, чтобы установить модуль <span class="em emphasis">MySQL Authentication</span>:</p>
...
<p class="para">Модуль <span class="app application">mod_ssl</span> доступен в составе пакета <span class="app application">apache2-common</span>. Выполните нижеследующую команду в терминале для включения модуля <span class="app application">mod_ssl</span>:</p>
