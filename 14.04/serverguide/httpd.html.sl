...
<a class="nextlinks-prev" href="web-servers.html" title="Spletni strežniki">Nazaj</a><a class="nextlinks-next" href="php5.html" title="PHP5 - Scripting Language">Naprej</a>
</div>
...
<p class="para">
          ...
          <span class="app application">apache2-common</span> package. Execute the following command from a terminal prompt to
