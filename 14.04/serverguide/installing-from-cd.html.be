...
<a class="nextlinks-prev" href="preparing-to-install.html" title="Рыхтуецца да ўстаноўкі">Назад</a><a class="nextlinks-next" href="installing-upgrading.html" title="Абнаўленьне">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Устаноўка з дыска</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="list itemizedlist">
	      <p class="para">Загрузіць сыстэму з CD-ROMа.</p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<li class="list itemizedlist">
                    ...
                    of an administrator.  For more details see <a class="xref" href="automatic-updates.html" title="Аўтаматычныя абнаўленьні">Аўтаматычныя абнаўленьні</a>.
                    </p>
                  </li>
<li class="list itemizedlist">
                    <p class="para">
