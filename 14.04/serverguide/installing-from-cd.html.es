...
<title>Instalación desde el CD</title>
...
<div class="hgroup"><h1 class="title">Instalación desde el CD</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="list itemizedlist">
	      <p class="para">Reinicie el sistema desde la unidad de CD-ROM.</p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<p class="para">Durante la instalación de la Edición Servidor tendrá la opción de instalar paquetes adicionales desde el CD. Los paquetes están agrupados por el tipo de servicio que proporcionan.</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
...
<p class="para">Si no instaló alguna de las tareas durante el proceso de instalación pero, por ejemplo, decidió convertir su nuevo servidor LAMP en un servidor DNS también, simplemente inserte el CD de instalación y en un terminal:</p>
