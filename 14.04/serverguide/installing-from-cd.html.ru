...
<a class="nextlinks-prev" href="preparing-to-install.html" title="Подготовка к установке">Назад</a><a class="nextlinks-next" href="installing-upgrading.html" title="Обновление">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Установка с CD</h1></div>
<div class="region">
<div class="contents">
<p class="para">Основные этапы установки Ubuntu Server Edition с CD такие же, как и при установке любой операционной системы с компакт-диска. В отличие от <span class="em emphasis">Desktop Edition</span>, <span class="em emphasis">Server Edition</span> не включает в себя графическую программу установки. Server Edition использует вместо неё консольное меню.</p>
...
<li class="list itemizedlist">
	      <p class="para">Загрузите систему с компакт-диска.</p>
	    </li>
<li class="list itemizedlist">
...
<li class="list itemizedlist">
          ...
          For advanced disk options see <a class="xref" href="advanced-installation.html" title="Расширенная установка">Расширенная установка</a>.
	      </p>
	    </li>
<li class="list itemizedlist">
...
<p class="para">И, опять таки, за подробными инструкциями обратитесь к <a href="https://help.ubuntu.com/14.04/installation-guide/" class="ulink" title="https://help.ubuntu.com/14.04/installation-guide/"> Руководству по установке Ubuntu</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="installing-from-cd.html#install-tasks" title="Наборы пакетов (задачи)">Наборы пакетов (задачи)</a></li></ul></div>
<div class="sect2 sect" id="install-tasks"><div class="inner">
<div class="hgroup"><h2 class="title">Наборы пакетов (задачи)</h2></div>
<div class="region"><div class="contents">
<p class="para">Во время установки Server Edition у вас будет возможность выбрать установку дополнительных пакетов с установочного CD. Эти пакеты сгруппированы по типам предоставляемых ими сервисов.</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
...
<p class="para">Если вы не установили какую-либо задачу в процессе установки, но, например, решили сделать ваш новый сервер LAMP ещё и DNS-сервером, просто вставьте установочный CD и введите в терминале:</p>
