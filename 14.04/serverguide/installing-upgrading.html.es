...
<a class="nextlinks-prev" href="installing-from-cd.html" title="Instalación desde el CD">Anterior</a><a class="nextlinks-next" href="advanced-installation.html" title="Instalación avanzada">Siguiente</a>
</div>
...
<p class="para">Los sistemas basados en Debian también pueden actualizarse usando <span class="cmd command">apt-get dist-upgrade</span>. Sin embargo, se recomienda usar <span class="app application">do-release-upgrade</span> porque tiene la habilidad de manejar cambios en la configuración del sistema que algunas veces son necesarios entre diferentes versiones.</p>
