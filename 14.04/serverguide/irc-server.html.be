...
<a class="nextlinks-prev" href="chat-overview.html" title="Overview">Назад</a><a class="nextlinks-next" href="jabberd2-server.html" title="Jabber Instant Messaging Server">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="irc-server.html#irc-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="irc-server.html#irc-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="irc-server.html#irc-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
