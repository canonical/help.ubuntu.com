...
<a class="nextlinks-prev" href="network-file-system.html" title="Network File System (NFS)">Назад</a><a class="nextlinks-next" href="cups.html" title="CUPS - Сэрвер друку">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html#iscsi-initiator-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
