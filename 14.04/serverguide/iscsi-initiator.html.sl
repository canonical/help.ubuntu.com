...
<a class="nextlinks-prev" href="network-file-system.html" title="Network File System (NFS)">Nazaj</a><a class="nextlinks-next" href="cups.html" title="CUPS - tiskalniški strežnik">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html#iscsi-initiator-references" title="Sklici">Sklici</a></li>
</ul></div>
