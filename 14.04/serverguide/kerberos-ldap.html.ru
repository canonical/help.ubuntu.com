...
<a class="nextlinks-prev" href="kerberos.html" title="Kerberos">Назад</a><a class="nextlinks-next" href="sssd-ad.html" title="SSSD and Active Directory">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-openldap" title="Настройка OpenLDAP">Настройка OpenLDAP</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-primary-kdc" title="Настройка первичного KDC">Настройка первичного KDC</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-secondary-kdc" title="Настройка вторичного KDC">Настройка вторичного KDC</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<li class="list itemizedlist">
          <p class="para">Ещё одной полезной ссылкой является <a href="http://manpages.ubuntu.com/manpages/trusty/en/man5/krb5.conf.5.html" class="ulink" title="http://manpages.ubuntu.com/manpages/trusty/en/man5/krb5.conf.5.html">man-страница krb5.conf</a>.</p>
        </li>
<li class="list itemizedlist">
