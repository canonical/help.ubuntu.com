...
<a class="nextlinks-prev" href="kerberos.html" title="Kerberos">Nazaj</a><a class="nextlinks-next" href="sssd-ad.html" title="SSSD and Active Directory">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-openldap" title="Nastavljanje OpenLDAP">Nastavljanje OpenLDAP</a></li>
...
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-resources" title="Viri">Viri</a></li>
</ul></div>
...
<p class="para">
      ...
      configured between at least two servers.  For information on setting up OpenLDAP see <a class="xref" href="openldap-server.html" title="Strežnik OpenLDAP">Strežnik OpenLDAP</a>.
      </p>
<p class="para">
