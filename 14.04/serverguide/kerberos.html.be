...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="network-authentication.html" title="Network Authentication">Network Authentication</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="samba-ldap.html" title="Samba і LDAP">Назад</a><a class="nextlinks-next" href="kerberos-ldap.html" title="Kerberos і LDAP">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="kerberos.html#kerberos-server" title="Сэрвер Kerberos">Сэрвер Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html#kerberos-secondary-kdc" title="Другасны KDC">Другасны KDC</a></li>
<li class="links"><a class="xref" href="kerberos.html#kerberos-linux-client" title="Linux кліент Kerberos">Linux кліент Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html#kerberos-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">
	...
	<span class="em emphasis">Network Time Protocol (NTP)</span> server.  For details
        on setting up NTP see <a class="xref" href="NTP.html" title="Time Synchronisation with NTP">Time Synchronisation with NTP</a>.
        </p>
<p class="para">
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
	  ...
	  <a class="xref" href="kerberos.html#kerberos-server-installation" title="Усталёўка">Усталёўка</a>, you 
