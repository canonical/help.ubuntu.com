...
<a class="nextlinks-prev" href="virtualization.html" title="Εικονικοποίηση">Προηγούμενο</a><a class="nextlinks-next" href="cloud-images-and-uvtool.html" title="Cloud images and uvtool">Επόμενο</a>
</div>
...
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">--connect:</span> προσδιορίζει σε ποιο hypervisor να συνδεθεί.</p>
        </li>
</ul></div>
