...
<a class="nextlinks-prev" href="virtualization.html" title="Virtualización">Anterior</a><a class="nextlinks-next" href="cloud-images-and-uvtool.html" title="Cloud images and uvtool">Siguiente</a>
</div>
...
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">--connect:</span> especifica a qué supervisor conectarse.</p>
        </li>
</ul></div>
