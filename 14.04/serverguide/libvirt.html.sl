...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="virtualization.html" title="Virtualization">Virtualization</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="virtualization.html" title="Virtualization">Nazaj</a><a class="nextlinks-next" href="cloud-images-and-uvtool.html" title="Cloud images and uvtool">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="libvirt.html#libvirt-installation" title="Namestitev">Namestitev</a></li>
...
<li class="links"><a class="xref" href="libvirt.html#libvirt-management" title="Upravljanje navideznih naprav">Upravljanje navideznih naprav</a></li>
...
<li class="links"><a class="xref" href="libvirt.html#libvirt-resources" title="Viri">Viri</a></li>
</ul></div>
...
<p class="para">V terminalu vnesite:</p>
...
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">-n ime-naprave:</span> ime nove navidezne naprave, v tem primeru <span class="em emphasis">ime-naprave</span>.</p>
        </li>
<li class="list itemizedlist">
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">-o:</span> izvirna navidezna naprava</p>
        </li>
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">-n:</span> ime nove navidezne naprave</p>
        </li>
<li class="list itemizedlist">
...
<div class="hgroup"><h2 class="title">Upravljanje navideznih naprav</h2></div>
<div class="region">
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
            <p class="para">Za izpis zagnanih navideznih naprav:</p>

            <div class="screen"><pre class="contents "><span class="cmd command">virsh -c qemu:///system list</span>
</pre></div>
          </li>
<li class="list itemizedlist">
            <p class="para">Za zagon navidezne naprave:</p>

            <div class="screen"><pre class="contents "><span class="cmd command">virsh -c qemu:///system start ime-naprave</span>
</pre></div>
          </li>
<li class="list itemizedlist">
            <p class="para">Similarly, to start a virtual machine at boot:</p>

            <div class="screen"><pre class="contents "><span class="cmd command">virsh -c qemu:///system autostart ime-naprave</span>
</pre></div>
          </li>
<li class="list itemizedlist">
            <p class="para">Navidezno napravo lahko znova zaženete z:</p>

            <div class="screen"><pre class="contents "><span class="cmd command">virsh -c qemu:///system reboot ime-naprave</span>
</pre></div>
          </li>
<li class="list itemizedlist">
            ...
            <div class="screen"><pre class="contents "><span class="cmd command">virsh -c qemu:///system save ime-naprave ime-naprave-022708.state</span>
</pre></div>
...
<li class="list itemizedlist">
            <p class="para">Shranjeno navidezno napravo lahko obnovite z:</p>

            <div class="screen"><pre class="contents "><span class="cmd command">virsh -c qemu:///system restore ime-naprave-022708.state</span>
</pre></div>
          </li>
<li class="list itemizedlist">
            <p class="para">Za izklop navidezne naprave vpišite:</p>

            <div class="screen"><pre class="contents "><span class="cmd command">virsh -c qemu:///system shutdown ime-naprave</span>
</pre></div>
          </li>
<li class="list itemizedlist">
            ...
            <div class="screen"><pre class="contents "><span class="cmd command">virsh -c qemu:///system attach-disk ime-naprave /dev/cdrom /media/cdrom</span>
</pre></div>
          </li>
</ul></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
...
<div class="hgroup"><h3 class="title">Upravitelj navideznih naprav</h3></div>
<div class="region"><div class="contents">
<p class="para">Paket <span class="app application">virt-manager</span> vsebuje grafično orodje za upravljanje z krajevnimi in oddaljenimi navideznimi napravami. Za namestitev virt-manager vnesite:</p>
...
<p class="para">You can connect to the <span class="app application">libvirt</span>
        ...
        terminal prompt:</p>
<div class="screen"><pre class="contents "><span class="cmd command">virt-manager -c qemu+ssh://virtnode1.moja-domena.com/system</span>
</pre></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
          ...
          <span class="app application">SSH</span> see <a class="xref" href="openssh-server.html" title="Strežnik OpenSSH">Strežnik OpenSSH</a></p>
        </div></div></div></div>
</div></div>
</div></div>
</div>
...
<p class="para">Za namestitev programa <span class="app application">virt-viewer</span> iz terminala, vnesite:</p>
...
<div class="screen"><pre class="contents "><span class="cmd command">virt-viewer -c qemu:///system ime-naprave</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">virt-viewer -c qemu+ssh://virtnode1.moja-domena.com/system ime-naprave</span>
</pre></div>
<p class="para">Ne pozabite zamenjati <span class="em emphasis">ime-naprave</span> z ustreznim imenom navidezne naprave.</p>
...
<li class="list itemizedlist">
          <p class="para">Za več podrobnosti o <span class="app application">libvirt</span> si oglejte <a href="http://libvirt.org/" class="ulink" title="http://libvirt.org/">domačo stran libvirt</a>.</p>
        </li>
<li class="list itemizedlist">
