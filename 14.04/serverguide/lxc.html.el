...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="virtualization.html" title="Εικονικοποίηση">Εικονικοποίηση</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="ubuntucloud.html" title="Ubuntu Cloud">Προηγούμενο</a><a class="nextlinks-next" href="cgroups.html" title="Control Groups">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html#lxc-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
...
<li class="links"><a class="xref" href="lxc.html#lxc-network" title="Δικτύωση">Δικτύωση</a></li>
...
<li class="links"><a class="xref" href="lxc.html#lxc-debugging" title="Επίλυση Προβλημάτων">Επίλυση Προβλημάτων</a></li>
<li class="links"><a class="xref" href="lxc.html#python-lxc" title="LXC API">LXC API</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-security" title="Ασφάλεια">Ασφάλεια</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html#bridging" title="Γεφύρωση">Γεφύρωση</a>).  Then, specify the host's bridge in the
