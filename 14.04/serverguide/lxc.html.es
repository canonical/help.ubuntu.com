...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="virtualization.html" title="Virtualización">Virtualización</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="ubuntucloud.html" title="Ubuntu Cloud">Anterior</a><a class="nextlinks-next" href="cgroups.html" title="Grupos de control">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html#lxc-installation" title="Instalación">Instalación</a></li>
...
<li class="links"><a class="xref" href="lxc.html#lxc-network" title="Red">Red</a></li>
...
<li class="links"><a class="xref" href="lxc.html#lxc-cgroups" title="Grupos de control">Grupos de control</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-cloning" title="Clonar">Clonar</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-hooks" title="Lifecycle management hooks">Lifecycle management hooks</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-consoles" title="Consolas">Consolas</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-debugging" title="Resolución de problemas">Resolución de problemas</a></li>
<li class="links"><a class="xref" href="lxc.html#python-lxc" title="LXC API">LXC API</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-security" title="Seguridad">Seguridad</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html#bridging" title="Puentear (Bridging)">Puentear (Bridging)</a>).  Then, specify the host's bridge in the
