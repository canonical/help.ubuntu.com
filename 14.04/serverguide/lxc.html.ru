...
<a class="nextlinks-prev" href="ubuntucloud.html" title="Облако Ubuntu">Назад</a><a class="nextlinks-next" href="cgroups.html" title="Группы управления">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html#lxc-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-basic-usage" title="Основы использования">Основы использования</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-global-conf" title="Глобальная конфигурация">Глобальная конфигурация</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-network" title="Работа в сети">Работа в сети</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-startup" title="Запуск LXC">Запуск LXC</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-backinstores" title="Резервные хранилища">Резервные хранилища</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-templates" title="Шаблоны">Шаблоны</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-autostart" title="Автозапуск">Автозапуск</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-apparmor" title="Apparmor">Apparmor</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-cgroups" title="Группы управления">Группы управления</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-cloning" title="Клонирование">Клонирование</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-hooks" title="Обработчики управления жизненным циклом">Обработчики управления жизненным циклом</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-consoles" title="Консоли">Консоли</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-debugging" title="Устранение проблем">Устранение проблем</a></li>
<li class="links"><a class="xref" href="lxc.html#python-lxc" title="API LXC">API LXC</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-security" title="Защита">Защита</a></li>
<li class="links"><a class="xref" href="lxc.html#lxc-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<p class="para">Для создания непривилегированных контейнеров необходимо несколько шагов. Вам необходимо создать конфигурационный файл базового контейнера, для определения вашего определенного сопоставления идентификаторов и настроек сети, а так же настроить физическую рабочую станцию на разрешение непривилегированному пользователю привязаться к физическому компьютеру. В примере ниже предполагается, что вам сопоставляется пользовательские и групповые идентификаторы в диапазоне 100000-165536.</p>
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html#bridging" title="Использование моста">Использование моста</a>).  Then, specify the host's bridge in the
...
<p class="para">При выполнении <span class="cmd command">lxc-create</span> все параметры, указанные после <span class="em emphasis">--</span>, передаются шаблону. В следующей команде <span class="em emphasis">--name</span>, <span class="em emphasis">--template</span> и <span class="em emphasis">--bdev</span> передаются <span class="cmd command">lxc-create</span>, в то время как <span class="em emphasis">--release</span> передаётся шаблону: <div class="screen"><pre class="contents "><span class="cmd command">
