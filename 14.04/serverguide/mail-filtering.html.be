...
<a class="nextlinks-prev" href="mailman.html" title="Mailman">Назад</a><a class="nextlinks-next" href="chat-servers.html" title="Chat Applications">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-testing" title="Праверка">Праверка</a></li>
...
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
