...
<a class="nextlinks-prev" href="mailman.html" title="Mailman">Назад</a><a class="nextlinks-next" href="chat-servers.html" title="Приложения для чата">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-testing" title="Тестирование">Тестирование</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-troubleshooting" title="Устранение проблем">Устранение проблем</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-references" title="Ссылки">Ссылки</a></li>
</ul></div>
<div class="sect2 sect" id="mail-filter-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Установка</h2></div>
<div class="region"><div class="contents">
<p class="para">Смотрите раздел<a class="xref" href="postfix.html" title="Postfix">Postfix</a> для установки и настройки Postfix.</p>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
		...
		<p class="para">Если вы внесли изменения в этот файл, убедитесь, что выполнили <span class="cmd command">sudo apt-get update</span> перед повторной попыткой установки.</p>
	</div></div></div></div>
</div></div>
</div></div>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
	       <p class="para">Для инструкций по журналам <span class="app application">Postfix</span> смотрите раздел <a class="xref" href="postfix.html#postfix-troubleshooting" title="Устранение проблем">Устранение проблем</a>.</p>
	     </li>
<li class="list itemizedlist">
