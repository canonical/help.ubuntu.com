...
<a class="nextlinks-prev" href="mailman.html" title="Mailman">Nazaj</a><a class="nextlinks-next" href="chat-servers.html" title="Chat Applications">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-testing" title="Preizkušanje">Preizkušanje</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-troubleshooting" title="Odpravljanje napak">Odpravljanje napak</a></li>
<li class="links"><a class="xref" href="mail-filtering.html#mail-filter-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<li class="list itemizedlist">
	       ...
	       For instructions on <span class="app application">Postfix</span> logging see the 
               <a class="xref" href="postfix.html#postfix-troubleshooting" title="Odpravljanje napak">Odpravljanje napak</a> section.
	       </p>
	     </li>
<li class="list itemizedlist">
	       <p class="para">
