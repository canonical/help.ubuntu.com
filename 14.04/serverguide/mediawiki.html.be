...
<a class="nextlinks-prev" href="moinmoin.html" title="Moin Moin">Назад</a><a class="nextlinks-next" href="phpmyadmin.html" title="phpMyAdmin">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">MediaWiki</h1></div>
<div class="region">
<div class="contents"><p class="para">
    MediaWiki is an web based Wiki software written in the PHP
    language. It can either use <span class="app application">MySQL</span> or
    <span class="app application">PostgreSQL</span> Database Management
    System.
    </p></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-extensions" title="Extensions">Extensions</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<p class="para">
      To install <span class="app application">MediaWiki</span>, run the following
      command in the command prompt:
      </p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install mediawiki php5-gd</span>
</pre></div>
<p class="para">
       For additional <span class="app application">MediaWiki</span> functionality see the <span class="app application">mediawiki-extensions</span>
       package.
       </p>
</div></div>
</div></div>
...
<div class="note note-tip" title="Падказка"><div class="inner"><div class="region"><div class="contents">
        <p class="para">
...
<div class="hgroup"><h2 class="title">Extensions</h2></div>
<div class="region"><div class="contents">
<p class="para">
      The extensions add new features and enhancements for the MediaWiki
      application. The extensions give wiki administrators and end users
      the ability to customize MediaWiki to their requirements.
      </p>
<p class="para">
      You can download MediaWiki extensions as an archive file or
      checkout from the Subversion repository. You should copy it to
      <span class="file filename">/var/lib/mediawiki/extensions</span> directory. You
      should also add the following line at the end of file: 
      <span class="file filename">/etc/mediawiki/LocalSettings.php</span>.
      </p>
...
<li class="list itemizedlist">
          <p class="para">
          For more details, please refer to the <a href="http://www.mediawiki.org" class="ulink" title="http://www.mediawiki.org">MediaWiki</a> web site.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
