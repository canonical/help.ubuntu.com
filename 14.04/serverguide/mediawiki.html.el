...
<a class="nextlinks-prev" href="moinmoin.html" title="Moin Moin">Προηγούμενο</a><a class="nextlinks-next" href="phpmyadmin.html" title="phpMyAdmin">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">MediaWiki</h1></div>
<div class="region">
<div class="contents"><p class="para">Το MediaWiki είναι λογισμικό Wiki, γραμμένο στη γλώσσα PHP. Μπορεί να χρησιμοποιήσει είτε το <span class="app application">MySQL</span> ή το <span class="app application">PostgreSQL</span> ως σύστημα διαχείρισης βάσεων δεδομένων.</p></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-extensions" title="Επεκτάσεις">Επεκτάσεις</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<p class="para">Για να εγκαταστήσετε το <span class="app application">MediaWiki</span>, εκτελέστε την ακόλουθη εντολή στη γραμμή εντολών:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install mediawiki php5-gd</span>
</pre></div>
<p class="para">Για επιπλέον λειτουργίες του <span class="app application">MediaWiki</span> δείτε το πακέτο <span class="app application">mediawiki-extensions</span>.</p>
</div></div>
</div></div>
...
<div class="hgroup"><h2 class="title">Επεκτάσεις</h2></div>
<div class="region"><div class="contents">
<p class="para">Οι επεκτάσεις προσθέτουν νέες λειτουργίες και βελτιώσεις στην εφαρμογή MediaWiki. Οι επεκτάσεις δίνουν στους διαχειριστές και στους τελικούς χρήστες τη δυνατότητα να προσαρμόσουν το MediaWiki στις απαιτήσεις τους.</p>
<p class="para">Μπορείτε να κάνετε λήψη επεκτάσεων του MediaWiki ως συμπιεσμένο αρχείο ή από το αποθετήριο Subversion. Θα πρέπει να τις αντιγράψετε στον κατάλογο <span class="file filename">/var/lib/mediawiki/extensions</span>. Επίσης, θα πρέπει να προσθέσετε την ακόλουθη γραμμή στο τέλος του αρχείου <span class="file filename">/etc/mediawiki/LocalSettings.php</span>.</p>
<div class="code"><pre class="contents ">require_once "$IP/extensions/ΌνομαΕπέκτασης/ΌνομαΕπέκτασης.php";
</pre></div>
</div></div>
</div></div>
...
<li class="list itemizedlist">
          <p class="para">Για περισσότερες πληροφορίες, παρακαλούμε αναφερθείτε στον ιστότοπο του <a href="http://www.mediawiki.org" class="ulink" title="http://www.mediawiki.org">MediaWiki</a></p>
        </li>
<li class="list itemizedlist">
          <p class="para">
