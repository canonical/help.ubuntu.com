...
<a class="nextlinks-prev" href="moinmoin.html" title="Moin Moin">Anterior</a><a class="nextlinks-next" href="phpmyadmin.html" title="phpMyAdmin">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">MediaWiki</h1></div>
<div class="region">
<div class="contents"><p class="para">MediaWiki es un software Wiki basado en web y escrito en el lenguaje PHP. Puede usarse con los sistemas de gestión de bases de datos <span class="app application">MySQL</span> o <span class="app application">PostgreSQL</span>.</p></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-extensions" title="Extensiones">Extensiones</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<p class="para">Para instalar <span class="app application">MediaWiki</span>, ejecute los siguientes comandos:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install mediawiki php5-gd</span>
</pre></div>
<p class="para">Para saber más del funcionamiento de <span class="app application">MediaWiki</span> vea el paquete <span class="app application">mediawiki-extensions</span></p>
</div></div>
</div></div>
...
<p class="para">Una vez que la configuración esté completa, debe copiar el archivo <span class="file filename">LocalSettings.php</span> al directorio <span class="file filename">/etc/mediawiki</span>:</p>
...
<div class="hgroup"><h2 class="title">Extensiones</h2></div>
<div class="region"><div class="contents">
<p class="para">Las extensiones añaden nuevas características y mejoras a la aplicación MediaWiki. Las extensiones proporcionan a los administradores y los usuarios finales la capacidad de personalizar MediaWiki a sus necesidades.</p>
<p class="para">Puede descargar extensiones MediaWiki como un archivo comprimido o descargarlo de un repositorio Subversion. Deberá copiarlo en el directorio <span class="file filename">/var/lib/mediawiki/extensions</span>. También tendrá que añadir la siguiente línea al final del archivo: <span class="file filename">/etc/mediawiki/LocalSettings.php</span>.</p>
...
<li class="list itemizedlist">
          <p class="para">Para más detalles, visite el sitio web de <a href="http://www.mediawiki.org" class="ulink" title="http://www.mediawiki.org">MediaWiki</a>.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<li class="list itemizedlist">
          <p class="para">También, la página <a href="https://help.ubuntu.com/community/MediaWiki" class="ulink" title="https://help.ubuntu.com/community/MediaWiki">Ubuntu Wiki MediaWiki</a> es un buen recurso.</p>
        </li>
</ul></div></div></div>
</div></div>
</div>
