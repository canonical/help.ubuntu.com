...
<a class="nextlinks-prev" href="moinmoin.html" title="Moin Moin">Nazaj</a><a class="nextlinks-next" href="phpmyadmin.html" title="phpMyAdmin">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-extensions" title="Extensions">Extensions</a></li>
<li class="links"><a class="xref" href="mediawiki.html#mediawiki-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<p class="para">Za namesitev programa <span class="app application">MediaWiki</span> v terminal vnesite:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install mediawiki php5-gd</span>
</pre></div>
<p class="para">Za dodatne zmožnosti programa <span class="app application">MediaWiki</span> si oglejte paket <span class="app application">mediawiki-extensions</span>.</p>
</div></div>
</div></div>
...
<li class="list itemizedlist">
          <p class="para">Za več podrobnosti si oglejte spletno stran <a href="http://www.mediawiki.org" class="ulink" title="http://www.mediawiki.org">MediaWiki</a>.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
