...
<a class="nextlinks-prev" href="lamp-overview.html" title="Обзор">Назад</a><a class="nextlinks-next" href="mediawiki.html" title="MediaWiki">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="moinmoin.html#moinmoin-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="moinmoin.html#moinmoin-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="moinmoin.html#moinmoin-verification" title="Проверка">Проверка</a></li>
<li class="links"><a class="xref" href="moinmoin.html#moinmoin-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">udo apt-get install python-moinmoin</span>
</pre></div>
<p class="para">
       ...
       server, please refer to <a class="xref" href="httpd.html#http-installation" title="Установка">Установка</a>
       sub-section in <a class="xref" href="httpd.html" title="HTTPD - веб сервер Apache2">HTTPD - веб сервер Apache2</a> section.
       </p>
</div></div>
</div></div>
