...
<a class="nextlinks-prev" href="device-mapper-multipathing.html" title="Device Mapper Multipathing">Anterior</a><a class="nextlinks-next" href="multipath-setting-up-dm-multipath.html" title="Setting up DM-Multipath Overview">Siguiente</a>
</div>
...
<li class="list itemizedlist">
      ...
      configuration option, see Section , <a class="link" href="multipath-dm-multipath-config-file.html#multipath-config-defaults" title="Predeterminados del archivo de configuración">Configuration File
