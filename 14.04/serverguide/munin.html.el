...
<li class="list itemizedlist">
          <p class="para">Δείτε τον ιστότοπο του <a href="http://munin.projects.linpro.no/" class="ulink" title="http://munin.projects.linpro.no/">Munin</a> για περισσότερες λεπτομέρειες.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">Συγκεκριμένα, η σελίδα με την <a href="http://munin.projects.linpro.no/wiki/Documentation" class="ulink" title="http://munin.projects.linpro.no/wiki/Documentation">Τεκμηρίωση του Munin</a> περιλαμβάνει πληροφορίες σχετικά με επιπλέον πρόσθετα, τη συγγραφή προσθέτων, κτλ.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">Επίσης, κυκλοφορεί ένα βιβλίο της Open Source Press στα Γερμανικά: <a href="https://www.opensourcepress.de/index.php?26&amp;backPID=178&amp;tt_products=152" class="ulink" title="https://www.opensourcepress.de/index.php?26&amp;backPID=178&amp;tt_products=152">Munin Graphisches Netzwerk- und System-Monitoring</a>.</p>
        </li>
</ul></div></div></div>
</div></div>
</div>
