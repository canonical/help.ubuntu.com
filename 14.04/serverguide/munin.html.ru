...
<a class="nextlinks-prev" href="nagios.html" title="Nagios">Назад</a><a class="nextlinks-next" href="web-servers.html" title="Веб-серверы">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Munin</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="munin.html#munin-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="munin.html#munin-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="munin.html#munin-plugins" title="Дополнительные плагины">Дополнительные плагины</a></li>
<li class="links"><a class="xref" href="munin.html#munin-references" title="Ссылки">Ссылки</a></li>
</ul></div>
<div class="sect2 sect" id="munin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Установка</h2></div>
<div class="region"><div class="contents">
<p class="para">Перед установкой <span class="app application">Munin</span> на <span class="em emphasis">server01</span> необходимо установить веб-сервер <span class="app application">apache2</span>. Стандартной конфигурации будет достаточно для запуска сервера <span class="app application">munin</span>. Для более детальной информации по настройке apache2, обратитесь к разделу <a class="xref" href="httpd.html" title="HTTPD - веб сервер Apache2">HTTPD - веб сервер Apache2</a>.</p>
...
<li class="list itemizedlist">
          <p class="para">Посетите официальный сайт <a href="http://munin.projects.linpro.no/" class="ulink" title="http://munin.projects.linpro.no/">Munin</a> для более детальной информации.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">Узконаправленная <a href="http://munin.projects.linpro.no/wiki/Documentation" class="ulink" title="http://munin.projects.linpro.no/wiki/Documentation"> документация Munin</a> содержит информацию о дополнительных плагинах, написании плагинов и т.д.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">Также можно прочесть книгу на немецком языке издательства «Open Source Press»: <a href="https://www.opensourcepress.de/index.php?26&amp;backPID=178&amp;tt_products=152" class="ulink" title="https://www.opensourcepress.de/index.php?26&amp;backPID=178&amp;tt_products=152">Munin Graphisches Netzwerk- und System-Monitoring</a>.</p>
        </li>
</ul></div></div></div>
</div></div>
</div>
