...
<a class="nextlinks-prev" href="databases.html" title="Базы даньняў">Назад</a><a class="nextlinks-next" href="postgresql.html" title="PostgreSQL">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="mysql.html#mysql-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="mysql.html#mysql-configuration" title="Настаўленьні">Настаўленьні</a></li>
...
<li class="links"><a class="xref" href="mysql.html#mysql-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
