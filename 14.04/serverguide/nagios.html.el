...
<a class="nextlinks-prev" href="monitoring-overview.html" title="Επισκόπηση">Προηγούμενο</a><a class="nextlinks-next" href="munin.html" title="Munin">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Nagios</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="nagios.html#nagios-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="nagios.html#nagios-configuration-overview" title="Συνοπτική περιγραφή ρυθμίσεων">Συνοπτική περιγραφή ρυθμίσεων</a></li>
<li class="links"><a class="xref" href="nagios.html#nagios-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="nagios.html#nagios-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Δείτε το <a class="xref" href="httpd.html" title="HTTPD - Apache2 Διακομιστής Ιστού">HTTPD - Apache2 Διακομιστής Ιστού</a> για λεπτομέρειες σχετικά με τη ρύθμιση του Apache, το <a class="xref" href="dns.html" title="Υπηρεσία ονομάτων τομέα (DNS)">Υπηρεσία ονομάτων τομέα (DNS)</a> για το DNS και το <a class="xref" href="mysql.html" title="MySQL">MySQL</a> για τη MySQL.</p>
      </div></div></div></div>
