...
<a class="nextlinks-prev" href="ftp-server.html" title="Сэрвер FTP">Назад</a><a class="nextlinks-next" href="iscsi-initiator.html" title="iSCSI Initiator">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="network-file-system.html#nfs-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="network-file-system.html#nfs-configuration" title="Настаўленьні">Настаўленьні</a></li>
...
<li class="links"><a class="xref" href="network-file-system.html#nfs-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
