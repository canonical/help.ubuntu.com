...
<p class="para">Si tiene problemas al montar un recurso NFS compartido, compruebe que tiene instalado el paquete <span class="app application">nfs-common</span> en su cliente. Para instalar <span class="app application">nfs-common</span>, introduzca la orden siguiente en una terminal: <div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install nfs-common</span>
</pre></div></p>
</div></div>
</div></div>
