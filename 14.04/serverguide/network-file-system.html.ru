...
<p class="para">Если вы испытываете сложности с монтированием NFS-ресурса, убедитесь, что пакет <span class="app application">nfs-common</span> установлен на вашем клиенте. Для установки пакета <span class="app application">nfs-common</span> введите следующую команду в терминале:
