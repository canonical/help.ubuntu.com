...
<a class="nextlinks-prev" href="network-authentication.html" title="Network Authentication">Назад</a><a class="nextlinks-next" href="samba-ldap.html" title="Samba і LDAP">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-installation" title="Усталёўка">Усталёўка</a></li>
...
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html#openldap-server-installation" title="Усталёўка">Усталёўка</a>. Make sure the slapd-config
...
<p class="para">
	...
	<a class="xref" href="samba-ldap.html" title="Samba і LDAP">Samba і LDAP</a> for details.
	</p>
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
