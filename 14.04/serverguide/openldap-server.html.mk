...
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-installation" title="Инсталација">Инсталација</a></li>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html#openldap-server-installation" title="Инсталација">Инсталација</a>. Make sure the slapd-config
