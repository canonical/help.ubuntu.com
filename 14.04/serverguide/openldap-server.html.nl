...
<a class="nextlinks-prev" href="network-authentication.html" title="Network Authentication">Vorige</a><a class="nextlinks-next" href="samba-ldap.html" title="Samba and LDAP">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-installation" title="Installatie">Installatie</a></li>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html#openldap-server-installation" title="Installatie">Installatie</a>. Make sure the slapd-config
