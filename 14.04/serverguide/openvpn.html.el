...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="vpn.html" title="VPN">VPN</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="vpn.html" title="VPN">Προηγούμενο</a><a class="nextlinks-next" href="other-useful-applications.html" title="Άλλες Χρήσιμες Εφαρμογές">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="openvpn.html#openvpn-server-installation" title="Εγκατάσταση διακομιστή">Εγκατάσταση διακομιστή</a></li>
<li class="links"><a class="xref" href="openvpn.html#openvpn-pki-setup" title="Δημόσιο κλειδί εγκατάστασης υποδομής">Δημόσιο κλειδί εγκατάστασης υποδομής</a></li>
<li class="links"><a class="xref" href="openvpn.html#openvpn-simple-server-configuration" title="Απλή ρύθμιση παραμέτρων διακομιστή">Απλή ρύθμιση παραμέτρων διακομιστή</a></li>
<li class="links"><a class="xref" href="openvpn.html#openvpn-simple-client-configuration" title="Απλή διαμόρφωση πελάτη">Απλή διαμόρφωση πελάτη</a></li>
<li class="links"><a class="xref" href="openvpn.html#openvpn-first-troubleshooting" title="Πρώτη αντιμετώπιση προβλημάτων">Πρώτη αντιμετώπιση προβλημάτων</a></li>
...
<li class="links"><a class="xref" href="openvpn.html#openvpn-client-implementations" title="Εφαρμογές λογισμικού πελάτη">Εφαρμογές λογισμικού πελάτη</a></li>
<li class="links"><a class="xref" href="openvpn.html#openvpn-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist"><p class="para">Ελέγξτε το syslog σας , π.χ. grep -i vpn /var/log/syslog</p></li>
<li class="list itemizedlist"><p class="para">
Check that you have specified the keyfile names correctly in client.conf and server.conf.
          </p></li>
<li class="list itemizedlist"><p class="para">Μπορεί ο πελάτης να συνδεθεί με το μηχάνημα του διακομιστή; Ίσως ένα τείχος προστασίας εμποδίζει την πρόσβαση; Ελέγξτε το syslog του διακομιστή.</p></li>
...
<div class="region"><div class="contents">
<p class="para">Επεξεργασθείτε το <span class="file filename">/etc/openvpn/server.conf</span> αλλάζοντας τις ακόλουθες επιλογές σε:</p>
...
<p class="para">Στη συνέχεια το κάνετε εκτελέσιμο:</p>
...
<p class="para">Επανεκκίνηση OpenVPN:</p>
