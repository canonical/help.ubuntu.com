...
<div class="region"><div class="contents">
<p class="para">Postfix soporta dos implementacions de SASL, Cyrus SASL y Dovecot SASL. Para activar Dovecot SASL el paquete <span class="app application">dovecot-common</span> necesitará ser instalado. De una terminal ingrese lo siguiente:</p>
