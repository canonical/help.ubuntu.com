...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="email-services.html" title="E-poštne storitve">E-poštne storitve</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="email-services.html" title="E-poštne storitve">Nazaj</a><a class="nextlinks-next" href="exim4.html" title="Exim4">Naprej</a>
</div>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
            ...
            on Virtual Domains and other advanced configurations see <a class="xref" href="postfix.html#postfix-references" title="Sklici">Sklici</a>.
            </p>
          </div></div></div></div>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="postfix.html#postfix-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="postfix.html#postfix-configuration" title="Basic Configuration">Basic Configuration</a></li>
<li class="links"><a class="xref" href="postfix.html#postfix-smtp-authentication" title="Overitev SMTP">Overitev SMTP</a></li>
<li class="links"><a class="xref" href="postfix.html#postfix-sasl" title="Nastavljanje SASL">Nastavljanje SASL</a></li>
<li class="links"><a class="xref" href="postfix.html#mail-stack-delivery" title="Mail-Stack Delivery">Mail-Stack Delivery</a></li>
<li class="links"><a class="xref" href="postfix.html#postfix-testing" title="Preizkušanje">Preizkušanje</a></li>
<li class="links"><a class="xref" href="postfix.html#postfix-troubleshooting" title="Odpravljanje napak">Odpravljanje napak</a></li>
</ul></div>
<div class="sect2 sect" id="postfix-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Namestitev</h2></div>
<div class="region"><div class="contents">
<p class="para">Za namestitev programa <span class="app application">postfix</span> zaženite sledeči ukaz:</p>
...
<div class="region"><div class="contents">
<p class="para">Za nastavljanje programa <span class="app application">postfix</span> zaženite sledeči ukaz:</p>
...
<li class="list itemizedlist"><p class="para">Spletna stran</p></li>
<li class="list itemizedlist"><p class="para">posta.primer.si</p></li>
...
<li class="list itemizedlist"><p class="para">Ne</p></li>
...
<li class="list itemizedlist"><p class="para">vse</p></li>
</ul></div>
            </p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
            <p class="para">
...
<div class="hgroup"><h2 class="title">Overitev SMTP</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="steps">
     	         <p class="para">Nastavite Postfix za SMTP-AUTH z uporabo SASL (Dovecot SASL):</p>
...
<li class="steps">
                <p class="para">
                Next, generate or obtain a digital certificate for TLS. See <a class="xref" href="certificates-and-security.html" title="Potrdila">Potrdila</a> for details.
                This example also uses a Certificate Authority (CA).  For information on generating a CA certificate see
                <a class="xref" href="certificates-and-security.html#certificate-authority" title="Overitelj potrdil">Overitelj potrdil</a>.
	        </p>
		<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
                <p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo postconf -e 'smtpd_tls_CAfile = /etc/ssl/certs/cacert.pem'</span>
                  ...
                  <p class="para">
                  Again, for more details about certificates see <a class="xref" href="certificates-and-security.html" title="Potrdila">Potrdila</a>.
                  </p>
                </li>
</ol></div></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title">Nastavljanje SASL</h2></div>
<div class="region"><div class="contents">
<p class="para">	              
	    Postfix supports two SASL implementations Cyrus SASL and Dovecot SASL.  To enable Dovecot SASL 	    
	    the <span class="app application">dovecot-common</span> package will need to be installed.  From a terminal prompt
	    enter the following:
	    </p>
...
<p class="para">
            ...
            package uses the certificate and key from the <span class="app application">ssl-cert</span> package, and in a production environment you should
            use a certificate and key generated for the host.  See <a class="xref" href="certificates-and-security.html" title="Potrdila">Potrdila</a> for more details.
            </p>
<p class="para">
            Once you have a customized certificate and key for the host, change the following options in <span class="file filename">/etc/postfix/main.cf</span>:
            </p>
<div class="code"><pre class="contents ">smtpd_tls_cert_file = /etc/ssl/certs/ssl-mail.pem
smtpd_tls_key_file = /etc/ssl/private/ssl-mail.key
</pre></div>
<p class="para">Nato znova zaženite Postfix:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo service postfix restart</span>
</pre></div>
</div></div>
</div></div>
<div class="sect2 sect" id="postfix-testing"><div class="inner">
<div class="hgroup"><h2 class="title">Preizkušanje</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">telnet posta.primer.si 25</span>
</pre></div>
<p class="para">
            After you have established the connection to the postfix mail
            server, type:
            </p>
<div class="screen"><pre class="contents ">ehlo posta.primer.si
</pre></div>
<p class="para">
...
<div class="hgroup"><h2 class="title">Odpravljanje napak</h2></div>
<div class="region">
...
<div class="hgroup"><h3 class="title">Dnevniške datoteke</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Sklici</h3></div>
<div class="region"><div class="contents">
<p class="para">
