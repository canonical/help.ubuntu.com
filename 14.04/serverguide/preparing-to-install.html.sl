...
<a class="nextlinks-prev" href="installation.html" title="Namestitev">Nazaj</a><a class="nextlinks-next" href="installing-from-cd.html" title="Namestitev s CD-ja">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="preparing-to-install.html#system-requirements" title="Sistemske zahteve">Sistemske zahteve</a></li>
...
<td class="td-colsep"><p class="para">1 gigabajt</p></td>
...
<div class="region"><div class="contents"><div class="list itemizedlist"><ul class="list itemizedlist"><li class="list itemizedlist">
	      ...
	      Before installing <span class="app application">Ubuntu Server Edition</span> you should make sure all data on the system 
              is backed up. See <a class="xref" href="backups.html" title="Varnostne kopije">Varnostne kopije</a> for backup options.
	      </p>
	      <p class="para"> 
