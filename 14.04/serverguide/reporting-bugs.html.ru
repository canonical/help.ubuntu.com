...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="serverguide-appendix.html" title="Дополнение">Дополнение</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks"><a class="nextlinks-prev" href="serverguide-appendix.html" title="Дополнение">Назад</a></div>
...
<li class="links"><a class="xref" href="reporting-bugs.html#reporting-bugs-apport-cli" title="Отправка отчётов об ошибках с помощью apport-cli">Отправка отчётов об ошибках с помощью apport-cli</a></li>
<li class="links"><a class="xref" href="reporting-bugs.html#apport-crash-catching" title="Уведомление о сбоях приложений">Уведомление о сбоях приложений</a></li>
<li class="links"><a class="xref" href="reporting-bugs.html#reporting-bugs-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
    <p class="para">Чтобы узнать больше о пакетах в Ubuntu, смотрите <a class="xref" href="package-management.html" title="Управление пакетами">Управление пакетами</a>.</p>
    </div></div></div></div>
