...
<a class="nextlinks-prev" href="squid.html" title="Прокси-сервер Squid">Назад</a><a class="nextlinks-next" href="tomcat.html" title="Apache Tomcat">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="ruby-on-rails.html#ruby-on-rails-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="ruby-on-rails.html#ruby-on-rails-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="ruby-on-rails.html#ruby-on-rails-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<p class="para">Перед установкой <span class="app application">Rails</span> необходимо установить <span class="app application">Apache</span> и <span class="app application">MySQL</span>. Для установки <span class="app application">Apache</span>, пожалуйста, обратитесь к <a class="xref" href="httpd.html" title="HTTPD - веб сервер Apache2">HTTPD - веб сервер Apache2</a>. Для инструкций по установке <span class="app application">MySQL</span>, обратитесь к <a class="xref" href="mysql.html" title="MySQL">MySQL</a>.</p>
