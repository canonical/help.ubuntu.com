...
<a class="nextlinks-prev" href="samba-fileprint-security.html" title="Securing File and Print Server">Назад</a><a class="nextlinks-next" href="samba-ad-integration.html" title="Active Directory Integration">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="samba-dc.html#samba-dc-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">
      ...
      See <a class="xref" href="samba-ldap.html" title="Samba і LDAP">Samba і LDAP</a> for details.
      </p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
   
          <p class="para">Спачатку ўстанавіце <span class="app application">samba</span> і <span class="app application">libpam-smbpass</span>. У тэрмінале ўвядзіце:</p>
