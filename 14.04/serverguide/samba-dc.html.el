...
<a class="nextlinks-prev" href="samba-fileprint-security.html" title="Securing File and Print Server">Προηγούμενο</a><a class="nextlinks-next" href="samba-ad-integration.html" title="Active Directory Integration">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="samba-dc.html#samba-pdc-smbpasswd" title="Κύριος Ελεγκτής Τομέα">Κύριος Ελεγκτής Τομέα</a></li>
<li class="links"><a class="xref" href="samba-dc.html#samba-bdc-smbpasswd" title="Ελεγκτής Τομέα Αντιγράφου Ασφαλείας">Ελεγκτής Τομέα Αντιγράφου Ασφαλείας</a></li>
<li class="links"><a class="xref" href="samba-dc.html#samba-dc-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<li class="steps">
          ...
          <p class="para">Πρώτον, εγκαταστήστε τα Samba, και <span class="app application">libpam-smbpass</span> για να συγχρονίσετε τους λογαριασμούς χρηστών, πληκτρολογώντας τα ακόλουθα σε ένα τερματικό εντολών:</p>
...
<li class="list itemizedlist">
              ...
              <p class="para">Σε αυτό το παράδειγμα η ομάδα <span class="em emphasis">machines</span> θα χρειαστεί να δημιουργηθεί χρησιμοποιώντας την λειτουργία  <span class="app application">addgroup</span> δείτε το <a class="xref" href="user-management.html#adding-deleting-users" title="Προσθήκη και Διαγραφή Χρηστών">Προσθήκη και Διαγραφή Χρηστών</a> για λεπτομέρειες.</p>
...
<p class="para">Η χρησιμοποίηση του LDAP είναι ο πιο αυτοδύναμος τρόπος να συγχρονίσετε τις πληροφορίες λογαριασμού, επειδή και οι δύο ελεγκτές τομέα μπορούν να χρησιμοποιήσουν τις ίδιες πληροφορίες σε πραγματικό χρόνο. Παρόλα αυτά, το να στήσετε έναν διακομιστή LDAP μπορεί να είναι πού περίπλοκο για ένα μικρό νούμερο χρηστών και λογαριασμών υπολογιστών. Δείτε  <a class="xref" href="samba-ldap.html" title="Samba και LDAP">Samba και LDAP</a> για λεπτομέρειες.</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
   
          <p class="para">Πρώτα, εγκαταστήστε τα <span class="app application">samba</span> και <span class="app application">libpam-smbpass</span>. Από ένα τερματικό πληκτρολογήστε:</p>
