...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="samba.html" title="Samba">Samba</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="samba-fileprint-security.html" title="Securing File and Print Server">Nazaj</a><a class="nextlinks-next" href="samba-ad-integration.html" title="Active Directory Integration">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="samba-dc.html#samba-pdc-smbpasswd" title="Osnovni nadzornik domene">Osnovni nadzornik domene</a></li>
...
<li class="links"><a class="xref" href="samba-dc.html#samba-dc-resources" title="Viri">Viri</a></li>
</ul></div>
<div class="sect2 sect" id="samba-pdc-smbpasswd"><div class="inner">
<div class="hgroup"><h2 class="title">Osnovni nadzornik domene</h2></div>
<div class="region"><div class="contents">
<p class="para">Ta odsek pokriva nastavljanje Sambe kot osnovni nadzornik domene (PDC) z uporabo privzetega začelja smbpasswd.</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">

          <p class="para">
          First, install Samba, and <span class="app application">libpam-smbpass</span> to sync the user accounts,
...
<li class="steps">
          ...
          <p class="para">Nato nastavite program Samba z urejanjem datoteke <span class="file filename">/etc/samba/smb.conf</span>. Spremenljivka <span class="em emphasis">security</span> naj bo nastavljena na <span class="em emphasis">user</span>, spremenljivka <span class="em emphasis">workgrouppa na ime va</span></p>

<div class="code"><pre class="contents ">   workgroup = PRIMER
   ...
   security = user
</pre></div>
...
<li class="list itemizedlist">
              ...
              <span class="app application">addgroup</span> utility see <a class="xref" href="user-management.html#adding-deleting-users" title="Dodajanje in odstranjevanje uporabnikov">Dodajanje in odstranjevanje uporabnikov</a> for details.
              </p>
...
<li class="steps">
          ...
          <p class="para">Sedaj ustvarite mapo <span class="file filename">netlogon</span> in prazno datoteko <span class="file filename">logon.cmd</span>:</p> 
...
<p class="para">
      ...
      See <a class="xref" href="samba-ldap.html" title="Samba in LDAP">Samba in LDAP</a> for details.
      </p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
   
          <p class="para">
          First, install <span class="app application">samba</span> and <span class="app application">libpam-smbpass</span>.  From a terminal enter:
          </p>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo scp -r uporabniško-ime@pdc:/var/lib/samba /var/lib</span>
</pre></div>
...
<li class="steps">
          ...
          <p class="para">Za konec znova zaženite program <span class="app application">samba</span>:</p>
