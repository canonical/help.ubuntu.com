...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Průvodce pro Ubuntu Server">Průvodce pro Ubuntu Server</a> » <a class="trail" href="samba.html" title="Samba">Samba</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="samba-printserver.html" title="Print Server">Předchozí</a><a class="nextlinks-next" href="samba-dc.html" title="As a Domain Controller">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html#samba-security-mode" title="Samba bezpečnostní módy">Samba bezpečnostní módy</a></li>
...
<li class="links"><a class="xref" href="samba-fileprint-security.html#samba-security-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<li class="list itemizedlist">
          ...
          Samba user accounts are separate from system accounts, but the <span class="app application">libpam-smbpass</span> 
...
<p class="para">
      First, install the <span class="app application">libpam-smbpass</span> package which will sync the system users to the Samba
      user database:
      </p>
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
        <p class="para">
        If you chose the <span class="em emphasis">Samba Server</span> task during installation <span class="app application">libpam-smbpass</span>
