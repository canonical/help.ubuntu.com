...
<a class="nextlinks-prev" href="samba-printserver.html" title="Διακομιστής Εκτύπωσης">Προηγούμενο</a><a class="nextlinks-next" href="samba-dc.html" title="As a Domain Controller">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html#samba-security-mode" title="Καταστάσεις Ασφάλειας Samba">Καταστάσεις Ασφάλειας Samba</a></li>
...
<li class="links"><a class="xref" href="samba-fileprint-security.html#samba-share-security" title="Ασφάλεια Διαμοιραζόμενου">Ασφάλεια Διαμοιραζόμενου</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html#samba-apparmor" title="Προφίλ Samba AppArmor">Προφίλ Samba AppArmor</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html#samba-security-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">security = user:</span> απαιτεί από τους πελάτες να παρέχουν ένα όνομα χρήστη και κωδικό πρόσβασης για να συνδεθούν στα διαμοιραζόμενα. Οι λογαριασμοί χρηστών του Samba είναι διαφορετικοί από τους λογαριασμούς συστήματος, αλλά το πακέτο <span class="app application">libpam-smbpass</span> θα συγχρονίσει τους χρήστες και τους κωδικούς συστήματος με τη βάση δεδομένων χρηστών του Samba.</p>
        </li>
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">security = domain:</span> αυτή η κατάσταση επιτρέπει στο διακομιστή του Samba να εμφανίζεται στους πελάτες των Windows σαν  Πρωτεύον Ελεγκτής Τομέα (Primary Domain Controller (PDC)), ΕφεδρικόςΕλεγκτής Τομέα (Backup Domain Controller (BDC)), ή Τμήμα Μέλους Διακομιστή (Domain Member Server (DMS)). Δείτε <a class="xref" href="samba-dc.html" title="As a Domain Controller">As a Domain Controller</a> για περισσότερεσ πληροφορίες.</p>
        </li>
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">security = ADS:</span> επιτρέπει στο διακομιστή Samba  να συνδεθεί στον τομέα Ενεργού Καταλόγου σαν ένα ιθαγενές μέλος. Δείτε <a class="xref" href="samba-ad-integration.html" title="Active Directory Integration">Active Directory Integration</a> για λεπτομέρειες.</p>
        </li>
<li class="list itemizedlist">
...
<div class="region"><div class="contents">
<p class="para">Αυτό το τμήμα θα επαναδιαμορφώσει το αρχείο και το διακομιστή εκτυπωτή Samba, από <a class="xref" href="samba-fileserver.html" title="File Server">File Server</a> και <a class="xref" href="samba-printserver.html" title="Διακομιστής Εκτύπωσης">Διακομιστής Εκτύπωσης</a>, ώστε να απαιτεί πιστοποίηση.</p>
<p class="para">Πρώτον, εγκαταστήστε το πακέτο <span class="app application">libpam-smbpass</span> το οποίο θα συγχρονίσει τους χρήστες του συστήματος στη βάση δεδομένων χρηστών του Samba:</p>
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Εάν επιλέξατε τη διεργασία <span class="em emphasis">Διακομιστής Samba</span> κατά τη διάρκεια της εγκατάστασης τότε το <span class="app application">libpam-smbpass</span> είναι ήδη εγκατεστημένο.</p>
      </div></div></div></div>
...
<p class="para">Από προεπιλογή το Samba αναζητά τις τοπικές ομάδες συστήματος που ορίζονται στο <span class="file filename">/etc/group</span> για να καθορίσει ποιοι χρήστες ανήκουν σε ποιες ομάδες. Για περισσότερες πληροφορίες για εισαγωγή και διαγραφή χρηστών από ομάδες βλ. <a class="xref" href="user-management.html#adding-deleting-users" title="Προσθήκη και Διαγραφή Χρηστών">Προσθήκη και Διαγραφή Χρηστών</a>.</p>
