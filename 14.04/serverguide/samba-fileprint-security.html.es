...
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">security = user:</span> exige que los clientes proporcionen un nombre de usuario y una contraseña para conectarse a los recursos compartidos. Las cuentas de usuario de Samba están separadas de las cuentas del sistema, pero el paquete <span class="app application">libpam-smbpass</span> sincroniza las cuentas y contraseña del sistema con la base de datos de usuarios de Samba.</p>
        </li>
<li class="list itemizedlist">
...
<p class="para">En primer lugar, instale el paquete <span class="app application">libpam-smbpassapplication&gt;, que sincronizar</span></p>
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Si seleccione la tarea <span class="em emphasis">Servidor Samba</span> durante la instalación, ya tendrá instalado el paquete <span class="app application">libpam-smbpass</span>.</p>
      </div></div></div></div>
