...
<a class="nextlinks-prev" href="samba-introduction.html" title="Úvod">Předchozí</a><a class="nextlinks-next" href="samba-printserver.html" title="Print Server">Následující</a>
</div>
<div class="hgroup"><h1 class="title">File Server</h1></div>
<div class="region">
<div class="contents">
<p class="para">Jedna z nejběžnějších metod, jak propojit počítače s Ubuntu a Windows spočívá v konfiguraci Samby jako souborového serveru. Tato část popisuje nastavení <span class="app application">Samba</span> serveru pro sdílení souborů s Windows klienty.</p>
<p class="para">Server bude nakonfigurován ke sdílení souborů s každým klientem na síti bez vyžadování hesla. Pokud vaše prostředí vyžaduje přísnější přístupové kontroly, podívejte se na <a class="xref" href="samba-fileprint-security.html" title="Securing File and Print Server">Securing File and Print Server</a></p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html#samba-fileserver-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html#samba-fileserver-configuration" title="Nastavení">Nastavení</a></li>
...
<p class="para">Prvním krokem je instalace balíčku <span class="app application">samba</span>. Do příkazové řádky zadejte:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt-get install samba</span>
</pre></div>
<p class="para">To je vše, co je potřeba; nyní jste připraven nastavit Sambu pro sdílení souborů.</p>
</div></div>
</div></div>
<div class="sect2 sect" id="samba-fileserver-configuration"><div class="inner">
<div class="hgroup"><h2 class="title">Nastavení</h2></div>
<div class="region"><div class="contents">
<p class="para">Hlavní konfigurační soubor Samby je umísten v <span class="file filename">/etc/samba/smb.conf</span>. Výchozí konfigurační soubor obsahuje množství komentářů s popisem různých konfiguračních direktiv.</p>
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Ne všechny dostupné volby jsou součástí výchozího konfiguračního souboru. Podívejte se na manuálové stránky <span class="file filename">smb.conf</span> nebo na <a href="http://samba.org/samba/docs/man/Samba-HOWTO-Collection/" class="ulink" title="http://samba.org/samba/docs/man/Samba-HOWTO-Collection/">Samba HOWTO Collection</a> pro více informací.</p>
      </div></div></div></div>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">

        <p class="para">Nejprve upravte nasledujíci klíč-hodnota záznamy v sekci <span class="em emphasis">[global]</span> souboru <span class="file filename">/etc/samba/smb.conf</span>:</p>
...
<div class="code"><pre class="contents ">   workgroup = EXAMPLE
   ...
   security = user
        ...
        <p class="para">Parametr <span class="em emphasis">security</span> je níže v sekci [global] a je standartně zakomentován. Nezapomeňte také změnit <span class="em emphasis">EXAMPLE</span> tak, aby lépe odpovídalo vašemu prostředí.</p>

        </li>
<li class="steps">
  
        <p class="para">Vytvořte novou sekci ve spodní části souboru, nebo odstraňte jeden z příkladů pro adresáře které mají být sdíleny:</p>
...
<li class="steps">
        ...
        <p class="para">Nyní, když už je <span class="app application">Samba</span> nakonfigurována, musíme vytvořit složku a upravit práva k ní. V terminálu zadejte:</p>
...
<li class="steps">
      ...
      <p class="para">Nakonec restartujte <span class="app application">sambu</span> pro nastavení nové konfigurace:</p>
...
<div class="note note-warning" title="Varování"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Opakujeme, že výše uvedené nastavení povoluje přístup všem klientům v místní síti. Pro zabezbečnější nastavení čtěte <a class="xref" href="samba-fileprint-security.html" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
      </div></div></div></div>
<p class="para">
