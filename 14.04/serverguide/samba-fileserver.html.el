...
<p class="para">Ο διακομιστής θα ρυθμιστεί ώστε να μοιράζει αρχεία με κάθε πελάτη του δικτύου χωρίς να ζητάει κωδικό πρόσβασης. Εάν το περιβάλλον σας απαιτεί πιο αυστηρό Έλεγχο Εισόδου βλ. <a class="xref" href="samba-fileprint-security.html" title="Securing File and Print Server">Securing File and Print Server</a></p>
</div>
...
<div class="region"><div class="contents">
<p class="para">Το κύριο αρχείο ρύθμισης του Samba βρίσκεται στο <span class="file filename">/etc/samba/smb.conf</span>. Το αρχικό αρχείο ρυθμίσεων έχει ένα σημαντικό αριθμό  παρατηρήσεων, προκειμένου να τεκμηριώσει διάφορες οδηγίες διαμόρφωσης.</p>
