...
<p class="para">El servidor se configurará para compartir archivos con cualquier cliente de la red sin solicitar ninguna contraseña. Si su entorno requiere controles de acceso más estrictos, consulte <a class="xref" href="samba-fileprint-security.html" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
</div>
...
<div class="region"><div class="contents">
<p class="para">El archivo principal de configuración de Samba se encuentra en <span class="file filename">/etc/samba/smb.conf</span>. El archivo de configuración predeterminado tiene una cantidad significativa de comentarios con idea de documentar varias directivas de configuración.</p>
