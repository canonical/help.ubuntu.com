...
<p class="para">Сервер будет настроен для предоставления доступа к файлам любому клиенту сети без запроса пароля. Если вам требуется более строгий контроль доступа, смотрите <a class="xref" href="samba-fileprint-security.html" title="Защита файлового сервера и сервера печати">Защита файлового сервера и сервера печати</a></p>
</div>
...
<div class="region"><div class="contents">
<p class="para">Главный файл настройки Samba находится здесь: <span class="file filename">/etc/samba/smb.conf</span>. Настройки по умолчанию содержат значительное количество комментариев, описывающих различные варианты настройки.</p>
