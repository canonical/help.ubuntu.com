...
cn: samba
                ...
                <p class="para">Eliminar las líneas de abajo:</p> 
...
<p class="para">Reinicie <span class="app application">samba</span> para activar la nueva configuración:</p>
...
<li class="list itemizedlist">
		<p class="para">Para añadir un usuario nuevo:</p>
