...
<a class="nextlinks-prev" href="samba-fileserver.html" title="Servidor de archivos">Anterior</a><a class="nextlinks-next" href="samba-fileprint-security.html" title="Securing File and Print Server">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Servidor de impresión</h1></div>
<div class="region">
<div class="contents">
<p class="para">Otro uso habitual de Samba es configurarlo para compartir impresoras instaladas en un servidor Ubuntu, bien localmente o a través de la red. Esta sección (similar a <a class="xref" href="samba-fileserver.html" title="Servidor de archivos">Servidor de archivos</a>) configurará Samba para permitir que cualquier cliente de la red local pueda usar las impresoras instaladas sin necesidad de introducir un nombre de usuario y una contraseña.</p>
<p class="para">Para una configuración más segura, consulte <a class="xref" href="samba-fileprint-security.html" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-printserver.html#samba-printserver-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="samba-printserver.html#samba-printserver-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="samba-printserver.html#samba-printserver-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para">Antes de instalar y configurar Samba, es mejor tener previamente una instalación funcional de <span class="app application">CUPS</span> Consulte <a class="xref" href="cups.html" title="CUPS - Servidor de impresión">CUPS - Servidor de impresión</a> para más información.</p>
