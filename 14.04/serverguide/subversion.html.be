...
<a class="nextlinks-prev" href="git.html" title="Git">Назад</a><a class="nextlinks-next" href="version-control-ref.html" title="Спасылкі">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="subversion.html#subversion-installation" title="Усталёўка">Усталёўка</a></li>
...
<p class="para"> 
					...
					Apache2 web server.  To use SSL with Subversion add the above
                                        ...
                                        For more information on setting up Apache2 with SSL see <a class="xref" href="httpd.html#https-configuration" title="Настаўленьні HTTPS">Настаўленьні HTTPS</a>.
					</p>
<p class="para">
