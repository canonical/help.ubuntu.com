...
<a class="nextlinks-prev" href="network-configuration.html" title="Network Configuration">Vorige</a><a class="nextlinks-next" href="dhcp.html" title="Dynamic Host Configuration Protocol (DHCP)">Volgende</a>
</div>
