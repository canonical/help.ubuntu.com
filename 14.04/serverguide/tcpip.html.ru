...
<a class="nextlinks-prev" href="network-configuration.html" title="Настройка сети">Назад</a><a class="nextlinks-next" href="dhcp.html" title="Протокол динамической настройки хостов (Dynamic Host Configuration Protocol, DHCP)">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="tcpip.html#tcpip-introduction" title="Введение в TCP/IP">Введение в TCP/IP</a></li>
<li class="links"><a class="xref" href="tcpip.html#tcpip-configuration" title="Настройка TCP/IP">Настройка TCP/IP</a></li>
<li class="links"><a class="xref" href="tcpip.html#ip-routing" title="IP-маршрутизация">IP-маршрутизация</a></li>
<li class="links"><a class="xref" href="tcpip.html#tcp-and-udp" title="TCP и UDP">TCP и UDP</a></li>
<li class="links"><a class="xref" href="tcpip.html#icmp" title="ICMP">ICMP</a></li>
<li class="links"><a class="xref" href="tcpip.html#daemons" title="Демоны">Демоны</a></li>
<li class="links"><a class="xref" href="tcpip.html#tcpip-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<li class="list itemizedlist">
              <p class="para">Существуют man-страницы <a href="http://manpages.ubuntu.com/manpages/trusty/en/man7/tcp.7.html" class="ulink" title="http://manpages.ubuntu.com/manpages/trusty/en/man7/tcp.7.html">TCP</a> и <a href="http://manpages.ubuntu.com/manpages/trusty/man7/ip.7.html" class="ulink" title="http://manpages.ubuntu.com/manpages/trusty/man7/ip.7.html">IP</a>, содержащие дополнительную полезную информацию.</p>
            </li>
<li class="list itemizedlist">
