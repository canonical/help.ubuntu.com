...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Namizni vodnik Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Pomoč"></span></span> Namizni vodnik Ubuntu</a> » <a class="trail" href="a11y.html" title="Splošni dostop">Splošni dostop</a> › <a class="trail" href="a11y.html#sound" title="Težave s sluhom">Težave s sluhom</a> » </div></div>
...
<p class="p">To je lahko uporabno, če se nahajate v okolju, kjer ne želite da se vaš računalnik oglaša kot npr. v knjižnici (oglejte si <span class="link"><a href="sound-alert.html" title="Izbira ali onemogočitev opozorilnega zvoka">Izbira ali onemogočitev opozorilnega zvoka</a></span> kako utišati zvok opozorila).</p>
...
<li class="steps"><p class="p">Odprite <span class="gui">Splošni dostop</span> in izberite zavihek <span class="gui">Slišanje</span>.</p></li>
<li class="steps"><p class="p">Vključite <span class="gui">Vidna opozorila</span>. Izberite ali želite da celoten zaslon ali samo naslov trenutnega okno utripa.</p></li>
</ol></div></div></div>
</div>
