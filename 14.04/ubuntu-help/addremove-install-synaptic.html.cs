...
<title>Použití Synaptic pro pokročilejší správu softwaru</title>
...
<div class="region">
<div class="contents">
<p class="p"><span class="app">Správce balíků Synaptic</span> umožňuje provádět určité pokročilé úkony správy softwaru, které <span class="app">Cenrum softwaru pro Ubuntu</span> neumí. Rozhraní Synapticu je složitější a nepodporuje některé novější funkce Centra softwaru jako například hodnocení a recenze a proto není doporučován uživatelům začínajícím s Ubuntu.</p>
<p class="p">Synaptic není součástí výchozí instalace, ale můžete jej <span class="link"><a href="https://apps.ubuntu.com/cat/applications/synaptic" title="https://apps.ubuntu.com/cat/applications/synaptic">nainstalovat</a></span> pomocí Centra softwaru.</p>
</div>
...
<li class="steps"><p class="p">Z nabídky <span class="gui">Dash</span> nebo z <span class="gui">Launcheru</span> spusťte Synaptic. Do okna <span class="gui">Ověření</span> budete muset zadat své heslo.</p></li>
...
<li class="steps"><p class="p">Vyberte další aplikace, které si přejete nainstalovat.</p></li>
<li class="steps"><p class="p">Klikněte na <span class="gui">Použít</span> a poté znovu na <span class="gui">Použít</span> ve zobrazeném okně. Aplikace, které jste vybrali budou staženy a nainstalovány.</p></li>
</ol></div></div></div>
<p class="p">
...
<div class="region"><ul><li class="links ">
<a href="addremove-install.html" title="Instalace dodatečného softwaru">Instalace dodatečného softwaru</a><span class="desc"> — Použití Centra softwaru pro Ubuntu pro instalaci programů a zlepšení práce s Ubuntu</span>
</li></ul></div>
</div></div>
</div>
</div>
