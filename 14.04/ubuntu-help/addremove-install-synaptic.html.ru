...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Используйте Synaptic для более продвинутого управления программным обеспечением</span></h1></div>
<div class="region">
<div class="contents">
<p class="p"><span class="app">Менеджер пакетов Synaptic</span> — более мощный и может выполнять некоторые задачи по управлению программами, которые <span class="app">Центр приложений Ubuntu</span> выполнить не в состоянии. Интерфейс Synaptic сложнее и не поддерживает новейшие возможности Центра приложения, такие как рейтинги и отзывы, поэтому новичкам в Ubuntu пользоваться Synaptic не рекомендуется.</p>
<p class="p">Synaptic по умолчанию не установлен, но <span class="link"><a href="https://apps.ubuntu.com/cat/applications/synaptic" title="https://apps.ubuntu.com/cat/applications/synaptic">установить</a></span> его можно из Центра приложений.</p>
</div>
