...
<div class="region">
<div class="contents">
<p class="p"><span class="app">Upravitelj paketov Synaptic</span> je bolj zmogljiv in lahko opravlja nekatera opravila upravljanja programov, ki jih <span class="app">Programsko središče Ubuntu</span> ne zmore. Synapticov vmesnik je dosti bolj zapleten in ne podpira novejših zmožnosti Programskega središča, kot so ocene ter mnenja. Zato ga novim uporabnikom Ubuntuja ne priporočamo.</p>
<p class="p">Synaptic ni privzeto nameščen, vendar ga lahko <span class="link"><a href="https://apps.ubuntu.com/cat/applications/synaptic" title="https://apps.ubuntu.com/cat/applications/synaptic">namestite</a></span> s Programskim središčem.</p>
</div>
