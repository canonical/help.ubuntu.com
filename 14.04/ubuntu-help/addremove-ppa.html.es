...
<title>Añadir un repositorio de paquetes personal (PPA)</title>
...
<li class="steps"><p class="p">Pulse <span class="gui">Añadir</span> e introduzca la ubicación del <span class="code">ppa:</span>.</p></li>
...
<li class="steps"><p class="p">Cierre la ventana de Orígenes del software.  El Centro de software de Ubuntu revisará sus orígenes de software para el software nuevo.</p></li>
</ol></div>
</div></div>
</div>
...
<div class="region"><ul><li class="links ">
<a href="addremove-sources.html" title="Añadir repositorios adicionales">Añadir repositorios adicionales</a><span class="desc"> — Añadir otros repositorios para ampliar los orígenes de software que usa Ubuntu para instalar y actualizar.</span>
</li></ul></div>
</div></div>
</div>
</div>
