...
<div class="region">
<div class="contents">
<p class="p"><span class="em">Персональные архивы пакетов (Personal Package Archives или PPA)</span> — это репозитории программ, разработанные для пользователей Ubuntu, они проще в установке, чем другие сторонние репозитории.</p>
...
<li class="steps"><p class="p">Щёлкните <span class="gui">Добавить</span> и введите расположение <span class="code">ppa:</span>.</p></li>
<li class="steps"><p class="p">Щёлкните <span class="gui">Добавить источник</span>. Введите свой пароль в окне аутентификации.</p></li>
<li class="steps"><p class="p">Закройте окно источников приложений. После этого Центр приложений Ubuntu проверит ваши источники программного обеспечения на наличие обновлений.</p></li>
</ol></div>
</div></div>
</div>
...
<div class="region"><ul><li class="links ">
<a href="addremove-sources.html" title="Добавление дополнительных репозиториев программ">Добавление дополнительных репозиториев программ</a><span class="desc"> — Добавьте другие репозитории, чтобы увеличить число источников программ, используемых Ubuntu для установки и обновлений.</span>
</li></ul></div>
</div></div>
</div>
</div>
