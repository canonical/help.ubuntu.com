...
<li class="steps"><p class="p">Klikněte na ikonu <span class="app">Centrum Softwaru Ubuntu</span> v <span class="gui">Launcheru</span> nebo vyhledejte <span class="input">Centrum Softwaru</span> v <span class="gui">Dashi</span>.</p></li>
<li class="steps"><p class="p">Až se Centrum softwaru spustí, klikněte na tlačítko <span class="gui">Nainstalováno</span> v horní části aplikace.</p></li>
...
<li class="steps"><p class="p">Je možné, že budete požádání o zadání hesla. Poté, co tak učiníte, aplikace bude odstraněna.</p></li>
</ol></div></div></div>
