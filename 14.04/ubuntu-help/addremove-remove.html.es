...
<div class="region">
<div class="contents">
<p class="p">El <span class="app">Centro de software de Ubuntu</span> le ayuda a eliminar software que ya no usa.</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Pulse en el icono del <span class="app">Centro de software de Ubuntu</span> en el <span class="gui">Lanzador</span> o busque <span class="input">Centro de software</span> en el <span class="gui">Tablero</span>.</p></li>
<li class="steps"><p class="p">Cuando se abra el Centro de software pulse en el botón <span class="gui">Instalado</span> en la parte superior.</p></li>
...
<li class="steps"><p class="p">Quizá se le pida introducir su contraseña. Después de hacerlo, se desinstalará la aplicación.</p></li>
</ol></div></div></div>
