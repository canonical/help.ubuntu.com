...
<div class="region">
<div class="contents">
<p class="p">Het <span class="app">Ubuntu softwarecentrum</span> helpt u software die u niet meer gebruikt te verwijderen.</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Klik op het <span class="app">Ubuntu Software Center</span>-pictogram in de <span class="gui">Launcher</span> of zoek naar <span class="input">Softwarecentrum</span> in de <span class="gui">Dash</span>.</p></li>
<li class="steps"><p class="p">Klik wanneer het <span class="app">Softwarecentrum</span> geopend is op <span class="gui">Geïnstalleerd</span> bovenin het venster.</p></li>
...
<li class="steps"><p class="p">Er kan gevraagd worden om uw wachtwoord op te geven. Nadat u dat gedaan heeft, zal de toepassing verwijderd worden.</p></li>
</ol></div></div></div>
