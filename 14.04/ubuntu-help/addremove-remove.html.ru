...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Удаление приложения</span></h1></div>
<div class="region">
<div class="contents">
<p class="p"><span class="app">Центр приложений Ubuntu</span> поможет удалить программы, которые вам больше не нужны.</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Щёлкните значок <span class="app">Центра приложений Ubuntu</span> на <span class="gui">панели запуска</span> или поищите <span class="input">Центр приложений</span> в <span class="app">главном меню</span>.</p></li>
<li class="steps"><p class="p">Когда откроется Центр приложений, щёлкните вверху кнопку <span class="gui">Установлено</span>.</p></li>
...
<li class="steps"><p class="p">Возможно потребуется ввести ваш пароль. После ввода пароля приложение будет удалено.</p></li>
</ol></div></div></div>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Некоторые приложения зависят от других приложений, чтобы работать правильно. Если попытаться удалить приложение, требуемое другому, то будут удалены оба приложения. Перед удалением приложений нужно будет подтвердить, что это действительно необходимо.</p></div></div></div></div>
</div>
...
<div class="region"><ul><li class="links ">
<a href="addremove-install.html" title="Установка дополнительных программ">Установка дополнительных программ</a><span class="desc"> — Используйте Центр приложений Ubuntu, чтобы добавить программы и сделать Ubuntu более удобной.</span>
</li></ul></div>
</div></div>
</div>
</div>
