...
<li class="steps"><p class="p">
        Click on the <span class="app">Ubuntu Software Center</span> icon in the Launcher, or 
        search for Ubuntu Software Center in the search bar of the 
...
<li class="steps"><p class="p">
        Click <span class="gui">Add Source</span> then close the Software Sources window. 
...
<p class="p">
      ...
      Flash Plugin</span>. Software in this repository will appear in Ubuntu 
...
<p class="p">
      ...
      Software</span> tab in <span class="app">Software Sources</span>. If you see the 
...
<p class="p">
      Click <span class="gui">Add Source</span> then close the Software Sources window. Wait a 
...
<div class="region"><ul><li class="links ">
<a href="addremove-ppa.html" title="Add a Personal Package Archive (PPA)">
