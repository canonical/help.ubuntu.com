...
<li class="steps"><p class="p">Klik op het <span class="app">Ubuntu softwarecentrum</span>-pictogram in de Starter, of zoek naar softwarecentrum in de zoekbalk van de <span class="app">Snelzoeker</span>.</p></li>
<li class="steps"><p class="p">Klik nadat het Softwarecentrum geopend is op <span class="guiseq"><span class="gui">Bewerken</span> ▸ <span class="gui">Softwarebronnen…</span></span></p></li>
...
<li class="steps"><p class="p">Klik op <span class="gui">Bron toevoegen</span> en sluit daarna het venster Softwarebronnen. Ubuntu softwarecentrum zal nu uw softwarebronnen controleren op nieuwe updates.</p></li>
</ol></div>
</div></div>
</div>
...
<p class="p">De bron ‘Partners van Canonical’ bevat een aantal niet-vrije toepassingen die gratis te gebruiken zijn, maar waarvan de broncode niet gewijzigd mag worden. Het gaat hier om software zoals <span class="app">Skype</span>, <span class="app">Adobe Reader</span> en <span class="app">Adobe Flash Plugin</span>. Software uit deze bron zal te zien zijn als er naar gezocht wordt in het Ubuntu softwarecentrum, maar kan alleen geïnstalleerd worden indien deze bron is ingeschakeld.</p>
<p class="p">Om de softwarebron in te schakelen volgt u bovenstaande stappen om het tabblad <span class="gui">Overige Software</span> in <span class="app">Softwarebronnen</span> te openen. Als u de bron <span class="gui">Partners van Canonical</span> ziet staan, zorg er dan voor dat deze is aangevinkt en sluit daarna het venster Softwarebronnen. Als u hem niet ziet staan, klik dan op <span class="gui">Toevoegen</span> en voer het volgende in:</p>
<p class="p">
      <span class="code">deb http://archive.canonical.com/ubuntu trusty partner</span>
    </p>
<p class="p">Klik op <span class="gui">Bron toevoegen</span> en sluit daarna het venster Softwarebronnen. Wacht even totdat het Ubuntu softwarecentrum de broninformatie heeft gedownload.</p>
</div></div>
</div></div>
