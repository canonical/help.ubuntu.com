...
<title>¿Cómo asigno perfiles a los dispositivos?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">¿Cómo asigno perfiles a los dispositivos?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Abra <span class="guiseq"><span class="gui">Configuración del sistema</span> ▸ <span class="gui">Color</span></span>, y pulse en el dispositivo que quiere añadir al perfil.</p>
<p class="p">Pulsando <span class="gui">Añadir perfil</span> puede seleccionar un perfil existente o importar un archivo nuevo.</p>
<p class="p">Cada dispositivo puede tener varios perfiles asignados a él, pero sólo un perfil puede ser el <span class="em">predeterminado</span>. El perfil predeterminado se selecciona automáticamente cuando no hay información adicional. Un ejemplo de esto seria si un perfil se creo para el papel satinado y otro para el papel normal</p>
...
<div class="desc">Puede hacer predeterminado un perfil cambiándolo con el botón de radio.</div>
</div>
</div></div>
<p class="p">Si el hardware de calibración que está conectado el botón <span class="gui">Calibrar...</span> creará un nuevo perfil.</p>
</div>
