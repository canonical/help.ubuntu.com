...
<div class="region">
<div class="contents">
<p class="p">U kunt een doelbestand inscannen en opslaan als een niet gecomprimeerd TIFF-bestand. Daarna kunt u klikken op <span class="gui">Kalibreren...</span> in <span class="guiseq"><span class="gui">Systeeminstellingen</span> ▸ <span class="gui">Kleur</span></span> om een profiel voor het apparaat aan te maken.</p>
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents"><p class="p">Scanners zijn ongelooflijk stabiel in tijd en temperatuur en hoeven meestal niet gekalibreerd te worden.</p></div></div></div></div>
</div>
