...
<div class="trail">
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Handleiding Ubuntu-desktop"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Handleiding Ubuntu-desktop</a> » <a class="trail" href="prefs.html" title="Gebruikers- &amp; systeeminstellingen">Instellingen</a> » <a class="trail" href="color.html" title="Kleurbeheer">Kleurbeheer</a> › <a class="trail" href="color.html#calibration" title="Kalibratie">Kalibratie</a> » </div>
</div>
...
<div class="region">
<div class="contents">
<p class="p">Het kalibreren van uw scherm zou een vereiste moeten zijn als u zich bezig houdt met ontwerpen en illustreren via de computer.</p>
<p class="p">Met behulp van een colorimeter meet u nauwkeurig de verschillende kleuren die op uw scherm kunnen worden weergegeven. Via <span class="guiseq"><span class="gui">Systeeminstellingen</span> ▸ <span class="gui">Kleur</span></span> kunt u een profiel aanmaken; de assistent zal u tonen hoe u de colorimeter aansluit en welke instellingen moeten worden aangepast.</p>
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents">
<p class="p">Schermen veranderen de hele tijd - de helderheid van de achtergrondverlichting in een TFT-scherm halveert ongeveer elke 18 maanden, en wordt tevens geler naarmate deze ouder wordt. Dit betekent dat u uw scherm opnieuw dient te kalibreren wanneer het pictogram [!] in het kleurbeheerpaneel verschijnt.</p>
<p class="p">LED-schermen veranderen ook na verloop van tijd, maar in veel minder snel dan TFT's.</p>
</div></div></div></div>
</div>
