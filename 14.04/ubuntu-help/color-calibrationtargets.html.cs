...
<title>Jaké cílové typy jsou podporovány?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Jaké cílové typy jsou podporovány?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Následující cílové typy jsou podporovány:</p>
...
<p class="p">Můžete zakoupit cíle od dobře známých výrobců jako je KODAK, X-Rite a LaserSoft v mnoha internetových obchodech.</p>
<p class="p">Alternativně můžete zakoupit cíle z adresy <span class="link"><a href="http://www.targets.coloraid.de/" title="http://www.targets.coloraid.de/">Wolf Faust</a></span> za velmi příznivé ceny.</p>
</div></div></div></div>
</div>
