...
<p class="p">Dit betekent dat, als u uw kleurprofiel met anderen deelt, zij <span class="em">dicht</span> tegen kalibratie aan zitten, maar het is op zijn minst misleidend om te zeggen dat hun scherm gekalibreerd is.</p>
<p class="p">Zo zal ook het delen van een profiel dat u aangemaakt heeft onder uw eigen specifieke lichtcondities geen zin hebben, tenzij iedereen dezelfde lichtcondities heeft (geen zonlicht via ramen, zwarte muren, daglichtlampen enz.).</p>
