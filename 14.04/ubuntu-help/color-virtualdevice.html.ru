...
<title>Что такое виртуальное устройство управления цветом?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Что такое виртуальное устройство управления цветом?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Виртуальное устройство – это устройство управления цветом, которое не подсоединено к компьютеру. Примерами могут быть:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">интернет-магазин печати, куда загружают фотографии, печатают и отправляют вам;</p></li>
<li class="list"><p class="p">фотографии с цифровой камеры, сохранённые на карте памяти.</p></li>
</ul></div></div></div>
<p class="p">Для создания виртуального профиля цифрового фотоаппарата просто перетащите один из файлов изображений в диалог <span class="guiseq"><span class="gui">Параметры системы</span> ▸ <span class="gui">Цвет</span></span>. После этого можно <span class="link"><a href="color-assignprofiles.html" title="Как присвоить профили устройствам?">присвоить</a></span> ему профили так же, как и для любых других устройств, и даже выполнить его <span class="link"><a href="color-calibrate-camera.html" title="Как мне откалибровать мой фотоаппарат?">калибровку</a></span>.</p>
</div>
