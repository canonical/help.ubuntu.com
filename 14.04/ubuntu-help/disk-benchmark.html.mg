...
<li class="steps"><p class="p">Open the <span class="app">Disks</span> application from the <span class="link"><a href="unity-dash-intro.html" title="Find apps, files, music, and more with the Dash">Dash</a></span>.</p></li>
<li class="steps"><p class="p">Choose the hard disk from the <span class="gui">Disk Drives</span> list.</p></li>
...
<p class="p">Click <span class="gui">Start Benchmarking</span> to test how fast data can be read from
 the disk. <span class="link"><a href="user-admin-explain.html" title="How do administrative privileges work?">Administrative privileges</a></span> may
