...
<li class="steps"><p class="p">Open via de <span class="link"><a href="unity-dash-intro.html" title="Toepassingen, bestanden, muziek en meer zoeken met de Snelzoeker">Snelzoeker</a></span> de <span class="app">Schijven</span>-toepassing.</p></li>
<li class="steps"><p class="p">Kies de harde schijf uit de lijst met <span class="gui">schijfstations</span>.</p></li>
<li class="steps"><p class="p">Klik op de knop met het tandwiel en kies <span class="gui">Benchmark volume</span>.</p></li>
