...
<title>Preizkus hitrosti delovanja trdega diska</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Preizkus hitrosti delovanja trdega diska</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Za izmeritev hitrosti delovanja svojega trdega diska:</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Odprite program <span class="app">Diski</span> iz <span class="link"><a href="unity-dash-intro.html" title="S Pregledno ploščo najdite datoteke, programe, glasbo in več">Pregledne plošče</a></span>.</p></li>
<li class="steps"><p class="p">Izberite disk s seznama <span class="gui">Diskovni pogoni</span>.</p></li>
<li class="steps"><p class="p">Kliknite na gumb koles in izberite <span class="gui">Primerjalni preizkus pogona</span>.</p></li>
<li class="steps"><p class="p">Kliknite <span class="gui">Začni primerjalni preizkus</span> in prilagodite parametra <span class="gui">Hitrost prenosa</span> in <span class="gui">Dostopni čas</span>, kot želite.</p></li>
<li class="steps">
<p class="p">Kliknite <span class="gui">Začni primerjalni preizkus</span>, da preizkusite, kako hitro je mogoče podatke brati z diska. Morda bodo zahtevana <span class="link"><a href="user-admin-explain.html" title="Kako delujejo skrbniška dovoljenja?">Skrbniška dovoljenja</a></span>. Vnesite svoje geslo ali geslo za zahtevani skrbniški račun.</p>
