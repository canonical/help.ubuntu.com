...
<li class="steps"><p class="p">Seleccione el disco que desea comprobar en la lista <span class="gui">Dispositivos de almacenamiento</span>. La información y el estado del disco aparecerán en <span class="gui">Unidad</span>.</p></li>
<li class="steps"><p class="p"><span class="gui">Estado SMART</span> debería decir «El disco está sano».</p></li>
<li class="steps"><p class="p">Pulse en el botón de  <span class="gui">SMART Data</span> para ver más información del disco, o para realizar una autoprueba.</p></li>
</ol></div>
</div></div>
</div></div>
</div></div>
