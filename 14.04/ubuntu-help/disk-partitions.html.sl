...
<p class="p">Nosilce shrambe računalnika lahko preverite in spreminjate z diskovnimi orodji.</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Odprite <span class="gui">Pregledno ploščo</span> in zaženite program <span class="app">Diskovna orodja</span>.</p></li>
<li class="steps"><p class="p">V pladnju <span class="gui">Naprave shrambe</span> boste našli trde diske, pogone CD/DVD in druge fizične naprave. Kliknite na napravo, ki jo želite preučiti.</p></li>
<li class="steps">
<p class="p">V desnem pladnju področje <span class="gui">Nosilci</span> zagotavlja viden pregled nosilcev in razdelkov na izbrani napravi. Vsebuje tudi različna orodja za upravljanje teh nosilcev.</p>
...
<p class="p">En primerni razdelek mora vsebovati podatke, ki jih vaš računalnik uporablja za <span class="em">zagon</span>. Zato se imenuje zagonski razdelek ali nosilec. Za določitev ali je mogoče iz nosilca zagnati sistem, si oglejte <span class="gui">Zastavice razdelkov</span> v diskovnih orodjih. Zagonljiv razdelek lahko vsebujejo tudi zunanji mediji kot so pogoni USB in CD-ji.</p>
</div></div>
</div></div>
