...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="files.html" title="Files, folders &amp; search">Files</a> › <a class="trail" href="files.html#removable" title="Removable drives and external disks">Removable drives and external disks</a> » </div></div>
...
<li class="steps">
<p class="p">Locate the device in the sidebar. It should have a small
...
<p class="p">If you can't close one of the files, for example if the application
  using the file is locked up, you can right-click the file in the
  <span class="gui">Volume is busy</span> window and select <span class="gui">End Process</span>.
...
<div class="note note-warning" title="Fampilazana"><div class="inner"><div class="region"><div class="contents"><p class="p">You can also choose <span class="gui">Eject Anyway</span> to
