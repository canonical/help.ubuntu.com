...
<div class="region">
<div class="contents">
<p class="p">Veel computers hebben lezers voor SD (Secure Digital), MMC (MultiMediaCard), SmartMedia, geheugenstick, CompactFlash en andere opslagmediakaarten. Deze zouden automatisch gedetecteerd en <span class="link"><a href="disk-partitions.html" title="Volumes en partities beheren">aangekoppeld</a></span> moeten worden. Hier volgen een paar stappen voor het oplossen van het probleem als dat niet het geval is:</p>
...
<li class="steps"><p class="p">Open <span class="app">Bestanden</span> via de <span class="gui">Snelzoeker</span>. Verschijnt de ingebrachte kaart in de lijst met <span class="gui">Apparaten</span> in de linker zijbalk? Soms staat de kaart wel in de lijst, maar is hij niet aangekoppeld; klik er één keer op om hem aan te koppelen. (Als de zijbalk niet zichtbaar is, druk dan op <span class="key"><kbd>F9</kbd></span> of klik op <span class="guiseq"><span class="gui">Beeld</span> ▸ <span class="gui"> Zijbalk</span> ▸ <span class="gui"> Zijbalk tonen</span></span>.)</p></li>
<li class="steps"><p class="p">Als uw kaart niet getoond wordt in de zijbalk, klik dan op <span class="guiseq"><span class="gui">Ga naar</span> ▸ <span class="gui">Computer</span></span>. Als uw kaart op de juiste wijze is geconfigureerd, dan zou de lezer als een station te zien moeten zijn wanneer er geen kaart in zit, en de kaart zelf wanneer de kaart gekoppeld is (zie onderstaande afbeelding).</p></li>
