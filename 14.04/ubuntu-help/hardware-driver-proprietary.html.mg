...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">What are proprietary drivers?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Most of the devices (hardware) attached to your computer should function
  ...
  them can be fixed.</p>
<p class="p">Some hardware does not have open source drivers, usually because the hardware
...
<p class="p">If a proprietary driver is available for a certain device, you can install it
...
<p class="p">Many computers do not need proprietary drivers at all because the open source
  drivers fully support the hardware.</p>
<div class="note note-warning" title="Fampilazana"><div class="inner"><div class="region"><div class="contents"><p class="p">Most problems with proprietary drivers cannot be fixed by Ubuntu developers.</p></div></div></div></div>
</div>
