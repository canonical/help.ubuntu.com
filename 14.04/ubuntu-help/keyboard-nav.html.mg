...
<div class="trail">
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="a11y.html" title="Universal access">
    Universal access
...
<div class="note note-tip" title="Fikafika"><div class="inner"><div class="region"><div class="contents"><p class="p">If you cannot use a pointing device like a mouse, you can control the
...
<td>
<p class="p">Move keyboard focus between different controls. <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Tab</kbd></span></span> moves between groups of controls, such as from a sidebar
      to the main content. <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Tab</kbd></span></span> can also
      break out of a control that uses <span class="key"><kbd>Tab</kbd></span> itself, such as a text area.</p>
...
<td style="border-top-style: solid;"><p class="p">Activate a focused item such as a button, check box, or list item.</p></td>
</tr>
<tr>
...
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Shift</kbd></span>+<span class="key"><kbd>F10</kbd></span></span> or the Menu key</p></td>
...
<td style="border-top-style: solid;"><p class="p">In a tabbed interface, switch to the tab to the left or right.</p></td>
</tr>
</table></div>
</div></div>
<div class="table"><div class="inner">
...
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><a href="windows-key.html" title='What is the "Super" key?'><kbd>Super</kbd></a></span>+<span class="key"><kbd>↓</kbd></span></span></p></td>
<td style="border-top-style: solid;"><p class="p">Restore a maximized window to its original size.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Move the current window. Press <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>F7</kbd></span></span>,
    then use the arrow keys to move the window. Press <span class="key"><kbd>Enter</kbd></span> to finish
    moving the window, or <span class="key"><kbd>Esc</kbd></span> to return it to its original place.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Resize the current window. Press <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>F8</kbd></span></span>,
    then use the arrow keys to resize the window. Press <span class="key"><kbd>Enter</kbd></span> to finish
    resizing the window, or <span class="key"><kbd>Esc</kbd></span> to return it to its original size.</p></td>
</tr>
<tr>
...
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><a href="windows-key.html" title='What is the "Super" key?'><kbd>Super</kbd></a></span>+<span class="key"><kbd>↑</kbd></span></span></p></td>
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-windows-maximize.html" title="Maximize and unmaximize a window">Maximize</a></span> a window.</p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><a href="windows-key.html" title='What is the "Super" key?'><kbd>Super</kbd></a></span>+<span class="key"><kbd>←</kbd></span></span></p></td>
...
<td style="border-top-style: solid;"><p class="p">Pop up the window menu, as if you had right-clicked on the titlebar.</p></td>
</tr>
</table></div>
</div></div>
</div>
