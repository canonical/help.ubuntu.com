...
<p class="p">Para resolver esto, pulse en el icono situado en el extremo derecho de la barra de menús y seleccione <span class="gui">Configuración del sistema</span>. En la sección Hardware, elija <span class="gui">Monitores</span>. Pruebe diferentes opciones de <span class="gui">resolución</span> y seleccione la que se vea mejor en su pantalla.</p>
</div>
...
<li class="steps"><p class="p">Pulse en el icono situado en el extremo derecho de la barra de menús y seleccione <span class="gui">Configuración del sistema</span>. Abra <span class="gui">Monitores</span>.</p></li>
