...
<div class="trail">
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Handleiding Ubuntu-desktop"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Handleiding Ubuntu-desktop</a> » <a class="trail" href="prefs.html" title="Gebruikers- &amp; systeeminstellingen">Instellingen</a> » <a class="trail" href="mouse.html" title="Muis">Muis</a> › <a class="trail" href="mouse.html#problems" title="Veel voorkomende problemen">Veel voorkomende problemen</a> » </div>
</div>
...
<li class="links "><a href="mouse-problem-notmoving.html#connected" title="Controleren of de muis werd herkend door uw computer">Controleren of de muis werd herkend door uw computer</a></li>
...
<div class="hgroup"><h2 class="title"><span class="title">Controleren of de muis werd herkend door uw computer</span></h2></div>
<div class="region"><div class="contents">
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Druk <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>T</kbd></span></span> om een <span class="app">Terminal</span>venster te openen.</p></li>
<li class="steps"><p class="p">Typ in het terminalvenster <span class="cmd">xsetpointer -l | grep Pointer</span>, precies zoals hier staat, en druk op <span class="key"><kbd>Enter</kbd></span>.</p></li>
<li class="steps"><p class="p">Er zal een korte lijst met muisapparaten verschijnen. Controleer of er op zijn minst bij één van de items <span class="sys">[XExtensionPointer]</span> staat en dat links van één van de <span class="sys">[XExtensionPointer]</span>-items de naam van de muis staat.</p></li>
<li class="steps"><p class="p">Als er nergens de naam van de muis staat gevolgd door <span class="sys">[XExtensionPointer]</span>, dan werd de muis niet herkend door uw computer. Als de naam wel in de lijst staat, dan werd uw muis herkend door uw computer. In dit geval moet u controleren of de muis is <span class="link"><a href="#plugged-in" title="Controleer of de muis is aangesloten">aangesloten</a></span> en in <span class="link"><a href="#broken" title="Controleren of de muis überhaupt werkt">werkende staat</a></span>.</p></li>
</ol></div></div></div>
<p class="p">Als de muis een seriële (RS-232) connector heeft, dan moet u mogelijk wat extra stappen doorlopen om hem werkend te krijgen. De stappen kunnen afhangen van het merk en model van uw muis.</p>
<p class="p">Problemen met het detecteren van de muis oplossen kan gecompliceerd zijn. Vraag hulp bij de leverancier als u denkt dat de muis niet op de juiste manier gedetecteerd is.</p>
</div></div>
</div></div>
...
<li class="list"><p class="p">Controleer of de muis aan staat. Onderaan de muis bevindt zich vaak een schakelaar om de muis uit te schakelen, zodat u hem kunt verplaatsen zonder hem telkens te activeren.</p></li>
