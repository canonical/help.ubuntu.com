...
<a href="music-player-notrecognized.html" title="Waarom wordt mijn muziekspeler niet herkend wanneer ik hem aansluit?">Waarom wordt mijn muziekspeler niet herkend wanneer ik hem aansluit?</a><span class="desc"> — Voeg een <span class="input">.is_audio_player</span>-bestand toe om uw computer te vertellen dat het een muziekspeler is.</span>
</li></ul></div>
</div></div>
</div>
</div>
