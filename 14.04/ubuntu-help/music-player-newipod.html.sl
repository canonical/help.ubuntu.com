...
<div class="region">
<div class="contents">
<p class="p">V primeru da imate nov iPod, ki še nikoli ni bil povezan z računalnikom, ob povezavi z računalnikom Linux ne bo pravilno prepoznan. To se zgodi, ker je treba nove iPode nastaviti in posodobiti s programom <span class="app">iTunes</span>, ki deluje le na Windows ali Mac OS X.</p>
<p class="p">Za nastavitev iPoda, namestite iTunes na računalnik Windows ali Mac in ga priklopite. Vodeni boste skozi nastavitvene korake. Ko boste vprašani za <span class="gui">Obliko nosilca</span>, izberite <span class="gui">MS-DOS (FAT)</span>, <span class="gui">Windows</span> ali podobno. Druga oblika (HFS/Mac) z Linuxom ne deluje dobro.</p>
...
<a href="music-player-notrecognized.html" title="Zakaj moj predvajalnik zvoka ob vklopu ni prepoznan?">Zakaj moj predvajalnik zvoka ob vklopu ni prepoznan?</a><span class="desc"> — Dodajte datoteko <span class="input">.is_audio_player</span>, ki bo vašemu računalniku povedala, da je to predvajalnik zvoka.</span>
</li></ul></div>
</div></div>
</div>
</div>
