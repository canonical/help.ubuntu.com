...
<div class="note note-important" title="Mavesa-danja"><div class="inner"><div class="region"><div class="contents"><p class="p">A script will not be passed any parameters when executed from a remote
...
<dt class="terms"><span class="gui">Ask before emptying the Trash or deleting files</span></dt>
...
<div class="note note-warning" title="Fampilazana"><div class="inner"><div class="region"><div class="contents"><p class="p">Deleting an item using the <span class="gui">Delete</span> menu option bypasses the Trash altogether.  The item is removed from the system completely.  There is no way to recover the deleted item.</p></div></div></div></div>
</dd>
</dl></div></div></div></div>
