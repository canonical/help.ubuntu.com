...
<div class="region">
<div class="contents"><p class="p">U kunt bepalen hoe het bestandsbeheer bijschriften onder de pictogrammen weergeeft. Klik in de menubalk op <span class="gui">Bewerken</span>, kies <span class="gui">Voorkeuren</span> en ga naar het <span class="gui">Weergave</span>-tabblad.</p></div>
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="p">Als u een venster in bestandsbeheer geopend heeft, dan kan het zijn dat u het opnieuw moet laden om de wijzigingen in de pictogrambijschriften te zien. Klik op <span class="guiseq"><span class="gui">Beeld</span> ▸ <span class="gui">Herladen</span></span> of druk op <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>R</kbd></span></span>.</p></div></div></div></div>
</div></div>
</div></div>
