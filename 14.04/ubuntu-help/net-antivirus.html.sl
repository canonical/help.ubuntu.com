...
<title>Ali potrebujem protivirusni program?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Ali potrebujem protivirusni program?</span></h1></div>
<div class="region">
<div class="contents">
...
<p class="p">Za Linux obstajajo protivirusni programi, vendar pa vam jih verjetno ni treba uporabljati. Virusi, ki vplivajo na Linux, so še vedno zelo redki. Nekateri trdijo, da je to zato, ker je Linux ni tako razširjen kot drugi operacijski sistemi, zato zanj nihče ne piše virusov. Drugi trdijo, da je Linux bolj varen in da so varnostni problemi, ki bi jih lahko virusi zlorabili, popravljeni zelo hitro.</p>
<p class="p">Ne glede na razlog, so virusi za Linux tako redki, da vam trenutno glede njih ni treba skrbeti.</p>
<p class="p">V primeru da želite biti dodatno varni ali želite preveriti za obstoj virusov v datotekah, ki jih pošiljate ljudem, ki uporabljajo Windows in Mac OS, lahko še vedno namestite protivirusni program. Preverite v <span class="app">Programskem središču Ubuntu</span>, kjer so na voljo številni programi.</p>
</div>
...
<div class="region"><ul><li class="links ">
<a href="net-email-virus.html" title="Ali moram svojo e-pošto preiskati za viruse?">Ali moram svojo e-pošto preiskati za viruse?</a><span class="desc"> — Virusi zelo verjetno ne bodo okužili vašega računalnika, vendar lahko okužijo druge ljudi, ki jim pošiljate e-pošto.</span>
</li></ul></div>
</div></div>
</div>
</div>
