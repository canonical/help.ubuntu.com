...
<title>Общеизвестные сетевые порты</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Общеизвестные сетевые порты</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Этот список сетевых портов официально используется приложениями, предоставляющими сетевые услуги, такие как совместное использование файлов или удалённый просмотр рабочего стола. Можно изменить настройки вашего межсетевого экрана для <span class="link"><a href="net-firewall-on-off.html" title="Разрешение или запрет доступа с помощью межсетевого экрана">запрещения или разрешения доступа</a></span> к этим приложениям. Используются тысячи портов, так что эта таблица далеко не полная.</p>
...
<td><p class="p">Печать</p></td>
<td><p class="p">Позволяет открывать общий доступ к вашему принтеру для других пользователей в сети.</p></td>
</tr>
<tr>
<td><p class="p">5298/tcp</p></td>
<td><p class="p">Присутствие</p></td>
<td><p class="p">Позволяет объявлять ваш статус в чате другим людям в сети, например: «в сети» или «занят».</p></td>
</tr>
<tr class="shade">
<td><p class="p">5900/tcp</p></td>
<td><p class="p">Удалённый рабочий стол</p></td>
<td><p class="p">Позволяет открывать общий доступ к вашему рабочему столу, что разрешит другим пользователям просматривать его или оказывать удалённую помощь.</p></td>
</tr>
<tr>
<td><p class="p">3689/tcp</p></td>
<td><p class="p">Мультимедиа (DAAP)</p></td>
...
<div class="region"><ul><li class="links ">
<a href="net-firewall-on-off.html" title="Разрешение или запрет доступа с помощью межсетевого экрана">Разрешение или запрет доступа с помощью межсетевого экрана</a><span class="desc"> — Можно управлять доступом программ к сети. Это поможет сохранить ваш компьютер в безопасности.</span>
</li></ul></div>
</div></div>
</div>
</div>
