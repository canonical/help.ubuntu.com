...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Handleiding Ubuntu-desktop"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Handleiding Ubuntu-desktop</a> » <a class="trail" href="net.html" title="Netwerken, web, e-mail &amp; chatten">Netwerken, web, e-mail &amp; chatten</a> » <a class="trail" href="net-general.html" title="Netwerktermen &amp; -tips">Netwerktermen &amp; -tips</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Wat is een MAC-adres?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Een <span class="em">MAC-adres</span> is een uniek identificatienummer dat door de fabrikant is toegekend aan een hardwareonderdeel (zoals een draadloze kaart of een ethernetkaart). MAC staat voor <span class="em">Media Access Control</span>, en het is de bedoeling dat elk identificatienummer uniek is voor een bepaald apparaat.</p>
...
<li class="steps"><p class="p">Klik op het <span class="gui">netwerkmenu</span> in de menubalk.</p></li>
<li class="steps"><p class="p">Kies <span class="gui">Verbindingsinformatie</span>.</p></li>
<li class="steps"><p class="p">Uw MAC-adres zal weergegeven worden als <span class="gui">Hardware-adres</span>.</p></li>
</ol></div></div></div>
<p class="p">In de praktijk kan het zijn dat het <span class="link"><a href="net-wireless-edit-connection.html" title="Een draadloze verbinding bewerken">wijzigen of ‘spoofen’ van een MAC-adres</a></span> nodig is. Zo kunnen sommige internetproviders eisen dat er een bepaald MAC-adres gebruikt wordt om toegang te krijgen tot hun dienst. Als de netwerkkaart niet meer werkt, en u deze moet verruilen voor een nieuwe kaart, dan werkt de dienst niet meer. In een dergelijk geval dient u het MAC-adres te ‘spoofen’.</p>
</div>
