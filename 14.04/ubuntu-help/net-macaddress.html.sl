...
<div class="region">
<div class="contents">
<p class="p"><span class="em">Naslov MAC</span> je edinstveno določilo, ki jo je proizvajalec dodelil omrežni strojni opremi (kot je brezžična kartica ali kartica eternet). <span class="em">MAC</span> pomeni <span class="em">Nadzor do dostopa predstavnosti</span> in vsaka koda je edinstvena za določeno napravo.</p>
...
<li class="steps"><p class="p">Kliknite na <span class="gui">omrežni meni</span> v menijski vrstici.</p></li>
<li class="steps"><p class="p">Izberite <span class="gui">Podrobnosti o povezavi</span>.</p></li>
<li class="steps"><p class="p">Vaš naslov MAC bo prikazan kot <span class="gui">Naslov strojne opreme</span>.</p></li>
</ol></div></div></div>
<p class="p">V praksi boste morda želeli  <span class="link"><a href="net-wireless-edit-connection.html" title="Urejanje brezžične povezave">spremeniti ali  "ponarediti" naslov MAC</a></span>. Na primer, nekateri ponudniki interneta lahko zahtevajo, da se za dostop do njihove storitve uporabi določeni naslov MAC. Če omrežna kartica preneha delovati in morate vstaviti novo delujočo kartico, storitev več ne bo delovala. V takih primerih boste morali ponarediti naslov MAC.</p>
</div>
