...
<p class="p">Če to ne deluje, morda težavo povzroča Upravljalnik Omrežja. Da bi videli, če je to res, pojdite v <span class="link"><a href="unity-dash-intro.html" title="S Pregledno ploščo najdite datoteke, programe, glasbo in več">Pregledno ploščo</a></span> in odprite Terminal. Vnesite <span class="cmd">nm-applet</span>, pritisnite <span class="key"><kbd>Enter</kbd></span> in preverite, če se pojavi omrežni meni. Če se ne pojavi, bi se morala v Terminalu pojaviti sporočila o napakah. Ta bi vam morala povedati kaj je šlo narobe, vendar bodo morda precej tehnična. Če se to zgodi, vprašajte za pomoč na podpornem forumu in vključite ta sporočila o napakah.</p>
</div>
