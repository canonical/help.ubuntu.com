...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="net.html" title="Networking, web, email &amp; chat">Networking, web, email &amp; chat</a> » <a class="trail" href="net-problem.html" title="Network problems">Network problems</a> » </div></div>
...
<p class="p">If this doesn't work, there could be a problem with the Network Manager. To see if this is the case, go to the <span class="link"><a href="unity-dash-intro.html" title="Find apps, files, music, and more with the Dash">Dash</a></span> and open the Terminal. Type <span class="cmd">nm-applet</span> and press <span class="key"><kbd>Enter</kbd></span> and see if the network menu appears. If it doesn't, you should see some error messages appear in the Terminal. These should tell you what is going wrong, but they may be quite technical in nature. If so, ask for help on a support forum and quote these error messages.</p>
</div>
