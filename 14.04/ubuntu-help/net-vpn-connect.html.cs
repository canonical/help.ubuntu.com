...
<p class="p">Existuje mnoho typů VPN. Může být nutné nainstalovat extra software v závislo na VPN do které se připojujete. Zjistěte si detaily od správce VPN a nainstalujte řádného <span class="em">VPN klienta</span>. Budete potřebovat povolit <span class="gui">Zobrazit technické detaily</span> v dolní části <span class="app">Centra softwaru</span>.</p>
