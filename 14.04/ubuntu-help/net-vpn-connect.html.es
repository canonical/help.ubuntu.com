...
<p class="p">Hay varios tipos distintos de VPN. Puede que tenga que instalar más software extra dependiendo del tipo de VPN a la que se esté conectando. Solicite los detalles de la conexión a quien esté al cargo de la VPN y mire qué <span class="em">cliente VPN</span> necesita usar. Luego, abra el <span class="app">Centro de software de Ubuntu</span> y busque el paquete de <span class="app">network-manager</span> que funcione con su VPN (si es que hay alguno) e instálelo. Tendrá que pulsar en el enlace <span class="gui">Mostrar elementos técnicos</span> en la parte inferior del <span class="app">Centro de software de Ubuntu</span>.</p>
