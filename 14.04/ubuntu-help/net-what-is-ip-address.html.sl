...
<div class="note note-tip" title="Namig"><div class="inner"><div class="region"><div class="contents"><p class="p">Vsak naslov IP je lahko <span class="em">dinamičen</span> ali <span class="em">statičen</span>. Dinamični naslovi IP so začasno dodeljeni vsakič, ko vaš računalnik dostopa do omrežja. Statični naslovi IP se ne spreminjajo. Dinamični naslovi IP so bolj pogosti kot statični naslovi - statični naslovi IP se uporabljajo le, ko obstajajo posebne zahteve kot je na primer skrbništvo strežnika.</p></div></div></div></div>
</div>
