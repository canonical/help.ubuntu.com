...
<div class="region">
<div class="contents">
<p class="p">Ваш компьютер можно использовать как беспроводную точку доступа. Это позволит другим устройствам подключаться к нему без использования отдельной сети, а также позволит предоставлять ваше интернет-соединение другим интерфейсам, таким как проводная сеть или соединение через сотовую сеть.</p>
...
<li class="steps"><p class="p">Откройте <span class="gui">Сеть</span> и выберите <span class="gui">Беспроводное</span> слева.</p></li>
<li class="steps"><p class="p">Щёлкните кнопку <span class="gui">Использовать как точку подключения</span>.</p></li>
<li class="steps"><p class="p">Если соединение с беспроводной сетью уже установлено, то будет предложено отключится от этой сети. Простой беспроводной адаптер одновременно может быть либо подключённым к сети, либо образовывать одну сеть. Щёлкните <span class="gui">Создать точку подключения</span> для подтверждения.</p></li>
</ol></div></div></div>
<p class="p">Имя сети (SSID) и ключ безопасности создаются автоматически. Имя сети будет основано на имени вашего компьютера. Эта информация потребуется другим устройствам для подключения к только что созданной точке доступа.</p>
</div>
