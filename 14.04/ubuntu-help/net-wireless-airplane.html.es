...
<p class="p">Para hacer esto, pulse en el <span class="gui">menú de red</span> en la barra de menús y desmarque <span class="gui">Activar inalámbrico</span>. Esto apagará su conexión de red hasta que marque la opción de nuevo.</p>
<p class="p">Para volver a encender el inalámbrico, pulse en el <span class="gui">menú de red</span> en la barra de menús y seleccione <span class="gui">Activar inalámbrico</span> para que la opción quede señalada con una marca de verificación.</p>
<div class="note note-tip" title="Sugerencia"><div class="inner"><div class="region"><div class="contents"><p class="p">Es posible que su portátil siga emitiendo si no apaga el <span class="link"><a href="bluetooth-turn-on-off.html" title="Encender o apagar el Bluetooth">Bluetooth</a></span>.</p></div></div></div></div>
</div>
...
<div class="region"><ul><li class="links ">
<a href="bluetooth-turn-on-off.html" title="Encender o apagar el Bluetooth">Encender o apagar el Bluetooth</a><span class="desc"> — Activar o desactivar el dispositivo Bluetooth de su equipo.</span>
</li></ul></div>
</div></div>
</div>
</div>
