...
<li class="steps"><p class="p">Откройте окно Терминала, введите <span class="cmd">sudo lshw -C network</span> и нажмите <span class="key"><kbd>Enter</kbd></span>. Если выдаётся сообщение об ошибке, можно установить на ваш компьютер программу <span class="app">lshw</span>, введя в терминале <span class="cmd">sudo apt-get install lshw</span>.</p></li>
<li class="steps">
