...
<li class="steps">
<p class="p">Abra la terminal, escriba <span class="cmd">nm-tool</span> y presione <span class="key"><kbd>Intro</kbd></span>.</p>
<p class="p">Mostrará información sobre el hardware de red y el estado de la conexión. Revise la lista de información y compruebe si hay una sección relativa al adaptador de red. La información de cada dispositivo de red se separa por una fila de guiones. Si encuentra la línea <span class="code">Estado: conectado</span> en la sección del adaptador de red, significa que está funcionando y conectado a su enrutador inalámbrico.</p>
</li>
</ol></div></div></div>
...
<p class="p">Si la información proveniente de <span class="cmd">nm-tool</span> no indica que hay una conexión a la red, pulse <span class="gui">Siguiente</span> para proceder a la siguiente parte de la guía de resolución de problemas.</p>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="net-wireless-troubleshooting.html" title="Solucionador de problemas de red inalámbrica">Anterior</a><a class="nextlinks-next" href="net-wireless-troubleshooting-hardware-info.html" title="Solucionador de problemas de red inalámbrica">Siguiente</a>
</div>
