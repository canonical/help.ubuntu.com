...
<div class="trail">
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Handleiding Ubuntu-desktop"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Handleiding Ubuntu-desktop</a> » <a class="trail" href="net.html" title="Netwerken, web, e-mail &amp; chatten">Netwerken, web, e-mail &amp; chatten</a> » <a class="trail" href="net-wireless.html" title="Draadloos netwerk">Draadloos netwerk</a> » <a class="trail" href="net-wireless-troubleshooting.html" title="Probleemoplosser draadloos netwerk">Probleemoplosser draadloos netwerk</a> » </div>
<div class="trail">
...
<li class="steps"><p class="p">Klik op het <span class="gui">netwerkmenu</span> in de menubalk en controleer of <span class="gui">Draadloos netwerk inschakelen</span> aangevinkt is.</p></li>
<li class="steps">
<p class="p">Open een terminalvenster, typ <span class="cmd">nm-tool</span> in en druk daarna op <span class="key"><kbd>Enter</kbd></span>.</p>
<p class="p">Dit zal informatie tonen over uw netwerkhardware en verbindingsstatus. Zoek naar informatie in de lijst en kijk of er een sectie is over de draadloze netwerkadapter. De informatie voor elk netwerkapparaat worden gescheiden door een rij streepjes. Wanneer u de regel <span class="code">State: Connected</span> vindt in de sectie voor uw draadloze adapter, betekent dit dat deze werkt en verbonden is met uw draadloze router.</p>
</li>
</ol></div></div></div>
...
<p class="p">De informatie van <span class="cmd">nm-tool</span> gaf niet aan dat u aan een netwerk verbonden bent, klik op <span class="gui">Volgende</span> om door te gaan naar het volgende deel van problemen oplossen.</p>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="net-wireless-troubleshooting.html" title="Probleemoplosser draadloos netwerk">Vorige</a><a class="nextlinks-next" href="net-wireless-troubleshooting-hardware-info.html" title="Probleemoplosser draadloos netwerk">Volgende</a>
</div>
