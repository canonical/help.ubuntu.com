...
<li class="steps">
<p class="p">Откройте Терминал, введите <span class="cmd">nm-tool</span> и нажмите <span class="key"><kbd>Enter</kbd></span>.</p>
<p class="p">Будут показаны сведения о вашем сетевом оборудовании и состоянии подключения. Просмотрите перечень информации и найдите раздел, относящийся к беспроводному сетевому адаптеру. Информация о каждом сетевом устройстве разделена пунктиром. Если в разделе вашего беспроводного адаптера вы найдёте строку <span class="code">State: connected</span>, то это значит, что адаптер работает и подключён к вашему беспроводному маршрутизатору.</p>
</li>
</ol></div></div></div>
...
<p class="p">Если вывод команды <span class="cmd">nm-tool</span> не показал, что вы подключены к сети, щёлкните <span class="gui">Вперёд</span> для перехода к следующей части руководства по устранению неполадок.</p>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="net-wireless-troubleshooting.html" title="Диагностика беспроводных сетей">Назад</a><a class="nextlinks-next" href="net-wireless-troubleshooting-hardware-info.html" title="Диагностика беспроводных сетей">Вперёд</a>
</div>
