...
<li class="steps">
<p class="p">Odprite Terminal, vtipkajte <span class="cmd">nm-tool</span> in pritisnite <span class="key"><kbd>Enter</kbd></span>.</p>
<p class="p">To bo prikazalo podatke o vaši omrežni strojni opremi in stanju povezave. Oglejte si podatke in preverite, če obstaja odsek, ki se nanaša na brezžično kartico. Podatki za omrežne naprave so ločeni z vrstico pomišljajev. Če v odseku za brezžično kartico najdete odsek <span class="code">Stanje: povezano</span> pomeni, da deluje in da je povezana z brezžičnim usmerjevalnikom.</p>
</li>
</ol></div></div></div>
