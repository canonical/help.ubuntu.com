...
<div class="region">
<div class="contents">
<p class="p">WEP y WPA (con WPA2) son los nombres de herramientas de cifrado diferentes para proteger su conexión inalámbrica. El cifrado permite alterar la conexión de red de modo que nadie puede «escuchar» y ver qué páginas web está viendo. WEP significa <span class="em">Privacidad equivalente inalámbrica (Wired Equivalent Privacy)</span>, y WPA significa <span class="em">Acceso protegido inalámbrico (Wireless Protected Access)</span>. WPA2 es la segunda versión del estándar WPA.</p>
<p class="p">Usar <span class="em">algún</span> cifrados siempre es mejor que no usar ninguno, pero WEP es el menos seguro de estos estándares, y debería evitar su uso siempre que pueda. WPA2 es el más seguro de los tres. Si su tarjeta inalámbrica y su router soportan WPA2, este es el que debería usar al configurar su red inalámbrica.</p>
</div>
