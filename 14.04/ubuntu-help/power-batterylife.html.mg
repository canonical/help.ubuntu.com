...
<li class="list"><p class="p">Use the <span class="gui">Power</span> preferences in <span class="app">System Settings</span> to change
    ...
    power: you can <span class="link"><a href="display-dimscreen.html" title="Set screen brightness">automatically
    dim</a></span> the display after a certain time; 
    <span class="link"><a href="display-dimscreen.html" title="Set screen brightness">reduce the display brightness</a></span> (for laptops);
...
<div class="region"><div class="contents"><div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list">
<p class="p"><span class="link"><a href="display-dimscreen.html" title="Set screen brightness">Reduce the screen brightness</a></span>;
