...
<p class="p">Helaas, de slaapstand <span class="link"><a href="power-suspendfail.html" title="Waarom wordt mijn computer niet meer actief nadat ik hem in de pauzestand heb gezet?">werkt niet</a></span> in veel gevallen, hetgeen kan leiden tot gegevensverlies als u verwacht dat uw documenten en toepassingen weer zullen openen wanneer u uw computer weer aanzet. Daarom is de slaapstand standaard uitgeschakeld.</p>
</div>
...
<li class="steps">
<p class="p">Open een terminalvenster, typ <span class="cmd">sudo pm-hibernate</span> in en druk daarna op <span class="key"><kbd>Enter</kbd></span>.</p>
<p class="p">Voer uw wachtwoord in wanneer daar naar gevraagd wordt.</p>
</li>
<li class="steps">
<p class="p">Schakel de computer weer in nadat deze uitgegaan is. Werden uw toepassingen opnieuw geopend?</p>
<p class="p">Wanneer de slaapstand niet werkt, controleer dan of uw wisselgeheugenpartitie minstens even groot is als uw beschikbare RAM-geheugen.</p>
</li>
</ol></div></div></div>
</div></div>
</div></div>
...
<div class="region"><div class="contents">
<p class="p">Wanneer de slaapstand werkt, kunt u door blijven gaan met het gebruiken van de opdracht <span class="cmd">sudo pm-hibernate</span> als u uw computer in de slaapstand wilt zetten.</p>
