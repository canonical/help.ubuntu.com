...
<title>Co se stane, když uspím svůj počítač?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Co se stane, když uspím svůj počítač?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Uspání znemená že se počítač skutečně uspí. Všechny programy a soubory zůstanou otevřené, ale obrazovka a ostatní části počítače se vypnou a tím šetří energii. Ale počítač jako takový je stále zapnutý a spotřebovává malé množství energie. Můžete ho probudit stisknutím klávesy, kliknutím myši nebo stisknutím tlačítka napájení.</p>
<p class="p">Některá zařízení mají problém s <span class="link"><a href="power-suspendfail.html" title="Proč se můj počítač neprobudí po uspání do paměti?">uspáním nebo probouzením</a></span>. Je dobrý nápad si nejdříve funkčnost uspání vyzkoušet předtím, než na tuto funkci začnete spoléhat.</p>
<div class="note note-important" title="Důležité"><div class="inner">
<div class="title title-note"><h2><span class="title">Před uspáním vždy uložte rozdělanou práci</span></h2></div>
<div class="region"><div class="contents"><p class="p">Před uspáním počítače byste si měli uložit všechnu rozdělanou práci, jen pro případ, že se něco pokazí a vaše otevřené aplikace a dokumenty nebudou po probuzení počítače obnoveny.</p></div></div>
</div></div>
</div>
...
<li class="links "><a href="shell-exit.html#suspend" title="Uspávání">Uspávání</a></li>
</ul></div>
</div></div>
</div>
</div>
