...
<div class="hgroup"><h2 class="title"><span class="title">Ακύρωση εργασίας εκτύπωσης</span></h2></div>
...
<p class="p">Ως τελευταία λύση, ειδικά αν έχετε μια μεγάλη εργασία εκτύπωσης με πολλές σελίδες η οποία δεν ακυρώνεται, αφαιρέστε το χαρτί από την θήκη χαρτιού του εκτυπωτή. Ο εκτυπωτής θα αντιληφθεί την έλλειψη χαρτιού και θα σταματήσει την εκτύπωση. Μπορείτε έπειτα να δοκιμάσετε ξανά να ακυρώσετε την εργασία εκτύπωσης, ή να δοκιμάσετε να απενεργοποιήσετε και να ανοίξετε ξανά τον εκτυπωτή.</p>
<div class="note note-warning" title="Προειδοποίηση"><div class="inner"><div class="region"><div class="contents"><p class="p">Προσέξτε ώστε να μη δημιουργηθεί βλάβη στον εκτυπωτή κατά την αφαίρεση του χαρτιού. Αν παρατηρήσετε πως πρέπει να ασκήσετε αρκετά μεγάλη δύναμη στο χαρτί για να το αφαιρέσετε, τότε είναι πιθανόν καλύτερα να το αφήσετε στη θέση του.</p></div></div></div></div>
</div></div>
</div></div>
