...
<li class="steps"><p class="p">Desno kliknite na želeni privzeti tiskalnik v seznamu razpoložljivih tiskalnikov in kliknite <span class="gui">Nastavi kot privzeti</span>.</p></li>
</ol></div></div></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
<p class="p">Ko izbirate iz seznama tiskalnikov na voljo, lahko filtrirate rezultate iskanje z opredelitvijo imena ali mesta tiskalnika (na primer <span class="input">1. nadstropje</span> ali <span class="input">vhod</span>).</p>
<p class="p">Filtriranje rezultatov iskanja je na voljo samo v pogovornem oknu za dodajanje novih tiskalnikov.</p>
</div></div></div></div>
<p class="p">Ko v programu tiskate, je privzeti tiskalnik samodejno uporabljen, razen če za določen posel tiskanja izberete drug tiskalnik.</p>
</div>
