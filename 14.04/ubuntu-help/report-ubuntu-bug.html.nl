...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Een fout in Ubuntu melden</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Als u een fout in Ubuntu tegenkomt, dan kunt u een foutrapportage insturen.</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps">
<p class="p">Druk op <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>F2</kbd></span></span> en typ <span class="input">ubuntu-bug naamvanprogramma</span> in.</p>
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="p">Als u "This is not a genuine Ubuntu package" te zien krijgt, betekent dit dat de software waarover u een probleemrapport probeert in te sturen niet uit de officiële Ubuntu-softwarebron komt. In dit geval kunt u geen gebruik maken van het ingebouwde probleemrapportage-hulpmiddel van Ubuntu.</p></div></div></div></div>
...
<div class="region"><ul><li class="links ">
<a href="get-involved.html" title="Doe mee om deze handleiding te verbeteren.">Doe mee om deze handleiding te verbeteren.</a><span class="desc"> — Hoe en waar u problemen kunt rapporteren met deze hulp-onderwerpen.</span>
</li></ul></div>
</div></div>
</div>
</div>
