...
<li class="steps">
<p class="p">Pritisnite <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>F2</kbd></span></span> in vnesite <span class="input">ubuntu-bug imeprograma</span></p>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">V primeru da dobite napako "To ni pristen paket Ubuntu", to pomeni, da program, za katerega poskušate poročati hrošč, ni iz uradnih skladišč Ubuntu. V tem primeru Ubuntujevega vgrajenega orodja za poročanje hroščev ne morete uporabiti.</p></div></div></div></div>
