...
<p class="p">Abra el <span class="link"><a href="unity-launcher-intro.html" title="Use el Lanzador para iniciar aplicaciones">lanzador</a></span> y pulse en el icono del <span class="gui">selector de espacios de trabajo</span> situado cerca de la parte inferior. De manera predeterminada, Ubuntu muestra 4 espacios de trabajo, organizados en 2 filas y 2 columnas. Puede cambiar el número de espacios de trabajo:</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Cambiar el número de espacios de trabajo</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Vaya al <span class="link"><a href="unity-dash-intro.html" title="Encuentre aplicaciones, música y mucho más con el Tablero">Tablero</a></span> y abra la <span class="app">Terminal</span>.</p></li>
<li class="steps">
