...
<p class="p">Open the <span class="link"><a href="unity-launcher-intro.html" title="Use the Launcher to start applications">Launcher</a></span> and click the <span class="gui">workspace switcher</span> icon near the bottom. By default, Ubuntu shows 4 workspaces, arranged in 2 rows and 2 columns. You can change the number of workspaces:</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Change the number of workspaces</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Go to the <span class="link"><a href="unity-dash-intro.html" title="Find apps, files, music, and more with the Dash">Dash</a></span> and open the <span class="app">Terminal</span>.</p></li>
<li class="steps">
