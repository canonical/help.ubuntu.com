...
<p class="p">Open de <span class="link"><a href="unity-launcher-intro.html" title="Gebruik de starter om toepassingen te starten">starter</a></span> en klik op de <span class="gui">werkbladwisselaar</span> onderaan. Standaard toont Ubuntu vier werkbladen, gerangschikt in twee rijen en twee kolommen. U kunt het aantal werkbladen wijzigen:</p>
