...
<p class="p">Odprite <span class="link"><a href="unity-launcher-intro.html" title="Uporaba zaganjalnika za zaganjanje programov">Zaganjalnik</a></span> in kliknite na ikono <span class="gui">preklopnika oken</span> blizu dna. Privzeto Ubuntu prikaže 4 delovne površine razporejene v 2 vrstici in 2 stolpca. Število delovnih površin lahko spremenite:</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Sprememba števila delovnih površin</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Pojdite v <span class="link"><a href="unity-dash-intro.html" title="S Pregledno ploščo najdite datoteke, programe, glasbo in več">Pregledno ploščo</a></span> in odprite <span class="app">Terminal</span>.</p></li>
<li class="steps">
