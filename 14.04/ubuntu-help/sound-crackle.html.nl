...
<p class="p">Als de luidsprekers niet helemaal zijn aangesloten, of als ze in de verkeerde aansluiting zitten, dan hoort u mogelijk een zoemend geluid.</p>
</li>
<li class="list">
...
<p class="p">Sommige geluidskaarten werken niet goed op Linux-systemen omdat ze geen goede stuurprogramma's hebben. Dit probleem is moeilijker te herkennen. Zoek op het internet naar het merk en model van uw geluidskaart in combinatie met de term "Ubuntu" om te zien of anderen hetzelfde probleem hebben.</p>
<p class="p">U kunt <span class="cmd">sudo lspci -v</span> in de <span class="app">Terminal</span> uitvoeren om meer informatie te krijgen over uw geluidskaart.</p>
</li>
</ul></div></div></div>
</div>
