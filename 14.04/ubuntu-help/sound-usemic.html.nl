...
<li class="steps"><p class="p">Selecteer in het tabblad <span class="gui">Invoer</span> het apparaat in de lijst met apparaten. Als het goed is reageert de invoerniveau-indicator wanneer u spreekt.</p></li>
</ol></div>
</div></div>
</div>
