...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="unity-launcher-intro.html" title="Use the Launcher to start applications">Use the Launcher to start applications</a> › <a class="trail" href="unity-launcher-intro.html#launcher-using" title="Use the Launcher">Use the Launcher</a> » </div></div>
...
<div class="note note-tip" title="Fikafika"><div class="inner"><div class="region"><div class="contents"><p class="p">Apps that aren't currently running have translucent Launcher icon squares.
