...
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents"><p class="p">Setting your theme to <span class="link"><a href="a11y-contrast.html" title="کنٹراسٹ کو ایڈجسٹ کریں">High Contrast</a></span> will also disable the overlay scrollbars.</p></div></div></div></div>
</div></div>
</div></div>
