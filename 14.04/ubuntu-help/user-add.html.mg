...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="prefs.html" title="User &amp; system settings">Settings</a> » <a class="trail" href="user-accounts.html" title="User accounts">Users</a> › <a class="trail" href="user-accounts.html#manage" title="Manage user accounts">Accounts</a> » </div></div>
...
<p class="p">The account is initially disabled until you choose what to do about
  ...
  See <span class="link"><a href="user-goodpassword.html" title="Choose a secure password">Choose a secure password</a></span>.</p>
...
<div class="note" title="Fanamarihana"><div class="inner"><div class="region"><div class="contents"><p class="p">In the <span class="gui">User Accounts</span> window you can click the image next
