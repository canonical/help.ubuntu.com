...
<a href="../../14.04" class="trail">Ubuntu 14.04</a> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="prefs.html" title="User &amp; system settings">Settings</a> » <a class="trail" href="user-accounts.html" title="User accounts">Users</a> › <a class="trail" href="user-accounts.html#passwords" title="Passwords">Passwords</a> » </div></div>
...
<div class="contents">
<p class="p">
     It is important to choose not only <span class="link"><a href="user-goodpassword.html" title="Choose a secure password">a good
...
<div class="note note-important" title="Mavesa-danja"><div class="inner"><div class="region"><div class="contents"><p class="p">
     If you have an encrypted home directory, you will not be able to reset a
 forgotten password.
  </p></div></div></div></div>
<p class="p">
  If you simply want to change your password, see <span class="link"><a href="user-changepassword.html" title="Change your password">Change your password</a></span>.
  </p>
...
<div class="note" title="Fanamarihana"><div class="inner"><div class="region"><div class="contents"><p class="p">If you are unable to get into the Grub boot menu, and therefore cannot choose to boot into recovery mode, you can <span class="link"><a href="user-forgottenpassword.html#live-cd" title="Reset password using a Live CD or USB">use a live CD to reset your user password</a></span>.
           </p></div></div></div></div>
</li>
...
<li class="steps"><p class="p">
                      <span class="link"><a href="files-rename.html" title="Rename a file or folder">Rename</a></span> the backup "shadow.bak".
           </p></li>
</ol></div></div></div>
</li>
<li class="steps"><p class="p">
...
<div class="region"><div class="contents">
<div class="note note-warning" title="Fampilazana"><div class="inner"><div class="region"><div class="contents"><p class="p">This will delete all your saved passwords for wireless
