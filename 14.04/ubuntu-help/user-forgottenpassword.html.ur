...
<div class="note" title="Note"><div class="inner"><div class="region"><div class="contents"><p class="p">If you are unable to get into the Grub boot menu, and therefore cannot choose to boot into recovery mode, you can <span class="link"><a href="user-forgottenpassword.html#live-cd" title="Reset password using a Live CD or USB">use a live CD to reset your user password</a></span>.
           </p></div></div></div></div>
</li>
...
<div class="region"><div class="contents">
<div class="note note-warning" title="Warning"><div class="inner"><div class="region"><div class="contents"><p class="p">This will delete all your saved passwords for wireless
