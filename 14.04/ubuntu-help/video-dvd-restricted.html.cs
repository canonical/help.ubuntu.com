...
<li class="steps"><p class="p">Nainstalujte <span class="link"><a href="https://apps.ubuntu.com/cat/applications/libdvdnav4" title="https://apps.ubuntu.com/cat/applications/libdvdnav4">libdvdnav4</a></span>, <span class="link"><a href="https://apps.ubuntu.com/cat/applications/libdvdread4" title="https://apps.ubuntu.com/cat/applications/libdvdread4">libdvdread4</a></span>, <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-bad" title="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-bad">gstreamer0.10-plugins-bad</a></span> a <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-ugly" title="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-ugly">gstreamer0.10-plugins-ugly</a></span>.</p></li>
<li class="steps"><p class="p">Pokud byste chtěli přehrát šifrované DVD (viz právní poznámka výše), otevřete Dash a spusťte <span class="app">Terminál</span>.</p></li>
<li class="steps">
<p class="p">Zadejte následující příkaz a zmáčkněte <span class="key"><kbd>Enter</kbd></span>:</p>
<p class="p"><span class="code">sudo /usr/share/doc/libdvdread4/install-css.sh</span></p>
</li>
<li class="steps"><p class="p">K dokončení instalace zadejte své heslo.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
...
<a href="video-dvd.html" title="Proč nemohu přehrát DVD?">Proč nemohu přehrát DVD?</a><span class="desc"> — Je možné, že nemáte nainstalované správné kodeky, nebo je DVD pro jiný region.</span>
</li></ul></div>
</div></div>
</div>
</div>
