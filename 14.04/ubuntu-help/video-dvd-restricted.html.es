...
<li class="steps"><p class="p">Instale <span class="link"><a href="https://apps.ubuntu.com/cat/applications/libdvdnav4" title="https://apps.ubuntu.com/cat/applications/libdvdnav4">libdvdnav4</a></span>, <span class="link"><a href="https://apps.ubuntu.com/cat/applications/libdvdread4" title="https://apps.ubuntu.com/cat/applications/libdvdread4">libdvdread4</a></span>, <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-bad" title="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-bad">gstreamer0.10-plugins-bad</a></span> y <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-ugly" title="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-ugly">gstreamer0.10-plugins-ugly</a></span>.</p></li>
<li class="steps"><p class="p">Si quiere reproducir DVD cifrados (lea la nota legal anterior), abra el Tablero y lance un <span class="app">Terminal</span>.</p></li>
<li class="steps">
<p class="p">Teclee lo siguiente en la pantalla que aparecerá, seguido de la tecla <span class="key"><kbd>Intro</kbd></span>:</p>
<p class="p"><span class="code">sudo /usr/share/doc/libdvdread4/install-css.sh</span></p>
</li>
<li class="steps"><p class="p">Introduzca su contraseña para completar la instalación.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
...
<a href="video-dvd.html" title="¿Por qué no puedo reproducir DVD?">¿Por qué no puedo reproducir DVD?</a><span class="desc"> — Puede que no tenga instalados los códecs adecuados, o que el DVD sea de una región equivocada.</span>
</li></ul></div>
</div></div>
</div>
</div>
