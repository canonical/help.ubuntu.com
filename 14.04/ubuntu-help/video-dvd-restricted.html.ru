...
<li class="steps"><p class="p">Установите <span class="link"><a href="https://apps.ubuntu.com/cat/applications/libdvdnav4" title="https://apps.ubuntu.com/cat/applications/libdvdnav4">libdvdnav4</a></span>, <span class="link"><a href="https://apps.ubuntu.com/cat/applications/libdvdread4" title="https://apps.ubuntu.com/cat/applications/libdvdread4">libdvdread4</a></span>, <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-bad" title="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-bad">gstreamer0.10-plugins-bad</a></span>, и <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-ugly" title="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-ugly">gstreamer0.10-plugins-ugly</a></span>.</p></li>
<li class="steps"><p class="p">При необходимости проигрывать закодированные DVD (см. выше заметку о законности) откройте главное меню и запустите <span class="app">Терминал</span>.</p></li>
<li class="steps">
<p class="p">Введите в появившемся окне следующую команду, затем нажмите <span class="key"><kbd>Enter</kbd></span>:</p>
<p class="p"><span class="code">sudo /usr/share/doc/libdvdread4/install-css.sh</span></p>
</li>
<li class="steps"><p class="p">Введите свой пароль для завершения установки.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
