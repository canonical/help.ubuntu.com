...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Kaj naj omogočim omejene kodeke za predvajanje DVD-jev?</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Namestite <span class="link"><a href="https://apps.ubuntu.com/cat/applications/libdvdnav4" title="https://apps.ubuntu.com/cat/applications/libdvdnav4">libdvdnav4</a></span>, <span class="link"><a href="https://apps.ubuntu.com/cat/applications/libdvdread4" title="https://apps.ubuntu.com/cat/applications/libdvdread4">libdvdread4</a></span>, <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-bad" title="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-bad">gstreamer0.10-plugins-bad</a></span>, and <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-ugly" title="https://apps.ubuntu.com/cat/applications/gstreamer0.10-plugins-ugly">gstreamer0.10-plugins-ugly</a></span>.</p></li>
<li class="steps"><p class="p">V primeru da želite predvajati šifrirane DVD-je (oglejte si pravne opombe zgoraj), odprite Pregledno ploščo in zaženite <span class="app">Terminal</span>.</p></li>
<li class="steps">
<p class="p">Vpišite naslednje v zaslon, ki se pojavi, in pritisnite <span class="key"><kbd>Enter</kbd></span>.</p>
<p class="p"><span class="code">sudo /usr/share/doc/libdvdread4/install-css.sh</span></p>
</li>
<li class="steps"><p class="p">Vnesite svoje geslo za dokončanje namestitve.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
