...
<a class="nextlinks-prev" href="NTP.html" title="Time Synchronisation with NTP">Назад</a><a class="nextlinks-next" href="dm-multipath-chapter.html" title="DM-Multipath">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="DPDK.html#dpdk-references" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
