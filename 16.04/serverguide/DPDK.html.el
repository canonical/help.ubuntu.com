...
<a class="nextlinks-prev" href="NTP.html" title="Συγχρονισμός Ώρας με NTP">Προηγούμενο</a><a class="nextlinks-next" href="dm-multipath-chapter.html" title="DM-Multipath">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="DPDK.html#dpdk-prerequisites" title="Προαπαιτούμενα">Προαπαιτούμενα</a></li>
...
<li class="links"><a class="xref" href="DPDK.html#dpdk-references" title="Πόροι">Πόροι</a></li>
</ul></div>
