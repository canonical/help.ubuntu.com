...
<a class="nextlinks-prev" href="NTP.html" title="Синхронизация времени с NTP">Назад</a><a class="nextlinks-next" href="dm-multipath-chapter.html" title="Множественное связывание устройств (DM-Multipath)">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="DPDK.html#dpdk-prerequisites" title="Необходимые требования">Необходимые требования</a></li>
...
<li class="links"><a class="xref" href="DPDK.html#dpdk-support" title="Поддержка и устранение неисправностей">Поддержка и устранение неисправностей</a></li>
<li class="links"><a class="xref" href="DPDK.html#dpdk-references" title="Ресурсы">Ресурсы</a></li>
</ul></div>
