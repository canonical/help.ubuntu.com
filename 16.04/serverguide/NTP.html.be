...
<a class="nextlinks-prev" href="dhcp.html" title="Dynamic Host Configuration Protocol (DHCP)">Назад</a><a class="nextlinks-next" href="DPDK.html" title="Data Plane Development Kit">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="NTP.html#ntp-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="NTP.html#timeservers-conf" title="Настаўленьні">Настаўленьні</a></li>
...
<li class="links"><a class="xref" href="NTP.html#ntp-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
