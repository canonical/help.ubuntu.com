...
<title>Συγχρονισμός Ώρας με NTP</title>
...
<a class="nextlinks-prev" href="dhcp.html" title="Πρωτόκολλο Δυναμικής Διαμόρφωσης Κεντρικού Υπολογιστή (Dynamic Host Configuration Protocol (DHCP))">Προηγούμενο</a><a class="nextlinks-next" href="DPDK.html" title="Data Plane Development Kit">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Συγχρονισμός Ώρας με NTP</h1></div>
<div class="region">
<div class="contents">
<p class="para">Το NTP είναι ένα πρωτόκολλο TCP/IP για να συγχρονίζεται την ώρα σε ένα δίκτυο. Βασικά ο πελάτης κάνει αίτηση για την τρέχοντα ώρα από έναν διακομιστή, και τον χρησιμοποιεί για να ρυθμίσει το δικό του ρολόι.</p>
<p class="para">
...
<li class="links"><a class="xref" href="NTP.html#ntp-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="NTP.html#timeservers-conf" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
...
<li class="links"><a class="xref" href="NTP.html#ntp-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
