...
<title>Sincronizar la hora con NTP</title>
...
<a class="nextlinks-prev" href="dhcp.html" title="Dynamic Host Configuration Protocol (DHCP)">Anterior</a><a class="nextlinks-next" href="DPDK.html" title="Data Plane Development Kit">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Sincronizar la hora con NTP</h1></div>
<div class="region">
<div class="contents">
<p class="para">NTP es un protocolo TCP/IP para sincronizar la hora a través de una red. Básicamente, un cliente solicita la hora actual a un servidor, y usa la respuesta para poner en hora su propio reloj.</p>
<p class="para">
...
<p class="para">Ubuntu usa ntpdate y ntpd.</p>
</div>
...
<li class="links"><a class="xref" href="NTP.html#ntp-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="NTP.html#timeservers-conf" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="NTP.html#ntp-status" title="Ver el estado">Ver el estado</a></li>
<li class="links"><a class="xref" href="NTP.html#ntp-pps" title="PPS Support">PPS Support</a></li>
<li class="links"><a class="xref" href="NTP.html#ntp-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<div class="region"><div class="contents">
<p class="para">Para instalar ntpd, desde un terminal introduzca:</p>
...
<p class="para">Después de cambiar el archivo de configuración tiene que recargar <span class="app application">ntpd</span>:</p>
...
<div class="hgroup"><h2 class="title">Ver el estado</h2></div>
<div class="region"><div class="contents">
<p class="para">Use ntpq para ver más información:</p>
...
<li class="list itemizedlist">
  	    <p class="para">Vea la página wiki <a href="https://help.ubuntu.com/community/UbuntuTime" class="ulink" title="https://help.ubuntu.com/community/UbuntuTime">Ubuntu Time</a> para más información.</p>
      </li>
<li class="list itemizedlist">
  	    <p class="para">
