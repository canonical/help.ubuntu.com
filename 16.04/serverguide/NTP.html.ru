...
<a class="nextlinks-prev" href="dhcp.html" title="Протокол динамической настройки хостов (Dynamic Host Configuration Protocol, DHCP)">Назад</a><a class="nextlinks-next" href="DPDK.html" title="Data Plane Development Kit">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="NTP.html#timeservers-conf" title="Конфигурация">Конфигурация</a></li>
