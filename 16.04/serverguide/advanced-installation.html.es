...
<a class="nextlinks-prev" href="installing-upgrading.html" title="Actualizando">Anterior</a><a class="nextlinks-next" href="kernel-crash-dump.html" title="Kernel Crash Dump">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="advanced-installation.html#lvm" title="Gestor de volumen lógico (LVM)">Gestor de volumen lógico (LVM)</a></li>
...
<p class="para">Si elige situar la partición raíz en un array RAID, el instalador le preguntará si desea arrancar en un estado <span class="em emphasis">degradado</span>. Consulte <a class="xref" href="advanced-installation.html#raid-degraded" title="RAID degradado">RAID degradado</a> para más información.</p>
...
<p class="para">The first steps of a diskless iSCSI installation are identical
          to the <a class="xref" href="installing-from-cd.html" title="Instalación">Instalación</a> section up to "Hard drive
          layout".</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<p class="para">Again, the iSCSI installation on a normal server with one or
          many disks attached is identical to the <a class="xref" href="installing-from-cd.html" title="Instalación">Instalación</a> section until we reach the disk
