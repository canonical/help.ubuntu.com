...
<a class="nextlinks-prev" href="installing-upgrading.html" title="Обновление">Назад</a><a class="nextlinks-next" href="kernel-crash-dump.html" title="Отчёт о падении ядра">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Расширенная установка</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="advanced-installation.html#software-raid" title="Программный RAID">Программный RAID</a></li>
<li class="links"><a class="xref" href="advanced-installation.html#lvm" title="Менеджер логических томов (LVM)">Менеджер логических томов (LVM)</a></li>
...
<p class="para">Как только система загружена, вы можете как восстановить массив (смотрите <a class="xref" href="advanced-installation.html#raid-maintenance" title="Обслуживание RAID">Обслуживание RAID</a>), так и скопировать важные данные на другую машину в случае сильных повреждений устройства.</p>
</div></div>
</div></div>
...
<li class="list itemizedlist">
              <p class="para">Более подробную информацию об <span class="app application">fdisk</span> смотрите в <a href="http://manpages.ubuntu.com/manpages/xenial/en/man8/fdisk.8.html" class="ulink" title="http://manpages.ubuntu.com/manpages/xenial/en/man8/fdisk.8.html">man-странице fdisk</a>.</p>
            </li>
</ul></div></div></div>
</div></div>
</div>
...
<p class="para">The first steps of a diskless iSCSI installation are identical
          to the <a class="xref" href="installing-from-cd.html" title="Установка">Установка</a> section up to "Hard drive
          layout".</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<p class="para">Again, the iSCSI installation on a normal server with one or
          many disks attached is identical to the <a class="xref" href="installing-from-cd.html" title="Установка">Установка</a> section until we reach the disk
