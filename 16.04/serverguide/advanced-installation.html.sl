...
<a href="../../16.04" class="trail">Ubuntu 16.04</a> » <a class="trail" href="index.html" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="installation.html" title="Namestitev">Namestitev</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="installing-upgrading.html" title="Nadgrajevanje">Nazaj</a><a class="nextlinks-next" href="kernel-crash-dump.html" title="Kernel Crash Dump">Naprej</a>
</div>
...
<p class="para">
           Once the system has booted you can either repair the array see <a class="xref" href="advanced-installation.html#raid-maintenance" title="Vzdrževanje polja RAID">Vzdrževanje polja RAID</a> for details, or copy 
...
<p class="para">The first steps of a diskless iSCSI installation are identical
          to the <a class="xref" href="installing-from-cd.html" title="Namestitev">Namestitev</a> section up to "Hard drive
          layout".</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<p class="para">Again, the iSCSI installation on a normal server with one or
          many disks attached is identical to the <a class="xref" href="installing-from-cd.html" title="Namestitev">Namestitev</a> section until we reach the disk
