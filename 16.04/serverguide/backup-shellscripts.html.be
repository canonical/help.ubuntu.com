...
<a class="nextlinks-prev" href="backups.html" title="Backups">Назад</a><a class="nextlinks-next" href="backups-shellscripts-rotation.html" title="Archive Rotation">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="backup-shellscripts.html#backup-shellscript-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<p class="para">
      ...
      See <a class="xref" href="backup-shellscripts.html#backup-shellscript-references" title="Спасылкі">Спасылкі</a> for links to resources providing more in-depth shell scripting information.
      </p>
</div></div>
</div></div>
...
<p class="para">
        For more in-depth <span class="app application">crontab</span> options see <a class="xref" href="backup-shellscripts.html#backup-shellscript-references" title="Спасылкі">Спасылкі</a>.
        </p>
</div></div>
</div></div>
</div>
