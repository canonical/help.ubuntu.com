...
<a class="nextlinks-prev" href="backup-shellscripts.html" title="Shell Scripts">Vorige</a><a class="nextlinks-next" href="bacula.html" title="Bacula">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html#backup-shellscript-tapedrive" title="Tapestations">Tapestations</a></li>
</ul></div>
...
<p class="para">Het script kan op dezelfde manier worden uitgevoerd als in <a class="xref" href="backup-shellscripts.html#backup-executing-shellscript" title="Executing the Script">Executing the Script</a>.</p>
<p class="para"> 
