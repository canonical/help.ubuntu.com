...
<a class="nextlinks-prev" href="backup-shellscripts.html" title="Shell Scripts">Nazaj</a><a class="nextlinks-next" href="bacula.html" title="Bacula">Naprej</a>
</div>
...
<p class="para">
      The script can be executed using the same methods as in <a class="xref" href="backup-shellscripts.html#backup-executing-shellscript" title="Izvajanje skripta">Izvajanje skripta</a>.
      </p>
<p class="para"> 
