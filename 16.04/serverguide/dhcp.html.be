...
<a class="nextlinks-prev" href="tcpip.html" title="TCP/IP">Назад</a><a class="nextlinks-next" href="NTP.html" title="Time Synchronisation with NTP">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="dhcp.html#dhcp-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="dhcp.html#dhcp-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="dhcp.html#dhcp-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
