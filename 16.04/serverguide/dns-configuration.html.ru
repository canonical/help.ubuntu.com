...
<a class="nextlinks-prev" href="dns-installation.html" title="Установка">Назад</a><a class="nextlinks-next" href="dns-troubleshooting.html" title="Устранение проблем">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="dns-configuration.html#dns-configuration-overview" title="Обзор">Обзор</a></li>
<li class="links"><a class="xref" href="dns-configuration.html#dns-caching-configuration" title="Кэширующий сервер имён">Кэширующий сервер имён</a></li>
<li class="links"><a class="xref" href="dns-configuration.html#dns-primarymaster-configuration" title="Первичный мастер">Первичный мастер</a></li>
<li class="links"><a class="xref" href="dns-configuration.html#dns-secondarymaster-configuration" title="Вторичный мастер">Вторичный мастер</a></li>
</ul></div>
...
<p class="para">Смотрите <a class="xref" href="dns-troubleshooting.html#dns-testing-dig" title="dig">dig</a> для информации по тестированию кэширующего DNS-сервера.</p>
</div></div>
</div></div>
...
<p class="para">Теперь вы можете добавлять DNS записи в конец файла зоны. Смотрите подробности в разделе <a class="xref" href="dns-references.html#dns-record-types" title="Общие типы записей">Общие типы записей</a>.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
