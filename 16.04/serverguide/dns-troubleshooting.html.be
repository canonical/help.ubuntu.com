...
<a class="nextlinks-prev" href="dns-configuration.html" title="Настаўленьні">Назад</a><a class="nextlinks-next" href="dns-references.html" title="Спасылкі">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="dns-troubleshooting.html#dns-testing" title="Праверка">Праверка</a></li>
...
<div class="screen"><pre class="contents "><span class="cmd command">cat /etc/apparmor.d/usr.sbin.named | sudo apparmor_parser -r</span>
	      ...
	      <p class="para">Каб пабачыць боль зьвестак па <span class="app application">AppArmor</span> глядзіце <a class="xref" href="apparmor.html" title="AppArmor">AppArmor</a></p>
	    </li>
<li class="list itemizedlist">
...
<p class="para">
	  ...
	  <span class="app application">BIND9</span> logging options.  For coverage of advanced options see <a class="xref" href="dns-references.html#dns-more-info" title="Больш зьвестак">Больш зьвестак</a>.
	  </p>
</div></div>
</div></div>
</div>
