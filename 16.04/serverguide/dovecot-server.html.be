...
<a href="../../16.04" class="trail">Ubuntu 16.04</a> » <a class="trail" href="index.html" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="email-services.html" title="Email Services">Email Services</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="exim4.html" title="Exim4">Назад</a><a class="nextlinks-next" href="mailman.html" title="Mailman">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Сэрвер Dovecot</h1></div>
<div class="region">
...
<li class="links"><a class="xref" href="dovecot-server.html#dovecot-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="dovecot-server.html#dovecot-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="dovecot-server.html#dovecot-ssl" title="Наладкі Dovecot SSL">Наладкі Dovecot SSL</a></li>
<li class="links"><a class="xref" href="dovecot-server.html" title="Наладкі брандмаўэра для сэрвера Email">Наладкі брандмаўэра для сэрвера Email</a></li>
<li class="links"><a class="xref" href="dovecot-server.html#dovecot-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
<div class="sect2 sect" id="dovecot-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Усталёўка</h2></div>
<div class="region"><div class="contents">
<p class="para">Каб устанавіць <span class="app application">dovecot</span>, увядзіце наступнае ў загадны радок:</p>
...
<p class="para">
            ...
            <span class="file filename">/etc/dovecot/dovecot.conf</span>. You can
            choose the protocol you use. It could be pop3, pop3s (pop3
            secure), imap and imaps (imap secure). A description of these protocols is beyond the scope of this guide. For further information, refer to the Wikipedia articles on <a href="http://en.wikipedia.org/wiki/POP3" class="ulink" title="http://en.wikipedia.org/wiki/POP3">POP3</a> and
            <a href="http://en.wikipedia.org/wiki/Internet_Message_Access_Protocol" class="ulink" title="http://en.wikipedia.org/wiki/Internet_Message_Access_Protocol">IMAP</a>.
            </p>
<p class="para">
            ...
            <span class="file filename">/etc/dovecot/dovecot.conf</span>:
	    </p>
...
<div class="code"><pre class="contents ">mail_location = maildir:~/Maildir # (для maildir)
or
...
<div class="hgroup"><h2 class="title">Наладкі Dovecot SSL</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
	  ...
	  Please
          refer to <a class="xref" href="certificates-and-security.html" title="Certificates">Certificates</a>
...
<div class="hgroup"><h2 class="title">Наладкі брандмаўэра для сэрвера Email</h2></div>
...
<li class="list itemizedlist">
              <p class="para">Глядзіце <a href="http://www.dovecot.org/" class="ulink" title="http://www.dovecot.org/">вэб-старонку Dovecot</a> для больш зьмястоўнай інфармацыі.</p>
            </li>
<li class="list itemizedlist">
              <p class="para">
