...
<a class="nextlinks-prev" href="console-security.html" title="Console Security">Назад</a><a class="nextlinks-next" href="apparmor.html" title="AppArmor">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Брандмаўэр</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="firewall.html#firewall-introduction" title="Уводзіны">Уводзіны</a></li>
...
<li class="links"><a class="xref" href="firewall.html#other-firewall-tools" title="Іншыя прылады">Іншыя прылады</a></li>
<li class="links"><a class="xref" href="firewall.html#firewall-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<div class="list itemizedlist"><ul class="list itemizedlist"><li class="list itemizedlist">
		<p class="para">
		<a href="http://www.fwbuilder.org/" class="ulink" title="http://www.fwbuilder.org/">fwbuilder</a> is very powerful and will look familiar 
	        to an administrator who has used a commercial firewall utility such as <span class="app application">Checkpoint FireWall-1</span>.  
		</p>
	      </li></ul></div>
<p class="para">
