...
<a href="../../16.04" class="trail">Ubuntu 16.04</a> » <a class="trail" href="index.html" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="file-servers.html" title="Εξυπηρετητές αρχείων">Εξυπηρετητές αρχείων</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="file-servers.html" title="Εξυπηρετητές αρχείων">Προηγούμενο</a><a class="nextlinks-next" href="network-file-system.html" title="Σύστημα Αρχείων Δικτύου (NFS)">Επόμενο</a>
</div>
...
<p class="para">
          ...
          the section on <span class="app application">OpenSSH</span> in <a class="xref" href="remote-administration.html" title="Απομακρυσμένη Διαχείριση">Απομακρυσμένη Διαχείριση</a> instead.
          </p>
<p class="para">
...
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-ftp-server-installation" title="vsftpd - Εγκατάσταση εξυπηρετητή FTP">vsftpd - Εγκατάσταση εξυπηρετητή FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-anonymous-configuration" title="Ρύθμιση ανώνυμου FTP">Ρύθμιση ανώνυμου FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-userauth-configuration" title="Ρύθμιση FTP με πιστοποίηση χρηστών">Ρύθμιση FTP με πιστοποίηση χρηστών</a></li>
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-security" title="Ασφάλιση του FTP">Ασφάλιση του FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html#vsftpd-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<p class="para">
                  ...
                  host.  For more information on certificates see <a class="xref" href="certificates-and-security.html" title="Πιστοποιητικά">Πιστοποιητικά</a>.
                  </p>
