...
<li class="list itemizedlist">
                      <p class="para">Подробнее о параметрах <span class="file filename">/etc/vsftpd.conf</span> смотрите в <a href="http://manpages.ubuntu.com/manpages/xenial/en/man5/vsftpd.conf.5.html" class="ulink" title="http://manpages.ubuntu.com/manpages/xenial/en/man5/vsftpd.conf.5.html">man-странице vsftpd.conf</a>.</p>
                    </li>
</ul></div></div></div>
</div></div>
</div>
