...
<a class="nextlinks-prev" href="bazaar.html" title="Bazaar">Назад</a><a class="nextlinks-next" href="subversion.html" title="Subversion">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="git.html#git-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="git.html#git-configuration" title="Настаўленьні">Настаўленьні</a></li>
...
<p class="para">
        ...
        If you have not yet configured an SSH key, refer to <a class="xref" href="openssh-server.html#openssh-keys" title="Ключы SSH">Ключы SSH</a>
        </p>
