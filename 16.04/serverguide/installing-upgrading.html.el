...
<a class="nextlinks-prev" href="installing-from-cd.html" title="Εγκατάσταση">Προηγούμενο</a><a class="nextlinks-next" href="advanced-installation.html" title="Εγκατάσταση για προχωρημένους">Επόμενο</a>
</div>
