...
<a class="nextlinks-prev" href="chat-overview.html" title="Overview">Předchozí</a><a class="nextlinks-next" href="jabberd2-server.html" title="Jabber Instant Messaging Server">Následující</a>
</div>
...
<li class="links"><a class="xref" href="irc-server.html#irc-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="irc-server.html#irc-configuration" title="Nastavení">Nastavení</a></li>
