...
<a class="nextlinks-prev" href="network-file-system.html" title="Σύστημα Αρχείων Δικτύου (NFS)">Προηγούμενο</a><a class="nextlinks-next" href="cups.html" title="CUPS - Εξυπηρετητής εκτυπώσεων">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html#iscsi-initiator-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
