...
<a class="nextlinks-prev" href="network-file-system.html" title="Network File System (NFS)">Anterior</a><a class="nextlinks-next" href="cups.html" title="CUPS - Servidor de impresión">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html#iscsi-initiator-references" title="Referencias">Referencias</a></li>
</ul></div>
