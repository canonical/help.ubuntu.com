...
<a class="nextlinks-prev" href="kerberos.html" title="Kerberos">Назад</a><a class="nextlinks-next" href="sssd-ad.html" title="SSSD and Active Directory">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-openldap" title="Наладка OpenLDAP">Наладка OpenLDAP</a></li>
...
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">
      ...
      configured between at least two servers.  For information on setting up OpenLDAP see <a class="xref" href="openldap-server.html" title="Сэрвер OpenLDAP">Сэрвер OpenLDAP</a>.
      </p>
<p class="para">
