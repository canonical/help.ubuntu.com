...
<a class="nextlinks-prev" href="kerberos.html" title="Kerberos">Προηγούμενο</a><a class="nextlinks-next" href="sssd-ad.html" title="SSSD and Active Directory">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-openldap" title="Ρύθμιση του OpenLDAP">Ρύθμιση του OpenLDAP</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-primary-kdc" title="Ρύθμιση πρωτεύοντος KDC">Ρύθμιση πρωτεύοντος KDC</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-secondary-kdc" title="Ρύθμιση δευτερεύοντος KDC">Ρύθμιση δευτερεύοντος KDC</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html#kerberos-ldap-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
