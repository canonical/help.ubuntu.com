...
<a class="nextlinks-prev" href="advanced-installation.html" title="Advanced Installation">Назад</a><a class="nextlinks-next" href="package-management.html" title="Кіраваньне пакетамі">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kernel-dump-introduction" title="Уводзіны">Уводзіны</a></li>
...
<li class="links"><a class="xref" href="kernel-crash-dump.html#Installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kernel-dump-configuration" title="Настаўленьні">Настаўленьні</a></li>
...
<li class="links"><a class="xref" href="kernel-crash-dump.html#kdump-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
