...
<a class="nextlinks-prev" href="advanced-installation.html" title="Εγκατάσταση για προχωρημένους">Προηγούμενο</a><a class="nextlinks-next" href="package-management.html" title="Διαχείριση Πακέτων">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kernel-dump-introduction" title="Εισαγωγή">Εισαγωγή</a></li>
...
<li class="links"><a class="xref" href="kernel-crash-dump.html#Installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kernel-dump-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#verification" title="Έλεγχος">Έλεγχος</a></li>
...
<li class="links"><a class="xref" href="kernel-crash-dump.html#kdump-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
