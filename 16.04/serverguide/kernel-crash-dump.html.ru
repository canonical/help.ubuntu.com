...
<a href="../../16.04" class="trail">Ubuntu 16.04</a> » <a class="trail" href="index.html" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="installation.html" title="Установка">Установка</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="advanced-installation.html" title="Расширенная установка">Назад</a><a class="nextlinks-next" href="package-management.html" title="Управление пакетами">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Отчёт о падении ядра</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kernel-dump-introduction" title="Введение">Введение</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kernel-crash-dump-mechanisms" title="Механизм отчёта о падении ядра">Механизм отчёта о падении ядра</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#Installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kernel-dump-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#verification" title="Проверка">Проверка</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kdump-testing" title="Проверка механизма отчёта о падении ядра">Проверка механизма отчёта о падении ядра</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html#kdump-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<p class="para">Если возвращается значение <span class="em emphasis">0</span>, свойство отключено. Включите его следующей командой:</p>
...
<p class="para">Дальнейший вывод отрезан, но вы можете посмотреть перезагрузку системы и где-нибудь в журнале вы сможете найти следующую строчку: <div class="screen"><pre class="contents ">Begin: Saving vmcore from kernel crash ...</pre></div> После завершения система перезагрузится в нормальный рабочий режим. После чего вы сможете найти файл отчёта о падении ядра в каталоге <span class="file filename">/var/crash</span>:</p>
