...
<a class="nextlinks-prev" href="virtualization.html" title="Виртуализация">Назад</a><a class="nextlinks-next" href="qemu.html" title="Qemu">Вперёд</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo virt-install -n web_devel -r 256 \ --disk path=/var/lib/libvirt/images/web_devel.img,bus=virtio,size=4 -c \ ubuntu-16.04-server-i386.iso --network network=default,model=virtio \ --graphics vnc,listen=0.0.0.0 --noautoconsole -v</span>
</pre></div>
