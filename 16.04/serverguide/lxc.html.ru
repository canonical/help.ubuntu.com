...
<a class="nextlinks-prev" href="lxd.html" title="LXD">Назад</a><a class="nextlinks-next" href="cgroups.html" title="Группы управления">Вперёд</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo lxc-create -t download -n u1 -- --dist ubuntu --release xenial --arch amd64</span>
или
<span class="cmd command">sudo lxc-create -t download -n u1 -- -d ubuntu -r xenial -a amd64</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc-create -t download -n u1 -- -d ubuntu -r xenial -a amd64 lxc-start -n u1 -d lxc-attach -n u1 lxc-stop -n u1 lxc-destroy -n u1</span>
</pre></div>
</div></div>
</div></div>
