...
<a class="nextlinks-prev" href="ubuntucloud.html" title="Облако Ubuntu">Назад</a><a class="nextlinks-next" href="lxc.html" title="LXC">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="lxd.html#lxd-resources" title="Интернет-ресурсы">Интернет-ресурсы</a></li>
<li class="links"><a class="xref" href="lxd.html#lxd-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="lxd.html#lxd-kernel-prep" title="Подготовка ядра">Подготовка ядра</a></li>
<li class="links"><a class="xref" href="lxd.html#lxd-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="lxd.html#lxd-first-container" title="Создание вашего первого контейнера">Создание вашего первого контейнера</a></li>
...
<li class="links"><a class="xref" href="lxd.html#lxd-profiles" title="Профили">Профили</a></li>
<li class="links"><a class="xref" href="lxd.html#lxd-nesting" title="Вложенность">Вложенность</a></li>
...
<li class="links"><a class="xref" href="lxd.html" title="Образы и контейнеры">Образы и контейнеры</a></li>
<li class="links"><a class="xref" href="lxd.html#lxd-troubleshooting" title="Устранение проблем">Устранение проблем</a></li>
</ul></div>
