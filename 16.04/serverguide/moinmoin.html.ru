...
<a class="nextlinks-prev" href="lamp-overview.html" title="Обзор">Назад</a><a class="nextlinks-next" href="phpmyadmin.html" title="phpMyAdmin">Вперёд</a>
</div>
...
<p class="para">Нужно также установить веб-сервер <span class="app application">apache2</span>. За сведениями об установке <span class="app application">apache2</span> обратитесь к подразделу <a class="xref" href="httpd.html#http-installation" title="Установка">Установка</a> раздела <a class="xref" href="httpd.html" title="HTTPD - веб сервер Apache2">HTTPD - веб сервер Apache2</a>.</p>
</div></div>
</div></div>
