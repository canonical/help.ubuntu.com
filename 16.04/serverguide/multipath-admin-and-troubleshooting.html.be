...
<a class="nextlinks-prev" href="multipath-dm-multipath-config-file.html" title="The DM-Multipath Configuration File">Назад</a><a class="nextlinks-next" href="remote-administration.html" title="Remote Administration">Наперад</a>
</div>
