...
<a class="nextlinks-prev" href="multipath-devices.html" title="Multipath Devices">Назад</a><a class="nextlinks-next" href="multipath-dm-multipath-config-file.html" title="The DM-Multipath Configuration File">Наперад</a>
</div>
