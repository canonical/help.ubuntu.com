...
<a class="nextlinks-prev" href="multipath-devices.html" title="Dispositivos multiruta">Anterior</a><a class="nextlinks-next" href="multipath-dm-multipath-config-file.html" title="The DM-Multipath Configuration File">Siguiente</a>
</div>
