...
<a class="nextlinks-prev" href="databases.html" title="Βάσεις δεδομένων">Προηγούμενο</a><a class="nextlinks-next" href="postgresql.html" title="PostgreSQL">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="mysql.html#mysql-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="mysql.html#mysql-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
...
<li class="links"><a class="xref" href="mysql.html#mysql-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
