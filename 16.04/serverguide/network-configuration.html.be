...
<a class="nextlinks-prev" href="networking.html" title="Сеціва">Назад</a><a class="nextlinks-next" href="tcpip.html" title="TCP/IP">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="network-configuration.html#network-config-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
