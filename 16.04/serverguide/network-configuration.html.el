...
<a class="nextlinks-prev" href="networking.html" title="Δικτύωση">Προηγούμενο</a><a class="nextlinks-next" href="tcpip.html" title="TCP/IP">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="network-configuration.html#bridging" title="Γεφύρωση">Γεφύρωση</a></li>
<li class="links"><a class="xref" href="network-configuration.html#network-config-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
