...
<a class="nextlinks-prev" href="network-authentication.html" title="Network Authentication">Předchozí</a><a class="nextlinks-next" href="samba-ldap.html" title="Samba and LDAP">Následující</a>
</div>
...
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-installation" title="Instalace">Instalace</a></li>
...
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html#openldap-server-installation" title="Instalace">Instalace</a>. Make sure the slapd-config
