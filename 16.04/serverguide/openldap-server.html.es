...
<a href="../../16.04" class="trail">Ubuntu 16.04</a> » <a class="trail" href="index.html" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="network-authentication.html" title="Autentificación de redes">Autentificación de redes</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="network-authentication.html" title="Autentificación de redes">Anterior</a><a class="nextlinks-next" href="samba-ldap.html" title="Samba y LDAP">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-installation" title="Instalación">Instalación</a></li>
...
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-logging" title="Entrada">Entrada</a></li>
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-replication" title="Replicación">Replicación</a></li>
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-acl" title="Control de acceso">Control de acceso</a></li>
...
<li class="links"><a class="xref" href="openldap-server.html#openldap-auth-config" title="Autenticación LDAP">Autenticación LDAP</a></li>
<li class="links"><a class="xref" href="openldap-server.html#ldap-usergroup-management" title="Gestión de grupo y usuario">Gestión de grupo y usuario</a></li>
<li class="links"><a class="xref" href="openldap-server.html#ldap-backup" title="Respaldar y restaurar">Respaldar y restaurar</a></li>
<li class="links"><a class="xref" href="openldap-server.html#openldap-server-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html#openldap-server-installation" title="Instalación">Instalación</a>. Make sure the slapd-config
...
<p class="para">
	The assumption here is that you have set up replication between Provider and Consumer according to <a class="xref" href="openldap-server.html#openldap-server-replication" title="Replicación">Replicación</a>
...
<p class="para">
	...
	<a class="xref" href="samba-ldap.html" title="Samba y LDAP">Samba y LDAP</a> for details.
	</p>
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
