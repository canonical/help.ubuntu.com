...
<a class="nextlinks-prev" href="installation.html" title="Установка">Назад</a><a class="nextlinks-next" href="installing-from-cd.html" title="Установка">Вперёд</a>
</div>
...
<p class="para">Ubuntu 16.04 LTS Server Edition поддерживает три (3) основные архитектуры: Intel x86, AMD64 и ARM. В таблице ниже перечислены рекомендуемые спецификации оборудования. В зависимости от ваших потребностей можно обойтись и менее мощным оборудованием, но большинство пользователей рискуют остаться разочарованными, проигнорировав эти рекомендации.</p>
<div class="table">
...
<td class="td-colsep"><p class="para">256 мегабайт</p></td>
