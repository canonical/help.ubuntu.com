...
<a href="../../16.04" class="trail">Ubuntu 16.04</a> » <a class="trail" href="index.html" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="remote-administration.html" title="Απομακρυσμένη Διαχείριση">Απομακρυσμένη Διαχείριση</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="openssh-server.html" title="OpenSSH Server">Προηγούμενο</a><a class="nextlinks-next" href="zentyal.html" title="Zentyal">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="puppet.html#puppet-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="puppet.html#puppet-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="puppet.html#puppet-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">
      ...
      <span class="em emphasis">Puppet Master</span>.  See <a class="xref" href="dns.html" title="Υπηρεσία ονομάτων τομέα (DNS)">Υπηρεσία ονομάτων τομέα (DNS)</a> for more DNS details.
      </p>
<p class="para">
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
        ...
        benefits.  For more information see <a class="xref" href="puppet.html#puppet-resources" title="Πόροι">Πόροι</a>.
        </p>
      </div></div></div></div>
</div></div>
</div></div>
