...
<a class="nextlinks-prev" href="openldap-server.html" title="Сэрвер OpenLDAP">Назад</a><a class="nextlinks-next" href="kerberos.html" title="Kerberos">Наперад</a>
</div>
...
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html" title="Сэрвер OpenLDAP">Сэрвер OpenLDAP</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-samba-configuration" title="Наладкі Samba">Наладкі Samba</a></li>
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
