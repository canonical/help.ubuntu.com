...
<a class="nextlinks-prev" href="openldap-server.html" title="Εξυπηρετητής OpenLDAP">Προηγούμενο</a><a class="nextlinks-next" href="kerberos.html" title="Kerberos">Επόμενο</a>
</div>
...
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html" title="Εξυπηρετητής OpenLDAP">Εξυπηρετητής OpenLDAP</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-samba-configuration" title="Ρύθμιση Samba">Ρύθμιση Samba</a></li>
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">
	...
	can be found in the <a class="xref" href="openldap-server.html#openldap-auth-config" title="Πιστοποίηση LDAP">Πιστοποίηση LDAP</a> section, but we only need the NSS part.
	</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
