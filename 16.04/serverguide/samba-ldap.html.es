...
<a class="nextlinks-prev" href="openldap-server.html" title="Servidor OpenLDAP">Anterior</a><a class="nextlinks-next" href="kerberos.html" title="Kerberos">Siguiente</a>
</div>
...
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html" title="Servidor OpenLDAP">Servidor OpenLDAP</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-installation" title="Instalación de software">Instalación de software</a></li>
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-openldap-configuration" title="Configuración LDAP">Configuración LDAP</a></li>
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-samba-configuration" title="Configuración Samba">Configuración Samba</a></li>
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para">
	...
	can be found in the <a class="xref" href="openldap-server.html#openldap-auth-config" title="Autenticación LDAP">Autenticación LDAP</a> section, but we only need the NSS part.
	</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
