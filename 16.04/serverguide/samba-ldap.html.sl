...
<a class="nextlinks-prev" href="openldap-server.html" title="Strežnik OpenLDAP">Nazaj</a><a class="nextlinks-next" href="kerberos.html" title="Kerberos">Naprej</a>
</div>
...
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html" title="Strežnik OpenLDAP">Strežnik OpenLDAP</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-samba-configuration" title="Nastavljanje Sambe">Nastavljanje Sambe</a></li>
<li class="links"><a class="xref" href="samba-ldap.html#samba-ldap-resources" title="Viri">Viri</a></li>
</ul></div>
...
<p class="para">
	...
	can be found in the <a class="xref" href="openldap-server.html#openldap-auth-config" title="Overitev LDAP">Overitev LDAP</a> section, but we only need the NSS part.
	</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
