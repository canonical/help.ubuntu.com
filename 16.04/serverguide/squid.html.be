...
<a class="nextlinks-prev" href="php.html" title="PHP - Scripting Language">Назад</a><a class="nextlinks-next" href="ruby-on-rails.html" title="Ruby on Rails">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="squid.html#squid-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="squid.html#squid-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="squid.html#squid-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
