...
<a class="nextlinks-prev" href="kerberos-ldap.html" title="Kerberos і LDAP">Назад</a><a class="nextlinks-next" href="dns.html" title="Domain Name Service (DNS)">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="sssd-ad.html#sssd-ad-samba" title="Наладкі Samba">Наладкі Samba</a></li>
...
<li class="links"><a class="xref" href="sssd-ad.html#sssd-ad-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
