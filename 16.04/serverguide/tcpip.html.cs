...
<a class="nextlinks-prev" href="network-configuration.html" title="Network Configuration">Předchozí</a><a class="nextlinks-next" href="dhcp.html" title="Dynamic Host Configuration Protocol (DHCP)">Následující</a>
</div>
...
<li class="links"><a class="xref" href="tcpip.html#tcpip-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
