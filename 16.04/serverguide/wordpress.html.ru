...
<a class="nextlinks-prev" href="phpmyadmin.html" title="phpMyAdmin">Назад</a><a class="nextlinks-next" href="file-servers.html" title="Файл-серверы">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="wordpress.html#wordpress-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="wordpress.html#wordpress-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="wordpress.html#wordpress-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<p class="para">Следует также установить веб-сервер <span class="app application">apache2</span> и сервер <span class="app application">mysql</span>. Для установки веб-сервера <span class="app application">apache2</span> обратитесь к подразделу <a class="xref" href="httpd.html#http-installation" title="Установка">Установка</a> раздела <a class="xref" href="httpd.html" title="HTTPD - веб сервер Apache2">HTTPD - веб сервер Apache2</a>. Для установки сервера <span class="app application">mysql</span> обратитесь к подразделу <a class="xref" href="mysql.html#mysql-installation" title="Установка">Установка</a> раздела <a class="xref" href="mysql.html" title="MySQL">MySQL</a>.</p>
</div></div>
</div></div>
