...
<a class="nextlinks-prev" href="puppet.html" title="Puppet">Προηγούμενο</a><a class="nextlinks-next" href="network-authentication.html" title="Πιστοποίηση δικτύου">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="zentyal.html#zentyal-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
...
<li class="links"><a class="xref" href="zentyal.html#zentyal-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
