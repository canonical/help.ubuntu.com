...
<div class="region"><ul><li class="links ">
<a href="addremove-install.html" title="Instalar software adicional">Instalar software adicional</a><span class="desc"> — Use <span class="app">Ubuntu Software</span> para añadir programas y hacer Ubuntu mas utilizable</span>
</li></ul></div>
</div></div>
</div>
</div>
