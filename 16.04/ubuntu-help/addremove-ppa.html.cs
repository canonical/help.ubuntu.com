...
<div class="region">
<div class="contents">
<p class="p"><span class="em">Personal Package Archives (PPA)</span> jsou zdroje softwaru určené pro uživatele Ubuntu, spravují a přidávají se snáze nž jiná zdroje softwaru třetích stran.</p>
...
<li class="steps"><p class="p">Kliněte na <span class="gui">Přidat</span> a zadejte umístění <span class="code">ppa:</span>.</p></li>
...
<div class="region"><ul><li class="links ">
<a href="addremove-sources.html" title="Přidání dalších zdrojů softwaru">Přidání dalších zdrojů softwaru</a><span class="desc"> — Přidání dalších zdrojů softwaru pro rozšíření zdrojů, které Ubuntu používá pro instalace a aktualizace.</span>
</li></ul></div>
</div></div>
</div>
</div>
