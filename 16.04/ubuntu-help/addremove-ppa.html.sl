...
<li class="steps"><p class="p">Zaprite okno <span class="app">Programi in posodobitve</span>. <span class="app">Programi Ubuntu</span> bo nato v programskih virih preveril, če so na voljo novi programi.</p></li>
</ol></div>
</div></div>
</div>
