...
<dd class="terms"><p class="p">Het kan zijn dat uw Bluetooth-adapter/dongle niet herkend werd door de computer. Dit kan komen doordat de <span class="link"><a href="hardware-driver.html" title="Wat is een stuurprogramma?">stuurprogramma's</a></span> voor de adapter niet zijn geïnstalleerd. Sommige Bluetooth-adapters worden niet ondersteund door Linux waardoor u mogelijk niet aan de juiste stuurprogramma's ervoor kunt komen. In dit geval dient u waarschijnlijk een andere Bluetooth-adapter aan te schaffen.</p></dd>
<dt class="terms">Adapter niet ingeschakeld</dt>
<dd class="terms"><p class="p">Zorg ervoor dat uw Bluetooth-adapter is ingeschakeld. Klik op het <span class="gui">Bluetooth-pictogram</span> in de <span class="gui">menubalk</span> en controleer of hij is <span class="link"><a href="bluetooth-turn-on-off.html" title="Bluetooth in- of uitschakelen">ingeschakeld</a></span>.</p></dd>
<dt class="terms">Bluetooth is op het externe apparaat uitgeschakeld</dt>
<dd class="terms"><p class="p">Controleer of Bluetooth is ingeschakeld op het apparaat waarmee u probeert te verbinden. Bijvoorbeeld, als u probeert te verbinden met een telefoon, zorg er dan voor dat die niet in vliegtuigmodus staat.</p></dd>
