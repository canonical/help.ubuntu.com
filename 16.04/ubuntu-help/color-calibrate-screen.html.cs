...
<title>Jak zkalibruji obrazovku?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Jak zkalibruji obrazovku?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">
...
<p class="p">
    ...
    By running <span class="guiseq"><span class="gui">System Settings</span> ▸ <span class="gui">Color</span></span>
    you can create a profile, and the wizard will show you how to attach 
    the colorimeter device and what settings to adjust.
  </p>
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents">
<p class="p">Obrazovky se v průběhu let mění - podsvícení u TFT monitoru se zmenší na polovinu jasu přibližně každých 18 měsíců, a navíc se s věkem zabarvuje do žluta. To znamená, že byste měli překalibrovat vaši obrazovku vždy, když se objeví ikona [!] v ovládacím panelu.</p>
<p class="p">LED obrazovky se také mění v průběhu času, ale mnohem pomaleji než TFT monitory.</p>
</div></div></div></div>
</div>
