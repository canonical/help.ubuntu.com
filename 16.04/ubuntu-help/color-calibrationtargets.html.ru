...
<title>Какие типы тестовых таблиц поддерживаются?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Какие типы тестовых таблиц поддерживаются?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Поддерживаются следующие типы тестовых таблиц:</p>
...
<p class="p">Тестовые таблицы известных производителей, таких как KODAK, X-Rite и LaserSoft, можно приобрести в различных онлайн-магазинах.</p>
<p class="p">Или же можно купить тестовые таблицы в магазине <span class="link"><a href="http://www.targets.coloraid.de/" title="http://www.targets.coloraid.de/">Wolf Faust</a></span> по очень выгодной цене.</p>
</div></div></div></div>
</div>
