...
<title>Могу ли я поделиться своими цветовыми профилями?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Могу ли я поделиться своими цветовыми профилями?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Созданные вами цветовые профили применимы только для оборудования и условий освещённости, для которых производилась калибровка. Цветовой профиль монитора, включённого в сеть в течение нескольких сотен часов, будет сильно отличаться от профиля такого же монитора со следующим серийным номером, но проработавшего тысячу часов.</p>
<p class="p">Это означает, что если поделиться с кем-то вашим цветовым профилем, то, вероятно, можно <span class="em">приблизить</span> их к точной калибровке, но считать, что их дисплей откалиброван, в лучшем случае — заблуждение.</p>
<p class="p">Точно так же, предоставление в общее пользование профиля, созданного вами при ваших конкретных условиях освещённости, не имеет большого смысла, если только для комнаты, где происходит просмотр и редактирование изображений, не рекомендовано специально управлять освещением (без солнечного света из окон, чёрные стены, освещение лампами дневного света и т. д.).</p>
<div class="note note-warning" title="Предупреждение"><div class="inner"><div class="region"><div class="contents"><p class="p">Необходимо тщательно проверить условия распространения профилей, загруженных с веб-сайтов поставщиков, или созданных от вашего имени.</p></div></div></div></div>
</div>
