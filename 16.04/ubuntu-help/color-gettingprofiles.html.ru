...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Где взять цветовые профили?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Лучший способ получения профилей — создать их самому, хотя это и требует некоторых первоначальных затрат.</p>
<p class="p">Многие производители стараются предоставлять цветовые профили для устройств, однако в ряде случаев они свёрнуты в <span class="em">пакет драйверов</span>, который, возможно, надо будет скачать, распаковать, а затем найти там цветовые профили.</p>
<p class="p">Некоторые производители не предоставляют точных профилей для оборудования, таких профилей лучше избегать. Откроем секрет: загрузите профиль, и если он создан больше года назад от даты приобретения устройства, — это, скорее всего, фиктивно созданные данные, непригодные к использованию.</p>
<p class="p">Для информации о том, почему использование поставляемых производителем профилей часто не только бесполезно, но и вредно, см. <span class="link"><a href="color-why-calibrate.html" title="Почему я сам должен сделать калибровку?">Почему я сам должен сделать калибровку?</a></span>.</p>
</div>
...
<div class="region"><ul>
<li class="links ">
<a href="color-testing.html" title="Как проверить, правильно ли работает управление цветом?">Как проверить, правильно ли работает управление цветом?</a><span class="desc"> — Проверить управление цветом несложно, мы даже предоставляем несколько тестовых профилей.</span>
</li>
<li class="links ">
<a href="color-missingvcgt.html" title="Отсутствуют сведения для цветовой коррекции всего экрана?">Отсутствуют сведения для цветовой коррекции всего экрана?</a><span class="desc"> — Цветовая коррекция всего экрана изменяет все цвета экрана во всех окнах.</span>
</li>
<li class="links ">
