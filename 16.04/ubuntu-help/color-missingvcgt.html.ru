...
<title>Отсутствуют сведения для цветовой коррекции всего экрана?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Отсутствуют сведения для цветовой коррекции всего экрана?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">К сожалению, многие поставляемые производителем ICC-профили не содержат информации, необходимой для цветовой коррекции всего экрана. Эти профили всё ещё могут быть полезны для приложений, создающих цветокомпенсацию, но не удастся увидеть всех цветов, если поменять экран.</p>
<p class="p">Для создания профиля экрана, содержащего как данные калибровки, так и данные характеризации, необходимо использовать специальные инструменты для измерения цвета, так называемые колориметры или спектрометры.</p>
</div>
