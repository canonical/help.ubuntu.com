...
<li class="list"><p class="p"><span class="em">Blauwige test</span>: Dit maakt het scherm blauw en controleert of de curven naar de monitor worden verstuurd.</p></li>
<li class="list"><p class="p"><span class="em">ADOBEGAMMA-test</span>: Dit maakt het scherm roze en test verschillende functies van een beeldschermprofiel</p></li>
<li class="list"><p class="p"><span class="em">FakeBRG</span>: Dit wijzigt het scherm niet, maar verwisselt de RGB-kanalen zodat ze BGR worden. De meeste kleurverlopen zullen erover het algemeen correct uitzien, en is er niet veel verschil zichtbaar op de rest van het scherm, maar in toepassingen die kleurbeheer ondersteunen zullen afbeeldingen er heel anders uitzien.</p></li>
</ul></div></div></div>
<p class="p">Voeg een van de testprofielen toe aan uw schermapparaat via de voorkeuren onder <span class="guiseq"><span class="gui">Systeeminstellingen</span> ▸ <span class="gui">Kleur</span></span>.</p>
