...
<li class="steps"><p class="p">Abra la aplicación <span class="app">Discos</span> desde el <span class="link"><a href="unity-dash-intro.html" title="Encontrar aplicaciones, archivos, música y mucho más con el tablero">tablero</a></span>.</p></li>
