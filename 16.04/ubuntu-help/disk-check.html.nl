...
<li class="steps"><p class="p">Open het menu rechtsboven en kies <span class="gui">SMART-gegevens &amp; zelftests</span> om meer schijfinformatie te krijgen, of om een zelftest uit te voeren.</p></li>
</ol></div>
</div></div>
</div></div>
</div></div>
