...
<li class="steps"><p class="p">Open de <span class="gui">Snelzoeker</span> en start <span class="app">Schijven</span>.</p></li>
<li class="steps"><p class="p">In het paneel met de naam <span class="gui">Opslagapparaten</span> vindt u harde schijven, cd/dvd-stations en fysieke apparaten. Klik op het apparaat dat u wilt onderzoeken.</p></li>
<li class="steps">
<p class="p">In het rechterpaneel geeft het gebied met de naam <span class="gui">Volumen</span> een grafisch overzicht van de volumes en partities die zich op het geselecteerde apparaat bevinden. Het bevat ook een aantal hulpmiddelen die gebruikt worden om deze volumes te beheren.</p>
...
<p class="p">Eén primaire partitie moet informatie bevatten die gebruikt wordt door uw computer om op te starten, of <span class="em">booten</span>. Daarom wordt deze soms bootpartitie of bootvolume genoemd. Om te bepalen of een volume opstartbaar is, bekijk de <span class="gui">partitieparameters</span> ervan in Schijfgereedschap. Externe media zoals usb-stations en cd's kunnen ook opstartbaar zijn.</p>
</div></div>
</div></div>
