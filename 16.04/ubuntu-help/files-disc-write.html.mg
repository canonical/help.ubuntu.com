...
<div class="region">
<div class="contents">
<p class="p">You can put files onto a blank disc by using <span class="gui">CD/DVD Creator</span>. The
 option to create a CD or DVD will appear in the file manager as soon as you
 place the CD into your CD/DVD writer. The file manager lets you transfer files
 to other computers or perform <span class="link"><a href="backup-why.html" title="Back up your important files">backups</a></span> by putting
...
<li class="steps">
<p class="p">In the <span class="gui">Blank CD/DVD-R Disc</span> window that appears,
     select <span class="gui">CD/DVD Creator</span> and click <span class="gui">OK</span>.
     The <span class="gui">CD/DVD Creator</span> folder window will open.</p>
...
<p class="p">(You could choose <span class="gui">Image file</span> instead. This will put the files
     in a <span class="em">disc image</span>, which will be saved on your computer. You can
...
<p class="p">If <span class="gui">Burn Several Copies</span> is selected, you will be prompted for
     additional discs.</p>
</li>
...
<p class="p">In this case, try burning the disc again but use a lower burning speed, e.g.
 12x rather than 48x. Burning at slower speeds is more reliable. You can choose
 the speed by clicking the <span class="gui">Properties</span> button in the
