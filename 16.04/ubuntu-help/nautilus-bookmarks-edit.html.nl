...
<li class="steps"><p class="p">Klik op <span class="gui">Bladwijzers</span> in de menubalk en kies <span class="gui">Bladwijzer maken voor deze locatie</span>.</p></li>
</ol></div>
</div></div>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Een bladwijzer verwijderen:</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Klik op <span class="gui">Bladwijzers</span> in de menubalk en kies <span class="gui">Bladwijzers…</span> uit het appmenu.</p></li>
<li class="steps"><p class="p">Kies in het <span class="gui">Bladwijzers</span>venster de bladwijzer die u wenst te verwijderen, en klik de <span class="key"><kbd>-</kbd></span> knop.</p></li>
</ol></div>
</div></div>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Een bladwijzer hernoemen:</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Klik in de menubalk op <span class="gui">Bestanden</span> en kies <span class="gui">Bladwijzers</span> uit het toepassingsmenu.</p></li>
<li class="steps"><p class="p">Kies in het <span class="gui">Bladwijzers</span>venster de bladwijzer die u wenst te hernoemen.</p></li>
<li class="steps">
