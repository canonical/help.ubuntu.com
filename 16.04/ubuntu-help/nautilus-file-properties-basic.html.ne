...
<p class="p">The file properties window shows you information like the type of file,
  ...
  can have it displayed in <span class="link"><a href="nautilus-list.html" title="File manager list columns preferences">list view columns</a></span>
...
<dt class="terms">Location</dt>
<dd class="terms"><p class="p">The location of each file on your computer is given by its <span class="em">absolute path</span>. This is a unique "address" of the file on your computer, made up of a list of the folders that you would need to go into to find the file. For example, if Jim had a file called <span class="file">Resume.pdf</span> in his Home folder, its location would be <span class="file">/home/jim/Resume.pdf</span>.</p></dd>
<dt class="terms">Volume</dt>
<dd class="terms"><p class="p">The file system or device that the file is stored on. This shows you
    where the file is physically stored, for example if it is on the hard disk
    or on a CD, or a
    <span class="link"><a href="nautilus-connect.html" title="Browse files on a server or network share">network share or file server</a></span>. Hard
    disks can be split up into several
    <span class="link"><a href="disk-partitions.html" title="Manage volumes and partitions">disk partitions</a></span>; the partition will
    be displayed under <span class="gui">Volume</span> too.</p></dd>
