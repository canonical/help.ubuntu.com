...
<dt class="terms"><span class="gui">Brez</span></dt>
...
<p class="p">Dovoljenja datotek lahko hitro nastavite za vse datoteke v mapi s klikom na <span class="gui">Spremeni dovoljenja za vse priložene datoteke</span>. Uporabite spustne sezname za prilagoditev dovoljenj vsebovanih datotek ali map in kliknite <span class="gui">Spremeni</span>.</p>
</div></div>
</div></div>
