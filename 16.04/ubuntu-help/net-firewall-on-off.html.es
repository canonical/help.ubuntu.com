...
<title>Activar o bloquear acceso al cortafuegos</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Activar o bloquear acceso al cortafuegos</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Ubuntu incorpora el <span class="app">Cortafuegos sin complicaciones («Uncomplicated Firewall»)</span> (<span class="app">ufw</span>) pero no viene activado de forma predeterminada. Como Ubuntu no trae ningún servicio de red abierto (excepto para la infraestructura básica de red) en la instalación predeterminada, no se necesita ningún cortafuegos para bloquear intentos de conexiones maliciosas entrantes.</p>
<p class="p">Para tener más información sobre el uso de ufw, consulte la <span class="link"><a href="https://wiki.ubuntu.com/UncomplicatedFirewall" title="https://wiki.ubuntu.com/UncomplicatedFirewall">documentación en línea</a></span>.</p>
</div>
...
<div class="region"><div class="contents"><p class="p">Para activar el cortafuegos, teclee <span class="cmd">sudo ufw enable</span> en un terminal. Para desactivar ufw, teclee <span class="cmd">sudo ufw disable</span>.</p></div></div>
</div></div>
...
<p class="p">Muchos programas están diseñados para ofrecer servicios de red. Por ejemplo, puede compartir contenidos, o permitir que alguien vea su escritorio de forma remota. Dependiendo de los programas que instale, es posible que tenga que ajustar el cortafuegos para permitir que esos programas funcionen según lo previsto. Ufw ya trae varias reglas predefinidas. Por ejemplo, para permitir conexiones <span class="app">SSH</span>, introduzca <span class="cmd">sudo ufw allow ssh</span> en un terminal. Para bloquear el SSH, introduzca <span class="cmd">sudo ufw block ssh</span>.</p>
<p class="p">Todo programa que proporciona servicios usa un <span class="em">puerto de red</span> específico. Para permitir el acceso a los servicios de ese programa, tiene que permitir el acceso a su puerto asignado en el cortafuegos. Para permitir conexiones al puerto 53, introduzca <span class="cmd">sudo ufw allow 53</span> en un terminal. Para bloquear el puerto 53, introduzca <span class="cmd">sudo ufw block 53</span>.</p>
