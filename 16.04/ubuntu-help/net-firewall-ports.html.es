...
<div class="region">
<div class="contents">
<p class="p">Esta es una lista de los puertos de red comúnmente usados por las aplicaciones que proveen servicios de red, como la compartición de archivos o la visualización de escritorios remotos. Puede cambiar el cortafuegos de su sistema a <span class="link"><a href="net-firewall-on-off.html" title="Activar o bloquear acceso al cortafuegos">bloquear o permitir el acceso</a></span> a estas aplicaciones. Hay miles de puertos en uso, por lo que esta tabla no está completa.</p>
...
<div class="region"><ul><li class="links ">
<a href="net-firewall-on-off.html" title="Activar o bloquear acceso al cortafuegos">Activar o bloquear acceso al cortafuegos</a><span class="desc"> — Puede controlar qué programas pueden acceder a la red. Esto ayuda a mantener su equipo seguro.</span>
</li></ul></div>
</div></div>
</div>
</div>
