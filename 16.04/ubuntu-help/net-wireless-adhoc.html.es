...
<title>Crear un «hotspot» inalámbrico</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Crear un «hotspot» inalámbrico</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Puede utilizar su equipo como un punto de acceso inalámbrico. Permite a otros dispositivos conectar a su equipo sin necesidad de una red externa y también permite compartir la conexión a internet realizada con otra interfaz, tal como una red por cable o sobre una red móvil.</p>
...
<li class="steps"><p class="p">Abra <span class="gui">Red</span> y seleccione <span class="gui">Inalámbrica</span> en la izquierda.</p></li>
<li class="steps"><p class="p">Pulse el botón <span class="gui">Usar como «hotspot»</span>.</p></li>
<li class="steps"><p class="p">Si ya se conectó a una red inalámbrica, se le preguntará si quiere desconectarse de dicha red. Un solo adaptador de red inalámbrica solamente puede conectarse a o crear una red al mismo tiempo. Pulse <span class="gui">Crear «hotspot»</span> para confirmar.</p></li>
</ol></div></div></div>
<p class="p">Se generan automáticamente un nombre de red (SSID) y clave de seguridad. El nombre de la red estará basado en el nombre de su equipo. Otros dispositivos necesitarán esta información para conectarse al «hotspot» que acaba de crear.</p>
</div>
