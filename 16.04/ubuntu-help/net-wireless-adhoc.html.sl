...
<li class="steps"><p class="p">Desno kliknite na gumb <span class="gui">Uporabi kot dostopno točko</span>.</p></li>
<li class="steps"><p class="p">Če ste že povezani z brezžičnim omrežjem, boste vprašani, če želite prekiniti povezavo z omrežjem. Ena brezžična kartica se lahko sočasno poveže samo z enim omrežjem. Kliknite <span class="gui">Ustvari dostopno točko</span> za potrditev.</p></li>
</ol></div></div></div>
