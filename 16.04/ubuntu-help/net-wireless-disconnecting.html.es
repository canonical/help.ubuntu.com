...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">¿Por qué mi red inalámbrica se sigue desconectando?</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Puede toparse con que ha sido desconectado/a de una red inalámbrica aún cuando ha decidido permanecer conectado/a. Su equipo normalmente intentará reconectarse a la red en cuanto suceda esto (el icono de red en la barra de menús se animará si el equipo intenta reconectarse), pero esto puede resultar molesto, en especial si estaba usando Internet en ese momento.</p></div>
<div id="signal" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Señal inalámbrica débil</span></h2></div>
<div class="region"><div class="contents">
<p class="p">Una razón frecuente por la que puede desconectarse de una red inalámbrica es que recibe poca señal. Las redes inalámbricas tienen un alcance limitado, por lo que si está demasiado lejos de la estación base inalámbrica no recibirá una señal lo bastante fuerte como para mantener la conexión. Los muros y otros objetos situados entre usted y la estación base también debilitan la señal.</p>
<p class="p">El icono de red en la barra de menús muestra qué tan fuerte es su señal inalámbrica. Si la señal es baja, intente moverse más cerca de la estación base inalámbrica.</p>
</div></div>
</div></div>
<div id="network" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">La conexión de red no se establece correctamente</span></h2></div>
<div class="region"><div class="contents">
...
<p class="p">Una posible razón para esto es que se equivocó al introducir la contraseña inalámbrica, o que su equipo no tiene permiso para conectarse a la red (porque la red necesita un nombre de usuario, por ejemplo).</p>
</div></div>
</div></div>
<div id="hardware" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Controladores o hardware inalámbrico poco fiables</span></h2></div>
<div class="region"><div class="contents"><p class="p">Algunos equipos de red inalámbrica pueden ser poco fiables. Las redes inalámbricas son complicadas, por lo que las tarjetas inalámbricas y estaciones base de vez en cuando tienen problemas de menor importancia y pueden perder la conexión. Esto es molesto, pero ocurre con bastante regularidad con muchos dispositivos. Si se desconecta de conexiones inalámbricas de vez en cuando, esta puede ser la única razón. Si esto ocurre con mucha frecuencia, es posible que desee considerar el uso de hardware diferente.</p></div></div>
</div></div>
<div id="busy" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Redes inalámbricas ocupadas</span></h2></div>
<div class="region"><div class="contents"><p class="p">Las redes inalámbricas en lugares ocupados (en universidades y cibercafés, por ejemplo) a menudo tienen muchos equipos que intentan conectarse todo a la vez. A veces esas redes se saturan y pueden no ser capaces de manejar todos los equipos que están intentando conectarse, por lo que algunos de ellos quedan desconectados.</p></div></div>
</div></div>
