...
<li class="list">
<p class="p">Dvakrat preverite, da imate pravo geslo</p>
<p class="p">Gesla so občutljiva na velikost črk (pomembno je ali so črke velike ali majhne). Zato preverite, da niste napisali znakov napačne velikosti.</p>
</li>
<li class="list">
...
<li class="list">
<p class="p">Preverite, da uporabljate pravo vrsto brezžične varnosti</p>
