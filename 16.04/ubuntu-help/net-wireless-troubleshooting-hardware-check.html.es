...
<li class="steps"><p class="p">Abra una ventana de Terminal, escriba <span class="cmd">sudo lshw -C network</span> y presione <span class="key"><kbd>Intro</kbd></span>. Si esto da un mensaje de error, puede instalar el programa <span class="app">lshw</span> en su equipo escribiendo <span class="cmd">sudo apt-get install lshw</span> en la terminal.</p></li>
<li class="steps">
