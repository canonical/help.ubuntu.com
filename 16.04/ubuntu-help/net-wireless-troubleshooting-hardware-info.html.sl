...
<a class="nextlinks-prev" href="net-wireless-troubleshooting-initial-check.html" title="Odpravljanje težav z brezžičnimi omrežji">Nazaj</a><a class="nextlinks-next" href="net-wireless-troubleshooting-hardware-check.html" title="Odpravljanje težav z brezžičnimi povezavami">Naprej</a>
</div>
<div class="hgroup">
...
<li class="list"><p class="p">Proizvajalci in številke modela vašega računalnika, brezžične kartice in usmerjevalnika. Te podatke lahko običajno najdete na zadnji/spodnji strani naprave.</p></li>
<li class="list"><p class="p">Morebitne številke različic, ki so natisnjene na napravah ali njihovem pakiranju. To vam lahko še posebno pomaga, zato pozorno poglejte.</p></li>
