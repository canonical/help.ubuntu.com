...
<title>Εκμεταλλευτείτε στο έπακρο τη μπαταρία του φορητού σας υπολογιστή.</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Εκμεταλλευτείτε στο έπακρο τη μπαταρία του φορητού σας υπολογιστή.</span></h1></div>
<div class="region">
<div class="contents">
...
<li class="list"><p class="p">Οι μπαταρίες παλιώνουν ακόμα και όταν τις έχετε κάπου αποθηκευμένες. Δεν υπάρχει κανένα σημαντικό πλεονέκτημα στο να αγοράζετε εφεδρική μπαταρία ταυτόχρονα με την αρχική - πάντα να αγοράζετε ανταλλακτικά μόνο όταν τα χρειάζεστε.</p></li>
</ul></div></div></div>
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents"><p class="p">Αυτή η συμβουλή ισχύει ειδικά για τις μπαταρίες Λιθίου-ιόντων (Li-Ion), οι οποίες είναι ο πιο κοινός τύπος. Άλλοι τύποι μπαταριών μπορεί να έχουν όφελος με διαφορετική αντιμετώπιση.</p></div></div></div></div>
</div>
...
<div class="region"><ul><li class="links ">
<a href="power-batterybroken.html" title="Ένα σφάλμα αναφέρει ότι η μπαταρία μου έχει χαμηλή ενέργεια">Ένα σφάλμα αναφέρει ότι η μπαταρία μου έχει χαμηλή ενέργεια</a><span class="desc"> — Η μπαταρία σας πιθανώς δεν είναι χαλασμένη· μάλλον είναι απλώς παλιά.</span>
</li></ul></div>
</div></div>
</div>
</div>
