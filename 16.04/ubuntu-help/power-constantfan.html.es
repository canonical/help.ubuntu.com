...
<title>El ventilador de mi portátil funciona todo el tiempo</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">El ventilador de mi portátil funciona todo el tiempo</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Si el ventilador de su portátil está siempre funcionando, podría deberse a que el hardware que controla el sistema de refrigeración del portátil no funciona muy bien con Linux. Algunos portátiles necesitan software adicional para controlar eficientemente sus ventiladores de refrigeración, pero dicho software podría no estar instalado (o disponible para Linux) y por tanto los ventiladores estarían funcionando a máxima velocidad todo el tiempo.</p>
<p class="p">En tal caso, quizá pueda cambiar algunas opciones o instalar software que le permita un control total del ventilador. Por ejemplo, puede instalar <span class="link"><a href="http://vaio-utils.org/fan/" title="http://vaio-utils.org/fan/">vaiofand</a></span> para controlar los ventiladores de algunos portátiles Sony VAIO. Instalar este software es un proceso algo técnico que depende fuertemente de la marca y modelo de su portátil, por lo que puede que desee buscar ayuda específica sobre cómo hacerlo en su equipo.</p>
<p class="p">También es posible que su portátil simplemente produzca una gran cantidad de calor. Esto no significa necesariamente que se esté recalentando, sino que puede ser que necesite que el ventilador funcione a toda velocidad todo el tiempo para permitirle mantenerse frío. Si este es el caso, tiene pocas opciones para evitar que el ventilador funcione a toda velocidad todo el tiempo. A veces, puede ayudar la compra de accesorios de refrigeración para su equipo.</p>
</div>
