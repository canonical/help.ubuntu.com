...
<li class="steps">
<p class="p">Escriba <span class="cmd">sudo pm-hibernate</span> en la terminal y presione <span class="key"><kbd>Intro</kbd></span>.</p>
<p class="p">Escriba su contraseña cuando se le pida.</p>
</li>
<li class="steps">
<p class="p">Después de que se apague su equipo, enciéndalo de nuevo. ¿Se volvieron a abrir sus aplicaciones abiertas?</p>
<p class="p">Si la hibernación no funciona, compruebe que su partición de intercambio es al menos del mismo tamaño que su RAM disponible.</p>
</li>
</ol></div></div></div>
</div></div>
</div></div>
...
<div class="region"><div class="contents">
<p class="p">Sí la prueba de hibernación funciona, puede continuar y utilizar la orden <span class="cmd">sudo pm-hibernate</span> cuando quiera hibernar.</p>
