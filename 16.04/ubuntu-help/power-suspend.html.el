...
<title>Τί συμβαίνει όταν αναστέλλω τη λειτουργία του υπολογιστή μου;</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Τί συμβαίνει όταν αναστέλλω τη λειτουργία του υπολογιστή μου;</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Όταν κάνετε <span class="em">αναστολή λειτουργίας</span> του υπολογιστή, τον βάζετε σε κατάσταση ύπνωσης. Όλες οι εφαρμογές και τα έγγραφα παραμένουν ανοιχτά, αλλά η οθόνη και τα άλλα τμήματα του υπολογιστή κλείνουν προς εξοικονόμηση ενέργειας. Ο υπολογιστής παρόλα αυτά παραμένει σε λειτουργία και καταναλώνει κάποιο μικρό ποσό ενέργειας. Μπορείτε να τον επαναφέρετε πιέζοντας κάποιο πλήκτρο ή κάνοντας κλικ με το ποντίκι. Αν αυτό δε λειτουργεί, δοκιμάστε να πιέσετε το πλήκτρο παροχής ενέργειας.</p>
<p class="p">Κάποιοι υπολογιστές έχουν πρόβλημα με την υποστήριξη του υλικού τους, κάτι το οποίο σημαίνει πως <span class="link"><a href="power-suspendfail.html" title="Γιατί ο υπολογιστής μου δεν ανοίγει ξανά μετά την αναστολή λειτουργίας του;">ενδεχομένως να μην είναι σε θέση να αναστείλουν τη λειτουργία τους ή να αδρανοποιηθούν σωστά</a></span>. Μια καλή ιδέα είναι να δοκιμάσετε αν η αναστολή λειτουργεί σωστά στον υπολογιστή σας πριν βασιστείτε σ' αυτήν.</p>
<div class="note note-important" title="Σημαντικό"><div class="inner">
<div class="title title-note"><h2><span class="title">Αποθηκεύετε πάντα την εργασία σας πριν την αναστολή λειτουργίας</span></h2></div>
<div class="region"><div class="contents"><p class="p">Θα πρέπει να αποθηκεύετε την εργασία σας πριν αναστείλετε τη λειτουργία του υπολογιστή σας, για την περίπτωση προβλήματος κατά την οποία οι εφαρμογές και τα έγγραφά σας δεν θα μπορούν να επανακτηθούν όταν τον επαναφέρετε σε κατάσταση λειτουργίας ξανά.</p></div></div>
</div></div>
</div>
