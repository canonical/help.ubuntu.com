...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Moj računalnik se ne prižge</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Obstaja veliko razlogov zakaj se računalnik ne prižge. Ta tema na kratko opiše nekaj mogočih vzrokov.</p></div>
<div id="nopower" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Računalnik ni vklopljen, prazna baterija ali razrahljan kabel</span></h2></div>
<div class="region"><div class="contents"><p class="p">Prepričajte se, da napajalni kabli računalnika so trdno priključeni ter da so vtičnice vklopljene. Prav tako se prepričajte, da je zaslon priključen in vklopljen. Če imate prenosni računalnik, priključite napajalne kable (v primeru, da zmanjka baterije). Prav tako lahko preverite, da je baterija pravilno nameščena (preverite spodnjo stran prenosnika), če je odstranljiva.</p></div></div>
</div></div>
<div id="hardwareproblem" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Težave s strojno opremo računalnika</span></h2></div>
<div class="region"><div class="contents"><p class="p">Sestavni del vašega računalnika je lahko pokvarjen. V tem primeru morate svoj računalnik popraviti. Pogoste napake so pokvarjen napajalnik, nepravilno vstavljeni sestavni deli (kot je na primer RAM) in pokvarjena matična plošča.</p></div></div>
</div></div>
