...
<dt class="terms">Usando el ratón:</dt>
<dd class="terms"><p class="p">Abra el <span class="link"><a href="unity-launcher-intro.html" title="Use el Lanzador para iniciar aplicaciones">Lanzador</a></span> y pulse en el botón del <span class="gui">cambiador de espacios de trabajo</span> situado cerca de la parte inferior. Pulse dos veces sobre cualquier ventana o espacio de trabajo para pasar a él, pulse de nuevo el botón del cambiador de espacios de trabajo para volver a su espacio de trabajo anterior.</p></dd>
<dt class="terms">Usando el teclado:</dt>
<dd class="terms"><div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Pulse <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>→</kbd></span></span> para mover a un área de trabajo que está a la derecha del área de trabajo actual.</p></li>
<li class="list"><p class="p">Pulse <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>←</kbd></span></span> para mover a un área de trabajo que está a la izquierda del área de trabajo actual.</p></li>
<li class="list"><p class="p">Pulse <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>↓</kbd></span></span> para mover a un área de trabajo que está debajo del área de trabajo actual.</p></li>
<li class="list"><p class="p">Pulse <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>↑</kbd></span></span> para moverse a un área de trabajo que esté encima de la actual.</p></li>
</ul></div></div></div></dd>
</dl></div></div></div>
