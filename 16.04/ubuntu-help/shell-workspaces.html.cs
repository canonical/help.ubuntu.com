...
<p class="p">Now you can open the <span class="link"><a href="unity-launcher-intro.html" title="Použití Launcheru pro spouštění aplikací">Launcher</a></span> and click the <span class="gui">workspace switcher</span> icon near the bottom. By default, Ubuntu shows 4 workspaces, arranged in 2 rows and 2 columns. You can change the number of workspaces:</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Změna počtu pracovních ploch</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Přejděte do nabídky <span class="link"><a href="unity-dash-intro.html" title="Find applications, files, music, and more with the Dash">Dash</a></span> a spusťte <span class="app">Terminál</span>.</p></li>
<li class="steps">
