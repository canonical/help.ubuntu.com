...
<span style="color: #333">Ubuntu 16.04</span> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="prefs.html" title="User &amp; system settings">Settings</a> » <a class="trail" href="media.html#sound" title="Basic sound">Sound</a> » </div></div>
...
<div class="region"><ul><li class="links ">
<a href="sound-usemic.html" title="Use a different microphone">Use a different microphone</a><span class="desc"> — Use an analog or USB microphone and select a default input device.</span>
</li></ul></div>
</div></div>
</div>
</div>
