...
<li class="steps"><p class="p">Use el <span class="link"><a href="unity-dash-intro.html" title="Encontrar aplicaciones, archivos, música y mucho más con el tablero">tablero</a></span> para encontrar y abrir <span class="gui">Aplicaciones al inicio</span>. De forma alternativa puede pulsar <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>F2</kbd></span></span> y ejecutar la orden <span class="cmd">gnome-session-properties</span>.</p></li>
