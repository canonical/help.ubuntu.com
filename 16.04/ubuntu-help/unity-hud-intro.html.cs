...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Co je to HUD?</span></h1></div>
<div class="region">
<div class="contents">
...
LTS.</p>
<p class="p">Některé aplikace jako například <span class="link"><a href="https://apps.ubuntu.com/cat/applications/gimp" title="https://apps.ubuntu.com/cat/applications/gimp">Gimp</a></span> nebo <span class="link"><a href="https://apps.ubuntu.com/cat/applications/inkscape" title="https://apps.ubuntu.com/cat/applications/inkscape">Inkscape</a></span> mají v nabídkách stovky položek. Pokud takové aplikace používáte, je možné, že si spíš zapamatujete název konkrétní položky než celou cestu skrze nabídku dané aplikace.</p>
...
<div class="hgroup"><h2 class="title"><span class="title">Použití HUD</span></h2></div>
<div class="region"><div class="contents">
<p class="p">To try the HUD:</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Pro otevření HUD stiskněte <span class="key"><kbd>Alt</kbd></span>.</p></li>
<li class="steps"><p class="p">Začněte psát.</p></li>
...
<p class="p">HUD ukládá historii vašich hledání a podle ní upravuje výsledky vyhledávání tak, aby pro vás byly ještě užitečnější.</p>
</div></div>
</div></div>
