...
<span style="color: #333">Ubuntu 16.04</span> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="unity-launcher-intro.html" title="Use the Launcher to start applications">Use the Launcher to start applications</a> › <a class="trail" href="unity-launcher-intro.html#launcher-using" title="Use the Launcher">Use the Launcher</a> » </div></div>
