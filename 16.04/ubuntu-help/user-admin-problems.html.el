...
<div class="region">
<div class="contents">
<p class="p">Μπορεί να συναντήσετε μερικά προβλήματα αν δεν έχετε <span class="link"><a href="user-admin-explain.html" title="Πως δουλεύουν τα δικαιώματα διαχειριστή;">δικαιώματα διαχειριστή</a></span>. Μερικές εργασίες απαιτούν δικαιώματα διαχειριστή για να γίνουν, όπως:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Σύνδεση με δίκτυα ή με ασύρματα δίκτυα</p></li>
<li class="list"><p class="p">Εμφάνιση των περιεχομένων ενός αποσπώμενου δίσκου που είναι συνδεδεμένος στον υπολογιστή, ή των περιεχομένων μιας διαφορετικής κατάτμησης του δίσκου (π.χ. μια κατάτμηση των Windows)</p></li>
<li class="list"><p class="p">Εγκατάσταση νέων εφαρμογών</p></li>
</ul></div></div></div>
<p class="p">Μπορείτε να <span class="link"><a href="user-admin-change.html" title="Αλλαγή στο ποιος θα έχει προνόμια διαχειριστή">αλλάξετε ποιος θα έχει προνόμια διαχειριστή</a></span>.</p>
</div>
