...
<div class="region"><ul><li class="links ">
<a href="addremove-sources.html" title="Softwarebronnen toevoegen">Softwarebronnen toevoegen</a><span class="desc"> — Andere softwarebronnen toevoegen om de softwarebronnen die Ubuntu gebruikt voor installatie en upgrades uit te breiden.</span>
</li></ul></div>
</div></div>
</div>
</div>
