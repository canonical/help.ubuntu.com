...
<p class="p">You may also wish to remove software that does not have a GUI.
    ...
    <span class="link"><a href="addremove-install-synaptic.html" title="Use Synaptic for more advanced software management">Synaptic</a></span>. Note that <span class="app">Synaptic</span> does not list snaps.
  </p>
