...
<div class="trail">
<span style="color: #333">Ubuntu 17.04</span> » <a class="trail" href="index.html" title="Ubuntu Desktop Guide"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="prefs.html" title="User &amp; system settings">Settings</a> » <a class="trail" href="color.html" title="Color management">Color management</a> » </div>
</div>
...
<div class="contents">
<p class="p">
    Open <span class="guiseq"><span class="gui">System Settings</span> ▸ <span class="gui">Color</span></span>,
    and click the device that you wish to add a profile to.
  </p>
<p class="p">
    By clicking <span class="gui">Add profile</span> you can select an existing
    profile or import a new file.
  </p>
<p class="p">
    Each device can have multiple profiles assigned to it, but only one
    profile can be the <span class="em">default</span> profile.
...
<div class="desc">You can make a profile default by changing it with the radio button.</div>
</div>
</div></div>
<p class="p">
    If calibration hardware is connected the <span class="gui">Calibrate…</span>
