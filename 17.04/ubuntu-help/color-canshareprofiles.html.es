...
<title>¿Puedo compartir mi perfil de color?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">¿Puedo compartir mi perfil de color?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Los perfiles de color que ha creado usted mismo son específicos para el hardware y las condiciones de iluminación para las que se calibraron. Una pantalla que ha estado encendida por unos pocos cientos de horas va a tener un perfil de color muy diferente a una pantalla similar con el siguiente número de serie, y que ha sido iluminada por miles de horas.</p>
<p class="p">Esto significa que si comparte su perfil de color con alguien, podría <span class="em">aproximarlos</span> a una calibración, pero sería erróneo decir que su monitor está calibrado.</p>
<p class="p">Del mismo modo, a menos que todo el mundo ha recomendado iluminación controlada (sin luz solar de las ventanas, las paredes negras, las lámparas de luz día, etc) en una habitación donde se lleva a cabo la visualización y edición de imágenes, compartiendo un perfil que creó en sus propias condiciones específicas de iluminación no tiene mucho sentido.</p>
<div class="note note-warning" title="Advertencia"><div class="inner"><div class="region"><div class="contents"><p class="p">Debe revisar cuidadosamente los requisitos de redistribución de los perfiles descargados de sitios web de proveedores o que se han creado en su nombre.</p></div></div></div></div>
</div>
