...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Как импортировать цветовые профили?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Профиль можно импортировать, дважды щёлкнув на файле <span class="input">.ICC</span> или <span class="input">.ICM</span> в менеджере файлов.</p>
<p class="p">Кроме того, в <span class="guiseq"><span class="gui">Параметры системы</span> ▸ <span class="gui">Цвет</span></span> можно выбрать <span class="gui">Добавить профиль...</span> при выборе профиля для устройства.</p>
</div>
