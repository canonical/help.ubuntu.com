...
<title>Kaj je navidezno barvno upravljana naprava?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Kaj je navidezno barvno upravljana naprava?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Navidezna naprava je barvno upravljana naprava, ki ni povezana z računalnikom. Primeri tega so:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list" style="list-style-type:disc">
<li class="list"><p class="p">Spletna tiskarska trgovina, kamor pošljete fotografije, ki so nato natisnjene in poslane k vam</p></li>
<li class="list"><p class="p">Slike z digitalnega fotoaparata shranjene na spominski kartici.</p></li>
</ul></div></div></div>
<p class="p">Za ustvarjanje navideznega profila za digitalni fotoaparat samo povlecite in spustite datoteke slike na pogovorno okno <span class="guiseq"><span class="gui">Sistemske nastavitve</span> ▸ <span class="gui">Barva</span></span>. Nato mu lahko <span class="link"><a href="color-assignprofiles.html" title="Kako določiti profile napravam?">dodelite profile</a></span> tako kot katerikoli drugi napravi ali pa ga celo <span class="link"><a href="color-calibrate-camera.html" title="Kako umeriti fotoaparat?">umerite</a></span>.</p>
</div>
