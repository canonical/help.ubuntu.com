...
<div class="region">
<div class="contents">
<p class="p">It is recommended that you <span class="link"><a href="backup-why.html" title="Záloha důležitých souborů">back up</a></span> important files before you test the performance of a disk.</p>
...
<p class="p">Click <span class="gui">Start Benchmarking...</span> to start the tests.
  <span class="link"><a href="user-admin-explain.html" title="Jak funguje oprávnění správce?">Administrative privileges</a></span> may
