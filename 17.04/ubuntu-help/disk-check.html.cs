...
<p class="p">Even if the <span class="gui">SMART Assessment</span> indicates that the disk <span class="em">isn't</span>
 ...
 with a <span class="link"><a href="backup-why.html" title="Záloha důležitých souborů">backup</a></span> to prevent data loss.</p>
<p class="p">If the status of one or more of the health checks is "Pre-Fail", the disk is still reasonably healthy but
 ...
 <span class="link"><a href="backup-how.html" title="Jak zálohovat">backup your important files regularly</a></span> and check
