...
<li class="steps"><p class="p">Selecteer uit de lijst links de schijf waarvan u de informatie en status wilt controleren.</p></li>
<li class="steps"><p class="p"><span class="gui">Assessment</span> zou moeten aangeven "Schijf is in orde".</p></li>
<li class="steps"><p class="p">Klik in de <span class="gui">menubalk</span>  op het <span class="media"><span class="media media-image"><img src="figures/window-menu.png" class="media media-inline" alt="Menupictogram"></span></span> en kies <span class="gui">SMART-gegevens &amp; zelftests</span> om meer schijfinformatie te krijgen, of om een zelftest uit te voeren.</p></li>
</ol></div>
</div></div>
</div></div>
</div></div>
