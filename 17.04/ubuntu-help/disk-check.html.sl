...
<li class="steps"><p class="p">Iz seznama na levi izberite disk katerega podrobnosti in stanje želite preveriti.</p></li>
<li class="steps"><p class="p"><span class="gui">Ocena</span> bi morala izpisati "Disk deluje brezhibno".</p></li>
...
<p class="p">Even if the <span class="gui">SMART Assessment</span> indicates that the disk <span class="em">isn't</span>
 ...
 with a <span class="link"><a href="backup-why.html" title="Ustvarjanje varnostne kopije pomembnih datotek">backup</a></span> to prevent data loss.</p>
