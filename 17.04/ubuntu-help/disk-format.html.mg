...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Wipe the data off a removable disk and reuse it</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">If you have a removable disk, like a USB flash drive or an external hard
...
<p class="p">To format a removable disk:</p>
...
<li class="steps">
<p class="p">Select the disk that you want to wipe from the list on the left.</p>
<div class="note note-warning" title="Fampilazana"><div class="inner"><div class="region"><div class="contents"><p class="p">Make sure that you have selected the correct disk! If you select the wrong
 disk, all the files on the other disk will be deleted!</p></div></div></div></div>
<p class="p"> 
</p>
</li>
...
<li class="steps"><p class="p">If you want to securely wipe the data from the disk, select <span class="gui">Overwrite existing data with zeroes</span>
   from the <span class="gui">Erase</span> dropdown list.</p></li>
<li class="steps"><p class="p">Click <span class="gui">Format...</span>.</p></li>
...
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Open the <span class="app">Disks</span> application from the <span class="gui">Dash</span>.</p></li>
<li class="steps"><p class="p">Select the disk from the list on the left.</p></li>
