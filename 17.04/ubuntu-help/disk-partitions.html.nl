...
<div class="hgroup"><h2 class="title"><span class="title">Volumes en partities bekijken en beheren</span></h2></div>
<div class="region"><div class="contents">
<p class="p">Om volumes en partities op uw computer te bekijken en te beheren:</p>
...
<li class="steps"><p class="p">In het linkerdeel van het venster vindt u een lijst met harde schijven, cd/dvd-stations en andere fysieke apparaten. Klik op het apparaat dat u wilt onderzoeken.</p></li>
<li class="steps">
<p class="p">In het rechterdeel van het venster geeft het gebied met de naam <span class="gui">Volumen</span> een grafisch overzicht van de volumen en partities die zich op het geselecteerde apparaat bevinden. Het bevat ook een aantal hulpmiddelen die gebruikt worden om deze volumen te beheren.</p>
<p class="p">Let op: met deze hulpmiddelen is het mogelijk om de gegevens van uw schijf volledig te wissen.</p>
</li>
</ol></div></div></div>
