...
<li class="list"><p class="p">Αν δεν θυμάστε που σώσατε το αρχείο αλλά έχετε μια ιδέα για το πως το ονομάσατε, μπορείτε να αναζητήσετε το αρχείο με την ονομασία του. Δείτε τον σύνδεσμο <span class="link"><a href="files-search.html" title="Search for files or folders">αναζήτηση αρχείων</a></span> για να μάθετε τον τρόπο.</p></li>
...
<li class="list"><p class="p">You might have renamed the file in a way that made the file hidden.
  ...
  <span class="link"><a href="files-hidden.html" title="Κρύψτε ένα αρχείο">Κρύψτε ένα αρχείο</a></span> to learn more.</p></li>
</ul></div></div></div>
</div>
