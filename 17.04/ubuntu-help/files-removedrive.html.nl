...
<li class="steps"><p class="p"><span class="link"><a href="bestanden-bladeren.html" title="bestanden-bladeren">Open bestandsbeheer</a></span>.</p></li>
<li class="steps">
...
<p class="p">Als een toepassing bestanden op het apparaat heeft geopend en gebruikt, dan kunt u het apparaat niet veilig verwijderen. U krijgt een venster te zien waarin u verteld wordt dat "het volume bezet is", samen met een lijst met alle geopende bestanden op dat apparaat. Nadat u alle bestanden op het apparaat gesloten heeft zal het apparaat automatisch veilig verwijderd worden (zodat u het af kunt koppelen of uitwerpen).</p>
<p class="p">Als u één van deze bestanden niet kunt sluiten, bijvoorbeeld als de toepassing die het bestand gebruikt vergrendeld is, dan kunt u met rechts klikken op het bestand in het venster <span class="gui">Volume is bezet</span> en <span class="gui">Proces beëindigen</span> kiezen. Dit forceert de hele vergrendelde toepassing te sluiten, waarbij het kan zijn dat andere bestanden die u met die toepassing geopend heeft gesloten worden.</p>
