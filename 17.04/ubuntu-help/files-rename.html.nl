...
<div class="region">
<div class="contents">
<p class="p">U kunt bestandsbeheer gebruiken om de naam van een bestand of map te wijzigen.</p>
...
<li class="steps"><p class="p">Typ de nieuwe naam en druk op <span class="key"><kbd>Enter</kbd></span>.</p></li>
</ol></div>
</div></div>
...
<p class="p">Wanneer u een bestand hernoemt, wordt alleen het eerste deel van de bestandsnaam geselecteerd, niet de bestandsextensie (het deel na de "."). De extensie geeft normaal gesproken aan wat voor type bestand het is (bijv. <span class="file">bestand.pdf</span> is een PDF-document), en dat wilt u doorgaans niet wijzigen. Als u ook de extensie wilt wijzigen, selecteer dan de volledige naam en wijzig hem.</p>
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents"><p class="p">Als u het verkeerde bestand heeft hernoemd, of uw bestand een verkeerde naam heeft gegeven, kunt u het hernoemen ongedaan maken. Om de handeling terug te draaien en de vorige naam te herstellen dient u onmiddellijk te klikken op <span class="gui">Bewerken</span> in de menubalk en <span class="gui">Hernoemen ongedaan maken</span> te kiezen.</p></div></div></div></div>
</div>
