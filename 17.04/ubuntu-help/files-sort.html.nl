...
<p class="p">Om bestanden in een andere map te sorteren, klikt u in de taakbalk op de <span class="media"><span class="media media-image"><img src="figures/go-down.png" class="media media-inline" alt="omlaag"></span></span>knop en kies <span class="gui">Op naam</span>, <span class="gui">Op grootte</span>, <span class="gui">Op type</span> of <span class="gui">Op wijzigingsdatum</span>.</p>
...
<p class="p">U kunt in omgekeerde volgorde sorteren door in het keuzemenu <span class="gui">Omgekeerde volgorde</span> te kiezen.</p>
</div></div>
</div></div>
...
<p class="p">In lijstweergave kunt u kolommen met meer attributen laten weergeven en op die kolommen sorteren. Klik in de taakbalk op de <span class="media"><span class="media media-image"><img src="figures/go-down.png" class="media media-inline" alt="omlaag"></span></span>-knop, kies <span class="gui">Zichtbare kolommen</span> en selecteer de kolommen waarvan u wil dat die zichtbaar zijn. U kunt vervolgens op die kolommen sorteren. Zie <span class="link"><a href="nautilus-list.html" title="Bestandsbeheer-voorkeuren: lijstkolommen">Bestandsbeheer-voorkeuren: lijstkolommen</a></span> voor een beschrijving van de beschikbare kolommen.</p>
</div></div>
</div></div>
...
<dt class="terms">Op wijzigingsdatum</dt>
