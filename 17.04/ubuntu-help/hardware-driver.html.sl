...
<p class="p">Ko napravo priklopite na računalnik, morate za njeno pravilno delovanje imeti nameščen pravi gonilnik. Če na primer vklopite tiskalnik, a pravilni gonilnik ni na voljo, tiskalnika ne boste mogli uporabiti. Običajno vsak model naprave uporablja gonilnik, ki ni združljiv s katerimkoli drugim modelom.</p>
<p class="p">Na Linuxu so gonilniki za večino naprav že privzeto nameščeni, zato bi moralo vse delovati, ko napravo priklopite. Obstaja pa tudi možnost, da boste morali gonilnik namestiti ročno ali pa da sploh ni na voljo.</p>
<p class="p">Nekateri obstoječi gonilniki so nedokončani ali le delno delujoči. Lahko se na primer zgodi, da tiskalnik ne more izvesti dvostranskega tiskanja, a sicer popolnoma deluje.</p>
</div>
...
<div class="region"><ul><li class="links ">
<a href="bluetooth-problem-connecting.html" title="Ne morem se povezati s svojo napravo Bluetooth">Ne morem se povezati s svojo napravo Bluetooth</a><span class="desc"> — Vmesnik je lahko izklopljen ali pa morda nimate gonilnikov ali pa je Bluetooth onemogočen ali blokiran.</span>
</li></ul></div>
</div></div>
</div>
</div>
