...
<div class="region">
<div class="contents">
<p class="p">Esto puede suceder porque la resolución de pantalla que ha definido no es la más adecuada para su pantalla.</p>
...
<div class="hgroup"><h2 class="title"><span class="title">Cuando hay varios monitores conectados</span></h2></div>
...
<p class="p">Para configurar las pantallas, para que cada una tenga su propia resolución:</p>
...
<li class="steps"><p class="p">Desmarque <span class="gui">Pantallas en espejo</span>.</p></li>
<li class="steps"><p class="p">Seleccione cada pantalla por turnos de la caja gris en la parte superior de la ventana de <span class="gui">Monitores</span>. Cambie la <span class="gui">Resolución</span> hasta que la pantalla se vea bien.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
...
<div class="region"><ul><li class="links ">
<a href="look-resolution.html" title="Cambiar el tamaño o la rotación de la pantalla">Cambiar el tamaño o la rotación de la pantalla</a><span class="desc"> — Cambiar la resolución de la pantalla y su orientación (rotación).</span>
</li></ul></div>
</div></div>
</div>
</div>
