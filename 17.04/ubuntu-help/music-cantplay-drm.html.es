...
<div class="region">
<div class="contents">
<p class="p">Si descargó música de una tienda en línea, podría toparse con que no se puede reproducir en su equipo, en especial si la compró en un equipo con Windows o Mac OS X y luego la copió a su equipo.</p>
<p class="p">Esto se debe a que la música está en un formato que su equipo no reconoce. Para poder reproducir una canción necesita tener instalado el soporte para el formato de sonido adecuado - por ejemplo, si quiere reproducir archivos MP3, necesitará tener instalado el soporte para MP3. Si no tiene el soporte para un formato de archivos concreto, verá un mensaje indicándoselo cuando intente reproducir una canción. El mensaje además le dará instrucciones sobre cómo instalar el soporte para ese formato de forma que pueda reproducirlo.</p>
<p class="p">Si ya tiene instalado el soporte para el formato de sonido de la canción pero todavía no puede reproducirla, es posible que la canción esté <span class="em">protegida contra copia</span> (también llamado <span class="em">restringida por DRM</span>). El DRM es una forma de restringir quién puede reproducir una canción y en qué dispositivos puede reproducirla. La empresa que le vendió la canción es quien controla esto, no usted. Si un archivo de música tiene restricciones DRM, probablemente no podrá reproducirlo - normalmente se necesita un software especial suministrado por el vendedor para poder reproducir archivos restringidos por DRM, pero este software no suele funcionar en Linux.</p>
<p class="p">Puede aprender más sobre el DRM en la <span class="link"><a href="http://www.eff.org/issues/drm" title="http://www.eff.org/issues/drm">Electronic Frontier Foundation</a></span>.</p>
</div>
