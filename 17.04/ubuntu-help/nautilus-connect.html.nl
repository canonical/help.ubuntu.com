...
<p class="p">Open vanuit de <span class="gui">Snelzoeker</span> de toepassing <span class="app">Bestanden</span> en klik <span class="gui">Netwerk bladeren</span> in de zijbalk om door bestanden op het netwerk te bladeren. De bestandsbeheerder zal alle computers vinden op uw lokale netwerk  die aangeven bestanden te delen. Als u wil verbinden met een server op het internet, of als u de door u gezochte computer niet ziet, dan kunt u handmatig met een server verbinding maken door diens netwerk- of internetadres te typen.</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Met een bestandsserver verbinden</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Klik in de menubalk op <span class="gui">Bestanden</span> en kies <span class="gui">Met server verbinden</span> uit het toepassingsmenu.</p></li>
<li class="steps">
<p class="p">Voer het serveradres in de vorm van een <span class="link"><a href="#urls" title="URLs schrijven">URL</a></span> in. Meer informatie over ondersteunde URLs kunt u <span class="link"><a href="#types" title="Servertypen">hieronder vinden</a></span>.</p>
...
<div class="example"><p class="p"><span class="sys">schema://servernaam.voorbeeld.com/map</span></p></div>
...
<div class="example"><p class="p"><span class="sys">schema://username@servernaam.voorbeeld.com/map</span></p></div>
<p class="p">Sommige schema's vereisen dat u het poortnummer opgeeft. Voeg het toe aan de domeinnaam:</p>
<div class="example"><p class="p"><span class="sys">schema://servernaam.voorbeeld.com:poort/map</span></p></div>
...
<div class="example"><p class="p"><span class="sys">ssh://gebruikersnaam@servernaam.voorbeeld.com/map</span></p></div>
<p class="p">Als u SSH gebruikt, zullen alle door u verstuurde gegevens (inclusief uw wachtwoord) versleuteld worden zodat andere gebruikers op het netwerk dit niet kan zien.</p>
</dd>
...
<div class="example"><p class="p"><span class="sys">ftp://gebruikersnaam@ftp.voorbeeld.com/map/</span></p></div>
</dd>
...
<div class="example"><p class="p"><span class="sys">ftp://ftp.voorbeeld.com/map/</span></p></div>
<p class="p">Sommige anonieme FTP-sites vereisen dat u zich met een openbare gebruikersnaam en wachtwoord aanmeldt, of dat u zich aanmeldt met een openbare gebruikersnaam waarbij uw e-mailadres als wachtwoord wordt gebruikt. Gebruik voor deze servers <span class="gui">FTP (met aanmelding)</span> en de door de FTP-site opgegeven aanmeldgegevens.</p>
</dd>
...
<div class="example"><p class="p"><span class="sys">smb://servernaam/Gedeeldemap</span></p></div>
</dd>
<dt class="terms">WebDAV en Secure WebDAV</dt>
<dd class="terms">
<p class="p">Gebaseerd op het op het web gebruikte HTTP-protocol, wordt WebDAV soms gebruikt om bestanden op een lokaal netwerk te delen en om bestanden op het internet op te slaan. Als de server waar u me verbindt beveiligde verbindingen ondersteunt, kiest u deze optie. Secure WebDAV maakt gebruik van sterke SSL-encryptie, zodat andere gebruikers uw wachtwoord niet kunnen zien.</p>
<p class="p">Een typische WebDAV-URL ziet er als volgt uit:</p>
<div class="example"><p class="p"><span class="sys">http://voorbeeld.hostnaam.com/map</span></p></div>
</dd>
</dl></div></div></div>
</div></div>
</div></div>
