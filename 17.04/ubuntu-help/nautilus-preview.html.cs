...
<title>Nastavení náhledů správce souborů</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Nastavení náhledů správce souborů</span></h1></div>
<div class="region">
<div class="contents">
...
<p class="p">By default, all previews are done for <span class="gui">Local Files Only</span>, those
    ...
    <span class="link"><a href="nautilus-connect.html" title="Procházení souborů na server nebo po síti">browse files on other computers</a></span> over
...
<dd class="terms"><p class="p">Pokud v <span class="link"><a href="nautilus-list.html" title="Nastavení sloupců ve správci souborů">seznamovém pohledu</a></span> nebo <span class="link"><a href="nautilus-display.html#icon-captions" title="Popisky ikon">popiskách ikon</a></span> necháte zobrazovat velikost souborů, bude u složek zobrazováno kolik souborů a dalších složek obsahují. Počítání jednotlivých položek pro složky může být pomalý, obzvláště pro velmi velké složky nebo po síti. Tuto vlastnost můžete vypnout, zapnout nebo zapnout pouze pro soubory na vašem počítači nebo místních externích zařízeních.</p></dd>
</dl></div></div></div>
</div>
...
<a href="files-preview.html" title="Náhledy souborů a složek">Náhledy souborů a složek</a><span class="desc"> — Rychlé zobrazení a schování náhledů dokumentů, obrázků, videí a dalších souborů.</span>
</li></ul></div>
</div></div>
</div>
</div>
