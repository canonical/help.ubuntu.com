...
<div class="region"><ul>
<li class="links ">
<a href="net-chat-skype.html" title="How can I use Skype on Ubuntu?">How can I use Skype on Ubuntu?</a><span class="desc"> — <span class="app">Skype</span> is proprietary software and must be installed manually
    on Ubuntu</span>
</li>
<li class="links ">
<a href="net-chat-empathy.html" title="Instant messaging on Ubuntu">Instant messaging on Ubuntu</a><span class="desc"> — With <span class="app">Empathy</span> you can chat, call and video call with friends
