...
<p class="p">Vsak program, ki ponuja storitve uporablja določena <span class="em">omrežna vrata</span>. Da omogočite dostop do storitev programa boste mogoče morali omogočiti dostop določenim vratom v požarnem zidu. Za dostop povezavam na vratih 53, vnesite <span class="cmd">sudo ufw allow 53</span> v terminal. Za preprečevanje povezav na vratih 53, vnesite <span class="cmd">sudo ufw deny 53</span>.</p>
