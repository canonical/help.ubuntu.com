...
<div class="region">
<div class="contents">
<p class="p">This is a list of network ports commonly used by applications that provide network services, like file sharing or remote desktop viewing. You can change your system's firewall to <span class="link"><a href="net-firewall-on-off.html" title="Control network traffic in and out of your computer">block or allow access</a></span> to these applications. There are thousands of ports in use, so this table isn't complete.</p>
<div class="table"><div class="inner"><div class="region"><table class="table" style="border-top-style: solid;">
<thead><tr>
<td><p class="p">Port</p></td>
<td><p class="p">Name</p></td>
...
<td><p class="p">Remote desktop</p></td>
