...
<td><p class="p">Hiermee kunt u uw chat-status veranderen voor andere mensen op het netwerk, zoals ‘online’ of ‘bezet’.</p></td>
</tr>
<tr class="shade">
...
<div class="region"><ul><li class="links ">
<a href="net-firewall-on-off.html" title="Netwerkverkeer van en naar uw computer beheren">Netwerkverkeer van en naar uw computer beheren</a><span class="desc"> — U kunt het netwerkverkeer van en naar uw computer regelen. Dit helpt uw computer veilig te houden.</span>
</li></ul></div>
</div></div>
</div>
</div>
