...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">The <span class="app">Google Chrome</span> browser is shipped with Flash bundled, and does not need a plug-in.</p></div></div></div></div>
</div>
...
<li class="steps"><p class="p">Убедитесь, что <span class="link"><a href="addremove-sources.html#canonical-partner" title="Активация репозитория «Партнёры Canonical»">репозиторий «Партнёры Canonical» подключен</a></span>.</p></li>
