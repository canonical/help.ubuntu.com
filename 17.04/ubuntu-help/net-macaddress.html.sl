...
<p class="p">V praksi boste morda želeli  <span class="link"><a href="net-wireless-edit-connection.html" title="Edit a Wi-Fi connection">spremeniti ali  "ponarediti" naslov MAC</a></span>. Na primer, nekateri ponudniki interneta lahko zahtevajo, da se za dostop do njihove storitve uporabi določeni naslov MAC. Če omrežna kartica preneha delovati in morate vstaviti novo delujočo kartico, storitev več ne bo delovala. V takih primerih boste morali ponarediti naslov MAC.</p>
</div>
