...
<li class="steps"><p class="p">Open <span class="gui">Netwerk</span> en kies <span class="gui">Netwerkproxy</span> in de lijst aan de linkerkant van het venster.</p></li>
<li class="steps">
<p class="p">Kies uit de volgende methodes welke proxymethode u wilt gebruiken.</p>
<div class="terms"><div class="inner"><div class="region"><dl class="terms">
<dt class="terms">Geen</dt>
...
<dt class="terms">Automatisch</dt>
<dd class="terms"><p class="p">Een URL verwijst naar een bron met de juiste configuratie voor uw systeem.</p></dd>
</dl></div></div></div>
</li>
</ol></div></div></div>
<p class="p">De proxy-instellingen zullen worden toegepast op toepassingen die een netwerkverbinding gebruiken om de gekozen configuratie te gebruiken.</p>
</div></div>
</div></div>
