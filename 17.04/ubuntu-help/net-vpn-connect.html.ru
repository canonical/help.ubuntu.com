...
<p class="p">Существуют различные типы VPN. В зависимости от типа VPN, к которому вы подключаетесь, может понадобиться установка дополнительного программного обеспечения. Получите сведения о подключении у поставщика услуг VPN и узнайте, какой <span class="em">клиент VPN</span> необходимо использовать. Затем откройте <span class="app">Менеджер приложений Ubuntu</span>, найдите пакет <span class="app">network-manager</span>, который работает с вашей VPN (если он там имеется) и установите его.</p>
