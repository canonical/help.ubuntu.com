...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Povezava z žičnim (Eternet) omrežjem</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Za nastavitev večine žičnih omrežnih povezav, vse kar morate storite je, da priključite omrežni kabel. Ikona omrežja v menijski vrstici bi morala utripat nekaj sekund in nato se spremeni v ikono "vtičnice", ko ste povezani.</p>
...
<p class="p">Če še vedno niste povezani, potem vaše omrežje mogoče ne podpira samodejne nastavitve (DHCP). V tem primeru jo boste mogli <span class="link"><a href="net-manual.html" title="Ročno nastavi omrežne nastavitve">ročno nastavit</a></span>.</p>
</div>
