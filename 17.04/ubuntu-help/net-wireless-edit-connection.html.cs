...
If the network has a <span class="link"><a href="net-wireless-wepwpa.html" title="Co znamená WEP a WPA?">WEP/WPA password</a></span> and you have checked this option, you will only need to enter the password once.
...
<p class="p">If this option is checked, you need to be an <span class="link"><a href="user-admin-explain.html" title="Jak funguje oprávnění správce?">administrator</a></span> to change any of the settings for this network.
...
infrastructure ones; you may wish to <span class="link"><a href="net-wireless-adhoc.html" title="Vytvořte bezdrátový přístupový bod.">set-up your own ad-hoc network</a></span> though.</p>
...
<dd class="terms"><p class="p">This is the <span class="em">Basic Service Set Identifier</span>. The SSID (see above) is the name of the network which humans are intended to read; the BSSID is a name which the computer understands (it's a string of letters and numbers that is supposed to be unique to the network). If a <span class="link"><a href="net-wireless-hidden.html" title="Připojení k skryté bezdrátové síti">network is hidden</a></span>, it will not have an SSID but it will have a BSSID.</p></dd>
