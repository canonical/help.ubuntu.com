...
<div class="note" title="Fanamarihana"><div class="inner"><div class="region"><div class="contents"><p class="p">Most networks will work fine if you leave these settings at their defaults, so you probably don't need to change any of them. Many of the options here are provided to give you greater control over more advanced networks.</p></div></div></div></div>
</div>
...
If the network has a <span class="link"><a href="net-wireless-wepwpa.html" title="What do WEP and WPA mean?">WEP/WPA password</a></span> and you have checked this option, you will only need to enter the password once.
...
<p class="p">If this option is checked, you need to be an <span class="link"><a href="user-admin-explain.html" title="How do administrative privileges work?">administrator</a></span> to change any of the settings for this network.
...
<dd class="terms"><p class="p">This is the name of the wireless network you are connecting to, otherwise known as the <span class="em">Service Set Identifier</span>.
Don't change this unless you have changed the name of the wireless network (for example,
by changing the settings of your wireless router or base station).</p></dd>
<dt class="terms"><span class="gui">Mode</span></dt>
<dd class="terms">
<p class="p">Use this to specify whether you are connecting to an <span class="gui">Infrastructure</span> network
(one where computers wirelessly connect to a central base station or router) or an <span class="gui">Ad-hoc</span> network
(where there is no base station, and the computers in the network connect to one another). Most networks are
infrastructure ones; you may wish to <span class="link"><a href="net-wireless-adhoc.html" title="Create a wireless hotspot">set-up your own ad-hoc network</a></span> though.</p>
...
<p class="p">The following methods are available:</p>
...
<div class="region"><ul><li class="links ">
<a href="net-wireless-hidden.html" title="Connect to a hidden wireless network">Connect to a hidden wireless network</a><span class="desc"> — Click the network menu on the menu bar and select Connect to Hidden Wi-Fi Network.</span>
</li></ul></div>
</div></div>
</div>
</div>
