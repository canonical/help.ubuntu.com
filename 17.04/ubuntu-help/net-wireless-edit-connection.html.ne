...
<div class="note" title="द्रष्टव्य"><div class="inner"><div class="region"><div class="contents"><p class="p">Most networks will work fine if you leave these settings at their defaults, so you probably don't need to change any of them. Many of the options here are provided to give you greater control over more advanced networks.</p></div></div></div></div>
</div>
