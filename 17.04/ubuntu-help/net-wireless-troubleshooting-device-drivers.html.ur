...
<div id="content">
<div class="links nextlinks"><a class="nextlinks-prev" href="net-wireless-troubleshooting-hardware-check.html" title="Wireless connection troubleshooter">Previous</a></div>
<div class="hgroup">
...
<div class="region">
<div class="contents">
<p class="p">In this step you can check to see if you can get working device drivers for your wireless adapter.
A <span class="em">device driver</span> is a piece of software which tells the computer how to make a hardware device
...
<p class="p">Most Linux distributions keep a list of wireless devices that they have support for. Sometimes, these lists provide extra information
  on how to get the drivers for certain adapters working properly. Go to the list for your distribution
 (for example, <span class="link"><a href="https://help.ubuntu.com/community/WifiDocs/WirelessCardsSupported" title="https://help.ubuntu.com/community/WifiDocs/WirelessCardsSupported">Ubuntu</a></span>,
 ...
 <span class="link"><a href="http://en.opensuse.org/HCL:Network_(Wireless)" title="http://en.opensuse.org/HCL:Network_(Wireless)">openSuSE</a></span>) and see if your make and model of wireless
...
<p class="p">Although Ubuntu includes support for a large amount of devices, some drivers need to be installed separately.
  Use the <span class="gui">Additional Drivers</span> tool to check for these extra open or <span class="link"><a href="hardware-driver-proprietary.html" title="What are proprietary drivers?">proprietary</a></span> drivers.</p>
...
<p class="p">In general, you cannot use a device driver designed for one operating system (like Windows) on another operating
  system (like Linux). This is because they have different ways of handling devices. For wireless adapters, however,
  you can install a compatibility layer called <span class="em">NDISwrapper</span> which lets you use some Windows wireless drivers
