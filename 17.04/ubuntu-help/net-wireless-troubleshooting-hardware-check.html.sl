...
<li class="steps"><p class="p">Odprite Terminal in vpišite <span class="cmd">sudo lshw -C network</span> in pritisnite <span class="key"><kbd>Enter</kbd></span>. Če vam ukaz vrne napako, namestite program <span class="app">lshw</span> tako, da vpišete <span class="cmd">sudo apt install lshw</span> v terminal.</p></li>
<li class="steps">
