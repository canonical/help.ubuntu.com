...
<li class="steps"><p class="p">Open de Terminal en voer de opdracht <span class="cmd">nmcli dev</span> uit om te zien of uw draadloze netwerkadapter in de lijst staat. De status zou <span class="em">verbonden</span> moeten zijn.</p></li>
</ol></div></div></div>
...
<p class="p">Als de opdracht <span class="cmd">nmcli dev</span> niet aangaf dat u met het netwerk verbonden bent, klik dan op <span class="gui">Volgende</span> om door te gaan naar het volgende deel van problemen oplossen.</p>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="net-wireless-troubleshooting.html" title="Probleemoplosser draadloos netwerk">Vorige</a><a class="nextlinks-next" href="net-wireless-troubleshooting-hardware-info.html" title="Probleemoplosser draadloos netwerk">Volgende</a>
</div>
