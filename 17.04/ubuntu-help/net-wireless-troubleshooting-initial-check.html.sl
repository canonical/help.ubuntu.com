...
<li class="steps"><p class="p">Če želite preveriti ali je vaš brezžični omrežni vmesnik na seznamu,  odprite Terminal in zaženite ukaz <span class="cmd">nmcli dev</span> . Njegovo stanje bi moralo biti <span class="em">povezano</span>.</p></li>
</ol></div></div></div>
...
<p class="p">Če ukaz <span class="cmd">nmli dev</span> ni izpisal, da ste povezani v omrežje, kliknite na <span class="gui">Naprej</span> in nadaljujte z naslednjimi koraki vodnika za odstranjevanje težav.</p>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="net-wireless-troubleshooting.html" title="Odpravljanje težav z brezžičnimi omrežji">Nazaj</a><a class="nextlinks-next" href="net-wireless-troubleshooting-hardware-info.html" title="Odpravljanje težav z brezžičnimi omrežji">Naprej</a>
</div>
