...
<li class="steps"><p class="p">Realizar una comprobación inicial</p></li>
<li class="steps"><p class="p">Recopilar información sobre su hardware</p></li>
<li class="steps"><p class="p">Comprobar su hardware</p></li>
<li class="steps"><p class="p">Intentar crear una conexión con su enrutador inalámbrico</p></li>
<li class="steps"><p class="p">Comprobar su módem y su enrutador</p></li>
</ol></div></div></div>
