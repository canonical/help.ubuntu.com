...
<li class="steps"><p class="p">Выполнение первоначальной проверки</p></li>
<li class="steps"><p class="p">Сбор информации о вашем оборудовании</p></li>
<li class="steps"><p class="p">Проверка вашего оборудования</p></li>
<li class="steps"><p class="p">Попытка создать подключение к беспроводному маршрутизатору</p></li>
<li class="steps"><p class="p">Выполнение проверки вашего модема и маршрутизатора</p></li>
</ol></div></div></div>
