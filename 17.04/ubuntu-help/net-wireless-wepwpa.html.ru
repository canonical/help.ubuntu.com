...
<title>Что означают аббревиатуры WEP и WPA?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Что означают аббревиатуры WEP и WPA?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">WEP и WPA (как и WPA2) — это названия разных инструментов шифрования, используемых для защиты вашего беспроводного соединения. Шифрование засекречивает сетевое соединение, поэтому никто не сможет «прослушать» его или, например, наблюдать, какие веб-страницы просматриваются. WEP — это сокращение от <span class="em">Wired Equivalent Privacy</span>, а WPA — <span class="em">Wireless Protected Access</span>. WPA2 — это вторая версия стандарта WPA.</p>
<p class="p">Использовать <span class="em">любое</span> шифрование всегда лучше, чем не использовать никакого. Однако WEP — наименее надёжный из этих стандартов, и если этого можно избежать, то пользоваться им не стоит. WPA2 — наиболее надёжный из этих трёх стандартов. Если ваша беспроводная карта и маршрутизатор поддерживают WPA2, то рекомендуется выбрать именно его при настройке беспроводной сети.</p>
</div>
