...
<div class="note note-important" title="Mavesa-danja"><div class="inner">
...
<li class="steps"><p class="p">After you computer turns off, switch it back on. Did your open applications
       re-open?</p></li>
</ol></div></div></div>
...
<div class="region"><ul>
<li class="links ">
<a href="shell-exit.html" title="Log out, power off, switch users">Log out, power off, switch users</a><span class="desc"> — Learn how to leave your user account, by logging out, switching users,
    and so on.</span>
</li>
<li class="links ">
