...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">¿Mi equipo funcionará con una fuente de energía en otro país?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Otros países utilizan suministros de energía de diferentes voltajes (generalmente 110V o 220-240V) y frecuencias AC (generalmente 50 Hz o 60 Hz). El equipo debería funcionar en otro país con un transformador adecuado de corriente. Puede necesitar también un adaptador de clavija de pared (enchufe).</p>
<p class="p">Si tiene un portátil, todo lo que necesita hacer es conseguir el enchufe adecuado para su adaptador de corriente. Muchos portátiles se entregan con más de un enchufe para su adaptador, así que puede que ya tenga el adecuado. Si no es así, conectar el existente en un adaptador de viaje estándar será suficiente.</p>
<p class="p">Si tiene un equipo de escritorio, también puede obtener un cable con un enchufe diferente, o utilizar un adaptador de viaje. En este caso, sin embargo, es posible que necesite cambiar el interruptor de voltaje en la fuente de alimentación del equipo, si es que existe. Muchos equipos no tienen un interruptor de este tipo, y trabajará sin problemas con cualquier tensión. Mire la parte posterior del equipo y busque el zócalo del cable de alimentación. En algún lugar cercano, puede haber un pequeño interruptor marcado con «110» o «230» (por ejemplo). Conmútelo si es necesario.</p>
<div class="note note-warning" title="Advertencia"><div class="inner"><div class="region"><div class="contents"><p class="p">Tenga cuidado al cambiar los cables de alimentación o al usar adaptadores de viaje. Si es posible, apague todo en primer lugar.</p></div></div></div></div>
</div>
