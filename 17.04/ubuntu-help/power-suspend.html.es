...
<title>¿Qué ocurre si suspendo mi equipo?</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">¿Qué ocurre si suspendo mi equipo?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Cuando <span class="em">suspende</span> el equipo, lo envía a un estado de reposo. Todas sus aplicaciones y archivos continúan abiertos, pero la pantalla y otras partes del equipo se apagan para ahorrar energía. Aun así, el equipo permanece encendido, y sigue utilizando una pequeña cantidad de energía. Puede reactivarlo presionando una tecla o pulsando con el ratón. Si eso no funciona, pruebe a presionar el botón de encendido.</p>
<p class="p">Algunos equipos tienen problemas con el soporte del hardware, significa que <span class="link"><a href="power-suspendfail.html" title="¿Por qué mi equipo no se enciende después de suspenderlo?">pueden no ser capaces de suspender o hibernar adecuadamente</a></span>. Es una buena idea probar la suspensión en el equipo para ver sí funciona antes de contar con ello.</p>
<div class="note note-important" title="Importante"><div class="inner">
<div class="title title-note"><h2><span class="title">Siempre guarde su trabajo antes de la suspensión</span></h2></div>
<div class="region"><div class="contents"><p class="p">Usted debería guardar todo su trabajo antes de suspender el equipo, solo en caso de que algo salga mal y no se puedan recuperar sus aplicaciones y documentos abiertos cuando reactive de nuevo el equipo.</p></div></div>
</div></div>
</div>
