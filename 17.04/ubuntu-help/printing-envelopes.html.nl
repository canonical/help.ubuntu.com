...
<title>Enveloppen en etiketten afdrukken</title>
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Enveloppen en etiketten afdrukken</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Bij de meeste printers kunt u rechtstreeks op een envelop of etikettenvel afdrukken. Dit is vooral nuttig als u bijvoorbeeld een heleboel brieven te versturen heeft.</p></div>
...
<p class="p">Er zijn twee dingen waar u op moet letten als u iets wilt afdrukken op een envelop. Ten eerste dat uw printer weet wat de grootte van de envelop is. Nadat u op <span class="gui">Afdrukken</span> heeft geklikt en het afdrukvenster wordt geopend, gaat u naar het tabblad <span class="gui">Pagina-instellingen</span> en selecteert u "Envelop" in het keuzemenu <span class="gui">Papiersoort</span>, als het mogelijk is. Indien dit niet mogelijk is, kijk dan of het mogelijk is om een envelopgrootte te selecteren in het keuzemenu <span class="gui">Papiergrootte</span> (b.v. "C5"). Op de envelopverpakking kunt u de grootte terugvinden; de meeste enveloppen hebben standaardgroottes.</p>
...
<div class="region"><ul><li class="links "><a href="printing.html#paper" title="Verschillende papierformaten en indelingen">Verschillende papierformaten en indelingen</a></li></ul></div>
</div></div></div>
</div>
</div>
<div class="clear"></div>
