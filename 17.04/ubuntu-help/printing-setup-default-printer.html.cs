...
<div class="region">
<div class="contents">
<p class="p">Pokud máte více jak jednu tiskárnu, můžete si nastavit, která bude výchozí. Patrně budete chtít vybrat tu, kterou používáte nejčastěji.</p>
...
<li class="steps"><p class="p">V seznamu dostupných tiskáren klikněte pravým tlačítkem na tu, kterou si přejete nastavit jako výchozí a vyberte <span class="gui">Nastavit jako výchozí</span>.</p></li>
</ol></div></div></div>
...
<p class="p">Když budete tisknout z nějaké aplikace, automaticky se vybere tiskárna nastavena jako výchozí. Pokud budete chtít použít jinou tiskárnu, bude ji muset pro danou úlohu zvolit ručně.</p>
</div>
