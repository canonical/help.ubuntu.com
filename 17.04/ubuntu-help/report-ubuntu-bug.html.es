...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Informar de un problema en Ubuntu</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents"><p class="p">Si recibe el mensaje de error «Este no es un paquete de Ubuntu auténtico», significa que el programa para el que está intentando notificar un fallo no proviene de los repositorios oficiales de Ubuntu. En tal caso, no podrá usar la herramienta integrada de notificación de fallos de Ubuntu.</p></div></div></div></div>
...
<div class="region"><ul><li class="links ">
<a href="get-involved.html" title="Participe para mejorar esta guía">Participe para mejorar esta guía</a><span class="desc"> — Cómo y dónde informar errores en estos temas de ayuda.</span>
</li></ul></div>
</div></div>
</div>
</div>
