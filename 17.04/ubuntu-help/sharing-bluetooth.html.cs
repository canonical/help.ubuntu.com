...
<p class="p">You can allow access to your <span class="file">Public</span> and
  ...
  computer.</p>
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents"><p class="p">A Bluetooth device is <span class="em">trusted</span> if you have <span class="em">paired</span>, or
    connected your computer to it. See
    <span class="link"><a href="bluetooth-connect-device.html" title="Spojení počítače se zařízením s Bluetooth">Spojení počítače se zařízením s Bluetooth</a></span>.</p></div></div></div></div>
...
<div class="region"><ul><li class="links ">
<a href="bluetooth-connect-device.html" title="Spojení počítače se zařízením s Bluetooth">Spojení počítače se zařízením s Bluetooth</a><span class="desc"> — Párování Bluetooth zařízení.</span>
</li></ul></div>
</div></div>
</div>
</div>
