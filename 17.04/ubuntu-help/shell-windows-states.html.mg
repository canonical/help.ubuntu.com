...
<div class="list"><div class="inner"><div class="region"><ul class="list" style="list-style-type:disc"><li class="list"><p class="p">Click on it in the <span class="link"><a href="unity-launcher-intro.html" title="Use the Launcher to start applications">Launcher</a></span>
...
<div class="region"><div class="contents">
<div class="note note-important" title="Mavesa-danja"><div class="inner"><div class="region"><div class="contents"><p class="p">A window cannot be resized if it is <span class="em">maximized</span>.</p></div></div></div></div>
<p class="p">To resize your window horizontally and/or vertically:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list" style="list-style-type:disc"><li class="list"><p class="p">Move the mouse pointer into any corner of the window until it changes into a
...
<div class="list"><div class="inner"><div class="region"><ul class="list" style="list-style-type:disc"><li class="list"><p class="p">Move the mouse pointer to either side of the window until it changes into a
...
<div class="list"><div class="inner"><div class="region"><ul class="list" style="list-style-type:disc"><li class="list"><p class="p">Move the mouse pointer to the top or bottom of the window until it changes
...
<li class="steps"><p class="p">Click on the <span class="gui">title bar</span> of a window and drag it toward the
...
<li class="steps"><p class="p">Drag another window to the right side: when the right half of the
  screen is highlighted, release. Each of the two windows fills half the
  screen.</p></li>
</ol></div></div></div>
<div class="note note-tip" title="Fikafika"><div class="inner"><div class="region"><div class="contents"><p class="p">Pressing <span class="key"><kbd>Alt</kbd></span> + click anywhere in a window will allow you to
...
<div class="region"><ul><li class="links "><a href="shell-windows.html#working-with-windows" title="Working with windows">Working with windows</a></li></ul></div>
</div></div>
