...
<p class="p">Om het waarschuwingsgeluid helemaal uit te schakelen kiest u voor <span class="gui">Dempen</span> naast <span class="gui">Waarschuwingsvolume</span>.</p>
</div>
...
<div class="region"><ul><li class="links ">
<a href="a11y-visualalert.html" title="Scherm laten knipperen bij alerteringsgeluiden">Scherm laten knipperen bij alerteringsgeluiden</a><span class="desc"> — Visuele alertering inschakelen om het scherm of het venster te laten knipperen wanneer er een alerteringsgeluid klinkt.</span>
</li></ul></div>
</div></div>
</div>
</div>
