...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Se escuchan chisporroteos o zumbidos al reproducir sonidos</span></h1></div>
<div class="region">
<div class="contents">
...
<li class="list">
<p class="p">Asegúrese de que el cable de los altavoces/auriculares no está dañado.</p>
...
<li class="list">
<p class="p">Compruebe si los controladores de sonido no son muy buenos.</p>
<p class="p">Algunas tarjetas de sonido no funcionan muy bien con Linux porque no disponen de buenos controladores. Este problema es más difícil de identificar. Pruebe buscando en Internet la marca y el modelo de su tarjeta de sonido, añadiendo el término «Ubuntu» para ver si otras personas tienen el mismo problema.</p>
<p class="p">Puede ejecutar <span class="cmd">sudo lspci -v</span> en el <span class="app">Terminal</span> para obtener más información sobre su tarjeta de sonido.</p>
</li>
</ul></div></div></div>
</div>
