...
<li class="steps"><p class="p">Gebruik <span class="link"><a href="unity-dash-intro.html" title="Toepassingen, bestanden, muziek en meer zoeken met de Snelzoeker">de Snelzoeker</a></span> om <span class="gui">Opstarttoepassingen</span> te zoeken en te openen. U kunt ook drukken op <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>F2</kbd></span></span> en de opdracht <span class="cmd">gnome-session-properties</span> uitvoeren.</p></li>
