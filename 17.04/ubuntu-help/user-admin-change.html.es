...
<li class="steps"><p class="p">Pulse <span class="gui">Desbloquear</span> e introduzca su contraseña para desbloquear la configuración de la cuenta. (Para dar privilegios de administrador a un usuario, usted debe tener esos mismos privilegios.)</p></li>
<li class="steps"><p class="p">Seleccione el usuario cuyos privilegios quiere cambiar</p></li>
<li class="steps"><p class="p">Haga clic sobre la etiqueta <span class="gui">Estándar</span> junto a <span class="gui">Tipo de cuenta</span> y seleccione <span class="gui">Administrador</span>.</p></li>
<li class="steps"><p class="p">Cierre la ventana de Cuentas de usuario. Los privilegios del usuario se cambiarán la próxima vez que inicie la sesión.</p></li>
</ol></div></div></div>
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
<p class="p">La primera cuenta de usuario en el sistema cuenta con privilegios de administrador. Esta es la cuenta de usuario que se creó cuando se instaló por primera vez el sistema.</p>
<p class="p">No es deseable tener demasiados usuarios con privilegios de <span class="gui">Administrador</span> en un sistema.</p>
</div></div></div></div>
</div>
