...
<li class="steps"><p class="p">Open the <span class="link"><a href="files-browse.html" title="Browse files and folders">file manager</a></span>.</p></li>
<li class="steps"><p class="p">Right-click on video file and select <span class="gui">Properties</span>.</p></li>
<li class="steps"><p class="p">Go to the <span class="gui">Audio/Video</span> tab and look at which
...
<div class="note" title="Fanamarihana"><div class="inner"><div class="region"><div class="contents"><p class="p">There are a few other problems which might prevent someone from playing
