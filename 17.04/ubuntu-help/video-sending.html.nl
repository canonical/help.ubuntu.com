...
<li class="steps"><p class="p">Klik met uw rechtermuisknop op het videobestand en selecteer daarna <span class="gui">Eigenschappen</span>.</p></li>
<li class="steps"><p class="p">Ga naar het tabblad <span class="gui">Audio/Video</span> en kijk welke <span class="gui">codec</span> er bij <span class="gui">Video</span>staat.</p></li>
</ol></div></div></div>
...
<p class="p">Als u niet de juiste codec kunt vinden, probeer dan <span class="link"><a href="http://www.videolan.org/vlc/" title="http://www.videolan.org/vlc/">VLC Mediaspeler</a></span>. Het werkt op Windows, Mac OS en Linux en ondersteunt vele verschillende videoformaten. U kunt ook proberen uw video te converteren naar een ander formaat. De meeste video-editors kunnen dit, maar er zijn ook specifieke videoconverteertoepassingen beschikbaar. Kijk in <span class="app">Ubuntu Software</span> wat er te krijgen is.</p>
