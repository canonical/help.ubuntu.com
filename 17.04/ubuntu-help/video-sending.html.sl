...
<li class="steps"><p class="p">Desno kliknite na video datoteko in izberite <span class="gui">Lastnosti</span>.</p></li>
<li class="steps"><p class="p">Pojdite v zavihek <span class="gui">Zvok/Video</span> in preverite kateri <span class="gui">kodek</span> je naveden pod <span class="gui">Video</span>.</p></li>
</ol></div></div></div>
