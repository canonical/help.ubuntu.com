...
<li class="steps"><p class="p">Seznam služeb, které jsou dostupné u tohoto účtu bude zobrazen u <span class="gui">Použít pro</span>. Podívejte se na <span class="link"><a href="accounts-which-application.html" title="Služby a aplikace on-line">Služby a aplikace on-line</a></span>, které aplikace přistupují ke kterým účtům.</p></li>
...
<div class="region"><ul>
<li class="links ">
<a href="accounts-remove.html" title="Odebrání účtu">Odebrání účtu</a><span class="desc"> — Jak z aplikace odebrat přístup k poskytovateli služby on-line.</span>
</li>
<li class="links ">
<a href="accounts-which-application.html" title="Služby a aplikace on-line">Služby a aplikace on-line</a><span class="desc"> — Aplikace mohou používat účty vytvořené v <span class="app">Účtech on-line</span> a služby, které nabízí.</span>
</li>
</ul></div>
</div></div>
</div>
