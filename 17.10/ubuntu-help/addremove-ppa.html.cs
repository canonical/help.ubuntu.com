...
<div class="region"><ul><li class="links ">
<a href="addremove-sources.html" title="Přidávání zdrojů softwaru">Přidávání zdrojů softwaru</a><span class="desc"> — Přidejte repozitáře pro rozšíření zdrojů softwaru, které Ubuntu používá pro instalaci a aktualizaci.</span>
</li></ul></div>
</div></div>
</div>
</div>
