...
<p class="p">Позже при необходимости вы сможете повторно <span class="link"><a href="bluetooth-connect-device.html" title="Соединение компьютера с устройством Bluetooth">подключиться к устройству Bluetooth</a></span>.</p>
</div>
