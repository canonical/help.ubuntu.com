...
<p class="p">При выборе другого местоположения время будет обновлено автоматически. Также можно <span class="link"><a href="clock-set.html" title="Изменение даты и времени">установить время вручную</a></span>.</p>
</div>
