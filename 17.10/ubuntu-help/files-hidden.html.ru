...
<p class="p">To hide a file, <span class="link"><a href="files-rename.html" title="Переименование файла или папки">rename it</a></span> with a
...
<a href="files-tilde.html" title="What is a file with a ~ at the end of its name?">What is a file with a <span class="file">~</span> at the end of its name?</a><span class="desc"> — Это резервные копии файлов. По умолчанию они скрыты.</span>
</li></ul></div>
</div></div>
</div>
</div>
