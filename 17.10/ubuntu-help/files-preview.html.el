...
<a href="nautilus-preview.html" title="Προτιμήσεις προεπισκόπησης του διαχειριστή αρχείων">Προτιμήσεις προεπισκόπησης του διαχειριστή αρχείων</a><span class="desc"> — Ελέγξτε πότε οι μικρογραφίες χρησιμοποιούνται για τα αρχεία.</span>
</li></ul></div>
</div></div>
</div>
</div>
