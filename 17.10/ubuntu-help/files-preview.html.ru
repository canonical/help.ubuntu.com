...
<a href="nautilus-preview.html" title="Параметры вкладки Образцы менеджера файлов">Параметры вкладки <span class="gui">Образцы</span> менеджера файлов</a><span class="desc"> — Настройки миниатюр для файлов.</span>
</li></ul></div>
</div></div>
</div>
</div>
