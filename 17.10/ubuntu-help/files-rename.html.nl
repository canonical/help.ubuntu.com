...
<div class="note note-warning" title="Waarschuwing"><div class="inner"><div class="region"><div class="contents"><p class="p">Als u een bestandsnaam met een <span class="file">.</span> als eerste teken opgeeft, dan zal het bestand <span class="link"><a href="files-hidden.html" title="Een bestand verbergen">verborgen</a></span> zijn wanneer u probeert het in bestandsbeheer te zien te krijgen.</p></div></div></div></div>
</div></div>
</div></div>
