...
<a class="nextlinks-prev" href="gs-browse-web.html" title="Путешествие по Интернету">Назад</a><a class="nextlinks-next" href="gs-change-date-time-timezone.html" title="Смена даты, времени и часового пояса">Вперёд</a>
</div>
