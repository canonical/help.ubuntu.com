...
<div class="hgroup"><h2 class="title"><span class="title">Buscar desde las aplicaciones</span></h2></div>
<div class="region"><div class="contents"><p class="p">El sistema de búsqueda añade resultados de varias aplicaciones. En la parte izquierda de los resultados de búsqueda, puede ver iconos de las aplicaciones que proporcionan los resultados. Pulse en uno de esos iconos para reiniciar la búsqueda desde la aplicación asociada a ese icono. Dado que en la <span class="gui">Vista de actividades</span> sólo se muestran los resultados más relevantes, la búsqueda desde la aplicación le puede proporcionar mejores resultados.</p></div></div>
</div></div>
<div id="use-search-customize" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Personalizar los resultados de búsqueda</span></h2></div>
