...
<a class="nextlinks-prev" href="gs-switch-tasks.html" title="Переключение между задачами">Назад</a><a class="nextlinks-next" href="gs-use-system-search.html" title="Использование системного поиска">Вперёд</a>
</div>
