...
<td style="border-top-style: solid;"><p class="p">Cyklicky procházet okna v rámci stejné aplikace. Držte zmáčknutou klávesu <span class="key"><kbd>Alt</kbd></span> a mačkejte <span class="key"><kbd>F6</kbd></span> dokud se nezvýrazní okno, které chcete, a pak <span class="key"><kbd>Alt</kbd></span> pusťte. Je to podobné jako funkce <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>`</kbd></span></span>.</p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>Esc</kbd></span></span></p></td>
<td style="border-top-style: solid;"><p class="p">Cyklicky procházet všechna otevřená okna v rámci pracovní plochy.</p></td>
</tr>
<tr>
