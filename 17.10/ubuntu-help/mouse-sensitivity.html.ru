...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Настройка скорости мыши и сенсорной панели</span></h1></div>
<div class="region">
<div class="contents">
...
<li class="steps"><p class="p">С помощью ползунка <span class="gui">Скорость указателя</span> настройте комфортную для вас скорость перемещения курсора. Для каждого устройства указателя, такого, как мышь или сенсорная панель, имеется ползунок.</p></li>
</ol></div></div></div>
<p class="p">You can set different pointer speed for each type of device. For example,
  you can have one scroll speed for a laptop touchpad and another for a mouse.
  Sometimes the most comfortable settings for one type of device are not the
  best for another.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Раздел <span class="gui">Сенсорная панель</span> появится только если в вашей системе есть сенсорная панель. Раздел <span class="gui">Мышь</span> виден, только если ваша мышь подключена.</p></div></div></div></div>
</div>
