...
<p class="p">В подписях к значкам можно отобразить ту же информацию, что и в столбцах при просмотре в виде списка. Подробнее смотрите <span class="link"><a href="nautilus-list.html" title="Files list columns preferences">Files list columns preferences</a></span>.</p>
</div></div>
</div></div>
