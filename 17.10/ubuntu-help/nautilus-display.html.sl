...
<p class="p">Podatki, ki jih lahko pokažete v sličicah ikon so enaki kot stolpci, ki jih lahko uporabite v seznamskem pogledu. Za več podrobnosti si oglejte <span class="link"><a href="nautilus-list.html" title="Files list columns preferences">Files list columns preferences</a></span>.</p>
</div></div>
</div></div>
