...
<div class="region"><ul><li class="links ">
<a href="net-wireless-find.html" title="No puedo ver mi red inalámbrica en la lista">No puedo ver mi red inalámbrica en la lista</a><span class="desc"> — El hardware inalámbrico puede estar apagado o roto, o puede estar intentando conectarse a una red oculta.</span>
</li></ul></div>
</div></div>
</div>
</div>
