...
<li class="links ">
<a href="power-batteryslow.html" title="Waarom is mijn laptop traag als het op accuspanning loopt?">Waarom is mijn laptop traag als het op accuspanning loopt?</a><span class="desc"> — Sommige laptops werken opzettelijk langzamer wanneer ze op de accu lopen.</span>
</li>
</ul></div>
</div></div>
</div>
