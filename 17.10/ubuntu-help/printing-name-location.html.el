...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents"><p class="p">Χρειάζεστε <span class="link"><a href="user-admin-explain.html" title="Πώς δουλεύουν τα δικαιώματα διαχειριστή;">δικαιώματα διαχειριστή</a></span> στο σύστημα για να αλλάξετε το όνομα ή την θέση ενός εκτυπωτή.</p></div></div></div></div>
</div>
