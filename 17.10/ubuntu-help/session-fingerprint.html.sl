...
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Save any open work, and then <span class="link"><a href="shell-exit.html#logout" title="Odjava ali preklop uporabnika">log
      out</a></span>.</p></li>
...
<a href="hardware-auth.html" title="Pametne kartice in bralniki prstnih odtisov">Pametne kartice in bralniki prstnih odtisov</a><span class="desc"> — <span class="link"><a href="session-fingerprint.html" title="Prijava s prstnim odtisom">Bralniki prstnih odtisov</a></span>, pametne kartice ...</span>
</li></ul></div>
</div></div></div>
</div>
</div>
