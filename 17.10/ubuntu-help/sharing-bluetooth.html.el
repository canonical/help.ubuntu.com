...
<li class="steps"><p class="p">Σιγουρευτείτε ότι το <span class="link"><a href="bluetooth-turn-on-off.html" title="Ενεργοποίηση ή απενεργοποίηση του bluetooth"><span class="gui">Bluetooth</span> είναι ανοιχτό</a></span>.</p></li>
...
<div class="note note-tip" title="Συμβουλή"><div class="inner"><div class="region"><div class="contents"><p class="p">Μπορείτε να <span class="link"><a href="sharing-displayname.html" title="Ορισμός του ονόματος εμφάνισης για τον υπολογιστή σας">αλλάξετε</a></span> το όνομα των οθονών του υπολογιστή σας σε άλλες συσκευές.</p></div></div></div></div>
</div>
