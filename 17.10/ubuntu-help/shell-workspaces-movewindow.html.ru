...
<li class="steps"><p class="p">The <span class="em"><a href="shell-workspaces.html" title="Что такое рабочее место, и для чего оно нужно?">workspace selector</a></span> will
      appear.</p></li>
...
<li class="steps"><p class="p">Select the window that you want to move (for example, using the
      ...
      <span class="em"><a href="shell-windows-switching.html" title="Переключение между окнами">window switcher</a></span>).</p></li>
<li class="steps">
