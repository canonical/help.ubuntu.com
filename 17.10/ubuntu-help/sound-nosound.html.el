...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Δε μπορώ να ακούσω κανέναν ήχο στον υπολογιστή</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Αν δεν ακούτε κανέναν ήχο στον υπολογιστή σας, για παράδειγμα όταν παίζετε μουσική, ακολουθήστε τις ακόλουθες συμβουλές.</p></div>
...
<li class="steps"><p class="p">Ανοίξτε τις <span class="app">Ρυθμίσεις</span> από την επισκόπηση <span class="gui">Δραστηριότητες</span>.</p></li>
<li class="steps"><p class="p">Πατήστε <span class="gui">ήχος</span>.</p></li>
<li class="steps"><p class="p">Μεταβείτε στην καρτέλα <span class="gui">Εφαρμογές</span> και ελέγξτε ότι η εφαρμογή σας δεν είναι σε σίγαση.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
...
<p class="p">Αν αυτό δεν δουλέψει, δοκιμάστε να κάνετε το ίδιο για κάθε άλλη συσκευή που είναι καταχωρισμένη.</p>
</li>
</ol></div></div></div>
</div></div>
</div></div>
<div id="hardware-detected" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Ελέγξετε ότι η κάρτα ήχου ανιχνεύτηκε σωστά</span></h2></div>
<div class="region"><div class="contents">
