...
<div class="region">
<div class="contents">
<p class="p">Do počítače můžete <span class="link"><a href="user-add.html" title="Přidání nového uživatelského účtu">přidat více uživatelských účtu</a></span>. Naopak, když někdo počítač již nadále nebudu používat, můžete jeho uživatelský účet smazat.</p>
<p class="p">Abyste mohli odstranit účet uživatele, potřebujete <span class="link"><a href="user-admin-explain.html" title="Jak fungují oprávnění správce?">oprávnění správce</a></span>.</p>
...
<li class="links ">
<a href="user-add.html" title="Přidání nového uživatelského účtu">Přidání nového uživatelského účtu</a><span class="desc"> — Jak přidat nové uživatele, aby se další lidé mohli přihlásit k počítači.</span>
</li>
</ul></div>
</div></div>
</div>
