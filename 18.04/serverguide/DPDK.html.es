...
<a class="nextlinks-prev" href="NTP.html.es" title="Time Synchronization">Anterior</a><a class="nextlinks-next" href="dm-multipath-chapter.html.es" title="DM-Multipath">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-prerequisites" title="Prerequisitos">Prerequisitos</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-config-dev" title="DPDK Device configuration">DPDK Device configuration</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-config-hp" title="DPDK HugePage configuration">DPDK HugePage configuration</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-apps" title="Compile DPDK Applications">Compile DPDK Applications</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-openvswitch" title="OpenVswitch-DPDK">OpenVswitch-DPDK</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-openvswitch-guest" title="OpenVswitch DPDK to KVM Guests">OpenVswitch DPDK to KVM Guests</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-in-guest" title="DPDK in KVM Guests">DPDK in KVM Guests</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#ovs-dpdk-tuning" title="Tuning Openvswitch-DPDK">Tuning Openvswitch-DPDK</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-support" title="Soporte y resolución de problemas">Soporte y resolución de problemas</a></li>
<li class="links"><a class="xref" href="DPDK.html.es#dpdk-references" title="Recursos">Recursos</a></li>
</ul></div>
<div class="sect2 sect" id="dpdk-prerequisites"><div class="inner">
<div class="hgroup"><h2 class="title">Prerequisitos</h2></div>
...
<div class="hgroup"><h2 class="title">Soporte y resolución de problemas</h2></div>
<div class="region"><div class="contents">
<p class="para">
