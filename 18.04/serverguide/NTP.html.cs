...
<a class="nextlinks-prev" href="dhcp.html.cs" title="Dynamic Host Configuration Protocol (DHCP)">Předchozí</a><a class="nextlinks-next" href="DPDK.html.cs" title="Data Plane Development Kit">Následující</a>
</div>
...
<p class="para">
        Ubuntu by default uses <span class="em emphasis">timedatectl / timesyncd</span> to synchronize time and users can optionally use chrony to <a class="xref" href="NTP.html.cs#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a>.
</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="NTP.html.cs#timedate-info" title="Synchronizing your systems time">Synchronizing your systems time</a></li>
<li class="links"><a class="xref" href="NTP.html.cs#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a></li>
<li class="links"><a class="xref" href="NTP.html.cs#ntp-references" title="References">References</a></li>
</ul></div>
