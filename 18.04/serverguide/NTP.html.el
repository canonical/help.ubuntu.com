...
<a class="nextlinks-prev" href="dhcp.html.el" title="Πρωτόκολλο Δυναμικής Διαμόρφωσης Κεντρικού Υπολογιστή (Dynamic Host Configuration Protocol (DHCP))">Προηγούμενο</a><a class="nextlinks-next" href="DPDK.html.el" title="Data Plane Development Kit">Επόμενο</a>
</div>
...
<p class="para">
        Ubuntu by default uses <span class="em emphasis">timedatectl / timesyncd</span> to synchronize time and users can optionally use chrony to <a class="xref" href="NTP.html.el#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a>.
</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="NTP.html.el#timedate-info" title="Synchronizing your systems time">Synchronizing your systems time</a></li>
<li class="links"><a class="xref" href="NTP.html.el#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a></li>
<li class="links"><a class="xref" href="NTP.html.el#ntp-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
