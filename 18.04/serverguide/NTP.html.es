...
<a class="nextlinks-prev" href="dhcp.html.es" title="Dynamic Host Configuration Protocol (DHCP)">Anterior</a><a class="nextlinks-next" href="DPDK.html.es" title="Data Plane Development Kit">Siguiente</a>
</div>
...
<p class="para">
        Ubuntu by default uses <span class="em emphasis">timedatectl / timesyncd</span> to synchronize time and users can optionally use chrony to <a class="xref" href="NTP.html.es#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a>.
</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="NTP.html.es#timedate-info" title="Synchronizing your systems time">Synchronizing your systems time</a></li>
<li class="links"><a class="xref" href="NTP.html.es#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a></li>
<li class="links"><a class="xref" href="NTP.html.es#ntp-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<div class="hgroup"><h3 class="title">Ver el estado</h3></div>
<div class="region"><div class="contents">
<p class="para">
