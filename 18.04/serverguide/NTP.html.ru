...
<a class="nextlinks-prev" href="dhcp.html.ru" title="Протокол динамической настройки хостов (Dynamic Host Configuration Protocol, DHCP)">Назад</a><a class="nextlinks-next" href="DPDK.html.ru" title="Data Plane Development Kit">Вперёд</a>
</div>
...
<p class="para">
        Ubuntu by default uses <span class="em emphasis">timedatectl / timesyncd</span> to synchronize time and users can optionally use chrony to <a class="xref" href="NTP.html.ru#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a>.
</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="NTP.html.ru#timedate-info" title="Synchronizing your systems time">Synchronizing your systems time</a></li>
<li class="links"><a class="xref" href="NTP.html.ru#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a></li>
<li class="links"><a class="xref" href="NTP.html.ru#ntp-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<div class="hgroup"><h3 class="title">Просмотр статуса</h3></div>
<div class="region"><div class="contents">
<p class="para">
