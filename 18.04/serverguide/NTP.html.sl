...
<a class="nextlinks-prev" href="dhcp.html.sl" title="Dynamic Host Configuration Protocol (DHCP)">Nazaj</a><a class="nextlinks-next" href="DPDK.html.sl" title="Data Plane Development Kit">Naprej</a>
</div>
...
<p class="para">
        Ubuntu by default uses <span class="em emphasis">timedatectl / timesyncd</span> to synchronize time and users can optionally use chrony to <a class="xref" href="NTP.html.sl#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a>.
</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="NTP.html.sl#timedate-info" title="Synchronizing your systems time">Synchronizing your systems time</a></li>
<li class="links"><a class="xref" href="NTP.html.sl#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a></li>
<li class="links"><a class="xref" href="NTP.html.sl#ntp-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<li class="list itemizedlist">
  	    <p class="para">Za več podatkov si oglejte stran <a href="https://help.ubuntu.com/community/UbuntuTime" class="ulink" title="https://help.ubuntu.com/community/UbuntuTime">Čas Ubuntu na Ubuntu Wiki</a>.</p>
      </li>
</ul></div></div></div>
</div></div>
</div>
