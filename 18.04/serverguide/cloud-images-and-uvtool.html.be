...
<a class="nextlinks-prev" href="qemu.html.be" title="Qemu">Назад</a><a class="nextlinks-next" href="ubuntucloud.html.be" title="Ubuntu Cloud">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Cloud images and uvtool</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.be#cloud-image-introduction" title="Уводзіны">Уводзіны</a></li>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.be#creating-virtual-machines-using-uvtool" title="Creating virtual machines using uvtool">Creating virtual machines using uvtool</a></li>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.be#resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<div class="region"><div class="contents">
<p class="para">If you are interested in learning more, have questions or
      suggestions, please contact the Ubuntu Server Team at:</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
          <p class="para">IRC: канал #ubuntu-server на freenode</p>
        </li>
<li class="list itemizedlist">
          <p class="para">Mailing list: <a href="https://lists.ubuntu.com/mailman/listinfo/ubuntu-server" class="ulink" title="https://lists.ubuntu.com/mailman/listinfo/ubuntu-server">ubuntu-server
          at lists.ubuntu.com</a></p>
        </li>
</ul></div>
</div></div>
</div></div>
