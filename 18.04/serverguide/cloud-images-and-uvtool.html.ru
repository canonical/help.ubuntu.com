...
<a class="nextlinks-prev" href="qemu.html.ru" title="Qemu">Назад</a><a class="nextlinks-next" href="ubuntucloud.html.ru" title="Облако Ubuntu">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Облачные образы и uvtool</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.ru#cloud-image-introduction" title="Введение">Введение</a></li>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.ru#creating-virtual-machines-using-uvtool" title="Создание виртуальных машин с помощью uvtool">Создание виртуальных машин с помощью uvtool</a></li>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.ru#resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
