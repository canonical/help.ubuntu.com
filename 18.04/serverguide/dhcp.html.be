...
<a class="nextlinks-prev" href="tcpip.html.be" title="TCP/IP">Назад</a><a class="nextlinks-next" href="NTP.html.be" title="Time Synchronization">Наперад</a>
</div>
...
<div class="list itemizedlist"><ul class="list itemizedlist compact">
<li class="list itemizedlist">
                    <p class="para">Імя вузла</p>
                </li>
<li class="list itemizedlist">
                    <p class="para">Імя дамена</p>
                </li>
<li class="list itemizedlist">
                    <p class="para">Time Server</p>
                </li>
<li class="list itemizedlist">
                    <p class="para">Сэрвер друку</p>
                </li>
</ul></div>
<p class="para">
...
<li class="links"><a class="xref" href="dhcp.html.be#dhcp-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="dhcp.html.be#dhcp-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="dhcp.html.be#dhcp-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
