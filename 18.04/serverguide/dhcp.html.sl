...
<a class="nextlinks-prev" href="tcpip.html.sl" title="TCP/IP">Nazaj</a><a class="nextlinks-next" href="NTP.html.sl" title="Time Synchronization">Naprej</a>
</div>
...
<li class="list itemizedlist">
                    <p class="para">Ime domene</p>
                </li>
<li class="list itemizedlist">
                    <p class="para">Time Server</p>
                </li>
<li class="list itemizedlist">
                    <p class="para">Tiskalniški strežnik</p>
                </li>
</ul></div>
<p class="para">
...
<li class="links"><a class="xref" href="dhcp.html.sl#dhcp-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="dhcp.html.sl#dhcp-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="dhcp.html.sl#dhcp-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<li class="list itemizedlist">
              <p class="para">Stran <a href="https://help.ubuntu.com/community/dhcp3-server" class="ulink" title="https://help.ubuntu.com/community/dhcp3-server">dhcp3-server na Ubuntu Wiki</a> ima več podatkov.</p>
            </li>
<li class="list itemizedlist">
              <p class="para">
