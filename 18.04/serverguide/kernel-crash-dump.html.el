...
<a class="nextlinks-prev" href="advanced-installation.html.el" title="Εγκατάσταση για προχωρημένους">Προηγούμενο</a><a class="nextlinks-next" href="package-management.html.el" title="Διαχείριση Πακέτων">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html.el#kernel-dump-introduction" title="Εισαγωγή">Εισαγωγή</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.el#kernel-crash-dump-mechanisms" title="Kernel Crash Dump Mechanism">Kernel Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.el#Installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.el#kernel-dump-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.el#verification" title="Έλεγχος">Έλεγχος</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.el#kdump-testing" title="Testing the Crash Dump Mechanism">Testing the Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.el#kdump-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
