...
<a class="nextlinks-prev" href="advanced-installation.html.es" title="Instalación avanzada">Anterior</a><a class="nextlinks-next" href="package-management.html.es" title="Gestión de paquetes">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html.es#kernel-dump-introduction" title="Introducción">Introducción</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.es#kernel-crash-dump-mechanisms" title="Kernel Crash Dump Mechanism">Kernel Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.es#Installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.es#kernel-dump-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.es#verification" title="Verificación">Verificación</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.es#kdump-testing" title="Testing the Crash Dump Mechanism">Testing the Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.es#kdump-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<li class="list itemizedlist"><p class="para">Fallo de hardware</p></li>
<li class="list itemizedlist"><p class="para">Intervención manual</p></li>
</ul></div>
...
<p class="para">
    ...
    range=start-[end] «start» es inclusivo y «end» es esclusivo.
        </pre></div>
	</p>
<p class="para"> 
...
<p class="para">Los valores de arriba significan:</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
...
<li class="list itemizedlist">
              <p class="para"><a href="http://www.kernel.org/doc/Documentation/kdump/kdump.txt" class="ulink" title="http://www.kernel.org/doc/Documentation/kdump/kdump.txt">Documentación del núcleo Kdump</a>.</p>
            </li>
<li class="list itemizedlist">
              <p class="para">
