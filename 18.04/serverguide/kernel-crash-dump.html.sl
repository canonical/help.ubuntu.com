...
<a class="nextlinks-prev" href="advanced-installation.html.sl" title="Napredna namestitev">Nazaj</a><a class="nextlinks-next" href="package-management.html.sl" title="Upravljanje paketov">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html.sl#kernel-dump-introduction" title="Uvod">Uvod</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.sl#kernel-crash-dump-mechanisms" title="Kernel Crash Dump Mechanism">Kernel Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.sl#Installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.sl#kernel-dump-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.sl#verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.sl#kdump-testing" title="Testing the Crash Dump Mechanism">Testing the Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.sl#kdump-resources" title="Viri">Viri</a></li>
</ul></div>
