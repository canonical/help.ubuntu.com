...
<a class="nextlinks-prev" href="databases.html.el" title="Βάσεις δεδομένων">Προηγούμενο</a><a class="nextlinks-next" href="postgresql.html.el" title="PostgreSQL">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="mysql.html.el#mysql-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="mysql.html.el#mysql-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="mysql.html.el#mysql-engines" title="Database Engines">Database Engines</a></li>
<li class="links"><a class="xref" href="mysql.html.el#mysql-advanced" title="Advanced configuration">Advanced configuration</a></li>
<li class="links"><a class="xref" href="mysql.html.el#mysql-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">Όταν εκτελείτε αυτή την εντολή, θα πρέπει να δείτε τις ακόλουθες γραμμές ή κάτι παρόμοιο:</p>
<div class="code"><pre class="contents ">tcp        0      0 localhost:mysql         *:*                LISTEN      2556/mysqld
</pre></div>
<p class="para">Αν ο εξυπηρετητής δεν εκτελείται σωστά, μπορείτε να πληκτρολογήσετε την παρακάτω εντολή για να τον εκκινήσετε:</p>
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
                                <p class="para">Αντικαταστήστε το 192.168.0.5 με την κατάλληλη διεύθυνση.</p>
	                         </div></div></div></div>
<p class="para">
...
<li class="list itemizedlist">
                                <p class="para">Δείτε την <a href="http://www.mysql.com/" class="ulink" title="http://www.mysql.com/">Αρχική σελίδα του MySQL</a> για περισσότερες πληροφορίες.</p>
                            </li>
<li class="list itemizedlist">
                                <p class="para">
