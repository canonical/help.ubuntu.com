...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ru" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="vpn.html.ru" title="VPN">VPN</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="vpn.html.ru" title="VPN">Назад</a><a class="nextlinks-next" href="other-useful-applications.html.ru" title="Другие полезные приложения">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="openvpn.html.ru#openvpn-server-installation" title="Установка сервера">Установка сервера</a></li>
<li class="links"><a class="xref" href="openvpn.html.ru#openvpn-pki-setup" title="Настройка инфраструктуры открытых ключей">Настройка инфраструктуры открытых ключей</a></li>
<li class="links"><a class="xref" href="openvpn.html.ru#openvpn-simple-server-configuration" title="Простая конфигурация сервера">Простая конфигурация сервера</a></li>
<li class="links"><a class="xref" href="openvpn.html.ru#openvpn-simple-client-configuration" title="Простая конфигурация клиента">Простая конфигурация клиента</a></li>
<li class="links"><a class="xref" href="openvpn.html.ru#openvpn-first-troubleshooting" title="Первые поиски и устранения неисправностей">Первые поиски и устранения неисправностей</a></li>
<li class="links"><a class="xref" href="openvpn.html.ru#openvpn-advanced-config" title="Расширенные настройки">Расширенные настройки</a></li>
<li class="links"><a class="xref" href="openvpn.html.ru#openvpn-client-implementations" title="Реализации клиентского программного обеспечения">Реализации клиентского программного обеспечения</a></li>
<li class="links"><a class="xref" href="openvpn.html.ru#openvpn-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<p class="para">Затем перезагрузите sysctl.</p>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist"><p class="para">Проверьте свой журнал, например journalctl --identifier ovpn-server (для server.conf)</p></li>
...
<li class="list itemizedlist"><p class="para">Может ли клиент подключиться к серверу? Возможно, доступ блокирует сетевой экран? Проверьте журнал на сервере.</p></li>
