...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.cs" title="Průvodce pro Ubuntu Server">Průvodce pro Ubuntu Server</a> » <a class="trail" href="remote-administration.html.cs" title="Remote Administration">Remote Administration</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="openssh-server.html.cs" title="OpenSSH Server">Předchozí</a><a class="nextlinks-next" href="zentyal.html.cs" title="Zentyal">Následující</a>
</div>
...
<li class="links"><a class="xref" href="puppet.html.cs#puppet-preconfiguration" title="Preconfiguration">Preconfiguration</a></li>
<li class="links"><a class="xref" href="puppet.html.cs#puppet-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="puppet.html.cs#puppet-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="puppet.html.cs#puppet-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<p class="para">
      ...
      <span class="em emphasis">Puppet Master</span>.  See <a class="xref" href="dns.html.cs" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for more DNS details.
      </p>
<p class="para">
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
        ...
        benefits.  For more information see <a class="xref" href="puppet.html.cs#puppet-resources" title="Zdroje">Zdroje</a>.
        </p>
      </div></div></div></div>
</div></div>
</div></div>
