...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="remote-administration.html.es" title="Administración Remota">Administración Remota</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="openssh-server.html.es" title="Servidor OpenSSH">Anterior</a><a class="nextlinks-next" href="zentyal.html.es" title="Zentyal">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="puppet.html.es#puppet-preconfiguration" title="Preconfiguration">Preconfiguration</a></li>
<li class="links"><a class="xref" href="puppet.html.es#puppet-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="puppet.html.es#puppet-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="puppet.html.es#puppet-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para">
      ...
      <span class="em emphasis">Puppet Master</span>.  See <a class="xref" href="dns.html.es" title="Servicio de nombres de dominio (DNS)">Servicio de nombres de dominio (DNS)</a> for more DNS details.
      </p>
<p class="para">
...
<p class="para">Inicie el servicio:</p>
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
        ...
        benefits.  For more information see <a class="xref" href="puppet.html.es#puppet-resources" title="Recursos">Recursos</a>.
        </p>
      </div></div></div></div>
</div></div>
</div></div>
