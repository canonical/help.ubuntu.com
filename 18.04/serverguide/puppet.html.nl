...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.nl" title="Handleiding Ubuntu-server">Handleiding Ubuntu-server</a> » <a class="trail" href="remote-administration.html.nl" title="Remote Administration">Remote Administration</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="openssh-server.html.nl" title="OpenSSH Server">Vorige</a><a class="nextlinks-next" href="zentyal.html.nl" title="Zentyal">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="puppet.html.nl#puppet-preconfiguration" title="Preconfiguration">Preconfiguration</a></li>
<li class="links"><a class="xref" href="puppet.html.nl#puppet-installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="puppet.html.nl#puppet-configuration" title="Configuratie">Configuratie</a></li>
<li class="links"><a class="xref" href="puppet.html.nl#puppet-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para">
      ...
      <span class="em emphasis">Puppet Master</span>.  See <a class="xref" href="dns.html.nl" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for more DNS details.
      </p>
<p class="para">
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents">
        ...
        benefits.  For more information see <a class="xref" href="puppet.html.nl#puppet-resources" title="Resources">Resources</a>.
        </p>
      </div></div></div></div>
</div></div>
</div></div>
