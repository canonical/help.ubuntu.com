...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ru" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="remote-administration.html.ru" title="Удалённое администрирование">Удалённое администрирование</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="openssh-server.html.ru" title="Сервер OpenSSH">Назад</a><a class="nextlinks-next" href="zentyal.html.ru" title="Zentyal">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="puppet.html.ru#puppet-preconfiguration" title="Предварительная конфигурация">Предварительная конфигурация</a></li>
<li class="links"><a class="xref" href="puppet.html.ru#puppet-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="puppet.html.ru#puppet-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="puppet.html.ru#puppet-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Этот пример <span class="em emphasis">очень</span> простой и не показывает многие возможности и преимущества <span class="app application">Puppet</span>. Для дополнительной информации смотрите <a class="xref" href="puppet.html.ru#puppet-resources" title="Ресурсы">Ресурсы</a>.</p>
      </div></div></div></div>
</div></div>
</div></div>
