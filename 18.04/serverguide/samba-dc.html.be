...
<a class="nextlinks-prev" href="samba-fileprint-security.html.be" title="Securing File and Print Server">Назад</a><a class="nextlinks-next" href="samba-ad-integration.html.be" title="Active Directory Integration">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="samba-dc.html.be#samba-pdc-smbpasswd" title="Primary Domain Controller">Primary Domain Controller</a></li>
<li class="links"><a class="xref" href="samba-dc.html.be#samba-bdc-smbpasswd" title="Backup Domain Controller">Backup Domain Controller</a></li>
<li class="links"><a class="xref" href="samba-dc.html.be#samba-dc-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<li class="list itemizedlist">
              ...
              <span class="app application">addgroup</span> utility see <a class="xref" href="user-management.html.be#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a> for details.
              </p>
...
<p class="para">
      ...
      See <a class="xref" href="samba-ldap.html.be" title="Samba і LDAP">Samba і LDAP</a> for details.
      </p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<li class="steps">
          ...
          <p class="para">У канцы, перазапусьціце <span class="app application">samba</span>:</p>
