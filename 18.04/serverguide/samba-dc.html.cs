...
<a class="nextlinks-prev" href="samba-fileprint-security.html.cs" title="Securing File and Print Server">Předchozí</a><a class="nextlinks-next" href="samba-ad-integration.html.cs" title="Active Directory Integration">Následující</a>
</div>
...
<li class="links"><a class="xref" href="samba-dc.html.cs#samba-pdc-smbpasswd" title="Primary Domain Controller">Primary Domain Controller</a></li>
<li class="links"><a class="xref" href="samba-dc.html.cs#samba-bdc-smbpasswd" title="Backup Domain Controller">Backup Domain Controller</a></li>
<li class="links"><a class="xref" href="samba-dc.html.cs#samba-dc-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<li class="list itemizedlist">
              ...
              <span class="app application">addgroup</span> utility see <a class="xref" href="user-management.html.cs#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a> for details.
              </p>
...
<p class="para">
      ...
      See <a class="xref" href="samba-ldap.html.cs" title="Samba and LDAP">Samba and LDAP</a> for details.
      </p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
