...
<a class="nextlinks-prev" href="samba-fileprint-security.html.mk" title="Securing File and Print Server">Previous</a><a class="nextlinks-next" href="samba-ad-integration.html.mk" title="Active Directory Integration">Next</a>
</div>
...
<li class="links"><a class="xref" href="samba-dc.html.mk#samba-pdc-smbpasswd" title="Primary Domain Controller">Primary Domain Controller</a></li>
<li class="links"><a class="xref" href="samba-dc.html.mk#samba-bdc-smbpasswd" title="Backup Domain Controller">Backup Domain Controller</a></li>
<li class="links"><a class="xref" href="samba-dc.html.mk#samba-dc-resources" title="Resources">Resources</a></li>
</ul></div>
...
<li class="list itemizedlist">
              ...
              <span class="app application">addgroup</span> utility see <a class="xref" href="user-management.html.mk#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a> for details.
              </p>
...
<p class="para">
      ...
      See <a class="xref" href="samba-ldap.html.mk" title="Samba and LDAP">Samba and LDAP</a> for details.
      </p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
