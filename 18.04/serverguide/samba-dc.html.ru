...
<a class="nextlinks-prev" href="samba-fileprint-security.html.ru" title="Защита файлового сервера и сервера печати">Назад</a><a class="nextlinks-next" href="samba-ad-integration.html.ru" title="Интеграция с Active Directory">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="samba-dc.html.ru#samba-pdc-smbpasswd" title="Первичный контроллер домена">Первичный контроллер домена</a></li>
<li class="links"><a class="xref" href="samba-dc.html.ru#samba-bdc-smbpasswd" title="Резервный контроллер домена">Резервный контроллер домена</a></li>
<li class="links"><a class="xref" href="samba-dc.html.ru#samba-dc-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<li class="list itemizedlist">
              ...
              <p class="para">В этом примере группа <span class="em emphasis">machines</span> должна быть создана с использованием утилиты <span class="app application">addgroup</span>. Детальнее расписано тут: <a class="xref" href="user-management.html.ru#adding-deleting-users" title="Добавление и удаление пользователей">Добавление и удаление пользователей</a>.</p>
