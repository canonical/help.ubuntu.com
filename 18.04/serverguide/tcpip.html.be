...
<a class="nextlinks-prev" href="network-configuration.html.be" title="Сеткавыя настаўленьні">Назад</a><a class="nextlinks-next" href="dhcp.html.be" title="Dynamic Host Configuration Protocol (DHCP)">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="tcpip.html.be#tcpip-introduction" title="TCP/IP Introduction">TCP/IP Introduction</a></li>
<li class="links"><a class="xref" href="tcpip.html.be#tcpip-configuration" title="Наладкі TCP/IP">Наладкі TCP/IP</a></li>
<li class="links"><a class="xref" href="tcpip.html.be#ip-routing" title="IP Routing">IP Routing</a></li>
<li class="links"><a class="xref" href="tcpip.html.be#tcp-and-udp" title="TCP і UDP">TCP і UDP</a></li>
<li class="links"><a class="xref" href="tcpip.html.be#icmp" title="ICMP">ICMP</a></li>
<li class="links"><a class="xref" href="tcpip.html.be#daemons" title="Daemons">Daemons</a></li>
<li class="links"><a class="xref" href="tcpip.html.be#tcpip-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<div class="hgroup"><h2 class="title">Наладкі TCP/IP</h2></div>
...
<div class="hgroup"><h2 class="title">TCP і UDP</h2></div>
<div class="region"><div class="contents">
<p class="para">
