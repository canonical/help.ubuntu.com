...
<a class="nextlinks-prev" href="network-configuration.html.cs" title="Network Configuration">Předchozí</a><a class="nextlinks-next" href="dhcp.html.cs" title="Dynamic Host Configuration Protocol (DHCP)">Následující</a>
</div>
...
<li class="links"><a class="xref" href="tcpip.html.cs#tcpip-introduction" title="TCP/IP Introduction">TCP/IP Introduction</a></li>
<li class="links"><a class="xref" href="tcpip.html.cs#tcpip-configuration" title="TCP/IP Configuration">TCP/IP Configuration</a></li>
<li class="links"><a class="xref" href="tcpip.html.cs#ip-routing" title="IP Routing">IP Routing</a></li>
<li class="links"><a class="xref" href="tcpip.html.cs#tcp-and-udp" title="TCP and UDP">TCP and UDP</a></li>
<li class="links"><a class="xref" href="tcpip.html.cs#icmp" title="ICMP">ICMP</a></li>
<li class="links"><a class="xref" href="tcpip.html.cs#daemons" title="Daemons">Daemons</a></li>
<li class="links"><a class="xref" href="tcpip.html.cs#tcpip-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
