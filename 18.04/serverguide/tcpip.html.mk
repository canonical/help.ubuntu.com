...
<a class="nextlinks-prev" href="network-configuration.html.mk" title="Конфигурација на мрежа">Previous</a><a class="nextlinks-next" href="dhcp.html.mk" title="Dynamic Host Configuration Protocol (DHCP)">Next</a>
</div>
...
<li class="links"><a class="xref" href="tcpip.html.mk#tcpip-introduction" title="TCP/IP Introduction">TCP/IP Introduction</a></li>
<li class="links"><a class="xref" href="tcpip.html.mk#tcpip-configuration" title="TCP/IP Configuration">TCP/IP Configuration</a></li>
<li class="links"><a class="xref" href="tcpip.html.mk#ip-routing" title="IP Routing">IP Routing</a></li>
<li class="links"><a class="xref" href="tcpip.html.mk#tcp-and-udp" title="TCP and UDP">TCP and UDP</a></li>
<li class="links"><a class="xref" href="tcpip.html.mk#icmp" title="ICMP">ICMP</a></li>
<li class="links"><a class="xref" href="tcpip.html.mk#daemons" title="Daemons">Daemons</a></li>
<li class="links"><a class="xref" href="tcpip.html.mk#tcpip-resources" title="Resources">Resources</a></li>
</ul></div>
