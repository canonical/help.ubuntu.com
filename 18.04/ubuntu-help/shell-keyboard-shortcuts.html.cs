...
<td style="border-top-style: solid;"><p class="p">Zaměřit horní lištu. V přehledu <span class="gui">Činnosti</span> přepíná mezi zaměřením horní lišty, oblíbených, přehledu oken, seznamu aplikací, vyhledávacího pole a pořadače zpráv. K pohybu použijte kurzorové šipky na klávesnici.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-exit.html.cs" title="Odhlášení nebo přepnutí uživatele, vypnutí">Vypnout počítač</a></span>.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Otevřít <span class="link"><a href="shell-notifications.html.cs#messagetray" title="Pořadač zpráv">pořadač zpráv</a></span>. Opětovným zmáčknutím <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>M</kbd></span></span> nebo zmáčknutím <span class="key"><kbd>Esc</kbd></span> jej zavřete.</p></td>
</tr>
</table></div>
</div>
</div>
