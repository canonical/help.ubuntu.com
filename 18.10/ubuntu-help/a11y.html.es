...
<div class="links topiclinks"><div class="inner"><div class="region"><div class="linkdiv "><a class="linkdiv" href="a11y-icon.html.es" title="Encontrar el menú de acceso universal"><span class="title">Encontrar el menú de acceso universal</span><span class="linkdiv-dash"> — </span><span class="desc">El menú del acceso universal es el icono que parece una persona en la barra superior.</span></a></div></div></div></div>
</div>
...
<div class="region"><ul>
<li class="links ">
<a href="mouse-sensitivity.html.es" title="Adjust the speed of the mouse and touchpad">Adjust the speed of the mouse and touchpad</a><span class="desc"> — Cambiar cómo se mueve de rápido el puntero cuando usa el ratón o el touchpad.</span>
</li>
<li class="links ">
<a href="mouse-mousekeys.html.es" title="Click and move the mouse pointer using the keypad">Click and move the mouse pointer using the keypad</a><span class="desc"> — Activar las teclas del ratón para controlar el ratón con el teclado numérico.</span>
</li>
</ul></div>
</div></div>
<div class="links topiclinks"><div class="inner">
