...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Где найти файлы, которые я хочу скопировать?</span></h1></div>
<div class="region">
<div class="contents">
...
<p class="p">Обычно хранятся в вашей домашней папке (<span class="file">/home/ваше_имя</span>). Могут находиться во вложенных папках «Рабочий стол», «Документы», «Изображения», «Музыка» и «Видео».</p>
