...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Jak můžu zkalibrovat svůj fotoaparát?</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Fotoaparáty se kalibrují pořízením fotografie kalibračního obrazce za stanovených světelných podmínek. Výsledek se převede ze souboru RAW do souboru TIFF a ten se pak použije ke kalibraci fotoaparátu v ovládacím panelu barev.</p>
...
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents"><p class="p">Výsledný profil bude platný jen za světelných podmínek, za kterých jste získali původní snímek. To znamená, že budete asi potřebovat více profilů, pro světelné podmínky <span class="em">studia</span>, <span class="em">slunečního dne</span> a <span class="em">zamračeného dne</span>.</p></div></div></div></div>
</div>
