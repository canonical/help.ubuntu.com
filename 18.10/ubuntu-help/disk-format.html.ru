...
<div class="note note-warning" title="Предупреждение"><div class="inner"><div class="region"><div class="contents"><p class="p">Убедитесь, что диск выбран правильно, иначе все файлы будут удалены с другого диска.</p></div></div></div></div>
</li>
