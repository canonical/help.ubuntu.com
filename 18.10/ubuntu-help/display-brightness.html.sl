...
<p class="p">To change the brightness of your screen, click the
  <span class="gui"><a href="shell-introduction.html.sl#yourname" title="Vi in vaš računalnik">system menu</a></span> on the right side
...
<div class="note note-tip" title="Namig"><div class="inner"><div class="region"><div class="contents"><p class="p">Many laptop keyboards have special keys to adjust the brightness. These
    often have a picture that looks like the sun. Hold down the <span class="key"><kbd class="key-Fn">Fn</kbd></span>
    key to use these keys.</p></div></div></div></div>
...
<div class="note note-tip" title="Namig"><div class="inner"><div class="region"><div class="contents"><p class="p">If your computer features an integrated light sensor, the screen
