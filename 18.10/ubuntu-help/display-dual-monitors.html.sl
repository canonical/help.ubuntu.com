...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">The primary display is the one with the
        <span class="link"><a href="shell-introduction.html.sl" title="Uvod v GNOME">top bar</a></span>, and where the
