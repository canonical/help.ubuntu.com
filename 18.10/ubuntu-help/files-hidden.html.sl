...
<p class="p">Once you have renamed the file, you can either click the
  ...
  files again.</p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">Privzeto bodo skrite datoteke prikazane le v trenutnem oknu dokler upravljalnika datotek ne zaprete. Za spremembo te nastavitve, da bodo skrite datoteke vedno prikazane v upravljalniku datotek, si oglejte <span class="link"><a href="nautilus-views.html.sl" title="Views preferences in Files">Views preferences in <span class="app">Files</span></a></span>.</p></div></div></div></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">Most hidden files will have a <span class="file">.</span> at the
  ...
  <span class="link"><a href="files-tilde.html.sl" title="What is a file with a ~ at the end of its name?">What is a file with a <span class="file">~</span> at the end of its name?</a></span> for more information.</p></div></div></div></div>
</div></div>
</div></div>
