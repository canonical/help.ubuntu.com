...
<div class="hgroup"><h2 class="title"><span class="title">Безопасное извлечение используемого устройства</span></h2></div>
...
<div class="note note-warning" title="Предупреждение"><div class="inner"><div class="region"><div class="contents"><p class="p">Также можно выбрать <span class="gui">Всё равно извлечь</span> чтобы извлечь устройство, не закрывая файлов. Это может привести к ошибкам в тех приложениях, с помощью которых были открыты эти файлы.</p></div></div></div></div>
</div></div>
</div></div>
