...
<a class="nextlinks-prev" href="gs-browse-web.html.ru" title="Путешествие по Интернету">Назад</a><a class="nextlinks-next" href="gs-change-date-time-timezone.html.ru" title="Смена даты, времени и часового пояса">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title"><span class="title">Подключение к сетевым учётным записям</span></h1></div>
<div class="region">
<div class="contents">
