...
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents"><p class="p">Als u geen aanwijsapparaat zoals een muis kunt gebruiken, dan kunt u de muisaanwijzer besturen via het numerieke toetsenbord. Zie <span class="link"><a href="mouse-mousekeys.html.nl" title="Click and move the mouse pointer using the keypad">Click and move the mouse pointer using the keypad</a></span> voor meer informatie.</p></div></div></div></div>
