...
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">Если вы не можете использовать указательное устройство типа мыши, можно управлять указателем мыши с помощью клавиш цифрового блока клавиатуры. Подробнее смотрите: <span class="link"><a href="mouse-mousekeys.html.ru" title="Click and move the mouse pointer using the keypad">Click and move the mouse pointer using the keypad</a></span>.</p></div></div></div></div>
