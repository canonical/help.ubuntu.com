...
<li class="steps"><p class="p">Kliknutím na <span class="gui">Pozadí</span> v postranním panelu otevřete příslušný panel.</p></li>
<li class="steps"><p class="p">Vyberte <span class="gui">Pozadí</span> nebo <span class="gui">Uzamknutá obrazovka</span>.</p></li>
<li class="steps">
<p class="p">V horní části jsou zobrazeny tři volby:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Vyberte <span class="gui">Tapety</span>, aby se použil jeden z mnoha profesionálních obrázků pro pozadí šířených spolu s GNOME. Některé tapety se mění v průběhu dne. Tyto tapety mají v pravém dolním rohu malou ikonu hodin.</p></li>
<li class="list"><p class="p">Vyberte <span class="gui">Obrázky</span>, aby se použila jedna z vašich vlastních fotografií ze složky <span class="file">Obrázky</span>. Většina aplikací pro správu fotografií ukládá fotografie právě zde. V případě, že chcete použít nějaký obrázek, které není v této složce, použijte buď aplikaci <span class="app">Soubory</span>, klikněte na obrázek pravým tlačítkem a zvolte <span class="gui">Nastavit jako tapetu na pozadí</span>, nebo aplikaci <span class="app">Prohlížeč obrázků</span>, ve kterém obrázek otevřete, kliknete na tlačítko nabídky na hlavičkové liště a vyberete <span class="gui">Nastavit jako tapetu</span>.</p></li>
<li class="list"><p class="p">Vyberte <span class="gui">Barvy</span>, aby se použila jednolitá barva.</p></li>
</ul></div></div></div>
</li>
