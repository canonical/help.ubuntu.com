...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Změna rozlišení nebo otočení obrazovky</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="hgroup"><h2 class="title"><span class="title">Přirozené rozlišení</span></h2></div>
<div class="region"><div class="contents"><p class="p"><span class="em">Přirozené rozlišení</span> obrazovky notebooku nebo monitoru je takové, které funguje nejlépe: jednotlivé pixely signálu z grafické karty přesně sednou na fyzické pixely obrazovky. Když je po obrazovce žádáno jiné rozlišení, než je přirozené, je zapotřebí přepočet pixelů, který způsobí ztrátu kvality.</p></div></div>
</div></div>
<div id="scale" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Škálování</span></h2></div>
<div class="region"><div class="contents"><p class="p">Nastavení škálování zvětšuje velikost objektů zobrazených na obrazovce, aby lépe vyhovovaly hustotě bodů vašeho displeje a byly tak snáze čitelné. Můžete volit mezi <span class="gui">100 %</span>, <span class="gui">200 %</span> nebo <span class="gui">300 %</span>.</p></div></div>
</div></div>
<div id="orientation" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Orientace</span></h2></div>
<div class="region"><div class="contents"><p class="p">U některých notebooků a monitorů je možné obrazovku fyzicky otočit do rozličných směrů. Klikněte v panelu na <span class="gui">Orientace</span> a zvolte z <span class="gui">Na šířku</span>, <span class="gui">Na výšku vpravo</span>, <span class="gui">Na výšku vlevo</span> nebo <span class="gui">Na šířku (překlopené)</span>.</p></div></div>
</div></div>
