...
<div class="trail">
<span style="color: #333">Ubuntu 18.10</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="hardware.html.ru" title="Оборудование и драйверы">Аппаратное обеспечение</a> » <a class="trail" href="mouse.html.ru" title="Mouse &amp; Touchpad">Mouse &amp; Touchpad</a> » </div>
<div class="trail">
<span style="color: #333">Ubuntu 18.10</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="prefs.html.ru" title="Параметры пользователя и системы">Параметры</a> » <a class="trail" href="mouse.html.ru" title="Mouse &amp; Touchpad">Mouse &amp; Touchpad</a> » </div>
</div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Нажатия, перетаскивание и прокрутка с помощью сенсорной панели</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Нажатия, двойные нажатия, перетаскивание и прокрутку можно выполнять непосредственно на сенсорной панели, без использования отдельных аппаратных кнопок.</p></div>
<div id="tap" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Нажатие касанием</span></h2></div>
...
<li class="steps"><p class="p">Click <span class="gui">Mouse &amp; Touchpad</span> in the sidebar to open the panel.</p></li>
<li class="steps">
<p class="p">In the <span class="gui">Touchpad</span> section, make sure <span class="gui">Touchpad</span> is
      set to <span class="gui">ON</span>.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Раздел <span class="gui">Сенсорная панель</span> появится только если в вашей системе есть сенсорная панель.</p></div></div></div></div>
</li>
<li class="steps"><p class="p">Set <span class="gui">Tap to click</span> to <span class="gui">ON</span>.</p></li>
</ol></div></div></div>
...
<li class="steps"><p class="p">Click <span class="gui">Devices</span> in the sidebar.</p></li>
<li class="steps"><p class="p">Click <span class="gui">Mouse &amp; Touchpad</span> in the sidebar to open the panel.</p></li>
<li class="steps"><p class="p">In the <span class="gui">Touchpad</span> section, make sure <span class="gui">Touchpad</span> is
      set to <span class="gui">ON</span>.</p></li>
<li class="steps"><p class="p">Set <span class="gui">Two-finger Scrolling</span> to <span class="gui">ON</span>.</p></li>
</ol></div></div></div>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Прокрутка двумя пальцами может не работать на некоторых панелях.</p></div></div></div></div>
</div></div>
</div></div>
<div id="contentsticks" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Естественная прокрутка</span></h2></div>
<div class="region"><div class="contents">
...
<li class="steps"><p class="p">In the <span class="gui">Touchpad</span> section, make sure <span class="gui">Touchpad</span> is
      set to <span class="gui">ON</span>.</p></li>
<li class="steps"><p class="p">Set <span class="gui">Natural Scrolling</span> to <span class="gui">ON</span>.</p></li>
</ol></div></div></div>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Эту функцию также часто называют <span class="em">обратной прокруткой</span>.</p></div></div></div></div>
</div></div>
</div></div>
...
<a href="mouse.html.ru" title="Mouse &amp; Touchpad">Mouse &amp; Touchpad</a><span class="desc"> — <span class="link"><a href="mouse-lefthanded.html.ru" title="Управление мышью левой рукой">Управление левой рукой</a></span>, <span class="link"><a href="mouse-sensitivity.html.ru" title="Adjust the speed of the mouse and touchpad">скорость и чувствительность</a></span>, <span class="link"><a href="mouse-touchpad-click.html.ru" title="Нажатия, перетаскивание и прокрутка с помощью сенсорной панели">нажатия и прокрутка на сенсорной панели</a></span>…</span>
</li></ul></div>
</div></div></div>
</div>
</div>
