...
<title>Předvolby chování ve správci souborů</title>
...
<div class="region">
<div class="contents"><p class="p">Můžete určit, jestli se má u souborů používat jednoduché nebo dvojité kliknutí, jak se mají obsluhovat spustitelné soubory a chování koše. Klikněte v horní liště na <span class="gui">Soubory</span>, zvolte <span class="gui">Předvolby</span> a vyberte kartu <span class="gui">Chování</span>.</p></div>
...
<li class="steps"><p class="p">Klikněte na soubor pravým tlačítkem, aby se otevřela kontextová nabídka a vyberte požadovaný skript, který se má spustit, z nabídky <span class="gui">Skripty</span>.</p></li>
</ol></div></div></div>
<div class="note note-important" title="Důležité"><div class="inner"><div class="region"><div class="contents"><p class="p">Skriptu, který je spouště ze vzdálené složky, jako je složka zobrazující web nebo obsah <span class="sys">ftp</span>, nejsou předány žádné parametry.</p></div></div></div></div>
</div></div>
</div></div>
