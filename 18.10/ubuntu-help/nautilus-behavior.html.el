...
<title>Προτιμήσεις συμπεριφοράς διαχειριστή αρχείων</title>
...
<div class="region">
<div class="contents"><p class="p">Μπορείτε να ελέγξετε εάν κάνετε μονό κλικ ή διπλό κλικ σε αρχεία, το πώς χειρίζονται εκτελέσιμα αρχεία κειμένου και τη συμπεριφορά των απορριμμάτων. Κάντε κλικ στο <span class="gui">Αρχεία</span> στην πάνω γραμμή, επιλέξτε <span class="gui">Προτιμήσεις</span> και διαλέξτε την καρτέλα <span class="gui">Συμπεριφορά</span>.</p></div>
...
<li class="steps"><p class="p">Κάντε δεξί κλικ στο αρχείο για να ανοίξετε το μενού περιεχομένων και επιλέξτε την επιθυμητή δέσμη ενεργειών για εκτέλεση από το μενού <span class="gui">Δέσμες ενεργειών</span>.</p></li>
</ol></div></div></div>
<div class="note note-important" title="Σημαντικό"><div class="inner"><div class="region"><div class="contents"><p class="p">Δεν θα περαστούν παράμετροι σε μια δέσμη ενεργειών όταν εκτελείται από έναν απομακρυσμένο φάκελο όπως έναν φάκελο που εμφανίζει περιεχόμενο ιστού ή <span class="sys">ftp</span>.</p></div></div></div></div>
</div></div>
</div></div>
<div id="trash" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Απορρίμματα</span></h2></div>
<div class="region">
