...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Обзор файлов на сервере или сетевом ресурсе</span></h1></div>
<div class="region">
<div class="contents">
...
<p class="p">In <span class="gui">Connect to Server</span>, enter the address of the server, in
  the form of a
   <span class="link"><a href="#urls" title="Запись URL">URL</a></span>. Details on supported URLs are
   <span class="link"><a href="#types" title="Типы серверов">listed below</a></span>.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Если вы уже подключались к серверу ранее, можно выбрать его из списка <span class="gui">Недавние серверы</span>.</p></div></div></div></div>
</li>
...
<div class="hgroup"><h2 class="title"><span class="title">Запись URL</span></h2></div>
