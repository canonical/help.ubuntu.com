...
<title>Προτιμήσεις εμφάνισης του διαχειριστή αρχείων</title>
...
<div class="region">
<div class="contents"><p class="p">Μπορείτε να ελέγξετε πώς ο διαχειριστής αρχείων εμφανίζει λεζάντες κάτω από τα εικονίδια. Κάντε κλικ στο <span class="gui">Αρχεία</span> στην πάνω γραμμή, επιλέξτε <span class="gui">Προτιμήσεις</span> και διαλέξτε την καρτέλα <span class="gui">Εμφάνιση</span>.</p></div>
...
<div class="region"><div class="contents"><p class="p">Όταν βλέπετε τα αρχεία ως λίστα, μπορείτε να χρησιμοποιήσετε την επιλογή <span class="gui">Περιήγηση φακέλων σε δέντρο</span>. Αυτό εμφανίζει επεκτάσεις για κάθε κατάλογο στη λίστα αρχείων, έτσι ώστε τα περιεχόμενα πολλαπλών φακέλων να μπορούν να εμφανιστούν με τη μία. Αυτό είναι χρήσιμο αν η δομή του φακέλου είναι σχετική, όπως αν τα μουσικά σας αρχεία είναι οργανωμένα με φάκελο ανά καλλιτέχνη και υποφάκελο ανά δίσκο.</p></div></div>
</div></div>
