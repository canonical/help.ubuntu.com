...
<div class="region">
<div class="contents"><p class="p">Nadzirate lahko kako upravljalnik datotek prikaže napise pod ikonami. Kliknite <span class="gui">Datoteke</span> v vrhnji vrstici, izberite <span class="gui">Možnosti</span> in izberite zavihek <span class="gui">Prikaz</span>.</p></div>
...
<p class="p">Podatki, ki jih lahko pokažete v sličicah ikon so enaki kot stolpci, ki jih lahko uporabite v seznamskem pogledu. Za več podrobnosti si oglejte <span class="link"><a href="nautilus-list.html.sl" title="Files list columns preferences">Files list columns preferences</a></span>.</p>
</div></div>
</div></div>
