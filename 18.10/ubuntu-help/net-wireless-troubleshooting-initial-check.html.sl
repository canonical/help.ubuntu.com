...
<a class="nextlinks-prev" href="net-wireless-troubleshooting.html.sl" title="Odpravljanje težav z brezžičnimi omrežji">Nazaj</a><a class="nextlinks-next" href="net-wireless-troubleshooting-hardware-info.html.sl" title="Odpravljanje težav z brezžičnimi omrežji">Naprej</a>
</div>
<div class="hgroup">
...
<li class="steps"><p class="p">Click the system status area on the top bar and select
      ...
      <span class="link"><a href="net-wireless-airplane.html.sl" title="Izklopite brezžično omrežje (letalski način)">Airplane Mode</a></span> is <span class="em">not</span>
      switched on.</p></li>
<li class="steps">
