...
<li class="steps"><p class="p"><span class="link"><a href="apt:numlockx" title="apt:numlockx">Установите</a></span> пакет <span class="em">numlockx</span>.</p></li>
...
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">Возможно, второй шаг не понадобится на вашем компьютере, так что сначала попробуйте без него.</p></div></div></div></div>
</div>
