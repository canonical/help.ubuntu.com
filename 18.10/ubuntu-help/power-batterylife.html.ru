...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Уменьшение потребляемой мощности и увеличение времени работы от аккумулятора</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Компьютеры могут потреблять значительное количество электроэнергии. С помощью некоторых простых энергосберегающих стратегий можно уменьшить счёт за электроэнергию и помочь в сохранении окружающей среды.</p></div>
...
<div class="hgroup"><h2 class="title"><span class="title">Дополнительные советы</span></h2></div>
