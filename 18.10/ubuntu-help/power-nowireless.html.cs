...
<li class="steps"><p class="p">Jestliže bezdrátové funkce stále nefungují, přepněte na <span class="gui">❙</span> (zapnuto) a následně znovu na <span class="gui">○</span> (vypnuto) <span class="gui">režim letadlo</span>.</p></li>
</ol></div></div></div>
