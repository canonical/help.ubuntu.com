...
<div class="region"><div class="contents"><p class="p">Prepričajte se, da so električni kabli računalnika trdno vklopljeni in da so razdelilniki vklopljeni. Prepričajte se, da je zaslon priklopljen in prižgan. V primeru da imate prenosnik, povežite kabel za polnjenje (za primer, da je baterija prazna). Preverite tudi, če je baterija pravilno vstavljena v prenosnik.</p></div></div>
</div></div>
