...
<div class="links-twocolumn"><div class="linkdiv "><a class="linkdiv" href="shell-notifications.html.es" title="Notifications and the notification list"><span class="title">Notifications and the notification list</span><span class="linkdiv-dash"> — </span><span class="desc">Mensajes emergentes en la parte superior de la pantalla que le avisan de cuando ocurren ciertos eventos.</span></a></div></div>
</div></div></div></div></div>
</div></div>
