...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Neslyším z počítače žádný zvuk</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Když z počítače, například při přehrávání hudby, neslyšíte žádný zvuk, zkuste si projít následující tipy k řešení problému.</p></div>
...
<li class="steps"><p class="p">Z přehledu <span class="gui">Činnosti</span> otevřete <span class="app">Nastavení</span>.</p></li>
<li class="steps"><p class="p">Klikněte na <span class="gui">Zvuk</span>.</p></li>
<li class="steps"><p class="p">Přejděte na kartu <span class="gui">Aplikace</span> a zkontrolujte, že vaše aplikace není ztišená.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
<div id="speakers" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Ujistěte se, že jsou reproduktory zapnuté a správně připojené</span></h2></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title"><span class="title">Zkontrolujte, že je vybráno správné zvukové zařízení</span></h2></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title"><span class="title">Zkontrolujte, že zvuková karta byla správně nalezena</span></h2></div>
<div class="region"><div class="contents">
