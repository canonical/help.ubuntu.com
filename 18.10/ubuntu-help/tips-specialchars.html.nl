...
<span style="color: #333">Ubuntu 18.10</span> » <a class="trail" href="index.html.nl" title="Handleiding Ubuntu-desktop"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Hulp"></span></span> Ubuntu-bureaubladhandleiding</a> » <a class="trail" href="tips.html.nl" title="Tips &amp; trucs">Tips &amp; trucs</a> » </div></div>
...
<div class="region"><div class="contents"><p class="p">U kunt ervoor zorgen dat uw toetsenbord zich gedraagt als een toetsenbord voor een andere taal, ongeacht de letters die op de toetsen staan. U kunt eenvoudig wisselen tussen verschillende toetsenbordindelingen via een pictogram in de bovenbalk. Hoe u dat doet leest u in <span class="link"><a href="keyboard-layouts.html.nl" title="Alternatieve toetsenbordindelingen gebruiken">Alternatieve toetsenbordindelingen gebruiken</a></span>.</p></div></div>
</div></div>
