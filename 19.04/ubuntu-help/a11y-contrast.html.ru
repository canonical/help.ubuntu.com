...
<li class="steps"><p class="p">Во вкладке <span class="gui">Зрение</span> измените переключатель <span class="gui">Высокая контрастность</span> в положение <span class="gui">Включено</span>.</p></li>
</ol></div></div></div>
...
<div class="region"><div class="contents"><p class="p">Можно включить или отключить высокую контрастность, нажав на <span class="link"><a href="a11y-icon.html.ru" title="Найдите меню универсального доступа">значок специальных возможностей</a></span> в верхней панели и выбрав <span class="gui">Высокая контрастность</span>.</p></div></div>
</div></div>
</div>
