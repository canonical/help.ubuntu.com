...
<li class="steps"><p class="p">Во вкладке <span class="gui">Зрение</span> измените переключатель <span class="gui">Крупный текст</span> в положение <span class="gui">Включено</span>.</p></li>
</ol></div></div></div>
