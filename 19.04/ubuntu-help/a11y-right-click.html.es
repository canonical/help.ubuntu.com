...
<li class="steps"><p class="p">Pulse en <span class="gui">Asistente de pulsación</span> en la sección <span class="gui">Apuntar y pulsar</span>.</p></li>
<li class="steps"><p class="p">Active la <span class="gui">Pulsación secundaria simulada</span> (<span class="gui">Encendido</span>).</p></li>
</ol></div></div></div>
...
<p class="p">Si usa las <span class="link"><a href="mouse-mousekeys.html.es" title="Click and move the mouse pointer using the keypad">Teclas del ratón</a></span>, esto también le permite simular una pulsación derecha manteniendo pulsada la tecla <span class="key"><kbd>5</kbd></span> de su teclado numérico.</p>
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents"><p class="p">En la vista de <span class="gui">Actividades</span> siempre puede realizar una pulsación larga para ejecutar una pulsación con el botón derecho, incluso si esta característica está desactivada. La pulsación larga funciona de forma ligeramente diferente en la vista general: no tiene que liberar el botón para realizar la pulsación con el botón derecho.</p></div></div></div></div>
</div>
