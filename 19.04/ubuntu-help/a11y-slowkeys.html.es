...
<p class="p">También puede activar las teclas lentas pulsando el <span class="link"><a href="a11y-icon.html.es" title="Encontrar el menú de acceso universal">icono de acceso universal</a></span> en la barra superior y cambie <span class="gui">Teclas lentas</span>. El icono de accesibilidad está visible cuando se han activado una o mas opciones en el panel de <span class="gui">Acceso universal</span>.</p>
</div></div>
</div></div>
