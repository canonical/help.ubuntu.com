...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Přizpůsobení barevné teploty vaší obrazovky</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents"><p class="p">Na <span class="link"><a href="shell-introduction.html.cs" title="Obrázkový přehled GNOME">horní liště</a></span> se signalizuje, když je funkce <span class="gui">Noční světlo</span> aktivní. Je možné ji dočasně vypnout přes systémovou nabídku.</p></div></div></div></div>
</li>
</ol></div></div></div>
</div>
