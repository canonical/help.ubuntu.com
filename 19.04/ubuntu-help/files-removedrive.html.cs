...
<div class="hgroup"><h2 class="title"><span class="title">Bezpečné odebrání zařízení, které se používá</span></h2></div>
...
<div class="note note-warning" title="Varování"><div class="inner"><div class="region"><div class="contents"><p class="p">Můžete také zvolit <span class="gui">Přesto vysunout</span>, aby se zařízení odebralo bez uzavření souborů. Může to ale způsobit chyby v aplikacích, které mají tyto soubory otevřené.</p></div></div></div></div>
</div></div>
</div></div>
