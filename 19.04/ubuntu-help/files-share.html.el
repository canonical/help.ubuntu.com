...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Κοινή χρήση αρχείων με ηλεκτρονική αλληλογραφία</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="note note-important" title="Σημαντικό"><div class="inner"><div class="region"><div class="contents"><p class="p">Πριν ξεκινήσετε, βεβαιωθείτε ότι το <span class="app">Evolution</span> ή το <span class="app">Geary</span> είναι εγκατεστημένο στον υπολογιστή σας και  έχει ρυθμιστεί ο λογαριασμός ηλεκτρονικής αλληλογραφίας.</p></div></div></div></div>
...
<div class="note note-tip" title="Συμβουλή"><div class="inner"><div class="region"><div class="contents"><p class="p">Μπορείτε να στείλετε πολλά αρχεία με μια φορά. Επιλέξτε πολλαπλά αρχεία κρατώντας πατημένο το <span class="key"><kbd>Ctrl</kbd></span> ενώ κάνετε κλικ στα αρχεία, έπειτα κάντε δεξί κλικ σε κάποιο από τα επιλεγμένα αρχεία.</p></div></div></div></div>
</div>
