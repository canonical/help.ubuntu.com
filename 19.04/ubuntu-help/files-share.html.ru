...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Обмен файлами по почте</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Файлами можно легко обмениваться, посылая их по почте непосредственно из файлового менеджера.</p>
<div class="note note-important" title="Важно"><div class="inner"><div class="region"><div class="contents"><p class="p">Before you begin, make sure <span class="app">Evolution</span> or <span class="app">Geary</span> is
...
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">You can send multiple files at once. Select multiple files by holding
