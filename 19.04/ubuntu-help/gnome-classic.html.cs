...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Co je to GNOME klasické?</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="hgroup"><h2 class="title"><span class="title">Přepnutí na GNOME klasické a zpět</span></h2></div>
<div class="region"><div class="contents">
<div class="note note-important" title="Důležité"><div class="inner"><div class="region"><div class="contents"><p class="p">GNOME klasické je dostupné jen na systémech s nainstalovanými konkrétními rozšířeními GNOME Shellu. V některýc linuxových distribucích nemusí mí tato rozšíření k dispozici nebo nemusí být nainstalována ve výchozím stavu.</p></div></div></div></div>
...
<li class="steps"><p class="p">Klikněte na ikonu voleb, která je zobrazená vedle tlačítka <span class="gui">Přihlásit</span> a vyberte <span class="gui">GNOME klasické</span>.</p></li>
<li class="steps"><p class="p">Klikněte na tlačítko <span class="gui">Přihlásit se</span>.</p></li>
</ol></div>
</div></div>
<div class="steps"><div class="inner">
...
<li class="steps"><p class="p">Na přihlašovací obrazovce vyberte v seznamu své jméno.</p></li>
<li class="steps"><p class="p">Do vstupního pole pro heslo zadejte své heslo.</p></li>
<li class="steps"><p class="p">Klikněte na ikonu voleb, která je zobrazená vedle tlačítka <span class="gui">Přihlásit</span> a vyberte <span class="gui">GNOME</span>.</p></li>
<li class="steps"><p class="p">Klikněte na tlačítko <span class="gui">Přihlásit se</span>.</p></li>
</ol></div>
</div></div>
</div></div>
