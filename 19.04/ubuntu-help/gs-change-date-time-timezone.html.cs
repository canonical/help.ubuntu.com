...
<li class="steps"><p class="p">Zavřením okna s mapou světa se vraťte zpět do okna <span class="gui">Datum a čas</span>.</p></li>
...
<li class="steps"><p class="p">Zavřením okna se vraťte zpět do okna <span class="gui">Datum a čas</span> a následně zavřete panel.</p></li>
</ol></div></div></div>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="gs-connect-online-accounts.html.cs" title="Připojení k účtům on-line">Předchozí</a><a class="nextlinks-next" href="gs-change-wallpaper.html.cs" title="Změna tapety">Následující</a>
