...
<li class="steps"><p class="p">Κλείστε το παράθυρο του παγκόσμιου χάρτη για να πάτε πίσω στο <span class="gui">Ημερομηνία &amp; ώρα</span>.</p></li>
...
<li class="steps"><p class="p">Κλείστε το παράθυρο για να πάτε πίσω στο <span class="gui">Ημερομηνία &amp; ώρα</span>, και έπειτα κλείστε τον πίνακα.</p></li>
</ol></div></div></div>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="gs-connect-online-accounts.html.el" title="Σύνδεση σε διαδικτυακούς λογαριασμούς">Προηγούμενο</a><a class="nextlinks-next" href="gs-change-wallpaper.html.el" title="Αλλαγή ταπετσαρίας">Επόμενο</a>
