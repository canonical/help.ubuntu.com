...
<div class="region"><ul><li class="links ">
<a href="look-resolution.html.es" title="Change the resolution or orientation of the screen">Change the resolution or orientation of the screen</a><span class="desc"> — Cambiar la resolución de la pantalla y su orientación (rotación).</span>
</li></ul></div>
</div></div>
</div>
</div>
