...
<div class="linkdiv "><a class="linkdiv" href="mouse-sensitivity.html.es" title="Adjust the speed of the mouse and touchpad"><span class="title">Adjust the speed of the mouse and touchpad</span><span class="linkdiv-dash"> — </span><span class="desc">Cambiar cómo se mueve de rápido el puntero cuando usa el ratón o el touchpad.</span></a></div>
...
<div class="linkdiv "><a class="linkdiv" href="mouse-mousekeys.html.es" title="Click and move the mouse pointer using the keypad"><span class="title">Click and move the mouse pointer using the keypad</span><span class="linkdiv-dash"> — </span><span class="desc">Activar las teclas del ratón para controlar el ratón con el teclado numérico.</span></a></div>
