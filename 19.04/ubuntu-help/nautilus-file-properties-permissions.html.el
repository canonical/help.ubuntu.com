...
<div class="region">
<div class="contents">
<p class="p">Μπορείτε να χρησιμοποιήσετε τα δικαιώματα αρχείου για να ελέγξετε ποιος μπορεί να προβάλει και να επεξεργαστεί αρχεία που κατέχετε. Για προβολή και ορισμό των δικαιωμάτων για ένα αρχείο, κάντε δεξί κλικ σε αυτό και επιλέξτε <span class="gui">Ιδιότητες</span>, έπειτα επιλέξτε την καρτέλα <span class="gui">Δικαιώματα</span>.</p>
...
<p class="p">Μπορείτε επίσης γρήγορα να ορίσετε τα δικαιώματα ενός αρχείου για όλα τα αρχεία στον φάκελο κάνοντας κλικ στο <span class="gui">Αλλαγή δικαιωμάτων για τα περιεχόμενα αρχεία</span>. Χρησιμοποιήστε τις αναπτυσσόμενες λίστες για να ρυθμίσετε τα δικαιώματα των περιεχόμενων αρχείων ή φακέλων και πατήστε <span class="gui">Αλλαγή</span>. Τα δικαιώματα εφαρμόζονται σε αρχεία και φακέλους σε υποφακέλους επίσης, σε κάθε βάθος.</p>
</div></div>
</div></div>
