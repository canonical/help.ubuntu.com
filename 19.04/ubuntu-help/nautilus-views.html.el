...
<div class="region">
<div class="contents"><p class="p">Μπορείτε να αλλάξετε το πως θα ομαδοποιούνται και θα ταξινομούνται τα αρχεία και οι φάκελοι από προεπιλογή. Επιλέξτε <span class="guiseq"><span class="gui">Αρχεία</span> ▸ <span class="gui">Προτιμήσεις</span></span> στην πάνω μπάρα ενώ είναι ανοιχτά τα <span class="app">Αρχεία</span> και επιλέξτε την καρτέλα <span class="gui">Προβολές</span>.</p></div>
<div id="default-view" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Προεπιλεγμένη προβολή</span></h2></div>
