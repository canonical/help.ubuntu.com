...
<span style="color: #333">Ubuntu 19.04</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="net.html.ru" title="Networking, web &amp; email">Networking, web &amp; email</a> » <a class="trail" href="net-browser.html.ru" title="Веб-браузеры">Веб-браузеры</a> » </div></div>
...
<div class="note note-warning" title="Предупреждение"><div class="inner"><div class="region"><div class="contents"><p class="p">Adobe объявила, что прекращает обновление и распространение Flash Player к концу 2020 года. Вследствие этого, надстройка Flash не должна использоваться после 2020 года, по причинам безопасности.</p></div></div></div></div>
...
<div class="region"><div class="contents"><p class="p">Пакет <span class="app">flashplugin-installer</span> предоставляет надстройку NPAPI для Firefox. <span class="link"><a href="apt:flashplugin-installer" title="apt:flashplugin-installer">Установите пакет</a></span> и перезапустите веб-браузер.</p></div></div>
</div></div>
