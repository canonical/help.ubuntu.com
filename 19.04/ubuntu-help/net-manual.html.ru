...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Настройка параметров соединения вручную</span></h1></div>
<div class="region">
<div class="contents">
...
<p class="p">Click the
      ...
      button.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">For a <span class="gui">Wi-Fi</span> connection, the 
        <span class="media"><span class="media media-image"><img src="figures/emblem-system.png" class="media media-inline" alt="settings"></span></span>
...
<li class="steps"><p class="p">Нажмите <span class="gui">Применить</span>. Если вы не подключены к сети, нажмите на статус системы в верхней панели и подключитесь. Чтобы проверить правильность настроек, попробуйте посетить веб-сайт или открыть общий ресурс сети.</p></li>
</ol></div>
</div></div>
</div>
