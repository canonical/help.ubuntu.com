...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Почему беспроводное соединение постоянно прерывается?</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Вы можете обнаружить, что беспроводное соединение было разорвано, даже если вы этого не планировали. Как правило, компьютер попытается восстановить соединение сразу после его разрыва (в такие моменты на значке сети в верхней панели будут показаны три точки), но всё равно такие моменты неприятны, особенно если в это время вы работали с интернетом.</p></div>
...
<div class="hgroup"><h2 class="title"><span class="title">Ненадёжное беспроводное оборудование или драйверы</span></h2></div>
<div class="region"><div class="contents"><p class="p">Некоторые устройства для беспроводных сетей могут работать не вполне стабильно. Беспроводные сети довольно сложны, поэтому иногда у беспроводных карт и базовых станций возникают небольшие сбои и соединение прерывается. Это досаждает, но такие проблемы регулярно возникают у многих устройств. Если ваше соединение с беспроводной сетью время от времени прерывается, то причина может быть в этом. Если такие прерывания происходят достаточно часто, возможно, вам стоит подумать о приобретении другого устройства.</p></div></div>
</div></div>
