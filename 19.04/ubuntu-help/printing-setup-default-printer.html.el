...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents"><p class="p">Θα χρειαστείτε <span class="link"><a href="user-admin-explain.html.el" title="Πώς δουλεύουν τα δικαιώματα διαχειριστή;">δικαιώματα διαχειριστή</a></span> στο σύστημα για να ορίσετε προεπιλεγμένο εκτυπωτή.</p></div></div></div></div>
...
<li class="links ">
<a href="printing-setup.html.el" title="Ρύθμιση τοπικού εκτυπωτή">Ρύθμιση τοπικού εκτυπωτή</a><span class="desc"> — Ρυθμίστε έναν εκτυπωτή που είναι συνδεμένος στον υπολογιστή σας.</span>
</li>
</ul></div>
</div></div>
</div>
