...
<li class="steps">
<p class="p">Выключите переключатель <span class="gui">Недавно использованные</span>.</p>
<p class="p">Чтобы снова активировать этот параметр, включите переключатель <span class="gui">Последние использованные</span>.</p>
</li>
<li class="steps"><p class="p">Use the <span class="gui">Clear Recent History</span> button to purge the history
      immediately.</p></li>
</ol></div>
</div></div>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Эти настройки не повлияют на параметры хранения информации о посещённых сайтах в вашем браузере.</p></div></div></div></div>
<div class="steps"><div class="inner">
