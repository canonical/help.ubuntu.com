...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Очистка корзины и удаление временных файлов</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">You can delete files immediately and permanently without using the Trash.
    See <span class="link"><a href="files-delete.html.ru#permanent" title="Окончательное удаление файла">Окончательное удаление файла</a></span> for information.</p></div></div></div></div>
</div>
