...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Έλεγχος κοινής χρήσης μέσω Bluetooth</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="note note-tip" title="Συμβουλή"><div class="inner"><div class="region"><div class="contents"><p class="p">Μπορείτε να <span class="link"><a href="sharing-displayname.html.el" title="Ορισμός του ονόματος εμφάνισης για τον υπολογιστή σας">αλλάξετε</a></span> το όνομα των οθονών του υπολογιστή σας σε άλλες συσκευές.</p></div></div></div></div>
</div>
