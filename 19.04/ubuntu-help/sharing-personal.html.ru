...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Сделайте общими ваши личные файлы</span></h1></div>
<div class="region">
<div class="contents">
...
<p class="p">Switch <span class="gui">Personal File Sharing</span> to <span class="gui">ON</span>. This means
      ...
      folder.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">A <span class="em">URI</span> is displayed by which your <span class="file">Public</span> folder
        can be accessed from other computers on the network.</p></div></div></div></div>
</li>
</ol></div></div></div>
</div>
<div id="security" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Защита</span></h2></div>
<div class="region"><div class="contents"><div class="terms"><div class="inner"><div class="region"><dl class="terms">
<dt class="terms">Требуется пароль</dt>
<dd class="terms">
<p class="p">Если вы хотите установить пароль на доступ других пользователей к папке <span class="file">Общедоступные</span>, включите переключатель <span class="gui">Требовать пароль</span>. Без этого параметра любой сторонний пользователь сможет попробовать просмотреть папку <span class="file">Общедоступные</span>.</p>
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">По умолчанию эта опция отключена, но настоятельно рекомендуется включить её и выбрать надёжный пароль.</p></div></div></div></div>
</dd>
