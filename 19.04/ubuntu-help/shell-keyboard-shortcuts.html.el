...
<div class="trail">
<span style="color: #333">Ubuntu 19.04</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός Ubuntu επιφάνειας εργασίας</a> » <a class="trail" href="shell-overview.html.el" title="Η επιφάνεια εργασία σας">Επιφάνεια εργασίας</a> › <a class="trail" href="shell-overview.html.el#apps" title="Εφαρμογές και παράθυρα">Εφαρμογές και παράθυρα</a> » </div>
<div class="trail">
...
<div class="trail">
<span style="color: #333">Ubuntu 19.04</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός Ubuntu επιφάνειας εργασίας</a> » <a class="trail" href="tips.html.el" title="Συμβουλές &amp; κόλπα">Συμβουλές &amp; κόλπα</a> » </div>
<div class="trail">
...
<td style="border-top-style: solid;"><p class="p">Switch between windows in the current workspace. Hold down
      <span class="key"><kbd>Shift</kbd></span> for reverse order.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Εμφάνιση της λίστας εφαρμογών.</p></td>
</tr>
<tr>
<td style="border-top-style: solid;">
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-exit.html.el#logout" title="Αποσύνδεση ή αλλαγή χρηστών">Log Out</a></span>.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-exit.html.el#lock-screen" title="Κλείδωμα της οθόνης">Κλείδωμα της οθόνης.</a></span></p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>M</kbd></span></span> or
    <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>V</kbd></span></span></p></td>
<td style="border-top-style: solid;"><p class="p">Open <span class="link"><a href="shell-notifications.html.el#messagetray" title="shell-notifications#messagetray">the message
    tray</a></span>. Press <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>M</kbd></span></span> or
    <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>V</kbd></span></span> again or
...
<td><p class="p">Επιλογή όλων των κειμένων ή αντικειμένων σε μια λίστα.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Αποκοπή (αφαίρεση) του επιλεγμένου κειμένου ή αντικειμένων και τοποθέτησή τους στο πρόχειρο.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Αντιγραφή επιλεγμένου κειμένου ή αντικειμένων στο πρόχειρο.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Επικόλληση των περιεχομένων του προχείρου.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Αναίρεση της τελευταίας ενέργειας.</p></td>
</tr>
</table></div>
</div>
</div>
...
<div class="yelp-data yelp-data-ui-expander" dir="ltr" data-yelp-expanded="false"></div>
<div class="inner">
<div class="title title-table"><h2><span class="title">Σύλληψη από την οθόνη</span></h2></div>
<div class="region"><table class="table" style="border-top-style: solid;border-bottom-style: solid;">
<tr>
<td><p class="p"><span class="key"><kbd>Prt Scrn</kbd></span></p></td>
<td><p class="p"><span class="link"><a href="screen-shot-record.html.el#screenshot" title="Λήψη στιγμιότυπου">Λήψη στιγμιότυπου.</a></span></p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>Prt Scrn</kbd></span></span></p></td>
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="screen-shot-record.html.el#screenshot" title="Λήψη στιγμιότυπου">Λήψη στιγμιότυπου ενός παραθύρου.</a></span></p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Shift</kbd></span>+<span class="key"><kbd>Prt Scrn</kbd></span></span></p></td>
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="screen-shot-record.html.el#screenshot" title="Λήψη στιγμιότυπου">Λήψη στιγμιότυπου μιας περιοχής της οθόνης.</a></span> Ο δείκτης αλλάζει σε στόχο. Κάντε κλικ και σύρτε τον για να επιλέξετε μια περιοχή.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="screen-shot-record.html.el#screencast" title="Λήψη ενός στιγμιότυπου οθόνης">Έναρξη και τερματισμός εγγραφής στιγμιοτύπου οθόνης.</a></span></p></td>
</tr>
</table></div>
</div>
</div>
