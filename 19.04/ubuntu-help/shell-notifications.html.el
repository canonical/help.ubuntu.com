...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Notifications and the notification list</span></h1></div>
<div class="region">
...
<div class="hgroup"><h2 class="title"><span class="title">The notification list</span></h2></div>
<div class="region"><div class="contents">
<p class="p">The notification list gives you a way to
  ...
  <span class="keyseq"><span class="key"><a href="keyboard-key-super.html.el" title="Τι είναι το πλήκτρο Λογότυπο;"><kbd>Super</kbd></a></span>+<span class="key"><kbd>V</kbd></span></span>. The
...
<li class="steps"><p class="p">Switch <span class="gui">Notification Popups</span> to <span class="gui">OFF</span>.</p></li>
</ol></div></div></div>
<p class="p">When switched off, most notifications will not pop up at the top of the
  ...
  popping up again when you switch the toggle back to <span class="gui">ON</span>.</p>
