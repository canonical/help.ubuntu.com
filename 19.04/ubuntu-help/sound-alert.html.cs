...
<p class="p">Táhlo hlasitosti na kartě <span class="gui">Zvukové efekty</span> použijte k nastavení hlasitosti zvuku upozornění. Neovlivní to hlasitost ostatních zvuků, jako hudby, filmů apod.</p>
<p class="p">Jestli chcete zvuky upozornění zcela vypnout, přepněte vypínač <span class="gui">Hlasitost upozornění</span> na <span class="gui">Vypnuto</span>.</p>
</div>
