...
<li class="steps"><p class="p">Выберите звук уведомления на вкладке <span class="gui">Звуковые эффекты</span>. Нажатие на звуке позволяет прослушать его.</p></li>
</ol></div></div></div>
...
<p class="p">Чтобы полностью отключить звуковые уведомления, передвиньте переключатель <span class="gui">Громкость уведомлений</span> в положение <span class="gui">○</span>.</p>
</div>
