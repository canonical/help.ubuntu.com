...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents"><p class="p">V panelu <span class="gui">Uživatelé</span> můžete kliknout na obrázek vpravo vedle jména uživatele a nastavit účtu jiný obrázek. Ten se pak bude zobrazovat v přihlašovacím okně. GNOME poskytuje základní výběr obrázků, které můžete přímo použít nebo si můžete vybrat nějaký vlastní nebo si pořídit svoji fotografii pomocí webové kamery.</p></div></div></div></div>
</div>
