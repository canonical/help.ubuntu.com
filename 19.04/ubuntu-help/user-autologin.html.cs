...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents"><p class="p">Jestliže je váš účet typu <span class="em">Normální</span>, nemůžete měnit toto nastavení. Řekněte správci systému, který to může provést za vás.</p></div></div></div></div>
</div>
