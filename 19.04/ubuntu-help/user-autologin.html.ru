...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Автоматический вход</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Можно настроить автоматический вход в систему при запуске компьютера:</p>
...
<li class="steps"><p class="p">Выберите учётную запись, для которой нужно настроить автоматический вход.</p></li>
<li class="steps"><p class="p">Нажмите <span class="gui">Разблокировать</span> и введите свой пароль.</p></li>
<li class="steps"><p class="p">Передвиньте переключатель <span class="gui">Автоматический вход</span> в положение <span class="gui">❙</span>.</p></li>
</ol></div></div></div>
<p class="p">При следующем запуске компьютера вход в систему будет выполнен автоматически. Если этот параметр включён, не нужно будет водить пароль для авторизации. Это означает, что если кто-то другой включит компьютер, ему будут доступны данные вашей учётной записи и личная информация, включая файлы и историю просмотра в браузере.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Если учётная запись имеет <span class="em">Обычный</span> тип, эту настройку поменять нельзя. Обратитесь к вашему системному администратору.</p></div></div></div></div>
</div>
...
<a href="shell-exit.html.ru" title="Завершение сеанса, выключение компьютера или переключение пользователей">Завершение сеанса, выключение компьютера или переключение пользователей</a><span class="desc"> — Способы завершения работы с учётной записью: завершение сеанса, переключение пользователей и другие.</span>
</li></ul></div>
</div></div>
</div>
</div>
