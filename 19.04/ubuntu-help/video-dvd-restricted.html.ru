...
<div class="region"><div class="contents"><p class="p">Вы можете купить коммерческий DVD-декодер, который умеет работать с защитой от копирования, от компании <span class="link"><a href="https://fluendo.com/" title="https://fluendo.com/">Fluendo</a></span>. Он работает в Linux и его использование должно быть легальным во всех странах.</p></div></div>
</div></div>
