...
<title>Βρείτε το μενού γενικής πρόσβασης</title>
...
<span style="color: #333">Ubuntu 19.10</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός Ubuntu επιφάνειας εργασίας</a> » <a class="trail" href="a11y.html.el" title="Γενική πρόσβαση">Γενική πρόσβαση</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Βρείτε το μενού γενικής πρόσβασης</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Το <span class="em">γενικό μενού πρόσβασης</span> είναι εκεί όπου μπορείτε να ενεργοποιήσετε μερικές από τις ρυθμίσεις προσιτότητας. Μπορείτε να βρείτε αυτό το μενού κάνοντας κλικ στο εικονίδιο που φαίνεται σαν ένα άτομο που περιβάλλεται από έναν κύκλο στην πάνω γραμμή.</p>
...
<div class="desc">Το γενικό μενού πρόσβασης μπορεί να βρεθεί στην πάνω γραμμή.</div>
</div>
</div></div>
