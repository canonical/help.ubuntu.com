...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Μπορείτε να απ/ενεργοποιήσετε άμεσα κάνοντας κλικ στο <span class="link"><a href="a11y-icon.html.el" title="Βρείτε το μενού γενικής πρόσβασης">εικονίδιο προσιτότητας</a></span> στην πάνω γραμμή και να επιλέξετε <span class="gui">Εστίαση</span>.</p></div></div></div>
</div>
