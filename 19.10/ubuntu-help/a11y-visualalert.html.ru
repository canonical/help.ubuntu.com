...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Чтобы быстро включить или отключить визуальные уведомления, нажмите на <span class="link"><a href="a11y-icon.html.ru" title="Найдите меню универсального доступа">значок специальных возможностей</a></span> в верхней панели и измените положение переключателя <span class="gui">Визуальные предупреждения</span>.</p></div></div></div>
</div>
</div>
