...
<title>Γιατί δεν είναι ο τύπος λογαριασμού μου στον κατάλογο;</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Γιατί δεν είναι ο τύπος λογαριασμού μου στον κατάλογο;</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Η υποστήριξη για τον αγαπημένο σας πάροχο διαδικτυακής υπηρεσίας χρειάζεται κάποιο για να την αναπτύξει. Μόνο οι τύποι λογαριασμών που είναι καταχωρημένοι υποστηρίζονται προς το παρόν.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Εάν σκοπεύετε να προσθέσετε υποστήριξη για άλλες υπηρεσίες, επικοινωνήστε με τους προγραμματιστές στον <span class="link"><a href="https://bugzilla.gnome.org/enter_bug.cgi?product=gnome-online-accounts" title="https://bugzilla.gnome.org/enter_bug.cgi?product=gnome-online-accounts"> bug tracker</a></span>.</p></div></div></div>
</div>
</div>
