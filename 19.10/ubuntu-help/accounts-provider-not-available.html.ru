...
<span style="color: #333">Ubuntu 19.10</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="prefs.html.ru" title="Параметры пользователя и системы">Параметры</a> » <a class="trail" href="accounts.html.ru" title="Сетевые учётные записи">Сетевые учётные записи</a> » </div></div>
...
<p class="p">Поддержку вашего любимого поставщика сетевых учётных записей должен реализовать кто-нибудь из разработчиков. Поддерживаются только те типы учётных записей, которые присутствуют в списке.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Если вы заинтересованы в добавлении поддержки других сервисов, свяжитесь с разработчиками через <span class="link"><a href="https://bugzilla.gnome.org/enter_bug.cgi?product=gnome-online-accounts" title="https://bugzilla.gnome.org/enter_bug.cgi?product=gnome-online-accounts"> систему отслеживания ошибок</a></span>.</p></div></div></div>
</div>
</div>
