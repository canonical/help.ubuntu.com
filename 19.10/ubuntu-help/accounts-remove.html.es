...
<p class="p">Muchos proveedores de servicios en línea proporcionan un testigo de autorización que GNOME guarda en lugar su contraseña. Si elimina una cuenta, debe revocar también ese certificado en la cuenta en línea. Esto asegurará que ninguna otra aplicación o sitio web podrán conectarse a ese servicio usando la autorización para GNOME.</p>
