...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Conectar su equipo a un dispositivo Bluetooth</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Asegúrese de que Bluetooth está activado: el botón de la barra superior debe estar activado. Con el panel abierto y el interruptor encendido, el equipo debería empezar a buscar dispositivos.</p></li>
...
<div class="media media-image floatend"><div class="inner"><img src="figures/bluetooth-menu.png" class="media media-block" alt="El icono de Bluetooth en la barra superior"></div></div>
<p class="p">Cuando hay uno o más dispositivos Bluetooth conectados, el icono de Bluetooth aparece en el área de estado del sistema.</p>
</div>
