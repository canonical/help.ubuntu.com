...
<div class="region"><ul><li class="links ">
<a href="bluetooth-visibility.html.cs" title="Co je to viditelnost Bluetooth?">Co je to viditelnost Bluetooth?</a><span class="desc"> — Jestli ostatní zařízení mohou vyhledat váš počítač.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
