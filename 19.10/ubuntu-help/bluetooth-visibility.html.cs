...
<p class="p">The best way to find out how to enter that mode is to refer to the device’s
  ...
  <span class="link"><a href="bluetooth-device-specific-pairing.html.cs" title="Pairing instructions for specific devices">slightly different from usual</a></span>.
  </p>
</div>
...
<div class="region"><ul><li class="links ">
<a href="bluetooth-device-specific-pairing.html.cs" title="Pairing instructions for specific devices">Pairing instructions for specific devices</a><span class="desc"> — How to pair specific devices with your computer.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
