...
<p class="p">The best way to find out how to enter that mode is to refer to the device’s
  ...
  <span class="link"><a href="bluetooth-device-specific-pairing.html.es" title="Instrucciones de emparejado para dispositivos específicos">slightly different from usual</a></span>.
  </p>
</div>
