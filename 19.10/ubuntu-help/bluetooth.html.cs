...
<div class="linkdiv "><a class="linkdiv" href="bluetooth-device-specific-pairing.html.cs" title="Pairing instructions for specific devices"><span class="title">Pairing instructions for specific devices</span><span class="linkdiv-dash"> — </span><span class="desc">How to pair specific devices with your computer.</span></a></div>
</div></div></div></div>
</div>
