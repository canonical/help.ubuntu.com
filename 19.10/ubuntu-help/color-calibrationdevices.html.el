...
<li class="list"><p class="p">Gretag-Macbeth i1 Display 1, 2 ή LT (χρωματόμετρο)</p></li>
<li class="list"><p class="p">X-Rite i1 Display Pro (χρωματόμετρο)</p></li>
<li class="list"><p class="p">X-Rite ColorMunki σχεδίαση ή φωτογραφία (φασματόμετρο)</p></li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Το Pantone Huey είναι τώρα το πιο φτηνό και άριστα υποστηριζόμενο υλικό στο Linux.</p></div></div></div>
</div>
<p class="p">
...
<li class="list"><p class="p">X-Rite DTP51 (ανάγνωσης σημείου ανακλαστικού φασματομέτρου)</p></li>
</ul></div></div></div>
</div>
