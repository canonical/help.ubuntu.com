...
<div class="region">
<div class="contents pagewide"><p class="p">Μπορείτε να ελέγξετε πόσος χώρος έχει απομείνει στον δίσκο με τον <span class="app">Αναλυτή χρήσης δίσκου</span> ή την <span class="app">Παρακολούθηση συστήματος</span>.</p></div>
