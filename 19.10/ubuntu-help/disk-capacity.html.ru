...
<div class="region">
<div class="contents pagewide"><p class="p">Проверить, сколько свободного места осталось на диске, можно с помощью <span class="app">Анализатора использования дисков</span> или <span class="app">Системного монитора</span>.</p></div>
