...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Προεπισκόπηση αρχείων και φακέλων</span></h1></div>
<div class="region">
...
<a href="nautilus-preview.html.el" title="Προτιμήσεις προεπισκόπησης του διαχειριστή αρχείων">Προτιμήσεις προεπισκόπησης του διαχειριστή αρχείων</a><span class="desc"> — Ελέγξτε πότε οι μικρογραφίες χρησιμοποιούνται για τα αρχεία.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
