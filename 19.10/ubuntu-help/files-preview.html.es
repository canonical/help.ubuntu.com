...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Previsualizar archivos y carpetas</span></h1></div>
<div class="region">
...
<p class="p">Necesita tener instalado <span class="app">Sushi</span> en su equipo para seguir estos pasos.</p>
<p class="p"><span class="link-button link"><a href="apt:gnome-sushi" title="apt:gnome-sushi">Instalar <span class="app">Sushi</span></a></span></p>
</div></div></div>
</div>
...
<a href="nautilus-preview.html.es" title="Preferencias de la vista previa del gestor de archivos">Preferencias de la vista previa del gestor de archivos</a><span class="desc"> — Controlar cuándo se usan miniaturas para los archivos.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
