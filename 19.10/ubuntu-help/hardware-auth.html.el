...
<title>Αποτυπώματα &amp; έξυπνες κάρτες</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Αποτυπώματα &amp; έξυπνες κάρτες</span></h1></div>
<div class="region">
<div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="session-fingerprint.html.el" title="Είσοδος με δακτυλικό αποτύπωμα"><span class="title">Είσοδος με δακτυλικό αποτύπωμα</span><span class="linkdiv-dash"> — </span><span class="desc">Μπορείτε να συνδεθείτε στο σύστημά σας χρησιμοποιώντας έναν σαρωτή που υποστηρίζει δακτυλικό αποτύπωμα αντί να πληκτρολογήσετε τον κωδικό πρόσβασής σας.</span></a></div></div></div></div></div></div>
