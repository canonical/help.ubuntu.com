...
<div class="links-grid-link"><a href="bluetooth.html.es" title="Bluetooth">Bluetooth</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="bluetooth-connect-device.html.es" title="Conectar su equipo a un dispositivo Bluetooth">Connectar</a></span>, <span class="link"><a href="bluetooth-send-file.html.es" title="Enviar archivos a un dispositivo Bluetooth">envar archivos</a></span>, <span class="link"><a href="bluetooth-turn-on-off.html.es" title="Encender o apagar el Bluetooth">apagar y encender</a></span>…</span></div>
</div>
<div class="links-grid ">
<div class="links-grid-link"><a href="disk.html.es" title="Discos y almacenamiento">Discos y almacenamiento</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="disk-capacity.html.es" title="Comprobar cuánto espacio de disco hay disponible">Espacio en disco</a></span>, <span class="link"><a href="disk-benchmark.html.es" title="Comprobar el rendimiento de su disco duro">rendimiento</a></span>, <span class="link"><a href="disk-check.html.es" title="Comprobar los problemas del disco duro">problemas</a></span>, <span class="link"><a href="disk-partitions.html.es" title="Gestionar volúmenes y particiones">volúmenes y particiones</a></span>…</span></div>
</div>
<div class="links-grid ">
...
<div class="links-grid ">
<div class="links-grid-link"><a href="hardware-auth.html.es" title="Huellas dactilares y tarjetas inteligentes">Huellas dactilares y tarjetas inteligentes</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="session-fingerprint.html.es" title="Iniciar sesión con una huella dactilar">Lectores de huellas digitales</a></span>, tarjetas inteligentes…</span></div>
</div>
<div class="links-grid ">
<div class="links-grid-link"><a href="printing.html.es" title="Imprimir">Imprimir</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="printing-setup.html.es" title="Configurar una impresora local">Configuración local</a></span>, <span class="link"><a href="printing-order.html.es" title="Hacer que las páginas se impriman en diferente orden">ordenar y clasificar</a></span>, <span class="link"><a href="printing-2sided.html.es" title="Imprimir diseños de páginas múltiples y a doble cara">doble cara y multipágina</a></span></span></div>
</div>
<div class="links-grid ">
...
<li class="links ">
<a href="hardware-cardreader.html.es" title="Problemas con lectores de tarjetas">Problemas con lectores de tarjetas</a><span class="desc"> — Troubleshoot media card readers.</span>
</li>
<li class="links ">
