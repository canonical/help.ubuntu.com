...
<title>Что такое клавиша Меню?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Что такое клавиша <span class="key"><kbd>Меню</kbd></span>?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Клавиша <span class="key"><kbd>Меню</kbd></span>, также известная, как <span class="em">Приложения</span>, находится на многих клавиатурах, ориентированных на работу в ОС Windows Эта клавиша обычно располагается внизу справа, рядом с клавишей <span class="key"><kbd>Ctrl</kbd></span>, но производители могут размещать её и в других местах. Обычно она изображается значком курсора, наведённым на меню: <span class="media"><span class="media media-image"><img src="figures/keyboard-key-menu.svg" class="media media-inline" alt="Menu key icon"></span></span>.</p>
<p class="p">Основным назначением этой клавиши является запуск контекстного меню с помощью клавиатуры, вместо нажатия правой клавиши мышки. Это удобно, если мышь или аналогичное устройство недоступно, или если у мышки отсутствует правая клавиша.</p>
<p class="p">Клавиша <span class="key"><kbd>Menu</kbd></span> иногда отсутствует на клавиатурах, её не включают в интересах экономии места, особенно на клавиатурах портативных устройств и ноутбуков. В таких случаях существует функциональная клавиша <span class="key"><kbd>Меню</kbd></span>, которую можно активировать в сочетании с клавишей Function (<span class="key"><kbd class="key-Fn">Fn</kbd></span>).</p>
<p class="p"><span class="em">Контекстное меню</span> — это меню, появляющееся по нажатию правой клавиши мышки. Если меню предусмотрено, то его содержимое зависит от контекста и функционала той области, где было произведено нажатие. При использовании клавиши <span class="key"><kbd>Меню</kbd></span> контекстное меню показывается для той области, над которой располагается курсор мыши в момент нажатия клавиши.</p>
</div>
