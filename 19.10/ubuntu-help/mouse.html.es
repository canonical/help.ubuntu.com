...
<div class="linkdiv "><a class="linkdiv" href="touchscreen-gestures.html.es" title="Use touchscreen gestures to navigate the desktop"><span class="title">Use touchscreen gestures to navigate the desktop</span><span class="linkdiv-dash"> — </span><span class="desc">Manipulate your desktop using gestures on your touchscreen.</span></a></div>
</div>
</div></div></div></div></div>
