...
<p class="p">By default, all previews are done for
    ...
    <span class="link"><a href="nautilus-connect.html.cs" title="Procházení souborů na serveru nebo síťovém sdílení">browse files on other computers</a></span> over
...
<dd class="terms">
<p class="p">If you show file sizes in <span class="link"><a href="nautilus-list.html.cs" title="Předvolby sloupců v seznamu souborů">list view columns</a></span>
    or <span class="link"><a href="nautilus-display.html.cs#icon-captions" title="Popisy ikon">icon captions</a></span>,
