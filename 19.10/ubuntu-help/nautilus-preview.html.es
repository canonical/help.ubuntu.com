...
<dd class="terms">
<p class="p">If you show file sizes in <span class="link"><a href="nautilus-list.html.es" title="Preferencias de las columnas en la lista de archivos">list view columns</a></span>
    or <span class="link"><a href="nautilus-display.html.es#icon-captions" title="Títulos de iconos">icon captions</a></span>,
