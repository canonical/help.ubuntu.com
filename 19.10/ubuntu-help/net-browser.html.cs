...
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="net-install-flash.html.cs" title="Instalace zásuvného modulu Flash"><span class="title">Instalace zásuvného modulu Flash</span><span class="linkdiv-dash"> — </span><span class="desc">Pro zobrazení některých stránek obsahujících videa a interaktivní prvky můžete potřebovat nainstalovat Flash.</span></a></div></div>
...
<div class="region"><ul><li class="links "><a href="gs-browse-web.html.cs" title="Brouzdání po webu">Vysvětlení, jak brouzdat po webu</a></li></ul></div>
</div></div>
</div>
</div></section>
</div>
