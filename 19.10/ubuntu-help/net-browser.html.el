...
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="net-install-flash.html.el" title="Εγκατάσταση πρόσθετου για το flash"><span class="title">Εγκατάσταση πρόσθετου για το flash</span><span class="linkdiv-dash"> — </span><span class="desc">You may need to install Flash to be able to view some websites, which display videos and interactive web pages.</span></a></div></div>
</div></div></div></div></div>
