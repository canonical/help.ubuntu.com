...
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="net-install-flash.html.ru" title="Установка Flash-плагина"><span class="title">Установка Flash-плагина</span><span class="linkdiv-dash"> — </span><span class="desc">Flash может понадобиться для просмотра некоторых сайтов, содержащих видео и интерактивные веб-страницы.</span></a></div></div>
</div></div></div></div></div>
