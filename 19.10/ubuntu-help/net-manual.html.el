...
<div class="trail">
<span style="color: #333">Ubuntu 19.10</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός Ubuntu επιφάνειας εργασίας</a> » <a class="trail" href="net.html.el" title="Δικτύωση, ιστός &amp; ηλεκτρονική αλληλογραφία">Δικτύωση, ιστός &amp; ηλεκτρονική αλληλογραφία</a> » <a class="trail" href="net-wired.html.el" title="Wired networking">Wired networking</a> » </div>
<div class="trail">
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Χειροκίνητος ορισμός ρυθμίσεων δικτύου</span></h1></div>
<div class="region">
...
<li class="steps">
<p class="p">Click the
      <span class="media"><span class="media media-image"><img src="figures/emblem-system.png" class="media media-inline" alt="settings"></span></span>button.</p>
...
<li class="steps"><p class="p">Click <span class="gui">Apply</span>. If you are not connected to the network, open the
      <span class="gui"><a href="shell-introduction.html.el#systemmenu" title="System menu">system menu</a></span> from the right side of
...
<div class="region"><ul>
<li class="links ">
<a href="net-wired.html.el" title="Wired networking">Wired networking</a><span class="desc"> — <span class="link"><a href="net-wired-connect.html.el" title="Σύνδεση σε ενσύρματο δίκτυο (Ethernet)">Ενσύρματες συνδέσεις διαδικτύου</a></span>, <span class="link"><a href="net-fixed-ip-address.html.el" title="Δημιουργία σύνδεσης με σταθερή διεύθυνση IP">Σταθερές διευθύνσεις IP</a></span>…</span>
</li>
<li class="links ">
