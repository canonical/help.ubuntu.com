...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Apagar el modo inalámbrico (modo avión)</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Pulse en <span class="gui">Inalámbrica</span> para abrir el panel.</p></li>
<li class="steps"><p class="p">Active el <span class="gui">Modo avión</span>. Esto apagará su conexión inalámbrica hasta que apague el modo avión.</p></li>
</ol></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Puede desactivar su conexión inalámbrica desde el <span class="gui"><a href="shell-introduction.html.es#systemmenu" title="Menú del sistema">menú del sistema</a></span> pulsando en el nombre de la conexión y eligiendo <span class="gui">Apagar</span>.</p></div></div></div>
</div>
</div>
