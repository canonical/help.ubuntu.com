...
<li class="steps"><p class="p">Open the
      <span class="gui"><a href="shell-introduction.html.es#systemmenu" title="Menú del sistema">system menu</a></span> from the right
      ...
      You should also check that <span class="link"><a href="net-wireless-airplane.html.es" title="Apagar el modo inalámbrico (modo avión)">Airplane
