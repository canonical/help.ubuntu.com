...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Numeric keypad</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Open <span class="app"><span class="link"><a href="startup-applications.html.el" title="Startup Applications">Startup Applications</a></span></span>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">The second step may be redundant on your computer, so try without it first.</p></div></div></div>
</div>
</div>
