...
<div class="trail">
<span style="color: #333">Ubuntu 19.10</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός Ubuntu επιφάνειας εργασίας</a> » <a class="trail" href="prefs.html.el" title="Χρήστης &amp; ρυθμίσεις συστήματος">Ρυθμίσεις</a> » <a class="trail" href="power.html.el" title="Ενέργεια &amp; μπαταρία">Ενέργεια &amp; μπαταρία</a> » </div>
<div class="trail">
...
<li class="list">
<p class="p">Εάν δεν χρειάζεστε για λίγο να είστε συνδεδεμένοι στο διαδίκτυο, απενεργοποιήστε την κάρτα ασύρματου ή Bluetooth. Αυτές οι συσκευές λειτουργούν εκπέμποντας ραδιοκύματα, καταναλώνοντας αρκετή ισχύ.</p>
