...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Puede eliminar archivos inemdiata y permanentemente si usar la papelera. Consulte la <span class="link"><a href="files-delete.html.es#permanent" title="Eliminar permanentemente un archivo">Eliminar permanentemente un archivo</a></span> para obtener más información.</p></div></div></div>
</div>
</div>
