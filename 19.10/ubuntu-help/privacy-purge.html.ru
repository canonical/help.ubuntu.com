...
<li class="steps"><p class="p">Выберите <span class="gui">Очистка корзины и удаление временных файлов</span>.</p></li>
...
<li class="steps"><p class="p">Настройте частоту очистки <span class="em">Корзины</span> и <span class="em">Временных файлов</span>, изменив значение параметра <span class="gui">Очищать после</span>.</p></li>
