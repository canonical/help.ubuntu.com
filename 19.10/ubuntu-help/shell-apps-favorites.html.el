...
<title>Βάλτε τις αγαπημένες σας εφαρμογές στο ταμπλό</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Βάλτε τις αγαπημένες σας εφαρμογές στο ταμπλό</span></h1></div>
<div class="region">
...
<p class="p">Εναλλακτικά, μπορείτε να κάνετε κλικ και να σύρετε το εικονίδιο στο ταμπλό</p>
</li>
</ol></div></div></div>
<p class="p">Για να αφαιρέσετε ένα εικονίδιο εφαρμογής από το ταμπλό, κάντε δεξί κλικ στο εικονίδιο της εφαρμογής και επιλέξτε <span class="gui">Αφαίρεση από τα αγαπημένα</span>.</p>
</div>
