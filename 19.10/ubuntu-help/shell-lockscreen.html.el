...
<div class="trail">
<span style="color: #333">Ubuntu 19.10</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός Ubuntu επιφάνειας εργασίας</a> » <a class="trail" href="shell-overview.html.el" title="Η επιφάνεια εργασία σας">Επιφάνεια εργασίας</a> › <a class="trail" href="shell-overview.html.el#desktop" title="Προσαρμογή της επιφάνειας εργασίας σας">Προσαρμογή της επιφάνειας εργασίας σας</a> » <a class="trail" href="shell-notifications.html.el" title="Notifications and the notification list">Notifications and the notification list</a> › <a class="trail" href="shell-notifications.html.el#lock-screen-notifications" title="Hiding lock screen notifications">Hiding lock screen notifications</a> » </div>
</div>
...
<div class="region"><ul>
<li class="links "><a href="shell-notifications.html.el#lock-screen-notifications" title="Hiding lock screen notifications">Hiding lock screen notifications</a></li>
