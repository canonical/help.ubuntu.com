...
<div class="trail">
<span style="color: #333">Ubuntu 19.10</span> » <a class="trail" href="index.html.sl" title="Namizni vodnik Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Pomoč"></span></span> Vodič po namizju Ubuntu</a> » <a class="trail" href="shell-overview.html.sl" title="Your desktop">Namizje</a> › <a class="trail" href="shell-overview.html.sl#desktop" title="Customize your desktop">Customize your desktop</a> » <a class="trail" href="shell-notifications.html.sl" title="Notifications and the notification list">Notifications and the notification list</a> › <a class="trail" href="shell-notifications.html.sl#lock-screen-notifications" title="Hiding lock screen notifications">Hiding lock screen notifications</a> » </div>
<div class="trail">
...
<p class="p">To unlock your computer, raise the lock screen curtain by dragging it
  upward with the cursor, or by pressing <span class="key"><kbd>Esc</kbd></span> or <span class="key"><kbd>Enter</kbd></span>.
...
<p class="p">To hide notifications from the lock screen, see
  <span class="link"><a href="shell-notifications.html.sl#lock-screen-notifications" title="Hiding lock screen notifications">Hiding lock screen notifications</a></span>.</p>
</div>
...
<div class="region"><ul>
<li class="links "><a href="shell-notifications.html.sl#lock-screen-notifications" title="Hiding lock screen notifications">Hiding lock screen notifications</a></li>
