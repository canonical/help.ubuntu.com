...
<div class="links-divs">
<div class="linkdiv "><a class="linkdiv" href="shell-apps-auto-start.html.cs" title="Have applications start automatically on log in"><span class="title">Have applications start automatically on log in</span><span class="linkdiv-dash"> — </span><span class="desc">Use <span class="app">Tweaks</span> to start applications automatically on
    login.</span></a></div>
...
<div class="linkdiv "><a class="linkdiv" href="shell-lockscreen.html.cs" title="The lock screen"><span class="title">The lock screen</span><span class="linkdiv-dash"> — </span><span class="desc">Okrasná a zároveň funkční zamykací obrazovka zprostředkovává užitečné informace.</span></a></div>
