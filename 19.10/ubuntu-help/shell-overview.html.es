...
<div class="linkdiv "><a class="linkdiv" href="gnome-classic.html.es" title="¿Qué es una dirección GNOME clásico?"><span class="title">¿Qué es una dirección GNOME clásico?</span><span class="linkdiv-dash"> — </span><span class="desc">Considere cambiar a GNOME clásico si prefiere una experiencia del escritorio más tradicional.</span></a></div>
</div>
</div></div></div></div></div>
...
<div class="links-divs">
<div class="linkdiv "><a class="linkdiv" href="shell-apps-auto-start.html.es" title="Have applications start automatically on log in"><span class="title">Have applications start automatically on log in</span><span class="linkdiv-dash"> — </span><span class="desc">Use <span class="app">Tweaks</span> to start applications automatically on
    login.</span></a></div>
