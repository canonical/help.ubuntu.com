...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Αλλαγή της φωτογραφίας οθόνης εισόδου</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Όταν συνδέεστε ή αλλάζετε χρήστες, θα δείτε μια λίστα χρηστών με τις φωτογραφίες σύνδεσης τους. Μπορείτε να αλλάξετε την φωτογραφία σας με μια εικόνα παρακαταθήκης ή μια δικιά σας εικόνα. Μπορείτε ακόμα να πάρετε μια νέα φωτογραφία με την ιστοκάμερά σας.</p>
...
<li class="steps"><p class="p">Αν θέλετε να επεξεργαστείτε έναν χρήστη εκτός από τον εαυτόν σας, πατήστε <span class="gui">Ξεκλείδωμα</span> στην πάνω δεξιά γωνία και πληκτρολογήστε τον κωδικό πρόσβασής σας όταν σας ζητηθεί.</p></li>
<li class="steps">
