...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Povečavo lahko hitro vklopite in izklopite s klikom na <span class="link"><a href="a11y-icon.html.sl" title="Najdite meni splošnega dostopa">ikono splošnega dostopa</a></span> v vrhnji vrstici in izbiro <span class="gui">Povečava</span>.</p></div></div></div>
</div>
