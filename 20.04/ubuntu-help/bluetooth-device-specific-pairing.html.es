...
<p class="p">Incluso si logra obtener el manual de un dispositivo, es posible que no contenga suficiente información para lograr el emparejamiento. Aquí hay detalles para algunos dispositivos comunes.</p>
...
<dd class="terms"><p class="p">Pulse los botones «Start» y «Enter» a la vez durante unos 5 segundos. Puede seleccionar el control remoto en la lista de dispositivos de la manera habitual.</p></dd>
