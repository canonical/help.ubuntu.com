...
<title>¿Qué es la visibilidad de Bluetooth?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Qué es la visibilidad de Bluetooth?</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Puede <span class="link"><a href="sharing-displayname.html.es" title="Establecer el nombre visible del equipo">cambiar</a></span> el nombre que el equipo muestra a otros dispositivos.</p></div></div></div>
</div>
...
<p class="p">Los dispositivos sin pantalla normalmente tienen un modo de emparejamiento que se puede usar pulsando un botón o una combinación de botones durante un tiempo si ya se han activado o como si se hubiera activado.</p>
<p class="p">La mejor manera de averiguar cómo entrar en ese modo es consultar el manual del dispositivo. Para algunos dispositivos, el procedimiento puede ser <span class="link"><a href="bluetooth-device-specific-pairing.html.es" title="Instrucciones de emparejado para dispositivos específicos">ligeramente diferente del habitual</a></span>.</p>
</div>
...
<div class="region"><ul><li class="links ">
<a href="bluetooth-device-specific-pairing.html.es" title="Instrucciones de emparejado para dispositivos específicos">Instrucciones de emparejado para dispositivos específicos</a><span class="desc"> — Cómo emparejar dispositivos específicos a su equipo.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
