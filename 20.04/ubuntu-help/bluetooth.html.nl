...
<p class="p">Bluetooth is een draadloos protocol dat u in staat stelt een heleboel verschillende soorten apparaten met uw computer te verbinden. Bluetooth wordt meestal gebruikt voor koptelefoons en invoerapparaten zoals een muis of een toetsenbord. U kunt Bluetooth ook gebruiken om <span class="link"><a href="bluetooth-send-file.html.nl" title="Bestanden sturen naar een Bluetooth-apparaat">bestanden van het ene naar het andere apparaat te versturen</a></span>, zoals van uw computer naar uw mobiel.</p>
