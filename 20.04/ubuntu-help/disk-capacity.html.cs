...
<div class="region">
<div class="contents pagewide"><p class="p">Kolik vám na disku zbývá volného místa můžete zjistit pomocí <span class="app">Analyzátoru využití disku</span> nebo pomocí <span class="app">Sledování systému</span>.</p></div>
