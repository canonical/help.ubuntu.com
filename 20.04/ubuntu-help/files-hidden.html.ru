...
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">По умолчанию скрытые файлы будут отображаться в менеджере файлов только пока его не закроют. О том, как сделать так, чтобы файловый менеджер всегда показывал скрытые файлы, смотрите в разделе <span class="link"><a href="nautilus-views.html.ru" title="Параметры просмотра файлов и папок в Nautilus">Параметры просмотра файлов и папок в <span class="app">Nautilus</span></a></span>.</p></div></div></div>
</div>
<div class="note" title="Примечание">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
  ...
  <span class="link"><a href="files-tilde.html.ru" title="What is a file with a ~ at the end of its name?">What is a file with a <span class="file">~</span> at the end of its name?</a></span> for more information.</p></div></div></div>
</div>
</div></div>
