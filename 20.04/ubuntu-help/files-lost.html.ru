...
<li class="list"><p class="p">If you do not remember where you saved the file, but you have some
  idea of how you named it, you can <span class="link"><a href="files-search.html.ru" title="Поиск файлов">search for the
...
<li class="list"><p class="p">You might have renamed the file in a way that made the file hidden.
  ...
  Hidden Files</span> to display them. See <span class="link"><a href="files-hidden.html.ru" title="Скрытие файла">Скрытие файла</a></span> to learn
  more.</p></li>
</ul></div></div></div>
</div>
