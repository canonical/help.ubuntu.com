...
<a href="gs-get-online.html.es" title="Conectarse a Internet">Anterior</a><a href="gs-connect-online-accounts.html.es" title="Conectarse a cuentas en línea">Siguiente</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Navegar por la Web</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Alternativamente, puede abrir el navegador <span class="app">Firefox</span> <span class="link"><a href="gs-use-system-search.html.es" title="Utilizar la búsqueda de sistema">simplemente escribiendo</a></span> el nombre del navegador en la <span class="gui">Vista de actividades</span>.</p></div></div></div>
</div>
...
<p class="p">Si el sitio web se encuentra en el histórico o en los marcadores, aparece una lista desplegable debajo de la barra de direcciones.</p>
</li>
