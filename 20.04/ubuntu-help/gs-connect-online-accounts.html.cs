...
<a href="gs-browse-web.html.cs" title="Brouzdání po webu">Předchozí</a><a href="gs-change-date-time-timezone.html.cs" title="Změna data, času a časového pásma">Následující</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Připojení k účtům on-line</span></h1></div>
<div class="region">
...
<p class="p">Klikněte na panel <span class="gui">Účty on-line</span> a následně klikněte účet on-line služby, který chcete použít.</p>
<p class="p">Tím se otevře nové okno, ve kterém se můžete k účtu přihlásit.</p>
</li></ol></div></div></div>
...
<li class="steps"><p class="p">Například, když se připojujete ke svému účtu Google, budete muset kliknout na tlačítko <span class="gui">Schálit přístup</span>.</p></li>
</ol></div></div></div>
