...
<title>Переключение между задачами</title>
...
<a href="gs-launch-applications.html.ru" title="Запуск приложений">Назад</a><a href="gs-use-windows-workspaces.html.ru" title="Использование окон и рабочих столов">Вперёд</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Переключение между задачами</span></h1></div>
<div class="region">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Переключение между задачами</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Чтобы открыть <span class="gui">Обзор</span>, передвиньте курсор мыши на <span class="gui">Обзор</span> в левом верхнем углу экрана. Здесь можно увидеть все текущие задачи в виде маленьких окошек.</p></li>
<li class="steps"><p class="p">Нажмите на окно, чтобы переключиться на эту задачу.</p></li>
</ol></div></div></div></div></div>
</div></section><section id="switching-tasks-tiling"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Плиточное расположение окон</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="steps"><div class="inner"><div class="region"><ol class="steps">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Переключение между окнами</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Чтобы открыть <span class="gui">переключатель окон</span>, где показаны все открытые на данный момент окна, нажмите комбинацию клавиш <span class="keyseq"><span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super </kbd></a></span>+<span class="key"><kbd>Tab</kbd></span></span>.</p></li>
<li class="steps"><p class="p">Отпустите клавишу <span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span> для выбора следующего выделенного окна в <span class="gui">переключателе окон</span>.</p></li>
<li class="steps"><p class="p">Для перемещения по списку открытых окон нажмите клавишу <span class="key"><kbd>Tab</kbd></span>, одновременно удерживая клавишу <span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span>.</p></li>
</ol></div></div></div></div></div>
</div></section><section id="switch-tasks-search"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Для переключения между приложениями можно использовать поиск</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Откройте <span class="gui">Обзор</span>, нажав клавишу <span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span>.</p></li>
<li class="steps"><p class="p">Просто начните вводить название приложения, на которое вы хотите переключиться. По мере ввода текста будут появляться приложения с названиями, соответствующими вводимому тексту.</p></li>
<li class="steps"><p class="p">Когда в результатах появится приложение, на которое вы хотите переключиться, нажмите клавишу <span class="key"><kbd>Enter</kbd></span>.</p></li>
</ol></div></div></div></div></div>
