...
<a href="gs-switch-tasks.html.ru" title="Переключение между задачами">Назад</a><a href="gs-use-system-search.html.ru" title="Использование системного поиска">Вперёд</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Использование окон и рабочих столов</span></h1></div>
<div class="region">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Разворачивание окон на полный экран и восстановление их размеров</span></h2></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Разворачивание окон на полный экран и восстановление их размеров с помощью клавиатуры</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Чтобы развернуть окно на весь экран с помощью клавиатуры, нажмите клавишу <span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span> и затем <span class="key"><kbd>↑</kbd></span>.</p></li>
<li class="steps"><p class="p">Чтобы восстановить размеры окна с помощью клавиатуры, нажмите клавишу <span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span> и затем <span class="key"><kbd>↓</kbd></span>.</p></li>
</ol></div></div></div></div></div>
</div></section><section id="use-workspaces-and-windows-tile-keyboard"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Плиточное расположение окон с помощью клавиатуры</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Чтобы растянуть окно вдоль правой стороны экрана, нажмите клавишу <span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span> и затем <span class="key"><kbd>→</kbd></span>.</p></li>
<li class="steps"><p class="p">Чтобы растянуть окно вдоль левой стороны экрана, нажмите клавишу <span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span> и затем <span class="key"><kbd>←</kbd></span>.</p></li>
</ol></div></div></div></div></div>
</div></section><section id="use-workspaces-and-windows-workspaces-keyboard"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Переключение рабочих мест с помощью клавиатуры</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Чтобы переключиться на одно рабочее место вниз, нажмите комбинацию клавиш <span class="keyseq"><span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span>+<span class="key"><kbd>Page Down</kbd></span></span>.</p></li>
<li class="steps"><p class="p">Чтобы переключиться на одно рабочее место вверх, нажмите комбинацию клавиш <span class="keyseq"><span class="key"><a href="help:gnome-help/keyboard-key-super" title="help:gnome-help/keyboard-key-super"><kbd>Super</kbd></a></span>+<span class="key"><kbd>Page Up</kbd></span></span>.</p></li>
</ol></div></div></div></div></div>
