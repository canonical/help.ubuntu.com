...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Používání klávesnice na obrazovce</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Klávesnice na obrazovce se zobrazí automaticky, pokud používáte dotykovou obrazovku.</p></div></div></div>
</div>
...
<p class="p">Klávesnici můžete dočasně skrýt zmáčknutím tlačítka <span class="gui"><span class="media"><span class="media media-image"><img src="figures/go-down-symbolic.svg" height="16" width="16" class="media media-inline" alt="dolů"></span></span></span>. Automaticky se znovu objeví, když se zaměříte někam, kde ji lze použít.</p>
