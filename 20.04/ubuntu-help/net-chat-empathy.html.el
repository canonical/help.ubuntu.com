...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Άμεσα μηνύματα στο Ubuntu</span></h1></div>
<div class="region">
...
<p class="p">Το Empathy δεν είναι προεγκατεστημένο στο Ubuntu, αλλά μπορείτε το <span class="link"><a href="apt:empathy" title="apt:empathy">εγκαταστήσετε</a></span> από το αποθετήριο του Ubuntu. Για βοήθεια σχετικά με τη χρήση του Empathy, διαβάστε την <span class="link"><a href="https://help.gnome.org/users/empathy/stable/" title="https://help.gnome.org/users/empathy/stable/">Τεκμηρίωση του Empathy</a></span>.</p>
</div>
