...
<li class="steps"><p class="p">Busque la conexión de red a la que quiere asignar una IP fija. Pulse el botón <span class="media"><span class="media media-image"><img src="figures/emblem-system.png" class="media media-inline" alt="configuración"></span></span> junto a la conexión de red. Para una conexión <span class="gui">Inalámbrica</span>, el botón <span class="media"><span class="media media-image"><img src="figures/emblem-system.png" class="media media-inline" alt="configuración"></span></span> se situará junto a la red activa.</p></li>
