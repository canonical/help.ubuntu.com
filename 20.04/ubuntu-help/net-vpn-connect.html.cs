...
<li class="steps"><p class="p">Až je nastavení VPN dokončené, otevřete <span class="gui"><a href="shell-introduction.html.cs#systemmenu" title="Nabídka systému">nabídku systému</a></span> vpravo na horní liště, klikněte na <span class="gui">VPN   Vypnuto</span> a vyberte <span class="gui">Připojit</span>. Možná budete muset, než se spojení sestaví, pro něj zadat heslo. Jakmile je spojení sestavené, uvidíte na horní liště ikonu ve tvaru zámku.</p></li>
