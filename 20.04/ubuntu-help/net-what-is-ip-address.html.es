...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Qué es una dirección IP?</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Una dirección IP puede ser <span class="em">dinámica</span> o <span class="em">estática</span>. Las direcciones IP dinámicas se asignan temporalmente cada vez que su equipo se conecta a la red. Las direcciones IP son fijas, y no cambian. Las direcciones IP dinámicas son más frecuentes que las estáticas ya que las estáticas solo se usan habitualmente cuando hay un motivo especial par ello, como administrar un servidor.</p></div></div></div>
</div>
</div>
