...
<div class="media media-image floatstart"><div class="inner"><img src="figures/shell-activities-dash.png" height="530" class="media media-block" alt="Botón de Actividades en el tablero"></div></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Menú de aplicaciones</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<p class="p">El menú de aplicación, situado junto al botón de <span class="gui">Actividades</span>, muestra el nombre de la aplicación activa junto con su icono y proporciona un acceso rápido a las ventanas y los detalles de la aplicación, así como a un elemento para salir.</p>
</div></div>
...
<p class="p">Pulse en el reloj en el centro de la barra superior para ver la fecha actual, un calendario mensual y una lista de sus próximas citas. También puede abrir el calendario pulsando <span class="keyseq"><span class="key"><kbd>Súper</kbd></span>+<span class="key"><kbd>M</kbd></span></span>. Puede acceder a la configuración de fecha y hora y abrir totalmente su calendario directamente desde el menú.</p>
<div class="list"><div class="inner"><div class="region"><ul class="list compact">
