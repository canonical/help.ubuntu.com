...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Aplikace spouštěné při přihlášení</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Příkaz můžete buď napsat nebo kliknout na tlačítko <span class="gui">Procházet...</span> a příkaz vybrat. Aplikace k automatickému spouštění jsou typicky umístěné ve složce <span class="code">/usr/bin</span>.</p></div></div></div>
</div>
</div>
