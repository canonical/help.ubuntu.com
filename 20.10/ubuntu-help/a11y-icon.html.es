...
<p class="p">El <span class="em">menú de accesibilidad</span> es donde puede activar varios ajustes de accesibilidad. Puede encontrar este menú pulsando sobre el icono que parece una persona rodeada de un círculo, en la barra superior.</p>
...
<li class="steps"><p class="p">Active la opción <span class="gui">Mostrar siempre el menú de accesibilidad</span>.</p></li>
</ol></div></div></div>
<p class="p">Para acceder a este menú mediante el teclado en lugar del ratón, pulse <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>Tab</kbd></span></span> para mover el foco del teclado a la barra superior. Aparecerá una línea blanca debajo del botón <span class="gui">Actividades</span>; le indica qué elemento de la barra superior se selecciona. Utilice las teclas de flecha del teclado para mover la línea blanca en el icono de menú de accesibilidad y luego pulse <span class="key"><kbd>Intro</kbd></span> para abrirlo. Puede usar las teclas de flecha para seleccionar elementos del menú. Pulse <span class="key"><kbd>Intro</kbd></span> para cambiar al elemento seleccionado.</p>
</div>
...
<a href="a11y.html.es" title="Accesibilidad">Accesibilidad</a><span class="desc"> — <span class="link"><a href="a11y.html.es#vision" title="Deficiencias visuales">Visión</a></span>, <span class="link"><a href="a11y.html.es#sound" title="Deficiencias auditivas">audición</a></span>, <span class="link"><a href="a11y.html.es#mobility" title="Deficiencias motoras">movilidad</a></span>, <span class="link"><a href="a11y-braille.html.es" title="Leer la pantalla en Braille">braille</a></span>, <span class="link"><a href="a11y-mag.html.es" title="Magnificar un área de la pantalla">magnificador de pantalla</a></span>…</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
