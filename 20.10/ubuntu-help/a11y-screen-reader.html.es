...
<p class="p">El lector de pantalla <span class="app">Orca</span> puede hablar la interfaz de usuario. Dependiendo de cómo haya instalado GNOME, puede no tener Orca instalado. Si no lo tiene, instale Orca primero.</p>
...
<div class="region"><div class="contents"><p class="p">Puede activar y desactivar el lector de pantalla pulsando en el <span class="link"><a href="a11y-icon.html.es" title="Encontrar el menú de accesibilidad">icono de accesibilidad</a></span> en la barra superior y seleccionando <span class="gui">Lector de pantalla</span>.</p></div></div>
</div>
</div>
