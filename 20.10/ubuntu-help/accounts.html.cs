...
<div class="region"><ul><li class="links "><a href="gs-connect-online-accounts.html.cs" title="Připojení k účtům on-line">Vysvětlení, jak se připojit k účtům on-line</a></li></ul></div>
</div></div>
</div>
</div></section>
</div>
