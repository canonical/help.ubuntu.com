...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Что копировать</span></h1></div>
<div class="region">
...
<dt class="terms">Ваши личные параметры</dt>
<dd class="terms"><p class="p">Изменения, внесённые вами в параметры рабочего стола (цвета, фон, разрешение экрана и параметры мыши). В эту же группу входят параметры приложений, например настройки для <span class="app">LibreOffice</span>, музыкального проигрывателя и почтовой программы. Их можно создать заново, но на это может потребоваться много времени.</p></dd>
<dt class="terms">Параметры системы</dt>
<dd class="terms"><p class="p">Большинство людей никогда не меняет параметры системы, созданные во время установки. Если вы по какой-то причине вносили в них изменения, или если компьютер используется в качестве сервера, можно сделать резервные копии этих параметров.</p></dd>
<dt class="terms">Установленные программы</dt>
<dd class="terms"><p class="p">Программы, как правило, легко восстановить после сбоя компьютера, просто переустановив их.</p></dd>
</dl></div></div></div>
<p class="p">В общем, следует сделать резервные копии файлов, которые невозможно создать заново, и файлов, на повторное создание которых уйдёт много времени. Если файлы легко создать заново, то можно и не тратить дисковое пространство на хранение их резервных копий.</p>
</div>
