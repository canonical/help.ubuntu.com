...
<title>Jak můžu svým zařízení přiřadit profily?</title>
...
<div class="trail">
<span style="color: #333">Ubuntu 20.10</span> » <a class="trail" href="index.html.cs" title="Průvodce pracovním prostředím Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Nápověda"></span></span> Průvodce pracovním prostředím Ubuntu</a> » <a class="trail" href="prefs.html.cs" title="Uživatelská a systémová nastavení">Nastavení</a> » <a class="trail" href="color.html.cs" title="Správa barev">Správa barev</a> » </div>
</div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Jak můžu svým zařízení přiřadit profily?</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Když chcete změnit uživatelský profil, vyberte profil, který chcete použít a zmáčkněte <span class="gui">Povolit</span>, abyste výběr potvrdili.</p></li>
</ol></div></div></div>
<p class="p">Každé zařízení může mít přiřazeno více profilů, ale jen jeden může být <span class="em">výchozí</span>. Výchozí profil se použije, když nejsou k dispozici žádné dodatečné informace, které by umožnily zvolit profil automaticky. Příkladem automatického výběru by mohly být profily tiskárny pro lesklý a jiný profil pro matný papír.</p>
<p class="p">V případě, že je kalibrační hardware připojen, tlačítko <span class="gui">Kalibrovat…</span> vytvoří nový profil.</p>
</div>
