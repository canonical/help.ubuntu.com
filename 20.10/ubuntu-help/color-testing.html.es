...
<title>¿Cómo compruebo si la gestión del color funciona correctamente?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Cómo compruebo si la gestión del color funciona correctamente?</span></h1></div>
<div class="region">
...
<p class="p">El sistema incluye diversos perfiles de prueba que demuestran claramente las diferencias al aplicar perfiles:</p>
...
<li class="steps"><p class="p">Para volver al perfil anterior, seleccione el dispositivo en el panel <span class="gui">Color</span> y seleccione el perfil que estaba usando anteriormente antes de usar el perfil de prueba y pulse <span class="gui">Activar</span> para volver a usarlo.</p></li>
</ol></div></div></div>
<p class="p">Usando estos perfiles puede ver claramente cuándo una aplicación soporta gestión de color.</p>
</div>
