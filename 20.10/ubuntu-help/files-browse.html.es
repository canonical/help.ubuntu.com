...
<p class="p">Puede acceder rápidamente a lugares comunes desde la <span class="em">barra lateral</span>. Si no ve la barra lateral, pulse el botón de menú en la esquina superior derecha de la ventana y elija <span class="gui">Barra lateral</span>. Puede añadir marcadores a carpetas que use con frecuencia y aparecerán en la barra lateral. Arrastre una carpeta a la barra lateral y suéltela sobre <span class="gui">Nuevo marcador</span>, que aparecerá dinámicamente, o pulse en el menú de la ventana y elija <span class="gui">Añadir esta ubicación a marcadores</span>.</p>
</div></div>
