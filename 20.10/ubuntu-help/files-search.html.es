...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">En lugar de escribir directamente para mostrar la barra de búsqueda, puede pulsar sobre la <span class="media"><span class="media media-image"><img src="figures/edit-find-symbolic.svg" class="media media-inline" alt="Search key symbol"></span></span> en la barra de herramientas, o pulsar <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>F</kbd></span></span>.</p></div></div></div>
</div>
</li>
<li class="steps">
<p class="p">Puede limitar sus resultados por fecha, por tipo de archivo y si quiere buscar el texto completo de un archivo o solo buscar nombres de archivo.</p>
<p class="p">Para aplicar filtros, seleccione el botón del menú desplegable a la izquierda del icono <span class="media"><span class="media media-image"><img src="figures/edit-find-symbolic.svg" class="media media-inline" alt="Search key symbol"></span></span> del administrador de archivos, y elija entre los filtros disponibles:</p>
...
<li class="list"><p class="p">¿Su búsqueda debe incluir el texto completo o sólo los nombres de los archivos?</p></li>
</ul></div></div></div>
</li>
...
<li class="steps"><p class="p">Pulse otra vez sobre <span class="media"><span class="media media-image"><img src="figures/edit-find-symbolic.svg" class="media media-inline" alt="Search key symbol"></span></span> en la barra de herramientas para salir de la búsqueda y volver a la carpeta.</p></li>
</ol></div>
</div></div>
</div>
...
<li class="steps"><p class="p">Pulse el botón <span class="gui">Buscar ubicaciones</span> en la barra de cabecera.</p></li>
</ol></div></div></div>
