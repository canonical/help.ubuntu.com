...
<title>Путешествие по Интернету</title>
...
<a href="gs-get-online.html.ru" title="Подключение к сети">Назад</a><a href="gs-connect-online-accounts.html.ru" title="Подключение к сетевым учётным записям">Вперёд</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Путешествие по Интернету</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Веб-браузер можно запустить <span class="link"><a href="gs-use-system-search.html.ru" title="Использование системного поиска">просто напечатав</a></span> <span class="em">Firefox</span> в <span class="gui">режиме обзора</span>.</p></div></div></div>
</div>
...
<p class="p">Если адрес веб-сайта найден в истории или в закладках, под адресной строкой появится выпадающий список.</p>
</li>
