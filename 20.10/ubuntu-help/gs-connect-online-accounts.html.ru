...
<title>Подключение к сетевым учётным записям</title>
...
<a href="gs-browse-web.html.ru" title="Путешествие по Интернету">Назад</a><a href="gs-change-date-time-timezone.html.ru" title="Смена даты, времени и часового пояса">Вперёд</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Подключение к сетевым учётным записям</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Чаще всего, чтобы начать пользоваться учётной записью, после авторизации необходимо разрешить доступ этому сетевому сервису.</p></li>
<li class="steps"><p class="p">Например, если вы подключены к учётной записи в Google, нужно будет нажать кнопку <span class="gui">Разрешить доступ</span>.</p></li>
</ol></div></div></div>
<div class="media media-image"><div class="inner"><img src="gs-goa5.svg" width="100%" class="media media-block" alt=""></div></div>
<div class="steps"><div class="inner"><div class="region"><ol class="steps" start="6"><li class="steps"><p class="p">Многие сетевые учётные записи предоставляют выбор, какими сервисами вы хотели бы пользоваться. Если вы не хотите пользоваться сервисом, отключите его с помощью переключателя в правой части окна.</p></li></ol></div></div></div>
</div>
<nav class="prevnext pagewide"><div class="inner">
<a href="gs-browse-web.html.ru" title="Путешествие по Интернету">Назад</a><a href="gs-change-date-time-timezone.html.ru" title="Смена даты, времени и часового пояса">Вперёд</a>
