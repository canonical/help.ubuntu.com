...
<title>El puntero del ratón no se mueve</title>
...
<div class="trail">
<span style="color: #333">Ubuntu 20.10</span> » <a class="trail" href="index.html.es" title="Guía del escritorio de Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Ayuda"></span></span> Guía de escritorio de Ubuntu</a> » <a class="trail" href="prefs.html.es" title="Usuario y configuración del sistema">Configuración</a> » <a class="trail" href="mouse.html.es" title="Ratón, «touchpad» y pantalla táctil">Ratón, «touchpad» y pantalla táctil</a> › <a class="trail" href="mouse.html.es#problems" title="Problemas comunes">Problemas comunes</a> » </div>
<div class="trail">
<span style="color: #333">Ubuntu 20.10</span> » <a class="trail" href="index.html.es" title="Guía del escritorio de Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Ayuda"></span></span> Guía de escritorio de Ubuntu</a> » <a class="trail" href="hardware.html.es" title="Hardware y controladores">Hardware</a> » <a class="trail" href="mouse.html.es" title="Ratón, «touchpad» y pantalla táctil">Ratón, «touchpad» y pantalla táctil</a> › <a class="trail" href="mouse.html.es#problems" title="Problemas comunes">Problemas comunes</a> » </div>
</div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">El puntero del ratón no se mueve</span></h1></div>
<div class="region">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Compruebe que el ratón está conectado</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Si tiene un ratón con cable, compruebe que esta firmemente conectado a su equipo.</p>
<p class="p">Si es un ratón USB (con un conector rectangular), pruebe a conectarlo en un puerto USB distinto. Si es un ratón PS/2 (con un pequeño conector redondo con seis pines), compruebe que está conectado en el puerto verde del ratón, y no en el puerto violeta del teclado. Puede que tenga que reiniciar el equipo si no estaba bien conectado.</p>
</div></div>
</div></section><section id="broken"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Compruebe que actualmente el ratón funciona</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Comprobar el ratón inalámbrico</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<li class="list"><p class="p">Si está usando un ratón Bluetooth, asegúrese de que ha emparejado el ratón con el equipo. Consulte la sección <span class="link"><a href="bluetooth-connect-device.html.es" title="Conectar su equipo a un dispositivo Bluetooth">Conectar su equipo a un dispositivo Bluetooth</a></span>.</p></li>
<li class="list"><p class="p">Pulse un botón y compruebe si el puntero del ratón se mueve ahora. Algunos ratones inalámbricos se ponen en reposo para ahorrar energía, por lo que es posible que no respondan hasta que pulse un botón. Consulte la sección <span class="link"><a href="mouse-wakeup.html.es" title="El ratón sufre un retardo antes de empezar a funcionar">El ratón sufre un retardo antes de empezar a funcionar</a></span>.</p></li>
