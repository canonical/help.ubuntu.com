...
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="net-install-flash.html.el" title="Εγκατάσταση πρόσθετου για το flash"><span class="title">Εγκατάσταση πρόσθετου για το flash</span><span class="linkdiv-dash"> — </span><span class="desc">Μπορεί να χρειάζεται η εγκατάσταση του Flash για να μπορείτε να δείτε κάποιες ιστοσελίδες που περιέχουν βίντεο ή διαδραστικό περιεχόμενο.</span></a></div></div>
</div></div></div></div></div>
