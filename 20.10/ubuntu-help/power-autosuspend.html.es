...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Configurar la suspensión automática</span></h1></div>
<div class="region">
...
<li class="steps">
<p class="p">Elija <span class="gui">Usando batería</span> o <span class="gui">Enchufado</span>, active el interruptor, y elija un <span class="gui">Retardo</span>. Se pueden configurar ambas opciones.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">En un equipo de escritorio, hay una opción etiquetada como <span class="gui">Cuando esté inactivo</span>.</p></div></div></div>
</div>
</li>
</ol></div></div></div>
</div>
