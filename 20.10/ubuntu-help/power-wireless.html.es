...
<li class="steps"><p class="p">La sección <span class="gui">Ahorro de energía</span> contiene interruptores para <span class="gui">inalámbrica</span>, <span class="gui">Banda ancha móvil</span>, y <span class="gui">Bluetooth</span>. Desactive los servicios que no usa. Cuando lo necesite, vuelva a activarlos.</p></li>
</ol></div></div></div>
</div>
