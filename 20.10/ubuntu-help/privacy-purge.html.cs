...
<li class="steps"><p class="p">Přepněte jeden, nebo oba, z vypínačů <span class="gui">Automaticky vyprázdnit koš</span> a <span class="gui">Automaticky odstranit dočasné soubory</span> do polohy zapnuto.</p></li>
<li class="steps"><p class="p">Pomocí hodnoty <span class="gui">Vyčistit po</span> nastavte, jak často by se měly <span class="em">Koš</span> a <span class="em">Dočasné soubory</span> čistit.</p></li>
