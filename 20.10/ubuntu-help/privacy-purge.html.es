...
<li class="steps"><p class="p">Active uno o ambos interruptores <span class="gui">Vaciar la papelera automáticamente</span> o <span class="gui">Limpiar los archivos temporales automáticamente</span>.</p></li>
<li class="steps"><p class="p">Establezca la frecuencia con la que quiere que se limpien la <span class="em">Papelera</span> y los <span class="em">Archivos temporales</span> cambiando el valor de <span class="gui">Limpiar después de</span>.</p></li>
