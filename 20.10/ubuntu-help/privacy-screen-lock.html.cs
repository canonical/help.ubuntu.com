...
<li class="steps"><p class="p">Ujistěte se, že <span class="gui">Automatické zamknutí obrazovky</span> je přepnuté do polohy zapnuto a pak vyberte v rozbalovacím seznamu časovou prodlevu.</p></li>
</ol></div>
</div></div>
