...
<li class="steps"><p class="p">Asegúrese de que el <span class="gui">Bloqueo automático de la pantalla</span> está activado y seleccione el tiempo en la lista desplegable.</p></li>
</ol></div>
</div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Las aplicaciones pueden mostrar notificaciones que todavía se muestran en la pantalla de bloqueo. Esto es adecuado, por ejemplo, para ver si tiene algún correo sin desbloquear la pantalla. Si le preocupa que otras personas puedan ver esas notificaciones, desactive la opción <span class="gui">Mostrar notificaciones</span></p></div></div></div>
</div>
