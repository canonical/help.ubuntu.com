...
<title>Iniciar sesión con una huella dactilar</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Iniciar sesión con una huella dactilar</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Si su sistema tiene un lector de huellas digitales soportado, puede grabar su huella y usarla para iniciar sesión.</p></div>
<section id="record"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Grabar una huella dactilar</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Si su dedo está demasiado seco, puede que tenga dificultad para registrar su huella dactilar. Si esto sucede, humedezca ligeramente el dedo, séquelo con un paño limpio y sin pelusa, y vuelva a intentarlo.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Siga las instrucciones del diálogo y deslice su dedo a una <span class="em">velocidad moderada</span> sobre el lector de huellas digitales. Una vez que el equipo tenga un registro correcto de su huella dactilar, verá un mensaje de <span class="gui">Hecho</span>.</p></li>
<li class="steps"><p class="p">Seleccione <span class="gui">Siguiente</span>. Verá un mensaje de confirmación de que su huella digital se ha guardado correctamente. Seleccione <span class="gui">Cerrar</span> para finalizar.</p></li>
</ol></div></div></div>
</div></div>
</div></section><section id="verify"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Compruebe que la huella dactilar funciona</span></h2></div>
<div class="region"><div class="contents pagewide">
