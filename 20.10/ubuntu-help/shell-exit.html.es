...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Cerrar la sesión, apagar o cambiar de usuario</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Cuando haya terminado de usar su equipo, puede apagarlo, suspenderlo (para ahorrar energía), o dejarlo encendido y cerrar la sesión.</p></div>
<section id="logout"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Cerrar la sesión o cambiar de usuario</span></h2></div>
...
<p class="p">Para <span class="gui">Salir de la sesión</span> o <span class="gui">Cambiar de usuario</span>, pulse sobre el <span class="link"><a href="shell-introduction.html.es#systemmenu" title="Menú del sistema">menú del sistema</a></span> en la parte derecha de la barra superior, pulse sobre su nombre y seleccione la opción apropiada.</p>
<div class="note" title="Nota">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Las opciones <span class="gui">Salir de la sesión</span> y <span class="gui">Cambiar de usuario</span>, sólo aparecen en el menú si tiene más de una cuenta de usuario en su sistema.</p></div></div></div>
</div>
</div></div>
...
<p class="p">Para bloquear la pantalla, pulse en el menú del sistema en la parte derecha de la barra superior y elija <span class="gui">Bloquear</span> en el menú.</p>
<p class="p">Cuando su pantalla está bloqueada otros usuarios pueden iniciar sesión en sus propias cuentas pulsando <span class="gui">Iniciar sesión como otro usuario</span> en la parte inferior de la pantalla de inicio de sesión. Puede volver a su escritorio cuando hayan terminado.</p>
</div>
...
<p class="p">Para suspender el equipo manualmente, pulse en el menú del sistema en la parte derecha de la barra superior, expanda <span class="gui">Apagar / Cerrar sesión</span>, y elija <span class="gui">Suspender</span>.</p>
</div>
<section class="links" role="navigation"><div class="inner">
<div class="hgroup pagewide"></div>
<div class="contents pagewide"><div class="links seealsolinks"><div class="inner">
...
<div class="region">
<div class="contents pagewide">
<p class="p">Si quiere apagar su equipo por completo o hacer un reinicio total, pulse sobre en el menú del sistema en la parte derecha de la barra superior, expanda <span class="gui">Apagar / Cerrar sesión</span>, y elija <span class="gui">Apagar…</span>.</p>
