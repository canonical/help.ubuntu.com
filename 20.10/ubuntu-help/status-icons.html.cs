...
<p class="p">Tato kapitola vysvětluje význam jednotlivých ikon nacházejících se v pravém horním rohu obrazovky. Přesněji řečeno, jsou popsány různé varianty ikon poskytovaných systémem.</p>
<div role="navigation" class="links sectionlinks"><div class="inner"><div class="region"><ul>
<li class="links "><a href="status-icons.html.cs#universalicons" title="Ikony nabídky přístupnosti">Ikony nabídky přístupnosti</a></li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ikony nabídky přístupnosti</span></h2></div>
...
<td><p class="p">Vede do nabídky, která slouží k přepínání voleb zpřístupnění.</p></td>
</tr></table></div></div></div></div></div>
</div></section><section id="audioicons"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ikony ovládání hlasitosti</span></h2></div>
...
<td><p class="p">Je nastavena vysoká hlasitost.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Je nastavena střední hlasitost.</p></td>
</tr>
<tr>
...
<td><p class="p">Je nastavena nízká hlasitost.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Hlasitost je ztlumena.</p></td>
</tr>
</table></div></div></div></div></div>
</div></section><section id="bluetoothicons"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ikony správy Bluetooth</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Bluetooth je aktivováno.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Bluetooth je vypnuto.</p></td>
</tr>
</table></div></div></div></div></div>
</div></section><section id="networkicons"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ikony správy sítě</span></h2></div>
<div class="region">
<div class="contents pagewide">
...
<td><p class="p">Připojeno do sítě 3G.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Připojeno do sítě 4G.</p></td>
</tr>
<tr>
...
<td><p class="p">Připojeno do sítě EDGE.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Připojeno do sítě GPRS.</p></td>
</tr>
<tr>
...
<td><p class="p">Připojeno do sítě UMTS.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Připojeno do mobilní sítě.</p></td>
</tr>
<tr>
...
<td><p class="p">Vyřizuje se připojení k mobilní síti.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Velmi dobrá síla signálu.</p></td>
</tr>
<tr>
...
<td><p class="p">Dobrá síla signálu.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Střední síla signálu.</p></td>
</tr>
<tr>
...
<td><p class="p">Slabá síla signálu.</p></td>
</tr>
<tr class="shade">
...
<p class="p"><span class="app">Přípojení do místní sítě (LAN)</span></p>
<div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Při vyhledávání sítě se objevila chyba.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Síť není aktivní.</p></td>
</tr>
<tr>
...
<td><p class="p">Nebylo nalezeno směrování do sítě.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Síť je odpojená.</p></td>
</tr>
<tr>
...
<td><p class="p">Přijímají se data ze sítě.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Přijímají se data z a vysílají do sítě.</p></td>
</tr>
<tr>
...
<td><p class="p">Vysílají se data do sítě.</p></td>
</tr>
</table></div></div></div>
<p class="p"><span class="app">Připojení do virtuální soukromé sítě (VPN)</span></p>
<div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Vyřizuje se připojení k síti.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Připojeno do sítě VPN.</p></td>
</tr>
</table></div></div></div>
<p class="p"><span class="app">Drátové připojení</span></p>
<div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<p class="p"><span class="app">Bezdrátové připojení</span></p>
<div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Vyřizuje se bezdrátové připojení.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Bezdrátová síť je šifrovaná.</p></td>
</tr>
<tr>
...
<td><p class="p">Připojeno k bezdrátové síti.</p></td>
</tr>
<tr class="shade">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ikony správy napájení.</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Baterie je plně nabitá.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Baterie je částečně vybitá.</p></td>
</tr>
<tr>
...
<td><p class="p">Baterie je málo nabitá.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Varování: Baterie je téměř vybitá.</p></td>
</tr>
<tr>
...
<td><p class="p">Baterie je zcela vybitá.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Baterie byla odpojena.</p></td>
</tr>
<tr>
...
<td><p class="p">Baterie byla plně nabita.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Baterie je téměř plně nabitá a nabíjí se.</p></td>
</tr>
<tr>
...
<td><p class="p">Baterie je částečně nabitá a nabíjí se.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Baterie je málo nabitá a nabíjí se.</p></td>
</tr>
<tr>
...
<td><p class="p">Baterie je téměř vybitá a nabíjí se.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Baterie je prázdná a nabíjí se.</p></td>
</tr>
</table></div></div></div></div></div>
