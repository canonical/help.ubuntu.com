...
<span style="color: #333">Ubuntu 20.10</span> » <a class="trail" href="index.html.nl" title="Gids voor de Ubuntu-werkomgeving"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Hulp"></span></span> Ubuntu-bureaubladhandleiding</a> » <a class="trail" href="tips.html.nl" title="Tips &amp; trucs">Tips &amp; trucs</a> » </div></div>
...
<li class="steps"><p class="p">Klik op het tabblad <span class="gui">toetsenbord &amp; Muis</span>.</p></li>
<li class="steps"><p class="p">Druk op <span class="gui">Uitgeschakeld</span> bij de <span class="gui">Samensteltoets</span>instelling.</p></li>
<li class="steps"><p class="p">Zet de schakelaar aan in het dialoogvenster en kies de sneltoets die u wilt gebruiken.</p></li>
