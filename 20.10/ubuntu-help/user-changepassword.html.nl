...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Uw wachtwoord wijzigen</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Klik op het label <span class="gui">·····</span> naast <span class="gui">Wachtwoord</span>. Als u het wachtwoord voor een andere gebruiker wijzigt, dan dient u eerst het paneel te <span class="gui">ontgrendelen</span>.</p></li>
<li class="steps">
...
<p class="p">Zorg ervoor dat u <span class="link"><a href="user-goodpassword.html.nl" title="Kies een veilig wachtwoord">een goed wachtwoord kiest</a></span>. Dit helpt uw gebruikersaccount veilig te houden.</p>
<div class="note" title="Opmerking">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Wanneer u uw aanmeldwachtwoord wijzigt, dan zal uw aanmeldwachtwoord in de sleutelbos automatisch aangepast worden zodat het hetzelfde is als uw nieuwe aanmeldwachtwoord.</p></div></div></div>
</div>
...
<li class="links ">
<a href="user-goodpassword.html.nl" title="Kies een veilig wachtwoord">Kies een veilig wachtwoord</a><span class="desc"> — Gebruik langere, ingewikkeldere wachtwoorden.</span>
</li>
</ul></div>
</div></div>
</div>
