...
<title>Απομακρύνετε μια εφαρμογή</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Απομακρύνετε μια εφαρμογή</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Μια εφαρμογή είναι ένα λογισμικό που έχει γραφική διεπαφή χρήστη (GUI). Μπορείτε να χρησιμοποιήσετε το <span class="app">Λογισμικό Ubuntu</span> για να αφαιρέσετε εφαρμογές που δεν χρησιμοποιείτε πια.</p>
...
<p class="p">Μπορεί επίσης να επιθυμείτε να αφαιρέσετε λογισμικό που δεν έχει γραφικό περιβάλλον. Για να αφαιρέσετε τέτοιο λογισμικό μπορείτε να χρησιμοποιήσετε το <span class="link"><a href="addremove-install-synaptic.html.el" title="Χρησιμοποιήστε το Synaptic για πιο προχωρημένη διαχείριση λογισμικού">Synaptic</a></span>. Σημειώστε ότι το <span class="app">Synaptic</span> δεν μπορεί να διαχειριστεί τα snap.</p>
<p class="p">Για να αφαιρέσετε μια εφαρμογή:</p>
...
<li class="steps"><p class="p">Όταν το <span class="app">Λογισμικό Ubuntu</span> ξεκινήσει, πατήστε το κουμπί <span class="gui">Εγκατεστημένα</span> στην κορυφή.</p></li>
<li class="steps"><p class="p">Βρείτε την εφαρμογή που θέλετε να απεγκαταστήσετε χρησιμοποιώντας το πεδίο αναζήτησης ή ψάχνοντας στη λίστα των εγκαταστημένων εφαρμογών.</p></li>
<li class="steps"><p class="p">Επιλέξτε την εφαρμογή και κάντε κλικ στην επιλογή <span class="gui">Αφαίρεση</span>.</p></li>
<li class="steps"><p class="p">Επιβεβαιώστε ότι θέλετε να αφαιρέσετε την εφαρμογή.</p></li>
<li class="steps"><p class="p">Θα σας ζητηθεί να εισάγετε τον κωδικό σας ως έλεγχος ταυτότητας. Κατόπιν, η εφαρμογή θα αφαιρεθεί.</p></li>
</ol></div></div></div>
<div class="note" title="Σημείωση">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Η σωστή λειτουργία κάποιων εφαρμογών εξαρτάται από άλλες εφαρμογές. Αν προσπαθήσετε να αφαιρέσετε μια εφαρμογή που τη χρειάζεται κάποια άλλη εφαρμογή, τότε θα αφαιρεθούν και οι δύο. Πριν αφαιρεθούν οι εφαρμογές, θα ερωτηθείτε ώστε να επιβεβαιώσετε πως όντως αυτό θέλετε να συμβεί.</p></div></div></div>
</div>
</div>
