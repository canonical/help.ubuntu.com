...
<div class="region"><ul><li class="links ">
<a href="bluetooth-visibility.html.el" title="Τι είναι η ορατότητα Bluetooth;">Τι είναι η ορατότητα Bluetooth;</a><span class="desc"> — Αν άλλες συσκευές μπορούν να ανακαλύψουν τον υπολογιστή σας.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
