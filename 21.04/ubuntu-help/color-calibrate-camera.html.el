...
<p class="p">Οι συσκευές της κάμερας βαθμονομούνται παίρνοντας μια φωτογραφία ενός προορισμού στις επιθυμητές συνθήκες φωτισμού. Μετατρέποντας το αρχείο RAW σε αρχείο TIFF, μπορεί να χρησιμοποιηθεί για βαθμονόμηση της κάμερας στο πλαίσιο ελέγχου χρώματος.</p>
