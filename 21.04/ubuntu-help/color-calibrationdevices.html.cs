...
<title>Které přístroje pro měření barev jsou podporovány?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Které přístroje pro měření barev jsou podporovány?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Systém ohledně podpory přístrojů pro měření barev spoléhá na nástroje správy barev Argyll. Jsou tak podporovány následující měřicí přístroje:</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Pantone Huey je v současnosti nejlevnější a nejlépe podporované zařízení v Linuxu.</p></div></div></div>
</div>
...
<li class="list"><p class="p">X-Rite DTP51 (bodový čtecí reflexní spektrometr)</p></li>
</ul></div></div></div>
</div>
