...
<title>¿Le falta información para la corrección de color de de la pantalla completa?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Le falta información para la corrección de color de de la pantalla completa?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Desafortunadamente muchos de los perfiles de color ICC que proporcionan los fabricantes, no incluyen la información requerida para una completa corrección de la pantalla. Aún así, esos perfiles pueden seguir siendo útiles para aplicaciones que realizan compensación del color, pero no verá todos los colores del cambio de su pantalla.</p>
<p class="p">Para crear un perfil de pantalla que incluya datos tanto calibración como de caracterización, necesita usar instrumentos especiales de medición de color llamados colorímetro o espectrómetro.</p>
</div>
