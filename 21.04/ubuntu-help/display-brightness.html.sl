...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Set screen brightness</span></h1></div>
<div class="region">
...
<p class="p">To change the brightness of your screen, click the
  <span class="gui"><a href="shell-introduction.html.sl#systemmenu" title="System menu">system menu</a></span> on the right side
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Many laptop keyboards have special keys to adjust the brightness. These
    often have a picture that looks like the sun. Hold down the <span class="key"><kbd class="key-Fn">Fn</kbd></span>
    key to use these keys.</p></div></div></div>
</div>
<p class="p">You can also adjust the screen brightness by using the <span class="gui">Power</span> panel.</p>
...
<li class="steps"><p class="p">Adjust the <span class="gui">Screen brightness</span> slider to the value you want to
      use. The change should take effect immediately.</p></li>
</ol></div>
</div></div>
<div class="note note-tip" title="Namig">
<svg width="24" height="24" version="1.1">
 ...
 <path class="yelp-svg-fill" d="m9 20a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h6a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-6zm0 2a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h6a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-6z"></path>
    ...
    screen brightness in the <span class="gui">Power</span> panel.</p></div></div></div>
</div>
<p class="p">If it is possible to set the brightness of your screen, you can also have
  ...
  <span class="link"><a href="power-whydim.html.sl" title="Zakaj se moj zaslon po določenem času zatemni?">Zakaj se moj zaslon po določenem času zatemni?</a></span>.</p>
</div>
...
<div class="region"><ul>
<li class="links ">
<a href="power-autobrightness.html.sl" title="Enable automatic brightness">Enable automatic brightness</a><span class="desc"> — Automatically control screen brightness to reduce battery use.</span>
</li>
<li class="links ">
