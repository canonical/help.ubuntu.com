...
<title>Conectar otra pantalla al equipo</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Conectar otra pantalla al equipo</span></h1></div>
<div class="region">
<div class="contents pagewide"></div>
<section id="steps"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Configurar un monitor adicional</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Para configurar una pantalla adicional, conecte la pantalla al equipo. Si su sistema no la reconoce inmediatamente, o si quiere ajustar su configuración:</p>
...
<li class="steps">
<p class="p">En el diagrama de disposición de pantallas, arrastre sus pantallas a las posiciones relativas que quiera.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Los números en el diagrama se muestran en la parte superior izquierda de cada pantalla cuando el panel <span class="gui">Pantallas</span> está activo.</p></div></div></div>
</div>
</li>
<li class="steps">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">La pantalla primaria es la que tiene la <span class="link"><a href="shell-introduction.html.es" title="Resumen visual de GNOME">barra superior</a></span>, y en la que se muestra la vista de <span class="gui">Actividades</span>.</p></div></div></div>
</div>
</li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Modos de pantalla</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Añadir más de un monitor</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Con más de dos pantallas, el único modo disponible es <span class="gui">Pantallas unidas</span></p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Pulse el botón para la pantalla que quiere configurar.</p></li>
