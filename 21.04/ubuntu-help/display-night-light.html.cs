...
<title>Přizpůsobení barevné teploty vaší obrazovky</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Přizpůsobení barevné teploty vaší obrazovky</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Počítačové monitory vyzařují modré světlo, které může způsobovat nespavost a únavu očí po setmění. Funkce <span class="gui">Noční světlo</span> mění barevný tón vašeho displeje podle denní doby tak, aby po setmění měl teplejší barvy. Když chcete <span class="gui">Noční světlo</span> zapnout:</p>
...
<li class="steps"><p class="p">Zmáčkněte <span class="gui">Od soumraku do úsvitu</span>, aby se barevný tón obrazovky řídil podle východu a západu slunce ve vašem místě. Pokud byste si chtěli nastavit vlastní časový plán, klikněte na tlačítko <span class="gui">Ručně</span>.</p></li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Na <span class="link"><a href="shell-introduction.html.cs" title="Obrázkový přehled GNOME">horní liště</a></span> se signalizuje, když je funkce <span class="gui">Noční světlo</span> aktivní. Je možné ji dočasně vypnout přes systémovou nabídku.</p></div></div></div>
</div>
</div>
