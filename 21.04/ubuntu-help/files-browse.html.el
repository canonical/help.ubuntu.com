...
and then select <span class="gui">Sidebar</span>. You can <span class="link"><a href="nautilus-bookmarks-edit.html.el" title="Επεξεργασία φακέλων σελιδοδεικτών">add
