...
<title>Επαναφορά αρχείων από τα απορρίμματα</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Επαναφορά αρχείων από τα απορρίμματα</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Εάν διαγράψετε ένα αρχείο με τον διαχειριστή αρχείων, το αρχείο τοποθετείται κανονικά στα <span class="gui">Απορρίμματα</span> και πρέπει να μπορεί να ανακτηθεί.</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Για να επαναφέρετε ένα αρχείο από τα απορρίμματα:</span></h2></div>
...
<li class="links ">
<a href="files-lost.html.el" title="Εύρεση ενός χαμένου αρχείου">Εύρεση ενός χαμένου αρχείου</a><span class="desc"> — Follow these tips if you can’t find a file you created or
    downloaded.</span>
</li>
</ul></div>
</div></div>
