...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Recuperar un archivo de la papelera</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Si elimina un archivo con el gestor de archivos, normalmente se envía a la <span class="gui">Papelera</span>, y debería poder recuperarlo.</p>
...
<li class="steps"><p class="p">Pulse en <span class="gui">Papelera</span> en la barra lateral. Si no ve la barra lateral, pulse el botón de menú en la esquina superior derecha de la ventana <span class="gui">Barra lateral</span></p></li>
...
<p class="p">Si eliminó el archivo pulsando <span class="keyseq"><span class="key"><kbd>Mayús</kbd></span>+<span class="key"><kbd>Supr</kbd></span></span> o desde la línea de comandos, el archivo no se podrá recuperar usando este método porque se habrá eliminado permanentemente. Los archivos eliminados permanentemente no se pueden recuperar de la <span class="gui">Papelera</span>.</p>
<p class="p">Existen varias herramientas de recuperación disponibles que a veces pueden recuperar archivos que se eliminaron permanentemente. No obstante, normalmente no son muy fáciles de usar. Si eliminó un archivo permanentemente de forma accidental, probablemente sea mejor pedir ayuda en los foros de soporte para ver si es posible recuperarlo.</p>
</div>
