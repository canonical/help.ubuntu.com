...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Μετονομασία αρχείου ή φακέλου</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Όπως με άλλους διαχειριστές αρχείων, μπορείτε να χρησιμοποιήσετε το <span class="app">Αρχεία</span> για να αλλάξετε το όνομα ενός αρχείου ή φακέλου.</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Για να μετονομάσετε ένα αρχείο ή φάκελο:</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Κάντε δεξί κλικ στο στοιχείο και επιλέξτε <span class="gui">Μετονομασία</span> ή επιλέξτε το αρχείο και πατήστε <span class="key"><kbd>F2</kbd></span>.</p></li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Εάν μετονομάσατε λάθος αρχείο, ή ονομάσατε το αρχείο σας λαθεμένα, μπορείτε να αναιρέσετε την μετονομασία. Για να αντιστρέψετε την ενέργεια, κάντε κλικ αμέσως το κουμπί μενού στην εργαλειοθήκη και επιλέξτε <span class="gui">Αναίρεση μετονομασίας</span>, ή πατήστε <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Z</kbd></span></span> για να επαναφέρετε το προηγούμενο όνομα.</p></div></div></div>
</div>
</div>
<section id="valid-chars"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Έγκυροι χαρακτήρες για ονόματα αρχείων</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Αν ονομάσετε ένα αρχείο με μια <span class="file">.</span> ως τον πρώτο χαρακτήρα του, τότε το αρχείο θα είναι <span class="link"><a href="files-hidden.html.el" title="Απόκρυψη ενός αρχείου">κρυφό</a></span> όταν προσπαθήσετε να το δείτε στον διαχειριστή αρχείων.</p></div></div></div>
</div>
</div></div>
...
<dd class="terms">
<p class="p">Δεν μπορείτε να έχετε δύο αρχεία ή φακέλους με το ίδιο όνομα στον ίδιο φάκελο. Αν δοκιμάσετε να μετονομάσετε ένα αρχείο με ένα όνομα που ήδη υπάρχει στο φάκελο που δουλεύετε, ο διαχειριστής αρχείων δεν θα το επιτρέψει.</p>
<p class="p">Τα ονόματα αρχείου και φακέλου εξαρτώνται από πεζά/κεφαλαία, έτσι το όνομα αρχείου <span class="file">Αρχείο.txt</span> δεν είναι το ίδιο με το <span class="file">ΑΡΧΕΙΟ.txt</span>. Η χρήση διαφορετικών ονομάτων αρχείου όπως αυτό επιτρέπεται, όμως δεν συνιστάται.</p>
</dd>
