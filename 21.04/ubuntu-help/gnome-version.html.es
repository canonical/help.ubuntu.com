...
<p class="p">Puede conocer la versión de GNOME que se está ejecutando en su sistema yendo al panel <span class="gui">Detalles/Acerca de</span> en la <span class="gui">Configuración</span>.</p>
...
<li class="steps">
<p class="p">Pulse en <span class="gui">Acerca de</span> para abrir el panel.</p>
