...
<a href="gs-get-online.html.cs" title="Připojení k internetu">Předchozí</a><a href="gs-connect-online-accounts.html.cs" title="Připojení k účtům on-line">Následující</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Brouzdání po webu</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Případně můžete prohlíčes spustit <span class="link"><a href="gs-use-system-search.html.cs" title="Vyhledávání v systému">prostým napsaním</a></span> <span class="em">firefox</span> v <span class="gui">Přehledu činností</span>.</p></div></div></div>
</div>
...
<p class="p">Když je web nalezen v historii nebo v záložkách, objeví se pod adresní lištou rozbalovací seznam.</p>
</li>
