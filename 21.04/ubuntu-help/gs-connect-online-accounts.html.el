...
<a href="gs-browse-web.html.el" title="Περιήγηση στον Ιστό">Προηγούμενο</a><a href="gs-change-date-time-timezone.html.el" title="Αλλαγή ημερομηνίας, ώρας και ζώνης ώρας">Επόμενο</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Σύνδεση σε διαδικτυακούς λογαριασμούς</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Στις περισσότερες περιπτώσεις, θα πρέπει να παραχωρήσετε πρόσβαση στη διαδικτυακή υπηρεσία μετά την είσοδο σας για να ξεκινήσετε.</p></li>
<li class="steps"><p class="p">Για παράδειγμα, εάν συνδεθείτε με τον λογαριασμό σας στο Google, θα πρέπει να πατήσετε το κουμπί <span class="gui">Παραχώρηση πρόσβασης</span>.</p></li>
</ol></div></div></div>
