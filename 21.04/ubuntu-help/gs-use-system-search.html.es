...
<title>Utilizar la búsqueda de sistema</title>
...
<a href="gs-use-windows-workspaces.html.es" title="Usar ventanas y áreas de trabajo">Anterior</a><a href="gs-get-online.html.es" title="Conectarse a Internet">Siguiente</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Utilizar la búsqueda de sistema</span></h1></div>
<div class="region">
...
<li class="steps">
<p class="p">Los elementos que pueden aparecer en los resultados de búsqueda incluyen:</p>
...
<li class="steps">
<p class="p">En los resultados de búsqueda, pulse el elemento al que quiera	 cambiarse.</p>
<p class="p">Si no, resalte un elemento utilizando las teclas de flecha y pulse <span class="key"><kbd>Intro</kbd></span>.</p>
</li>
</ol></div></div></div>
</div>
<section id="use-search-inside-applications"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Buscar desde las aplicaciones</span></h2></div>
<div class="region"><div class="contents pagewide"><p class="p">El sistema de búsqueda añade resultados de varias aplicaciones. En la parte izquierda de los resultados de búsqueda, puede ver iconos de las aplicaciones que proporcionan los resultados. Pulse en uno de esos iconos para reiniciar la búsqueda desde la aplicación asociada a ese icono. Dado que en la <span class="gui">Vista de actividades</span> sólo se muestran los resultados más relevantes, la búsqueda desde la aplicación le puede proporcionar mejores resultados.</p></div></div>
</div></section><section id="use-search-customize"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Personalizar los resultados de búsqueda</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Su equipo le permite personalizar lo que quiere mostrar en los resultados de búsqueda en la <span class="gui">Vista de actividades</span>. Por ejemplo, puede decidir si quiere mostrar los resultados para los sitios web, fotografías o música.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">En la lista de ubicaciones de búsqueda, pulse el interruptor que está al lado de la ubicación de búsqueda que quiera activar o desactivar.</p></li>
</ol></div>
</div></div>
</div></div>
