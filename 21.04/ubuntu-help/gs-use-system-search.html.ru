...
<title>Использование системного поиска</title>
...
<a href="gs-use-windows-workspaces.html.ru" title="Использование окон и рабочих столов">Назад</a><a href="gs-get-online.html.ru" title="Подключение к сети">Вперёд</a>
</div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Использование системного поиска</span></h1></div>
<div class="region">
...
<li class="steps">
<p class="p">Среди элементов, которые появляются в результатах поиска, могут быть следующие элементы:</p>
...
<li class="steps">
<p class="p">В списке результатов поиска нажмите на элемент, чтобы переключиться на него.</p>
<p class="p">Также можно выделить элемент с помощью клавиш со стрелками и нажать клавишу <span class="key"><kbd>Enter</kbd></span>.</p>
</li>
</ol></div></div></div>
</div>
<section id="use-search-inside-applications"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Поиск в приложениях</span></h2></div>
<div class="region"><div class="contents pagewide"><p class="p">Системный поиск собирает результаты от разных приложений. На левой стороне от результатов поиска можно видеть значки приложений, которые предоставили эти результаты. Нажмите на один из этих значков, чтобы перезапустить поиск внутри приложения, обозначенного этим значком. Поскольку в <span class="gui">режиме обзора</span> показываются только наиболее точные совпадения, поиск внутри приложения может дать дополнительные результаты.</p></div></div>
</div></section><section id="use-search-customize"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Настройка результатов поиска</span></h2></div>
...
<div class="title title-steps"><h3><span class="title">Чтобы настроить показываемые результаты поиска:</span></h3></div>
