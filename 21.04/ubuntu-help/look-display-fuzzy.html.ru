...
<p class="p">If you have two displays connected to the computer (for example, a normal
  ...
  <span class="link"><a href="look-resolution.html.ru#native" title="Native Resolution">native</a></span>, resolutions.</p>
<p class="p">Using <span class="link"><a href="display-dual-monitors.html.ru#modes" title="Display modes">Mirror</a></span> mode, you can
...
<p class="p">Using <span class="link"><a href="display-dual-monitors.html.ru#modes" title="Display modes">Join Displays</a></span> mode,
...
<div class="region"><ul><li class="links ">
<a href="look-resolution.html.ru" title="Change the resolution or orientation of the screen">Change the resolution or orientation of the screen</a><span class="desc"> — Изменение разрешения экрана и его ориентации (поворота).</span>
</li></ul></div>
</div></div>
</div>
</div></section>
