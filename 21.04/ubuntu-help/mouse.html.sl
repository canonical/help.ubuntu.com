...
<div class="linkdiv "><a class="linkdiv" href="mouse-sensitivity.html.sl" title="Adjust the speed of the mouse and touchpad"><span class="title">Adjust the speed of the mouse and touchpad</span><span class="linkdiv-dash"> — </span><span class="desc">Spremenite kako hitro se premika miškin kazalnik, ko uporabite miško ali drsno ploščico.</span></a></div>
<div class="linkdiv "><a class="linkdiv" href="mouse-mousekeys.html.sl" title="Click and move the mouse pointer using the keypad"><span class="title">Click and move the mouse pointer using the keypad</span><span class="linkdiv-dash"> — </span><span class="desc">Enable mouse keys to control the mouse with the numeric
    keypad.</span></a></div>
...
<div class="linkdiv "><a class="linkdiv" href="touchscreen-gestures.html.sl" title="Use touchscreen gestures to navigate the desktop"><span class="title">Use touchscreen gestures to navigate the desktop</span><span class="linkdiv-dash"> — </span><span class="desc">Manipulate your desktop using gestures on your touchscreen.</span></a></div>
</div>
</div></div></div></div></div>
<section id="problems"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Pogoste težave</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-twocolumn">
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="mouse-problem-notmoving.html.sl" title="Miškin kazalec se ne premika"><span class="title">Miškin kazalec se ne premika</span><span class="linkdiv-dash"> — </span><span class="desc">How to check why your mouse is not working.</span></a></div></div>
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="mouse-wakeup.html.sl" title="Mouse reacts with delay before it starts working"><span class="title">Mouse reacts with delay before it starts working</span><span class="linkdiv-dash"> — </span><span class="desc">V primeru da morate miško stresti ali klikniti preden se odzove.</span></a></div></div>
</div></div></div></div></div></div>
</div></section><section id="tips"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Namigi</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-twocolumn">
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="mouse-middleclick.html.sl" title="Srednji klik"><span class="title">Srednji klik</span><span class="linkdiv-dash"> — </span><span class="desc">Use the middle mouse button to open applications, open tabs and
    more.</span></a></div></div>
