...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Možnosti predogleda upravljalnika datotek</span></h1></div>
<div class="region">
...
<p class="p">By default, all previews are done for
    ...
    <span class="link"><a href="nautilus-connect.html.sl" title="Brskanje datotek na strežniku ali omrežni souporabi">browse files on other computers</a></span> over
...
<dd class="terms">
<p class="p">If you show file sizes in <span class="link"><a href="nautilus-list.html.sl" title="Files list columns preferences">list view columns</a></span>
    or <span class="link"><a href="nautilus-display.html.sl#icon-captions" title="Naslovi ikon">icon captions</a></span>,
