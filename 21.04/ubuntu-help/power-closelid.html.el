...
<title>Γιατί ο υπολογιστής μου απενεργοποιείται όταν κλείνω το καπάκι;</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Γιατί ο υπολογιστής μου απενεργοποιείται όταν κλείνω το καπάκι;</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">When you close the lid of your laptop, your computer will
  <span class="link"><a href="power-suspend.html.el" title="Τι συμβαίνει όταν αναστέλλω τον υπολογιστή μου;"><span class="em">suspend</span></a></span> in order to save power.
  ...
  power button.</p>
<p class="p">Μερικοί υπολογιστές δεν μπορούν να ανασταλούν σωστά, κανονικά επειδή το υλικό τους δεν υποστηρίζεται πλήρως από το λειτουργικό σύστημα (για παράδειγμα, οι οδηγοί Linux είναι ατελείς). Σε αυτήν την περίπτωση, μπορεί να βρείτε ότι δεν μπορείτε να συνεχίσετε τον υπολογιστή σας αφού έχετε κλείσει το καπάκι. Μπορείτε να δοκιμάσετε <span class="link"><a href="power-suspendfail.html.el" title="Γιατί ο υπολογιστής μου δεν επιστρέφει μετά την αναστολή;">να ρυθμίσετε το πρόβλημα με την αναστολή</a></span>, ή μπορείτε να αποτρέψετε τον υπολογιστή από την προσπάθεια αναστολής όταν κλείνετε το καπάκι.</p>
</div>
<section id="nosuspend"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Σταματήστε τον υπολογιστή από αναστολή όταν το καπάκι είναι κλειστό</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Αυτές οι οδηγίες θα δουλέψουν μόνο αν χρησιμοποιείτε το <span class="app">systemd</span>. Επικοινωνήστε με τη διανομή σας για περισσότερες πληροφορίες.</p></div></div></div>
</div>
<div class="note note-important" title="Σημαντικό">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m12.5 2a9.5 9.5 0 0 0-9.5 9.5 9.5 9.5 0 0 0 9.5 9.5 9.5 9.5 0 0 0 9.5-9.5 9.5 9.5 0 0 0-9.5-9.5zm0 3a1.5 1.5 0 0 1 1.5 1.5v6a1.5 1.5 0 0 1-1.5 1.5 1.5 1.5 0 0 1-1.5-1.5v-6a1.5 1.5 0 0 1 1.5-1.5zm0 10.5a1.5 1.5 0 0 1 1.5 1.5 1.5 1.5 0 0 1-1.5 1.5 1.5 1.5 0 0 1-1.5-1.5 1.5 1.5 0 0 1 1.5-1.5z"></path>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Να είσαστε πολύ προσεκτικοί εάν αλλάζετε αυτήν τη ρύθμιση. Μερικοί φορητοί μπορεί να υπερθερμανθούν, εάν αφήνονται να εκτελούνται με το καπάκι κλειστό, ειδικά εάν είναι σε μια περιορισμένη θέση όπως σε ένα σακίδιο.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Select the <span class="gui">General</span> tab.</p></li>
<li class="steps"><p class="p">Switch the <span class="gui">Suspend when laptop lid is closed</span> switch to
      off.</p></li>
