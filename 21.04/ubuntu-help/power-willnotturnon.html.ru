...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Компьютер не включается</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Возможны различные причины, из-за которых компьютер не включается. В этом разделе приведён краткий обзор некоторых из возможных причин.</p></div>
<section id="nopower"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Компьютер не подключён к источнику питания, разряжена батарея или плохой контакт</span></h2></div>
<div class="region"><div class="contents pagewide"><p class="p">Проверьте, надёжно ли вставлены в разъёмы кабели питания компьютера и есть ли напряжение в розетках. Убедитесь, что монитор подключен к розетке и включён. Если у вас ноутбук, подключите зарядное устройство (в случае, если аккумулятор разряжен). Можно также проверить, надёжно ли закреплён аккумулятор (проверьте снизу ноутбука), если он съёмный.</p></div></div>
</div></section><section id="hardwareproblem"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Неполадки аппаратного обеспечения</span></h2></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Компьютер подаёт звуковые сигналы и отключается</span></h2></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Вентиляторы компьютера крутятся, но изображение на экране отсутствует</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">В первую очередь проверьте, подсоединён ли и включён ли монитор.</p>
<p class="p">Проблема может быть в аппаратной неисправности. Например, при нажатии кнопки питания вентиляторы включаются, а другие важные части компьютера — нет. В таком случае нужно отнести компьютер в ремонт.</p>
</div></div>
