...
<li class="steps"><p class="p">V části <span class="gui">Šetření energií</span> najdete vypínače pro <span class="gui">Wi-Fi</span>, <span class="gui">Mobilní připojení</span> a <span class="gui">Bluetooth</span>. Nepoužívané věci vypněte. Když je budete později potřebovat, znovu je zapněte.</p></li>
</ol></div></div></div>
</div>
