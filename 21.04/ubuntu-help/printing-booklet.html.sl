...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Tiskanje knjižice</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Knjižico lahko natisnete iz datoteke PDF.</p>
...
<p class="p">V primeru, da število strani v vašem dokumentu PDF ni večkratnik števila 4, dodajte ustrezno število praznih strani (1, 2, 3), da bo število strani v dokumentu večkratnik števila 4. Za to lahko:a</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Ustvarite dokument <span class="app">LibreOffice</span> z zahtevanim številom (1-3) praznih strani.</p></li>
<li class="steps"><p class="p">Prazne strani izvozite v PDF z izbiro <span class="guiseq"><span class="gui">Datoteka</span> ▸ <span class="gui">Izvozi kot PDF …</span></span>.</p></li>
<li class="steps"><p class="p">Združite prazen PDF s svojim dokumentom PDF s programom <span class="app">PDF-Shuffler</span> ali <span class="app">PDF Mod</span> in na konec postavite prazne strani.</p></li>
</ol></div></div></div>
