...
<li class="steps"><p class="p">Επιλέξτε τον επιθυμητό προεπιλεγμένο εκτυπωτή από τη λίστα των διαθέσιμων εκτυπωτών.</p></li>
...
<li class="steps"><p class="p">Επιλέξτε το πλαίσιο ελέγχου <span class="gui">Προεπιλεγμένος εκτυπωτής</span>.</p></li>
</ol></div></div></div>
