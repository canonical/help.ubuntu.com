...
<title>Γιατί υπάρχουν ραβδώσεις, γραμμές ή εσφαλμένα χρώματα στα αντίτυπα μου;</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Γιατί υπάρχουν ραβδώσεις, γραμμές ή εσφαλμένα χρώματα στα αντίτυπα μου;</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Εάν τα αντίτυπα σας είναι ραβδωτά, ξεθωριασμένα, έχουν γραμμές πάνω τους που δεν θα έπρεπε να είναι εκεί, ή εάν είναι φτωχά σε ποιότητα, αυτό μπορεί να οφείλεται σε πρόβλημα με τον εκτυπωτή ή με τη χαμηλή παροχή μελανιού/γραφίτη.</p>
...
<div class="region"><ul><li class="links ">
<a href="printing-inklevel.html.el" title="How can I check my printer’s ink or toner levels?">How can I check my printer’s ink or toner levels?</a><span class="desc"> — Ελέγξτε την ποσότητα του μελανιού ή γραφίτη που υπάρχει στις κεφαλές του εκτυπωτή.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
