...
<p class="p">La <span class="em">Configuración de la privacidad</span> le ayuda a controlar si determinadas partes de su escritorio son visibles o no al resto de usuarios. Puede usar esta configuración para limpiar el histórico de uso de su equipo y eliminar archivos innecesarios.</p>
