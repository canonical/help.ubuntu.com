...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Zaslonske slike in posnetki</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">You can take a picture of your screen (a <span class="em">screenshot</span>) or record a
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Zajeme zaslonske slike</span></h2></div>
<div class="region">
...
<li class="steps">
<p class="p">Kliknite <span class="gui">Zajemi zaslonsko sliko</span>.</p>
<p class="p">V primeru da ste izbrali <span class="gui">Izbor področja za zajem</span>, se bo kazalec spremenil v križec. Kliknite in vlecite področje, ki ga želite na zaslonski sliki.</p>
</li>
<li class="steps">
<p class="p">V oknu <span class="gui">Shrani zaslonsko sliko</span> izberite ime datoteke in mapo ter kliknite <span class="gui">Shrani</span>.</p>
<p class="p">Namesto tega lahko zaslonski posnetek uvozite neposredno v program za urejanje slik brez predhodnega shranjevanja. Kliknite <span class="gui">Kopiraj na odložišče</span> in nato prilepite sliko v drug program ali povlecite sličico zaslonske slike v ta program.</p>
</li>
</ol></div></div></div></div>
<section id="keyboard-shortcuts"><div class="inner">
<div class="hgroup pagewide"><h3 class="title"><span class="title">Tipkovne bližnjice</span></h3></div>
<div class="region"><div class="contents pagewide">
<p class="p">Hitro zajemite sliko namizja, okna ali področja z uporabo naslednjih tipkovnih bližnjic:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list compact">
<li class="list"><p class="p"><span class="key"><kbd>Prt Scrn</kbd></span> za zajem slike namizja.</p></li>
<li class="list"><p class="p"><span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>Prt Scrn</kbd></span></span> za zajem slike okna.</p></li>
<li class="list"><p class="p"><span class="keyseq"><span class="key"><kbd>Shift</kbd></span>+<span class="key"><kbd>Prt Scrn</kbd></span></span> za zajem slike izbranega področja.</p></li>
</ul></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">If you do not have a <span class="file">Pictures</span> folder, the images will be
      saved in your home folder instead.</p></div></div></div>
</div>
<p class="p">Lahko tudi držite <span class="key"><kbd>Ctrl</kbd></span> s katerokoli od zgornjih bližnjic za kopiranje slike zaslona na odložišče namesto shranjevanja.</p>
</div></div>
</div></section>
</div>
</div></section><section id="screencast"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ustvarjanje zaslonskega posnetka</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Posnamete lahko tudi videoposnetek dogajanja na zaslonu:</p>
...
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">If you do not have a <span class="file">Videos</span> folder, the videos will be
    saved in your home folder instead.</p></div></div></div>
</div>
</div></div>
