...
<a href="hardware-auth.html.nl" title="Vingerafdruk &amp; smartcards">Vingerafdruk &amp; smartcards</a><span class="desc"> — <span class="link"><a href="session-fingerprint.html.nl" title="Aanmelden met een vingerafdruk">Vingerafdruk-lezers</a></span>, smartcards…</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
