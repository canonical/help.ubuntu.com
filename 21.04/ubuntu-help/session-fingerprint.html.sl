...
<title>Prijava s prstnim odtisom</title>
...
<span style="color: #333">Ubuntu 21.04</span> » <a class="trail" href="index.html.sl" title="Namizni vodnik Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Pomoč"></span></span> Vodič po namizju Ubuntu</a> » <a class="trail" href="hardware.html.sl" title="Strojna oprema in gonilniki">Strojna oprema</a> » <a class="trail" href="hardware-auth.html.sl" title="Pametne kartice in bralniki prstnih odtisov">Pametne kartice in bralniki prstnih odtisov</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Prijava s prstnim odtisom</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">If your system has a supported fingerprint scanner, you can record your
  fingerprint and use it to log in.</p></div>
<section id="record"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Record a fingerprint</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">V primeru da je vaš prst presuh, boste morda imeli težave z zaznavanjem svojega prstnega odtisa. V primeru da se to zgodi ga rahlo navlažite, posušite s suho, nevlaknasto krpo in poskusite znova.</p></div></div></div>
</div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Check that your fingerprint works</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Sedaj preverite da vaša nova prijava s prstnim odtisom deluje. Tudi če imate registriran prstni odtis, se lahko še vedno prijavite s svojim geslom.</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Save any open work, and then <span class="link"><a href="shell-exit.html.sl#logout" title="Odjava ali preklop uporabnika">log
      out</a></span>.</p></li>
...
<a href="hardware-auth.html.sl" title="Pametne kartice in bralniki prstnih odtisov">Pametne kartice in bralniki prstnih odtisov</a><span class="desc"> — <span class="link"><a href="session-fingerprint.html.sl" title="Prijava s prstnim odtisom">Bralniki prstnih odtisov</a></span>, pametne kartice ...</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
