...
<p class="p">You must have the <span class="app">Vino</span> package installed for
     <span class="gui">Screen Sharing</span> to be visible.</p>
<p class="p"><span class="link-button link"><a href="apt:vino" title="apt:vino">Install Vino</a></span></p>
</div></div></div>
</div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Ta možnost je privzeto omogočena</p></div></div></div>
</div>
</dd>
