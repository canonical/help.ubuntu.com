...
<p class="p">Když se chcete <span class="gui">Odhlásit</span> nebo <span class="gui">Přepnout uživatele</span>, klikněte na <span class="link"><a href="shell-introduction.html.cs#systemmenu" title="Nabídka systému">nabídku systému</a></span> na pravé straně horní lišty, klikněte na své jméno a pak zvolte příslušnou položku.</p>
