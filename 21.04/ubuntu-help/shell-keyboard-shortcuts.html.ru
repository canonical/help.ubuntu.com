...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-exit.html.ru#logout" title="Завершение сеанса и переключение пользователей">Show the Power Off / Restart dialog</a></span>.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Show <span class="link"><a href="shell-notifications.html.ru#notificationlist" title="The notification list">the notification
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="screen-shot-record.html.ru#screencast" title="Создание скринкаста">Start and stop screencast
