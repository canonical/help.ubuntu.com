...
<li class="steps"><p class="p">The <span class="em"><a href="shell-workspaces.html.sl" title="Kaj je delovna površina in kako mi bo pomagala?">workspace selector</a></span> will
      expand.</p></li>
<li class="steps"><p class="p">Drop the window onto an empty workspace. This workspace now contains
      the window you have dropped, and a new empty workspace appears at the
      bottom of the <span class="em">workspace selector</span>.</p></li>
</ol></div>
</div></div>
<div class="steps"><div class="inner">
...
<p class="p">Press <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>Shift</kbd></span>+<span class="key"><kbd>Page
      Down</kbd></span></span> to move the window to a workspace which is below the
      current workspace on the <span class="em">workspace selector</span>.</p>
</li>
</ol></div>
</div></div>
