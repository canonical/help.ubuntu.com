...
<li class="list"><p class="p">In the
    <span class="gui"><a href="shell-introduction.html.ru#activities" title="Режим обзора">Activities</a></span> overview, move
    your cursor to the right-most side of the screen.</p></li>
...
<li class="list"><p class="p">To add a workspace, drag and drop a
    ...
    empty workspace will appear below it.</p></li>
