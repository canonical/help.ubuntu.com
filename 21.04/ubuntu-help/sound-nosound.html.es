...
<li class="steps"><p class="p">En <span class="gui">Niveles de volumen</span> compruebe que su aplicación no está silenciada.</p></li>
</ol></div></div></div>
</div></div>
...
<li class="steps"><p class="p">Pulse en <span class="gui">Sonido</span> para abrir el panel.</p></li>
<li class="steps">
<p class="p">En <span class="gui">Salida</span>, cambie la configuración del <span class="gui">Perfil</span> para el dispositivo seleccionado y reproduzca un sonido para comprobar que funciona. Puede necesitar ir a través de la lista y probar cada perfil.</p>
