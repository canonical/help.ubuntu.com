...
<li class="links "><a href="status-icons.html.el#universalicons" title="Accessibility Menu Icons">Accessibility Menu Icons</a></li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Accessibility Menu Icons</span></h2></div>
...
<td><p class="p">Οδηγεί σε ένα μενού που ενεργοποιεί τις ρυθμίσεις προσιτότητας.</p></td>
</tr></table></div></div></div></div></div>
</div></section><section id="audioicons"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Εικονίδια ελέγχου έντασης</span></h2></div>
...
<td><p class="p">Η ένταση ορίστηκε στο υψηλό.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Η ένταση ορίστηκε στο μεσαίο.</p></td>
</tr>
<tr>
...
<td><p class="p">Η ένταση ορίστηκε στο χαμηλό.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Η ένταση είναι κλειστή.</p></td>
</tr>
</table></div></div></div></div></div>
</div></section><section id="bluetoothicons"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Εικονίδια του διαχειριστή Bluetooth</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Το Bluetooth έχει ενεργοποιηθεί.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Το Bluetooth έχει απενεργοποιηθεί.</p></td>
</tr>
</table></div></div></div></div></div>
</div></section><section id="networkicons"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Εικονίδια διαχειριστή δικτύου</span></h2></div>
<div class="region">
<div class="contents pagewide">
...
<td><p class="p">Συνδέθηκε σε 3G δίκτυο.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Συνδέθηκε σε 4G δίκτυο.</p></td>
</tr>
<tr>
...
<td><p class="p">Συνδέθηκε σε δίκτυο EDGE.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Συνδέθηκε σε δίκτυο GPRS.</p></td>
</tr>
<tr>
...
<td><p class="p">Συνδέθηκε σε δίκτυο UMTS.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Συνδέθηκε σε δίκτυο κινητής τηλεφωνίας.</p></td>
</tr>
<tr>
...
<td><p class="p">Λήψη ενός δικτύου κινητής τηλεφωνίας.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Πολύ υψηλή ισχύς σήματος.</p></td>
</tr>
<tr>
...
<td><p class="p">Υψηλή ισχύς σήματος.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Μέτρια ισχύς σήματος.</p></td>
</tr>
<tr>
...
<td><p class="p">Χαμηλή ισχύς σήματος.</p></td>
</tr>
<tr class="shade">
...
<p class="p"><span class="app">Σύνδεση σε δίκτυο τοπικής περιοχής (LAN)</span></p>
<div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Παρουσιάστηκε σφάλμα στην εύρεση του δικτύου.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Το δίκτυο είναι αδρανές.</p></td>
</tr>
<tr>
...
<td><p class="p">Δεν βρέθηκε διαδρομή για το δίκτυο.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Το δίκτυο είναι εκτός σύνδεσης.</p></td>
</tr>
<tr>
...
<td><p class="p">Το δίκτυο λαμβάνει δεδομένα.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Το δίκτυο εκπέμπει και δέχεται δεδομένα.</p></td>
</tr>
<tr>
...
<td><p class="p">Το δίκτυο εκπέμπει δεδομένα.</p></td>
</tr>
</table></div></div></div>
<p class="p"><span class="app">Σύνδεση σε εικονικό ιδιωτικό δίκτυο (VPN)</span></p>
<div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Λήψη σύνδεσης δικτύου.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Συνδέθηκε σε δίκτυο VPN.</p></td>
</tr>
</table></div></div></div>
<p class="p"><span class="app">Ενσύρματη σύνδεση</span></p>
<div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<p class="p"><span class="app">Ασύρματη σύνδεση</span></p>
<div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Λήψη της ασύρματης σύνδεσης.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Το ασύρματο δίκτυο είναι κρυπτογραφημένο.</p></td>
</tr>
<tr>
...
<td><p class="p">Συνδέθηκε σε ασύρματο δίκτυο.</p></td>
</tr>
<tr class="shade">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Εικονίδια διαχειριστή ισχύος</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="table"><div class="inner"><div class="region"><table class="table">
<tr>
...
<td><p class="p">Η μπαταρία είναι πλήρης.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Η μπαταρία είναι μερικώς άδεια.</p></td>
</tr>
<tr>
...
<td><p class="p">Το φορτίο της μπαταρίας είναι χαμηλό</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Προσοχή: Η μπαταρία είναι πολύ χαμηλή.</p></td>
</tr>
<tr>
...
<td><p class="p">Η μπαταρία είναι πολύ χαμηλή.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Η μπαταρία έχει αποσυνδεθεί.</p></td>
</tr>
<tr>
...
<td><p class="p">Η μπαταρία είναι πλήρως φορτισμένη.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Η μπαταρία είναι γεμάτη και φορτίζεται.</p></td>
</tr>
<tr>
...
<td><p class="p">Η μπαταρία είναι μερικώς γεμάτη και φορτίζεται.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Η μπαταρία είναι χαμηλή και φορτίζεται.</p></td>
</tr>
<tr>
...
<td><p class="p">Η μπαταρία είναι πολύ χαμηλή και φορτίζεται.</p></td>
</tr>
<tr class="shade">
...
<td><p class="p">Η μπαταρία είναι άδεια και φορτίζεται.</p></td>
</tr>
</table></div></div></div></div></div>
