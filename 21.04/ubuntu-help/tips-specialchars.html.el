...
<p class="p"><span class="link-button link"><a href="apt:gnome-tweaks" title="apt:gnome-tweaks">Install
...
<p class="p">Για περισσότερες αλληλουχίες πλήκτρων σύνθεσης, δείτε <span class="link"><a href="http://en.wikipedia.org/wiki/Compose_key#Common_compose_combinations" title="http://en.wikipedia.org/wiki/Compose_key#Common_compose_combinations">τη σελίδα πλήκτρων σύνθεσης στη βικιπαίδεια</a></span>.</p>
</div></div>
