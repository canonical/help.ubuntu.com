...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Cuentas de usuario</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Cada persona que utiliza el equipo debe tener una cuenta de usuario diferente. Esto le permite mantener sus archivos separados de los suyos y elegir su propia configuración. También es más seguro. Solo puede acceder a una cuenta de otro usuario si conoce la contraseña.</p></div>
<section id="manage"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Gestionar las cuentas de usuario</span></h2></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Contraseñas</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-twocolumn">
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="user-changepassword.html.es" title="Cambiar su contraseña"><span class="title">Cambiar su contraseña</span><span class="linkdiv-dash"> — </span><span class="desc">Mantenga su cuenta segura cambiando su contraseña frecuentemente, en la configuración de su cuenta.</span></a></div></div>
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="user-goodpassword.html.es" title="Elegir una contraseña segura"><span class="title">Elegir una contraseña segura</span><span class="linkdiv-dash"> — </span><span class="desc">Use contraseñas más largas y complicadas.</span></a></div></div>
</div></div></div></div></div></div>
</div></section><section id="privileges"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Privilegios del usuario</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-twocolumn">
<div class="links-divs">
...
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="user-admin-explain.html.es" title="¿Cómo funcionan los privilegios de administrador?"><span class="title">¿Cómo funcionan los privilegios de administrador?</span><span class="linkdiv-dash"> — </span><span class="desc">Necesita privilegios de administrador para cambiar partes importantes de su sistema.</span></a></div></div>
</div></div></div></div></div></div>
