...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Uporabniški računi</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Each person that uses the computer should have a different user account.
  This allows them to keep their files separate from yours and to choose their
  own settings. It is also more secure. You can only access a different user
  account if you know their password.</p></div>
<section id="manage"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Upravljanje uporabniških računov</span></h2></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Gesla</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-twocolumn">
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="user-goodpassword.html.sl" title="Izbor varnega gesla"><span class="title">Izbor varnega gesla</span><span class="linkdiv-dash"> — </span><span class="desc">Uporabite daljša, bolj zapletena gesla.</span></a></div></div>
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="user-changepassword.html.sl" title="Spreminjanje gesla"><span class="title">Spreminjanje gesla</span><span class="linkdiv-dash"> — </span><span class="desc">Obdržite svoj račun varen s pogostim spreminjanem gesla v nastavitvah računa.</span></a></div></div>
</div></div></div></div></div></div>
</div></section><section id="privileges"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Uporabniška dovoljenja</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-twocolumn">
<div class="links-divs">
...
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="user-admin-problems.html.sl" title="Težave, ki jih povzročijo skrbniške omejitve"><span class="title">Težave, ki jih povzročijo skrbniške omejitve</span><span class="linkdiv-dash"> — </span><span class="desc">You can do some things, like installing applications, only if you
