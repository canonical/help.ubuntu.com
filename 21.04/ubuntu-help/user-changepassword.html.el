...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Αλλάξτε τον κωδικό πρόσβασής σας</span></h1></div>
<div class="region">
...
<li class="steps">
<p class="p">Πληκτρολογήστε τον τρέχοντα κωδικό πρόσβασής σας, και έπειτα εισάγετε έναν νέο κωδικό πρόσβασης. Εισάγετε τον νέο σας κωδικό πρόσβασης πάλι στο πεδίο <span class="gui">Επαλήθευση νέου κωδικού πρόσβασης</span>.</p>
<p class="p">Μπορείτε να πατήσετε στο εικονίδιο <span class="gui"><span class="media"><span class="media media-image"><img src="figures/system-run-symbolic.svg" height="16" width="16" class="media media-inline" alt="δημιουργία κωδικού πρόσβασης"></span></span></span> για να δημιουργήσετε αυτόματα έναν τυχαίο κωδικό πρόσβασης.</p>
</li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Όταν ενημερώνετε τον κωδικό πρόσβασης σύνδεσης, ο κωδικός πρόσβασης σύνδεσης της κλειδοθήκης θα ενημερωθεί αυτόματα για να είναι ο ίδιος με τον κωδικό πρόσβασης της νέας σύνδεσης.</p></div></div></div>
</div>
