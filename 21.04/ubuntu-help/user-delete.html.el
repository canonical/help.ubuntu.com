...
<title>Διαγραφή λογαριασμού χρήστη</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Διαγραφή λογαριασμού χρήστη</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">You can <span class="link"><a href="user-add.html.el" title="Προσθήκη νέου λογαριασμού χρήστη">add multiple user accounts to your
  computer</a></span>. If somebody is no longer using your computer, you can delete
  that user’s account.</p>
<p class="p">Χρειάζεστε <span class="link"><a href="user-admin-explain.html.el" title="Πώς δουλεύουν τα δικαιώματα διαχειριστή;">δικαιώματα διαχειριστή</a></span> για να διαγράψετε τους λογαριασμούς χρήστη.</p>
