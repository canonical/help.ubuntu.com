...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Pro legální přehrání DVD použijte Fluendo</span></h2></div>
<div class="region"><div class="contents pagewide"><p class="p">Můžete zakoupit komerční dekodér DVD, zvládající ochranu proti kopírování, od <span class="link"><a href="https://fluendo.com/" title="https://fluendo.com/">Fluendo</a></span>. Funguje na Linuxu a jeho použití by mělo být legální ve většině zemí.</p></div></div>
