...
<span style="color: #333">Ubuntu 21.10</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="a11y.html.ru" title="Accessibility">Accessibility</a> › <a class="trail" href="a11y.html.ru#sound" title="Ограничения слуха">Ограничения слуха</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Мигание экрана при звуковых сигналах</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Чтобы быстро включить или отключить визуальные уведомления, нажмите на <span class="link"><a href="a11y-icon.html.ru" title="Find the accessibility menu">значок специальных возможностей</a></span> в верхней панели и измените положение переключателя <span class="gui">Визуальные предупреждения</span>.</p></div></div></div>
</div>
</div>
