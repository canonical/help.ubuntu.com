...
<div class="linkdiv "><a class="linkdiv" href="accounts-add.html.es" title="Añadir una cuenta"><span class="title">Añadir una cuenta</span><span class="linkdiv-dash"> — </span><span class="desc">Allow applications to access your accounts online for files,
...
<div class="linkdiv "><a class="linkdiv" href="accounts-provider-not-available.html.es" title="¿Por qué no parece mi tipo de cuenta en la lista?"><span class="title">¿Por qué no parece mi tipo de cuenta en la lista?</span><span class="linkdiv-dash"> — </span><span class="desc">What if an online service is not listed?</span></a></div>
</div></div></div></div>
</div>
