...
<div class="linkdiv "><a class="linkdiv" href="accounts-add.html.ru" title="Добавление учётной записи"><span class="title">Добавление учётной записи</span><span class="linkdiv-dash"> — </span><span class="desc">Allow applications to access your accounts online for files,
