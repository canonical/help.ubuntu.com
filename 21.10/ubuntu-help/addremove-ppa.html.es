...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Añadir un repositorio de paquetes personal (PPA)</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Abra <span class="app">Software y actualizaciones</span> mediante la barra de búsqueda de <span class="em">Actividades</span>.</p></li>
...
<div class="region"><ul><li class="links ">
<a href="addremove-sources.html.es" title="Añadir repositorios de software">Añadir repositorios de software</a><span class="desc"> — Añadir repositorios para ampliar los origenes de software que Ubuntu usa para instalaciones y actualizaciones.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
