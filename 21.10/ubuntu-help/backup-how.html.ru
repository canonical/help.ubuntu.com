...
<p class="p">An alternative option is to <span class="link"><a href="files-copy.html.ru" title="Копирование и перемещение файлов и папок">copy your files</a></span>
 to a safe location, such as an external hard drive, an online storage service,
 or a USB drive. Your <span class="link"><a href="backup-thinkabout.html.ru" title="Где найти файлы, которые я хочу скопировать?">personal files</a></span>
