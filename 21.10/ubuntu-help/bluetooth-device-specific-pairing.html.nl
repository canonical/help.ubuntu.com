...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Pairing instructions for specific devices</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Even if you manage to source the manual for a device, it might not contain
  enough information to make pairing possible. Here are details for a few common
  devices.</p>
<div class="terms"><div class="inner"><div class="region"><dl class="terms">
<dt class="terms">PlayStation 3 joypads</dt>
<dd class="terms"><p class="p">Those devices use “cable-pairing”. Plug the joypads in via USB with the
      ...
      “PS” button, you will get asked whether to set those joypads up. Unplug them and
      press the “PS” button to use them over Bluetooth.</p></dd>
<dt class="terms">PlayStation 4 joypads</dt>
<dd class="terms">
...
<p class="p">Using the “PS” and “Share” button combination to pair the joypad can also be used to
      make the joypad visible and pair it like any other Bluetooth device, if you don’t have
      a USB cable at hand.</p>
</dd>
<dt class="terms">PlayStation 3 BD Remote Control</dt>
<dd class="terms"><p class="p">Hold the “Start” and “Enter” buttons at the same time for around 5 seconds.
      You can then select the remote in the devices list as usual.</p></dd>
<dt class="terms">Nintendo Wii and Wii U Remotes</dt>
<dd class="terms"><p class="p">Use the red “Sync” button inside the battery compartment to start the pairing
      ...
      the Bluetooth panel. Refer to the application’s manual for instructions.</p></dd>
...
<div class="region"><ul><li class="links ">
<a href="bluetooth-visibility.html.nl" title="Wat is Bluetooth-zichtbaarheid?">Wat is Bluetooth-zichtbaarheid?</a><span class="desc"> — Of andere apparaten uw computer kunnen zien.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
