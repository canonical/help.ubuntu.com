...
<div class="region"><ul><li class="links ">
<a href="bluetooth-visibility.html.ru" title="Что такое видимость Bluetooth?">Что такое видимость Bluetooth?</a><span class="desc"> — Whether other devices can discover your computer.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
