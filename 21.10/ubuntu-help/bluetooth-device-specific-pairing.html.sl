...
<div class="region"><ul><li class="links ">
<a href="bluetooth-visibility.html.sl" title="Kaj je vidnost Bluetooth?">Kaj je vidnost Bluetooth?</a><span class="desc"> — Whether other devices can discover your computer.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
