...
<div class="linkdiv "><a class="linkdiv" href="bluetooth-device-specific-pairing.html.cs" title="Návody k párování speciálních zařízení"><span class="title">Návody k párování speciálních zařízení</span><span class="linkdiv-dash"> — </span><span class="desc">Jak spárovat některá speciální zařízení s počítačem.</span></a></div>
</div></div></div></div>
</div>
<section id="problems"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Problémy</span></h2></div>
<div class="region">
<div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="bluetooth-problem-connecting.html.cs" title="Nemohu připojit své zařízení Bluetooth"><span class="title">Nemohu připojit své zařízení Bluetooth</span><span class="linkdiv-dash"> — </span><span class="desc">Adaptér může být vypnutý nebo možná nemáte ovladače nebo je Bluetooth zakázané nebo blokované.</span></a></div></div></div></div></div></div>
