...
<title>Πως βαθμονομώ την κάμερα μου;</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Πως βαθμονομώ την κάμερα μου;</span></h1></div>
<div class="region">
...
<p class="p">Θα χρειαστείτε να περικόψετε το αρχείο TIFF έτσι ώστε μόνο ο προορισμός να είναι ορατός. Βεβαιωθείτε ότι τα λευκά ή μαύρα περιγράμματα είναι ακόμα ορατά. Η βαθμονόμηση δεν θα δουλέψει εάν η εικόνα είναι ανάποδα ή είναι παραμορφωμένη σε μεγάλο ποσοστό.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Το τελικό προφίλ είναι έγκυρο μόνο στις συνθήκες φωτισμού από όπου παίρνετε την αρχική εικόνα. Αυτό σημαίνει ότι μπορεί να χρειαστείτε να αρκετές φορές για συνθήκες φωτισμού <span class="em">στούντιο</span>, <span class="em">λαμπερού ηλιακού φωτός</span> και <span class="em">συννεφιάς</span>.</p></div></div></div>
</div>
</div>
