...
<title>Ποιοι τύποι προορισμού υποστηρίζονται;</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Ποιοι τύποι προορισμού υποστηρίζονται;</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Ο παρακάτω τύποι προορισμών υποστηρίζονται:</p>
...
<p class="p">Μπορείτε να προμηθευτείτε προορισμούς από γνωστούς πωλητές όπως KODAK, X-Rite και LaserSoft σε ποικίλα διαδικτυακά καταστήματα.</p>
<p class="p">Εναλλακτικά μπορείτε να αγοράσετε προορισμούς από το <span class="link"><a href="http://www.targets.coloraid.de/" title="http://www.targets.coloraid.de/">Wolf Faust</a></span> σε πολλή λογική τιμή.</p>
</div></div></div>
</div>
</div>
