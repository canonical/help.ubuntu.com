...
<p class="p">Even if the <span class="gui">Overall Assessment</span> indicates that the disk
  ...
  to be prepared with a <span class="link"><a href="backup-why.html.ru" title="Резервное копирование важных данных">backup</a></span> to prevent data
  loss.</p>
<p class="p">If the status says “Pre-fail”, the disk is still reasonably healthy but
 ...
 <span class="link"><a href="backup-how.html.ru" title="Как создать резервную копию">backup your important files regularly</a></span> and check
