...
<li class="steps"><p class="p">Нажмите правой кнопкой и выберите <span class="gui">Копировать</span> или нажмите <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>C</kbd></span></span>.</p></li>
...
<li class="steps"><p class="p">Нажмите правой кнопкой и выберите <span class="gui">Вырезать</span> или нажмите <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>X</kbd></span></span>.</p></li>
