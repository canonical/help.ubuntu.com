...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">If you name a file with a <span class="file">.</span> as the first character, the
    file will be <span class="link"><a href="files-hidden.html.ru" title="Скрытие файла">hidden</a></span> when you attempt to
    view it in the file manager.</p></div></div></div>
</div>
</div></div>
