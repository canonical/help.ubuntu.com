...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Обмен файлами по почте</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Файлами можно легко обмениваться, посылая их по почте непосредственно из файлового менеджера.</p>
<div class="note note-important" title="Важно">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m12.5 2a9.5 9.5 0 0 0-9.5 9.5 9.5 9.5 0 0 0 9.5 9.5 9.5 9.5 0 0 0 9.5-9.5 9.5 9.5 0 0 0-9.5-9.5zm0 3a1.5 1.5 0 0 1 1.5 1.5v6a1.5 1.5 0 0 1-1.5 1.5 1.5 1.5 0 0 1-1.5-1.5v-6a1.5 1.5 0 0 1 1.5-1.5zm0 10.5a1.5 1.5 0 0 1 1.5 1.5 1.5 1.5 0 0 1-1.5 1.5 1.5 1.5 0 0 1-1.5-1.5 1.5 1.5 0 0 1 1.5-1.5z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Before you begin, make sure <span class="app">Evolution</span> or <span class="app">Geary</span> is
    installed on your computer, and your email account is configured.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Нажмите <span class="gui">Кому</span> чтобы выбрать адресата, или введите почтовый адрес, на который нужно послать файл. Обязательно заполните поле <span class="gui">Тема</span> и поле сообщения, затем нажмите <span class="gui">Отправить</span>.</p></li>
</ol></div>
</div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">You can send multiple files at once. Select multiple files by holding
