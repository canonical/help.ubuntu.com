...
<div class="trail">
<span style="color: #333">Ubuntu 21.10</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="media.html.ru" title="Звук, видео и изображения">Media</a> › <a class="trail" href="media.html.ru#photos" title="Фотографии и цифровые фотокамеры">Фотографии</a> » </div>
</div>
