...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Оборудование и драйверы</span></h1></div>
<div class="region">
...
<li class="links ">
<a href="wacom.html.ru" title="Графический планшет Wacom">Графический планшет Wacom</a><span class="desc"> — Configure your Wacom graphics tablet, including the tracking
  mode and which monitor it is mapped to.</span>
</li>
<li class="links ">
<a href="disk.html.ru" title="Диски и другие устройства хранения информации">Диски и другие устройства хранения информации</a><span class="desc"> — Check on disk space and control how disk space is allocated and used.</span>
</li>
<li class="links ">
...
<li class="links ">
<a href="hardware-auth.html.ru" title="Отпечатки пальцев и смарт-карты">Отпечатки пальцев и смарт-карты</a><span class="desc"> — Use hardware devices to authenticate instead of passwords.</span>
</li>
<li class="links ">
<a href="printing.html.ru" title="Печать">Печать</a><span class="desc"> — Set up local and network printers. Learn about different
...
<li class="links ">
<a href="color.html.ru" title="Управление цветом">Управление цветом</a><span class="desc"> — Calibrate color profiles on monitors, printers, and other devices.</span>
</li>
</ul></div></div></div>
...
<li class="links ">
<a href="hardware-cardreader.html.ru" title="Проблемы с устройствами для чтения карт памяти">Проблемы с устройствами для чтения карт памяти</a><span class="desc"> — Troubleshoot media card readers.</span>
</li>
<li class="links ">
