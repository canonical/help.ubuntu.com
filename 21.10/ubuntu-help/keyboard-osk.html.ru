...
<p class="p">You can press the
  ...
  <span class="link"><a href="touchscreen-gestures.html.ru" title="Use gestures on touchpads and touchscreens">dragging up from the bottom edge</a></span>.</p>
<p class="p">Press the
  ...
  <span class="link"><a href="session-language.html.ru" title="Изменение языка">Language</a></span> or
  <span class="link"><a href="keyboard-layouts.html.ru" title="Использование других раскладок клавиатуры">Input Sources</a></span>.</p>
</div>
