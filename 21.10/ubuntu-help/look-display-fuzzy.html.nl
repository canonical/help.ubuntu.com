...
<div class="region"><ul><li class="links ">
<a href="look-resolution.html.nl" title="Change the resolution or orientation of the screen">Change the resolution or orientation of the screen</a><span class="desc"> — De resolutie en de oriëntatie (rotatie) van het scherm wijzigen.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
