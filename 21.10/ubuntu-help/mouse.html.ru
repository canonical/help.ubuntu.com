...
<div class="linkdiv "><a class="linkdiv" href="touchscreen-gestures.html.ru" title="Use gestures on touchpads and touchscreens"><span class="title">Use gestures on touchpads and touchscreens</span><span class="linkdiv-dash"> — </span><span class="desc">Manipulate your desktop using gestures on your touchpad or touchscreen.</span></a></div>
</div>
</div></div></div></div></div>
