...
<p class="p">By default, all previews are done for
    ...
    <span class="link"><a href="nautilus-connect.html.ru" title="Обзор файлов на сервере или сетевом ресурсе">browse files on other computers</a></span> over
...
<dd class="terms">
<p class="p">If you show file sizes in <span class="link"><a href="nautilus-list.html.ru" title="Files list columns preferences">list view columns</a></span>
    or <span class="link"><a href="nautilus-display.html.ru#icon-captions" title="Подписи к значкам">icon captions</a></span>,
    folders will be shown with a count of how many files and folders they
    contain. Counting items in a folder can be slow, especially for very large
    folders, or over a network.</p>
<p class="p">You can turn this feature on or off, or turn it on only for files on
