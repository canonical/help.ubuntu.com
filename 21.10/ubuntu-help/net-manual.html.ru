...
<div class="trail">
<span style="color: #333">Ubuntu 21.10</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="net.html.ru" title="Networking, web &amp; email">Networking</a> » <a class="trail" href="net-wired.html.ru" title="Wired networking">Wired networking</a> » </div>
<div class="trail">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">For a <span class="gui">Wi-Fi</span> connection, the 
        <span class="media"><span class="media media-image"><img src="figures/emblem-system-symbolic.svg" class="media media-inline" alt="settings"></span></span>
        button will be located next to the active network.</p></div></div></div>
</div>
</li>
...
<li class="steps"><p class="p">Click <span class="gui">Apply</span>. If you are not connected to the network, open the
      <span class="gui"><a href="shell-introduction.html.ru#systemmenu" title="Системное меню">system menu</a></span> from the right side of
...
<div class="region"><ul>
<li class="links ">
<a href="net-wired.html.ru" title="Wired networking">Wired networking</a><span class="desc"> — Use a wired internet connection and set a static IP address.</span>
</li>
<li class="links ">
