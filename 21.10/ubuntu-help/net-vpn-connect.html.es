...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Conectar a una VPN</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Si no hay ningún paquete de NetworkManager para su tipo de VPN, probablemente tendrá que descargar e instalar algún programa cliente de la empresa que proporcione el software VPN. Probablemente tendrá que seguir algunas instrucciones distintas para hacer que funcione.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Cuando termine de configurar la VPN, abra el <span class="gui"><a href="shell-introduction.html.es#systemmenu" title="Menú del sistema">menú del sistema</a></span> en la parte derecha de la barra superior, pulse en <span class="gui">VPN apagada</span> y seleccione <span class="gui">Conectar</span>. Es posible que deba introducir una contraseña antes de establecer la conexión. Cuando la conexión se establezca, verá un icono de un candado en la barra superior.</p></li>
<li class="steps"><p class="p">Si todo va bien, se conectará correctamente a la VPN. De lo contrario, puede que necesite volver a comprobar la configuración VPN que introdujo. Puede hacerlo pulsando desde el panel de <span class="gui">Red</span> que usó para crear la conexión, seleccionando la conexión VPN en la lista y pulsando el botón <span class="media"><span class="media media-image"><img src="figures/emblem-system-symbolic.svg" class="media media-inline" alt="configuración"></span></span> para revisar la configuración.</p></li>
