...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Σύνδεση σε ασύρματο δίκτυο</span></h1></div>
<div class="region">
...
<p class="p">If the name of the network is not shown, scroll down the list. If you
    ...
    <span class="link"><a href="net-wireless-hidden.html.el" title="Σύνδεση σε κρυφό ασύρματο δίκτυο">might be hidden</a></span>.</p>
</li>
<li class="steps">
...
<div class="region"><ul>
<li class="links ">
<a href="net-wrongnetwork.html.el" title="My computer connects to the wrong network">My computer connects to the wrong network</a><span class="desc"> — Edit your connection settings, and remove the unwanted connection
    option.</span>
</li>
<li class="links ">
