...
<div id="content">
<nav class="prevnext pagewide"><div class="inner"><a href="net-wireless-troubleshooting-initial-check.html.ru" title="Устранение неполадок с беспроводной сетью">Вперёд</a></div></nav><div class="hgroup pagewide"><h1 class="title"><span class="title">Устранение неполадок с беспроводной сетью</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">Проверка оборудования</p></li>
<li class="list"><p class="p">Попытка установить соединение с беспроводным маршрутизатором</p></li>
<li class="list"><p class="p">Проверка модема и маршрутизатора</p></li>
</ul></div></div></div>
<p class="p">Для начала нажмите ссылку <span class="em">Далее</span> в верхней правой части станицы. Эта ссылка, как и другие на следующих страницах, последовательно проведёт вас по настройкам этого руководства.</p>
...
<nav class="prevnext pagewide"><div class="inner"><a href="net-wireless-troubleshooting-initial-check.html.ru" title="Устранение неполадок с беспроводной сетью">Вперёд</a></div></nav><section class="links" role="navigation"><div class="inner">
