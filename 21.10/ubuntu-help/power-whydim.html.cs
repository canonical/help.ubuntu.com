...
<li class="steps"><p class="p">V části <span class="gui">Šetření energií</span> přepněte vypínač <span class="gui">Ztlumit jas obrazovky při neaktivitě</span> do polohy vypnuto.</p></li>
</ol></div></div></div>
</div>
