...
<li class="steps"><p class="p">Desactive la opción <span class="gui">Oscurecer la pantalla cuando esté inactiva</span> en la sección <span class="gui">Ahorro de energía</span>.</p></li>
</ol></div></div></div>
</div>
