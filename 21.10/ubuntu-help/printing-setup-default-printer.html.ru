...
<li class="links ">
<a href="printing-setup.html.ru" title="Установка локального принтера">Установка локального принтера</a><span class="desc"> — Set up a printer that is connected to your computer, or your local
    network.</span>
</li>
</ul></div>
</div></div>
