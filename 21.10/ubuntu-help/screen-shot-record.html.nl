...
<div class="region">
<div class="contents pagewide"><p class="p">U kunt een afdruk maken van uw scherm (een <span class="em">schermafdruk</span>), of een filmpje opnemen van wat er op het scherm gebeurt (een <span class="em">screencast</span>). Dit is handig als u bijvoorbeeld iemand wilt laten zien hoe je iets doet op de computer. Schermafdrukken en screencasts zijn gewoon afbeeldings- en videobestanden, dus u kunt ze in een e-mail versturen en ze op het internet delen.</p></div>
...
<li class="steps"><p class="p">Open <span class="app">Schermafdruk</span> vanuit het <span class="gui"><a href="shell-introduction.html.nl#activities" title="Activiteiten-overzicht">Activiteiten</a></span>-overzicht.</p></li>
...
<div class="hgroup pagewide"><h3 class="title"><span class="title">Sneltoetsen</span></h3></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Als u geen map <span class="file">Afbeeldingen</span> heeft, dan worden de afbeeldingen opgeslagen in uw persoonlijke map.</p></div></div></div>
</div>
...
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Als u geen map <span class="file">Video's</span> heeft, dan worden de video's opgeslagen in uw persoonlijke map.</p></div></div></div>
</div>
</div></div>
