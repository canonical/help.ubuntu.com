...
<div class="note note-package" title="Πακέτο">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Αν το κείμενο κάτω από το <span class="gui">όνομα υπολογιστή</span> σας επιτρέπει να το επεξεργαστείτε, μπορείτε να <span class="link"><a href="sharing-displayname.html.el" title="Ορισμός του ονόματος εμφάνισης για τον υπολογιστή σας">αλλάξετε</a></span> το όνομα που ο υπολογιστής σας εμφανίζετε στο δίκτυο.</p></div></div></div>
</div>
</li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ασφάλεια</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Είναι σημαντικό να σκεφτείτε την πλήρη έκταση της σημασίας κάθε επιλογής ασφάλειας πριν την αλλάξετε.</p>
<div class="terms"><div class="inner"><div class="region"><dl class="terms">
<dt class="terms">Οι νέες συνδέσεις πρέπει να ζητούν πρόσβαση</dt>
<dd class="terms">
<p class="p">Εάν θέλετε να μπορείτε να επιλέξετε αν κάποιος θα επιτρέπεται να προσπελάσει την επιφάνεια εργασίας σας, ενεργοποιήστε το <span class="gui">Οι νέες συνδέσεις πρέπει να ζητούν πρόσβαση</span>. Αν απενεργοποιήσετε αυτήν την επιλογή, δεν θα σας ζητηθεί αν θέλετε να επιτρέπετε σε κάποιον άλλον να συνδεθεί στον υπολογιστή σας.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Αυτή η επιλογή είναι ενεργοποιημένη από προεπιλογή.</p></div></div></div>
</div>
</dd>
<dt class="terms">Να απαιτείται κωδικός πρόσβασης</dt>
<dd class="terms">
<p class="p">Για να ζητήσετε άλλα άτομα να χρησιμοποιούν έναν κωδικό πρόσβασης όταν συνδέονται με την επιφάνεια εργασίας σας, ενεργοποιήστε το <span class="gui">Απαιτείται κωδικός πρόσβασης</span>. Αν δεν χρησιμοποιείτε αυτήν την επιλογή, οποιοσδήποτε μπορεί να προσπαθήσει να προβάλει την επιφάνεια εργασίας σας.</p>
<div class="note note-tip" title="Συμβουλή">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m12 2c-3.8541 0-7 3.1459-7 7 0 1.823 0.4945 3.139 1.1641 4.133 0.6695 0.994 1.4328 1.671 2.039 2.471 0.0882 0.116 0.1749 0.656 0.2071 1.32 0.016 0.332 0.0133 0.68 0.1894 1.119 0.0881 0.22 0.2439 0.478 0.5059 0.672 0.2619 0.194 0.6028 0.285 0.8945 0.285h4c0.583 0 1.204-0.478 1.402-0.908 0.199-0.43 0.217-0.793 0.244-1.137 0.056-0.688 0.138-1.319 0.211-1.441 0.549-0.916 1.304-2.009 1.94-3.114 0.636-1.104 1.203-2.199 1.203-3.4 0-3.8541-3.146-7-7-7zm0 2c2.773 0 5 2.2267 5 5 0 0.456-0.359 1.401-0.936 2.402-0.111 0.195-0.246 0.399-0.369 0.598h-7.8825c-0.4871-0.728-0.8125-1.519-0.8125-3 0-2.7733 2.2267-5 5-5z" style="block-progression:tb;color-rendering:auto;color:#000000;image-rendering:auto;isolation:auto;mix-blend-mode:normal;shape-rendering:auto;solid-color:#000000;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-transform:none;white-space:normal"></path>
 <path class="yelp-svg-fill" d="m9 20a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h6a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-6zm0 2a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h6a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-6z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Αυτή η επιλογή είναι ανενεργή από προεπιλογή, αλλά θα πρέπει να την ενεργοποιήσετε και να ορίσετε έναν ασφαλή κωδικό πρόσβασης.</p></div></div></div>
</div>
</dd>
</dl></div></div></div>
</div></div>
</div></section><section id="networks"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Δίκτυα</span></h2></div>
