...
<li class="steps"><p class="p">Выберите <span class="gui">Общий доступ к экрану</span>.</p></li>
...
<p class="p">Важно полностью осознать назначение каждого из этих параметров защиты перед их изменением.</p>
<div class="terms"><div class="inner"><div class="region"><dl class="terms">
<dt class="terms">New connections must ask for access</dt>
<dd class="terms">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Эта опция включена по умолчанию.</p></div></div></div>
</div>
</dd>
<dt class="terms">Require a Password</dt>
<dd class="terms">
<p class="p">To require other people to use a password when connecting to your
      desktop, enable <span class="gui">Require a Password</span>. If you do not use this
