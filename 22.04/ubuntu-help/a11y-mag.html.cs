...
<li class="steps"><p class="p">V pravém horním rohu okna <span class="gui">Volby přiblížení</span> přepněte vypínač <span class="gui">Přiblížit</span> do polohy zapnuto.</p></li>
</ol></div></div></div>
