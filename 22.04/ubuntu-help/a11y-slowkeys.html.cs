...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Zapnutí pomalých kláves</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Přepněte vypínač <span class="gui">Pomalé klávesy</span> do polohy zapnuto.</p></li>
</ol></div></div></div>
...
<p class="p">Zapněte přepínač <span class="gui">Zapnout z klávesnice</span>, abyst mohli pomalé klávesy povolovat a zakazovat z klávesnice. Pak už stačí jen zmáčknout na osm vteřin klávesu <span class="key"><kbd>Shift</kbd></span> a tím pomalé klávesy povolíte či zakážete.</p>
<p class="p">Pomalé klávesy můžete povolit a zakázat také kliknutím na <span class="link"><a href="a11y-icon.html.cs" title="Vyhledání nabídky přístupnosti">ikonu zpřístupnění</a></span> na horní liště a následujícím výběrem položky <span class="gui">Pomalé klávesy</span>. Ikona zpřístupnění je viditelná, když je zapnuté aspoň jedno nastavení v panelu <span class="gui">Přístupnost</span>.</p>
</div></div>
</div>
</div>
<p class="p">Pomocí táhla <span class="gui">Zpoždění přijetí</span> můžete řídit, jak dlouho je třeba držet klávesu zmáčknutou, aby byla zaregistrována. Více informací viz <span class="link"><a href="a11y-bouncekeys.html.cs" title="Zapnutí vícenásobných zmáčknutí kláves">Zapnutí vícenásobných zmáčknutí kláves</a></span></p>
<p class="p">Můžete nechat počítač vydat zvuk pokaždé, když zmáčknete klávesu, když je klávesa přijata, nebo když je klávesa odmítnuta, protože jste ji nedrželi dostatečně dlouho.</p>
</div>
