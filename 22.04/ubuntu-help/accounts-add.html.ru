...
<li class="steps"><p class="p">All services that are offered by an account provider will be enabled
      by default. <span class="link"><a href="accounts-disable-service.html.ru" title="К каким сетевым сервисам разрешён доступ с помощью учётной записи.">Switch</a></span>
