...
<a href="accounts.html.ru" title="Сетевые учётные записи">Сетевые учётные записи</a><span class="desc"> — Connect to your accounts with various online services.</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
