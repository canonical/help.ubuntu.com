...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Добавление персонального архива пакетов (PPA)</span></h1></div>
<div class="region">
...
<div class="region"><ul><li class="links ">
<a href="addremove-sources.html.ru" title="Добавление репозиториев программного обеспечения">Добавление репозиториев программного обеспечения</a><span class="desc"> — Добавьте репозитории, чтобы расширить список источников, используемых Ubuntu для установки и удаления приложений.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
