...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Kde mohu najít soubory, které chci zálohovat?</span></h1></div>
<div class="region">
...
<p class="p">Většinou jsou uchovány ve vaší domovské složce (<span class="file">/home/vaše_jméno</span>). Měly by být v podsložkách jako jsou <span class="file">Plocha</span>, <span class="file">Dokumenty</span>, <span class="file">Obrázky</span>, <span class="file">Hudba</span> a <span class="file">Videa</span>.</p>
...
<p class="p">Názvy některých souborů a složek začínají tečkou (.). Takovéto soubory a složky jsou normálně skryté. Abyste si je zobrazili, zmáčkněte tlačítko nabídky v pravém horním rohu okna aplikace <span class="app">Soubory</span> a zvolte <span class="gui">Zobrazovat skryté soubory</span> nebo zmáčkněte na klávesnici <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>H</kbd></span></span>. Tyto soubory můžete zkopírovat do místa zálohy stejně, jako kterékoliv jiné soubory.</p>
</li>
<li class="list">
