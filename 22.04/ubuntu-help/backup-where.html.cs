...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Kde uchovávat zálohy</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">Fleshdisk do USB (malá kapacita)</p></li>
<li class="list"><p class="p">Interní disk (velká kapacita)</p></li>
<li class="list"><p class="p">Externí pevný disk (obvykle velká kapacita)</p></li>
<li class="list"><p class="p">Síťový disk (velká kapacita)</p></li>
<li class="list"><p class="p">Souborový/zálohovací server (velká kapacita)</p></li>
<li class="list"><p class="p">Zapisovatelné CD nebo DVD (malá/střední kapacita)</p></li>
<li class="list"><p class="p">Zálohovací služba on-line (například <span class="link"><a href="http://aws.amazon.com/s3/" title="http://aws.amazon.com/s3/">Amazon S3</a></span>, kapacita se odvíjí od ceny)</p></li>
</ul></div>
</div></div>
<p class="p">Některé z těchto možností mají dostatečnou kapacitu pro zálohu všech souborů ve vašem systémů, také známou jako <span class="em">kompletní záloha systému</span>.</p>
</div>
