...
<title>Резервное копирование важных данных</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Резервное копирование важных данных</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p"><span class="em">Резервное копирование</span> файлов — это просто процесс создания копии этих файлов с целью обеспечения их сохранности. Резервные копии создаются на случай потери данных в случае их утери или повреждения, позволяя при необходимости восстановить исходные данные. Копии должны храниться отдельно от исходных файлов, например, на USB-носителе, внешнем жёстком диске, CD/DVD или в онлайн-хранилище.</p>
...
<div class="linkdiv "><a class="linkdiv" href="backup-how.html.ru" title="Как создать резервную копию"><span class="title">Как создать резервную копию</span><span class="linkdiv-dash"> — </span><span class="desc">Use Déjà Dup (or another backup application) to make copies of
    your valuable files and settings to protect against loss.</span></a></div>
</div>
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="backup-what.html.ru" title="Что копировать"><span class="title">Что копировать</span><span class="linkdiv-dash"> — </span><span class="desc">Back up anything that you cannot bear to lose if something goes
