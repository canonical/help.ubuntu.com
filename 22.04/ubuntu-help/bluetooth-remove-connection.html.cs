...
<title>Odpojení zařízení Bluetooth</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Odpojení zařízení Bluetooth</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">V dialogovém okně zařízení přepněte vypínač <span class="gui">Připojení</span> do polohy vypnuto nebo odeberte zařízení ze seznamu <span class="gui">Zařízení</span> kliknutím na <span class="gui">Odebrat zařízení</span>.</p></li>
</ol></div></div></div>
