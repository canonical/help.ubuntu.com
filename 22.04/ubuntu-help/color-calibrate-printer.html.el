...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Πως βαθμονομώ τον εκτυπωτή μου;</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Υπάρχουν δύο τρόποι βαθμονόμησης ενός εκτυπωτή:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Χρησιμοποιώντας μια συσκευή φωτοφασματομέτρου όπως η Pantone ColorMunki</p></li>
<li class="list"><p class="p">Downloading a printing reference file from a color company</p></li>
</ul></div></div></div>
<p class="p">Χρησιμοποιώντας μια εταιρεία χρωμάτων για δημιουργία ενός προφίλ εκτυπωτή είναι συνήθως η πιο φτηνή επιλογή εάν έχετε μόνο έναν ή δύο διαφορετικούς τύπους χαρτιού. Κάνοντας λήψη του διαγράμματος αναφοράς από τους ιστότοπους εταιρειών, μπορείτε έπειτα να τους στείλετε πίσω την εκτύπωση σε έναν γεμισμένο φάκελο όπου θα σαρώσουν το χαρτί, θα δημιουργήσουν το προφίλ και θα σας γυρίσουν με ηλεκτρονική αλληλογγραφία ένα ακριβές προφίλ ICC.</p>
<p class="p">Χρησιμοποιώντας μια ακριβή συσκευή όπως μια ColorMunki δουλεύει πιο φτηνά μόνο εάν περιγράφετε έναν μεγάλο αριθμό συνόλων μελανιού ή τύπων χαρτιού.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Εάν αλλάξετε τον τροφοδότη μελανιού, βεβαιωθείτε να επαναβαθμονομήσετε τον εκτυπωτή!</p></div></div></div>
</div>
</div>
...
<li class="links ">
<a href="color-calibrate-scanner.html.el" title="Πώς βαθμονομώ τον σαρωτή μου;">Πώς βαθμονομώ τον σαρωτή μου;</a><span class="desc"> — Η βαθμονόμηση του σαρωτή σας είναι σημαντική για τη λήψη πιστών χρωμάτων.</span>
</li>
</ul></div>
</div></div>
</div>
