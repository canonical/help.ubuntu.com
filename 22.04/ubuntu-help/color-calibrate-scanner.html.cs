...
<title>Jak můžu zkalibrovat svůj skener?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Jak můžu zkalibrovat svůj skener?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Jestli chcete, aby váš skener poskytoval při skenování věrné barvy, měli byste jej zkalibrovat.</p>
...
<li class="steps"><p class="p">Vyberte svůj skener.</p></li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Skenery bývají neuvěřitelně stálé, jak s vlivem času, tak teploty, takže obvykle nevyžadují rekalibrace.</p></div></div></div>
</div>
</div>
