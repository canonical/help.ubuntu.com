...
<title>Πώς βαθμονομώ τον σαρωτή μου;</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Πώς βαθμονομώ τον σαρωτή μου;</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Αν θέλετε ο σαρωτής σας να αναπαριστά το χρώμα με ακρίβεια στις σαρώσεις, θα πρέπει να τον βαθμονομήσετε.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Οι συσκευές σάρωσης είναι απίστευτα σταθερές με τον χρόνο και τη θερμοκρασία και δεν χρειάζονται συνήθως επαναβαθμονόμηση.</p></div></div></div>
</div>
</div>
