...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Jak můžu zkalibrovat svoji obrazovku?</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Vyberte svoji obrazovku.</p></li>
...
<p class="p">Obrazovky s podsvětlením pomocí LED se s postupem času také mění, ale ne tak rychle jako u světelných trubic.</p>
</div>
