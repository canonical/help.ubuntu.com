...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Test výkonnosti vašeho pevného disku</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Pokud je zaškrtnuto <span class="gui">Provést srovnávací test zápisu</span>, bude se testovat, jak rychle mohou být data přečtena z a zapsána na disk. Tento test trvá déle.</p></div></div></div>
</div>
</li>
</ol></div></div></div>
