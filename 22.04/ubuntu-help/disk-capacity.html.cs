...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Kontrola volného místa na disku</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Kolik vám na disku zbývá volného místa můžete zjistit pomocí <span class="app">Analyzátoru využití disku</span>, <span class="app">Sledování systému</span> nebo <span class="app">Využití</span>.</p></div>
<section id="disk-usage-analyzer"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Kontrola pomocí Analyzátoru využití disku</span></h2></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Kontrola pomocí Sledování systému</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Kontrola pomocí aplikace Využití</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Když chcete zjistit volné místo na disku a jeho kapacitu pomocí <span class="app">Využití</span>: </p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Z přehledu <span class="gui">Činnosti</span> otevřete aplikaci <span class="app">Využití</span>.</p></li>
<li class="steps"><p class="p">Vyberte kartu <span class="gui">Úložiště</span>, abyste viděli celkové <span class="gui">Použité</span> a <span class="gui">Dostupné</span> místo na disku, stejně jako použité <span class="gui">Operačním systémem</span> a běžnými uživatelskými složkami.</p></li>
</ol></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Místo je možné uvolnit v uživatelských složkách a podsložkách zaškrtnutím políčka vedle názvu složky.</p></div></div></div>
</div>
</div></div>
</div></section><section id="disk-full"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Co dělat, když je disk plný?</span></h2></div>
<div class="region"><div class="contents pagewide">
