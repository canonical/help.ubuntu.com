...
<p class="p">K běžným místům se můžete rychle dostat z <span class="em">postranní lišty</span>. Pokud ji nevidíte, zmáčkněte tlačítko nabídky v pravém horním rohu okna a vyberte <span class="gui">Postranní panel</span>. Můžete si také <span class="link"><a href="nautilus-bookmarks-edit.html.cs" title="Úprava záložky pro složku">přidat záložky pro složky, které často používáte</a></span>, a ty se rovněž objeví v postranním panelu.</p>
</div></div>
