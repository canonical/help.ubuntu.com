...
<div class="region">
<div class="contents pagewide"><p class="p">Soubory můžete na prázdný disk dostat pomocí vypalovací aplikace, jako je <span class="app">Brasero</span>.</p></div>
...
<p class="p">V takovém případě zkuste data vypálit znovu, ale použijte nižší rychlost vypalování. Například 12× místo 48×. Vypalování nižší rychlostí je spolehlivější.</p>
</div></div>
