...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Co je klávesa <span class="key"><kbd>Super</kbd></span>?</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Používáte-li klávesnici Apple, máte místo klávesy Windows klávesu <span class="key"><kbd>⌘</kbd></span> (Command), zatímco Chromebook místo ní má klávesu s lupou.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Vyberte kategorii <span class="gui">Systém</span>.</p></li>
<li class="steps"><p class="p">Klikněte na řádek <span class="gui">Zobrazit přehled činností</span>.</p></li>
