...
<a href="tips-specialchars.html.ru" title="Ввод специальных символов">Ввод специальных символов</a><span class="desc"> — Type characters not found on your keyboard, including foreign alphabets, mathematical symbols, emoji, and dingbats.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
