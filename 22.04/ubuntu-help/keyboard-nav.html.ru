...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Если вы не можете использовать указательное устройство типа мыши, можно управлять указателем мыши с помощью клавиш цифрового блока клавиатуры. Подробнее смотрите: <span class="link"><a href="mouse-mousekeys.html.ru" title="Click and move the mouse pointer using the keypad">Click and move the mouse pointer using the keypad</a></span>.</p></div></div></div>
</div>
...
<p class="p"><span class="key"><a href="keyboard-key-menu.html.ru" title="Что такое клавиша Меню?"><kbd>Menu</kbd></a></span></p>
</td>
...
<p class="p"><span class="key"><a href="keyboard-key-super.html.ru" title="Что такое клавиша Super?"><kbd>Super</kbd></a></span> key
    </p>
</td>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-notifications.html.ru#notificationlist" title="The notification list">Open the
