...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Nastavení opakování zmáčknutých kláves</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">V části <span class="gui">Psaní</span> zmáčkněte <span class="gui">Opakování kláves</span>.</p></li>
<li class="steps">
<p class="p">Přepněte vypínač <span class="gui">Opakování kláves</span> do polohy vypnuto.</p>
<p class="p">Případně můžete táhlem <span class="gui">Zpoždění</span> upravit, jak dlouho je třeba klávesu držet zmáčknutou, aby s opakováním začala, a táhlem <span class="gui">Rychlost</span>, jak rychle má zmáčknutí klávesy opakovat.</p>
</li>
</ol></div></div></div>
</div>
