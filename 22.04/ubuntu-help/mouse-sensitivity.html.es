...
<title>Ajustar la velocidad del ratón y del panel táctil</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Ajustar la velocidad del ratón y del panel táctil</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Si el puntero se mueve demasiado deprisa o despacio cuando mueve el ratón o usa el panel táctil puede ajustar la velocidad del puntero para estos dispositivos.</p>
...
<li class="steps"><p class="p">Ajuste el control deslizante de la <span class="gui">Velocidad del puntero del panel táctil</span> hasta que el movimiento del puntero le sea cómodo. A veces, el ajuste mas confortable para un tipo de dispositivo no es el mejor para otro.</p></li>
</ol></div></div></div>
<div class="note" title="Nota">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">La sección <span class="gui">Panel táctil</span> sólo aparece si su equipo tiene un panel táctil, mientras que la sección <span class="gui">Ratón</span> sólo es visible cuando hay un ratón conectado.</p></div></div></div>
</div>
</div>
