...
<p class="p">Oprávnění můžete nastavit i pro ostatní uživatele, než je vlastník a uživatelé ve skupině.</p>
<p class="p">Jestliže je soubor spustitelným programem, například se jedná o skript, musíte vybrat <span class="gui">Povolit spuštění souboru jako programu</span>, aby šel spustit. I se zapnutou touto volbou může správce souborů soubor otevřít v aplikaci. Podívejte se na <span class="link"><a href="nautilus-behavior.html.cs#executable" title="Spustitelné textové soubory">Spustitelné textové soubory</a></span>, kde se dočtete proč.</p>
</div></div>
