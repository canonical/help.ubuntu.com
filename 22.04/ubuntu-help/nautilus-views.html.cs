...
<title>Předvolby zobrazení v Souborech</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Předvolby zobrazení v <span class="app">Souborech</span></span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Můžete změnit, jak se mají ve výchozím stavu soubory a složky seskupovat a řadit. Zmáčkněte tlačítko nabídky v pravém horním rohu okna, zvolte <span class="gui">Předvolby</span> a pak vyberte kartu <span class="gui">Zobrazení</span>.</p></div>
<section id="default-view"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Výchozí zobrazení</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="terms"><div class="inner"><div class="region"><dl class="terms">
<dt class="terms"><span class="gui">Řadit položky</span></dt>
<dd class="terms"><p class="p">Můžete změnit, jak se mají <span class="link"><a href="files-sort.html.cs" title="Řazení souborů a složek">soubory řadit</a></span> v jednotlivých složkách. Kliknete na tlačítko nabídky voleb zobrazení na nástrojové liště a vyberte požadovanou volbu v <span class="gui">Řadit podle</span>, nebo klikněte v seznamovém zobrazení na záhlaví příslušného sloupce.</p></dd>
