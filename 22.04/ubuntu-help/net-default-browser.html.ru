...
<span style="color: #333">Ubuntu 22.04</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="net.html.ru" title="Networking, web &amp; email">Networking</a> » <a class="trail" href="net-browser.html.ru" title="Web browsers">Web browsers</a> » </div></div>
...
<a href="net-browser.html.ru" title="Web browsers">Web browsers</a><span class="desc"> — Change your default web browser.</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
