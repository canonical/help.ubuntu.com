...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Ostatní uživatelé se nemohou připojit k Internetu</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Když nastavíte síťové připojení, měli by všichni uživatelé počítače normálně mít možnost jej používat. Pokud informace o připojení nejsou sdílené, měli byste zkontrolovat nastavení připojení.</p>
...
<p class="p">Ostatní uživatelé tohoto počítače budou nyní moci používat toto připojení, aniž by museli zadávat nějaké údaje.</p>
<div class="note" title="Upozornění">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Kterýkoliv uživatel může toto nastavení změnit.</p></div></div></div>
</div>
</div>
