...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Verbinding maken met een draadloos netwerk</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Als de verbinding geslaagd is, dan zal het pictogram in een punt met een paar balkjes erboven (<span class="media"><span class="media media-image"><img src="figures/topbar-network-wireless-strength-excellent.svg" height="28" width="28" class="media media-inline" alt=""></span></span>) veranderen. Hoe meer balkjes er zijn, hoe beter de verbinding met het netwerk. Als er niet veel balkjes zijn, dan is de verbinding zwak en mogelijk niet erg betrouwbaar.</p></li>
</ol></div></div></div>
...
<div class="region"><ul>
<li class="links ">
<a href="net-wrongnetwork.html.nl" title="My computer connects to the wrong network">My computer connects to the wrong network</a><span class="desc"> — Edit your connection settings, and remove the unwanted connection
    option.</span>
</li>
<li class="links ">
