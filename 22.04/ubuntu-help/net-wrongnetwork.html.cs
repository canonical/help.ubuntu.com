...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Můj počítač se připojuje k nesprávné síti</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Když zapnete počítač, pokusí se automaticky připojit k bezdrátovým sítím, ke kterým jste se již připojili někdy v minulosti. Pokud se tak připojuje k síti, ke které si připojovat nechcete, použije postup uvedený dále.</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Když chcete zapomenout některá bezdrátové připojení:</span></h2></div>
...
<p class="p">Jestli se později budete chtít do sítě, kterou jste nechali zapomenout, znovu připojit, postupujte podle kroků v <span class="link"><a href="net-wireless-connect.html.cs" title="Připojení k bezdrátové síti">Připojení k bezdrátové síti</a></span>.</p>
</div>
