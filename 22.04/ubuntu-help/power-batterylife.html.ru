...
<li class="list"><p class="p">Use the <span class="gui">Power</span> panel in <span class="app">Settings</span> to change your
    ...
    after a certain time, enable the <span class="gui">Automatic <span class="link"><a href="power-profile.html.ru" title="Choose a power profile">Power
...
<li class="list"><p class="p">Reduce the <span class="link"><a href="display-brightness.html.ru" title="Set screen brightness">screen brightness</a></span>.</p></li>
...
<li class="list">
<p class="p">If you do not need an Internet connection for a little while, <span class="link"><a href="power-wireless.html.ru" title="Switch off unused wireless technologies">turn off
