...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Por qué mi portátil se vuelve más lento cuando funciona con la batería?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Algunos equipos portátiles, intencionadamente, se ralentizan cuando están trabajando con la batería para ahorrar energía. El procesador del equipo portátil (CPU) cambia a una velocidad más lenta, y los procesadores consumen menos energía cuando se funcionan más lentamente, por lo que la batería debe durar más tiempo.</p>
<p class="p">Esta característica se llama <span class="em">escalado de frecuencia de la CPU</span>.</p>
</div>
