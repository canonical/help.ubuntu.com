...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Proč se můj počítač vypne, když zavřu víko?</span></h1></div>
<div class="region">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Zabránění počítači v uspání při zavření víka</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Tyto rady jsou platné, jen když používáte <span class="app">systemd</span>. Více informací získáte u autorů své distribuce.</p></div></div></div>
</div>
<div class="note note-important" title="Důležité">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m12.5 2a9.5 9.5 0 0 0-9.5 9.5 9.5 9.5 0 0 0 9.5 9.5 9.5 9.5 0 0 0 9.5-9.5 9.5 9.5 0 0 0-9.5-9.5zm0 3a1.5 1.5 0 0 1 1.5 1.5v6a1.5 1.5 0 0 1-1.5 1.5 1.5 1.5 0 0 1-1.5-1.5v-6a1.5 1.5 0 0 1 1.5-1.5zm0 10.5a1.5 1.5 0 0 1 1.5 1.5 1.5 1.5 0 0 1-1.5 1.5 1.5 1.5 0 0 1-1.5-1.5 1.5 1.5 0 0 1 1.5-1.5z"></path>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Při změně tohoto nastavení buďte obezřetní. Některé notebooky se mohou přehřívat, když zůstanou běžet se zavřeným víkem, hlavně když jsou v uzavřeném prostoru, třeba v batohu.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Vyberte kartu <span class="gui">Obecné</span>.</p></li>
<li class="steps"><p class="p">Přepněte vypínač <span class="gui">Při zavření víka uspat do paměti</span> do polohy zapnuto.</p></li>
