...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Po probuzení počítače nemám žádnou bezdrátovou síť</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Přepněte vypínač <span class="gui">Wi-Fi</span> v pravé horní části okna do polohy vypnuto a pak znovu do polohy zapnuto.</p></li>
<li class="steps"><p class="p">Jestliže bezdrátové funkce stále nefungují, přepněte vypínač <span class="gui">Režim „letadlo“</span> do polohy zapnuto a pak opět do polohy vypnuto.</p></li>
</ol></div></div></div>
<p class="p">Pokud to nepomůže, může bezdrátové funkce rozchodit restartování počítače. Pokud i po té máte nadále problémy, připojte se k Internetu pomocí kabelu a počítač aktualizujte.</p>
</div>
