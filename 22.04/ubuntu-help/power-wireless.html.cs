...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Vypnutí nepoužívaných bezdrátových technologií</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Spotřebu z baterie můžete snížit vypnutím Bluetooth, Wi-Fi nebo mobilního širokopásmového připojení v době, kdy je nevyužíváte.</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Otevřete přehled <span class="gui"><a href="shell-introduction.html.cs#activities" title="Přehled Činností">Činnosti</a></span> a začněte psát <span class="gui">Wi-Fi</span>, respektive <span class="gui">Bluetooth</span>.</p></li>
<li class="steps"><p class="p">Kliknutím na <span class="gui">Wi-Fi</span>, respektive <span class="gui">Bluetooth</span>, otevřete příslušný panel.</p></li>
<li class="steps"><p class="p">Nepoužívané věci vypněte v záhlavní liště. Když je budete později potřebovat, znovu je můžete zapnout.</p></li>
</ol></div></div></div>
</div>
