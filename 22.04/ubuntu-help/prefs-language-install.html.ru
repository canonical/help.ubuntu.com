...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Установка языков</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Некоторые переводы могут оказаться неполными, а отдельные приложения могут совсем не поддерживать ваш язык.</p></div></div></div>
</div>
</div>
