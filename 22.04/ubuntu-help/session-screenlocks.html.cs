...
<title>Obrazovka se sama zamkne po příliš krátké době</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Obrazovka se sama zamkne po příliš krátké době</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Pokud je <span class="gui">Automatické zamknutí obrazovky</span> zapnuté, můžete měnit hodnotu v rozbalovacím seznamu <span class="gui">Prodleva automatického uzamknutí obrazovky</span>.</p></li>
</ol></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Jestli chcete, aby se obrazovka sama automaticky nezamykala vůbec, přepněte vypínač <span class="gui">Automatické zamykání obrazovky</span> do polohy vypnuto.</p></div></div></div>
</div>
</div>
