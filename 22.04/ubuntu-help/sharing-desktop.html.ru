...
<li class="steps"><p class="p">Open the <span class="gui"><a href="shell-introduction.html.ru#activities" title="Режим обзора">Activities</a></span> 
      overview and start typing <span class="gui">Sharing</span>.</p></li>
...
<p class="p">The <span class="gui">How to Connect</span> section displays the
  ...
  <span class="link"><a href="net-findip.html.ru" title="Определение своего IP-адреса">IP address</a></span>.</p>
