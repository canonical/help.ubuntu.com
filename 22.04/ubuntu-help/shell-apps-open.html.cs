...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Spouštění aplikací</span></h1></div>
<div class="region">
...
<li class="list">
<p class="p">Některé aplikace mají svoji ikonu v <span class="em">Oblíbených</span>, což je vodorovný pruh ikon v dolní části přehledu <span class="gui">Činností</span>. Kliknutím na některou z ikon spustíte příslušnou aplikaci.</p>
...
<li class="list"><p class="p">Klikněte na tlačítko s mřížkou (devět malých čtverčků) v oblíbených. Uvidíte první stránku s nainstalovanými aplikacemi. K zobrazení dalších stránek s dalšími aplikacemi použijte čtverečky v dolní části nad oblíbenými. Zmáčknutím ikony příslušnou aplikaci spustíte.</p></li>
<li class="list">
<p class="p">Aplikaci můžete spustit na samostatné <span class="link"><a href="shell-workspaces.html.cs" title="Co je to pracovní plocha a co mi přinese?">pracovní ploše</a></span> tím, že přetáhnete její ikonu z oblíbených na jednu z pracovních ploch. Aplikace se pak otevře na této pracovní ploše.</p>
<p class="p">Aplikaci můžete spustit na <span class="em">nové</span> pracovní ploše tím, že přetáhnete její ikonu na prázdnou pracovních plochu nebo na malou mezeru mezi dvěma pracovními plochami.</p>
</li>
</ul></div></div></div>
