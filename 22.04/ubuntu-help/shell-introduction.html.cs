...
<title>Obrázkový přehled GNOME</title>
...
<li class="links "><a href="shell-introduction.html.cs#systemmenu" title="Nabídka systému">Nabídka systému</a></li>
<li class="links "><a href="shell-introduction.html.cs#lockscreen" title="Uzamknutá obrazovka">Uzamknutá obrazovka</a></li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Přehled <span class="gui">Činností</span></span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Po spuštění GNOME automaticky vstoupí do přehledu <span class="gui">Činností</span>. Ten poskytuje přístup k oknům a plikacím. Můžete v něm také začít psát a tím se začnou vyhledávat aplikace, soubory, složky a weby.</p>
<p class="p">Do přehledu se kdykoliv dostanete kliknutím na tlačítko <span class="gui">Činnosti</span> nebo prostým najetím ukazatelem myši do citlivého levého horního rohu. Případně můžete zmáčknout klávesu <span class="key"><a href="keyboard-key-super.html.cs" title="Co je klávesa Super?"><kbd>Super</kbd></a></span> na klávesnici.</p>
...
<p class="p">Kliknutím na tlačítko s mřížkou úplně dole v oblíbených si zobrazíte přehled aplikací. Ten obsahuje všechny aplikace nainstalované ve vašem počítači. Kliknutím na kteroukoliv z aplikací ji spustíte, případně můžete aplikaci přetáhnout na pracovní plochu zobrazenou nad nainstalovanými aplikacemi. Také ji můžete přetáhnout do oblíbených, kde zůstane, i když nebude spuštěná a získáte tak k ní rychlý přístup.</p>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Nabídka aplikace</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<p class="p">Nabídka aplikace nacházející se vedle tlačítka <span class="gui">Činnosti</span> zobrazuje název zaměřené aplikace spolu s její ikonou a poskytuje rychlý přístup k oknům aplikace a podrobnostem o aplikaci, spolu s položkou pro ukončení.</p>
</div></div>
</div></section><section id="clock"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Hodiny, kalendář a události</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<p class="p">Po kliknutí na hodiny na horní liště uvidíte aktuální datum, měsíční kalendář a seznam blížících se událostí a nová upozornění. Můžete také otevřít kalendář zmáčknutím <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>M</kbd></span></span>. Získáte přístup k nastavení data a času a k otevření aplikace s úplným kalendářem přímo z nabídky.</p>
<div class="list"><div class="inner"><div class="region"><ul class="list compact">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Nabídka systému</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Uzamknutá obrazovka</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Když zamknete svoji obrazovku, případně se zamkne automaticky, zobrazí se uzamknutá obrazovka. Mimo ochrany vašeho sezení po dobu, co jste od počítač pryč, zobrazuje datum a čas a také informace o stavu baterie a sítě.</p>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Seznam oken</span></h2></div>
<div class="region"><div class="contents pagewide">
