...
<p class="p">Aby se vám lépe pracovalo, můžete si okna přesouvat a měnit jejich velikost. Mimo běžného přetahování, které funguje jak se očekává, nabízí systém i klávesové zkratky a modifikátory, které dokáží uspořádávání oken urychlit.</p>
