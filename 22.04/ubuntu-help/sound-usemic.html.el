...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Χρήση διαφορετικού μικροφώνου</span></h1></div>
<div class="region">
...
<p class="p">Αν το μικρόφωνο σας έχει ένα κυκλικό βύσμα , απλά συνδέστε το στην κατάλληλη υποδοχή ήχου στον υπολογιστή σας. Οι περισσότεροι υπολογιστές έχουν δύο υποδοχές: μια για μικρόφωνα και μια για ηχεία. Αυτή η υποδοχή έχει συνήθως ένα απαλό κόκκινο χρώμα ή μια φωτογραφία ενός μικροφώνου. Τα μικρόφωνα που συνδέονται στην σωστή υποδοχή χρησιμοποιούνται από προεπιλογή. Αν όχι, δείτε τις οδηγίες παρακάτω για το πως να επιλέξετε μια προεπιλεγμένη συσκευή εισόδου.</p>
<p class="p">Εάν έχετε ένα μικρόφωνο USB, συνδέστε το σε οποιαδήποτε θύρα USB στον υπολογιστή σας. Τα μικρόφωνα USB δρουν ως ξεχωριστές συσκευές ήχου και μπορεί να πρέπει να καθορίσετε ποιο μικρόφωνο να χρησιμοποιήσετε από προεπιλογή.</p>
...
<p class="p">Μπορείτε να ρυθμίσετε την ένταση και να απενεργοποιήσετε το μικρόφωνο από αυτόν τον πίνακα.</p>
</div>
