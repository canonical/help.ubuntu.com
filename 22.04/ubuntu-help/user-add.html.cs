...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Přidání nového uživatelského účtu</span></h1></div>
<div class="region">
...
<li class="steps">
<p class="p">Heslo novému uživateli můžete nastavit, nebo ponechat na něm, ať si jej nastaví při prvním přihlášení.</p>
<p class="p">Když zvolíte, že chcete nastavit heslo teď, můžete zmáčknout ikonu <span class="gui"><span class="media"><span class="media media-image"><img src="figures/system-run-symbolic.svg" height="16" width="16" class="media media-inline" alt="generovat heslo"></span></span></span>, aby se vám automaticky vygenerovalo náhodné heslo.</p>
</li>
<li class="steps"><p class="p">Klikněte na <span class="gui">Přidat</span>.</p></li>
</ol></div></div></div>
<p class="p">Když chcete změnit heslo po té, co byl účet vytvořen, vyberte účet, <span class="gui">Odekmkněte</span> panel a zmáčkněte aktuální heslo.</p>
<div class="note" title="Upozornění">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">V panelu <span class="gui">Uživatelé</span> můžete kliknout na obrázek vpravo vedle jména uživatele a nastavit účtu jiný obrázek. Ten se pak bude zobrazovat v přihlašovacím okně. Systém poskytuje základní výběr obrázků, které můžete přímo použít nebo si můžete vybrat nějaký vlastní nebo si pořídit svoji fotografii pomocí webové kamery.</p></div></div></div>
</div>
</div>
