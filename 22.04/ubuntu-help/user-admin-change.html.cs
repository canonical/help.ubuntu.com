...
<span style="color: #333">Ubuntu 22.04</span> » <a class="trail" href="index.html.cs" title="Průvodce pracovním prostředím Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Nápověda"></span></span> Průvodce pracovním prostředím Ubuntu</a> » <a class="trail" href="prefs.html.cs" title="Uživatelská a systémová nastavení">Nastavení</a> » <a class="trail" href="user-accounts.html.cs" title="Uživatelské účty">Uživatelé</a> › <a class="trail" href="user-accounts.html.cs#privileges" title="Uživatelská oprávnění">Oprávnění</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Změna osob s oprávněním správce</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Klikněte na <span class="gui">Standardní</span> vedle <span class="gui">Typ účtu</span> a vyberte <span class="gui">Správce</span>.</p></li>
<li class="steps"><p class="p">Nová oprávnění uživatele se použijí, až se příště přihlásí.</p></li>
</ol></div></div></div>
...
<p class="p">První uživatelský účet v systému je obvykle ten, který má oprávnění správce. Jedná se o uživatelský účet, který byl vytvořen při instalaci systému.</p>
<p class="p">Není rozumné mít v jednom systému příliš uživatelů s oprávněními <span class="gui">Správce</span>.</p>
</div></div></div>
</div>
</div>
