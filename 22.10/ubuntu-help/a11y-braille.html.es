...
<p class="p">El lector de pantalla <span class="app">Orca</span> puede mostrar la interfaz de usuario en dispositivos Braille actualizables. Dependiendo de cómo haya instalado su sistema, puede no tener Orca instalado. Si no lo tiene, instale primero Orca.</p>
