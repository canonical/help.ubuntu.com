...
<span style="color: #333">Ubuntu 22.10</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός χρήσης Ubuntu</a> » <a class="trail" href="a11y.html.el" title="Accessibility">Accessibility</a> » </div></div>
...
<a href="a11y.html.el" title="Accessibility">Accessibility</a><span class="desc"> — Use assistive technologies to help with special needs for
