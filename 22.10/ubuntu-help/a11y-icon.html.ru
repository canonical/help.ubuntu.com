...
<title>Найдите меню специальных возможностей</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Найдите меню специальных возможностей</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p"><span class="em">Меню специальных возможностей</span> позволяет включать и отключать различные параметры специальных возможностей. Чтобы открыть это меню, нажмите на значок в виде круга с силуэтом человечка внутри, находящийся в верхней панели.</p>
...
<li class="steps"><p class="p">Переведите переключатель параметра <span class="gui">Всегда показывать меню специальных возможностей</span> во включённое положение.</p></li>
</ol></div></div></div>
