...
<li class="steps"><p class="p">Измените переключатель <span class="gui">«Медленные клавиши»</span> в положение «включено».</p></li>
</ol></div></div></div>
...
<div class="title title-note"><h2><span class="title">Быстрое включение и отключение «медленных клавиш»</span></h2></div>
<div class="region"><div class="contents">
<p class="p">Измените положение переключателя <span class="gui">Управляется с клавиатуры</span>, чтобы включить или выключить «медленные» клавиши с клавиатуры. Если этот параметр включён, то, нажав и удерживая клавишу <span class="key"><kbd>Shift</kbd></span> в течение восьми секунд, можно включать и отключать «медленные» клавиши.</p>
<p class="p">Для включения или отключения «медленных клавиш» можно также нажать на <span class="link"><a href="a11y-icon.html.ru" title="Найдите меню специальных возможностей">значок специальных возможностей</a></span> в верхней панели и выбрать <span class="gui">«Медленные» клавиши</span>. Значок специальных возможностей становится виден на панели, если один или более параметров были включены в разделе <span class="gui">Специальные возможности</span>.</p>
</div></div>
</div>
</div>
<p class="p">Используйте ползунок <span class="gui">Задержка принятия</span> для настройки времени, в течение которого нужно удерживать клавишу для регистрации её нажатия. Более подробную информацию смотрите в <span class="link"><a href="a11y-bouncekeys.html.ru" title="Включение «отскакивающих клавиш»">Включение «отскакивающих клавиш»</a></span>.</p>
