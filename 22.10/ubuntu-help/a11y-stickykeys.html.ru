...
<li class="steps"><p class="p">Переместите переключатель <span class="gui">Залипающие клавиши</span> в положение «включено».</p></li>
</ol></div></div></div>
...
<p class="p">Измените положение переключателя <span class="gui">Управляется с клавиатуры</span>, чтобы включить или выключить залипание клавиш на клавиатуре. Если этот параметр включен, то вы можете нажать <span class="key"><kbd>Shift</kbd></span> пять раз подряд, чтобы включить или отключить залипание клавиш.</p>
<p class="p">Чтобы включить или отключить залипающие клавиши, можно также нажать на <span class="link"><a href="a11y-icon.html.ru" title="Найдите меню специальных возможностей">значок специальных возможностей</a></span> в верхней панели и выбрать <span class="gui">Залипающие клавиши</span>. Значок специальных возможностей становится виден в том случае, если один или более параметров были включены в разделе <span class="gui">Специальные возможности</span>.</p>
</div></div>
</div>
</div>
