...
<p class="p">Система включает в себя вспомогательные технологии для поддержки пользователей с различными физическими ограничениями и особенностями развития, а также для взаимодействия со вспомогательными устройствами. Меню специальных возможностей можно добавить в верхнюю панель, что даст простой доступ ко многим из этих вспомогательных функций.</p>
<div class="links topiclinks"><div class="inner"><div class="region"><div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="a11y-icon.html.ru" title="Найдите меню специальных возможностей"><span class="title">Найдите меню специальных возможностей</span><span class="linkdiv-dash"> — </span><span class="desc">Меню специальных возможностей — это значок в верхней панели в виде человечка.</span></a></div></div></div></div></div>
</div>
...
<li class="links ">
<a href="keyboard-cursor-blink.html.ru" title="Сделать клавиатурный курсор мигающим">Сделать клавиатурный курсор мигающим</a><span class="desc"> — Сделайте курсор мигающим и измените скорость его мигания.</span>
</li>
<li class="links ">
...
<div class="region"><ul>
<li class="links ">
<a href="mouse-sensitivity.html.ru" title="Настройка скорости мыши и сенсорной панели">Настройка скорости мыши и сенсорной панели</a><span class="desc"> — Изменение скорости перемещения указателя для мыши или сенсорной панели.</span>
</li>
<li class="links ">
<a href="mouse-mousekeys.html.ru" title="Управление нажатиями и перемещением указателя мыши с помощью клавиатуры">Управление нажатиями и перемещением указателя мыши с помощью клавиатуры</a><span class="desc"> — Включите «Кнопки мыши», чтобы управлять курсором с клавиатуры.</span>
</li>
</ul></div>
</div></div>
<div class="links topiclinks"><div class="inner">
...
<li class="links ">
<a href="keyboard-osk.html.ru" title="Использование экранной клавиатуры">Использование экранной клавиатуры</a><span class="desc"> — Используйте экранную клавиатуру для ввода текста нажатиями мыши или с помощью сенсорного экрана.</span>
</li>
<li class="links ">
<a href="keyboard-repeat-keys.html.ru" title="Управление повторными нажатиями клавиш">Управление повторными нажатиями клавиш</a><span class="desc"> — Сделайте так, чтобы клавиатура не повторяла буквы при удержании клавиши, или измените задержку и скорость повторного нажатия.</span>
</li>
<li class="links ">
