...
<div class="linkdiv "><a class="linkdiv" href="backup-how.html.el" title="Πώς να δημιουργήσετε αντίγραφα ασφαλείας"><span class="title">Πώς να δημιουργήσετε αντίγραφα ασφαλείας</span><span class="linkdiv-dash"> — </span><span class="desc">Use Déjà Dup (or another backup application) to make copies of
    your valuable files and settings to protect against loss.</span></a></div>
</div>
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="backup-what.html.el" title="Τι να αντιγράψετε στο αντίγραφο ασφαλείας"><span class="title">Τι να αντιγράψετε στο αντίγραφο ασφαλείας</span><span class="linkdiv-dash"> — </span><span class="desc">Δημιουργήστε αντίγραφα ασφαλείας όλων όσων δεν μπορείτε να αντέξετε να τα χάσετε εάν κάτι πάει στραβά.</span></a></div></div>
</div></div></div></div>
</div>
