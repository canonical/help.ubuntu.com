...
<span class="link"><a href="bluetooth-send-file.html.el" title="Αποστολή αρχείων σε μια συσκευή Bluetooth">send files between devices</a></span>, such as
...
<div class="linkdiv "><a class="linkdiv" href="bluetooth-device-specific-pairing.html.el" title="Pairing instructions for specific devices"><span class="title">Pairing instructions for specific devices</span><span class="linkdiv-dash"> — </span><span class="desc">How to pair specific devices with your computer.</span></a></div>
...
<div class="region">
<div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="bluetooth-problem-connecting.html.el" title="Δεν μπορώ να συνδέσω τη συσκευή Bluetooth"><span class="title">Δεν μπορώ να συνδέσω τη συσκευή Bluetooth</span><span class="linkdiv-dash"> — </span><span class="desc">Ο προσαρμογέας μπορεί να είναι ανενεργός ή μπορεί να μην έχει οδηγούς, ή το Bluetooth μπορεί να είναι ανενεργό ή φραγμένο.</span></a></div></div></div></div></div></div>
