...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Πως ελέγχω αν η διαχείριση χρώματος λειτουργεί σωστά;</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Πατήστε <span class="gui">Προσθήκη</span> για να επιβεβαιώσετε την επιλογή σας.</p></li>
<li class="steps"><p class="p">Για να επαναφέρετε το προηγούμενο προφίλ σας, επιλέξτε τη συσκευή στον πίνακα <span class="gui">Χρώμα</span>, έπειτα επιλέξτε το προφίλ που χρησιμοποιούσατε πριν να δοκιμάσετε ένα από τα προφίλ δοκιμής και πατήστε <span class="gui">Ενεργοποίηση</span> για να το ξαναχρησιμοποιήσετε.</p></li>
</ol></div></div></div>
<p class="p">Χρησιμοποιώντας αυτά τα προφίλ, μπορείτε να δείτε καθαρά πότε μια εφαρμογή υποστηρίζει διαχείριση χρώματος.</p>
</div>
