...
<div class="trail">
<span style="color: #333">Ubuntu 22.10</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="prefs.html.ru" title="Параметры пользователя и системы">Параметры</a> » <a class="trail" href="color.html.ru" title="Управление цветом">Цвет</a> › <a class="trail" href="color.html.ru#profiles" title="Цветовые профили">Цветовые профили</a> » </div>
</div>
...
<p class="p">Но, если ProPhoto — наилучшая программа, то почему же мы не используем её всегда? Причина в <span class="em">дискретизации</span>. Если у нас имеется только 8 битов (256 уровней) для кодирования каждого канала, то для большего диапазона потребуется, соответственно, и больший шаг между каждым значением.</p>
