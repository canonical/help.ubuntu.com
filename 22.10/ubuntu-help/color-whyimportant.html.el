...
<div class="trail">
<span style="color: #333">Ubuntu 22.10</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός χρήσης Ubuntu</a> » <a class="trail" href="prefs.html.el" title="Χρήστης &amp; ρυθμίσεις συστήματος">Ρυθμίσεις</a> » <a class="trail" href="color.html.el" title="Διαχείριση χρωμάτων">Color</a> » </div>
<div class="trail">
<span style="color: #333">Ubuntu 22.10</span> » <a class="trail" href="index.html.el" title="Οδηγός χρήσης Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Βοήθεια"></span></span> Οδηγός χρήσης Ubuntu</a> » <a class="trail" href="hardware.html.el" title="Υλικό &amp; οδηγοί">Υλικό</a> » <a class="trail" href="color.html.el" title="Διαχείριση χρωμάτων">Color</a> » </div>
</div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Γιατί είναι σημαντική η διαχείριση του χρώματος;</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Η διαχείριση χρώματος είναι η διαδικασία λήψης ενός χρώματος χρησιμοποιώντας μια συσκευή εισόδου, η εμφάνιση της σε μια οθόνη και η εκτύπωσή της ενώ διαχειρίζεστε τα ακριβή χρώματα και την περιοχή των χρωμάτων σε κάθε μέσο.</p>
<p class="p">Η ανάγκη για χρωματική διαχείριση εξηγείται προφανώς άριστα με μια φωτογραφία ενός πουλιού σε πια παγωμένη ημέρα του χειμώνα.</p>
...
<div class="desc">Ένα πουλί σε έναν παγωμένο τοίχο όπως φαίνεται στην κάμερα εύρεσης προβολής</div>
</div>
</div></div>
<p class="p">Εμφανίζει τυπικά υπερκορεσμένο το γαλάζιο κανάλι, κάνοντας τις εικόνες να δείχνουν κρύες.</p>
<div class="figure"><div class="inner">
<a href="#" class="figure-zoom" data-zoom-in-title="Προβολή εικόνων στο κανονικό μέγεθος" data-zoom-out-title="Σμίκρυνση εικόνων"><svg width="10" height="10" class="figure-zoom-in"><rect x="0.5" y="0.5" width="9" height="9" class="yelp-svg-stroke" stroke-width="1" fill="none"></rect><rect x="0" y="5" width="5" height="5" class="yelp-svg-fill"></rect></svg><svg width="10" height="10" class="figure-zoom-out"><rect x="0.5" y="0.5" width="9" height="9" class="yelp-svg-stroke" stroke-width="1" fill="none"></rect><polygon points="0,0 10,0 10,10 5,10 5,5 10,5 0,5" class="yelp-svg-fill"></polygon></svg></a><div class="region">
...
<div class="desc">Αυτό βλέπει ο χρήστης όταν τυπώσει σε έναν τυπικό εκτυπωτή ψεκασμού</div>
</div>
</div></div>
