...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Δοκιμάστε την απόδοση του σκληρού σας δίσκου</span></h1></div>
<div class="region">
...
<p class="p">Click <span class="gui">Start Benchmarking…</span> to test how fast data can be read
      from the disk. <span class="link"><a href="user-admin-explain.html.el" title="Πώς δουλεύουν τα δικαιώματα διαχειριστή;">Administrative
