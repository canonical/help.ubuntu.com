...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Тестирование производительности жёсткого диска</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Чтобы проверить скорость жёсткого диска:</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">В окне <span class="gui"><a href="shell-introduction.html.ru#activities" title="Режим обзора">Обзор</a></span> откройте приложение <span class="app">Диски</span>.</p></li>
<li class="steps"><p class="p">Выберите диск из списка в панели слева.</p></li>
<li class="steps"><p class="p">Нажмите кнопку с шестерёнкой и выберите <span class="gui">Оценить производительность…</span>.</p></li>
<li class="steps"><p class="p">Нажмите <span class="gui">Оценить производительности…</span> и настройте параметры <span class="gui">Скорость передачи</span> и <span class="gui">Время доступа</span> по своему желанию.</p></li>
<li class="steps">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Если отмечена опция <span class="gui">Выполнить тест записи</span>, то будет проведён тест на скорость записи на диск. Для проведения этого теста требуется довольно много времени.</p></div></div></div>
</div>
</li>
</ol></div></div></div>
