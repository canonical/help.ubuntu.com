...
<p class="p">Чтобы скрыть файл, <span class="link"><a href="files-rename.html.ru" title="Переименование файла или папки">переименуйте его</a></span>, добавив <span class="file">.</span> в начале его имени. Например, чтобы скрыть файл <span class="file">example.txt</span>, следует переименовать его в <span class="file">.example.txt</span>.</p>
<div class="note" title="Примечание">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Скрыть папки можно таким же способом. Переименуйте папку, добавив символ <span class="file">.</span> в начало её имени.</p></div></div></div>
</div>
</div>
...
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Большинство скрытых файлов содержат символ <span class="file">.</span> в начале имени, но некоторые вместо этого содержат <span class="file">~</span> в конце имени. Это файлы резервных копий. Подробнее об этом смотрите <span class="link"><a href="files-tilde.html.ru" title="Что это за файлы с символом ~ в конце имени?">Что это за файлы с символом <span class="file">~</span> в конце имени?</a></span>.</p></div></div></div>
</div>
</div></div>
