...
<div class="trail">
<span style="color: #333">Ubuntu 22.10</span> » <a class="trail" href="index.html.sl" title="Namizni vodnik Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Pomoč"></span></span> Vodič po namizju Ubuntu</a> » <a class="trail" href="a11y.html.sl" title="Accessibility">Accessibility</a> › <a class="trail" href="a11y.html.sl#mobility" title="Težave z gibanjem">Težave z gibanjem</a> » </div>
</div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Krmarjenje s tipkami</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">V primeru da imate težave z uporabo miške ali druge kazalne naprave, lahko miškin kazalec nadzirate s številsko  tipkovnico. Za podrobnosti si oglejte <span class="link"><a href="mouse-mousekeys.html.sl" title="Click and move the mouse pointer using the keypad">Click and move the mouse pointer using the keypad</a></span>.</p></div></div></div>
</div>
...
<p class="p">V seznamskem ali ikonskem pogledu izberite vse predmete iz trenutno izbranega predmeta na predmet, ki je na novo v žarišču.</p>
...
<p class="p"><span class="key"><a href="keyboard-key-menu.html.sl" title="What is the Menu key?"><kbd>Menu</kbd></a></span></p>
</td>
...
<p class="p"><span class="key"><a href="keyboard-key-super.html.sl" title="What is the Super key?"><kbd>Super</kbd></a></span> key
    </p>
</td>
...
<td style="border-top-style: solid;"><p class="p">Dajte žarišče tipkovnice na vrhnjo vrstico. V pregledu <span class="gui">Dejavnosti</span> preklopite žarišče tipkovnice med vrhnjo vrstico, pregledno ploščo, pregledom oken, seznamom programov in iskalnim poljem. Za krmarjenje uporabite tipke s puščicami.</p></td>
</tr>
<tr>
<td style="border-top-style: solid;">
...
<td style="border-top-style: solid;"><p class="p">Kroži med okni istega programa. Držite tipko <span class="key"><kbd>Alt</kbd></span> in pritisnite <span class="key"><kbd>F6</kbd></span> dokler ni želeno okno poudarjeno. Nato izpustite <span class="key"><kbd>Alt</kbd></span>. To je podobno zmožnosti <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>`</kbd></span></span>.</p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>Esc</kbd></span></span></p></td>
<td style="border-top-style: solid;"><p class="p">Kroži med vsemi odprtimi okni na delovni površini.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-notifications.html.sl#notificationlist" title="The notification list">Open the
...
<td style="border-top-style: solid;"><p class="p">Skrči okno.</p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>←</kbd></span></span></p></td>
