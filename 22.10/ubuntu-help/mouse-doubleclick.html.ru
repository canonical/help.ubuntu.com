...
<li class="steps"><p class="p">В разделе <span class="gui">Наведение и нажатие</span> настройте бегунок <span class="gui">Двойного нажатия</span> на удобное для вас значение.</p></li>
</ol></div></div></div>
