...
<title>Нажатие средней кнопки мыши</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Нажатие средней кнопки мыши</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">В приложениях с полосами прокрутки щелчок левой кнопкой мыши в пустом месте полосы перемещает позицию прокрутки прямо в это место. Щелчок средней кнопкой перемещает вверх на одну страницу относительно исходного положения.</p></li>
<li class="list"><p class="p">Быстро открыть новое окно приложения из режима <span class="gui">Обзора</span> можно, нажав среднюю кнопку мыши. Просто нажмите средней кнопкой на значок приложения в панели задач, расположенной слева, или в обзоре приложений. Обзор приложений можно открыть, нажав на кнопку с изображением сетки внизу панели задач.</p></li>
<li class="list"><p class="p">Большинство веб-браузеров позволяют быстро открывать ссылки во вкладках средней кнопкой мыши. Просто щёлкните любую ссылку средней кнопкой мыши, и она откроется в новой вкладке.</p></li>
