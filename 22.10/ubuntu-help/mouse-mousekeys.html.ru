...
<li class="steps"><p class="p">С помощью клавиш со стрелками выберите <span class="gui">Кнопки мыши</span> во вкладке <span class="gui">Наведение и нажатие</span>, затем нажмите <span class="key"><kbd>Enter</kbd></span>, чтобы включить переключатель пункта <span class="gui">Кнопки мыши</span>.</p></li>
