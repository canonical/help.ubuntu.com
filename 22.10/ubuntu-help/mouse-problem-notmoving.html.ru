...
<li class="list"><p class="p">Убедитесь, что мышь включена. Часто снизу мыши имеется переключатель, позволяющий полностью отключить мышь, чтобы её можно было взять с собой, не держать постоянно включённой.</p></li>
