...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Настройка скорости мыши и сенсорной панели</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Отрегулируйте ползунок <span class="gui">Скорость указателя мыши</span> или <span class="gui">Скорость указателя сенсорной панели</span>, пока движение указателя не станет для вас удобным. Иногда самые удобные настройки для одного типа устройств не подходят для другого.</p></li>
</ol></div></div></div>
<div class="note" title="Примечание">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Раздел <span class="gui">Сенсорная панель</span> появится только если в вашей системе есть сенсорная панель. Раздел <span class="gui">Мышь</span> виден, только если ваша мышь подключена.</p></div></div></div>
</div>
</div>
