...
<div class="region">
<div class="contents pagewide"><p class="p">Γνωρίζοντας τη διεύθυνση IP σας μπορεί να σας βοηθήσει να ανιχνεύσετε προβλήματα με την σύνδεσή σας στο διαδίκτυο. Μπορεί να εκπλαγείτε μαθαίνοντας ότι έχετε <span class="em">δύο</span> διευθύνσεις IP: μια διεύθυνση IP για τον υπολογιστή σας στο εσωτερικό δίκτυο και μια διεύθυνση IP για τον υπολογιστή σας στο διαδίκτυο.</p></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Βρείτε την εξωτερική σας (διαδικτυακή) διεύθυνση IP</span></h2></div>
