...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Ενεργοποιήστε ή φράξτε την πρόσβαση τείχους προστασίας</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Go to <span class="gui">Activities</span> in the top left corner of the screen and
      ...
      manager yourself if you can’t find one (for example, GUFW).</p></li>
