...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Ustvarite povezavo s stalnim naslovom IP</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Click <span class="gui">Apply</span>. The network connection should now have a fixed
      IP address.</p></li>
</ol></div>
</div></div>
</div>
