...
<li class="steps">
<p class="p">Выберите устройство, <span class="gui">Wi-Fi</span> или <span class="gui">Проводное</span>, на левой панели.</p>
<p class="p">MAC-адрес проводного устройства будет отображаться как <span class="gui">аппаратный адрес</span> справа.</p>
<p class="p">Нажмите кнопку <span class="media"><span class="media media-image"><img src="figures/emblem-system-symbolic.svg" class="media media-inline" alt="параметры"></span></span>, чтобы увидеть MAC-адрес беспроводного устройства, отображаемый как <span class="gui">Аппаратный адрес</span> на панели <span class="gui">Подробности</span>.</p>
</li>
</ol></div></div></div>
