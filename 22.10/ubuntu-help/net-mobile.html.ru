...
<title>Подключение к мобильному Интернету</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Подключение к мобильному Интернету</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Вы можете настроить подключение к сотовой (3G) сети с помощью встроенного в компьютер 3G-модема, мобильного телефона или интернет-модема.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">В большинстве телефонов есть режим <span class="link"><a href="net-tethering.html.ru" title="net-tethering">USB-модема</a></span>, который не требует настройки на компьютере и, как правило, является лучшим способом подключения к сотовой сети.</p></div></div></div>
</div>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Если у вас нет встроенного 3G-модема, подключите телефон или интернет-флешку к USB-порту компьютера.</p></li>
...
<li class="steps">
<p class="p">Выберите <span class="gui">Отключить мобильное подключение</span>. Раздел меню <span class="gui">мобильное подключение</span> будет открыт.</p>
<div class="note" title="Примечание">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Если пункт <span class="gui">Мобильное подключение</span> отсутствует в меню, проверьте, не подключено ли ваше устройство как устройство хранения данных.</p></div></div></div>
</div>
</li>
<li class="steps"><p class="p">Выберите <span class="gui">Соединение</span>. При первом подключении запустится помощник <span class="gui">настройки мобильного подключения</span>. В появившемся окне помощника будет отображена вся необходимая информация. Нажмите <span class="gui">Далее</span>.</p></li>
