...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Other users can’t edit the network connections</span></h1></div>
<div class="region">
...
<div class="region"><ul>
<li class="links ">
<a href="net-othersconnect.html.el" title="Other users can’t connect to the internet">Other users can’t connect to the internet</a><span class="desc"> — Μπορείτε να αποθηκεύσετε ρυθμίσεις (όπως τον κωδικό πρόσβασης) για μια δικτυακή σύνδεση έτσι ώστε οιοσδήποτε χρησιμοποιεί τον υπολογιστή να μπορεί να συνδεθεί σε αυτόν.</span>
</li>
<li class="links ">
