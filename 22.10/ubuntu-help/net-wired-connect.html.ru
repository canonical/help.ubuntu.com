...
<p class="p">Всё, что нужно для настройки большинства проводных соединений — это подключить сетевой кабель. На верхней панели отображается значок проводной сети (<span class="media"><span class="media media-image"><img src="figures/network-wired-symbolic.svg" class="media media-inline" alt="параметры"></span></span>) с тремя точками во время установления соединения. Точки исчезнут после подключения.</p>
