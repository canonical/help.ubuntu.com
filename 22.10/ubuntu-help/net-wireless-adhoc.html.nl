...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">U kunt ook verbinding maken met het draadloze netwerk door de QR-code in te scannen op uw telefoon of tablet met de ingebouwde camera-app of een QR-codelezer.</p></div></div></div>
</div>
</div>
