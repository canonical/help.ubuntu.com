...
<li class="steps"><p class="p">Выберите <span class="gui">Wi-Fi Недоступно</span> или имя беспроводной сети, к которой вы уже подключены. В ответ будет раскрыт раздел Wi-Fi.</p></li>
<li class="steps"><p class="p">Нажмите <span class="gui">Параметры Wi-Fi</span>.</p></li>
<li class="steps"><p class="p">Нажмите кнопку меню в правом верхнем углу окна и выберите <span class="gui">Включить точку доступа Wi-Fi…</span>.</p></li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Вы также можете подключиться к беспроводной сети, отсканировав QR-код на своем телефоне или планшете с помощью встроенной камеры или сканера QR-кода.</p></div></div></div>
</div>
</div>
