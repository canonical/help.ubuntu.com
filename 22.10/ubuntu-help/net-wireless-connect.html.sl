...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Povezava z brezžičnim omrežjem</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">If the connection is successful, the icon will change to a dot with
    ...
    (<span class="media"><span class="media media-image"><img src="figures/topbar-network-wireless-strength-excellent.svg" height="28" width="28" class="media media-inline" alt=""></span></span>). More bars
...
<div class="region"><ul>
<li class="links ">
<a href="net-wrongnetwork.html.sl" title="My computer connects to the wrong network">My computer connects to the wrong network</a><span class="desc"> — Edit your connection settings, and remove the unwanted connection
    option.</span>
</li>
<li class="links ">
