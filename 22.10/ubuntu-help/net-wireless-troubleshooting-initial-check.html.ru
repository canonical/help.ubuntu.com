...
<li class="steps"><p class="p">Откройте <span class="gui"><a href="shell-introduction.html.ru#systemmenu" title="Системное меню">системное меню</a></span> в правой части верхней панели и выберите сеть Wi-Fi, а затем выберите <span class="gui">Параметры Wi-Fi</span>. Убедитесь, что переключатель <span class="gui">Wi-Fi</span> включен. Также следует убедиться, что <span class="link"><a href="net-wireless-airplane.html.ru" title="Отключение беспроводной связи (режим для авиаперелётов)">Режим авиаперелётов</a></span> <span class="em">не</span> включен.</p></li>
<li class="steps">
