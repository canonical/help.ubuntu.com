...
<p class="p">Это пошаговое руководство по устранению неисправностей поможет вам выявить и устранить проблемы с беспроводным соединением. Если по какой-то причине не удаётся подключиться к беспроводной сети, попробуйте выполнить следующие инструкции.</p>
...
<p class="p">Некоторые из инструкций в этом руководстве предусматривают ввод команд в <span class="em">командной строке</span> (терминале). Приложение <span class="app">Терминал</span> можно найти в <span class="gui">Обзоре</span>.</p>
