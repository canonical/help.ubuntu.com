...
<li class="steps"><p class="p">Apague y encienda el interruptor <span class="gui">Inalámbrica</span> en la parte superior derecha de la ventana.</p></li>
<li class="steps"><p class="p">Si la red inalámbrica sigue sin funcionar, active el <span class="gui">Modo avión</span> y desactívelo de nuevo.</p></li>
</ol></div></div></div>
