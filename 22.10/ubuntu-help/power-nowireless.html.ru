...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">При «пробуждении» компьютера отсутствует беспроводное соединение</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">После перевода компьютера режим ожидания вы можете обнаружить, что при возвращении в рабочий режим беспроводное соединение с Интернетом перестало действовать. Это бывает, когда <span class="link"><a href="hardware-driver.html.ru" title="Что такое драйвер?">драйвер</a></span> беспроводного устройства не полностью поддерживает некоторые функции энергосбережения. Обычно не удаётся правильно включить беспроводное соединение при «пробуждении» компьютера.</p>
...
<li class="steps"><p class="p">Переведите переключатель <span class="gui">Wi-Fi</span> в правом верхнем углу окна в положение «выключено», а затем снова включите его.</p></li>
<li class="steps"><p class="p">Если беспроводное соединение всё равно не работает, попробуйте включить и снова отключить <span class="gui">Режим для авиаперелётов</span>.</p></li>
</ol></div></div></div>
<p class="p">Если ничего не помогло, беспроводная сеть должна снова заработать после перезагрузки компьютера. Если и после перезагрузки проблема не исчезла, подключитесь к интернету с помощью проводного соединения и обновите систему.</p>
</div>
