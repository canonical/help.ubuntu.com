...
<title>Показывать состояние батареи в процентах</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Показывать состояние батареи в процентах</span></h1></div>
<div class="region">
...
<div class="title title-steps"><h2><span class="title">Отображение процента заряда батареи в верхней панели</span></h2></div>
...
<li class="steps"><p class="p">В разделе <span class="gui">Режим ожидания и Кнопка питания</span> установите для параметра <span class="gui">Показать процент заряда батареи</span> значение «Включено».</p></li>
</ol></div>
</div></div>
</div>
