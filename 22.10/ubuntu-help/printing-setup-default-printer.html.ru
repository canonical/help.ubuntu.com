...
<title>Выбор принтера, используемого по умолчанию</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Выбор принтера, используемого по умолчанию</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Для установки принтера, который будет использоваться по умолчанию, нужны <span class="link"><a href="user-admin-explain.html.ru" title="Как работают административные полномочия?">права администратора</a></span>.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Отметьте параметр <span class="gui">Использовать по умолчанию</span>.</p></li>
</ol></div></div></div>
<p class="p">При печати из приложения автоматически используется принтер, установленный по умолчанию, если только вы не выберете другой принтер.</p>
</div>
...
<li class="links ">
<a href="printing-setup.html.ru" title="Установка локального принтера">Установка локального принтера</a><span class="desc"> — Настройте принтер, подключённый к вашему компьютеру или находящийся в локальной сети.</span>
</li>
</ul></div>
</div></div>
</div>
