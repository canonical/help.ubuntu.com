...
<li class="steps"><p class="p">Press the <span class="key"><kbd>Print</kbd></span> key or launch <span class="app">Take a Screenshot</span>
      from the <span class="gui"><a href="shell-introduction.html.el#activities" title="Η επισκόπηση Δραστηριότητες">Activities</a></span>
      overview.</p></li>
<li class="steps">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Συντομεύσεις πληκτρολογίου</span></h2></div>
<div class="region"><div class="contents pagewide">
