...
<li class="list"><p class="p">Capture all or part of your screen as an image</p></li>
<li class="list"><p class="p">Send it as a file or paste it from the clipboard</p></li>
<li class="list"><p class="p">Save a video of your screen activity</p></li>
</ul></div></div></div>
...
<li class="steps"><p class="p">Press the <span class="key"><kbd>Print</kbd></span> key or launch <span class="app">Take a Screenshot</span>
      from the <span class="gui"><a href="shell-introduction.html.es#activities" title="Vista de Actividades">Activities</a></span>
      overview.</p></li>
<li class="steps">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Click the pointer button to include the pointer in the screenshot.</p></div></div></div>
</div>
</li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Where do they go?</span></h2></div>
...
<li class="list"><p class="p">The image is also saved in the clipboard, so you can immediately
      paste it into an image-editing application or share it on social media.</p></li>
...
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Click the pointer button to include the pointer in the screencast.</p></div></div></div>
</div>
</li>
...
<li class="steps"><p class="p">Once you have finished, click the red indicator or press
      <span class="keyseq"><span class="key"><kbd>Shift</kbd></span>+<span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>R</kbd></span></span>
      to stop the recording.</p></li>
</ol></div></div></div>
</div></div>
</div></section><section id="keyboard-shortcuts"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Atajos de teclado</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<td style="border-top-style: solid;"><p class="p">Capturar la pantalla</p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="key"><kbd>W</kbd></span></p></td>
<td style="border-top-style: solid;"><p class="p">Capturar ventana</p></td>
</tr>
<tr>
...
<tr>
<td style="border-top-style: solid;"><p class="p"><span class="key"><kbd>Intro</kbd></span></p></td>
...
<td style="border-top-style: solid;"><p class="p">Capturar la pantalla completa</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Start and stop recording a screencast</p></td>
</tr>
</table></div></div></div>
</div></div>
