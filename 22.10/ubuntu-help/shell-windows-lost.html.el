...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Εύρεση ενός χαμένου παραθύρου</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">Click different workspaces in the
      <span class="link"><a href="shell-workspaces.html.el" title="Τι είναι ένας χώρος εργασίας και πώς θα με βοηθήσει;">workspace selector</a></span>
