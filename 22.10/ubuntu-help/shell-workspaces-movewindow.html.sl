...
<title>Premakne trenutno okno na drugo delovno površino</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Premakne trenutno okno na drugo delovno površino</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">If more than one workspace is already in use, you can also drop the window
      onto one of the non-adjacent workspaces in the <span class="em"><a href="shell-workspaces.html.sl" title="Kaj je delovna površina in kako mi bo pomagala?">workspace
