...
<p class="p">Za organizacijo svojega dela lahko uporabite delovne površine. Tako imate lahko na primer vse okna sporočanja kot sta e-pošta in vaš program klepetanja na eni delovni površini in delate na drugi delovni površini. Vaš upravljalnik glasbe bi lahko bil na tretji delovni površini.</p>
<p class="p">Uporaba delovnih površin:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">In the
    <span class="gui"><a href="shell-introduction.html.sl#activities" title="Activities overview">Activities</a></span> overview, you can
...
<p class="p">Vedno obstaja vsaj ena delovna površina.</p>
<div class="media media-image"><div class="inner"><img src="figures/shell-workspaces.png" height="291" width="940" class="media media-block" alt="Izbirnik delovnih površin"></div></div>
</div>
