...
<p class="p">Open the <span class="gui"><a href="shell-introduction.html.el#systemmenu" title="System menu">system menu</a></span> and
...
<li class="steps"><p class="p">Run <span class="cmd">lspci</span> with 
      <span class="link"><a href="user-admin-explain.html.el" title="Πώς δουλεύουν τα δικαιώματα διαχειριστή;">administrative privileges</a></span>;
