...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Usar un micrófono diferente</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Puede utilizar un micrófono externo para charlar con amigos, hablar con colegas del trabajo, hacer grabaciones de voz, o usar otras aplicaciones multimedia. Incluso si su equipo tiene un micrófono o una cámara web con micrófono, un micrófono separado podría proporcionar una mejor calidad de sonido.</p>
<p class="p">Si su micrófono tiene un conector circular, enchúfelo en el conector adecuado de su equipo. La mayoría de los equipos tienen dos conectores: uno para micrófonos y uno para los altavoces. Normalmente, este adaptador es de color rosa o tiene una imagen de un micrófono junto a él. Los micrófonos enchufados en el adaptador apropiado se usan de manera predeterminada. Si no es así, vea a continuación las instrucciones para la selección de un dispositivo de entrada predeterminado.</p>
<p class="p">Si tiene un micrófono USB, enchúfelo en cualquier puerto USB de su equipo. Los micrófonos USB actúan como dispositivos de sonido separados, y puede tener que especificar qué micrófono usar de manera predeterminada.</p>
...
<p class="p">Puede ajustar el volumen y apagar el micrófono desde este panel.</p>
</div>
