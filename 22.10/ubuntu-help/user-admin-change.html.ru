...
<li class="steps"><p class="p">В разделе <span class="gui">Пользователи</span> выберите пользователя, полномочия которого вы хотите изменить.</p></li>
<li class="steps"><p class="p">Переведите переключатель <span class="gui">Администратор</span> во включённое положение.</p></li>
