...
<li class="steps"><p class="p">Если вы хотите автоматически войти в другую учётную запись, выберите её в разделе <span class="gui">Пользователи</span>.</p></li>
<li class="steps"><p class="p">Переведите переключатель <span class="gui">Автоматический вход</span> во включённое положение.</p></li>
</ol></div></div></div>
