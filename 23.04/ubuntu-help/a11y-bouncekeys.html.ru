...
<div class="region"><div class="contents"><p class="p">Можно включить или отключить «отскакивающие клавиши», нажав на <span class="link"><a href="a11y-icon.html.ru" title="Найти меню специальных возможностей">значок специальных возможностей</a></span> в верхней панели и выбрав <span class="gui">Отскакивающие клавиши</span>. Значок специальных возможностей виден в том случае, если один или более параметров были включены в разделе <span class="gui">Специальные возможности</span>.</p></div></div>
</div>
</div>
