...
<p class="p"><span class="em">Меню специальных возможностей</span> позволяет включать и отключать различные настройки специальных возможностей. Чтобы открыть это меню, нажмите на значок в виде круга с силуэтом человечка внутри, находящийся в верхней панели.</p>
