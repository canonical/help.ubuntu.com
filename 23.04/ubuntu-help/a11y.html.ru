...
<div class="links topiclinks"><div class="inner"><div class="region"><div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="a11y-icon.html.ru" title="Найти меню специальных возможностей"><span class="title">Найти меню специальных возможностей</span><span class="linkdiv-dash"> — </span><span class="desc">Меню специальных возможностей — это значок в верхней панели в виде человечка.</span></a></div></div></div></div></div>
</div>
