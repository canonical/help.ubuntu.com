...
<title>Как создать резервную копию</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Как создать резервную копию</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">Файлы, резервные копии которых уже имеются где-то ещё, например, на USB-накопителе или других съёмных носителях.</p></li>
<li class="list"><p class="p">Файлы, которые легко создать заново. Например, если вы программист, не стоит делать резервные копии всех файлов, создаваемых в процессе компиляции ваших программ. Вместо этого лучше создать копии файлов с исходными кодами.</p></li>
<li class="list"><p class="p">Любые файлы из папки «Корзина». Содержимое корзины можно найти в <span class="file">~/.local/share/Trash</span>.</p></li>
</ul></div></div></div>
</div>
