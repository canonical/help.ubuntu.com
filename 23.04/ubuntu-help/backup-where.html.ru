...
<title>Где хранить резервную копию</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Где хранить резервную копию</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">Карта памяти USB (малая вместимость)</p></li>
<li class="list"><p class="p">Внутренний жёсткий диск (большая вместимость)</p></li>
<li class="list"><p class="p">Внешний жёсткий диск (обычно большая вместимость)</p></li>
<li class="list"><p class="p">Диск, подключённый по сети (большая вместимость)</p></li>
<li class="list"><p class="p">Файловый сервер или сервер для резервного копирования (большая вместимость)</p></li>
<li class="list"><p class="p">CD или DVD (низкая/средняя вместимость)</p></li>
<li class="list"><p class="p">Служба резервного копирования в Интернете (например, <span class="link"><a href="http://aws.amazon.com/s3/" title="http://aws.amazon.com/s3/">Amazon S3</a></span>; объём сохраняемых данных зависит от цены)</p></li>
</ul></div>
</div></div>
<p class="p">Некоторые из этих вариантов обладают достаточной вместимостью для создания резервной копии всех файлов в вашей системе, то есть <span class="em">полной резервной копии системы</span>.</p>
</div>
