...
<title>Включение и выключение Bluetooth</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Включение и выключение Bluetooth</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Вы можете включить Bluetooth для подключения к другим Bluetooth-устройствам или отключить его для экономии энергии. Чтобы включить Bluetooth:</p>
...
<li class="steps"><p class="p">Включите переключатель на панели заголовка.</p></li>
</ol></div></div></div>
<p class="p">На многих ноутбуках есть аппаратный переключатель или комбинация клавиш для включения и выключения Bluetooth. Найдите переключатель на компьютере или клавишу на клавиатуре. Доступ к этой клавише часто осуществляется с помощью клавиши <span class="key"><kbd class="key-Fn">Fn</kbd></span>.</p>
...
<li class="steps"><p class="p">Выберите <span class="gui"><span class="media"><span class="media media-image"><img src="figures/bluetooth-active-symbolic.svg" class="media media-inline" alt=""></span></span> Bluetooth</span>.</p></li>
</ol></div></div></div>
<div class="note" title="Примечание">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Компьютер остаётся <span class="link"><a href="bluetooth-visibility.html.ru" title="Что такое видимость Bluetooth?">видимым</a></span> пока открыта панель <span class="gui">Bluetooth</span>.</p></div></div></div>
</div>
</div>
