...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Cómo asignar perfiles a los dispositivos?</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Para cambiar el perfil utilizado seleccione el perfil que quiere usar y pulse <span class="gui">Activar</span> para confirmar su elección.</p></li>
</ol></div></div></div>
<p class="p">Cada dispositivo puede tener asignados varios perfiles, pero sólo uno de ellos puede ser el perfil <span class="em">predeterminado</span>. El perfil predeterminado se usa cuando no hay información adicional que permita elegir el perfil automáticamente. Un ejemplo de selección automática sería si se crease un perfil para papel satinado y otro para papel normal.</p>
<p class="p">Si el hardware de calibración está conectado, el botón <span class="gui">Calibrar...</span> creará un perfil nuevo.</p>
</div>
