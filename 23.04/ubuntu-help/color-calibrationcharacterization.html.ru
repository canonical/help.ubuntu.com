...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">В чём разница между калибровкой и профилированием?</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Внимание: профиль действителен для устройства лишь в том случае, если оно находится в том же состоянии калибровки, при котором этот профиль был создан.</p></div></div></div>
</div>
