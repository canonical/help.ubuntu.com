...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Por qué necesito realizar la calibración yo mismo?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Generalmente los perfiles genéricos son malos. Cuando un fabricante crea un modelo nuevo, simplemente toman algunos elementos de la línea de producción y miden su media:</p>
<div class="media media-image"><div class="inner"><img src="figures/color-average.png" class="media media-block" alt="Perfiles medios"></div></div>
<p class="p">Las pantallas difieren bastante de una unidad a otra y pueden cambiar sustancialmente a lo largo del tiempo. También es más difícil para las impresoras, ya que el simple cambio de tipo o peso del papel pueden cambiar el estado de caracterización y hacer que el perfil no sea preciso.</p>
<p class="p">La mejor forma de asegurarse de que el perfil que tiene es preciso es realizando la calibración usted mismo, o permitiendo que una empresa externa le proporcione un perfil basado en su estado de caracterización exacto.</p>
</div>
