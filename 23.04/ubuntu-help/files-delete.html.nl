...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Bestanden en mappen verwijderen</span></h1></div>
<div class="region">
...
<p class="p">If you do not want a file or folder any more, you can delete it. When you
  ...
  until you empty the trash. You can <span class="link"><a href="files-recover.html.nl" title="Een verwijderd bestand terughalen">restore
...
<li class="steps"><p class="p">Druk op <span class="key"><kbd>Delete</kbd></span> op het toetsenbord. U kunt het item ook naar de <span class="gui">Prullenbak</span> in de zijbalk slepen.</p></li>
</ol></div>
</div></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Een bestand permanent verwijderen</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Verwijderde bestanden op een <span class="link"><a href="files.html.nl#removable" title="Verwijderbare schijven en externe schijven">verwijderbaar apparaat</a></span> zijn mogelijk niet zichtbaar in andere besturingssystemen zoals Windows of Mac OS. De bestanden zijn er nog wel, en zullen beschikbaar zijn wanneer u het apparaat weer aansluit op uw computer.</p></div></div></div>
</div>
</div></div>
...
<a href="files-recover.html.nl" title="Een verwijderd bestand terughalen">Een verwijderd bestand terughalen</a><span class="desc"> — Wanneer u bestanden verwijdert worden ze normaal gesproken naar de Prullenbak verplaatst, maar u kunt ze nog wel terughalen.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
