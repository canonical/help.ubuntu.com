...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Удаление файлов и папок</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Если файл или папка больше не нужны, можно удалить их. При удалении объект отправляется в <span class="gui">Корзину</span>, где будет хранится, пока вы не очистите корзину. Можно <span class="link"><a href="files-recover.html.ru" title="Восстановление файла из корзины">восстановить объекты </a></span> из <span class="gui">Корзины</span> в их исходное местоположение, если вы всё же решите, что они нужны, или если они были удалены случайно.</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Чтобы отправить файл в корзину:</span></h2></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Выберите объект, который хотите поместить в корзину, нажав на него.</p></li>
...
<p class="p">Файл будет отправлен в корзину. После этого на несколько секунд появится кнопка <span class="gui">Отменить</span>. Если вы нажмёте на эту кнопку, то файл будет восстановлен и перемещён в исходное местоположение.</p>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Окончательное удаление файла</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Можно окончательно удалить файл сразу же, не отправляя его сначала в корзину.</p>
<div class="steps"><div class="inner">
<div class="title title-steps"><h3><span class="title">Чтобы окончательно удалить файл:</span></h3></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Выберите объект, который нужно удалить.</p></li>
<li class="steps"><p class="p">Удерживая нажатой клавишу <span class="key"><kbd>Shift</kbd></span>, нажмите <span class="key"><kbd>Delete</kbd></span> на клавиатуре.</p></li>
