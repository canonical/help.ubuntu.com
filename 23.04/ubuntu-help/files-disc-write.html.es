...
<div class="region">
<div class="contents pagewide"><p class="p">Puede copiar archivos a un disco vacío usando una aplicación de grabación de discos como puede ser <span class="app">Brasero</span>.</p></div>
...
<p class="p">En este caso, pruebe a grabar de nuevo el disco usando una velocidad de grabación más lenta; por ejemplo 12x en lugar de 48x. Grabar a velocidades más lentas es más fiable.</p>
</div></div>
