...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Als u het verkeerde bestand heeft hernoemd, of uw bestand een verkeerde naam heeft gegeven, kunt u het hernoemen ongedaan maken. Om de handeling terug te draaien en de vorige naam te herstellen dient u onmiddellijk te klikken op <span class="gui">Hernoemen ongedaan maken</span> in de taakbalk, of te drukken op <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Z</kbd></span></span>.</p></div></div></div>
</div>
</div>
