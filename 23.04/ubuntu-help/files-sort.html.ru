...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Просмотр в виде значков</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Чтобы изменить способ сортировки файлов, нажмите кнопку просмотра параметров на панели инструментов и выберите <span class="gui">По имени</span>, <span class="gui">По размеру</span>, <span class="gui">По типу</span>, <span class="gui">По дате изменения</span> или <span class="gui">По дате обращения</span>.</p>
...
<p class="p">Можно сменить порядок сортировки на обратный, выбрав <span class="gui">В обратном порядке</span> из меню.</p>
</div></div>
