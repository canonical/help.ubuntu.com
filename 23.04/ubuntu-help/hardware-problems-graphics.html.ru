...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Проблемы с экраном</span></h1></div>
<div class="region">
...
<div class="linkdiv "><a class="linkdiv" href="session-screenlocks.html.ru" title="Экран блокируется слишком быстро"><span class="title">Экран блокируется слишком быстро</span><span class="linkdiv-dash"> — </span><span class="desc">Измените время ожидания перед блокировкой экрана в настройках <span class="gui">Блокировка экрана</span>.</span></a></div>
