...
<li class="steps"><p class="p">Нажмите <span class="gui">Автоповтор клавиш</span> в разделе <span class="gui">Ввод</span>.</p></li>
<li class="steps">
<p class="p">Переведите переключатель <span class="gui">Автоповтор клавиш</span> в выключенное положение.</p>
