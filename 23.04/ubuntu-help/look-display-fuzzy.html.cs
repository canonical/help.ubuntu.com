...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Proč vše na mojí obrazovce vypadá rozmazané/kostičkované?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">To se může stát, že rozlišení displeje, které máte nastavené, neodpovídá skutečnému rozlišení vaší obrazovky. Abyste to napravili:</p>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Když je připojeno více displejů</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Pokud máte k počítači připojeny dva displeje (například normální monitor a projektor), mohou mít navzájem různé optimální nebo <span class="link"><a href="look-resolution.html.cs#native" title="Přirozené rozlišení">přirozené</a></span> rozlišení.</p>
<p class="p">Použitím režimu <span class="link"><a href="display-dual-monitors.html.cs#modes" title="Režimy displeje">Duplikovat</a></span> můžete zobrazit tu samou věc na dvou obrazovkách. Obě obrazovky budou používat stejné rozlišení, které ale nemusí odpovídat přirozenému rozlišení obou obrazovek, takže tím může utrpět ostrost obrazu.</p>
<p class="p">Při použití režimu <span class="link"><a href="display-dual-monitors.html.cs#modes" title="Režimy displeje">Sloučit displeje</a></span> se dá nastavit rozlišení u každé obrazovky nezávisle, takže u obou můžete mít jejich přirozené rozlišení.</p>
</div></div>
...
<div class="region"><ul>
<li class="links "><a href="prefs-display.html.cs#problems" title="Problémy">Problémy</a></li>
<li class="links ">
