...
<div class="linkdiv "><a class="linkdiv" href="nautilus-views.html.ru" title="Параметры просмотра файлов и папок в приложении Файлы"><span class="title">Параметры просмотра файлов и папок в приложении <span class="app">Файлы</span></span><span class="linkdiv-dash"> — </span><span class="desc">Управление порядком сортировки и группировки по умолчанию для файлового менеджера.</span></a></div>
</div></div></div></div></div>
