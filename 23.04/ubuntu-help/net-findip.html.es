...
<div class="region">
<div class="contents pagewide"><p class="p">Conocer su dirección IP le puede ayudar a solucionar problemas con su conexión a Internet. Es posible que se sorprenda al saber que tiene <span class="em">dos</span> direcciones IP: una dirección IP de su equipo en la red interna y una dirección IP de su equipo en Internet.</p></div>
...
<li class="steps">
<p class="p">Pulse en <span class="gui">Red</span> en la barra lateral para abrir el panel.</p>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Buscar su dirección IP externa (Internet)</span></h2></div>
