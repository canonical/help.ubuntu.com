...
<p class="p">Нажмите кнопку <span class="media"><span class="media media-image"><img src="figures/emblem-system-symbolic.svg" class="media media-inline" alt="настройки"></span></span>, чтобы увидеть MAC-адрес беспроводного устройства, отображаемый как <span class="gui">Аппаратный адрес</span> на панели <span class="gui">Подробности</span>.</p>
</li>
</ol></div></div></div>
