...
<span style="color: #333">Ubuntu 23.04</span> » <a class="trail" href="index.html.nl" title="Gids voor de Ubuntu-werkomgeving"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Hulp"></span></span> Ubuntu-bureaubladhandleiding</a> » <a class="trail" href="net.html.nl" title="Netwerk, web &amp; e-mail">Netwerken</a> » <a class="trail" href="net-problem.html.nl" title="Netwerkproblemen">Netwerkproblemen</a> » </div></div>
...
<div class="region"><ul>
<li class="links ">
<a href="net-othersconnect.html.nl" title="Andere gebruikers kunnen geen verbinding maken met het internet">Andere gebruikers kunnen geen verbinding maken met het internet</a><span class="desc"> — U kunt instellingen (zoals het wachtwoord) voor een netwerkverbinding opslaan, zodat iedereen die de computer gebruikt er verbinding mee kan maken.</span>
</li>
<li class="links ">
