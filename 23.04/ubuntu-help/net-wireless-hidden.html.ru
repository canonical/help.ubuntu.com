...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Подключение к скрытой беспроводной сети</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Выберите <span class="gui">Wi-Fi Недоступно</span>. В ответ будет раскрыт раздел Wi-Fi.</p></li>
<li class="steps"><p class="p">Нажмите <span class="gui">Настройки Wi-Fi</span>.</p></li>
<li class="steps"><p class="p">Нажмите кнопку меню в правом верхнем углу окна и выберите <span class="gui">Подключиться к скрытой сети…</span>.</p></li>
<li class="steps"><p class="p">В появившемся окне в выпадающем списке <span class="gui">Подключение</span> выберите скрытую сеть, с которой ранее было установлено соединение, или пункт <span class="gui">Создать</span> для новой сети.</p></li>
<li class="steps"><p class="p">Введите имя сети для нового соединения и выберите способ защиты беспроводного соединения из выпадающего списка <span class="gui">Защита Wi-Fi</span>.</p></li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Вы можете подумать, что скрытие вашей беспроводной сети улучшит безопасность, не позволяя подключиться людям, которые не знают о ней. На практике, это не так: обнаружить сеть немного сложнее, но всё же возможно.</p></div></div></div>
</div>
</div>
...
<div class="region"><ul><li class="links ">
<a href="net-wireless-find.html.ru" title="Моей беспроводной сети нет в списке">Моей беспроводной сети нет в списке</a><span class="desc"> — Возможно, беспроводной адаптер отключен или неисправен, или вы пытаетесь подключиться к скрытой сети.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
