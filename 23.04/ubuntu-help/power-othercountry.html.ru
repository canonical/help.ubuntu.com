...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Будет ли мой компьютер работать при подключении к электросети в другой стране?</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Будьте осторожны при замене кабеля питания или использовании переходника. Сначала отключите всё от сети, если это возможно.</p></div></div></div>
</div>
</div>
