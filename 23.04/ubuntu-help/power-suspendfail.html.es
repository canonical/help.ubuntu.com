...
<title>¿Por qué mi equipo no reacciona después de haberlo enviado suspendido?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Por qué mi equipo no reacciona después de haberlo enviado suspendido?</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Si <span class="link"><a href="power-suspend.html.es" title="¿Qué ocurre cuando suspendo el equipo?">suspende</a></span> su equipo y luego tratar de despertarlo o de volver a encenderlo, es posible que no funcione como esperaba. Esto podría ser debido a que su hardware no permite suspender adecuadamente.</p></div>
<section id="resume"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Mi equipo está dormido y no puedo despertarlo</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Si suspende su equipo y luego presiona una tecla o pulsa con su ratón, debería despertarse y mostrar una pantalla pidiendo su contraseña. Si esto no ocurre, intente presionando el botón de encendido (no lo mantenga presionado, púlselo solo una vez).</p>
<p class="p">Si esto no funciona, asegúrese de que el monitor de su equipo está encendido e intente pulsar una tecla nuevamente.</p>
<p class="p">Como último recurso, apague el equipo manteniendo pulsado el botón de encendido de 5 a 10 segundos. Al hacerlo perderá sus trabajos sin guardar. Luego podrá encender el equipo nuevamente.</p>
<p class="p">Si esto ocurre siempre que pone su equipo a dormir, puede que la suspensión no funcione en su hardware.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Si su equipo gasta energía y no tiene una fuente de alimentación alternativa (como una batería), se apagará.</p></div></div></div>
</div>
</div></div>
</div></section><section id="hardware"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Mi conexión inalámbrica (u otro hardware) no funciona cuando mi equipo despierta</span></h2></div>
<div class="region"><div class="contents pagewide">
