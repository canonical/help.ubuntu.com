...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Устранение замятия бумаги</span></h1></div>
<div class="region">
...
<p class="p">После устранения замятия может понадобиться нажать кнопку <span class="em">resume</span> на принтере. Некоторые принтеры необходимо отключить и снова включить, а затем заново запустить задание на печать.</p>
</div>
