...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Establecer la impresora predeterminada</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Necesita <span class="link"><a href="user-admin-explain.html.es" title="¿Cómo funcionan los privilegios de administrador?">privilegios de administrador</a></span> para establecer la impresora predeterminada del sistema.</p></div></div></div>
</div>
...
<div class="region"><ul>
<li class="links ">
<a href="printing-setup.html.es" title="Configurar una impresora local">Configurar una impresora local</a><span class="desc"> — Configurar una impresora que está conectada a su equipo o en su red local.</span>
</li>
<li class="links ">
