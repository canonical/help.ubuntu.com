...
<div class="media media-image floatend if-if if__not-target-mobile"><div class="inner"><img src="figures/shell-exit-expanded.png" width="250" class="media media-block" alt="Menú del usuario"></div></div>
...
<a href="user-add.html.es" title="Añadir una cuenta de usuario nueva">Añadir una cuenta de usuario nueva</a><span class="desc"> — Añadir usuarios nuevos de manera que otras personas puedan iniciar sesión en el equipo.</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
