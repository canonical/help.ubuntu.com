...
<div class="region">
<div class="contents pagewide"><p class="p">Wanneer u klaar bent met het gebruiken van uw computer kunt u deze uitschakelen, in de pauzestand zetten (om energie te besparen), of hem aan laten staan en u alleen afmelden.</p></div>
<section id="logout"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Afmelden of van gebruiker wisselen</span></h2></div>
<div class="region">
<div class="contents pagewide">
<div class="media media-image floatend if-if if__not-target-mobile"><div class="inner"><img src="figures/shell-exit-expanded.png" width="250" class="media media-block" alt="Gebruikersmenu"></div></div>
...
<p class="p">To <span class="gui">Log Out</span> or <span class="gui">Switch User</span>, click the
  <span class="link"><a href="shell-introduction.html.nl#systemmenu" title="System menu">system menu</a></span> on the right
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">De onderdelen <span class="gui">Afmelden</span> en <span class="gui">Gebruiker wisselen</span> verschijnen alleen in het menu als u meer dan één gebruikersaccount op uw systeem heeft.</p></div></div></div>
</div>
</div>
...
<a href="user-add.html.nl" title="Een nieuwe gebruiker toevoegen">Een nieuwe gebruiker toevoegen</a><span class="desc"> — Nieuwe gebruikers toevoegen zodat anderen zich op de computer kunnen aanmelden.</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
...
<p class="p">If you’re leaving your computer for a short time, you should lock your
  ...
  <span class="link"><a href="shell-lockscreen.html.nl" title="Het vergrendelscherm">lock screen</a></span>. Enter your
