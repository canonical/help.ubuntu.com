...
<title>Проблемы со звуком</title>
...
<div class="trail">
<span style="color: #333">Ubuntu 23.04</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="prefs.html.ru" title="Настройки пользователя и системы">Настройки</a> » <a class="trail" href="media.html.ru#sound" title="Основы работы со звуком">Звук</a> » </div>
<div class="trail">
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Проблемы со звуком</span></h1></div>
<div class="region">
...
<div class="linkdiv "><a class="linkdiv" href="sound-nosound.html.ru" title="Компьютер не издаёт никаких звуков"><span class="title">Компьютер не издаёт никаких звуков</span><span class="linkdiv-dash"> — </span><span class="desc">Проверьте, что звук включён; проверьте подсоединение кабелей; проверьте, что звуковая карта определилась системой.</span></a></div>
