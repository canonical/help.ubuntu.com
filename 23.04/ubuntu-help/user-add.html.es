...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Añadir una cuenta de usuario nueva</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">En en panel <span class="gui">Usuarios</span> puede pulsar la imagen junto al nombre del usuario, a la derecha, para establecer una imagen para la cuenta. Esta imagen se mostrará en la ventana de inicio de sesión. El sistema proporciona algunos conjuntos de imágenes que puede usar, o puede seleccionar su propia imagen o hacer una foto con su cámara web.</p></div></div></div>
</div>
</div>
...
<div class="region"><ul>
<li class="links "><a href="shell-exit.html.es#logout" title="Cerrar la sesión o cambiar de usuario">Cerrar la sesión o cambiar de usuario</a></li>
<li class="links ">
