...
<title>Automatické přihlašování</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Automatické přihlašování</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Přepněte vypínač <span class="gui">Automatické přihlašování</span> do polohy zapnuto.</p></li>
</ol></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Jestliže je váš účet typu <span class="em">Normální</span>, nemůžete měnit toto nastavení. Řekněte správci systému, který to může provést za vás.</p></div></div></div>
</div>
</div>
