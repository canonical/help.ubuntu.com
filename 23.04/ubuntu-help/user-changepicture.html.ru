...
<li class="steps"><p class="p">Если вам нужно изменить параметры учётной записи другого пользователя, нажмите <span class="gui">Разблокировать</span> в верхнем правом углу окна и по запросу введите свой пароль. Выберите пользователя в разделе <span class="gui">Пользователи</span>.</p></li>
<li class="steps">
