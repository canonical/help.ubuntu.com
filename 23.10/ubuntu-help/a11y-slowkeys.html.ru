...
<li class="steps"><p class="p">В разделе <span class="gui">Помощник ввода</span> переведите переключатель <span class="gui">Медленные клавиши</span> в положение «включено».</p></li>
</ol></div></div></div>
