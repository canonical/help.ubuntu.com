...
<li class="steps"><p class="p">Выберите раздел <span class="gui">Слух</span>, чтобы открыть его.</p></li>
<li class="steps"><p class="p">В разделе <span class="gui">Визульные уведомление</span> переведите переключатель <span class="gui">Визульные уведомление</span> в положение «включено».</p></li>
<li class="steps"><p class="p">В пункте <span class="gui">Область вспышки</span> выберите по желанию, будет ли мигать только текущее окно или весь экран.</p></li>
</ol></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Чтобы быстро включить или отключить визуальные уведомления, нажмите на <span class="link"><a href="a11y-icon.html.ru" title="Найти меню специальных возможностей">значок специальных возможностей</a></span> в верхней панели и измените положение переключателя <span class="gui">Визуальные предупреждения</span>.</p></div></div></div>
</div>
</div>
