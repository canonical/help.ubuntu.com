...
<div class="region"><ul>
<li class="links ">
<a href="mouse-sensitivity.html.es" title="Ajustar la velocidad del ratón y del panel táctil">Ajustar la velocidad del ratón y del panel táctil</a><span class="desc"> — Cambiar cómo se mueve de rápido el puntero cuando usa el ratón o el panel táctil.</span>
</li>
<li class="links ">
...
<li class="links ">
<a href="a11y-stickykeys.html.es" title="Activar las teclas persistentes">Activar las teclas persistentes</a><span class="desc"> — Pulsar atajos del teclado de forma seguida en lugar de tener que mantener todas las teclas pulsadas a la vez.</span>
</li>
<li class="links ">
