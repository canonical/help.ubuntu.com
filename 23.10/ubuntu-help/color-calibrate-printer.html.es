...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Cómo calibrar la impresora?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Existen dos formas de perfilar una impresora:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Usar un dispositivo espectrofotómetro como el Pantone ColorMunki</p></li>
<li class="list"><p class="p">Descargar un archivo de referencia de impresión de una empresa de color</p></li>
</ul></div></div></div>
<p class="p">Usar una empresa de color para generar un perfil de impresora es la opción más barata si tiene uno o dos tipos de papel diferentes. Descargando el gráfico de referencia desde el sitio web de la empresa, puede después enviarles la impresión en un sobre acolchado que ellos analizarán, generarán el perfil y le enviarán un perfil ICC preciso.</p>
<p class="p">Usar un dispositivo caro tal como ColorMunki sólo compensa si está perfilando un gran número de conjuntos de tinta o tipos de papeles.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Si cambia de proveedor de tinta, asegúrese de recalibrar la impresora.</p></div></div></div>
</div>
</div>
...
<div class="region"><ul>
<li class="links ">
<a href="color-calibrate-scanner.html.es" title="¿Cómo calibrar el escáner?">¿Cómo calibrar el escáner?</a><span class="desc"> — Calibrar su escáner es importante para capturar colores precisos.</span>
</li>
<li class="links ">
