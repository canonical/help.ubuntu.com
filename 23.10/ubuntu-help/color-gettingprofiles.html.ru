...
<p class="p">Многие производители предоставляют цветовые профили для своих устройств, хотя иногда они упакованы в <span class="em">наборы драйверов</span>, которые нужно скачать, извлечь и найти в них цветовые профили.</p>
