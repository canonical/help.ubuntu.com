...
<div class="trail">
<span style="color: #333">Ubuntu 23.10</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="prefs.html.ru" title="Настройки пользователя и системы">Настройки</a> » <a class="trail" href="color.html.ru" title="Управление цветом">Цвет</a> » </div>
</div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Почему важно управление цветом?</span></h1></div>
<div class="region">
...
<p class="p">Обратите внимание, что белый цвет перестал быть «бумажным белым», а чёрный превратился в грязно-коричневый.</p>
<div class="figure"><div class="inner">
<a href="#" class="figure-zoom" data-zoom-in-title="Обычный размер изображений" data-zoom-out-title="Уменьшить масштаб изображений"><svg width="10" height="10" class="figure-zoom-in"><rect x="0.5" y="0.5" width="9" height="9" class="yelp-svg-stroke" stroke-width="1" fill="none"></rect><rect x="0" y="5" width="5" height="5" class="yelp-svg-fill"></rect></svg><svg width="10" height="10" class="figure-zoom-out"><rect x="0.5" y="0.5" width="9" height="9" class="yelp-svg-stroke" stroke-width="1" fill="none"></rect><polygon points="0,0 10,0 10,10 5,10 5,5 10,5 0,5" class="yelp-svg-fill"></polygon></svg></a><div class="region">
...
<p class="p">Большинство устройств захватывает изображения в RGB (красный, зелёный, синий), которые для печати необходимо преобразовать в CMYK (циановый, пурпурный, жёлтый, чёрный). Кроме того, <span class="em">белых</span> чернил не бывает, поэтому белым цвет будет ровно настолько, насколько белой является бумага.</p>
<p class="p">Единицы измерения — ещё одна проблема. Не зная шкалу, по которой измерялся цвет, невозможно сказать, является ли 100% красный цветом на границе с инфракрасным диапазоном, или же это просто самый густой красный цвет, который может вывести принтер. На одном мониторе 50% красного будет соответствовать 62% красного на другом. Это всё равно что сказать человеку, что вы проехали семь единиц расстояния, не сказав, километры это или метры.</p>
<p class="p">Когда речь идёт о цвете, единицы измерения определяют через цветовой охват, под которым подразумевается диапазон воспроизводимых цветов. У цифровой зеркальной фотокамеры может быть очень большой цветовой охват, способный воспроизвести все цвета на снимке заката. Но у проектора цветовой охват очень небольшой, из-за чего все цвета будут выглядеть блеклыми.</p>
<p class="p">В некоторых случаях можно <span class="em">скорректировать</span> отклик устройства, изменив отправляемые ему данные. Но в тех случаях, когда это невозможно (вспомните про непечатаемый цвет «электрик»), необходимо показать пользователю, на что похож результат.</p>
<p class="p">При работе с фотографиями важно иметь возможность использовать весь диапазон тонов устройства цветной печати, чтобы иметь возможность производить тонкую настройку цвета. При печати других типов графики нужно точное воспроизведение цвета, что важно если вы пытаетесь, например, напечатать на кружке логотип Red Hat, который <span class="em">должен</span> быть именно такого же оттенка красного, как на оригинальном логотипе.</p>
</div>
