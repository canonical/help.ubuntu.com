...
<div class="region">
<div class="contents pagewide"><p class="p">Можно настроить способ открытия файлов (одинарным или двойным нажатием), действие для исполняемых текстовых файлов и поведение корзины. Нажмите кнопку меню в правом верхнем углу окна, выберите <span class="gui">Параметры</span>, затем перейдите в раздел <span class="gui">Основное</span>.</p></div>
