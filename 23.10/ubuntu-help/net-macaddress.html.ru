...
<li class="steps"><p class="p">Откройте <span class="gui"><a href="shell-introduction.html.ru#activities" title="Режим обзора">Обзор</a></span> и начните вводить: <span class="gui">Сеть</span> для проводных соединений или <span class="gui">Wi-Fi</span> для беспроводных подключений.</p></li>
<li class="steps"><p class="p">Нажмите <span class="gui">Network</span> или <span class="gui">Wi-Fi</span>, чтобы открыть панель с настройками.</p></li>
<li class="steps"><p class="p">Щёлкните кнопу <span class="media"><span class="media media-image"><img src="figures/emblem-system-symbolic.svg" class="media media-inline" alt="настройки"></span></span> рядом с активным соединением.</p></li>
<li class="steps"><p class="p">MAC-адрес устройства будет отображаться как <span class="gui">Аппаратный адрес</span> в панеле <span class="gui">Подробности</span>.</p></li>
</ol></div></div></div>
<p class="p">На практике иногда возникает необходимость изменить или «подменить» MAC-адрес. Например, некоторые интернет-провайдеры привязывают доступ к своим услугам к определённому MAC-адресу. Если сетевая карта выйдет из строя, и вы замените её новой, связь станет недоступной. В таком случае вы можете подменить MAC-адрес старым.</p>
</div>
