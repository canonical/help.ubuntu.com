...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Definir la configuración del proxy</span></h1></div>
<div class="region">
<div class="contents pagewide"></div>
<section id="what"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">¿Qué es un proxy?</span></h2></div>
<div class="region"><div class="contents pagewide"><p class="p">Un <span class="em">proxy web</span> filtra los sitios web que está consultando, recibe solicitudes del navegador web para obtener las páginas web y sus elementos y, siguiendo una política, decide si los deja pasar. Normalmente se usan en empresas y accesos inalámbricos públicos a Internet para controlar los sitios web que está visitando, impedir que pueda acceder a Internet sin autenticarse o llevar a cabo comprobaciones de seguridad en sitios web.</p></div></div>
</div></section><section id="change"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Cambiar el método del proxy</span></h2></div>
