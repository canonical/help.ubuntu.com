...
<li class="steps"><p class="p">В случае успешного подключения значок изменится на точку с несколькими чёрточками над ней (<span class="media"><span class="media media-image"><img src="figures/topbar-network-wireless-signal-excellent.svg" height="28" width="28" class="media media-inline" alt=""></span></span>). Большее количество чёрточек указывает на более уверенное подключение к сети. Если чёрточек мало, то сигнал слабый и связь может быть не очень надёжной.</p></li>
</ol></div></div></div>
