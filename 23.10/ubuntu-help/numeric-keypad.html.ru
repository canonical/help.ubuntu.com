...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Цифровой блок</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Возможно, второй шаг не понадобится на вашем компьютере, так что сначала попробуйте без него.</p></div></div></div>
</div>
</div>
