...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Почему мой компьютер не выходит из режима ожидания?</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Если вы переведёте компьютер в <span class="link"><a href="power-suspend.html.ru" title="Что происходит при переходе компьютера в режим ожидания?">режим ожидания</a></span>, а затем попытаетесь возобновить его работу, вы можете обнаружить, что он работает не так, как вы ожидали. Причина может быть в том, что приостановка работы не поддерживается должным образом вашим оборудованием.</p></div>
<section id="resume"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Компьютер не может выйти из режима ожидания</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Если нажать клавишу мышки или клавиатуры компьютера, находящегося в режиме ожидания, он должен «проснуться» и показать экран ввода пароля. Если этого не произошло, попробуйте нажать кнопку питания (не удерживать, а просто нажать один раз).</p>
<p class="p">Если это не помогло, проверьте, включен ли монитор и попробуйте снова нажать клавишу на клавиатуре.</p>
...
<p class="p">Если это повторяется каждый раз при переводе компьютера в режим ожидания, то этот режим, возможно, не работает на вашем оборудовании.</p>
...
<div class="region"><div class="contents pagewide">
<p class="p">Если вы перевели компьютер в режим ожидания, а затем снова вернули его в рабочее состояние, может оказаться, что соединение с интернетом, мышь или какое-то другое устройство перестало правильно работать. Это может быть связано с тем, что драйвер устройства не поддерживает должным образом переход в режим ожидания. Это <span class="link"><a href="hardware-driver.html.ru" title="Что такое драйвер?">проблема с драйвером</a></span>, а не с самим устройством.</p>
...
<p class="p">Если нет возможности выключить или отсоединить устройство, или это не помогает, попробуйте перезагрузить компьютер, чтобы устройство снова начало работать.</p>
</div></div>
