...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Si hay varias cuentas de usuario en su sistema, hay una instancia separada de la <span class="gui">Región e idioma </span> para la pantalla de inicio de sesión. Haga clic en el botón <span class="gui">Pantalla de inicio de sesión</span> en la esquina superior derecha para alternar entre las dos instancias.</p></div></div></div>
</div>
</div>
