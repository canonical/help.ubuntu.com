...
<li class="steps">
<p class="p">Переведите переключатель <span class="gui">Общий доступ к файлам</span> в положение «выключено». Данная функция определяет, что другие люди в вашей сети смогут попытаться подключиться к вашему компьютеру и получить доступ к вашим файлам в <span class="file">Общедоступной</span> папке.</p>
<div class="note" title="Примечание">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
