...
<li class="steps"><p class="p">If more than one workspace is already in use, you can also drop the window
      onto one of the non-adjacent workspaces in the <span class="em"><a href="shell-workspaces.html.es" title="¿Qué es un área de trabajo y cómo me ayudará?">workspace
