...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ujistěte se, že zvuk není vypnutý</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Otevřete <span class="gui"><a href="shell-introduction.html.cs#systemmenu" title="Nabídka systému">nabídku systému</a></span> a ujistěte se, že zvuk není vypnutý nebo nastavený na příliš nízkou hlasitost.</p>
<p class="p">Některé notebooky mají na vypnutí speciální vypínač nebo klávesy na klávesnici – zkuste je použít, jestli se ztišení nezruší.</p>
<p class="p">Měli byste také zkontrolovat, jestli nemáte zvuk vypnutý v aplikaci, kterou používáte k přehrávání (například přehrávač hudby nebo filmů). Aplikace mohou mít tlačítka pro ztišení a ovládání hlasitosti přímo v hlavním okně, takže zkontrolujte i tyto.</p>
<p class="p">Můžete také zkontrolovat táhlo hlasitosti v panelu <span class="gui">Zvuk</span>:</p>
...
<li class="steps"><p class="p">Pod položou <span class="gui">Úrovně hlasitosti</span> zkontrolujte, že vaše aplikace nemá vypnutý zvuk. Tlačítko vpravo vedle táhla hlasitosti zvuk celkově zapíná a vypíná.</p></li>
</ol></div></div></div>
</div></div>
...
<li class="steps"><p class="p">Kliknutím na <span class="gui">Zvuk</span> otevřete příslušný panel.</p></li>
<li class="steps">
<p class="p">V části <span class="gui">Výstup</span> vyberte <span class="gui">Výstupní zařízení</span> a klikněte na tlačítko <span class="gui">Testovat</span>, abyste slyšeli, jestli funguje.</p>
<p class="p">Možná budete muset postupně vyzkoušet všechna zařízení.</p>
</li>
</ol></div></div></div>
</div></div>
...
<li class="steps"><p class="p">Spusťte s <span class="link"><a href="user-admin-explain.html.cs" title="Jak fungují oprávnění správce?">oprávněními správce</a></span> příkaz <span class="cmd">lspci</span>, tzn. buď napsat <span class="cmd">sudo lspci</span> a zadat heslo, nebo napsat <span class="cmd">su</span>, zadat heslo uživatele <span class="em">root</span> (správce) a pak napsat <span class="cmd">lspci</span>.</p></li>
