...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Uživatelské účty</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Každý uživatel počítače by měl mít svůj oddělený uživatelský účet. Díky tomu může udržovat své soubory oddělené od souborů ostatních a zvolit si svá vlastní nastavení. Přináší to také lepší zabezpečení. K jinému účtu máte přístup, jen když znáte jeho heslo.</p></div>
<section id="manage"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Správa uživatelských účtů</span></h2></div>
...
<div class="linkdiv "><a class="linkdiv" href="parental-controls.html.cs" title="Add parental controls"><span class="title">Add parental controls</span><span class="linkdiv-dash"> — </span><span class="desc">Set up parental controls for users on the system.</span></a></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Hesla</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-twocolumn">
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="user-goodpassword.html.cs" title="Volba bezpečného hesla"><span class="title">Volba bezpečného hesla</span><span class="linkdiv-dash"> — </span><span class="desc">Používejte dlouhá a složitá hesla.</span></a></div></div>
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="user-changepassword.html.cs" title="Změna vašeho hesla"><span class="title">Změna vašeho hesla</span><span class="linkdiv-dash"> — </span><span class="desc">Zachovejte bezpečnost svého účtu tím, že v nastavení účtu budete často měnit heslo.</span></a></div></div>
</div></div></div></div></div></div>
</div></section><section id="privileges"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Uživatelská oprávnění</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-twocolumn">
<div class="links-divs">
