...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Cambiar su contraseña</span></h1></div>
<div class="region">
...
<li class="steps">
<p class="p">Introduzca su contraseña actual y luego una contraseña nueva. Introduzca su contraseña nueva una vez más en el campo <span class="gui">Confirmar contraseña nueva</span>.</p>
<p class="p">Puede pulsar el icono <span class="gui"><span class="media"><span class="media media-image"><img src="figures/system-run-symbolic.svg" height="16" width="16" class="media media-inline" alt="generar contraseña"></span></span></span> para generar automáticamente una contraseña aleatoria.</p>
</li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Cuando actualiza su contraseña de inicio de sesión, la contraseña del depósito de claves se actualiza automáticamente para que coincida con su nueva contraseña.</p></div></div></div>
</div>
