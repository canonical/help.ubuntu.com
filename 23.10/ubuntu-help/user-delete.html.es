...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Eliminar una cuenta de usuario</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Puede <span class="link"><a href="user-add.html.es" title="Añadir una cuenta de usuario nueva">añadir varias cuentas de usuario a su equipo</a></span>. Si alguien no va a volver a usar su equipo, puede eliminar esa cuenta de usuario.</p>
<p class="p">Necesita <span class="link"><a href="user-admin-explain.html.es" title="¿Cómo funcionan los privilegios de administrador?">privilegios de administrador</a></span> para eliminar cuentas de usuario.</p>
