...
<div class="links-divs"><div class="linkdiv "><a class="linkdiv" href="backup-what.html.ru" title="Что копировать"><span class="title">Что копировать</span><span class="linkdiv-dash"> — </span><span class="desc">Делайте резервные копии всего, что не хотите потерять в случае сбоя.</span></a></div></div>
</div></div></div></div>
</div>
