...
<p class="p">Click <span class="gui">Start Benchmarking…</span> to test how fast data can be read
      from the disk. <span class="link"><a href="user-admin-explain.html.nl" title="Hoe werken beheerdersrechten?">Administrative
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Als <span class="gui">Schrijfbenchmark uitvoeren</span> is aangevinkt, dan zal er getest worden hoe snel gegevens gelezen van en geschreven naar de schijf kunnen worden. Dit zal langer duren.</p></div></div></div>
</div>
</li>
</ol></div></div></div>
