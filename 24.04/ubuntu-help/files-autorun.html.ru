...
<dd class="terms"><p class="p">Choose your favorite video application to handle video DVDs. Use the
    ...
    do not work correctly when you insert them, see <span class="link"><a href="video-dvd.html.ru" title="Почему не воспроизводятся DVD?">Почему не воспроизводятся DVD?</a></span>.
    </p></dd>
