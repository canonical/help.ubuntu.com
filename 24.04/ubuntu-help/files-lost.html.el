...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Εύρεση ενός χαμένου αρχείου</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">You might have renamed the file in a way that made the file hidden.
  ...
  <span class="link"><a href="files-hidden.html.el" title="Απόκρυψη ενός αρχείου">Απόκρυψη ενός αρχείου</a></span> to learn more.</p></li>
</ul></div></div></div>
</div>
