...
<title>Encontrar un archivo perdido</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Encontrar un archivo perdido</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Si ha creado o descargado un archivo, pero no sabe dónde está, siga estos consejos.</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Si no recuerda dónde guardó el archivo, pero tiene cierta idea de cómo se llama, puede buscarlo por su nombre. Consulte la sección <span class="link"><a href="files-search.html.es" title="Buscar archivos">búsqueda por nombre del archivo</a></span>.</p></li>
...
<li class="list"><p class="p">You might have renamed the file in a way that made the file hidden.
  ...
  <span class="link"><a href="files-hidden.html.es" title="Ocultar un archivo">Ocultar un archivo</a></span> to learn more.</p></li>
</ul></div></div></div>
</div>
