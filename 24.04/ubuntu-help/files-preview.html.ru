...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Предварительный просмотр файлов и папок</span></h1></div>
<div class="region">
...
<p class="p">Для выполнения этих действий на вашем компьютере должно быть установлено приложение <span class="app">Sushi</span>.</p>
<p class="p"><span class="link-button link"><a href="apt:gnome-sushi" title="apt:gnome-sushi">Установить <span class="app">Sushi</span></a></span></p>
</div></div></div>
</div>
...
<p class="p">Чтобы развернуть предварительный просмотр на полный экран, нажмите <span class="key"><kbd>F</kbd></span> или <span class="key"><kbd>F11</kbd></span>. Нажмите <span class="key"><kbd>F</kbd></span> или <span class="key"><kbd>F11</kbd></span> повторно, чтобы выйти из полноэкранного режима, или нажмите пробел, чтобы окончательно покинуть режим предварительного просмотра.</p>
</div>
...
<a href="nautilus-preview.html.ru" title="Параметры вкладки Образцы менеджера файлов">Параметры вкладки <span class="gui">Образцы</span> менеджера файлов</a><span class="desc"> — Настройки миниатюр для файлов.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
