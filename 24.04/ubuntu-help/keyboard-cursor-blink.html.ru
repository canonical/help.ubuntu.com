...
<li class="steps"><p class="p">В разделе <span class="gui">Помощник ввода</span> переведите переключатель <span class="gui">Мигание курсора</span> в положение «включено».</p></li>
<li class="steps"><p class="p">Для изменения скорости мигания курсора используйте ползунок <span class="gui">Скорость мигания</span>.</p></li>
</ol></div></div></div>
</div>
