...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Preferencias del gestor de archivos</span></h1></div>
<div class="region">
...
<div class="linkdiv "><a class="linkdiv" href="nautilus-views.html.es" title="Preferencias de vistas en Archivos"><span class="title">Preferencias de vistas en <span class="app">Archivos</span></span><span class="linkdiv-dash"> — </span><span class="desc">Specify the default sort order for files and folders.</span></a></div>
</div></div></div></div></div>
