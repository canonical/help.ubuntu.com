...
<div class="linkdiv "><a class="linkdiv" href="nautilus-views.html.ru" title="Параметры просмотра файлов и папок в приложении Файлы"><span class="title">Параметры просмотра файлов и папок в приложении <span class="app">Файлы</span></span><span class="linkdiv-dash"> — </span><span class="desc">Specify the default sort order for files and folders.</span></a></div>
</div></div></div></div></div>
