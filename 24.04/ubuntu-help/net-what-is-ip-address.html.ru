...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">IP-адрес может быть <span class="em">динамическим</span> или <span class="em">статическим</span>. Динамические IP-адреса назначаются временно при каждом подключении компьютера к сети. Статические IP-адреса являются постоянными, то есть не меняются. Динамические IP-адреса используются чаще статических — статические IP-адреса обычно используют только для специальных нужд, например для администрирования сервера.</p></div></div></div>
</div>
</div>
