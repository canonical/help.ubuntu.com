...
<li class="steps"><p class="p">Když je připojení úspěšné, změní se ikona na tečku s několika čárkami nad sebou (<span class="media"><span class="media media-image"><img src="figures/topbar-network-wireless-signal-excellent.svg" height="28" width="28" class="media media-inline" alt=""></span></span>). Čárky ukazují sílu signálu bezdrátové sítě. Málo čárek znamená slabý signál a spojení pak může být velmi nespolehlivé.</p></li>
</ol></div></div></div>
