...
<li class="steps"><p class="p">Als de verbinding geslaagd is, dan zal het pictogram in een punt met een paar balkjes erboven (<span class="media"><span class="media media-image"><img src="figures/topbar-network-wireless-signal-excellent.svg" height="28" width="28" class="media media-inline" alt=""></span></span>) veranderen. Hoe meer balkjes er zijn, hoe beter de verbinding met het netwerk. Als er niet veel balkjes zijn, dan is de verbinding zwak en mogelijk niet erg betrouwbaar.</p></li>
</ol></div></div></div>
