...
<a href="net-wireless-troubleshooting-initial-check.html.ru" title="Устранение неполадок с беспроводной сетью">Назад</a><a href="net-wireless-troubleshooting-hardware-check.html.ru" title="Устранение неполадок с беспроводными устройствами">Вперёд</a>
</div></nav><div class="hgroup pagewide">
<h1 class="title"><span class="title">Устранение неполадок с беспроводной сетью</span></h1>
<h2 class="subtitle"><span class="subtitle">Сбор информации о беспроводном оборудовании</span></h2>
</div>
<div class="region">
<div class="contents pagewide">
<p class="p">На этом этапе вы соберёте информацию о своём беспроводном сетевом устройстве. Способ устранения многих проблем с беспроводными подключениями зависит от производителя и номера модели беспроводного адаптера, так что вам нужно будет записать эти сведения. Могут также пригодиться предметы, входящие в поставку вашего компьютера, такие как установочные диски с драйверами. Найдите следующие предметы, если они у вас есть:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Упаковку и инструкции для беспроводных устройств (особенно руководство пользователя для маршрутизатора)</p></li>
<li class="list"><p class="p">Диск с драйверами для беспроводного адаптера (даже если он содержит только драйверы для Windows)</p></li>
<li class="list"><p class="p">Информацию о производителе и номере модели компьютера, беспроводного адаптера и маршрутизатора. Обычно её можно найти на нижней или задней стороне устройства.</p></li>
<li class="list"><p class="p">Любые номера версий или редакций, которые нанесены на корпус или упаковку беспроводных сетевых устройств. Они могут быть особенно полезными, так что смотрите внимательно.</p></li>
