...
<p class="p"><span class="link"><a href="status-icons.html.ru#batteryicons" title="Значки аккумулятора">Значок состояния</a></span> на верхней панели показывает уровень заряда основной внутренней батареи, а также то, заряжается она в данный момент или нет. Индикатор заряда батареи в <span class="gui"><a href="shell-introduction.html.ru#systemmenu" title="Системное меню">системном меню</a></span> показывает уровень заряда в процентах. Значок на верхней панели также можно настроить для отображения в <span class="link"><a href="power-percentage.html.ru" title="Показывать состояние батареи в процентах">процентов</a></span>.</p>
</div>
