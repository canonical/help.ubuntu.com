...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Если использование <span class="cmd">ubuntu-bug</span> не сработало по какой-либо причине, <span class="link"><a href="https://help.ubuntu.com/community/ReportingBugs#Filing_bugs_manually_at_Launchpad.net" title="https://help.ubuntu.com/community/ReportingBugs#Filing_bugs_manually_at_Launchpad.net"> сообщите об ошибке вручную</a></span> и перейдите к шагу 4 данной инструкции.</p></div></div></div>
</div>
</li>
