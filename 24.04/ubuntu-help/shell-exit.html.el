...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Αποσύνδεση, τερματισμός ή αλλαγή χρηστών</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Όταν έχετε τελειώσει τη χρήση του υπολογιστή σας, μπορείτε να τον σβήσετε, να τον αναστείλετε (για εξοικονόμηση ισχύος) ή να τον αφήσετε αναμμένο και να αποσυνδεθείτε.</p></div>
<section id="logout"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Αποσύνδεση ή αλλαγή χρηστών</span></h2></div>
<div class="region">
<div class="contents pagewide">
<div class="media media-image floatend if-if if__not-target-mobile"><div class="inner"><img src="figures/shell-exit-expanded.png" width="250" class="media media-block" alt="Μενού χρήστη"></div></div>
...
<p class="p">To <span class="gui">Log Out</span> or <span class="gui">Switch User</span>, click the
  <span class="link"><a href="shell-introduction.html.el#systemmenu" title="System menu">system menu</a></span> on the right
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Οι καταχωρίσεις <span class="gui">Αποσύνδεση</span> και <span class="gui">Αλλαγή χρήστη</span> εμφανίζονται μόνο στο μενού εάν έχετε περισσότερους από έναν λογαριασμούς χρήστη στο σύστημά σας.</p></div></div></div>
</div>
</div>
...
<a href="user-add.html.el" title="Προσθήκη νέου λογαριασμού χρήστη">Προσθήκη νέου λογαριασμού χρήστη</a><span class="desc"> — Προσθήκη νέων χρηστών έτσι ώστε τα άλλα άτομα να μπορούν να συνδεθούν στον υπολογιστή.</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
</div></section><section id="lock-screen"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Κλείδωμα της οθόνης</span></h2></div>
<div class="region">
<div class="contents pagewide">
...
<li class="links ">
<a href="session-screenlocks.html.el" title="Η οθόνη κλειδώνει υπερβολικά γρήγορα">Η οθόνη κλειδώνει υπερβολικά γρήγορα</a><span class="desc"> — Change how long to wait before locking the screen in the
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Αναστολή</span></h2></div>
<div class="region">
<div class="contents pagewide">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Μπορεί να θελήσετε να κλείσετε τον υπολογιστή σας, εάν επιθυμείτε να τον μετακινήσετε και δεν έχετε μπαταρία, εάν η μπαταρία σας είναι χαμηλή ή δεν κρατά φορτίο καλά. Επίσης ένας απενεργοποιημένος υπολογιστής χρησιμοποιεί <span class="link"><a href="power-batterylife.html.el" title="Χρησιμοποιήστε λιγότερη ισχύ και βελτιώστε τη ζωή της μπαταρίας">λιγότερη ενέργεια</a></span> από έναν που είναι σε αναστολή.</p></div></div></div>
</div>
</div>
<section class="links" role="navigation"><div class="inner">
<div class="hgroup pagewide"></div>
