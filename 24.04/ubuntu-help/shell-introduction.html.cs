...
<p class="p">To access the overview at any time,
  ...
  <span class="key"><a href="keyboard-key-super.html.cs" title="Co je klávesa Super?"><kbd>Super</kbd></a></span> key on your keyboard.</p>
...
<div class="list"><div class="inner"><div class="region"><ul class="list compact">
<li class="list"><p class="p"><span class="link"><a href="shell-exit.html.cs" title="Odhlášení nebo přepnutí uživatele, vypnutí">Zjistěte si více o přepínání uživatelů, odhlašování se a vypínání počítače.</a></span></p></li>
<li class="list"><p class="p"><span class="link"><a href="quick-settings.html.cs" title="Quick Settings">Learn more about Quick
