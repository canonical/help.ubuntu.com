...
<li class="links "><a href="shell-introduction.html.sl#systemmenu" title="System menu">System menu</a></li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title"><span class="gui">Activities</span> overview</span></h2></div>
...
<p class="p">To access the overview at any time,
  ...
  <span class="key"><a href="keyboard-key-super.html.sl" title="What is the Super key?"><kbd>Super</kbd></a></span> key on your keyboard.</p>
...
<p class="p">At the bottom of the overview, you will
  find the <span class="em">dash</span>. The dash shows you your favorite and running
...
<p class="p">Desen klik na ikono prikaže meni, ki vam omogoča izbiro kateregakoi okna v izvajajočem se programu ali odprtje novega okna. Za odprtje novega okna lahko tudi kliknete na ikono medtem ko držite tipko <span class="key"><kbd>Ctrl</kbd></span>.</p>
<p class="p">When you enter the overview, you will
  initially be in the windows overview. This shows you live thumbnails of all
  the windows on the current workspace.</p>
<p class="p">Click the grid button (which has nine
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ura, koledar in sestanki</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<li class="list"><p class="p"><span class="link"><a href="shell-notifications.html.sl" title="Notifications and the notification list">Learn more about notifications and
...
<div class="region"><div class="contents pagewide">
<div class="media media-image floatend if-if if__not-target-mobile"><div class="inner"><img src="figures/shell-exit.png" width="250" class="media media-block" alt="Uporabniški meni"></div></div>
<p class="p">Click the system menu in the top-right corner to manage your system
  ...
  <span class="media"><span class="media media-image"><img src="figures/system-shutdown-symbolic.svg" class="media media-inline" alt="power"></span></span> button allows you to suspend or power off the computer, or
  ...
  brightness.</p>
<p class="p">The rest of the menu consists of Quick Settings buttons which let you
  quickly control available services and devices like Wi-Fi, Bluetooth, power
  settings, and background apps.</p>
<div class="list"><div class="inner"><div class="region"><ul class="list compact">
<li class="list"><p class="p"><span class="link"><a href="shell-windows.html.sl" title="Okna in delovne površine">Naučite se več o preklapljanju uporabnikov, odjavi in izklopu računalnika.</a></span></p></li>
<li class="list"><p class="p"><span class="link"><a href="quick-settings.html.sl" title="Quick Settings">Learn more about Quick
      Settings.</a></span></p></li>
</ul></div></div></div>
</div></div>
</div></section><section id="lockscreen"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Zakleni zaslon</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<div class="list"><div class="inner"><div class="region"><ul class="list compact"><li class="list"><p class="p"><span class="link"><a href="shell-lockscreen.html.sl" title="The lock screen">Izvejte več o zaklepanju zaslona.</a></span></p></li></ul></div></div></div>
</div></div>
</div></section><section id="window-list"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Window List</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<li class="links ">
<a href="shell-overview.html.sl" title="Your desktop">Your desktop</a><span class="desc"> — Work with apps, windows, and workspaces. See your appointments and
