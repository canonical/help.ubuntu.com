...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Iniciar sesión automáticamente</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Active la opción <span class="gui">Inicio de sesión automático</span>.</p></li>
</ol></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Si su cuenta es de tipo <span class="em">Estándar</span>, no podrá cambiar esta configuración; el administrador del sistema puede cambiar esto en su lugar.</p></div></div></div>
</div>
</div>
...
<a href="shell-exit.html.es" title="Cerrar la sesión, apagar o cambiar de usuario">Cerrar la sesión, apagar o cambiar de usuario</a><span class="desc"> — Aprender cómo salir de su cuenta de usuario, cerrando la sesión, cambiando de usuario, etc.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
