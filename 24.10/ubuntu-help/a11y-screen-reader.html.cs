...
<p class="p">Čtečku obrazovky <span class="app">Orca</span> umí říkat, co je na obrazovce v uživatelském rozhraní. V závislosti na tom, jak máte nainstalovaný systém, můžete mít čtečku Orca předinstalovanou. Pokud ne, musíte ji nejprve nainstalovat.</p>
...
<div class="region"><div class="contents"><p class="p">Čtečku obrazovky můžete zapnout nebo vypnout kliknutím na <span class="link"><a href="a11y-icon.html.cs" title="Vyhledání nabídky přístupnosti">ikonu zpřístupnění</a></span> na horní liště a následným výběrem položky <span class="gui">Čtečka obrazovky</span>.</p></div></div>
</div>
</div>
