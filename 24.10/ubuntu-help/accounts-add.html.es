...
<p class="p">Añadir una cuenta le ayudará a enlazar sus cuentas en línea con su escritorio. Por lo tanto, su programa de correo-e, calendario y otras aplicaciones relacionadas se configurarán.</p>
...
<p class="p">Después de haber añadido las cuentas, las aplicaciones puede usar esas cuentas para los servicios que haya permitido. Consulte la sección <span class="link"><a href="accounts-disable-service.html.es" title="Controlar qué servicios en línea puede usar una cuenta para acceder">Controlar qué servicios en línea puede usar una cuenta para acceder</a></span> para obtener más información sobre cómo controlar qué servicios permitir.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Muchos proveedores de servicios en línea proporcionan un testigo de autorización que GNOME guarda en lugar su contraseña. Si elimina una cuenta, debe revocar también ese certificado en la cuenta en línea. Consulte la <span class="link"><a href="accounts-remove.html.es" title="Quitar una cuenta">Quitar una cuenta</a></span> para obtener más información.</p></div></div></div>
</div>
</div>
