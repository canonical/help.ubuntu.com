...
<p class="p">Если вы хотите увидеть все скрытые файлы в папке, перейдите в эту папку и либо нажмите кнопку меню на боковой панели и выберите <span class="gui">Показывать скрытые файлы</span>, либо нажмите <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>H</kbd></span></span>. Менеджер файлов отобразит как скрытые, так и обычные файлы.</p>
<p class="p">Чтобы снова скрыть эти файлы, нажмите кнопку меню на боковой панели и отключите параметр <span class="gui">Показывать скрытые файлы</span>, либо нажмите <span class="keyseq"><span class="key"><kbd> Ctrl</kbd></span>+<span class="key"><kbd>H</kbd></span></span>.</p>
</div></div>
...
<div class="region"><div class="contents pagewide">
<p class="p">Чтобы сделать файл обычным, а не скрытым, перейдите в папку, содержащую скрытый файл. Нажмите кнопку меню на боковой панели и выберите <span class="gui">Показывать скрытые файлы</span> или нажмите <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>H</kbd></span></span>. Затем найдите скрытый файл и переименуйте его так, чтобы перед его названием не стояла <span class="file">.</span>. Например, чтобы сделать обычным скрытый файл с названием <span class="file">.example.txt</span>, вы должны переименовать его в <span class="file">example.txt</span>.</p>
<p class="p">После того, как вы переименовали файл, вы можете либо нажать кнопку меню на боковой панели и выбрать <span class="gui">Показывать скрытые файлы</span>, либо нажать <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>H</kbd></span></span>, чтобы снова скрыть любые другие скрытые файлы.</p>
<div class="note" title="Примечание">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
