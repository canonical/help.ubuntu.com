...
<p class="p">Доступные способы сортировки файлов зависят от используемого вами <span class="em">режима просмотра папки</span>. Изменить текущий режим можно с помощью кнопки «Вид списком/сеткой» на панели инструментов.</p>
</div>
<section id="icon-view"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Просмотр в виде сетки</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Чтобы изменить способ сортировки файлов, нажмите кнопку варианта просмотра на панели инструментов и выберите <span class="gui">А-Я</span>, <span class="gui">Я-А</span>, <span class="gui">Последнее изменение</span>, <span class="gui">Первое изменение</span>, <span class="gui">Размер</span> или <span class="gui">Тип</span>.</p>
<p class="p">Например, при выборе варианта <span class="gui">А-Я</span> файлы будут отсортированы по их именам в алфавитном порядке. О других вариантах смотрите <span class="link"><a href="#ways" title="Способы сортировки файлов">Способы сортировки файлов</a></span>.</p>
</div></div>
...
<p class="p">Для получения дополнительных параметров сортировки нажмите кнопку варианта просмотра на панели инструментов.</p>
...
<dt class="terms">А-Я</dt>
<dd class="terms"><p class="p">Сортировка названий файлов в алфавитном порядке.</p></dd>
<dt class="terms">Я-А</dt>
<dd class="terms"><p class="p">Сортировка названий файлов по алфавиту в обратном порядке.</p></dd>
<dt class="terms">Последнее изменение</dt>
<dd class="terms"><p class="p">Сортировка по дате и времени последнего изменения файла. Сортируется по изменению файла от самого старого к самому новому.</p></dd>
<dt class="terms">Первое изменение</dt>
<dd class="terms"><p class="p">Сортировка по дате и времени последнего изменения файла. Сортируется по изменению файла от самого нового к самому старому.</p></dd>
