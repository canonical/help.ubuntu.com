...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">What is a file with a <span class="file">~</span> at the end of its name?</span></h1></div>
<div class="region">
...
<p class="p">Te datoteke se obravnavajo na enak način kot običajne skrite datoteke. Za nasvet o upravljanju s skritimi datotekami si oglejte <span class="link"><a href="files-hidden.html.sl" title="Skritje datoteke">Skritje datoteke</a></span>.</p>
</div>
...
<a href="files-hidden.html.sl" title="Skritje datoteke">Skritje datoteke</a><span class="desc"> — Make a file invisible, so you cannot see it in the file
    manager.</span>
</li></ul></div>
</div></div>
</div>
