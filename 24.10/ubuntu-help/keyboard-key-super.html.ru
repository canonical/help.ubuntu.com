...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Что такое клавиша <span class="key"><kbd>Super</kbd></span>?</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">На клавиатурах Apple вместо клавиши Windows расположена клавиша командная клавиша <span class="key"><kbd>⌘</kbd></span>, а на Chromebook — клавиша со значком лупы.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Выберите категорию <span class="gui">Система</span>.</p></li>
<li class="steps"><p class="p">Щёлкните строку <span class="gui">Показать обзор</span>.</p></li>
