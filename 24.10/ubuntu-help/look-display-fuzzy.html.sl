...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Zakaj je moj zaslon videti meglen/točkast?</span></h1></div>
<div class="region">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Ko je priklopljenih več zaslonov</span></h2></div>
...
<p class="p">If you have two displays connected to the computer (for example, a normal
  ...
  <span class="link"><a href="look-resolution.html.sl#native" title="Native Resolution">native</a></span>, resolutions.</p>
<p class="p">Using <span class="link"><a href="display-dual-monitors.html.sl#modes" title="Display modes">Mirror</a></span> mode, you can
...
<p class="p">Using <span class="link"><a href="display-dual-monitors.html.sl#modes" title="Display modes">Join Displays</a></span> mode,
...
<a href="look-resolution.html.sl" title="Change the resolution or orientation of the screen">Change the resolution or orientation of the screen</a><span class="desc"> — Sprememba ločljivosti zaslona in njegove usmerjenosti (vrtenje).</span>
</li></ul></div>
</div></div>
</div>
</div></section>
