...
<li class="steps"><p class="p">Vyberte orientaci, rozlišení nebo škálování a obnovovací frekvenci.</p></li>
...
<p class="p">U některých zařízení je možné obrazovku fyzicky otočit do rozličných směrů. Klikněte v panelu na <span class="gui">Orientace</span> a zvolte z <span class="gui">Na šířku</span>, <span class="gui">Na výšku vpravo</span>, <span class="gui">Na výšku vlevo</span> nebo <span class="gui">Na šířku (překlopené)</span>.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Pokud vaše zařízení otáčí obrazovku automaticky, můžete aktuální otočení uzamknout pomocí tlačítka <span class="media"><span class="media media-image"><img src="figures/rotation-locked-symbolic.svg" class="media media-inline" alt="zamknout otáčení"></span></span> ve spodní části <span class="gui"><a href="shell-introduction.html.cs#systemmenu" title="Nabídka systému">nabídky systému</a></span>. K odemknutí zmáčkněte tlačítko <span class="media"><span class="media media-image"><img src="figures/rotation-allowed-symbolic.svg" class="media media-inline" alt="odemknout otáčení"></span></span>.</p></div></div></div>
</div>
</div></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Obnovovací frekvence</span></h2></div>
<div class="region">
<div class="contents pagewide"><p class="p">Obnovovací frekvence určuje, kolikrát za sekundu se překreslí nebo obnoví obraz na obrazovce.</p></div>
...
<div class="region"><div class="contents pagewide"><p class="p">Nastavení škálování zvětšuje velikost objektů zobrazených na obrazovce, aby lépe vyhovovaly hustotě bodů vašeho displeje a byly tak snáze čitelné. Můžete volit mezi <span class="gui">100 %</span> nebo <span class="gui">200 %</span>.</p></div></div>
