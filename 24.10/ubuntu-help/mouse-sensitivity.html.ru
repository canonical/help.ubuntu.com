...
<li class="steps"><p class="p">Отрегулируйте ползунок <span class="gui">Скорость курсора</span>  пока движение указателя не станет для вас удобным. Иногда самые удобные настройки для одного типа устройств не подходят для другого.</p></li>
</ol></div></div></div>
