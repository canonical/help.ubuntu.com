...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Нажатие вторичной кнопки</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Вы можете настроить действие нажатия вторичной (правой) кнопкой мыши на сенсорной панели.</p>
<div class="list"><div class="inner"><div class="region"><ol class="list" style="list-style-type:bullet">
<li class="list"><p class="p">Нажатие двумя пальцами: Нажмите двумя пальцами в любом месте.</p></li>
<li class="list"><p class="p">Нажатие в углу: Надавите одним пальцем на угол.</p></li>
</ol></div></div></div>
<div class="steps"><div class="inner">
<div class="title title-steps"><h3><span class="title">Выберите способ обработки нажатия вторичной кнопки</span></h3></div>
...
<li class="steps"><p class="p">Нажмите <span class="gui">Мышь и сенсорная панель</span>, чтобы открыть этот раздел настроек.</p></li>
<li class="steps"><p class="p">Нажмите <span class="gui">Сенсорная панель</span> на верхней панели.</p></li>
<li class="steps"><p class="p">В разделе <span class="gui">Нажатие</span> выберите подходящий способ обработки нажатия.</p></li>
</ol></div>
</div></div>
</div></div>
