...
<p class="p">Права доступа можно использовать, чтобы управлять тем, у кого из пользователей будет возможность просматривать и редактировать принадлежащие вам файлы. Чтобы просмотреть и задать права доступа к файлу, нажмите на него правой кнопкой и выберите <span class="gui">Свойства</span>, затем откройте вкладку <span class="gui">Разрешения</span>.</p>
...
<p class="p">Если файл является программой, например, сценарием, то для его запуска, вы должны перевести переключатель <span class="gui">Исполняемый как приложение</span> во включённое положение. Даже если этот параметр будет включён, файловый менеджер всё равно будет открывать его в приложении. Подробнее смотрите <span class="link"><a href="nautilus-behavior.html.ru#executable" title="Исполняемые текстовые файлы">Исполняемые текстовые файлы</a></span>.</p>
</div></div>
