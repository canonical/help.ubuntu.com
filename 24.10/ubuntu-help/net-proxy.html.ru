...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Настройка прокси-сервера</span></h1></div>
<div class="region">
<div class="contents pagewide"></div>
<section id="what"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Что такое прокси?</span></h2></div>
<div class="region"><div class="contents pagewide"><p class="p"><span class="em">Прокси-сервер</span> фильтрует содержимое просматриваемых вами веб-сайтов. Он получает запросы на загрузку веб-страниц и их элементов от веб-браузера и, следуя заданным правилам, решает, пропускать их или нет. Обычно прокси используют в бизнесе и в публичных беспроводных точках доступа, чтобы управлять тем, какие сайты вы можете просматривать, запрещать пользователям доступ в Интернет без авторизации или проверять безопасность веб-сайтов.</p></div></div>
</div></section><section id="change"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Изменение режима прокси-сервера</span></h2></div>
