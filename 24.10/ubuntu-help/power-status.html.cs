...
<div class="trail">
<span style="color: #333">Ubuntu 24.10</span> » <a class="trail" href="index.html.cs" title="Průvodce pracovním prostředím Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Nápověda"></span></span> Průvodce pracovním prostředím Ubuntu</a> » <a class="trail" href="shell-overview.html.cs" title="Vaše uživatelské prostředí">Uživatelské prostředí</a> › <a class="trail" href="shell-overview.html.cs#apps" title="Aplikace a okna">Aplikace a okna</a> » <a class="trail" href="status-icons.html.cs" title="Co znamenají ikony na horní liště?">Co znamenají ikony na horní liště?</a> » </div>
<div class="trail">
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Kontrola stavu baterie</span></h1></div>
<div class="region">
...
<p class="p">The <span class="link"><a href="status-icons.html.cs#batteryicons" title="Ikony baterie">status icon</a></span> in the top
    ...
    <span class="gui"><a href="shell-introduction.html.cs#systemmenu" title="Nabídka systému">system menu</a></span> shows
    the charge as a percentage. The top bar icon can also be configured to
    display the <span class="link"><a href="power-percentage.html.cs" title="Zobrazení procent baterie">percentage</a></span>.</p>
</div>
...
<div class="region"><ul>
<li class="links ">
<a href="status-icons.html.cs" title="Co znamenají ikony na horní liště?">Co znamenají ikony na horní liště?</a><span class="desc"> — Vysvětlení významu ikon nacházejících se vpravo na horní liště.</span>
</li>
<li class="links ">
