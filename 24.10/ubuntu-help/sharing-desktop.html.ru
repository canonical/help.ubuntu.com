...
<div class="region"><div class="contents pagewide">
<p class="p">В разделе <span class="gui">Аутентификация</span> будут показаны регистрационные данные необходимые для использования в клиентском программном обеспечении на устройстве, с которым устанавливается соединение.


В разделе <span class="gui">Данные для входа</span> будут показаны имя пользователя и пароль, которые необходимо использовать в клиентском программном обеспечении для подключения к вашему рабочему столу.</p>
