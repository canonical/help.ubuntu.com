...
<li class="steps"><p class="p">Переведите переключатель <span class="gui">Общий доступ к мультимедиа</span> в положение «выключено».</p></li>
...
<li class="steps"><p class="p">Закройте диалоговое окно <span class="gui">Общий доступ к медиа</span>. Теперь вы сможете просматривать файлы и проигрывать мультимедиа из выбранных папок с внешнего устройства.</p></li>
</ol></div></div></div>
</div>
