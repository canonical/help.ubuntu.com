...
<li class="steps"><div class="note" title="Примечание">
<svg width="24" height="24" version="1.1">
...
<li class="steps"><p class="p">Выберите <span class="gui">Общий доступ к файлам</span>.</p></li>
<li class="steps">
<p class="p">Переведите переключатель <span class="gui">Общий доступ к файлам</span> в положение «включено». Данная функция определяет, что другие люди в вашей сети смогут попытаться подключиться к вашему компьютеру и получить доступ к вашим файлам в папке <span class="file">Общедоступные</span>.</p>
...
<dd class="terms">
<p class="p">Если вы хотите установить пароль на доступ других пользователей к <span class="file">Общедоступной</span> папке, переведите переключатель <span class="gui">Требовать пароль</span> в положение «включено». Без этого параметра любой сторонний пользователь сможет попробовать просмотреть вашу <span class="file">Общедоступную</span> папку.</p>
