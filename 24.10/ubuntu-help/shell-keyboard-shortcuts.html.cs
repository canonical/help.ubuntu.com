...
<div class="trail">
<span style="color: #333">Ubuntu 24.10</span> » <a class="trail" href="index.html.cs" title="Průvodce pracovním prostředím Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Nápověda"></span></span> Průvodce pracovním prostředím Ubuntu</a> » <a class="trail" href="shell-overview.html.cs" title="Vaše uživatelské prostředí">Uživatelské prostředí</a> › <a class="trail" href="shell-overview.html.cs#apps" title="Aplikace a okna">Aplikace a okna</a> » </div>
<div class="trail">
...
<div class="trail">
<span style="color: #333">Ubuntu 24.10</span> » <a class="trail" href="index.html.cs" title="Průvodce pracovním prostředím Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Nápověda"></span></span> Průvodce pracovním prostředím Ubuntu</a> » <a class="trail" href="tips.html.cs" title="Tipy a triky">Tipy a triky</a> » </div>
</div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Užitečné klávesové zkratky</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Tato stránka shrnuje klávesové zkratky, které vám mohou pomoci k efektivnějšímu používání počítače. Nemůžete-li použít myš nebo jiné polohovací zařízení, podívejte se na <span class="link"><a href="keyboard-nav.html.cs" title="Ovládání klávesnicí">Ovládání klávesnicí</a></span>, kde se dozvíte více o pohybu v rozhraní pouze pomocí klávesnice.</p>
<div class="table ui-expander">
<div class="yelp-data yelp-data-ui-expander" dir="ltr" data-yelp-expanded="true"></div>
<div class="inner">
<div class="title title-table"><h2><span class="title">Pohyb v uživatelském prostředí</span></h2></div>
<div class="region"><table class="table" style="border-top-style: solid;border-bottom-style: solid;">
<tr>
<td><p class="p">klávesa <span class="key"><a href="keyboard-key-super.html.cs" title="Co je klávesa Super?"><kbd>Super</kbd></a></span></p></td>
...
<td style="border-top-style: solid;"><p class="p">Přepnout mezi okny v rámci aktuální pracovní plochy. Přidržením klávesy <span class="key"><kbd>Shift</kbd></span> obrátíte pořadí.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Zobrazí seznam aplikací.</p></td>
</tr>
<tr>
<td style="border-top-style: solid;">
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-exit.html.cs" title="Odhlášení nebo přepnutí uživatele, vypnutí">Zobrazit dialogové okno Vypnout</a></span>.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-exit.html.cs#lock-screen" title="Zamknutí obrazovky">Uzamknout obrazovku</a></span>.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Zobrazit <span class="link"><a href="shell-notifications.html.cs#notificationlist" title="Seznam upozornění">seznam upozornění.</a></span> Zmáčknutím <span class="key"><kbd>Esc</kbd></span> nebo opětovně <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>V</kbd></span></span> jej zavřete.</p></td>
</tr>
</table></div>
</div>
</div>
...
<div class="inner">
<div class="title title-table"><h2><span class="title">Klávesové zkratky pro běžné úpravy</span></h2></div>
<div class="region"><table class="table" style="border-top-style: solid;border-bottom-style: solid;">
<tr>
<td><p class="p"><span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>A</kbd></span></span></p></td>
<td><p class="p">Vybrat celý text nebo všechny položky v seznamu.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Vyjmout (tj. odstranit) vybraný text nebo položky a přesunout je do schránky.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Zkopírovat vybraný text nebo položky do schránky.</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p">Vložit obsah ze schránky.</p></td>
</tr>
<tr>
...
<div class="yelp-data yelp-data-ui-expander" dir="ltr" data-yelp-expanded="false"></div>
<div class="inner">
<div class="title title-table"><h2><span class="title">Zachycení obrazovky</span></h2></div>
<div class="region"><table class="table" style="border-top-style: solid;border-bottom-style: solid;">
<tr>
<td><p class="p"><span class="key"><kbd>Print Screen</kbd></span></p></td>
<td><p class="p"><span class="link"><a href="screen-shot-record.html.cs#screenshot" title="Pořídit snímek obrazovky">Launch the screenshot tool.</a></span></p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="screen-shot-record.html.cs#screenshot" title="Pořídit snímek obrazovky">Pořídit snímek okna.</a></span></p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="screen-shot-record.html.cs#screenshot" title="Pořídit snímek obrazovky">Take a screenshot of the
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="screen-shot-record.html.cs#screencast" title="Pořízení nahrávky obrazovky">Začne nebo přestane nahrávat dění na obrazovce.</a></span></p></td>
</tr>
</table></div>
</div>
</div>
...
<div class="region"><ul>
<li class="links "><a href="shell-overview.html.cs#apps" title="Aplikace a okna">Aplikace a okna</a></li>
<li class="links ">
...
<li class="links ">
<a href="tips.html.cs" title="Tipy a triky">Tipy a triky</a><span class="desc"> — Jak využít GNOME na maximum díky pár užitečným tipům.</span>
</li>
</ul></div>
</div></div>
