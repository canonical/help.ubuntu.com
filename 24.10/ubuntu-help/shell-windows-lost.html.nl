...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Zoeken naar een verloren venster</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">Click different workspaces in the
      <span class="link"><a href="shell-workspaces.html.nl" title="Wat is een werkblad en hoe kan ik het gebruiken?">workspace selector</a></span>
...
<li class="list"><p class="p">Als een toepassing meerdere geopende vensters heeft, dan houdt u <span class="key"><kbd>Super</kbd></span> ingedrukt en drukt u op <span class="key"><kbd>`</kbd></span> (of de toets boven <span class="key"><kbd>Tab</kbd></span>) om erdoorheen te bladeren.</p></li>
</ul></div></div></div>
</div>
