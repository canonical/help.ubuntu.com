...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">¿Qué es un área de trabajo y cómo me ayudará?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Las áreas de trabajo se refieren a la agrupación de ventanas en su escritorio. Puede crear varias áreas de trabajo, que actúan como escritorios virtuales. Las áreas de trabajo están destinadas a reducir el desorden y hacer que el escritorio sea sencillo de examinar.</p>
...
<li class="list"><p class="p">In the
    <span class="gui"><a href="shell-introduction.html.es#activities" title="Vista de Actividades">Activities</a></span> overview, you can
...
<p class="p">Siempre hay al menos un área de trabajo.</p>
<div class="media media-image"><div class="inner"><img src="figures/shell-workspaces.png" height="291" width="940" class="media media-block" alt="Selector de áreas de trabajo"></div></div>
</div>
