...
<li class="steps"><p class="p">Press the <span class="gui">Add User...</span> button under
      <span class="gui">Other Users</span> to add a new user account.</p></li>
<li class="steps">
...
<p class="p">To connect the user to a network domain, click
      <span class="gui">Enterprise Login</span>.</p>
</li>
<li class="steps"><p class="p">Click <span class="gui">Add</span>. When the user has been added,
      <span class="gui">Parental Controls</span> and <span class="gui">Language</span> settings can be
      adjusted.</p></li>
</ol></div></div></div>
...
<div class="region"><ul>
<li class="links "><a href="shell-exit.html.cs#logout" title="Odhlášení nebo přepnutí uživatelů">Odhlášení nebo přepnutí uživatelů</a></li>
<li class="links ">
