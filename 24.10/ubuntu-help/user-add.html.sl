...
<title>Dodajanje novega uporabniškga računa</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Dodajanje novega uporabniškga računa</span></h1></div>
<div class="region">
...
<p class="p">If you want the new user to have
      <span class="link"><a href="user-admin-explain.html.sl" title="Kako delujejo skrbniška dovoljenja?">administrative access</a></span> to the
...
<li class="links "><a href="shell-exit.html.sl#logout" title="Odjava ali preklop uporabnika">Odjava ali preklop uporabnika</a></li>
</ul></div>
</div></div>
</div>
</div></section>
