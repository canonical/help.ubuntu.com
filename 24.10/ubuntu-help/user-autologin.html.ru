...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Автоматический вход</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Если вы хотите автоматически войти в другую учётную запись, выберите её в разделе <span class="gui">Другие пользователи</span>.</p></li>
<li class="steps"><p class="p">Переведите переключатель <span class="gui">Автоматический вход</span> в положение «включено».</p></li>
</ol></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Если учётная запись имеет <span class="em">Обычный</span> тип, эту настройку поменять нельзя. Обратитесь к вашему системному администратору.</p></div></div></div>
</div>
</div>
...
<a href="shell-exit.html.ru" title="Выход из системы, выключение компьютера или переключение пользователей">Выход из системы, выключение компьютера или переключение пользователей</a><span class="desc"> — Способы завершения работы с учётной записью: выход из системы, переключение пользователей и другие.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
