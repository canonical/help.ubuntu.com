...
<li class="steps"><p class="p">Нажмите на метку <span class="gui">·····</span> рядом с <span class="gui">Паролем</span>. Для смены пароля другого пользователя понадобится <span class="gui">Разблокировать</span> панель и выбрать учётную запись в разделе <span class="gui">Другие пользователи</span>.</p></li>
<li class="steps">
