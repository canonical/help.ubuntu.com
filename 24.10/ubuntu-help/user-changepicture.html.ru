...
<li class="steps"><p class="p">Если вам нужно изменить параметры учётной записи другого пользователя, нажмите <span class="gui">Разблокировать</span> в верхнем правом углу окна и по запросу введите свой пароль. Выберите пользователя в разделе <span class="gui">Другие пользователи</span>.</p></li>
<li class="steps">
<p class="p">Нажмите значок карандаша рядом с именем пользователя. Откроется галерея с несколькими стандартными изображениями. Если одно из них вам понравилась, нажмите на него, чтобы выбрать его для своей учётной записи.</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Если вы предпочитаете использовать изображение, уже имеющееся на компьютере, нажмите <span class="gui">Выберите файл...</span>.</p></li>
<li class="list"><p class="p">Если у вас есть веб-камера, можно сделать новую фотографию для учётной записи прямо сейчас, нажав <span class="gui">Сделать снимок...</span>. Сделайте снимок, затем переместите и измените размер рамки, чтобы получить нужный фрагмент картинки. Если сделанный снимок не понравился, нажмите <span class="gui">Сделать другой снимок</span>, чтобы попробовать снова, или <span class="gui">Отменить</span>, если вы передумали добавлять снимок.</p></li>
</ul></div></div></div>
</li>
</ol></div></div></div>
</div>
