...
<title>Найти меню специальных возможностей</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Найти меню специальных возможностей</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p"><span class="em">Меню специальных возможностей</span> позволяет включать и отключать различные настройки специальных возможностей. Чтобы открыть это меню, нажмите на значок в виде человечка, находящийся в верхней панели.</p>
...
<div class="desc">Меню специальных возможностей может быть найдено в верхней панели.</div>
</div>
</div></div>
<p class="p">Если вы не видите меню специальных возможностей, то его можно включить на панели настроек <span class="gui">Специальные возможности</span>:</p>
...
<a href="a11y.html.ru" title="Специальные возможности">Специальные возможности</a><span class="desc"> — Используйте вспомогательные технологии, чтобы помочь с особыми потребностями для зрения, слуха и подвижности.</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
