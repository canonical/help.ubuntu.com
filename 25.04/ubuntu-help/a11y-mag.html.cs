...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Zvětšení části obrazovky</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Funkci lupy můžete rychle zapnout a vypnout kliknutím na <span class="link"><a href="a11y-icon.html.cs" title="Vyhledání nabídky přístupnosti">ikonu zpřístupnění</a></span> na horní liště a následným vybráním <span class="gui">Přiblížit</span>.</p></div></div></div>
</div>
