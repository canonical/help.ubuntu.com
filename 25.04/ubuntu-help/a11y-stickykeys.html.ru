...
<li class="steps"><p class="p">В разделе <span class="gui">Помощник нажатия</span> переведите переключатель <span class="gui">Залипающие клавиши</span> в положение «включено».</p></li>
</ol></div></div></div>
