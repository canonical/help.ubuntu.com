...
<div class="linkdiv "><a class="linkdiv" href="accounts-add.html.es" title="Añadir una cuenta"><span class="title">Añadir una cuenta</span><span class="linkdiv-dash"> — </span><span class="desc">Permitir a las aplicaciones acceder a sus cuentas en línea para archivos, contactos, calendarios y más.</span></a></div>
