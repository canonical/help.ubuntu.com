...
<p class="p">Файлы или папки, имена которых начинаются с точки (.), по умолчанию являются скрытыми. Чтобы увидеть скрытые файлы, нажмите кнопку меню на боковой панели окна приложения <span class="app">Файлы</span> и отметьте <span class="gui">Показывать скрытые файлы</span>, или нажмите комбинацию клавиш <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>H</kbd></span></span>. Их можно копировать в место хранения резервной копии, как и любые другие файлы.</p>
</li>
<li class="list">
