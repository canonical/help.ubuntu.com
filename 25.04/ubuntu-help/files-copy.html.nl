...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Bestanden en mappen kopiëren of verplaatsen</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">U kunt niet een bestand kopiëren of verplaatsen naar een map die <span class="em">alleen-lezen</span> is. Sommige mappen zijn alleen-lezen om te voorkomen dat u wijzigingen aanbrengt aan de inhoud ervan. U kunt de instelling alleen-lezen wijzigen door de <span class="link"><a href="nautilus-file-properties-permissions.html.nl" title="Bestandsrechten instellen">bestandsrechten te wijzigen</a></span>.</p></div></div></div>
</div>
</div>
