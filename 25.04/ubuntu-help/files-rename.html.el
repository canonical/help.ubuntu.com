...
<div class="region"><ul>
<li class="links ">
<a href="files-rename-multiple.html.el" title="Rename multiple files">Rename multiple files</a><span class="desc"> — Rename more than one file at once.</span>
</li>
<li class="links ">
<a href="files-rename-music-metadata.html.el" title="Rename music files using metadata">Rename music files using metadata</a><span class="desc"> — Rename music files using metadata they contain.</span>
</li>
</ul></div>
</div></div>
</div>
