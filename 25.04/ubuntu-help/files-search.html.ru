...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Вместо того, чтобы вводить слова напрямую, вы можете вызвать панель поиска нажав <span class="media"><span class="media media-image"><img src="figures/nautilus-folder-search-symbolic.svg" class="media media-inline" alt="Search key symbol"></span></span> на панели инструментов или нажать <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>F</kbd></span></span>.</p></div></div></div>
</div>
</li>
<li class="steps">
...
<p class="p">Чтобы применить фильтры, нажмите кнопку раскрывающегося меню слева от значка <span class="media"><span class="media media-image"><img src="figures/nautilus-folder-search-symbolic.svg" class="media media-inline" alt="Search key symbol"></span></span> в файловом менеджере и выберите один из доступных фильтров:</p>
...
<li class="list"><p class="p"><span class="gui">Поиск</span>: Должен ли ваш поиск включать полнотекстовый поиск или поиск только по именам файлов?</p></li>
</ul></div></div></div>
</li>
...
<li class="steps"><p class="p">Снова нажмите <span class="media"><span class="media media-image"><img src="figures/nautilus-folder-search-symbolic.svg" class="media media-inline" alt="Search key symbol"></span></span> на панели инструментов, чтобы выйти из режима поиска и вернуться к содержимому папки.</p></li>
</ol></div>
</div></div>
</div>
...
<li class="steps"><p class="p">Выберите <span class="gui">Места поиска</span>.</p></li>
</ol></div></div></div>
<p class="p">Откроется диалоговое окно, которое позволит вам включать или выключать поиск в определённом каталоге. Вы можете настроить поиск в каждой из трех имеющихся вкладок:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
