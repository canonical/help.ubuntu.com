...
<title>Co je to za soubor s ~ na konci názvu?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Co je to za soubor s <span class="file">~</span> na konci názvu?</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Soubory s <span class="file">~</span> na konci názvu (například <span class="file">příklad.txt~</span>) jsou automaticky vytvořené záložní kopie dokumentů upravovaných v textovém editoru <span class="app">gedit</span> a v dalších aplikacích. Můžete je bez následků smazat, ale když je v počítači necháte, také se nic nestane.</p>
