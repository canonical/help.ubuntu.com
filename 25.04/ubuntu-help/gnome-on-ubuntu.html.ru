...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">О GNOME в Ubuntu</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">Помимо обоев рабочего стола Ubuntu, по умолчанию используется тема Yaru, а шрифт по умолчанию — Ubuntu.</p></li>
<li class="list"><p class="p">Кнопки свертывания и развертывания находятся в строке заголовка окна.</p></li>
</ul></div></div></div>
</div>
