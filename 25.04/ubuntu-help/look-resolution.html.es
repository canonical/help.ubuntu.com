...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Cambiar la resolución o la orientación de la pantalla</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Seleccione la orientación, la resolución o el escalado y la tasa de refresco..</p></li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Orientación</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">En algunos dispositivos puede rotar físicamente la pantalla en varias direcciones. Pulse en <span class="gui">Orientación</span> en el panel y elija <span class="gui">Horizontal</span>, <span class="gui">Vertical derecha</span>, <span class="gui">Vertical izquierda</span>, u <span class="gui">Horizontal (dada la vuelta)</span>.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Si su dispositivo rota la pantalla automáticamente puede bloquear la rotación actual usando el botón <span class="media"><span class="media media-image"><img src="figures/rotation-locked-symbolic.svg" class="media media-inline" alt="bloquear rotación"></span></span> en la parte inferior del <span class="gui"><a href="shell-introduction.html.es#systemmenu" title="Menú del sistema">menú del sistema</a></span>. Para desbloquear pulse el botón <span class="media"><span class="media media-image"><img src="figures/rotation-allowed-symbolic.svg" class="media media-inline" alt="desbloquear rotación"></span></span></p></div></div></div>
</div>
</div></div>
</div></section><section id="resolution"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Resolución</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Resolución nativa</span></h2></div>
<div class="region"><div class="contents pagewide"><p class="p">La <span class="em">resolución nativa</span> de la pantalla de un portátil o monitor LCD es la que mejor funciona: los píxeles en la señal de vídeo se alinearán con precisión con los píxeles en la pantalla. Cuando se requiere que la pantalla muestre otras resoluciones, es necesaria la interpolación para representar los píxeles, causando una pérdida de calidad de imagen.</p></div></div>
</div></section><section id="refresh"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Tasa de refresco</span></h2></div>
<div class="region">
<div class="contents pagewide"><p class="p">La tasa de refresco es el número de veces por segundo que se dibuja o actualiza la imagen en la pantalla.</p></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Escalar</span></h2></div>
<div class="region"><div class="contents pagewide"><p class="p">La configuración del escalado aumenta el tamaño de los objetos mostrados en la pantalla para que coincida con la densidad de la misma, haciendo que sean más fáciles de leer. Elija <span class="gui">100%</span> o <span class="gui">200%</span>.</p></div></div>
...
<a href="prefs-display.html.es" title="Pantalla">Pantalla</a><span class="desc"> — Set your background, configure monitors, and manage
