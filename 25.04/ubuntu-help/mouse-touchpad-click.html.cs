...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Klikání, přetahování a posuv na touchpadu</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Kliknout, dvojitě kliknout, táhnout a posouvat můžete čistě jen na ploše touchpadu, bez použití hardwarových tlačítek.</p>
<div class="note" title="Upozornění">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p"><span class="link"><a href="touchscreen-gestures.html.cs" title="Používání gest na touchpadu a dotykové obrazovce">Gesta touchpadu</a></span> jsou popsána samostatně.</p></div></div></div>
</div>
</div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Kliknutí klepnutím</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Když používáte klepání nebo tažení více prsty, dávejte pozor, aby byly prsty dostatečně daleko od sebe. Pokud jsou dva prsty příliš blízko u sebe, může je počítač považovat za jeden prst.</p></div></div></div>
</div>
<div class="steps"><div class="inner">
<div class="title title-steps"><h3><span class="title">Povolení kliknutí klepnutím</span></h3></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Otevřete přehled <span class="gui"><a href="shell-introduction.html.cs#activities" title="Přehled Činností">Činnosti</a></span> a začněte psát <span class="gui">Myš a touchpad</span>.</p></li>
<li class="steps"><p class="p">Kliknutím na <span class="gui">Myš a touchpad</span> otevřete příslušný panel.</p></li>
<li class="steps">
<p class="p">V části <span class="gui">Touchpad</span> zkontrolujte, jestli je vypínač přepnutý na zapnuto.</p>
<div class="note" title="Upozornění">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Část <span class="gui">Touchpad</span> se objeví, jen když ve svém počítači opravdu máte touchpad.</p></div></div></div>
</div>
</li>
<li class="steps"><p class="p">Přepněte vypínač <span class="gui">Kliknutí klepnutím</span> do polohy zapnuto.</p></li>
</ol></div>
</div></div>
</div></div>
</div></section><section id="twofingerscroll"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Posuv dvěma prsty</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<p class="p">Když je tato volba vybrána, klepání a přetahování jedním prstem nepracuje normálně, ale místo toho se posouvá, když táhnete dvěma prsty po libovolné části touchpadu. Táhněte prsty mezi horní a dolní částí touchpadu, abyste prováděli svislý posuv, nebo jimi táhněte na šířku napříč touchpadem, abyste prováděli vodorovný posuv. Dávejte pozor na to, abyste prsty nechali mírně od sebe. Když byste je měli přitisknuté příliš k sobě, jevily by se touchpadu jako jeden prst.</p>
<div class="note" title="Upozornění">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Posuv dvěma prsty nemusí fungovat na všech touchpadech.</p></div></div></div>
</div>
<div class="steps"><div class="inner">
<div class="title title-steps"><h3><span class="title">Povolení posuvu dvěma prsty</span></h3></div>
<div class="region"><ol class="steps">
<li class="steps"><p class="p">Otevřete přehled <span class="gui"><a href="shell-introduction.html.cs#activities" title="Přehled Činností">Činnosti</a></span> a začněte psát <span class="gui">Myš a touchpad</span>.</p></li>
<li class="steps"><p class="p">Kliknutím na <span class="gui">Myš a touchpad</span> otevřete příslušný panel.</p></li>
<li class="steps"><p class="p">V části <span class="gui">Touchpad</span> zkontrolujte, jestli je vypínač přepnutý na zapnuto.</p></li>
<li class="steps"><p class="p">Vypínač <span class="gui">Posouvání dvěma prsty</span> přepněte do polohy zapnuto.</p></li>
</ol></div>
</div></div>
</div></div>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Přirozený posuv</span></h2></div>
<div class="region"><div class="contents pagewide">
<p class="p">Pomocí touchpadu můžete posouvat obsah podobný způsobem, jako byste posouvali list papíru.</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Otevřete přehled <span class="gui"><a href="shell-introduction.html.cs#activities" title="Přehled Činností">Činnosti</a></span> a začněte psát <span class="gui">Myš a touchpad</span>.</p></li>
<li class="steps"><p class="p">Kliknutím na <span class="gui">Myš a touchpad</span> otevřete příslušný panel.</p></li>
<li class="steps"><p class="p">V části <span class="gui">Touchpad</span> zkontrolujte, jestli je vypínač <span class="gui">Touchpad</span> přepnutý do polohy zapnuto.</p></li>
<li class="steps"><p class="p">Vypínač <span class="gui">Přirozený posuv</span> přepněte do polohy zapnuto.</p></li>
</ol></div></div></div>
<div class="note" title="Upozornění">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m4 3h16c0.554 0 1 0.446 1 1v11h-6v6h-11c-0.554 0-1-0.446-1-1v-16c0-0.554 0.446-1 1-1z"></path>
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Někdy je tato funkce nazývána také <span class="em">Obrácený posuv</span>.</p></div></div></div>
</div>
</div></div>
