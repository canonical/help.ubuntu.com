...
<p class="p">If the file is a program, such as a script, you must switch on the
    ...
    <span class="link"><a href="nautilus-behavior.html.cs#executable" title="Spustitelné textové soubory">Spustitelné textové soubory</a></span> for more information.</p>
</div></div>
