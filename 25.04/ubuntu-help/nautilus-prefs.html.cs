...
<title>Předvolby správce souborů</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Předvolby správce souborů</span></h1></div>
<div class="region">
...
<div class="linkdiv "><a class="linkdiv" href="nautilus-views.html.cs" title="Předvolby zobrazení v Souborech"><span class="title">Předvolby zobrazení v <span class="app">Souborech</span></span><span class="linkdiv-dash"> — </span><span class="desc">Specify the default sort order for files and folders.</span></a></div>
