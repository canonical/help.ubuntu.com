...
<title>Προτιμήσεις του διαχειριστή αρχείων</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Προτιμήσεις του διαχειριστή αρχείων</span></h1></div>
<div class="region">
...
<div class="linkdiv "><a class="linkdiv" href="nautilus-views.html.el" title="Προτιμήσεις προβολών στα Αρχεία"><span class="title">Προτιμήσεις προβολών στα <span class="app">Αρχεία</span></span><span class="linkdiv-dash"> — </span><span class="desc">Specify the default sort order for files and folders.</span></a></div>
