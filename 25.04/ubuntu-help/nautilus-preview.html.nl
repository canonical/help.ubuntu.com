...
<dd class="terms"><p class="p">By default, all previews are done for
    ...
    <span class="link"><a href="nautilus-connect.html.nl" title="Door bestanden op een server of netwerk bladeren">browse files on other computers</a></span> over
...
<dt class="terms"><span class="gui">Aantal bestanden in mappen tellen</span></dt>
<dd class="terms">
<p class="p">If you show file sizes in <span class="link"><a href="nautilus-list.html.nl" title="Bestandsbeheer-voorkeuren: lijstkolommen">list view columns</a></span>
    or <span class="link"><a href="nautilus-display.html.nl#icon-captions" title="Pictogrambijschriften">icon captions</a></span>,
...
<div class="region"><ul><li class="links ">
<a href="files-preview.html.nl" title="Voorbeeldweergave voor bestanden en mappen">Voorbeeldweergave voor bestanden en mappen</a><span class="desc"> — Voorbeeldweergaven voor documenten, afbeeldingen, videos en meer snel weergeven of verbergen.</span>
</li></ul></div>
</div></div>
</div>
</div></section>
