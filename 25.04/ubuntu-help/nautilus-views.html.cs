...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">To change how files are sorted in folders, see <span class="link"><a href="files-sort.html.cs" title="Řazení souborů a složek">Řazení souborů a složek</a></span>.</p></div></div></div>
</div>
</div></div>
