...
<div class="region">
<div class="contents pagewide"><p class="p">Znalost svojí adresy IP může pomoci při řešení problémů s internetovým připojením. Můžete být překvapení zjištěním, že máte <span class="em">dvě</span> adresy IP: jednu pro svůj počítač ve vnitřní síti a jedno pro komunikaci vně na Internetu.</p></div>
<section id="wired"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Zjištění vaší interní (síťové) adresy IP u drátového připojení</span></h2></div>
...
<li class="steps">
<p class="p">Kliknutím na <span class="gui">Síť</span> v postranním panelu otevřete příslušný panel.</p>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Zjištění vaší interní (síťové) adresy IP u bezdrátového připojení</span></h2></div>
<div class="region"><div class="contents pagewide"><div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Otevřete přehled <span class="gui"><a href="shell-introduction.html.cs#activities" title="Přehled Činností">Činnosti</a></span> a začněte psát <span class="gui">Nastavení</span>.</p></li>
<li class="steps"><p class="p">Klikněte na <span class="gui">Nastavení</span>.</p></li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Zjištění vaší externí (internetové) adresy IP</span></h2></div>
