...
<title>Управление доступом к сети с помощью межсетевого экрана</title>
...
<span style="color: #333">Ubuntu 25.04</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Справка"></span></span> Руководство пользователя настольного выпуска Ubuntu</a> » <a class="trail" href="net.html.ru" title="Сети, Интернет и электронная почта">Сеть</a> » <a class="trail" href="net-security.html.ru" title="Безопасность в Интернете">Безопасность</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Управление доступом к сети с помощью межсетевого экрана</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Межсетевой экран не поставляется в составе GNOME, поэтому для дополнительной поддержки, помимо этого документа, обратитесь в группу сопровождения вашего дистрибутива или в ИТ-отдел вашей организации. Ваш компьютер должен быть оснащен <span class="em">межсетевым экраном</span>, который позволяет защищать программы от доступа посторонних людей через Интернет или локальную сеть. Это помогает сделать компьютер более защищённым.</p>
...
<li class="steps"><p class="p">Зайдите в <span class="gui">Обзор</span> в верхнем левом углу экрана и запустите приложение для работы с межсетевым экраном. Если его там нет, нужно будет установить его самостоятельно (например, GUFW).</p></li>
