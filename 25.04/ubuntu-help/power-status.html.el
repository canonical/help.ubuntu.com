...
<p class="p">The <span class="link"><a href="status-icons.html.el#batteryicons" title="Battery icons">status icon</a></span> in the top
    ...
    <span class="gui"><a href="shell-introduction.html.el#systemmenu" title="System menu">system menu</a></span> shows
    the charge as a percentage. The top bar icon can also be configured to
    display the <span class="link"><a href="power-percentage.html.el" title="Show the battery status as a percentage">percentage</a></span>.</p>
</div>
