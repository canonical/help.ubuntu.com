...
<div class="trail">
<span style="color: #333">Ubuntu 25.04</span> » <a class="trail" href="index.html.es" title="Guía del escritorio de Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Ayuda"></span></span> Guía de escritorio de Ubuntu</a> » <a class="trail" href="shell-overview.html.es" title="Su escritorio">Escritorio</a> › <a class="trail" href="shell-overview.html.es#apps" title="Aplicaciones y ventanas">Aplicaciones y ventanas</a> » <a class="trail" href="status-icons.html.es" title="¿Qué significan los iconos de la barra superior?">¿Qué significan los iconos de la barra superior?</a> » </div>
<div class="trail">
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Compruebe el estado de la batería</span></h1></div>
<div class="region">
<div class="contents pagewide">
<div class="steps"><div class="inner">
<div class="title title-steps"><h2><span class="title">Mostrar el estado de la batería y de los dispositivos conectados</span></h2></div>
...
<p class="p">The <span class="link"><a href="status-icons.html.es#batteryicons" title="Iconos de batería">status icon</a></span> in the top
    ...
    <span class="gui"><a href="shell-introduction.html.es#systemmenu" title="Menú del sistema">system menu</a></span> shows
    the charge as a percentage. The top bar icon can also be configured to
    display the <span class="link"><a href="power-percentage.html.es" title="Mostrar el estado de la batería como porcentaje">percentage</a></span>.</p>
</div>
...
<li class="links ">
<a href="status-icons.html.es" title="¿Qué significan los iconos de la barra superior?">¿Qué significan los iconos de la barra superior?</a><span class="desc"> — Explica el significado de los iconos de la parte derecha de la barra superior.</span>
</li>
</ul></div>
</div></div>
...
<div class="region"><ul>
<li class="links ">
<a href="power-percentage.html.es" title="Mostrar el estado de la batería como porcentaje">Mostrar el estado de la batería como porcentaje</a><span class="desc"> — Display the battery percentage in the top bar.</span>
</li>
<li class="links ">
