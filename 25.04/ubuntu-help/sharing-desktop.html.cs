...
<p class="p">If you want to log in to your user account remotely, see
  <span class="link"><a href="remote-login.html.cs" title="Log in remotely to your device">Remote Login</a></span>.</p>
...
<p class="p">The <span class="gui">How to Connect</span> section displays the
  ...
  <span class="link"><a href="net-findip.html.cs" title="Zjištění vaší IP adresy">IP address</a></span>.</p>
...
<p class="p">If you also enable <span class="link"><a href="remote-login.html.cs" title="Log in remotely to your device">Remote Login</a></span>, it will set its port
...
<svg width="24" height="24" version="1.1">
 ...
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
  ...
  you can <span class="link"><a href="about-hostname.html.cs" title="Change the device name">change</a></span>
