...
<title>Проблемы, вызванные ограничением прав доступа</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Проблемы, вызванные ограничением прав доступа</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">подключение к проводным или беспроводным сетям,</p></li>
<li class="list"><p class="p">просмотр содержимого другого раздела диска (например, раздела Windows), или</p></li>
