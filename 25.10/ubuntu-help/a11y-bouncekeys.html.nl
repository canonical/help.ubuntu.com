...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Springende toetsen inschakelen</span></h1></div>
<div class="region">
...
<div class="region"><div class="contents"><p class="p">U kunt springende toetsen aan- en uitzetten door te klikken op het <span class="link"><a href="a11y-icon.html.nl" title="Find the accessibility menu">toegankelijkheidspictogram</a></span> in de bovenbalk en <span class="gui">Springende toetsen</span> te selecteren. Het toegankelijkheidspictogram is zichtbaar als één of meer instellingen in <span class="gui">Universele toegang</span> ingeschakeld zijn.</p></div></div>
</div>
</div>
