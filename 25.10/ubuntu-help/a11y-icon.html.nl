...
<p class="p">To access this menu using the keyboard rather than the mouse, press
  ...
  <span class="gui"><a href="shell-introduction.html.nl#activities" title="Activiteiten-overzicht">Activities</a></span> button in the
...
<a href="a11y.html.nl" title="Toegankelijkheid">Toegankelijkheid</a><span class="desc"> — Gebruik toegankelijkheidstechnologie om u te helpen met speciale behoeften voor zicht, gehoor en mobiliteit.</span>
</li></ul></div>
</div></div></div>
</div></section>
</div>
