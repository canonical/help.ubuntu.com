...
<div class="region"><div class="contents"><p class="p">Μπορείτε να ενεργοποιήσετε ή όχι τον αναγνώστη οθόνης κάνοντας κλικ στο <span class="link"><a href="a11y-icon.html.el" title="Find the accessibility menu">εικονίδιο προσιτότητας</a></span> στην πάνω γραμμή και επιλέγοντας <span class="gui">Αναγνώστης οθόνης</span>.</p></div></div>
</div>
</div>
