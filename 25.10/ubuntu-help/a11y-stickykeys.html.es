...
<p class="p">Las <span class="em">teclas persistentes</span> le permiten usar atajos del teclado pulsándolas tecla a tecla, en lugar de tener que mantener pulsadas todas las teclas a la vez. Por ejemplo, el atajo <span class="keyseq"><span class="key"><a href="keyboard-key-super.html.es" title="¿Qué es la tecla Super?"><kbd>Super</kbd></a></span>+<span class="key"><kbd>Tab</kbd></span></span> sirve para pasar de una ventana a otra. Sin las teclas persistentes activadas tendría que mantener pulsadas ambas teclas al mismo tiempo; con las teclas persistentes, puede pulsar la tecla <span class="key"><kbd>Super</kbd></span>, soltarla y luego pulsar <span class="key"><kbd>Tab</kbd></span> para obtener el mismo resultado.</p>
