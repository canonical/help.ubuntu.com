...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Προσθήκη λογαριασμού</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">All services that are offered by an account provider will be enabled
      by default. <span class="link"><a href="accounts-disable-service.html.el" title="Ελέγξτε ποιες διαδικτυακές υπηρεσίες ενός λογαριασμού μπορούν να χρησιμοποιηθούν για πρόσβαση">Switch</a></span>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Αρκετές διαδικτυακές υπηρεσίες παρέχουν ένα διακριτικό εξουσιοδότησης το οποίο αποθηκεύει το GNOME αντί για τον κωδικό πρόσβασης σας. Αν αφαιρέσετε έναν λογαριασμό, θα πρέπει επίσης να ανακαλέσετε αυτό το πιστοποιητικό στην διαδικτυακή υπηρεσία. Για περισσότερες πληροφορίες δείτε <span class="link"><a href="accounts-remove.html.el" title="Αφαίρεση λογαριασμού">Αφαίρεση λογαριασμού</a></span>.</p></div></div></div>
</div>
</div>
