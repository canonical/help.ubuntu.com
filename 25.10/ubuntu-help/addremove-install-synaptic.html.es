...
<li class="links ">
<a href="addremove-install.html.es" title="Instalar aplicaciones adicionales">Instalar aplicaciones adicionales</a><span class="desc"> — Use <span class="app">App Center</span> para instalar aplicaciones adiciones y hacer a Ubuntu más útil.</span>
</li>
</ul></div>
</div></div>
</div>
