...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Odstranjevanje programov</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Nekateri programi se za pravilno delovanje zanašajo na druge programe. V primeru, da poskusite odstraniti program, ki ga drug program potrebuje, bosta odstranjena oba. Preden bosta programa odstranjena, boste vprašani za potrditev, da si to res želite.</p></div></div></div>
</div>
</div>
...
<a href="addremove.html.sl" title="Install &amp; remove software">Install &amp; remove software</a><span class="desc"> — Add and remove applications and other software. Handle
...
<div class="region"><ul>
<li class="links ">
<a href="addremove-install.html.sl" title="Namestite dodatne programe">Namestite dodatne programe</a><span class="desc"> — 
      Use <span class="app">App Center</span> to install additional applications and make Ubuntu more 
      useful.
    </span>
</li>
<li class="links ">
<a href="addremove-install-synaptic.html.sl" title="Uporaba programa Synaptic za naprednejše upravljanje programov">Uporaba programa Synaptic za naprednejše upravljanje programov</a><span class="desc"> — 
