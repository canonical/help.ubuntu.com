...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Send files to a Bluetooth device</span></h1></div>
<div class="region">
...
<p class="p">In the <span class="gui">Devices</span> list, select the device to which to send the
      ...
      list, you need to <span class="link"><a href="bluetooth-connect-device.html.sl" title="Povezava računalnika z napravo Bluetooth.">connect</a></span>
      to it.</p>
