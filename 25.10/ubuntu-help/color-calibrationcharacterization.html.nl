...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Wat is het verschil tussen kalibreren en karakteriseren?</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Houd er rekening mee dat een karakterisering (profiel) alleen geldig is voor een apparaat indien het in dezelfde staat van kalibratie is als toen het gekarakteriseerd werd.</p></div></div></div>
</div>
