...
<li class="steps"><p class="p">Выберите <span class="gui">Приложения по умолчанию</span>, чтобы открыть панель.</p></li>
<li class="steps"><p class="p">В разделе <span class="gui">Съёмный носитель</span> переведите переключатель <span class="gui">Автоматический запуск приложений</span> в положение «включено».</p></li>
<li class="steps">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Чтобы отключить автоматический запуск приложений при подключении устройства или носителя, переведите переключатель <span class="gui">Автоматический запуск приложений</span> в положение «выключено».</p></div></div></div>
</div>
</div>
