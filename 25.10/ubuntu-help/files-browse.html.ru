...
<p class="p">Вы можете быстро получить доступ к общим местам из <span class="em">боковой панели</span>. Если вы не видите боковую панель, нажмите кнопку <span class="gui">Показывать боковую панель</span> в верхнем левом углу окна. Вы можете <span class="link"><a href="nautilus-bookmarks-edit.html.ru" title="Редактирование закладок">часто используемые папки добавить в закладки</a></span>, и они появятся на боковой панели.</p>
</div></div>
