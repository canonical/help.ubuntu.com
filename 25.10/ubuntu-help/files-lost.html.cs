...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Vyhledání ztracených souborů</span></h1></div>
<div class="region">
...
<li class="list"><p class="p">You might have renamed the file in a way that made the file hidden.
  ...
  <span class="link"><a href="files-hidden.html.cs" title="Skrytí souboru">Skrytí souboru</a></span> to learn more.</p></li>
</ul></div></div></div>
</div>
