...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Certain <span class="link"><a href="files-rename.html.el#valid-chars" title="Έγκυροι χαρακτήρες για ονόματα αρχείων">characters</a></span>
...
<li class="links ">
<a href="files-rename.html.el" title="Μετονομασία αρχείου ή φακέλου">Μετονομασία αρχείου ή φακέλου</a><span class="desc"> — Αλλάξτε το όνομα αρχείου ή φακέλου</span>
</li>
</ul></div>
</div></div>
</div>
