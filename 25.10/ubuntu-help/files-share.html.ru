...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Перед тем, как начать, проверьте, что почтовый клиент <span class="app">Evolution</span> или <span class="app">Geary</span> присутствует в системе и ваша почтовая учётная запись настроена.</p></div></div></div>
</div>
...
<li class="steps"><p class="p">Нажмите правой кнопкой мыши на файл и выберите <span class="gui">Отправить…</span>. Появится окно создания письма с вложенным файлом.</p></li>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Можно отправить несколько файлов одновременно. Выберите их, удерживая нажатой <span class="key"><kbd>Ctrl</kbd></span> щёлкните по каждому из них, затем нажмите правой кнопкой по любому из выделенных файлов.</p></div></div></div>
</div>
</div>
