...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Zjištění provozované verze GNOME</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">Verzi GNOME, která běží na vašem počítači, zjistíte, když se podíváte do panelu <span class="gui">O systému</span> v <span class="gui">Nastaveních</span>.</p>
...
<li class="steps"><p class="p">Objeví se okno zobrazující informace o vašem systému, včetně názvu distribuce a verze GNOME.</p></li>
</ol></div></div></div>
</div>
