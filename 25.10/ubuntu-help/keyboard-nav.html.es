...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Navegación con el teclado</span></h1></div>
<div class="region">
<div class="contents pagewide">
<p class="p">En esta página se detalla la navegación con el teclado para personas que no pueden usar un ratón u otro dispositivo apuntador, o que quiere usar el teclado lo más posible. Para ver los atajos de teclado, útiles para todos los usuarios, consulte la sección <span class="link"><a href="shell-keyboard-shortcuts.html.es" title="Atajos de teclado útiles">Atajos de teclado útiles</a></span> en su lugar.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Si no puede usar un dispositivo apuntado como un ratón, puede controlar el puntero del ratón usando el teclado numérico de su teclado. Consulte la <span class="link"><a href="mouse-mousekeys.html.es" title="Pulsar y mover el puntero del ratón usando el teclado numérico">Pulsar y mover el puntero del ratón usando el teclado numérico</a></span> para obtener más detalles.</p></div></div></div>
</div>
...
<p class="p">En una vista de árbol los elementos que tienen hijos se pueden expandir o contraer para mostrar u ocultar sus hijos: se expanden pulsando <span class="keyseq"><span class="key"><kbd>Mayús</kbd></span>+<span class="key"><kbd>→</kbd></span></span> y se contraen pulsando <span class="keyseq"><span class="key"><kbd>Mayús</kbd></span>+<span class="key"><kbd>←</kbd></span></span>.</p>
</td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-notifications.html.es#notificationlist" title="La lista de notificaciones">Abrir la lista de notificaciones</a></span>. Pulse <span class="key"><kbd>Esc</kbd></span> para cerrarla.</p></td>
</tr>
</table></div>
</div></div>
<div class="table"><div class="inner">
