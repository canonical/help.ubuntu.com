...
<div class="trail">
<span style="color: #333">Ubuntu 25.10</span> » <a class="trail" href="index.html.nl" title="Gids voor de Ubuntu-werkomgeving"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Hulp"></span></span> Ubuntu-bureaubladhandleiding</a> » <a class="trail" href="a11y.html.nl" title="Toegankelijkheid">Toegankelijkheid</a> › <a class="trail" href="a11y.html.nl#mobility" title="Beperkte mobiliteit">Beperkte mobiliteit</a> » </div>
<div class="trail">
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Toetsenbordnavigatie</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Als u geen aanwijsapparaat zoals een muis kunt gebruiken, dan kunt u de muisaanwijzer besturen via het numerieke toetsenbord. Zie <span class="link"><a href="mouse-mousekeys.html.nl" title="Click and move the mouse pointer using the keypad">Click and move the mouse pointer using the keypad</a></span> voor meer informatie.</p></div></div></div>
</div>
...
<tr>
<td>
<p class="p"><span class="key"><kbd>Tab</kbd></span> en</p>
...
<p class="p">In een boomstructuur kunnen items met onderliggende items worden in- of uitgeklapt om de onderliggende items te tonen of te verbergen: uitklappen doet u door op<span class="keyseq"><span class="key"><kbd>Shift</kbd></span>+<span class="key"><kbd>→</kbd></span></span> te drukken en voor inklappen drukt u op <span class="keyseq"><span class="key"><kbd>Shift</kbd></span>+<span class="key"><kbd>←</kbd></span></span>.</p>
</td>
</tr>
<tr>
...
<tr>
<td style="border-top-style: solid;">
<p class="p"><span class="keyseq"><span class="key"><kbd>Shift</kbd></span>+<span class="key"><kbd>F10</kbd></span></span> of</p>
<p class="p"><span class="key"><a href="keyboard-key-menu.html.nl" title="Wat is de Menu-toets?"><kbd>Menu</kbd></a></span></p>
</td>
...
<td style="border-top-style: solid;"><p class="p"><span class="link"><a href="shell-notifications.html.nl#notificationlist" title="The notification list">Open the
