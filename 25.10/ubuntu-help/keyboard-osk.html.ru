...
<li class="steps"><p class="p">Переведите переключатель <span class="gui">Экранная клавиатура</span> в положение «включено».</p></li>
</ol></div></div></div>
...
<p class="p">Нажмите кнопку <span class="gui"><span class="media"><span class="media media-image"><img src="figures/emoji-flags-symbolic.svg" height="16" width="16" class="media media-inline" alt="флаг"></span></span></span>, чтобы изменить настройки для <span class="link"><a href="session-language.html.ru" title="Изменение языка">Языка</a></span> или <span class="link"><a href="keyboard-layouts.html.ru" title="Использование других раскладок клавиатуры">Источников ввода</a></span>.</p>
</div>
