...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Use an on-screen keyboard</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">The on-screen keyboard is automatically enabled if you use a
    touchscreen</p></div></div></div>
</div>
...
<p class="p">You can press the
  ...
  <span class="link"><a href="touchscreen-gestures.html.sl" title="Use gestures on touchpads and touchscreens">dragging up from the bottom edge</a></span>.</p>
<p class="p">Press the
  ...
  <span class="link"><a href="session-language.html.sl" title="Izbira jezika, ki ga uporabljate">Language</a></span> or
  <span class="link"><a href="keyboard-layouts.html.sl" title="Use alternative keyboard layouts">Input Sources</a></span>.</p>
</div>
