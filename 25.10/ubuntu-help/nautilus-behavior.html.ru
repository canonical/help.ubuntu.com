...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Параметры вкладки <span class="gui">Поведение</span> менеджера файлов</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">Можно настроить способ открытия файлов (одинарным или двойным нажатием), действие для исполняемых текстовых файлов и поведение корзины. Нажмите кнопку меню на боковой панели, выберите <span class="gui">Параметры</span>, затем перейдите в раздел <span class="gui">Основное</span>.</p></div>
...
<dt class="terms"><span class="gui">Действие для открытия объекта</span></dt>
...
<p class="p">Исполняемые текстовые файлы также называются <span class="em">сценариями</span>. Все сценарии в папке <span class="file">~/.local/share/nautilus/scripts</span> показываются в контекстном меню файла в подменю <span class="gui">Сценарии</span>. При запуске сценария из локальной папки все выбранные файлы передаются сценарию как параметры. Чтобы выполнить сценарий для файла:</p>
