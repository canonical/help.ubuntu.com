...
<p class="p">Окно свойств файла показывает такую информацию, как тип файла, его размер и время последнего изменения. Если вам часто бывает необходима эта информация, можно сделать так, чтобы она отображалась в <span class="link"><a href="nautilus-list.html.ru" title="Настройки столбцов списка файлов">столбцах при просмотре в режиме списка</a></span> или в <span class="link"><a href="nautilus-display.html.ru#icon-captions" title="Подписи к значкам">подписях к значкам</a></span>.</p>
<p class="p">Для определенных типов файлов, таких как изображения и видео, будет добавлен дополнительный раздел <span class="gui">Свойства</span>, в котором представлена информация о размере, длительности и используемом кодеке.</p>
<p class="p">Информацию по разделу <span class="gui">Разрешения</span> смотрите в <span class="link"><a href="nautilus-file-properties-permissions.html.ru" title="Настройка прав доступа к файлам">Настройка прав доступа к файлам</a></span>.</p>
</div>
...
<dd class="terms">
<p class="p">Имя файла или папки.</p>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Чтобы узнать как переименовать файл, смотрите <span class="link"><a href="files-rename.html.ru" title="Переименование файла или папки">Переименование файла или папки</a></span>.</p></div></div></div>
</div>
</dd>
<dt class="terms"><span class="gui">Тип</span></dt>
<dd class="terms">
<p class="p">Позволяет определить тип файла, например: документ PDF, текст OpenDocument или изображение в формате JPEG. От типа файла, кроме того, зависит то, в каком приложении его можно открыть. Например, нельзя открыть изображение в музыкальном проигрывателе. Подробнее об этом смотрите <span class="link"><a href="files-open.html.ru" title="Открытие файлов в другом приложении">Открытие файлов в другом приложении</a></span>.</p>
<div class="note note-tip" title="Подсказка">
<svg width="24" height="24" version="1.1">
 <path class="yelp-svg-fill" d="m12 2c-3.8541 0-7 3.1459-7 7 0 1.823 0.4945 3.139 1.1641 4.133 0.6695 0.994 1.4328 1.671 2.039 2.471 0.0882 0.116 0.1749 0.656 0.2071 1.32 0.016 0.332 0.0133 0.68 0.1894 1.119 0.0881 0.22 0.2439 0.478 0.5059 0.672 0.2619 0.194 0.6028 0.285 0.8945 0.285h4c0.583 0 1.204-0.478 1.402-0.908 0.199-0.43 0.217-0.793 0.244-1.137 0.056-0.688 0.138-1.319 0.211-1.441 0.549-0.916 1.304-2.009 1.94-3.114 0.636-1.104 1.203-2.199 1.203-3.4 0-3.8541-3.146-7-7-7zm0 2c2.773 0 5 2.2267 5 5 0 0.456-0.359 1.401-0.936 2.402-0.111 0.195-0.246 0.399-0.369 0.598h-7.8825c-0.4871-0.728-0.8125-1.519-0.8125-3 0-2.7733 2.2267-5 5-5z" style="block-progression:tb;color-rendering:auto;color:#000000;image-rendering:auto;isolation:auto;mix-blend-mode:normal;shape-rendering:auto;solid-color:#000000;text-decoration-color:#000000;text-decoration-line:none;text-decoration-style:solid;text-indent:0;text-transform:none;white-space:normal"></path>
 <path class="yelp-svg-fill" d="m9 20a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h6a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-6zm0 2a0.5 0.5 0 0 0-0.5 0.5 0.5 0.5 0 0 0 0.5 0.5h6a0.5 0.5 0 0 0 0.5-0.5 0.5 0.5 0 0 0-0.5-0.5h-6z"></path>
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Чтобы узнать как изменить приложение для открытия определённого типа файла, смотрите <span class="link"><a href="files-open.html.ru#default" title="Изменение приложения по умолчанию">Изменение приложения по умолчанию</a></span>.</p></div></div></div>
</div>
</dd>
...
<dt class="terms">Родительская папка</dt>
<dd class="terms"><p class="p">Местоположение каждого файла на компьютере выражается его <span class="em">абсолютным путём</span>. Это уникальный «адрес» файла на компьютере, составленный из списка папок, через которые нужно пройти, чтобы добраться до файла. Например, если у пользователя Jim в домашней папке есть файл <span class="file">Resume.pdf</span>, его родительской папкой является <span class="file">/home/jim</span>, то путь к файлу будет иметь вид: <span class="file">/home/jim/Resume.pdf</span>.</p></dd>
...
<dt class="terms">Создано</dt>
<dd class="terms"><p class="p">Дата и время создания файла.</p></dd>
