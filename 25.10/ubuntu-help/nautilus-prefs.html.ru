...
<title>Параметры менеджера файлов</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Параметры менеджера файлов</span></h1></div>
<div class="region">
<div class="contents pagewide"><div class="links topiclinks"><div class="inner"><div class="region"><div class="links-divs">
<div class="linkdiv "><a class="linkdiv" href="nautilus-list.html.ru" title="Настройки столбцов списка файлов"><span class="title">Настройки столбцов списка файлов</span><span class="linkdiv-dash"> — </span><span class="desc">Управление информацией, отображаемой в столбцах при просмотре в виде списка.</span></a></div>
...
<div class="linkdiv "><a class="linkdiv" href="nautilus-views.html.ru" title="Параметры просмотра файлов и папок в приложении Файлы"><span class="title">Параметры просмотра файлов и папок в приложении <span class="app">Файлы</span></span><span class="linkdiv-dash"> — </span><span class="desc">Управление порядком сортировки файлов и папок по умолчанию для файлового менеджера.</span></a></div>
</div></div></div></div></div>
