...
<title>Zakaj se moj računalnik ne vklopi nazaj potem ko ga pošljem v stanje pripravljenosti?</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Zakaj se moj računalnik ne vklopi nazaj potem ko ga pošljem v stanje pripravljenosti?</span></h1></div>
<div class="region">
<div class="contents pagewide"><p class="p">If you <span class="link"><a href="power-suspend.html.sl" title="Kaj se zgodi, ko pošljem računalnik v pripravljenost?">suspend</a></span> your computer, then try to
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Moj računalnik je v stanju pripravljenosti in se ne prižge</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Če vaš računalnik izgubi napetost in nima nadomestnega vira napetosti (kot je delujoča baterija), se bo izklopil.</p></div></div></div>
</div>
</div></div>
</div></section><section id="hardware"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Moja brezžična povezava (ali druga strojna oprema) ne deluje, ko računalnik povrnem iz stanja pripravljenosti ali mirovanja</span></h2></div>
<div class="region"><div class="contents pagewide">
