...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Změna názvu nebo umístění tiskárny</span></h1></div>
<div class="region">
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Abyste mohli změnit název a umístění tiskárny, potřebujete v systému <span class="link"><a href="user-admin-explain.html.cs" title="Jak fungují oprávnění správce?">oprávnění správce</a></span>.</p></div></div></div>
</div>
</div>
<section id="printer-name-change"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Změna názvu tiskárny</span></h2></div>
...
<li class="steps"><p class="p">Zmáčkněte tlačítko <span class="media"><span class="media media-image"><img src="figures/view-more-symbolic.svg" class="media media-inline" alt="nastavení"></span></span> vedle tiskárny.</p></li>
<li class="steps"><p class="p">Vyberte <span class="gui">Podrobnosti o tiskárně</span>.</p></li>
<li class="steps"><p class="p">Zadejte nový název pro tiskárnu do pole <span class="gui">Název</span>.</p></li>
<li class="steps"><p class="p">Zavřete dialogové okno.</p></li>
</ol></div></div></div>
</div></div>
</div></section><section id="printer-location-change"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Změna umístění tiskárny</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<li class="steps"><p class="p">Vyberte <span class="gui">Podrobnosti o tiskárně</span>.</p></li>
<li class="steps"><p class="p">Zadejte nové umístění pro tiskárnu do pole <span class="gui">Umístění</span>.</p></li>
<li class="steps"><p class="p">Zavřete dialogové okno.</p></li>
</ol></div></div></div>
</div></div>
