...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Share your personal files</span></h1></div>
<div class="region">
...
<p class="p">You must have the <span class="app">gnome-user-share</span> package installed for
     <span class="gui">Personal File Sharing</span> to be visible.</p>
<p class="p">
<span class="link-button link"><a href="apt:gnome-user-share" title="apt:gnome-user-share">Install gnome-user-share</a></span>
        </p>
</div></div></div>
</div>
...
<li class="steps"><div class="note" title="Opomba">
<svg width="24" height="24" version="1.1">
 ...
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
      ...
      you to edit it, you can <span class="link"><a href="about-hostname.html.sl" title="Change the device name">change</a></span>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Varnost</span></h2></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Ta možnost je privzeto onemogočena, vendar je pametno, da jo omogočite in nastavite varno geslo.</p></div></div></div>
</div>
</dd>
