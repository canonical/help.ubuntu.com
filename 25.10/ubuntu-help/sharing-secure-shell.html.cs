...
<p class="p">You need <span class="link"><a href="user-admin-explain.html.cs" title="Jak fungují oprávnění správce?">administrator privileges</a></span>
...
<svg width="24" height="24" version="1.1">
 ...
 <path class="yelp-svg-fill" d="m17 16h4l-5 5v-4c0-0.554 0.446-1 1-1z"></path>
        ...
        <span class="link"><a href="about-hostname.html.cs" title="Change the device name">device name</a></span>.</p></div></div></div>
</div>
</li>
</ol></div></div></div>
</div>
