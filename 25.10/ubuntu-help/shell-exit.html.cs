...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Položka <span class="gui">Přepnout uživatele</span> se v nabídce objeví jen v případě, že máte v systému více než jeden uživatelský účet.</p></div></div></div>
</div>
</div>
