...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Η καταχώριση <span class="gui">Αλλαγή χρήστη</span> εμφανίζεται μόνο στο μενού, αν έχετε περισσότερους από έναν λογαριασμούς χρήστη στο σύστημά σας.</p></div></div></div>
</div>
</div>
