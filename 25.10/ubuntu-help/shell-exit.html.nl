...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Het onderdeel <span class="gui">Gebruiker wisselen</span> verschijnt alleen in het menu als u meer dan één gebruikersaccount op uw systeem heeft.</p></div></div></div>
</div>
</div>
