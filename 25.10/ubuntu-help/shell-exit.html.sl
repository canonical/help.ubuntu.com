...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">The <span class="gui">Switch User</span> entry only appears in the menu if you have
    more than one user account on your system.</p></div></div></div>
</div>
</div>
