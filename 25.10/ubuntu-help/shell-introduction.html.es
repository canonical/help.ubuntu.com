...
<title>Resumen visual de GNOME</title>
...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Resumen visual de GNOME</span></h1></div>
<div class="region">
...
<li class="links "><a href="shell-introduction.html.es#systemmenu" title="Menú del sistema">Menú del sistema</a></li>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Vista de <span class="gui">Actividades</span></span></h2></div>
...
<p class="p">To access the overview at any time,
  ...
  <span class="key"><a href="keyboard-key-super.html.es" title="¿Qué es la tecla Super?"><kbd>Super</kbd></a></span> key on your keyboard.</p>
...
<div class="hgroup pagewide"><h2 class="title"><span class="title">Reloj, calendario y citas</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<li class="list"><p class="p"><span class="link"><a href="shell-notifications.html.es" title="Notificaciones y la lista de notificaciones">Aprender más acerca de las notificaciones y la lista de notificaciones.</a></span>.</p></li>
</ul></div></div></div>
</div></div>
</div></section><section id="systemmenu"><div class="inner">
<div class="hgroup pagewide"><h2 class="title"><span class="title">Menú del sistema</span></h2></div>
<div class="region"><div class="contents pagewide">
...
<div class="list"><div class="inner"><div class="region"><ul class="list compact">
<li class="list"><p class="p"><span class="link"><a href="shell-exit.html.es" title="Cerrar la sesión, apagar o cambiar de usuario">Aprender más acerca de cambiar de usuario, cerrar la sesión y apagar el equipo.</a></span></p></li>
<li class="list"><p class="p"><span class="link"><a href="quick-settings.html.es" title="Quick Settings">Learn more about Quick
...
<div class="region"><div class="contents pagewide">
<p class="p">Cuando bloquea su pantalla o se bloquea automáticamente, se muestra la pantalla de bloqueo. Además de proteger su escritorio mientras está ausente de su equipo, la pantalla de bloqueo muestra la fecha y la hora. También muestra información sobre la batería y el estado de la red.</p>
...
<div class="region"><div class="contents pagewide">
<p class="p">GNOME implementa una manera de cambiar entre ventanas diferente a la de la lista de ventanas visible en otros entornos de escritorio. Esto le permite centrarse en las tareas que tiene a mano sin distracciones.</p>
