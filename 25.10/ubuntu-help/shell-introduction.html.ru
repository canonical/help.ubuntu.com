...
<p class="p">После запуска GNOME, вам автоматически будет представлен режим <span class="gui">Обзора</span>. Режим обзора позволяет получить доступ к вашим окнам и приложениям. В режиме обзора вы можете просто начать печатать для поиска в приложениях, файлах, папках и Интернете.</p>
<p class="p">Чтобы получить доступ к режиму обзора в любое время, нажмите кнопку Обзор в верхнем левом углу или просто переместите указатель мыши в верхний левый активный угол. Также можете нажать клавишу <span class="key"><a href="keyboard-key-super.html.ru" title="Что такое клавиша Super?"><kbd>Super</kbd></a></span> на клавиатуре.</p>
...
<p class="p">В нижней части обзора вы найдете <span class="em">панель задач</span>. На этой панели отображаются ваши избранные и запущенные приложения. Щёлкните любой значок в панели, чтобы открыть это приложение; если приложение уже запущено, под его значком будет показана маленькая точка. Щёлкнув по этому значку, вы откроете последнее использовавшееся окно. Также можете перетаскивать значок на виртуальный рабочий стол.</p>
...
<p class="p">Нажмите кнопку сетки (с девятью точками) на панели задач, чтобы открыть режим обзор приложений. В этом режиме будут показаны все приложения, установленные на вашем компьютере. Щёлкните любое приложение, чтобы запустить его, или перетащите приложение на виртуальный рабочий стол, расположенное выше миниатюр приложений. Вы также можете перетащить приложение на панель задач, чтобы сделать его избранным. Избранные приложения останутся на панели задач, даже когда не запущены, чтобы обеспечить быстрый доступ к ним.</p>
...
<li class="list"><p class="p"><span class="link"><a href="shell-windows.html.ru" title="Окна и виртуальные рабочие столы">Подробнее об окнах и виртуальных рабочих столах.</a></span></p></li>
</ul></div></div></div>
</div></div>
...
<p class="p">Нажмите кнопку системного меню в правом верхнем углу экрана, чтобы управлять системными настройками и параметрами вашего компьютера. В верхней части меню отображается индикатор состояния батареи и кнопки для запуска приложения «Настройки» и инструмента создания снимков экрана. С помощью кнопки <span class="media"><span class="media media-image"><img src="figures/system-shutdown-symbolic.svg" class="media media-inline" alt="power"></span></span> вы можете приостановить или выключить компьютер, быстро предоставить кому-либо доступ к компьютеру без полного выхода из системы. С помощью ползунков можно регулировать громкость звука или яркость экрана.</p>
<p class="p">Остальная часть меню содержит кнопки быстрых настроек, с помощью которых вы можете управлять доступными службами и устройствами, такими как Wi-Fi, Bluetooth, параметрами питания и фоновыми приложениями.</p>
<div class="list"><div class="inner"><div class="region"><ul class="list compact">
<li class="list"><p class="p"><span class="link"><a href="shell-exit.html.ru" title="Выход из системы, выключение компьютера или переключение пользователей">Подробнее о смене пользователей, выходе из системы и выключении компьютера.</a></span></p></li>
<li class="list"><p class="p"><span class="link"><a href="shell-lockscreen.html.ru" title="Экран блокировки">Узнать больше о быстрых настройках.</a></span></p></li>
</ul></div></div></div>
</div></div>
