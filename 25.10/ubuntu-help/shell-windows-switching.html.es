...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Cambiar entre ventanas</span></h1></div>
<div class="region">
...
<li class="steps"><p class="p">Otra forma, manteniendo todavía pulsada la tecla <span class="key"><a href="keyboard-key-super.html.es" title="¿Qué es la tecla Super?"><kbd> Super</kbd></a></span>, pulse <span class="key"><kbd>Tab</kbd></span> para cambiar entre la lista de ventanas abiertas, o pulse <span class="keyseq"><span class="key"><kbd>Mayús</kbd></span>+<span class="key"><kbd>Tab</kbd></span></span> para cambiar hacia atrás.</p></li>
</ol></div></div></div>
...
</svg><div class="inner"><div class="region"><div class="contents"><p class="p">Las ventanas en el selector de ventanas se agrupan por aplicaciones. Las vistas previas de las aplicaciones con múltiples ventanas se despliegan cuando las pulsa. Pulse la tecla <span class="key"><a href="keyboard-key-super.html.es" title="¿Qué es la tecla Super?"><kbd>Super</kbd></a></span> y pulse <span class="key"><kbd>`</kbd></span> (o la tecla <span class="key"><kbd>Tab</kbd></span>) para recorrer la lista.</p></div></div></div>
</div>
