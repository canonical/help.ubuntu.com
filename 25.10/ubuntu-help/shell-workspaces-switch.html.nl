...
<div id="content">
<div class="hgroup pagewide"><h1 class="title"><span class="title">Wisselen tussen werkbladen</span></h1></div>
<div class="region">
...
<p class="p">If more than one workspace is being used, then you can also click on
  the <span class="link"><a href="shell-workspaces.html.nl" title="Wat is een werkblad en hoe kan ik het gebruiken?">workspace selector</a></span> between the
  search field and the window list to directly access another workspace.</p>
</li>
<li class="steps"><p class="p">Click on the workspace to activate the workspace.</p></li>
</ol></div>
</div></div>
