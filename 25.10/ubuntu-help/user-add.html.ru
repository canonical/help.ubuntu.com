...
<li class="steps"><p class="p">Нажмите кнопку <span class="gui">Добавить пользователя...</span> в разделе <span class="gui">Другие пользователи</span>, чтобы добавить новую учётную запись.</p></li>
<li class="steps">
