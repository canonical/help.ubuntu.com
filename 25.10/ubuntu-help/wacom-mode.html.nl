...
<p class="p"><span class="gui">Tablet Mode</span> determines how the stylus is mapped to the screen.</p>
...
<li class="steps"><p class="p">Choose between tablet (or absolute) mode and touchpad (or relative)
    mode. For tablet mode, switch <span class="gui">Tablet Mode</span> to on.</p></li>
</ol></div></div></div>
