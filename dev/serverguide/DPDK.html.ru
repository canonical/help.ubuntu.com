...
<a class="nextlinks-prev" href="NTP.html.ru" title="Time Synchronization">Назад</a><a class="nextlinks-next" href="dm-multipath-chapter.html.ru" title="Множественное связывание устройств (DM-Multipath)">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-prerequisites" title="Необходимые требования">Необходимые требования</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-config-dev" title="DPDK Device configuration">DPDK Device configuration</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-config-hp" title="DPDK HugePage configuration">DPDK HugePage configuration</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-apps" title="Compile DPDK Applications">Compile DPDK Applications</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-openvswitch" title="OpenVswitch-DPDK">OpenVswitch-DPDK</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-openvswitch-guest" title="OpenVswitch DPDK to KVM Guests">OpenVswitch DPDK to KVM Guests</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-in-guest" title="DPDK in KVM Guests">DPDK in KVM Guests</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#ovs-dpdk-tuning" title="Tuning Openvswitch-DPDK">Tuning Openvswitch-DPDK</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-support" title="Поддержка и устранение неисправностей">Поддержка и устранение неисправностей</a></li>
<li class="links"><a class="xref" href="DPDK.html.ru#dpdk-references" title="Ресурсы">Ресурсы</a></li>
</ul></div>
<div class="sect2 sect" id="dpdk-prerequisites"><div class="inner">
<div class="hgroup"><h2 class="title">Необходимые требования</h2></div>
