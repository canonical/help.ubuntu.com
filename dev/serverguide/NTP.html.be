...
<a class="nextlinks-prev" href="dhcp.html.be" title="Dynamic Host Configuration Protocol (DHCP)">Назад</a><a class="nextlinks-next" href="DPDK.html.be" title="Data Plane Development Kit">Наперад</a>
</div>
...
<p class="para">
        Ubuntu by default uses <span class="em emphasis">timedatectl / timesyncd</span> to synchronize time and users can optionally use chrony to <a class="xref" href="NTP.html.be#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a>.
</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="NTP.html.be#timedate-info" title="Synchronizing your systems time">Synchronizing your systems time</a></li>
<li class="links"><a class="xref" href="NTP.html.be#timeservers" title="Serve the Network Time Protocol">Serve the Network Time Protocol</a></li>
<li class="links"><a class="xref" href="NTP.html.be#ntp-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
