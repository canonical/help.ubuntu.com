...
<a class="nextlinks-prev" href="installing-upgrading.html.el" title="Αναβάθμιση">Προηγούμενο</a><a class="nextlinks-next" href="kernel-crash-dump.html.el" title="Kernel Crash Dump">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Εγκατάσταση για προχωρημένους</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="advanced-installation.html.el#software-raid" title="RAID λογισμικού">RAID λογισμικού</a></li>
<li class="links"><a class="xref" href="advanced-installation.html.el#lvm" title="Διαχειριστής λογικών τόμων (LVM)">Διαχειριστής λογικών τόμων (LVM)</a></li>
<li class="links"><a class="xref" href="advanced-installation.html.el#iscsi" title="iSCSI">iSCSI</a></li>
</ul></div>
...
<p class="para">Αν επιλέξετε να τοποθετήσετε την κατάτμηση του βασικού συστήματος (root) σε μία συστοιχία RAID, το πρόγραμμα εγκατάστασης θα ρωτήσει αν θέλετε να γίνεται εκκίνηση σε <span class="em emphasis">υποβαθμισμένη</span> κατάσταση. Δείτε το <a class="xref" href="advanced-installation.html.el#raid-degraded" title="Υποβαθμισμένο RAID">Υποβαθμισμένο RAID</a> για περισσότερες λεπτομέρειες.</p>
...
<p class="para">The first steps of a diskless iSCSI installation are identical
          to the <a class="xref" href="installing-from-cd.html.el" title="Installation using debian-installer">Installation using debian-installer</a> section up to "Hard drive
          layout".</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<p class="para">Again, the iSCSI installation on a normal server with one or
          many disks attached is identical to the <a class="xref" href="installing-from-cd.html.el" title="Installation using debian-installer">Installation using debian-installer</a> section until we reach the disk
