...
<title>Napredna namestitev</title>
...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="installation.html.sl" title="Namestitev">Namestitev</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="installing-upgrading.html.sl" title="Nadgrajevanje">Nazaj</a><a class="nextlinks-next" href="kernel-crash-dump.html.sl" title="Kernel Crash Dump">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Napredna namestitev</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="advanced-installation.html.sl#software-raid" title="Software RAID">Software RAID</a></li>
<li class="links"><a class="xref" href="advanced-installation.html.sl#lvm" title="Logical Volume Manager (LVM)">Logical Volume Manager (LVM)</a></li>
<li class="links"><a class="xref" href="advanced-installation.html.sl#iscsi" title="iSCSI">iSCSI</a></li>
</ul></div>
...
<div class="hgroup"><h3 class="title">Razdeljevanje</h3></div>
...
<li class="steps">
              ...
              <p class="para">Kot način razdeljevanja izberite <span class="em emphasis">Ročno</span>.</p>
...
<li class="steps">
              ...
              <p class="para">Za ta primer izberite <span class="em emphasis">"RAID1"</span>. V primeru, da uporabljate drugo postavitev, izberite primerno vrsto (RAID0, RAID1, RAID5).</p>

              <div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
                <p class="para">Če želite uporabiti <span class="em emphasis">RAID5</span>, potrebujete vsaj <span class="em emphasis">tri</span> pogone. Uporaba RAID0 ali RAID1 zahteva samo <span class="em emphasis">dva</span> pogona.</p>
              </div></div></div></div>
...
<div class="hgroup"><h3 class="title">Formatiranje</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
          ...
          a <span class="em emphasis">degraded</span> state.  See <a class="xref" href="advanced-installation.html.sl#raid-degraded" title="Degraded RAID">Degraded RAID</a> for further details.  
          </p>
<p class="para">
...
<li class="list itemizedlist">
                  <p class="para">Za zagon sistema pritisnite <span class="keyseq keycombo"><span class="key keycap"><kbd>Ctrl</kbd></span>+<span class="key keycap"><kbd>x</kbd></span></span>.</p>
                </li>
</ul></div>
...
<p class="para">
           Once the system has booted you can either repair the array see <a class="xref" href="advanced-installation.html.sl#raid-maintenance" title="Vzdrževanje polja RAID">Vzdrževanje polja RAID</a> for details, or copy 
           important data to another machine due to major hardware failure.
           </p>
</div></div>
</div></div>
<div class="sect3 sect" id="raid-maintenance"><div class="inner">
<div class="hgroup"><h3 class="title">Vzdrževanje polja RAID</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Viri</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Pregled</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Namestitev</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="list itemizedlist">
              <p class="para">Oglejte si <a href="https://help.ubuntu.com/community/Installation#lvm" class="ulink" title="https://help.ubuntu.com/community/Installation#lvm">članke LVM na Ubuntu Wiki</a>.</p>
            </li>
<li class="list itemizedlist">
              <p class="para">
...
<p class="para">The first steps of a diskless iSCSI installation are identical
          to the <a class="xref" href="installing-from-cd.html.sl" title="Installation using debian-installer">Installation using debian-installer</a> section up to "Hard drive
          layout".</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<p class="para">Again, the iSCSI installation on a normal server with one or
          many disks attached is identical to the <a class="xref" href="installing-from-cd.html.sl" title="Installation using debian-installer">Installation using debian-installer</a> section until we reach the disk
