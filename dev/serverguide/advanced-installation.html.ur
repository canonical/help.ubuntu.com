...
<a class="nextlinks-prev" href="installing-upgrading.html.ur" title="Upgrading">Previous</a><a class="nextlinks-next" href="kernel-crash-dump.html.ur" title="Kernel Crash Dump">Next</a>
</div>
<div class="hgroup"><h1 class="title">Advanced Installation</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="advanced-installation.html.ur#software-raid" title="Software RAID">Software RAID</a></li>
<li class="links"><a class="xref" href="advanced-installation.html.ur#lvm" title="Logical Volume Manager (LVM)">Logical Volume Manager (LVM)</a></li>
<li class="links"><a class="xref" href="advanced-installation.html.ur#iscsi" title="iSCSI">iSCSI</a></li>
</ul></div>
...
<p class="para">
          ...
          a <span class="em emphasis">degraded</span> state.  See <a class="xref" href="advanced-installation.html.ur#raid-degraded" title="Degraded RAID">Degraded RAID</a> for further details.  
          </p>
<p class="para">
...
<p class="para">
           Once the system has booted you can either repair the array see <a class="xref" href="advanced-installation.html.ur#raid-maintenance" title="RAID Maintenance">RAID Maintenance</a> for details, or copy 
...
<p class="para">The first steps of a diskless iSCSI installation are identical
          to the <a class="xref" href="installing-from-cd.html.ur" title="Installation using debian-installer">Installation using debian-installer</a> section up to "Hard drive
          layout".</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<p class="para">Again, the iSCSI installation on a normal server with one or
          many disks attached is identical to the <a class="xref" href="installing-from-cd.html.ur" title="Installation using debian-installer">Installation using debian-installer</a> section until we reach the disk
