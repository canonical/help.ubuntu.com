...
<a class="nextlinks-prev" href="firewall.html.be" title="Брандмаўэр">Назад</a><a class="nextlinks-next" href="certificates-and-security.html.be" title="Certificates">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="apparmor.html.be#apparmor-usage" title="Ужываньне AppArmor">Ужываньне AppArmor</a></li>
<li class="links"><a class="xref" href="apparmor.html.be#apparmor-profiles" title="Профілі">Профілі</a></li>
<li class="links"><a class="xref" href="apparmor.html.be#apparmor-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
<div class="sect2 sect" id="apparmor-usage"><div class="inner">
<div class="hgroup"><h2 class="title">Ужываньне AppArmor</h2></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">cat /etc/apparmor.d/profile.name | sudo apparmor_parser -a</span>
		...
		<p class="para">Каб перазапусьціць профіль:</p>
...
<p class="para">Ў профілях ёсьць два голоўных тыпа правілаў:</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
	        <p class="para">
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
	      <p class="para">
	      After editing a profile file the profile must be reloaded. See <a class="xref" href="apparmor.html.be#apparmor-usage" title="Ужываньне AppArmor">Ужываньне AppArmor</a> for details.
	      </p>
	    </div></div></div></div>
</div>
<div class="sect3 sect" id="apparmor-profiles-new"><div class="inner">
<div class="hgroup"><h3 class="title">Стварэньне профіля</h3></div>
...
<li class="list itemizedlist">
		  ...
		  Some standard test cases are:
	          ...
	          <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">		
		      <p class="para">Урухомленьне праграмы.</p>
		    </li>
<li class="list itemizedlist">		
		      <p class="para">Спыненьне праграмы.</p>
		    </li>
<li class="list itemizedlist">		
		      <p class="para">Перазагрузка праграмы.</p>
		    </li>
<li class="list itemizedlist">		
		      <p class="para">
