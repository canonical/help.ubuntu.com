...
<a class="nextlinks-prev" href="firewall.html.cs" title="Firewall">Předchozí</a><a class="nextlinks-next" href="certificates-and-security.html.cs" title="Certificates">Následující</a>
</div>
...
<li class="links"><a class="xref" href="apparmor.html.cs#apparmor-usage" title="Using AppArmor">Using AppArmor</a></li>
<li class="links"><a class="xref" href="apparmor.html.cs#apparmor-profiles" title="Profiles">Profiles</a></li>
<li class="links"><a class="xref" href="apparmor.html.cs#apparmor-references" title="References">References</a></li>
</ul></div>
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
	      <p class="para">
	      After editing a profile file the profile must be reloaded. See <a class="xref" href="apparmor.html.cs#apparmor-usage" title="Using AppArmor">Using AppArmor</a> for details.
	      </p>
	    </div></div></div></div>
</div>
