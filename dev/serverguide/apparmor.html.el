...
<a class="nextlinks-prev" href="firewall.html.el" title="Τείχος Προστασίας">Προηγούμενο</a><a class="nextlinks-next" href="certificates-and-security.html.el" title="Πιστοποιητικά">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="apparmor.html.el#apparmor-usage" title="Χρήση AppArmor">Χρήση AppArmor</a></li>
<li class="links"><a class="xref" href="apparmor.html.el#apparmor-profiles" title="Προφίλ">Προφίλ</a></li>
<li class="links"><a class="xref" href="apparmor.html.el#apparmor-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
	      <p class="para">Αφού επεξεργαστείτε ένα αρχείο προφίλ το προφίλ θα πρέπει να επαναφορτωθεί. Δείτε το <a class="xref" href="apparmor.html.el#apparmor-usage" title="Χρήση AppArmor">Χρήση AppArmor</a> για λεπτομέρειες.</p>
	    </div></div></div></div>
</div>
