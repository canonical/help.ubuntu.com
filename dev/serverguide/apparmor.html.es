...
<a class="nextlinks-prev" href="firewall.html.es" title="Cortafuegos">Anterior</a><a class="nextlinks-next" href="certificates-and-security.html.es" title="Certificados">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="apparmor.html.es#apparmor-usage" title="Usando AppArmor">Usando AppArmor</a></li>
<li class="links"><a class="xref" href="apparmor.html.es#apparmor-profiles" title="Perfiles">Perfiles</a></li>
<li class="links"><a class="xref" href="apparmor.html.es#apparmor-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
	      <p class="para">Después de editar el archivo de perfil, el perfil debe ser recargado. Ver <a class="xref" href="apparmor.html.es#apparmor-usage" title="Usando AppArmor">Usando AppArmor</a> para detalles.</p>
	    </div></div></div></div>
</div>
