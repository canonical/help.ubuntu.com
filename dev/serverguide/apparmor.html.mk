...
<a class="nextlinks-prev" href="firewall.html.mk" title="Firewall">Previous</a><a class="nextlinks-next" href="certificates-and-security.html.mk" title="Certificates">Next</a>
</div>
...
<li class="links"><a class="xref" href="apparmor.html.mk#apparmor-usage" title="Using AppArmor">Using AppArmor</a></li>
<li class="links"><a class="xref" href="apparmor.html.mk#apparmor-profiles" title="Profiles">Profiles</a></li>
<li class="links"><a class="xref" href="apparmor.html.mk#apparmor-references" title="References">References</a></li>
</ul></div>
...
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents">
	      <p class="para">
	      After editing a profile file the profile must be reloaded. See <a class="xref" href="apparmor.html.mk#apparmor-usage" title="Using AppArmor">Using AppArmor</a> for details.
	      </p>
	    </div></div></div></div>
</div>
