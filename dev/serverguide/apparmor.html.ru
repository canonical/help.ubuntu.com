...
<a class="nextlinks-prev" href="firewall.html.ru" title="Брандмауэр">Назад</a><a class="nextlinks-next" href="certificates-and-security.html.ru" title="Сертификаты">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="apparmor.html.ru#apparmor-usage" title="Использование AppArmor">Использование AppArmor</a></li>
<li class="links"><a class="xref" href="apparmor.html.ru#apparmor-profiles" title="Профили">Профили</a></li>
<li class="links"><a class="xref" href="apparmor.html.ru#apparmor-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
	      <p class="para">После редактирования файла профиля он должен быть перезагружен. Более подробно смотрите <a class="xref" href="apparmor.html.ru#apparmor-usage" title="Использование AppArmor">Использование AppArmor</a> .</p>
	    </div></div></div></div>
</div>
