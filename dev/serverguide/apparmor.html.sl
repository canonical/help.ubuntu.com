...
<a class="nextlinks-prev" href="firewall.html.sl" title="Požarni zid">Nazaj</a><a class="nextlinks-next" href="certificates-and-security.html.sl" title="Potrdila">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="apparmor.html.sl#apparmor-usage" title="Uporaba AppArmorja">Uporaba AppArmorja</a></li>
<li class="links"><a class="xref" href="apparmor.html.sl#apparmor-profiles" title="Profili">Profili</a></li>
<li class="links"><a class="xref" href="apparmor.html.sl#apparmor-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="apparmor-usage"><div class="inner">
<div class="hgroup"><h2 class="title">Uporaba AppArmorja</h2></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo ln -s /etc/apparmor.d/ime.profila /etc/apparmor.d/disable/</span>
<span class="cmd command">sudo apparmor_parser -R /etc/apparmor.d/ime.profila</span>
</pre></div>
	        <p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo rm /etc/apparmor.d/disable/ime.profila</span>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
	      <p class="para">
	      After editing a profile file the profile must be reloaded. See <a class="xref" href="apparmor.html.sl#apparmor-usage" title="Uporaba AppArmorja">Uporaba AppArmorja</a> for details.
	      </p>
	    </div></div></div></div>
</div>
<div class="sect3 sect" id="apparmor-profiles-new"><div class="inner">
<div class="hgroup"><h3 class="title">Ustvarjanje profila</h3></div>
...
<li class="list itemizedlist">
		  ...
		  Some standard test cases are:
	          ...
	          <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">		
		      <p class="para">Zaganjanje programa.</p>
		    </li>
<li class="list itemizedlist">		
		      <p class="para">Zaustavljanje programa.</p>
		    </li>
<li class="list itemizedlist">		
		      <p class="para">
...
<li class="list itemizedlist">
		      <p class="para">Hrošču priložite vaš novi profil.</p>
		    </li>
</ul></div>
		</li>
</ul></div></div></div>
...
<div class="hgroup"><h3 class="title">Posodabljanje profilov</h3></div>
<div class="region"><div class="contents">
<p class="para">
