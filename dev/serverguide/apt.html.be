...
<a class="nextlinks-prev" href="dpkg.html.be" title="dpkg">Назад</a><a class="nextlinks-next" href="aptitude.html.be" title="Aptitude">Наперад</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt upgrade</span>
		...
		<p class="para">
		For information on upgrading to a new Ubuntu release see <a class="xref" href="installing-upgrading.html.be" title="Абнаўленьне">Абнаўленьне</a>.
		</p>
                </li>
</ul></div>
        </p>
