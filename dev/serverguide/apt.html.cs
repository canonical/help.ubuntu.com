...
<a class="nextlinks-prev" href="dpkg.html.cs" title="dpkg">Předchozí</a><a class="nextlinks-next" href="aptitude.html.cs" title="Aptitude">Následující</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt upgrade</span>
		...
		<p class="para">
		For information on upgrading to a new Ubuntu release see <a class="xref" href="installing-upgrading.html.cs" title="Upgrading">Upgrading</a>.
		</p>
                </li>
</ul></div>
        </p>
