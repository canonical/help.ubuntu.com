...
<a class="nextlinks-prev" href="dpkg.html.el" title="dpkg">Προηγούμενο</a><a class="nextlinks-next" href="aptitude.html.el" title="Aptitude">Επόμενο</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt upgrade</span>
		...
		<p class="para">Για πληροφορίες με το πως να αναβαθμίσετε μία καινούρια έκδοση Ubuntu δείτε <a class="xref" href="installing-upgrading.html.el" title="Αναβάθμιση">Αναβάθμιση</a>.</p>
                </li>
</ul></div>
        </p>
<p class="para">
