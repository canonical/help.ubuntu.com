...
<a class="nextlinks-prev" href="dpkg.html.es" title="dpkg">Anterior</a><a class="nextlinks-next" href="aptitude.html.es" title="Aptitude">Siguiente</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt upgrade</span>
		...
		<p class="para">Para información sobre la actualización a una nueva versión de Ubuntu vea <a class="xref" href="installing-upgrading.html.es" title="Actualizando">Actualizando</a>.</p>
                </li>
</ul></div>
        </p>
<p class="para">
