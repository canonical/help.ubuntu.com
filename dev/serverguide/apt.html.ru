...
<a class="nextlinks-prev" href="dpkg.html.ru" title="dpkg">Назад</a><a class="nextlinks-next" href="aptitude.html.ru" title="Aptitude">Вперёд</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt upgrade</span>
		...
		<p class="para">Информацию по переходу на новый релиз Ubuntu смотрите в <a class="xref" href="installing-upgrading.html.ru" title="Обновление">Обновление</a>.</p>
                </li>
</ul></div>
        </p>
<p class="para">
