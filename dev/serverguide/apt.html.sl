...
<a class="nextlinks-prev" href="dpkg.html.sl" title="dpkg">Nazaj</a><a class="nextlinks-next" href="aptitude.html.sl" title="Aptitude">Naprej</a>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt upgrade</span>
		...
		<p class="para">
		For information on upgrading to a new Ubuntu release see <a class="xref" href="installing-upgrading.html.sl" title="Nadgrajevanje">Nadgrajevanje</a>.
		</p>
                </li>
</ul></div>
        </p>
