...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="package-management.html.be" title="Кіраваньне пакетамі">Кіраваньне пакетамі</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="apt.html.be" title="Apt">Назад</a><a class="nextlinks-next" href="automatic-updates.html.be" title="Аўтаматычныя абнаўленьні">Наперад</a>
</div>
...
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">i</span>: Installed package
        </p>
        </li>
<li class="list itemizedlist">
        <p class="para">
...
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">v</span>: Virtual package
        </p>
        </li>
<li class="list itemizedlist">
        <p class="para">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="aptitude.html.be#aptitude-commandline" title="Command Line Aptitude">Command Line Aptitude</a></li></ul></div>
