...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.el" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="package-management.html.el" title="Διαχείριση Πακέτων">Διαχείριση Πακέτων</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="apt.html.el" title="Apt">Προηγούμενο</a><a class="nextlinks-next" href="automatic-updates.html.el" title="Αυτόματες Ενημερώσεις">Επόμενο</a>
</div>
...
<p class="para">Η χρήση του <span class="app application">Aptitude</span> για διαχείριση πακέτων είναι σχετικά απλή, και η διεπαφή του χρήστη κάνει απλές διεργασίες εύκολες να εκτελεστούν. Τα ακόλουθα είναι παραδείγματα κοινών λειτουργιών διαχείρισης πακέτων όπως εκτελέστηκαν στο <span class="app application">Aptitude</span>:</p>
...
<p class="para">Η πρώτη στήλη πληροφοριών που προβάλλεται στη λίστα πακέτων στο πρώτο παράθυρο, όταν προβάλλετε πακέτα καταγράφει την τρέχουσα κατάσταση των πακέτων, και χρησιμοποιεί το ακόλουθο κλειδί για να περιγράψει την κατάσταση του πακέτου: <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">i</span>: Εγκαταστημένο πακέτο</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">c</span>: Πακέτο μη εγκαταστημένο, αλλά η διαμόρφωση πακέτου παραμένει στο σύστημα.</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">p</span>: Καθαρισμένο από το σύστημα</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">v</span>: Εικονικό πακέτο</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">B</span>: Σπασμένο πακέτο</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">u</span>: Ασυσκεύαστα αρχεία, αλλά χωρίς να έχει διαμορφωθεί το πακέτο ακόμα</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">C</span>: Μισο-διαμορφωμένα - Η διαμόρφωση απέτυχε και απαιτεί διόρθωση</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">H</span>: Μισο-εγκαταστημένα - Η αφαίρεση απέτυχε και απαιτεί διόρθωση</p>
        </li>
</ul></div></p>
<p class="para">Για να εξέλθετε από το Aptitude, απλά πατήστε το πλήκτρο <span class="key keycap"><kbd>q</kbd></span> και επιβεβαιώστε ότι θέλετε να εξέλθετε. Πολλές άλλες λειτουργίες είναι διαθέσιμες στο μενού Aptitude πατώντας το πλήκτρο <span class="key keycap"><kbd>F10</kbd></span>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="aptitude.html.el#aptitude-commandline" title="Command Line Aptitude">Command Line Aptitude</a></li></ul></div>
