...
<a class="nextlinks-prev" href="apt.html.es" title="Apt">Anterior</a><a class="nextlinks-next" href="automatic-updates.html.es" title="Actualizaciones automáticas">Siguiente</a>
</div>
...
<p class="para">Usar <span class="app application">Aptitude</span> para la administración de paquetes es relativamente simple, y la interfaz de usuario simplifica la ejecución de tareas comunes. Los siguientes son algunos ejemplos de funciones comunes de administración de paquetes y cómo se ejecutan en <span class="app application">Aptitude</span>:</p>
...
<p class="para">La primera columna de información mostrada en la lista de paquetes en el panel superior refleja el estado actual de cada paquete, y para describir dicho estado se usa la siguiente leyenda: <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">i</span>: Paquete instalado</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">c</span>: Paquete no instalado, pero la configuración del paquete permanece en el sistema</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">p</span>: Eliminado del sistema</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">v</span>: Paquete virtual</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">B</span>: Paquete roto</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">u</span>: Archivos desempaquetados, pero el paquete esta sin configurar</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">C</span>: Medio configurado - La configuración ha fallado y es necesario arreglarla.</p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">H</span>:Medio instalado - La desinstalación ha fallado y es necesario arreglarlo.</p>
        </li>
</ul></div></p>
<p class="para">Para cerrar Aptitude, simplemente presione la tecla <span class="key keycap"><kbd>q</kbd></span> y confirme que desea salir. Muchas otras funciones del menú de Aptitude estan disponibles presionando la tecla <span class="key keycap"><kbd>F10</kbd></span> .</p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="aptitude.html.es#aptitude-commandline" title="Línea de órdenes para Aptitude">Línea de órdenes para Aptitude</a></li></ul></div>
<div class="sect2 sect" id="aptitude-commandline"><div class="inner">
<div class="hgroup"><h2 class="title">Línea de órdenes para Aptitude</h2></div>
