...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="package-management.html.sl" title="Upravljanje paketov">Upravljanje paketov</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="apt.html.sl" title="Apt">Nazaj</a><a class="nextlinks-next" href="automatic-updates.html.sl" title="Samodejne posodobitve">Naprej</a>
</div>
...
<p class="para">Using <span class="app application">Aptitude</span> for package management is relatively straightforward, and the user interface makes common tasks simple to perform.  The following are examples of common package management functions as performed in <span class="app application">Aptitude</span>:
        </p>
...
<p class="para">The first column of information displayed in the package list in the top pane, when actually viewing packages lists the current state of the package, and uses the following key to describe the state of the package:
        <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">i</span>: Nameščen paket</p>
        </li>
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">c</span>: Package not installed, but package configuration remains on system
        </p>
        </li>
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">p</span>: Purged from system
        </p>
        </li>
<li class="list itemizedlist">
        <p class="para"><span class="em em-bold emphasis">v</span>: Navidezen paket</p>
        </li>
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">B</span>: Broken package
        </p>
        </li>
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">u</span>: Unpacked files, but package not yet configured
        </p>
        </li>
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">C</span>: Half-configured - Configuration failed and requires fix
        </p>
        </li>
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">H</span>: Half-installed - Removal failed and requires fix
        </p>
        </li>
</ul></div>
        </p>
<p class="para">To exit Aptitude, simply press the <span class="key keycap"><kbd>q</kbd></span> key and confirm you wish to exit. Many other functions are available from the Aptitude menu by pressing the <span class="key keycap"><kbd>F10</kbd></span> key.
        </p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="aptitude.html.sl#aptitude-commandline" title="Command Line Aptitude">Command Line Aptitude</a></li></ul></div>
