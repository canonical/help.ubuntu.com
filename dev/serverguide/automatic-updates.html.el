...
<a class="nextlinks-prev" href="aptitude.html.el" title="Aptitude">Προηγούμενο</a><a class="nextlinks-next" href="configuration.html.el" title="Ρυθμίσεις">Επόμενο</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="automatic-updates.html.el#update-notifications" title="Κοινοποιήσεις">Κοινοποιήσεις</a></li></ul></div>
