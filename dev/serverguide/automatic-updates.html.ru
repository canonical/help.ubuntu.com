...
<a class="nextlinks-prev" href="aptitude.html.ru" title="Aptitude">Назад</a><a class="nextlinks-next" href="configuration.html.ru" title="Конфигурация">Вперёд</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="automatic-updates.html.ru#update-notifications" title="Уведомления">Уведомления</a></li></ul></div>
