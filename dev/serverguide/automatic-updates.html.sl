...
<title>Samodejne posodobitve</title>
...
<a class="nextlinks-prev" href="aptitude.html.sl" title="Aptitude">Nazaj</a><a class="nextlinks-next" href="configuration.html.sl" title="Nastavljanje">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Samodejne posodobitve</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="automatic-updates.html.sl#update-notifications" title="Obvestila">Obvestila</a></li></ul></div>
<div class="sect2 sect" id="update-notifications"><div class="inner">
<div class="hgroup"><h2 class="title">Obvestila</h2></div>
...
<div class="code"><pre class="contents ">EMAIL="skrbnik@primer.si"
</pre></div>
</div></div>
</div></div>
</div>
