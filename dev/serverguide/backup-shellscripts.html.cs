...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.cs" title="Průvodce pro Ubuntu Server">Průvodce pro Ubuntu Server</a> » <a class="trail" href="backups.html.cs" title="Backups">Backups</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="backups.html.cs" title="Backups">Předchozí</a><a class="nextlinks-next" href="backups-shellscripts-rotation.html.cs" title="Archive Rotation">Následující</a>
</div>
...
<li class="links"><a class="xref" href="backup-shellscripts.html.cs#backup-shellscript" title="Simple Shell Script">Simple Shell Script</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.cs#backup-executing-shellscript" title="Executing the Script">Executing the Script</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.cs#backup-shellscript-archive-testing" title="Restoring from the Archive">Restoring from the Archive</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.cs#backup-shellscript-references" title="References">References</a></li>
</ul></div>
...
<li class="list itemizedlist">           
   	  ...
   	  <span class="em emphasis">$dest:</span> destination of the archive file.  The directory needs to be created and in this case 
          <span class="em emphasis">mounted</span> before executing the backup script.  See <a class="xref" href="network-file-system.html.cs" title="Network File System (NFS)">Network File System (NFS)</a> for details of
...
<p class="para">
      ...
      See <a class="xref" href="backup-shellscripts.html.cs#backup-shellscript-references" title="References">References</a> for links to resources providing more in-depth shell scripting information.
      </p>
</div></div>
</div></div>
...
<p class="para">
        For more in-depth <span class="app application">crontab</span> options see <a class="xref" href="backup-shellscripts.html.cs#backup-shellscript-references" title="References">References</a>.
        </p>
</div></div>
</div></div>
</div>
