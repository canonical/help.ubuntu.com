...
<a class="nextlinks-prev" href="backups.html.el" title="Αντίγραφα ασφαλείας">Προηγούμενο</a><a class="nextlinks-next" href="backups-shellscripts-rotation.html.el" title="Archive Rotation">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="backup-shellscripts.html.el#backup-shellscript" title="Απλό σενάριο εντολών κελύφους">Απλό σενάριο εντολών κελύφους</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.el#backup-executing-shellscript" title="Εκτέλεση του σεναρίου εντολών">Εκτέλεση του σεναρίου εντολών</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.el#backup-shellscript-archive-testing" title="Επαναφορά από το αρχείο">Επαναφορά από το αρχείο</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.el#backup-shellscript-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<li class="list itemizedlist">           
   	  ...
   	  <span class="em emphasis">$dest:</span> destination of the archive file.  The directory needs to be created and in this case 
          <span class="em emphasis">mounted</span> before executing the backup script.  See <a class="xref" href="network-file-system.html.el" title="Σύστημα Αρχείων Δικτύου (NFS)">Σύστημα Αρχείων Δικτύου (NFS)</a> for details of
...
<p class="para">
      ...
      See <a class="xref" href="backup-shellscripts.html.el#backup-shellscript-references" title="Αναφορές">Αναφορές</a> for links to resources providing more in-depth shell scripting information.
      </p>
</div></div>
</div></div>
...
<p class="para">
        For more in-depth <span class="app application">crontab</span> options see <a class="xref" href="backup-shellscripts.html.el#backup-shellscript-references" title="Αναφορές">Αναφορές</a>.
        </p>
</div></div>
</div></div>
</div>
