...
<a class="nextlinks-prev" href="backups.html.es" title="Copias de seguridad">Anterior</a><a class="nextlinks-next" href="backups-shellscripts-rotation.html.es" title="Rotación de archivadores">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="backup-shellscripts.html.es#backup-shellscript" title="Shell Script Simple">Shell Script Simple</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.es#backup-executing-shellscript" title="Ejecutando el Script">Ejecutando el Script</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.es#backup-shellscript-archive-testing" title="Restaurando desde el archivador">Restaurando desde el archivador</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.es#backup-shellscript-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<p class="para">
      ...
      See <a class="xref" href="backup-shellscripts.html.es#backup-shellscript-references" title="Referencias">Referencias</a> for links to resources providing more in-depth shell scripting information.
      </p>
</div></div>
</div></div>
...
<p class="para">Para más opciones en profundidad <span class="app application">crontab</span> vea <a class="xref" href="backup-shellscripts.html.es#backup-shellscript-references" title="Referencias">Referencias</a>.</p>
</div></div>
</div></div>
</div>
</div></div>
