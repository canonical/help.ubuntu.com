...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.nl" title="Handleiding Ubuntu-server">Handleiding Ubuntu-server</a> » <a class="trail" href="backups.html.nl" title="Backups">Backups</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="backups.html.nl" title="Backups">Vorige</a><a class="nextlinks-next" href="backups-shellscripts-rotation.html.nl" title="Archive Rotation">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="backup-shellscripts.html.nl#backup-shellscript" title="Simple Shell Script">Simple Shell Script</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.nl#backup-executing-shellscript" title="Executing the Script">Executing the Script</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.nl#backup-shellscript-archive-testing" title="Restoring from the Archive">Restoring from the Archive</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.nl#backup-shellscript-references" title="References">References</a></li>
</ul></div>
...
<li class="list itemizedlist">           
   	  ...
   	  <span class="em emphasis">$dest:</span> destination of the archive file.  The directory needs to be created and in this case 
          <span class="em emphasis">mounted</span> before executing the backup script.  See <a class="xref" href="network-file-system.html.nl" title="Network File System (NFS)">Network File System (NFS)</a> for details of
...
<p class="para">
      ...
      See <a class="xref" href="backup-shellscripts.html.nl#backup-shellscript-references" title="References">References</a> for links to resources providing more in-depth shell scripting information.
      </p>
</div></div>
</div></div>
...
<p class="para">
        For more in-depth <span class="app application">crontab</span> options see <a class="xref" href="backup-shellscripts.html.nl#backup-shellscript-references" title="References">References</a>.
        </p>
</div></div>
</div></div>
</div>
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Dit zal de huidige bestanden op het bestandssysteem overschrijven.</p>
      </div></div></div></div>
</div></div>
</div></div>
...
<li class="list itemizedlist">
          <p class="para">Zie het <a href="http://www.gnu.org/software/tar/manual/index.html" class="ulink" title="http://www.gnu.org/software/tar/manual/index.html">GNU tar-handboek</a> voor meer <span class="app application">tar</span>-opties.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
