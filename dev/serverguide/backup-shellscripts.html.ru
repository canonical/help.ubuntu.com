...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ru" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="backups.html.ru" title="Резервное копирование">Резервное копирование</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="backups.html.ru" title="Резервное копирование">Назад</a><a class="nextlinks-next" href="backups-shellscripts-rotation.html.ru" title="Ротация архивов">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="backup-shellscripts.html.ru#backup-shellscript" title="Простой Shell сценарий">Простой Shell сценарий</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.ru#backup-executing-shellscript" title="Выполнение сценария">Выполнение сценария</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.ru#backup-shellscript-archive-testing" title="Восстановление из архива">Восстановление из архива</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.ru#backup-shellscript-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<p class="para">Для более глубокого изучения опций <span class="app application">crontab</span> смотрите секцию <a class="xref" href="backup-shellscripts.html.ru#backup-shellscript-references" title="Ссылки">Ссылки</a>.</p>
</div></div>
</div></div>
</div>
</div></div>
