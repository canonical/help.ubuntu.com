...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="backups.html.sl" title="Varnostne kopije">Varnostne kopije</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="backups.html.sl" title="Varnostne kopije">Nazaj</a><a class="nextlinks-next" href="backups-shellscripts-rotation.html.sl" title="Archive Rotation">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="backup-shellscripts.html.sl#backup-shellscript" title="Simple Shell Script">Simple Shell Script</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.sl#backup-executing-shellscript" title="Izvajanje skripta">Izvajanje skripta</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.sl#backup-shellscript-archive-testing" title="Obnavljanje iz arhiva">Obnavljanje iz arhiva</a></li>
<li class="links"><a class="xref" href="backup-shellscripts.html.sl#backup-shellscript-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<li class="list itemizedlist">           
          <p class="para"><span class="em emphasis">$arhiv:</span> polno ime datoteke arhiva.</p>
        </li>
<li class="list itemizedlist">           
          <p class="para">
   	  <span class="em emphasis">$dest:</span> destination of the archive file.  The directory needs to be created and in this case 
          <span class="em emphasis">mounted</span> before executing the backup script.  See <a class="xref" href="network-file-system.html.sl" title="Network File System (NFS)">Network File System (NFS)</a> for details of
...
<li class="list itemizedlist">           
  	  ...
  	  <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">           
              <p class="para"><span class="em emphasis">c:</span> ustvari arhiv</p>
            </li>
<li class="list itemizedlist">           
              <p class="para">
...
<p class="para">
      ...
      See <a class="xref" href="backup-shellscripts.html.sl#backup-shellscript-references" title="Sklici">Sklici</a> for links to resources providing more in-depth shell scripting information.
      </p>
</div></div>
</div></div>
<div class="sect2 sect" id="backup-executing-shellscript"><div class="inner">
<div class="hgroup"><h2 class="title">Izvajanje skripta</h2></div>
<div class="region">
<div class="contents"></div>
<div class="sect3 sect" id="backup-script-execute-shell"><div class="inner">
<div class="hgroup"><h3 class="title">Izvajanje iz terminala</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Izvajanje s cron-om</h3></div>
<div class="region"><div class="contents">
<p class="para">Orodje <span class="app application">cron</span> se uporablja za samodejno izvajanje skriptov. Ozadnji program <span class="app application">cron</span> omogoča izvajanje skriptov ali ukazov ob določenem času in datumu.</p>
<p class="para">
...
<div class="code"><pre class="contents "># min u dm m dt   ukaz
</pre></div>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
            <p class="para">
...
<li class="list itemizedlist">
            <p class="para"><span class="em emphasis">dm:</span> dan v mesecu, ko bo ukaz izveden.</p>
          </li>
<li class="list itemizedlist">
            <p class="para">
...
<li class="list itemizedlist">
            <p class="para"><span class="em emphasis">ukaz:</span> ukaz, ki bo izveden.</p>
          </li>
</ul></div>
<p class="para">
...
<p class="para">Sledeči vnos dodajte v datoteko <span class="file filename">crontab</span>:</p>
...
<p class="para">
        For more in-depth <span class="app application">crontab</span> options see <a class="xref" href="backup-shellscripts.html.sl#backup-shellscript-references" title="Sklici">Sklici</a>.
        </p>
</div></div>
</div></div>
</div>
...
<div class="hgroup"><h2 class="title">Obnavljanje iz arhiva</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
        <p class="para">To bo prepisalo datoteke, trenutno prisotne na sistemu.</p>
      </div></div></div></div>
</div></div>
</div></div>
...
<li class="list itemizedlist">
        ...
        that can be used.  For example:
          ...
          <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
              <p class="para"><a href="http://www.gnu.org/software/cpio/" class="ulink" title="http://www.gnu.org/software/cpio/">cpio</a>: uporabljen za kopiranje datotek v in iz arhivov</p>
            </li>
<li class="list itemizedlist">
              <p class="para">
