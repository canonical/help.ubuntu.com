...
<a class="nextlinks-prev" href="backup-shellscripts.html.be" title="Shell Scripts">Назад</a><a class="nextlinks-next" href="bacula.html.be" title="Bacula">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Archive Rotation</h1></div>
<div class="region">
<div class="contents"><p class="para">
    The shell script in <a class="xref" href="backup-shellscripts.html.be" title="Shell Scripts">Shell Scripts</a> only allows for seven different archives.  For
...
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.be#backups-nfs-rotation" title="Rotating NFS Archives">Rotating NFS Archives</a></li>
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.be#backup-shellscript-tapedrive" title="Tape Drives">Tape Drives</a></li>
</ul></div>
...
<p class="para">
      The script can be executed using the same methods as in <a class="xref" href="backup-shellscripts.html.be#backup-executing-shellscript" title="Executing the Script">Executing the Script</a>.
      </p>
<p class="para"> 
