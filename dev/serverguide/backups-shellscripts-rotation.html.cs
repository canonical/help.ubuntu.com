...
<a class="nextlinks-prev" href="backup-shellscripts.html.cs" title="Shell Scripts">Předchozí</a><a class="nextlinks-next" href="bacula.html.cs" title="Bacula">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Archive Rotation</h1></div>
<div class="region">
<div class="contents"><p class="para">
    The shell script in <a class="xref" href="backup-shellscripts.html.cs" title="Shell Scripts">Shell Scripts</a> only allows for seven different archives.  For
...
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.cs#backups-nfs-rotation" title="Rotating NFS Archives">Rotating NFS Archives</a></li>
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.cs#backup-shellscript-tapedrive" title="Tape Drives">Tape Drives</a></li>
</ul></div>
...
<p class="para">
      The script can be executed using the same methods as in <a class="xref" href="backup-shellscripts.html.cs#backup-executing-shellscript" title="Executing the Script">Executing the Script</a>.
      </p>
<p class="para"> 
