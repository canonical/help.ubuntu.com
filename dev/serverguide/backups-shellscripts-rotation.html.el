...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.el" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="backups.html.el" title="Αντίγραφα ασφαλείας">Αντίγραφα ασφαλείας</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="backup-shellscripts.html.el" title="Σενάρια εντολών κελύφους">Προηγούμενο</a><a class="nextlinks-next" href="bacula.html.el" title="Bacula">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Archive Rotation</h1></div>
<div class="region">
<div class="contents"><p class="para">
    The shell script in <a class="xref" href="backup-shellscripts.html.el" title="Σενάρια εντολών κελύφους">Σενάρια εντολών κελύφους</a> only allows for seven different archives.  For
...
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.el#backups-nfs-rotation" title="Rotating NFS Archives">Rotating NFS Archives</a></li>
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.el#backup-shellscript-tapedrive" title="Συσκευές κασέτας">Συσκευές κασέτας</a></li>
</ul></div>
...
<p class="para">Αυτό είναι το νέο σενάριο εντολών:</p>
...
<p class="para">Το σενάριο μπορεί να εκτελεστεί χρησιμοποιώντας τις ίδιες μεθόδους όπως στο <a class="xref" href="backup-shellscripts.html.el#backup-executing-shellscript" title="Εκτέλεση του σεναρίου εντολών">Εκτέλεση του σεναρίου εντολών</a>.</p>
<p class="para"> 
...
<div class="hgroup"><h2 class="title">Συσκευές κασέτας</h2></div>
<div class="region"><div class="contents">
<p class="para"> 
...
<p class="para">Αυτό είναι το σενάριο κελύφους τροποποιημένο ώστε να χρησιμοποιεί μια συσκευή κασέτας:</p>
<div class="code"><pre class="contents ">#!/bin/bash
##########################################
#
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Το προεπιλεγμένο όνομα για μία συσκευή κασέτας SCSI είναι <span class="file filename">/dev/st0</span>. Χρησιμοποιήστε την κατάλληλη διαδρομή συσκευής για το σύστημά σας.</p>
      </div></div></div></div>
<p class="para">Η επαναφορά από μία συσκευή δισκέτας είναι βασικά το ίδιο με την επαναφορά από ένα αρχείο. Απλά γυρίστε την κασέτα στην αρχή και χρησιμοποιήστε τη διαδρομή της συσκευής αντί για μία διαδρομή αρχείου. Για παράδειγμα για να επαναφέρετε το αρχείο <span class="file filename">/etc/hosts</span> στο <span class="file filename">/tmp/etc/hosts</span> εκτελέστε τα ακόλουθα:</p>
