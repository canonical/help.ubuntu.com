...
<a class="nextlinks-prev" href="backup-shellscripts.html.nl" title="Shell Scripts">Vorige</a><a class="nextlinks-next" href="bacula.html.nl" title="Bacula">Volgende</a>
</div>
<div class="hgroup"><h1 class="title">Archive Rotation</h1></div>
<div class="region">
<div class="contents"><p class="para">
    The shell script in <a class="xref" href="backup-shellscripts.html.nl" title="Shell Scripts">Shell Scripts</a> only allows for seven different archives.  For
...
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.nl#backups-nfs-rotation" title="Rotating NFS Archives">Rotating NFS Archives</a></li>
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.nl#backup-shellscript-tapedrive" title="Tapestations">Tapestations</a></li>
</ul></div>
...
<p class="para">Hier is het nieuwe script:</p>
...
<p class="para">Het script kan op dezelfde manier worden uitgevoerd als in <a class="xref" href="backup-shellscripts.html.nl#backup-executing-shellscript" title="Executing the Script">Executing the Script</a>.</p>
<p class="para"> 
...
<div class="hgroup"><h2 class="title">Tapestations</h2></div>
<div class="region"><div class="contents">
<p class="para"> 
