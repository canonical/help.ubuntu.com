...
<a class="nextlinks-prev" href="backup-shellscripts.html.ru" title="Сценарии Shell">Назад</a><a class="nextlinks-next" href="bacula.html.ru" title="Bacula">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Ротация архивов</h1></div>
<div class="region">
<div class="contents"><p class="para">Shell сценарий в разделе <a class="xref" href="backup-shellscripts.html.ru" title="Сценарии Shell">Сценарии Shell</a> позволяет создавать только 7 различных архивов. Для сервера, данные на котором меняются нечасто, этого может быть достаточно. Если же сервер содержит большой объем данных, требуется использовать более комплексную схему ротации архивов.</p></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.ru#backups-nfs-rotation" title="Ротация NFS архивов">Ротация NFS архивов</a></li>
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.ru#backup-shellscript-tapedrive" title="Устройства на магнитной ленте">Устройства на магнитной ленте</a></li>
</ul></div>
...
<p class="para">Сценарий может запускаться так же, как описано в секции <a class="xref" href="backup-shellscripts.html.ru#backup-executing-shellscript" title="Выполнение сценария">Выполнение сценария</a>.</p>
