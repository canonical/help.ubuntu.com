...
<a class="nextlinks-prev" href="backup-shellscripts.html.sl" title="Shell Scripts">Nazaj</a><a class="nextlinks-next" href="bacula.html.sl" title="Bacula">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Archive Rotation</h1></div>
<div class="region">
<div class="contents"><p class="para">
    The shell script in <a class="xref" href="backup-shellscripts.html.sl" title="Shell Scripts">Shell Scripts</a> only allows for seven different archives.  For
...
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.sl#backups-nfs-rotation" title="Rotating NFS Archives">Rotating NFS Archives</a></li>
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.sl#backup-shellscript-tapedrive" title="Tape Drives">Tape Drives</a></li>
</ul></div>
...
<p class="para">Tukaj je novi skript:</p>
...
<p class="para">
      The script can be executed using the same methods as in <a class="xref" href="backup-shellscripts.html.sl#backup-executing-shellscript" title="Izvajanje skripta">Izvajanje skripta</a>.
      </p>
<p class="para"> 
