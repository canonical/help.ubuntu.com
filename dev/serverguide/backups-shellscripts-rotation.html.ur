...
<a class="nextlinks-prev" href="backup-shellscripts.html.ur" title="Shell Scripts">Previous</a><a class="nextlinks-next" href="bacula.html.ur" title="Bacula">Next</a>
</div>
<div class="hgroup"><h1 class="title">Archive Rotation</h1></div>
<div class="region">
<div class="contents"><p class="para">
    The shell script in <a class="xref" href="backup-shellscripts.html.ur" title="Shell Scripts">Shell Scripts</a> only allows for seven different archives.  For
...
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.ur#backups-nfs-rotation" title="Rotating NFS Archives">Rotating NFS Archives</a></li>
<li class="links"><a class="xref" href="backups-shellscripts-rotation.html.ur#backup-shellscript-tapedrive" title="Tape Drives">Tape Drives</a></li>
</ul></div>
...
<p class="para">
      The script can be executed using the same methods as in <a class="xref" href="backup-shellscripts.html.ur#backup-executing-shellscript" title="Executing the Script">Executing the Script</a>.
      </p>
<p class="para"> 
