...
<a class="nextlinks-prev" href="backups-shellscripts-rotation.html.be" title="Archive Rotation">Назад</a><a class="nextlinks-next" href="virtualization.html.be" title="Virtualization">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="bacula.html.be#bacula-overview" title="Overview">Overview</a></li>
<li class="links"><a class="xref" href="bacula.html.be#bacula-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="bacula.html.be#bacula-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="bacula.html.be#bacula-localhost-backup" title="Localhost Backup">Localhost Backup</a></li>
<li class="links"><a class="xref" href="bacula.html.be#bacula-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">
      ...
      the appropriate rights to create a database, see <a class="xref" href="mysql.html.be" title="MySQL">MySQL</a> for more 
      information.
      </p>
</div></div>
</div></div>
...
<div class="screen"><pre class="contents "><span class="output computeroutput">
Enter new Volume name: <span class="input userinput">Нядзеля</span>
Defined Pools:
     1: Default
     2: Scratch</span>
</pre></div>
...
<li class="list itemizedlist">
          <p class="para"><a href="http://www.bacula.org/" class="ulink" title="http://www.bacula.org/">Хатняя старонка Bacula</a> зьмяшнае апошнія навіны і распрацоўкі.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
