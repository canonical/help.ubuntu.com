...
<a class="nextlinks-prev" href="backups-shellscripts-rotation.html.cs" title="Archive Rotation">Předchozí</a><a class="nextlinks-next" href="virtualization.html.cs" title="Virtualization">Následující</a>
</div>
...
<li class="links"><a class="xref" href="bacula.html.cs#bacula-overview" title="Overview">Overview</a></li>
<li class="links"><a class="xref" href="bacula.html.cs#bacula-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="bacula.html.cs#bacula-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="bacula.html.cs#bacula-localhost-backup" title="Localhost Backup">Localhost Backup</a></li>
<li class="links"><a class="xref" href="bacula.html.cs#bacula-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<p class="para">
      ...
      the appropriate rights to create a database, see <a class="xref" href="mysql.html.cs" title="MySQL">MySQL</a> for more 
      information.
      </p>
</div></div>
</div></div>
