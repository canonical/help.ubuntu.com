...
<a class="nextlinks-prev" href="backups-shellscripts-rotation.html.el" title="Archive Rotation">Προηγούμενο</a><a class="nextlinks-next" href="virtualization.html.el" title="Εικονικοποίηση">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="bacula.html.el#bacula-overview" title="Επισκόπηση">Επισκόπηση</a></li>
<li class="links"><a class="xref" href="bacula.html.el#bacula-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="bacula.html.el#bacula-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="bacula.html.el#bacula-localhost-backup" title="Αντίγραφα ασφαλείας του τοπικού υπολογιστή">Αντίγραφα ασφαλείας του τοπικού υπολογιστή</a></li>
<li class="links"><a class="xref" href="bacula.html.el#bacula-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">Κατά τη διαδικασία εγκατάστασης, θα σας ζητηθεί να δώσετε πιστοποιητικά για τον <span class="em emphasis">διαχειριστή</span> της βάσης δεδομένων και για τον <span class="em emphasis">ιδιοκτήτη</span> της βάσης δεδομένων του <span class="em emphasis">bacula</span>. Ο διαχειριστής της βάσης δεδομένων θα πρέπει να έχει τα κατάλληλα δικαιώματα για να δημιουργήσει μια βάση δεδομένων. Δείτε το <a class="xref" href="mysql.html.el" title="MySQL">MySQL</a> για περισσότερες πληροφορίες.</p>
</div></div>
</div></div>
