...
<a class="nextlinks-prev" href="backups-shellscripts-rotation.html.ru" title="Ротация архивов">Назад</a><a class="nextlinks-next" href="virtualization.html.ru" title="Виртуализация">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="bacula.html.ru#bacula-overview" title="Обзор">Обзор</a></li>
<li class="links"><a class="xref" href="bacula.html.ru#bacula-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="bacula.html.ru#bacula-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="bacula.html.ru#bacula-localhost-backup" title="Создание резервной копии локального сервера">Создание резервной копии локального сервера</a></li>
<li class="links"><a class="xref" href="bacula.html.ru#bacula-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
