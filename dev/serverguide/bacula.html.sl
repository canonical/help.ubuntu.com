...
<a class="nextlinks-prev" href="backups-shellscripts-rotation.html.sl" title="Archive Rotation">Nazaj</a><a class="nextlinks-next" href="virtualization.html.sl" title="Virtualization">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="bacula.html.sl#bacula-overview" title="Pregled">Pregled</a></li>
<li class="links"><a class="xref" href="bacula.html.sl#bacula-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="bacula.html.sl#bacula-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="bacula.html.sl#bacula-localhost-backup" title="Localhost Backup">Localhost Backup</a></li>
<li class="links"><a class="xref" href="bacula.html.sl#bacula-resources" title="Viri">Viri</a></li>
</ul></div>
...
<li class="list itemizedlist"><p class="para">Grafični vmesnik wxWidgets</p></li>
</ul></div>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<p class="para">
      ...
      the appropriate rights to create a database, see <a class="xref" href="mysql.html.sl" title="MySQL">MySQL</a> for more 
      information.
      </p>
</div></div>
</div></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo adduser uporabniško-ime bacula</span>
</pre></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
        <p class="para">
...
<li class="list itemizedlist">
          <p class="para">V konzoli Bacula vnesite:</p>
...
<div class="screen"><pre class="contents "><span class="output computeroutput">
Enter new Volume name: <span class="input userinput">Nedelja</span>
Defined Pools:
     1: Default
     2: Scratch</span>
</pre></div>
          <p class="para">Zamenjajte <span class="em emphasis">Nedelja</span> z željeno oznako.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<li class="list itemizedlist">
          <p class="para">Oglejte si tudi stran <a href="https://help.ubuntu.com/community/Bacula" class="ulink" title="https://help.ubuntu.com/community/Bacula">Bacula na Ubuntu Wiki</a>.</p>
        </li>
</ul></div></div></div>
</div></div>
</div>
