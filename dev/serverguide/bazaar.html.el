...
<a class="nextlinks-prev" href="version-control-system.html.el" title="Σύστημα Ελέγχου Έκδοσης">Προηγούμενο</a><a class="nextlinks-next" href="git.html.el" title="Git">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="bazaar.html.el#bzr-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="bazaar.html.el#bzr-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="bazaar.html.el#bzr-learning" title="Μαθαίνοντας">Μαθαίνοντας</a></li>
<li class="links"><a class="xref" href="bazaar.html.el#bzr-lp-integration" title="Ενσωμάτωση Εκκινητή">Ενσωμάτωση Εκκινητή</a></li>
</ul></div>
