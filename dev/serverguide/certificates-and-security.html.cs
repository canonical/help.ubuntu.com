...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.cs" title="Průvodce pro Ubuntu Server">Průvodce pro Ubuntu Server</a> » <a class="trail" href="security.html.cs" title="Security">Security</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="apparmor.html.cs" title="AppArmor">Předchozí</a><a class="nextlinks-next" href="ecryptfs.html.cs" title="eCryptfs">Následující</a>
</div>
...
<li class="links"><a class="xref" href="certificates-and-security.html.cs#types-of-certificates" title="Types of Certificates">Types of Certificates</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.cs#generating-a-csr" title="Generating a Certificate Signing Request (CSR)">Generating a Certificate Signing Request (CSR)</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.cs#creating-a-self-signed-certificate" title="Creating a Self-Signed Certificate">Creating a Self-Signed Certificate</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.cs#installing-the-certificate" title="Installing the Certificate">Installing the Certificate</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.cs#certificate-authority" title="Certification Authority">Certification Authority</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.cs#certificate-references" title="References">References</a></li>
</ul></div>
...
<li class="steps">
              ...
              Request (CSR), see <a class="xref" href="certificates-and-security.html.cs#generating-a-csr" title="Generating a Certificate Signing Request (CSR)">Generating a Certificate Signing Request (CSR)</a> for details. Once
