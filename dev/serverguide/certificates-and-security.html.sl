...
<a class="nextlinks-prev" href="apparmor.html.sl" title="AppArmor">Nazaj</a><a class="nextlinks-next" href="ecryptfs.html.sl" title="eCryptfs">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Potrdila</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="certificates-and-security.html.sl#types-of-certificates" title="Vrste potrdil">Vrste potrdil</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.sl#generating-a-csr" title="Generating a Certificate Signing Request (CSR)">Generating a Certificate Signing Request (CSR)</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.sl#creating-a-self-signed-certificate" title="Creating a Self-Signed Certificate">Creating a Self-Signed Certificate</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.sl#installing-the-certificate" title="Nameščanje potrdila">Nameščanje potrdila</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.sl#certificate-authority" title="Overitelj potrdil">Overitelj potrdil</a></li>
<li class="links"><a class="xref" href="certificates-and-security.html.sl#certificate-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="types-of-certificates"><div class="inner">
<div class="hgroup"><h2 class="title">Vrste potrdil</h2></div>
...
<div class="hgroup"><h2 class="title">Nameščanje potrdila</h2></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title">Overitelj potrdil</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">openssl req -new -x509 -extensions v3_ca -keyout cakey.pem -out cacert.pem -days 3650</span>
              ...
              <p class="para">Vprašani boste za vnos podatkov o potrdilu.</p>
...
<li class="steps">
              ...
              Request (CSR), see <a class="xref" href="certificates-and-security.html.sl#generating-a-csr" title="Generating a Certificate Signing Request (CSR)">Generating a Certificate Signing Request (CSR)</a> for details. Once
...
<li class="list itemizedlist">
              <p class="para">Za več informacij o <span class="em emphasis">OpenSSL-u</span> si oglejte <a href="http://www.openssl.org/" class="ulink" title="http://www.openssl.org/">domačo stran OpenSSL-a</a>.</p>
            </li>
<li class="list itemizedlist">
              <p class="para">
