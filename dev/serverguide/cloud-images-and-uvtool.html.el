...
<a class="nextlinks-prev" href="qemu.html.el" title="Qemu">Προηγούμενο</a><a class="nextlinks-next" href="ubuntucloud.html.el" title="Ubuntu Cloud">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Cloud images and uvtool</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.el#cloud-image-introduction" title="Εισαγωγή">Εισαγωγή</a></li>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.el#creating-virtual-machines-using-uvtool" title="Creating virtual machines using uvtool">Creating virtual machines using uvtool</a></li>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.el#resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<div class="region"><div class="contents">
<p class="para">Εάν ενδιαφέρεστε να μάθετε περισσότερα, έχετε απορίες ή προτάσεις, παρακαλώ επικοινωνήστε με την Ομάδα Διακομιστή Ubuntu στο:</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
          <p class="para">IRC: #ubuntu-server on freenode</p>
        </li>
<li class="list itemizedlist">
          <p class="para">Λίστα Ηλεκτρονικής Αλληλογραφίας: <a href="https://lists.ubuntu.com/mailman/listinfo/ubuntu-server" class="ulink" title="https://lists.ubuntu.com/mailman/listinfo/ubuntu-server">ubuntu-server at lists.ubuntu.com</a></p>
        </li>
</ul></div>
</div></div>
</div></div>
