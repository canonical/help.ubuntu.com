...
<a class="nextlinks-prev" href="qemu.html.es" title="Qemu">Anterior</a><a class="nextlinks-next" href="ubuntucloud.html.es" title="Ubuntu Cloud">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Cloud images and uvtool</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.es#cloud-image-introduction" title="Introducción">Introducción</a></li>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.es#creating-virtual-machines-using-uvtool" title="Creating virtual machines using uvtool">Creating virtual machines using uvtool</a></li>
<li class="links"><a class="xref" href="cloud-images-and-uvtool.html.es#resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<div class="region"><div class="contents">
<p class="para">Si esta interesado en saber más, o tiene preguntas o sugerencias, por favor contacte con el equipo de Ubuntu Server en:</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
          <p class="para">IRC: #ubuntu-server on freenode</p>
        </li>
<li class="list itemizedlist">
          <p class="para">Lista de correo: <a href="https://lists.ubuntu.com/mailman/listinfo/ubuntu-server" class="ulink" title="https://lists.ubuntu.com/mailman/listinfo/ubuntu-server">ubuntu-server en lists.ubuntu.com</a></p>
        </li>
</ul></div>
</div></div>
</div></div>
