...
<a class="nextlinks-prev" href="automatic-updates.html.be" title="Аўтаматычныя абнаўленьні">Назад</a><a class="nextlinks-next" href="package-management-references.html.be" title="Спасылкі">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Настаўленьні</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="configuration.html.be#extra-repositories" title="Extra Repositories">Extra Repositories</a></li></ul></div>
<div class="sect2 sect" id="extra-repositories"><div class="inner">
<div class="hgroup"><h2 class="title">Extra Repositories</h2></div>
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents"><p class="para">Packages in the <span class="em emphasis">Multiverse</span> repository often have licensing issues that prevent them from being distributed with a free operating system, and they may be illegal in your locality.</p></div></div></div></div>
<div class="note note-warning" title="Перасцярога"><div class="inner"><div class="region"><div class="contents">
          <p class="para">
          Be advised that neither the <span class="em emphasis">Universe</span> or <span class="em emphasis">Multiverse</span> repositories contain officially supported packages. In particular, there may not be security updates for these packages.
          </p>
          </div></div></div></div>
<p class="para">
...
<p class="para">
          By default, the <span class="em emphasis">Universe</span> and
          <span class="em emphasis">Multiverse</span> repositories are enabled but if
          you would like to disable them edit <span class="file filename">/etc/apt/sources.list</span> 
