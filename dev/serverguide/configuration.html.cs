...
<a class="nextlinks-prev" href="automatic-updates.html.cs" title="Automatic Updates">Předchozí</a><a class="nextlinks-next" href="package-management-references.html.cs" title="References">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Nastavení</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="configuration.html.cs#extra-repositories" title="Extra Repositories">Extra Repositories</a></li></ul></div>
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents"><p class="para">Packages in the <span class="em emphasis">Multiverse</span> repository often have licensing issues that prevent them from being distributed with a free operating system, and they may be illegal in your locality.</p></div></div></div></div>
