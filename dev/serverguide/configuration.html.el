...
<a class="nextlinks-prev" href="automatic-updates.html.el" title="Αυτόματες Ενημερώσεις">Προηγούμενο</a><a class="nextlinks-next" href="package-management-references.html.el" title="Αναφορές">Επόμενο</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="configuration.html.el#extra-repositories" title="Επιπλέον Αποθετήρια">Επιπλέον Αποθετήρια</a></li></ul></div>
