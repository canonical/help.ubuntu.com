...
<a class="nextlinks-prev" href="automatic-updates.html.ru" title="Автоматические обновления">Назад</a><a class="nextlinks-next" href="package-management-references.html.ru" title="Ссылки">Вперёд</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="configuration.html.ru#extra-repositories" title="Дополнительные репозитории">Дополнительные репозитории</a></li></ul></div>
