...
<a class="nextlinks-prev" href="automatic-updates.html.sl" title="Samodejne posodobitve">Nazaj</a><a class="nextlinks-next" href="package-management-references.html.sl" title="Sklici">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Nastavljanje</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="configuration.html.sl#extra-repositories" title="Dodatna skladišča">Dodatna skladišča</a></li></ul></div>
<div class="sect2 sect" id="extra-repositories"><div class="inner">
<div class="hgroup"><h2 class="title">Dodatna skladišča</h2></div>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="para">Packages in the <span class="em emphasis">Multiverse</span> repository often have licensing issues that prevent them from being distributed with a free operating system, and they may be illegal in your locality.</p></div></div></div></div>
