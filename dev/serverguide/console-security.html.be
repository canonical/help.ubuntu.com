...
<a class="nextlinks-prev" href="user-management.html.be" title="User Management">Назад</a><a class="nextlinks-next" href="firewall.html.be" title="Брандмаўэр">Наперад</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="console-security.html.be#disable-ctrl-alt-delete" title="Выключыць Ctrl+Alt+Delete">Выключыць Ctrl+Alt+Delete</a></li></ul></div>
