...
<a class="nextlinks-prev" href="user-management.html.el" title="Διαχείριση Χρηστών">Προηγούμενο</a><a class="nextlinks-next" href="firewall.html.el" title="Τείχος Προστασίας">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Ασφάλεια Κονσόλας</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<p class="para">Οι ακόλουθες οδηγίες θα βοηθήσουν να υπερασπίσετε το διακομιστή σας ενάντια σε θέματα που θα μπορούσαν να αποφέρουν σοβαρές συνέπειες.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="console-security.html.el#disable-ctrl-alt-delete" title="Απενεργοποίηση Ctrl+Alt+Delete">Απενεργοποίηση Ctrl+Alt+Delete</a></li></ul></div>
<div class="sect2 sect" id="disable-ctrl-alt-delete"><div class="inner">
<div class="hgroup"><h2 class="title">Απενεργοποίηση Ctrl+Alt+Delete</h2></div>
