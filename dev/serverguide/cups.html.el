...
<a class="nextlinks-prev" href="iscsi-initiator.html.el" title="Aρχικοποιητής iSCSI">Προηγούμενο</a><a class="nextlinks-next" href="email-services.html.el" title="Υπηρεσίες Ηλ. Αλληλογραφίας">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="cups.html.el#cups-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="cups.html.el#cups-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="cups.html.el#cups-web" title="Περιβάλλον ιστού">Περιβάλλον ιστού</a></li>
<li class="links"><a class="xref" href="cups.html.el#cups-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
