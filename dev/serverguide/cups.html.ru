...
<a class="nextlinks-prev" href="iscsi-initiator.html.ru" title="iSCSI-инициатор">Назад</a><a class="nextlinks-next" href="email-services.html.ru" title="Сервисы электронной почты">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="cups.html.ru#cups-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="cups.html.ru#cups-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="cups.html.ru#cups-web" title="Веб-интерфейс">Веб-интерфейс</a></li>
<li class="links"><a class="xref" href="cups.html.ru#cups-references" title="Ссылки">Ссылки</a></li>
</ul></div>
