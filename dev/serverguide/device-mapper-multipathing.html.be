...
<a class="nextlinks-prev" href="dm-multipath-chapter.html.be" title="DM-Multipath">Назад</a><a class="nextlinks-next" href="multipath-devices.html.be" title="Multipath Devices">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="device-mapper-multipathing.html.be#multipath-new-and-changed-features" title="New and Changed Features for Ubuntu Server 12.04">New and Changed Features for Ubuntu Server 12.04</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.be#multipath-overview" title="Overview">Overview</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.be#multipath-storage-array-support" title="Storage Array Overview">Storage Array Overview</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.be#multipath-dm-multipath-components" title="DM-Multipath components">DM-Multipath components</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.be#multipath-dm-multipath-setup-overview" title="DM-Multipath Setup Overview">DM-Multipath Setup Overview</a></li>
</ul></div>
...
<p class="para">See Table <a class="xref" href="device-mapper-multipathing.html.be#priority-checker-conversion-table" title="Priority Checker
...
<div class="region"><div class="contents"><p class="para">By default, DM-Multipath includes support for the most common
      ...
      see Section, <a class="link" href="multipath-dm-multipath-config-file.html.be" title="The DM-Multipath Configuration File">The
...
<div class="region"><div class="contents">
<p class="para">Table <a class="link" href="device-mapper-multipathing.html.be#multipath-components-table" title="DM-Multipath Components">DM-Multipath
...
<li class="list orderedlist">
            ...
            re-defines the <a class="link" href="multipath-setting-up-dm-multipath.html.be#multipath-skel-config" title="">following</a></p>
          </li>
<li class="list orderedlist">
...
<li class="list orderedlist">
      ...
      configuration see Section, <a class="link" href="multipath-setting-up-dm-multipath.html.be#multipath-setup-overview" title="Setting Up DM-Multipath">Setting Up
