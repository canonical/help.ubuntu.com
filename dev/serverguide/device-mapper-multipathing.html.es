...
<a class="nextlinks-prev" href="dm-multipath-chapter.html.es" title="DM-Multipath">Anterior</a><a class="nextlinks-next" href="multipath-devices.html.es" title="Dispositivos multiruta">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="device-mapper-multipathing.html.es#multipath-new-and-changed-features" title="New and Changed Features for Ubuntu Server 12.04">New and Changed Features for Ubuntu Server 12.04</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.es#multipath-overview" title="Vista general">Vista general</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.es#multipath-storage-array-support" title="Storage Array Overview">Storage Array Overview</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.es#multipath-dm-multipath-components" title="DM-Multipath components">DM-Multipath components</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.es#multipath-dm-multipath-setup-overview" title="DM-Multipath Setup Overview">DM-Multipath Setup Overview</a></li>
</ul></div>
...
<div class="hgroup"><h3 class="title">Migración desde 0.4.8</h3></div>
...
<p class="para">See Table <a class="xref" href="device-mapper-multipathing.html.es#priority-checker-conversion-table" title="Priority Checker
...
<div class="region"><div class="contents"><p class="para">By default, DM-Multipath includes support for the most common
      ...
      see Section, <a class="link" href="multipath-dm-multipath-config-file.html.es" title="The DM-Multipath Configuration File">The
...
<div class="region"><div class="contents">
<p class="para">Table <a class="link" href="device-mapper-multipathing.html.es#multipath-components-table" title="DM-Multipath Components">DM-Multipath
...
<tr>
<td class="td-colsep td-rowsep" style="text-align: left;">
          <span class="em em-bold emphasis">demonio multipathd</span>
        </td>
...
<td class="td-colsep" style="text-align: left;">
          <span class="em em-bold emphasis">Orden kpartx</span>
        </td>
...
<li class="list orderedlist">
            ...
            re-defines the <a class="link" href="multipath-setting-up-dm-multipath.html.es#multipath-skel-config" title="">following</a></p>
          </li>
<li class="list orderedlist">
...
<li class="list orderedlist">
      ...
      configuration see Section, <a class="link" href="multipath-setting-up-dm-multipath.html.es#multipath-setup-overview" title="Setting Up DM-Multipath">Setting Up
