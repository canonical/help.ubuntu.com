...
<a class="nextlinks-prev" href="dm-multipath-chapter.html.mk" title="DM-Multipath">Previous</a><a class="nextlinks-next" href="multipath-devices.html.mk" title="Multipath Devices">Next</a>
</div>
...
<li class="links"><a class="xref" href="device-mapper-multipathing.html.mk#multipath-new-and-changed-features" title="New and Changed Features for Ubuntu Server 12.04">New and Changed Features for Ubuntu Server 12.04</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.mk#multipath-overview" title="Overview">Overview</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.mk#multipath-storage-array-support" title="Storage Array Overview">Storage Array Overview</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.mk#multipath-dm-multipath-components" title="DM-Multipath components">DM-Multipath components</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.mk#multipath-dm-multipath-setup-overview" title="DM-Multipath Setup Overview">DM-Multipath Setup Overview</a></li>
</ul></div>
...
<p class="para">See Table <a class="xref" href="device-mapper-multipathing.html.mk#priority-checker-conversion-table" title="Priority Checker
...
<div class="region"><div class="contents"><p class="para">By default, DM-Multipath includes support for the most common
      ...
      see Section, <a class="link" href="multipath-dm-multipath-config-file.html.mk" title="The DM-Multipath Configuration File">The
...
<div class="region"><div class="contents">
<p class="para">Table <a class="link" href="device-mapper-multipathing.html.mk#multipath-components-table" title="DM-Multipath Components">DM-Multipath
...
<li class="list orderedlist">
            ...
            re-defines the <a class="link" href="multipath-setting-up-dm-multipath.html.mk#multipath-skel-config" title="">following</a></p>
          </li>
<li class="list orderedlist">
...
<li class="list orderedlist">
      ...
      configuration see Section, <a class="link" href="multipath-setting-up-dm-multipath.html.mk#multipath-setup-overview" title="Setting Up DM-Multipath">Setting Up
