...
<a class="nextlinks-prev" href="dm-multipath-chapter.html.ru" title="Множественное связывание устройств (DM-Multipath)">Назад</a><a class="nextlinks-next" href="multipath-devices.html.ru" title="Множественные устройства">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="device-mapper-multipathing.html.ru#multipath-new-and-changed-features" title="Новые и изменённые возможности в Ubuntu Server 12.04">Новые и изменённые возможности в Ubuntu Server 12.04</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.ru#multipath-overview" title="Обзор">Обзор</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.ru#multipath-storage-array-support" title="Обзор массивов носителей">Обзор массивов носителей</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.ru#multipath-dm-multipath-components" title="Компоненты DM-Multipath">Компоненты DM-Multipath</a></li>
<li class="links"><a class="xref" href="device-mapper-multipathing.html.ru#multipath-dm-multipath-setup-overview" title="Настройка DM-Multipath">Настройка DM-Multipath</a></li>
</ul></div>
...
<p class="para">См. таблицу <a class="xref" href="device-mapper-multipathing.html.ru#priority-checker-conversion-table" title="Преобразование модулей проверки приоритета">Преобразование модулей проверки приоритета</a>, в которой приведён полный список изменений.</p>
<div class="table">
...
<div class="region"><div class="contents">
<p class="para">Таблица <a class="link" href="device-mapper-multipathing.html.ru#multipath-components-table" title="Компоненты DM-Multipath">DM-Multipath Components</a> описывает компоненты пакета DM-Multipath.</p>
<div class="table">
...
<li class="list orderedlist">
            <p class="para">Создайте пустой настроечный файл <span class="file filename">/etc/multipath.conf</span>, который переопределит <a class="link" href="multipath-setting-up-dm-multipath.html.ru#multipath-skel-config" title="">следующее</a></p>
          </li>
<li class="list orderedlist">
...
</ol></div> Для детальных инструкций по настройке multipath смотрите раздел <a class="link" href="multipath-setting-up-dm-multipath.html.ru#multipath-setup-overview" title="Настройка DM-Multipath">Setting Up DM-Multipath</a>.</p></div></div>
</div></div>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="dm-multipath-chapter.html.ru" title="Множественное связывание устройств (DM-Multipath)">Назад</a><a class="nextlinks-next" href="multipath-devices.html.ru" title="Множественные устройства">Вперёд</a>
