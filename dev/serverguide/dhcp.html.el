...
<a class="nextlinks-prev" href="tcpip.html.el" title="TCP/IP">Προηγούμενο</a><a class="nextlinks-next" href="NTP.html.el" title="Time Synchronization">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="dhcp.html.el#dhcp-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="dhcp.html.el#dhcp-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="dhcp.html.el#dhcp-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
