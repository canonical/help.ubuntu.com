...
<a class="nextlinks-prev" href="tcpip.html.ru" title="TCP/IP">Назад</a><a class="nextlinks-next" href="NTP.html.ru" title="Time Synchronization">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="dhcp.html.ru#dhcp-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="dhcp.html.ru#dhcp-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="dhcp.html.ru#dhcp-references" title="Ссылки">Ссылки</a></li>
</ul></div>
