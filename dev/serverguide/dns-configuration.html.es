...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="dns.html.es" title="Servicio de nombres de dominio (DNS)">Servicio de nombres de dominio (DNS)</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="dns-installation.html.es" title="Instalación">Anterior</a><a class="nextlinks-next" href="dns-troubleshooting.html.es" title="Resolución de problemas">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="dns-configuration.html.es#dns-configuration-overview" title="Vista general">Vista general</a></li>
<li class="links"><a class="xref" href="dns-configuration.html.es#dns-caching-configuration" title="Servidor de Nombres Caché">Servidor de Nombres Caché</a></li>
<li class="links"><a class="xref" href="dns-configuration.html.es#dns-primarymaster-configuration" title="Maestro primario">Maestro primario</a></li>
<li class="links"><a class="xref" href="dns-configuration.html.es#dns-secondarymaster-configuration" title="Maestro secundario">Maestro secundario</a></li>
</ul></div>
...
<p class="para">Vea <a class="xref" href="dns-troubleshooting.html.es#dns-testing-dig" title="dig">dig</a> para información sobre como testar un servidor DNS caché.</p>
</div></div>
</div></div>
...
<p class="para">Ahora, usted puede agregar registros DNS al final del archivo de zona. Vea <a class="xref" href="dns-references.html.es#dns-record-types" title="Tipos de registros habituales">Tipos de registros habituales</a> para detalles.</p>
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
	         <p class="para">
