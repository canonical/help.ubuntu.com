...
<a class="nextlinks-prev" href="dns-installation.html.sl" title="Namestitev">Nazaj</a><a class="nextlinks-next" href="dns-troubleshooting.html.sl" title="Odpravljanje napak">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="dns-configuration.html.sl#dns-configuration-overview" title="Pregled">Pregled</a></li>
<li class="links"><a class="xref" href="dns-configuration.html.sl#dns-caching-configuration" title="Caching Nameserver">Caching Nameserver</a></li>
<li class="links"><a class="xref" href="dns-configuration.html.sl#dns-primarymaster-configuration" title="Primary Master">Primary Master</a></li>
<li class="links"><a class="xref" href="dns-configuration.html.sl#dns-secondarymaster-configuration" title="Secondary Master">Secondary Master</a></li>
</ul></div>
...
<p class="para">
	  See <a class="xref" href="dns-troubleshooting.html.sl#dns-testing-dig" title="dig">dig</a> for information on testing a caching DNS server.
          </p>
</div></div>
</div></div>
...
<p class="para">
	       Now, you can add DNS records to the bottom of the zone file.  See <a class="xref" href="dns-references.html.sl#dns-record-types" title="Common Record Types">Common Record Types</a> for details.
	       </p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
	         <p class="para">
