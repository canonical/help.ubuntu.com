...
<a class="nextlinks-prev" href="dns-troubleshooting.html.ru" title="Устранение проблем">Назад</a><a class="nextlinks-next" href="security.html.ru" title="Защита">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Ссылки</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="dns-references.html.ru#dns-record-types" title="Общие типы записей">Общие типы записей</a></li>
<li class="links"><a class="xref" href="dns-references.html.ru#dns-more-info" title="Дополнительная информация">Дополнительная информация</a></li>
</ul></div>
