...
<a class="nextlinks-prev" href="dns-configuration.html.be" title="Настаўленьні">Назад</a><a class="nextlinks-next" href="dns-references.html.be" title="Спасылкі">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="dns-troubleshooting.html.be#dns-testing" title="Праверка">Праверка</a></li>
<li class="links"><a class="xref" href="dns-troubleshooting.html.be#dns-logging" title="Logging">Logging</a></li>
</ul></div>
...
<p class="para">
	    ...
	    Refer to <a class="xref" href="network-configuration.html.be#dns-client-configuration" title="DNS Client Configuration">DNS Client Configuration</a> for details on adding nameserver addresses to your network clients, and afterwards check
...
<div class="code"><pre class="contents ">/var/log/query.log w,
	      ...
	      <p class="para">Далей перазапусьціце профіль:</p>
<div class="screen"><pre class="contents "><span class="cmd command">cat /etc/apparmor.d/usr.sbin.named | sudo apparmor_parser -r</span>
</pre></div>
	      <p class="para">Каб пабачыць боль зьвестак па <span class="app application">AppArmor</span> глядзіце <a class="xref" href="apparmor.html.be" title="AppArmor">AppArmor</a></p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">Цяпер перазапусьціце <span class="app application">BIND9</span> каб ужыць зьмены:</p>
...
<p class="para">
	  ...
	  <span class="app application">BIND9</span> logging options.  For coverage of advanced options see <a class="xref" href="dns-references.html.be#dns-more-info" title="Больш зьвестак">Больш зьвестак</a>.
	  </p>
</div></div>
</div></div>
</div>
