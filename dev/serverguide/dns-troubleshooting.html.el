...
<a class="nextlinks-prev" href="dns-configuration.html.el" title="Ρυθμίσεις">Προηγούμενο</a><a class="nextlinks-next" href="dns-references.html.el" title="Αναφορές">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="dns-troubleshooting.html.el#dns-testing" title="Δοκιμή">Δοκιμή</a></li>
<li class="links"><a class="xref" href="dns-troubleshooting.html.el#dns-logging" title="Καταγραφή">Καταγραφή</a></li>
</ul></div>
...
<p class="para">
	    ...
	    Refer to <a class="xref" href="network-configuration.html.el#dns-client-configuration" title="DNS Client Configuration">DNS Client Configuration</a> for details on adding nameserver addresses to your network clients, and afterwards check
...
<div class="screen"><pre class="contents "><span class="cmd command">cat /etc/apparmor.d/usr.sbin.named | sudo apparmor_parser -r</span>
	      ...
	      <p class="para">Για περισσότερες πληροφορίες σχετικά με το <span class="app application">AppArmor</span> δείτε το <a class="xref" href="apparmor.html.el" title="AppArmor">AppArmor</a></p>
	    </li>
<li class="list itemizedlist">
...
<p class="para">Θα πρέπει να δείτε το αρχείο <span class="file filename">/var/log/query.log</span> να γεμίζει με πληροφορίες ερωτημάτων. Αυτό είναι ένα απλό παράδειγμα των επιλογών καταγραφής που προσφέρει το <span class="app application">BIND9</span>. Για κάλυψη προχωρημένων επιλογών δείτε το <a class="xref" href="dns-references.html.el#dns-more-info" title="Περισσότερες πληροφορίες">Περισσότερες πληροφορίες</a>.</p>
</div></div>
</div></div>
</div>
<div class="links nextlinks">
