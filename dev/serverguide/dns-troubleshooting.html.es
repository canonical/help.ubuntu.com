...
<a class="nextlinks-prev" href="dns-configuration.html.es" title="Configuración">Anterior</a><a class="nextlinks-next" href="dns-references.html.es" title="Referencias">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="dns-troubleshooting.html.es#dns-testing" title="Comprobando">Comprobando</a></li>
<li class="links"><a class="xref" href="dns-troubleshooting.html.es#dns-logging" title="Entrada">Entrada</a></li>
</ul></div>
...
<p class="para">
	    ...
	    Refer to <a class="xref" href="network-configuration.html.es#dns-client-configuration" title="Configuración de cliente DNS">Configuración de cliente DNS</a> for details on adding nameserver addresses to your network clients, and afterwards check
...
<div class="screen"><pre class="contents "><span class="cmd command">cat /etc/apparmor.d/usr.sbin.named | sudo apparmor_parser -r</span>
	      ...
	      <p class="para">Para más información sobre <span class="app application">AppArmor</span> vea <a class="xref" href="apparmor.html.es" title="AppArmor">AppArmor</a></p>
	    </li>
<li class="list itemizedlist">
