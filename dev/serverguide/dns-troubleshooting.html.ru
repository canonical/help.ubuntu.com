...
<a class="nextlinks-prev" href="dns-configuration.html.ru" title="Конфигурация">Назад</a><a class="nextlinks-next" href="dns-references.html.ru" title="Ссылки">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="dns-troubleshooting.html.ru#dns-testing" title="Тестирование">Тестирование</a></li>
<li class="links"><a class="xref" href="dns-troubleshooting.html.ru#dns-logging" title="Ведение журнала">Ведение журнала</a></li>
</ul></div>
...
<p class="para">
	    ...
	    Refer to <a class="xref" href="network-configuration.html.ru#dns-client-configuration" title="Настройка клиента DNS">Настройка клиента DNS</a> for details on adding nameserver addresses to your network clients, and afterwards check
...
<div class="screen"><pre class="contents "><span class="cmd command">cat /etc/apparmor.d/usr.sbin.named | sudo apparmor_parser -r</span>
	      ...
	      <p class="para">Дополнительную информацию по <span class="app application">AppArmor</span> смотрите в разделе <a class="xref" href="apparmor.html.ru" title="AppArmor">AppArmor</a></p>
	    </li>
<li class="list itemizedlist">
...
<p class="para">Теперь вы можете увидеть файл <span class="file filename">/var/log/query.log</span>, заполненный информацией о запросах. Это простейший пример использования опций журналирования <span class="app application">BIND9</span>. По использованию расширенных опций смотрите раздел <a class="xref" href="dns-references.html.ru#dns-more-info" title="Дополнительная информация">Дополнительная информация</a>.</p>
</div></div>
</div></div>
</div>
<div class="links nextlinks">
