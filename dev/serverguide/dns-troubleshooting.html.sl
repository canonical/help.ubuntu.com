...
<a class="nextlinks-prev" href="dns-configuration.html.sl" title="Nastavljanje">Nazaj</a><a class="nextlinks-next" href="dns-references.html.sl" title="Sklici">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Odpravljanje napak</h1></div>
<div class="region">
...
<li class="links"><a class="xref" href="dns-troubleshooting.html.sl#dns-testing" title="Preizkušanje">Preizkušanje</a></li>
<li class="links"><a class="xref" href="dns-troubleshooting.html.sl#dns-logging" title="Logging">Logging</a></li>
</ul></div>
...
<p class="para">
	    ...
	    Refer to <a class="xref" href="network-configuration.html.sl#dns-client-configuration" title="DNS Client Configuration">DNS Client Configuration</a> for details on adding nameserver addresses to your network clients, and afterwards check
...
<div class="screen"><pre class="contents "><span class="cmd command">cat /etc/apparmor.d/usr.sbin.named | sudo apparmor_parser -r</span>
	      ...
	      <p class="para">
               For more information on <span class="app application">AppArmor</span> see <a class="xref" href="apparmor.html.sl" title="AppArmor">AppArmor</a>
	      </p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<p class="para">
	  ...
	  <span class="app application">BIND9</span> logging options.  For coverage of advanced options see <a class="xref" href="dns-references.html.sl#dns-more-info" title="Več informacij">Več informacij</a>.
	  </p>
</div></div>
</div></div>
</div>
