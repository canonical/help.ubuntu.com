...
<a class="nextlinks-prev" href="dns-configuration.html.ur" title="Configuration">Previous</a><a class="nextlinks-next" href="dns-references.html.ur" title="References">Next</a>
</div>
...
<li class="links"><a class="xref" href="dns-troubleshooting.html.ur#dns-testing" title="Testing">Testing</a></li>
<li class="links"><a class="xref" href="dns-troubleshooting.html.ur#dns-logging" title="Logging">Logging</a></li>
</ul></div>
...
<p class="para">
	    ...
	    Refer to <a class="xref" href="network-configuration.html.ur#dns-client-configuration" title="DNS Client Configuration">DNS Client Configuration</a> for details on adding nameserver addresses to your network clients, and afterwards check
...
<div class="screen"><pre class="contents "><span class="cmd command">cat /etc/apparmor.d/usr.sbin.named | sudo apparmor_parser -r</span>
	      ...
	      <p class="para">
               For more information on <span class="app application">AppArmor</span> see <a class="xref" href="apparmor.html.ur" title="AppArmor">AppArmor</a>
	      </p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<p class="para">
	  ...
	  <span class="app application">BIND9</span> logging options.  For coverage of advanced options see <a class="xref" href="dns-references.html.ur#dns-more-info" title="More Information">More Information</a>.
	  </p>
</div></div>
</div></div>
</div>
