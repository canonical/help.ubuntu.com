...
<a class="nextlinks-prev" href="exim4.html.be" title="Exim4">Назад</a><a class="nextlinks-next" href="mailman.html.be" title="Mailman">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="dovecot-server.html.be#dovecot-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.be#dovecot-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.be#dovecot-ssl" title="Наладкі Dovecot SSL">Наладкі Dovecot SSL</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.be" title="Наладкі брандмаўэра для сэрвера Email">Наладкі брандмаўэра для сэрвера Email</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.be#dovecot-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<p class="para">
                ...
                following lines if you want to set up a custom certificate (See <a class="xref" href="certificates-and-security.html.be" title="Certificates">Certificates</a> for more details.):
        </p>
...
<p class="para">
      ...
      Please refer to <a class="xref" href="certificates-and-security.html.be" title="Certificates">Certificates</a>
