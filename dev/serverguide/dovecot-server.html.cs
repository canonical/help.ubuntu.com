...
<a class="nextlinks-prev" href="exim4.html.cs" title="Exim4">Předchozí</a><a class="nextlinks-next" href="mailman.html.cs" title="Mailman">Následující</a>
</div>
...
<li class="links"><a class="xref" href="dovecot-server.html.cs#dovecot-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.cs#dovecot-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.cs#dovecot-ssl" title="Dovecot SSL Configuration">Dovecot SSL Configuration</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.cs" title="Firewall Configuration for an Email Server">Firewall Configuration for an Email Server</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.cs#dovecot-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
                ...
                following lines if you want to set up a custom certificate (See <a class="xref" href="certificates-and-security.html.cs" title="Certificates">Certificates</a> for more details.):
        </p>
...
<p class="para">
      ...
      Please refer to <a class="xref" href="certificates-and-security.html.cs" title="Certificates">Certificates</a>
