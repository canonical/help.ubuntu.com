...
<a class="nextlinks-prev" href="exim4.html.es" title="Exim4">Anterior</a><a class="nextlinks-next" href="mailman.html.es" title="Mailman">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="dovecot-server.html.es#dovecot-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.es#dovecot-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.es#dovecot-ssl" title="Configuración de Dovecot SSL">Configuración de Dovecot SSL</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.es" title="Configuración del cortafuegos para un servidor de correo">Configuración del cortafuegos para un servidor de correo</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.es#dovecot-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<p class="para">
                ...
                following lines if you want to set up a custom certificate (See <a class="xref" href="certificates-and-security.html.es" title="Certificados">Certificados</a> for more details.):
        </p>
...
<p class="para">
      ...
      Please refer to <a class="xref" href="certificates-and-security.html.es" title="Certificados">Certificados</a>
