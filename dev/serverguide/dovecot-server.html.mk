...
<a class="nextlinks-prev" href="exim4.html.mk" title="Exim4">Previous</a><a class="nextlinks-next" href="mailman.html.mk" title="Mailman">Next</a>
</div>
...
<li class="links"><a class="xref" href="dovecot-server.html.mk#dovecot-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.mk#dovecot-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.mk#dovecot-ssl" title="Dovecot SSL Configuration">Dovecot SSL Configuration</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.mk" title="Firewall Configuration for an Email Server">Firewall Configuration for an Email Server</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.mk#dovecot-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
                ...
                following lines if you want to set up a custom certificate (See <a class="xref" href="certificates-and-security.html.mk" title="Certificates">Certificates</a> for more details.):
        </p>
...
<p class="para">
      ...
      Please refer to <a class="xref" href="certificates-and-security.html.mk" title="Certificates">Certificates</a>
