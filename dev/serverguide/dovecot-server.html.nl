...
<a class="nextlinks-prev" href="exim4.html.nl" title="Exim4">Vorige</a><a class="nextlinks-next" href="mailman.html.nl" title="Mailman">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="dovecot-server.html.nl#dovecot-installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.nl#dovecot-configuration" title="Configuratie">Configuratie</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.nl#dovecot-ssl" title="Dovecot SSL Configuration">Dovecot SSL Configuration</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.nl" title="Firewall Configuration for an Email Server">Firewall Configuration for an Email Server</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.nl#dovecot-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
                ...
                following lines if you want to set up a custom certificate (See <a class="xref" href="certificates-and-security.html.nl" title="Certificates">Certificates</a> for more details.):
        </p>
...
<p class="para">
      ...
      Please refer to <a class="xref" href="certificates-and-security.html.nl" title="Certificates">Certificates</a>
