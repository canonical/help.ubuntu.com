...
<a class="nextlinks-prev" href="exim4.html.ru" title="Exim4">Назад</a><a class="nextlinks-next" href="mailman.html.ru" title="Mailman">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="dovecot-server.html.ru#dovecot-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.ru#dovecot-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.ru#dovecot-ssl" title="Dovecot: Настройка SSL">Dovecot: Настройка SSL</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.ru" title="Настройка брандмауэра для почтового сервера">Настройка брандмауэра для почтового сервера</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.ru#dovecot-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<p class="para">
                ...
                following lines if you want to set up a custom certificate (See <a class="xref" href="certificates-and-security.html.ru" title="Сертификаты">Сертификаты</a> for more details.):
        </p>
...
<p class="para">
      ...
      Please refer to <a class="xref" href="certificates-and-security.html.ru" title="Сертификаты">Сертификаты</a>
