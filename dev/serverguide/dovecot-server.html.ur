...
<a class="nextlinks-prev" href="exim4.html.ur" title="Exim4">Previous</a><a class="nextlinks-next" href="mailman.html.ur" title="Mailman">Next</a>
</div>
...
<li class="links"><a class="xref" href="dovecot-server.html.ur#dovecot-installation" title="Installation">Installation</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.ur#dovecot-configuration" title="Configuration">Configuration</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.ur#dovecot-ssl" title="Dovecot SSL Configuration">Dovecot SSL Configuration</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.ur" title="Firewall Configuration for an Email Server">Firewall Configuration for an Email Server</a></li>
<li class="links"><a class="xref" href="dovecot-server.html.ur#dovecot-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
                ...
                following lines if you want to set up a custom certificate (See <a class="xref" href="certificates-and-security.html.ur" title="Certificates">Certificates</a> for more details.):
        </p>
...
<p class="para">
      ...
      Please refer to <a class="xref" href="certificates-and-security.html.ur" title="Certificates">Certificates</a>
