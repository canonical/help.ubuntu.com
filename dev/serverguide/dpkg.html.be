...
<a class="nextlinks-prev" href="package-management-introduction.html.be" title="Уводзіны">Назад</a><a class="nextlinks-next" href="apt.html.be" title="Apt">Наперад</a>
</div>
...
<li class="list itemizedlist">
        ...
        <span class="app application">grep</span> to see if a specific package is installed:
        </p>
...
<div class="screen"><pre class="contents "><span class="cmd command">dpkg -l | grep apache2</span>
        ...
        <p class="para">
        Replace <span class="em emphasis">apache2</span> with any package name, part of a package name, or other regular expression.
        </p>
...
<li class="list itemizedlist">
        ...
        <p class="para">
        To list the files installed by a package, in this case the <span class="app application">ufw</span> package, enter:
        </p>
...
<li class="list itemizedlist">
        ...
        <p class="para">
        If you are not sure which package installed a file, <span class="app application">dpkg -S</span> may be able to tell you.
        For example:
        </p>
...
<span class="output computeroutput">base-files: /etc/host.conf</span>
        ...
        <p class="para">
        The output shows that the <span class="file filename">/etc/host.conf</span> belongs to the <span class="app application">base-files</span> package.
        </p>
...
<li class="list itemizedlist">
        ...
        <p class="para">
        You can install a local <span class="em emphasis">.deb</span> file by entering:
        </p>
...
<p class="para">
    For more <span class="app application">dpkg</span> options see the man page: <span class="cmd command">man dpkg</span>.
    </p>
</div></div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="package-management-introduction.html.be" title="Уводзіны">Назад</a><a class="nextlinks-next" href="apt.html.be" title="Apt">Наперад</a>
