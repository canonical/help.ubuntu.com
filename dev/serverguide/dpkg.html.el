...
<a class="nextlinks-prev" href="package-management-introduction.html.el" title="Εισαγωγή">Προηγούμενο</a><a class="nextlinks-next" href="apt.html.el" title="Apt">Επόμενο</a>
</div>
...
<li class="list itemizedlist">
        ...
        <p class="para">Ανάλογα με τον όγκο των πακέτων στο σύστημά σας, αυτό μπορεί να παράγει ένα μεγάλο όγκο εξόδου. Διοχετεύστε την έξοδο μέσω <span class="app application">grep</span> για να δείτε εάν ένα συγκεκριμένο πακέτο έχει εγκατασταθεί:</p>

<div class="screen"><pre class="contents "><span class="cmd command">dpkg -l | grep apache2</span>
</pre></div>

        <p class="para">Αντικαταστήστε το <span class="em emphasis">apache2</span> με οποιοδήποτε όνομα πακέτου, ή άλλες κανονικές επεκτάσεις.</p>

      </li>
<li class="list itemizedlist">

        <p class="para">Για να καταγράψετε τα αρχεία που έχουν εγκατασταθεί από ένα πακέτο, σε αυτή την περίπτωση το πακέτο <span class="app application">ufw</span>, πληκτρολογήστε:</p>
...
<li class="list itemizedlist">
        ...
        <p class="para">Εάν δεν είστε σίγουροι ποιο πακέτο εγκατέστησε ένα αρχείο, η <span class="app application">dpkg -S</span> μπορεί να είναι ικανό να σας πει. Για παράδειγμα:</p>
...
<span class="output computeroutput">base-files: /etc/host.conf</span>
        ...
        <p class="para">Η έξοδος δείχνει ότι το <span class="file filename">/etc/host.conf</span> ανήκει στο πακέτο <span class="app application">base-files</span>.</p>
...
<li class="list itemizedlist">
        ...
        <p class="para">Μπορείτε να εγκαταστήσετε ένα τοπικό αρχείο <span class="em emphasis">.deb</span> πληκτρολογώντας:</p>
...
<li class="list itemizedlist">
        ...
        <p class="para">Η απεγκατάσταση ενός πακέτου μπορεί να επιτευχθεί:</p>
...
<p class="para">Για περισσότερες επιλογές <span class="app application">dpkg</span> δείτε τη σελίδα: <span class="cmd command">man dpkg</span>.</p>
</div></div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="package-management-introduction.html.el" title="Εισαγωγή">Προηγούμενο</a><a class="nextlinks-next" href="apt.html.el" title="Apt">Επόμενο</a>
</div>
