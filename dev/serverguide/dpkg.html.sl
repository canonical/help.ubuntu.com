...
<a class="nextlinks-prev" href="package-management-introduction.html.sl" title="Uvod">Nazaj</a><a class="nextlinks-next" href="apt.html.sl" title="Apt">Naprej</a>
</div>
...
<span class="output computeroutput">base-files: /etc/host.conf</span>
        ...
        <p class="para">Izpis pokaže, da datoteka <span class="file filename">/etc/host.conf</span> pripada paketu <span class="app application">base-files</span>.</p>
...
<li class="list itemizedlist">
        ...
        <p class="para">Krajevno datoteko <span class="em emphasis">.deb</span> lahko namestite z ukazom:</p>
