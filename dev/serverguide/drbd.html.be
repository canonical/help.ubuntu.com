...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="clustering.html.be" title="Clustering">Clustering</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="clustering.html.be" title="Clustering">Назад</a><a class="nextlinks-next" href="vpn.html.be" title="VPN">Наперад</a>
</div>
...
<p class="para">Каб карыстацца <span class="app application">drbd</span>, спачатку ўстанавіце неабходныя пакеты. Увядзіце ў тэрмінале:</p>
...
<li class="links"><a class="xref" href="drbd.html.be#drbd-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="drbd.html.be#drbd-testing" title="Праверка">Праверка</a></li>
<li class="links"><a class="xref" href="drbd.html.be#drbd-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<p class="para">
      ...
      file.  See <a class="xref" href="dns.html.be" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for details.  
      </p>
...
<p class="para">Пасьля, размацуйце <span class="file filename">/srv</span>:</p>
