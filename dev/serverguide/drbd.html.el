...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.el" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="clustering.html.el" title="Συστοίχιση">Συστοίχιση</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="clustering.html.el" title="Συστοίχιση">Προηγούμενο</a><a class="nextlinks-next" href="vpn.html.el" title="VPN">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="drbd.html.el#drbd-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="drbd.html.el#drbd-testing" title="Δοκιμή">Δοκιμή</a></li>
<li class="links"><a class="xref" href="drbd.html.el#drbd-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
<div class="sect2 sect" id="drbd-configuration"><div class="inner">
<div class="hgroup"><h2 class="title">Ρυθμίσεις</h2></div>
<div class="region"><div class="contents">
<p class="para">Οι δύο υπολογιστές σε αυτό το παράδειγμα θα ονομαστούν <span class="em emphasis">drbd01</span> και <span class="em emphasis">drbd02</span>. Θα πρέπει να έχουν ρυθμισμένη επίλυση ονομάτων (name resolution) είτε μέσα από DNS ή με το αρχείο <span class="file filename">/etc/hosts</span>. Δείτε το <a class="xref" href="dns.html.el" title="Υπηρεσία ονομάτων τομέα (DNS)">Υπηρεσία ονομάτων τομέα (DNS)</a> για λεπτομέρειες.</p>
