...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="clustering.html.es" title="Clústers">Clústers</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="clustering.html.es" title="Clústers">Anterior</a><a class="nextlinks-next" href="vpn.html.es" title="VPN">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="drbd.html.es#drbd-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="drbd.html.es#drbd-testing" title="Comprobando">Comprobando</a></li>
<li class="links"><a class="xref" href="drbd.html.es#drbd-references" title="Referencias">Referencias</a></li>
</ul></div>
<div class="sect2 sect" id="drbd-configuration"><div class="inner">
<div class="hgroup"><h2 class="title">Configuración</h2></div>
<div class="region"><div class="contents">
<p class="para">Los dos equipos de este ejemplo se llaman <span class="em emphasis">drbd01</span> y <span class="em emphasis">drbd02</span>. Necesitan disponer de la misma resolución de nombre configurada, bien mediante DNS o bien mediante del archivo <span class="file filename">/etc/hosts</span>. Consulte <a class="xref" href="dns.html.es" title="Servicio de nombres de dominio (DNS)">Servicio de nombres de dominio (DNS)</a> para más información.</p>
