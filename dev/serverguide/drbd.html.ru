...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ru" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="clustering.html.ru" title="Кластеризация">Кластеризация</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="clustering.html.ru" title="Кластеризация">Назад</a><a class="nextlinks-next" href="vpn.html.ru" title="VPN">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="drbd.html.ru#drbd-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="drbd.html.ru#drbd-testing" title="Тестирование">Тестирование</a></li>
<li class="links"><a class="xref" href="drbd.html.ru#drbd-references" title="Ссылки">Ссылки</a></li>
</ul></div>
<div class="sect2 sect" id="drbd-configuration"><div class="inner">
<div class="hgroup"><h2 class="title">Конфигурация</h2></div>
<div class="region"><div class="contents">
<p class="para">Две системы в этом примере будут называться <span class="em emphasis">drbd01</span> и <span class="em emphasis">drbd02</span>. Им потребуется разрешение имён, настроенное через DNS или с помощью файла <span class="file filename">/etc/hosts</span>. Подробности смотрите в разделе <a class="xref" href="dns.html.ru" title="Служба доменных имён (DNS)">Служба доменных имён (DNS)</a>.</p>
