...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="clustering.html.sl" title="Clustering">Clustering</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="clustering.html.sl" title="Clustering">Nazaj</a><a class="nextlinks-next" href="vpn.html.sl" title="VPN">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="drbd.html.sl#drbd-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="drbd.html.sl#drbd-testing" title="Preizkušanje">Preizkušanje</a></li>
<li class="links"><a class="xref" href="drbd.html.sl#drbd-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<p class="para">
      ...
      file.  See <a class="xref" href="dns.html.sl" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for details.  
      </p>
...
<div class="screen"><pre class="contents "><span class="cmd command">watch -n1 cat /proc/drbd</span>
          ...
          <p class="para">Če želite nehati brati izpis, pritisnite <span class="em emphasis">Ctrl+c</span>.</p>
...
<p class="para">Nato odklopite <span class="file filename">/srv</span>:</p>
...
<p class="para">Na koncu priklopite razdelek:</p>
...
<li class="list itemizedlist">
          <p class="para">Stran <a href="https://help.ubuntu.com/community/DRBD" class="ulink" title="https://help.ubuntu.com/community/DRBD">DRBD na Ubuntu Wiki</a> vsebuje več podatkov.</p>
        </li>
</ul></div></div></div>
</div></div>
</div>
