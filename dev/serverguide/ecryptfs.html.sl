...
<a class="nextlinks-prev" href="certificates-and-security.html.sl" title="Potrdila">Nazaj</a><a class="nextlinks-next" href="monitoring.html.sl" title="Nadzorovanje">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="ecryptfs.html.sl#ecryptfs-usage" title="Uporaba eCryptfs">Uporaba eCryptfs</a></li>
<li class="links"><a class="xref" href="ecryptfs.html.sl#ecryptfs-automount" title="Samodejno priključevanje šifriranih razdelkov">Samodejno priključevanje šifriranih razdelkov</a></li>
<li class="links"><a class="xref" href="ecryptfs.html.sl#ecryptfs-other-utils" title="Druga orodja">Druga orodja</a></li>
<li class="links"><a class="xref" href="ecryptfs.html.sl#eCryptfs-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="ecryptfs-usage"><div class="inner">
<div class="hgroup"><h2 class="title">Uporaba eCryptfs</h2></div>
<div class="region"><div class="contents">
<p class="para">Najprej namestite potrebne pakete. V terminalu vnesite:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt install ecryptfs-utils</span>
</pre></div>
<p class="para">Priklopite razdelek, ki bo šifriran:</p>
...
<p class="para">Odklopite <span class="file filename">/srv</span> in si poskusite ogledati datoteko:</p>
...
<div class="hgroup"><h2 class="title">Samodejno priključevanje šifriranih razdelkov</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Najprej ustvarite datoteko <span class="file filename">/root/.ecryptfsrc</span>, ki vsebuje:</p>
...
<p class="para">V datoteko <span class="file filename">/etc/fstab</span> dodajte potrebne vrstice:</p>
<div class="code"><pre class="contents ">/dev/sdb1       /mnt/usb        ext3    ro      0 0
/srv /srv ecryptfs defaults 0 0
</pre></div>
<p class="para">Prepričajte se, da je pogon USB priključen pred šifriranim razdelkom.</p>
<p class="para">
...
<div class="hgroup"><h2 class="title">Druga orodja</h2></div>
<div class="region"><div class="contents">
<p class="para">Paket <span class="app application">ecryptfs-utils</span> vsebuje vrsto drugih uporabnih orodij:</p>
