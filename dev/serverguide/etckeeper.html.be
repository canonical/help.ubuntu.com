...
<a class="nextlinks-prev" href="pam_motd.html.be" title="pam_motd">Назад</a><a class="nextlinks-next" href="byobu.html.be" title="Byobu">Наперад</a>
</div>
...
<p class="para">Устанавіце <span class="app application">etckeeper</span>, для гэтага ўвядзіце ў тэрмінале наступнае:</p>
...
<p class="para">
    When the installation is finished, all the <span class="app application">postfix</span> configuration files should be committed to the
    repository:
    </p>
...
<p class="para">
    For an example of how <span class="app application">etckeeper</span> tracks manual changes, add new a host to <span class="file filename">/etc/hosts</span>.
    Using <span class="app application">bzr</span> you can see which files have been modified:
    </p>
...
<p class="para">
    For more information on <span class="app application">bzr</span> see <a class="xref" href="bazaar.html.be" title="Bazaar">Bazaar</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="etckeeper.html.be#etckeeper-resources" title="Рэсурсы">Рэсурсы</a></li></ul></div>
...
<li class="list itemizedlist">
        <p class="para">
        For the latest news and information about <span class="app application">bzr</span> see the <a href="http://bazaar-vcs.org/" class="ulink" title="http://bazaar-vcs.org/">bzr</a> web site.
        </p>
        </li>
</ul></div></div></div>
</div></div>
