...
<a class="nextlinks-prev" href="pam_motd.html.cs" title="pam_motd">Předchozí</a><a class="nextlinks-next" href="byobu.html.cs" title="Byobu">Následující</a>
</div>
...
<p class="para">
    For more information on <span class="app application">bzr</span> see <a class="xref" href="bazaar.html.cs" title="Bazaar">Bazaar</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="etckeeper.html.cs#etckeeper-resources" title="Zdroje">Zdroje</a></li></ul></div>
