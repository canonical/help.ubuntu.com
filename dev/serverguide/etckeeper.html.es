...
<a class="nextlinks-prev" href="pam_motd.html.es" title="pam_motd">Anterior</a><a class="nextlinks-next" href="byobu.html.es" title="Byobu">Siguiente</a>
</div>
...
<p class="para">Para más información sobre <span class="app application">bzr</span> vea <a class="xref" href="bazaar.html.es" title="Bazaar">Bazaar</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="etckeeper.html.es#etckeeper-resources" title="Recursos">Recursos</a></li></ul></div>
