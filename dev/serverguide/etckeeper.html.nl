...
<a class="nextlinks-prev" href="pam_motd.html.nl" title="pam_motd">Vorige</a><a class="nextlinks-next" href="byobu.html.nl" title="Byobu">Volgende</a>
</div>
...
<p class="para">
    For more information on <span class="app application">bzr</span> see <a class="xref" href="bazaar.html.nl" title="Bazaar">Bazaar</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="etckeeper.html.nl#etckeeper-resources" title="Resources">Resources</a></li></ul></div>
