...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ru" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="other-useful-applications.html.ru" title="Другие полезные приложения">Другие полезные приложения</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="pam_motd.html.ru" title="pam_motd">Назад</a><a class="nextlinks-next" href="byobu.html.ru" title="Byobu">Вперёд</a>
</div>
...
<p class="para">Установите <span class="app application">etckeeper</span>, введя следующую команду в терминале:</p>
...
<p class="para">После завершения установки, все <span class="app application">postfix</span> конфигурационные файлы должны быть записаны в репозиторий:</p>
...
<p class="para">В качестве примера, как <span class="app application">etckeeper</span> отслеживает изменения вручную, добавьте новую систему в <span class="file filename">/etc/hosts</span>. Используя <span class="file filename">/etc/hosts</span> вы сможете увидеть какие файлы были изменены:</p>
...
<p class="para">Теперь сохраните изменения:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo etckeeper commit "added new host"</span>
</pre></div>
<p class="para">Дополнительную информацию по <span class="app application">bzr</span> смотрите в разделе <a class="xref" href="bazaar.html.ru" title="Bazaar">Bazaar</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="etckeeper.html.ru#etckeeper-resources" title="Ресурсы">Ресурсы</a></li></ul></div>
...
<li class="list itemizedlist">
        <p class="para">Последние новости и информацию о <span class="app application">bzr</span> смотрите на <a href="http://bazaar-vcs.org/" class="ulink" title="http://bazaar-vcs.org/">сайте bzr</a></p>
        </li>
</ul></div></div></div>
</div></div>
</div>
