...
<a class="nextlinks-prev" href="pam_motd.html.sl" title="pam_motd">Nazaj</a><a class="nextlinks-next" href="byobu.html.sl" title="Byobu">Naprej</a>
</div>
...
<p class="para">
    Install <span class="app application">etckeeper</span> by entering the following in a terminal:
    </p>
...
<p class="para">Za več podatkov o <span class="app application">bzr</span> si oglejte <a class="xref" href="bazaar.html.sl" title="Bazaar">Bazaar</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="etckeeper.html.sl#etckeeper-resources" title="Viri">Viri</a></li></ul></div>
