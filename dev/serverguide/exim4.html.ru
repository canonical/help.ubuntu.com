...
<a class="nextlinks-prev" href="postfix.html.ru" title="Postfix">Назад</a><a class="nextlinks-next" href="dovecot-server.html.ru" title="Dovecot Server">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="exim4.html.ru#exim4-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="exim4.html.ru#exim4-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="exim4.html.ru#exim4-smtp-auth" title="Аутентификация SMTP">Аутентификация SMTP</a></li>
<li class="links"><a class="xref" href="exim4.html.ru#exim4-sasl" title="Настройка SASL">Настройка SASL</a></li>
<li class="links"><a class="xref" href="exim4.html.ru#exim4-references" title="Ссылки">Ссылки</a></li>
</ul></div>
<div class="sect2 sect" id="exim4-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Установка</h2></div>
<div class="region"><div class="contents"><p class="para">Для установки <span class="app application">exim4</span> выполните следующую команду: <div class="screen"><pre class="contents "><span class="cmd command">sudo apt install exim4</span>
</pre></div></p></div></div>
</div></div>
