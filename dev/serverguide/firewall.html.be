...
<a class="nextlinks-prev" href="console-security.html.be" title="Console Security">Назад</a><a class="nextlinks-next" href="apparmor.html.be" title="AppArmor">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Брандмаўэр</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="firewall.html.be#firewall-introduction" title="Уводзіны">Уводзіны</a></li>
<li class="links"><a class="xref" href="firewall.html.be#firewall-ufw" title="ufw - Uncomplicated Firewall">ufw - Uncomplicated Firewall</a></li>
<li class="links"><a class="xref" href="firewall.html.be#ip-masquerading" title="IP Masquerading">IP Masquerading</a></li>
<li class="links"><a class="xref" href="firewall.html.be#firewall-logs" title="Logs">Logs</a></li>
<li class="links"><a class="xref" href="firewall.html.be#other-firewall-tools" title="Іншыя прылады">Іншыя прылады</a></li>
<li class="links"><a class="xref" href="firewall.html.be#firewall-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<li class="list itemizedlist">
                <p class="para"><span class="app application">ufw</span> можа быць выключана з дапамогай:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo ufw disable</span>
</pre></div>
	      </li>
<li class="list itemizedlist">
                <p class="para">Каб паглядзець стан брандмаўэра, увядзіце:</p>
...
<div class="hgroup"><h2 class="title">Іншыя прылады</h2></div>
<div class="region"><div class="contents">
<p class="para">
