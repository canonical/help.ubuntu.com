...
<a class="nextlinks-prev" href="console-security.html.cs" title="Console Security">Předchozí</a><a class="nextlinks-next" href="apparmor.html.cs" title="AppArmor">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Firewall</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="firewall.html.cs#firewall-introduction" title="Úvod">Úvod</a></li>
<li class="links"><a class="xref" href="firewall.html.cs#firewall-ufw" title="ufw - Uncomplicated Firewall">ufw - Uncomplicated Firewall</a></li>
<li class="links"><a class="xref" href="firewall.html.cs#ip-masquerading" title="IP Masquerading">IP Masquerading</a></li>
<li class="links"><a class="xref" href="firewall.html.cs#firewall-logs" title="Logs">Logs</a></li>
<li class="links"><a class="xref" href="firewall.html.cs#other-firewall-tools" title="Other Tools">Other Tools</a></li>
<li class="links"><a class="xref" href="firewall.html.cs#firewall-references" title="References">References</a></li>
</ul></div>
