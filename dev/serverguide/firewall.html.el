...
<a class="nextlinks-prev" href="console-security.html.el" title="Ασφάλεια Κονσόλας">Προηγούμενο</a><a class="nextlinks-next" href="apparmor.html.el" title="AppArmor">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Τείχος Προστασίας</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="firewall.html.el#firewall-introduction" title="Εισαγωγή">Εισαγωγή</a></li>
<li class="links"><a class="xref" href="firewall.html.el#firewall-ufw" title="ufw - Απλό Τείχος Προστασίας">ufw - Απλό Τείχος Προστασίας</a></li>
<li class="links"><a class="xref" href="firewall.html.el#ip-masquerading" title="Μεταμφίεση IP">Μεταμφίεση IP</a></li>
<li class="links"><a class="xref" href="firewall.html.el#firewall-logs" title="Ιστορικά">Ιστορικά</a></li>
<li class="links"><a class="xref" href="firewall.html.el#other-firewall-tools" title="Άλλα Εργαλεία">Άλλα Εργαλεία</a></li>
<li class="links"><a class="xref" href="firewall.html.el#firewall-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
