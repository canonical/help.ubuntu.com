...
<a class="nextlinks-prev" href="console-security.html.mk" title="Console Security">Previous</a><a class="nextlinks-next" href="apparmor.html.mk" title="AppArmor">Next</a>
</div>
<div class="hgroup"><h1 class="title">Firewall</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="firewall.html.mk#firewall-introduction" title="Вовед">Вовед</a></li>
<li class="links"><a class="xref" href="firewall.html.mk#firewall-ufw" title="ufw - Uncomplicated Firewall">ufw - Uncomplicated Firewall</a></li>
<li class="links"><a class="xref" href="firewall.html.mk#ip-masquerading" title="IP Masquerading">IP Masquerading</a></li>
<li class="links"><a class="xref" href="firewall.html.mk#firewall-logs" title="Logs">Logs</a></li>
<li class="links"><a class="xref" href="firewall.html.mk#other-firewall-tools" title="Other Tools">Other Tools</a></li>
<li class="links"><a class="xref" href="firewall.html.mk#firewall-references" title="References">References</a></li>
</ul></div>
