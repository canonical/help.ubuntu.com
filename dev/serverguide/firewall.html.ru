...
<a class="nextlinks-prev" href="console-security.html.ru" title="Безопасность консоли">Назад</a><a class="nextlinks-next" href="apparmor.html.ru" title="AppArmor">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Брандмауэр</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="firewall.html.ru#firewall-introduction" title="Введение">Введение</a></li>
<li class="links"><a class="xref" href="firewall.html.ru#firewall-ufw" title="ufw — Uncomplicated Firewall">ufw — Uncomplicated Firewall</a></li>
<li class="links"><a class="xref" href="firewall.html.ru#ip-masquerading" title="Маскарадинг IP">Маскарадинг IP</a></li>
<li class="links"><a class="xref" href="firewall.html.ru#firewall-logs" title="Журналирование">Журналирование</a></li>
<li class="links"><a class="xref" href="firewall.html.ru#other-firewall-tools" title="Другие инструменты">Другие инструменты</a></li>
<li class="links"><a class="xref" href="firewall.html.ru#firewall-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<li class="list itemizedlist">
                <p class="para">Для открытия порта (SSH в данном примере):</p>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo ufw allow proto tcp from 192.168.0.2 to any port 22</span>
	        ...
	        <p class="para">Замените 192.168.0.2 на 192.168.0.0/24, чтобы разрешить доступ по SSH из всей подсети.</p>
	      </li>
<li class="list itemizedlist">
