...
<a class="nextlinks-prev" href="console-security.html.sl" title="Console Security">Nazaj</a><a class="nextlinks-next" href="apparmor.html.sl" title="AppArmor">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Požarni zid</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="firewall.html.sl#firewall-introduction" title="Uvod">Uvod</a></li>
<li class="links"><a class="xref" href="firewall.html.sl#firewall-ufw" title="ufw - Uncomplicated Firewall">ufw - Uncomplicated Firewall</a></li>
<li class="links"><a class="xref" href="firewall.html.sl#ip-masquerading" title="IP Masquerading">IP Masquerading</a></li>
<li class="links"><a class="xref" href="firewall.html.sl#firewall-logs" title="Dnevniki">Dnevniki</a></li>
<li class="links"><a class="xref" href="firewall.html.sl#other-firewall-tools" title="Druga orodja">Druga orodja</a></li>
<li class="links"><a class="xref" href="firewall.html.sl#firewall-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<li class="list itemizedlist">
                <p class="para">Za pregled stanja požarnega zidu vnesite:</p>
...
<div class="hgroup"><h2 class="title">Dnevniki</h2></div>
<div class="region"><div class="contents">
<p class="para">
