...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="file-servers.html.be" title="Файлавыя сэрверы">Файлавыя сэрверы</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="file-servers.html.be" title="Файлавыя сэрверы">Назад</a><a class="nextlinks-next" href="network-file-system.html.be" title="Network File System (NFS)">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Сэрвер FTP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
          ...
          the section on <span class="app application">OpenSSH</span> in <a class="xref" href="remote-administration.html.be" title="Remote Administration">Remote Administration</a> instead.
          </p>
<p class="para">
...
<p class="para">Access to an FTP server can be managed in two ways:</p>
<div class="list itemizedlist"><ul class="list itemizedlist compact">
<li class="list itemizedlist">
              <p class="para">Anonymous</p>
            </li>
<li class="list itemizedlist">
              <p class="para">Authenticated</p>
            </li>
</ul></div>
<p class="para">
...
<li class="links"><a class="xref" href="ftp-server.html.be#vsftpd-ftp-server-installation" title="vsftpd - Устаноўка сэрвера FTP">vsftpd - Устаноўка сэрвера FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.be#vsftpd-anonymous-configuration" title="Anonymous FTP Configuration">Anonymous FTP Configuration</a></li>
<li class="links"><a class="xref" href="ftp-server.html.be#vsftpd-userauth-configuration" title="User Authenticated FTP Configuration">User Authenticated FTP Configuration</a></li>
<li class="links"><a class="xref" href="ftp-server.html.be#vsftpd-security" title="Securing FTP">Securing FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.be#vsftpd-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
<div class="sect2 sect" id="vsftpd-ftp-server-installation"><div class="inner">
<div class="hgroup"><h2 class="title">vsftpd - Устаноўка сэрвера FTP</h2></div>
...
<div class="hgroup"><h2 class="title">Anonymous FTP Configuration</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
                After making the change restart <span class="app application">vsftpd</span>:
                </p>
...
<div class="hgroup"><h2 class="title">User Authenticated FTP Configuration</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Цяпер перазапусьціце  <span class="app application">vsftpd</span>:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart vsftpd.service</span>
</pre></div>
<p class="para">
                Now when system users login to FTP they will start in their 
                <span class="em emphasis">home</span> directories where they can download,
...
<div class="note note-warning" title="Перасцярога"><div class="inner"><div class="region"><div class="contents">
                  <p class="para">
...
<p class="para">
                ...
                page, <span class="cmd command">man 5 vsftpd.conf</span> for
                details of each parameter. 
                </p>
</div></div>
</div></div>
<div class="sect2 sect" id="vsftpd-security"><div class="inner">
<div class="hgroup"><h2 class="title">Securing FTP</h2></div>
<div class="region"><div class="contents">
<p class="para"> 
                  There are options in <span class="file filename">/etc/vsftpd.conf</span> to
                  help make <span class="app application">vsftpd</span> more secure.  For
...
<p class="para">
                  After uncommenting the above options, create a <span class="file filename">/etc/vsftpd.chroot_list</span>
                  containing a list of users one per line.  Then restart <span class="app application">vsftpd</span>:
                  </p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart vsftpd.service</span>
</pre></div>
<p class="para">
                  Also, the <span class="file filename">/etc/ftpusers</span> file is a list of users that
                  are <span class="em emphasis">disallowed</span> FTP access.  The default list 
...
<p class="para">
                  To configure <span class="em emphasis">FTPS</span>, edit <span class="file filename">/etc/vsftpd.conf</span> and at the bottom add:
                  </p>
...
<p class="para">
                  ...
                  host.  For more information on certificates see <a class="xref" href="certificates-and-security.html.be" title="Certificates">Certificates</a>.
                  </p>
<p class="para">
                  Now restart <span class="app application">vsftpd</span>, and non-anonymous users will be forced to use 
                  <span class="em emphasis">FTPS</span>:
                  </p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart vsftpd.service</span>
</pre></div>
<p class="para">
...
<p class="para">
                  This is necessary because, by default <span class="app application">vsftpd</span> uses PAM for authentication, and the 
                  <span class="file filename">/etc/pam.d/vsftpd</span> configuration file contains:
                  </p>
<div class="code"><pre class="contents ">auth    required        pam_shells.so
</pre></div>
<p class="para">
                  The <span class="em emphasis">shells</span> PAM module restricts access to shells listed in the <span class="file filename">/etc/shells</span>
                  file.
                  </p>
<p class="para">
...
<li class="list itemizedlist">
                      <p class="para">
                      See the <a href="http://vsftpd.beasts.org/vsftpd_conf.html" class="ulink" title="http://vsftpd.beasts.org/vsftpd_conf.html">vsftpd website</a> for more information.
                      </p>
                    </li>
<li class="list itemizedlist">
                      <p class="para">
