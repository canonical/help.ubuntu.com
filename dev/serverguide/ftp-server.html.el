...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.el" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="file-servers.html.el" title="Εξυπηρετητές αρχείων">Εξυπηρετητές αρχείων</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="file-servers.html.el" title="Εξυπηρετητές αρχείων">Προηγούμενο</a><a class="nextlinks-next" href="network-file-system.html.el" title="Σύστημα Αρχείων Δικτύου (NFS)">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Εξυπηρετητής FTP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
          ...
          the section on <span class="app application">OpenSSH</span> in <a class="xref" href="remote-administration.html.el" title="Απομακρυσμένη Διαχείριση">Απομακρυσμένη Διαχείριση</a> instead.
          </p>
<p class="para">
...
<p class="para">Η πρόσβαση σε έναν εξυπηρετητή FTP μπορεί να επιτευχθεί με δύο τρόπους:</p>
<div class="list itemizedlist"><ul class="list itemizedlist compact">
<li class="list itemizedlist">
              <p class="para">Ανώνυμη</p>
            </li>
<li class="list itemizedlist">
              <p class="para">Πιστοποιημένη</p>
            </li>
</ul></div>
<p class="para">
...
<li class="links"><a class="xref" href="ftp-server.html.el#vsftpd-ftp-server-installation" title="vsftpd - Εγκατάσταση εξυπηρετητή FTP">vsftpd - Εγκατάσταση εξυπηρετητή FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.el#vsftpd-anonymous-configuration" title="Ρύθμιση ανώνυμου FTP">Ρύθμιση ανώνυμου FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.el#vsftpd-userauth-configuration" title="Ρύθμιση FTP με πιστοποίηση χρηστών">Ρύθμιση FTP με πιστοποίηση χρηστών</a></li>
<li class="links"><a class="xref" href="ftp-server.html.el#vsftpd-security" title="Ασφάλιση του FTP">Ασφάλιση του FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.el#vsftpd-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
<div class="sect2 sect" id="vsftpd-ftp-server-installation"><div class="inner">
<div class="hgroup"><h2 class="title">vsftpd - Εγκατάσταση εξυπηρετητή FTP</h2></div>
...
<div class="hgroup"><h2 class="title">Ρύθμιση ανώνυμου FTP</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Αφού κάνετε την αλλαγή, επανεκκινήστε το <span class="app application">vsftpd</span>:</p>
...
<div class="hgroup"><h2 class="title">Ρύθμιση FTP με πιστοποίηση χρηστών</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Τώρα επανεκκινήστε το <span class="app application">vsftpd</span>:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart vsftpd.service</span>
</pre></div>
<p class="para">Τώρα, όταν οι χρήστες του συστήματος συνδέονται στο FTP, θα ξεκινούν στους <span class="em emphasis">αρχικούς καταλόγους</span> τους, όπου μπορούν να κάνουν λήψη, αποστολή, δημιουργία καταλόγων, κτλ.</p>
<p class="para">
...
<div class="note note-warning" title="Προειδοποίηση"><div class="inner"><div class="region"><div class="contents">
                  <p class="para">Η ενεργοποίηση της ανώνυμης αποστολής FTP μπορεί να είναι ακραίος κίνδυνος ασφαλείας. Είναι καλύτερα να μην ενεργοποιήσετε την ανώνυμη αποστολή σε εξυπηρετητές στους οποίους είναι δυνατή η πρόσβαση απευθείας από το διαδίκτυο.</p>
                </div></div></div></div>
<p class="para">Το αρχείο ρυθμίσεων αποτελείται από πολλές παραμέτρους ρύθμισης. Οι πληροφορίες για κάθε παράμετρο είναι διαθέσιμες στο αρχείο ρυθμίσεων. Εναλλακτικά, μπορείτε να αναφερθείτε στη σελίδα man - <span class="cmd command">man 5 vsftpd.conf</span> - για λεπτομέρειες για κάθε παράμετρο.</p>
</div></div>
</div></div>
<div class="sect2 sect" id="vsftpd-security"><div class="inner">
<div class="hgroup"><h2 class="title">Ασφάλιση του FTP</h2></div>
<div class="region"><div class="contents">
<p class="para">Υπάρχουν επιλογές στο <span class="file filename">/etc/vsftpd.conf</span> που βοηθάνε στο να κάνετε το <span class="app application">vsftpd</span> πιο ασφαλές. Για παράδειγμα οι χρήστες μπορούν να περιοριστούν στους αρχικούς τους καταλόγους αν αποσχολιάσετε το:</p>
<div class="code"><pre class="contents ">chroot_local_user=YES
</pre></div>
<p class="para">Μπορείτε επίσης να περιορίσετε μόνο μια συγκεκριμένη λίστα χρηστών στους αρχικούς τους καταλόγους:</p>
<div class="code"><pre class="contents ">chroot_list_enable=YES
chroot_list_file=/etc/vsftpd.chroot_list
</pre></div>
<p class="para">Αφού αποσχολιάσετε τις παραπάνω επιλογές, δημιουργήστε ένα αρχείο <span class="file filename">/etc/vsftpd.chroot_list</span> που περιέχει μια λίστα χρηστών - έναν σε κάθε γραμμή. Μετά επανεκκινήστε το <span class="app application">vsftpd</span>:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart vsftpd.service</span>
</pre></div>
<p class="para">Επίσης το αρχείο <span class="file filename">/etc/ftpusers</span> είναι μια λίστα χρηστών στους οποίους <span class="em emphasis">δεν επιτρέπεται</span> η πρόσβαση FTP. Η προεπιλεγμένη λίστα περιέχει τους χρήστες root, daemon, nobody, κτλ. Για να απενεργοποιήσετε την πρόσβαση FTP σε επιπλέον χρήστες, απλά προσθέστε τους στη λίστα.</p>
<p class="para">
...
<p class="para">Για να ρυθμίσετε το <span class="em emphasis">FTPS</span>, επεξεργαστείτε το αρχείο <span class="file filename">/etc/vsftpd.conf</span> και στο τέλος του προσθέστε:</p>
<div class="code"><pre class="contents ">ssl_enable=Yes
</pre></div>
<p class="para">Επίσης, παρατηρήστε τις επιλογές σχετικά με το πιστοποιητικό και το κλειδί:</p>
...
<p class="para">
                  ...
                  host.  For more information on certificates see <a class="xref" href="certificates-and-security.html.el" title="Πιστοποιητικά">Πιστοποιητικά</a>.
                  </p>
<p class="para">Τώρα επανεκκινήστε το <span class="app application">vsftpd</span>, και οι μη-ανώνυμοι χρήστες θα είναι αναγκασμένοι να χρησιμοποιούν το <span class="em emphasis">FTPS</span>:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart vsftpd.service</span>
</pre></div>
<p class="para">
                  To allow users with a shell of <span class="file filename">/usr/sbin/nologin</span> access to FTP, but have no shell access, 
                  edit <span class="file filename">/etc/shells</span> adding the <span class="em emphasis">nologin</span> shell:
                  </p>
<div class="code"><pre class="contents "># /etc/shells: έγκυρα κελύφη εισόδου
/bin/csh
/bin/sh
/usr/bin/es
/usr/bin/ksh
...
<p class="para">Αυτό είναι απαραίτητο επειδή, από προεπιλογή το <span class="app application">vsftpd</span> χρησιμοποιεί το PAM για πιστοποίηση και το αρχείο ρυθμίσεων <span class="file filename">/etc/pam.d/vsftpd</span> περιέχει το παρακάτω:</p>
<div class="code"><pre class="contents ">auth    required        pam_shells.so
</pre></div>
<p class="para">Το άρθρωμα PAM <span class="em emphasis">shells</span> περιορίζει την πρόσβαση στα κελύφη που υπάρχουν στο αρχείο <span class="file filename">/etc/shells</span>.</p>
<p class="para">
...
<li class="list itemizedlist">
                      <p class="para">Δείτε τον <a href="http://vsftpd.beasts.org/vsftpd_conf.html" class="ulink" title="http://vsftpd.beasts.org/vsftpd_conf.html">ιστότοπο του vsftpd</a> για περισσότερες πληροφορίες.</p>
                    </li>
<li class="list itemizedlist">
                      <p class="para">
