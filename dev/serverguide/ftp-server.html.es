...
<a class="nextlinks-prev" href="file-servers.html.es" title="Servidores de archivos">Anterior</a><a class="nextlinks-next" href="network-file-system.html.es" title="Network File System (NFS)">Siguiente</a>
</div>
...
<p class="para">
          ...
          the section on <span class="app application">OpenSSH</span> in <a class="xref" href="remote-administration.html.es" title="Administración Remota">Administración Remota</a> instead.
          </p>
<p class="para">
...
<li class="links"><a class="xref" href="ftp-server.html.es#vsftpd-ftp-server-installation" title="vsftpd - Instalación del Servidor FTP">vsftpd - Instalación del Servidor FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.es#vsftpd-anonymous-configuration" title="Configuración de FTP anónimo">Configuración de FTP anónimo</a></li>
<li class="links"><a class="xref" href="ftp-server.html.es#vsftpd-userauth-configuration" title="Configuración de FTP con usuario autenticado">Configuración de FTP con usuario autenticado</a></li>
<li class="links"><a class="xref" href="ftp-server.html.es#vsftpd-security" title="Asegurando el FTP">Asegurando el FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.es#vsftpd-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<p class="para">
                  ...
                  host.  For more information on certificates see <a class="xref" href="certificates-and-security.html.es" title="Certificados">Certificados</a>.
                  </p>
