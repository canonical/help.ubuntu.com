...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.mk" title="Водич за Ubuntu Server">Водич за Ubuntu Server</a> » <a class="trail" href="file-servers.html.mk" title="File Servers">File Servers</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="file-servers.html.mk" title="File Servers">Previous</a><a class="nextlinks-next" href="network-file-system.html.mk" title="Network File System (NFS)">Next</a>
</div>
...
<p class="para">
          ...
          the section on <span class="app application">OpenSSH</span> in <a class="xref" href="remote-administration.html.mk" title="Remote Administration">Remote Administration</a> instead.
          </p>
<p class="para">
...
<li class="links"><a class="xref" href="ftp-server.html.mk#vsftpd-ftp-server-installation" title="vsftpd - FTP Server Installation">vsftpd - FTP Server Installation</a></li>
<li class="links"><a class="xref" href="ftp-server.html.mk#vsftpd-anonymous-configuration" title="Anonymous FTP Configuration">Anonymous FTP Configuration</a></li>
<li class="links"><a class="xref" href="ftp-server.html.mk#vsftpd-userauth-configuration" title="User Authenticated FTP Configuration">User Authenticated FTP Configuration</a></li>
<li class="links"><a class="xref" href="ftp-server.html.mk#vsftpd-security" title="Securing FTP">Securing FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.mk#vsftpd-references" title="References">References</a></li>
</ul></div>
<div class="sect2 sect" id="vsftpd-ftp-server-installation"><div class="inner">
<div class="hgroup"><h2 class="title">vsftpd - FTP Server Installation</h2></div>
...
<p class="para">
                Now restart <span class="app application">vsftpd</span>:
                </p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart vsftpd.service</span>
</pre></div>
<p class="para">
...
<div class="note note-warning" title="Предупредување"><div class="inner"><div class="region"><div class="contents">
                  <p class="para">
...
<p class="para">
                  ...
                  host.  For more information on certificates see <a class="xref" href="certificates-and-security.html.mk" title="Certificates">Certificates</a>.
                  </p>
<p class="para">
