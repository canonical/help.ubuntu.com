...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.nl" title="Handleiding Ubuntu-server">Handleiding Ubuntu-server</a> » <a class="trail" href="file-servers.html.nl" title="File Servers">File Servers</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="file-servers.html.nl" title="File Servers">Vorige</a><a class="nextlinks-next" href="network-file-system.html.nl" title="Network File System (NFS)">Volgende</a>
</div>
...
<p class="para">
          ...
          the section on <span class="app application">OpenSSH</span> in <a class="xref" href="remote-administration.html.nl" title="Remote Administration">Remote Administration</a> instead.
          </p>
<p class="para">
...
<li class="links"><a class="xref" href="ftp-server.html.nl#vsftpd-ftp-server-installation" title="vsftpd - FTP Server Installation">vsftpd - FTP Server Installation</a></li>
<li class="links"><a class="xref" href="ftp-server.html.nl#vsftpd-anonymous-configuration" title="Anonymous FTP Configuration">Anonymous FTP Configuration</a></li>
<li class="links"><a class="xref" href="ftp-server.html.nl#vsftpd-userauth-configuration" title="User Authenticated FTP Configuration">User Authenticated FTP Configuration</a></li>
<li class="links"><a class="xref" href="ftp-server.html.nl#vsftpd-security" title="Securing FTP">Securing FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.nl#vsftpd-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
                  ...
                  host.  For more information on certificates see <a class="xref" href="certificates-and-security.html.nl" title="Certificates">Certificates</a>.
                  </p>
<p class="para">
