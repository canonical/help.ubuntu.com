...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="file-servers.html.sl" title="Podatkovni strežniki">Podatkovni strežniki</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="file-servers.html.sl" title="Podatkovni strežniki">Nazaj</a><a class="nextlinks-next" href="network-file-system.html.sl" title="Network File System (NFS)">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Strežnik FTP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
          ...
          the section on <span class="app application">OpenSSH</span> in <a class="xref" href="remote-administration.html.sl" title="Oddaljeno skrbništvo">Oddaljeno skrbništvo</a> instead.
          </p>
<p class="para">
...
<li class="links"><a class="xref" href="ftp-server.html.sl#vsftpd-ftp-server-installation" title="vsftpd - Namestitev FTP strežnika">vsftpd - Namestitev FTP strežnika</a></li>
<li class="links"><a class="xref" href="ftp-server.html.sl#vsftpd-anonymous-configuration" title="Anonymous FTP Configuration">Anonymous FTP Configuration</a></li>
<li class="links"><a class="xref" href="ftp-server.html.sl#vsftpd-userauth-configuration" title="User Authenticated FTP Configuration">User Authenticated FTP Configuration</a></li>
<li class="links"><a class="xref" href="ftp-server.html.sl#vsftpd-security" title="Securing FTP">Securing FTP</a></li>
<li class="links"><a class="xref" href="ftp-server.html.sl#vsftpd-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="vsftpd-ftp-server-installation"><div class="inner">
<div class="hgroup"><h2 class="title">vsftpd - Namestitev FTP strežnika</h2></div>
...
<p class="para">Znova zaženite <span class="app application">vsftpd</span>:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart vsftpd.service</span>
</pre></div>
<p class="para">
...
<p class="para">
                  ...
                  host.  For more information on certificates see <a class="xref" href="certificates-and-security.html.sl" title="Potrdila">Potrdila</a>.
                  </p>
<p class="para">
