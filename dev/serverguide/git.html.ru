...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ru" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="version-control-system.html.ru" title="Система контроля версий">Система контроля версий</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="bazaar.html.ru" title="Bazaar">Назад</a><a class="nextlinks-next" href="subversion.html.ru" title="Subversion">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="git.html.ru#git-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="git.html.ru#git-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="git.html.ru#git-usage" title="Основы использования">Основы использования</a></li>
<li class="links"><a class="xref" href="git.html.ru#git-installing-gitolite" title="Установка сервера gitolite">Установка сервера gitolite</a></li>
<li class="links"><a class="xref" href="git.html.ru#git-configuring-gitolite" title="Конфигурация Gitolite">Конфигурация Gitolite</a></li>
<li class="links"><a class="xref" href="git.html.ru#git-gitolite-management" title="Управление пользователями gitolite и репозиториями">Управление пользователями gitolite и репозиториями</a></li>
<li class="links"><a class="xref" href="git.html.ru#git-gitolite-usage" title="Использование вашего сервера">Использование вашего сервера</a></li>
</ul></div>
...
<p class="para">
        ...
        If you have not yet configured an SSH key, refer to <a class="xref" href="openssh-server.html.ru#openssh-keys" title="Ключи SSH">Ключи SSH</a>
        </p>
