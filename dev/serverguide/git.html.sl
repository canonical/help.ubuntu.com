...
<a class="nextlinks-prev" href="bazaar.html.sl" title="Bazaar">Nazaj</a><a class="nextlinks-next" href="subversion.html.sl" title="Subversion">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="git.html.sl#git-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="git.html.sl#git-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="git.html.sl#git-usage" title="Basic usage">Basic usage</a></li>
<li class="links"><a class="xref" href="git.html.sl#git-installing-gitolite" title="Installing a gitolite server">Installing a gitolite server</a></li>
<li class="links"><a class="xref" href="git.html.sl#git-configuring-gitolite" title="Gitolite configuration">Gitolite configuration</a></li>
<li class="links"><a class="xref" href="git.html.sl#git-gitolite-management" title="Managing gitolite users and repositories">Managing gitolite users and repositories</a></li>
<li class="links"><a class="xref" href="git.html.sl#git-gitolite-usage" title="Using your server">Using your server</a></li>
</ul></div>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="para">This creates a bare repository, that cannot be used to edit files directly. If you would rather have a working copy of the contents of the repository on the server, ommit the <span class="em emphasis">--bare</span> option.</p></div></div></div></div>
<p class="para">
...
<p class="para">
        ...
        If you have not yet configured an SSH key, refer to <a class="xref" href="openssh-server.html.sl#openssh-keys" title="Ključi SSH">Ključi SSH</a>
        </p>
