...
<a class="nextlinks-prev" href="bazaar.html.ur" title="Bazaar">Previous</a><a class="nextlinks-next" href="subversion.html.ur" title="Subversion">Next</a>
</div>
...
<li class="links"><a class="xref" href="git.html.ur#git-installation" title="Installation">Installation</a></li>
<li class="links"><a class="xref" href="git.html.ur#git-configuration" title="Configuration">Configuration</a></li>
<li class="links"><a class="xref" href="git.html.ur#git-usage" title="Basic usage">Basic usage</a></li>
<li class="links"><a class="xref" href="git.html.ur#git-installing-gitolite" title="Installing a gitolite server">Installing a gitolite server</a></li>
<li class="links"><a class="xref" href="git.html.ur#git-configuring-gitolite" title="Gitolite configuration">Gitolite configuration</a></li>
<li class="links"><a class="xref" href="git.html.ur#git-gitolite-management" title="Managing gitolite users and repositories">Managing gitolite users and repositories</a></li>
<li class="links"><a class="xref" href="git.html.ur#git-gitolite-usage" title="Using your server">Using your server</a></li>
</ul></div>
...
<p class="para">
        ...
        If you have not yet configured an SSH key, refer to <a class="xref" href="openssh-server.html.ur#openssh-keys" title="SSH Keys">SSH Keys</a>
        </p>
