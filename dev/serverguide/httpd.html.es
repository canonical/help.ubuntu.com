...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="web-servers.html.es" title="Servidores web">Servidores web</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="web-servers.html.es" title="Servidores web">Anterior</a><a class="nextlinks-next" href="php.html.es" title="PHP - Scripting Language">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">HTTPD - Servidor web Apache2</h1></div>
<div class="region">
<div class="contents">
<p class="para">Apache es el servidor web utilizado con más frecuencia en los sistemas Linux. Los servidores web se emplean para entregar las páginas que los equipos cliente solicitan. Los clientes normalmente solicitan y visualizan las páginas web mediante aplicaciones de navegación como <span class="app application">Firefox</span>, <span class="app application">Opera</span>, <span class="app application">Chromium</span> e <span class="app application">Internet Explorer</span>.</p>
...
<li class="links"><a class="xref" href="httpd.html.es#http-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="httpd.html.es#http-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="httpd.html.es#https-configuration" title="Configuración HTTPS">Configuración HTTPS</a></li>
<li class="links"><a class="xref" href="httpd.html.es#http-directory-permissions" title="Compartir permisos de escritura">Compartir permisos de escritura</a></li>
<li class="links"><a class="xref" href="httpd.html.es#http-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<p class="para">Puede instalar más módulos de Apache2 y utilizarlos en su servidor web. Por ejemplo, ejecute la orden siguiente en una consola para instalar el módulo <span class="em emphasis">MySQL Authentication</span>:</p>
...
<p class="para">El módulo <span class="app application">mod_ssl</span> está disponible en el paquete <span class="app application">apache2-common</span>. Ejecute la orden siguiente en una consola para activar el módulo <span class="app application">mod_ssl</span>:</p>
...
<p class="para">
          ...
          <a class="xref" href="certificates-and-security.html.es" title="Certificados">Certificados</a>
          </p>
