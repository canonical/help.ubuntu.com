...
<a class="nextlinks-prev" href="web-servers.html.ru" title="Веб-серверы">Назад</a><a class="nextlinks-next" href="php.html.ru" title="PHP — язык сценариев">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="httpd.html.ru#http-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="httpd.html.ru#http-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="httpd.html.ru#https-configuration" title="Настройка HTTPS">Настройка HTTPS</a></li>
<li class="links"><a class="xref" href="httpd.html.ru#http-directory-permissions" title="Права разделения записи">Права разделения записи</a></li>
<li class="links"><a class="xref" href="httpd.html.ru#http-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<p class="para">
          ...
          <a class="xref" href="certificates-and-security.html.ru" title="Сертификаты">Сертификаты</a>
          </p>
