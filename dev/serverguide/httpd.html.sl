...
<title>HTTPD - spletni strežnik Apache2</title>
...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="web-servers.html.sl" title="Spletni strežniki">Spletni strežniki</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="web-servers.html.sl" title="Spletni strežniki">Nazaj</a><a class="nextlinks-next" href="php.html.sl" title="PHP - Scripting Language">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">HTTPD - spletni strežnik Apache2</h1></div>
<div class="region">
<div class="contents">
...
<li class="links"><a class="xref" href="httpd.html.sl#http-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="httpd.html.sl#http-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="httpd.html.sl#https-configuration" title="Nastavljanje HTTPS">Nastavljanje HTTPS</a></li>
<li class="links"><a class="xref" href="httpd.html.sl#http-directory-permissions" title="Sharing Write Permission">Sharing Write Permission</a></li>
<li class="links"><a class="xref" href="httpd.html.sl#http-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="http-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Namestitev</h2></div>
<div class="region"><div class="contents">
<p class="para">Spletni strežnik <span class="app application">Apache2</span> je na voljo v Ubuntu Linuxu. Za namestitev Apache2 vnesite:</p>
<div class="steps"><div class="inner"><ul class="steps"><li class="steps">
        <p class="para">V terminalu vnesite sledeči ukaz:</p>
...
<li class="list itemizedlist">
            <p class="para"><span class="em emphasis">apache2.conf:</span> glavna Apache2 nastavitvena datoteka. Vsebuje nastavitve, ki so <span class="em emphasis">splošne</span> za Apache2.</p>
          </li>
<li class="list itemizedlist">
            <p class="para">
...
<li class="list itemizedlist">
            <p class="para"><span class="em emphasis">envvars:</span> datoteka, kjer so nastavljene <span class="em emphasis">okoljske</span> spremenljivke Apache2.</p>
          </li>
<li class="list itemizedlist">
            <p class="para"><span class="em emphasis">mods-available:</span> ta mapa vsebuje nastavitvene datoteke, ki naložijo in nastavijo <span class="em emphasis">module</span>. Vendar pa nimajo vsi moduli nastavitvenih datotek.</p>
          </li>
<li class="list itemizedlist">
            <p class="para"><span class="em emphasis">mods-enabled:</span> vsebuje <span class="em emphasis">simbolne povezave</span> do datotek v <span class="file filename">/etc/apache2/mods-available</span>. Ko je nastavitvena datoteka modula simbolno povezana, bo omogočena naslednjič, ko bo <span class="app application">Apache2</span> znova zagnan.</p>
          </li>
<li class="list itemizedlist">
            <p class="para">
...
<li class="list itemizedlist">
            <p class="para"><span class="em emphasis">sites-enabled:</span> tako kot mods-enabled, <span class="file filename">sites-enabled</span> vsebuje simbolne povezave do mape <span class="file filename">/etc/apache2/sites-available</span>. Ko je nastavitvena datoteka simbolno povezana v sites-available, bo nastavljena stran dejavna naslednjič, ko bo Apache2 znova zagnan.</p>
          </li>
<li class="list itemizedlist">
            <p class="para">
...
<div class="hgroup"><h3 class="title">Osnovne nastavitve</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo cp /etc/apache2/sites-available/000-default.conf /etc/apache2/sites-available/mynewsite.conf</span>
                 ...
                 <p class="para">Za nastavitev nove strani, uredite novo datoteko z uporabo smernic, opisanih spodaj.</p>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo a2ensite moja-nova-stran</span>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo a2dissite moja-nova-stran</span>
<span class="cmd command">sudo systemctl restart apache2.service</span>
</pre></div>
</div></div>
</div></div>
<div class="sect3 sect" id="default-settings"><div class="inner">
<div class="hgroup"><h3 class="title">Privzete nastavitve</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="list itemizedlist">
                <p class="para"><span class="em em-bold emphasis">ExecCGI</span> - Omogoči izvajanje skriptov CGI. Skripti CGI se ne bodo izvajale, če ta možnost ni izbrana. <div class="note note-tip" title="Namig"><div class="inner"><div class="region"><div class="contents">
                  <p class="para">
...
<div class="hgroup"><h3 class="title">Nastavitve httpd</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Moduli Apache2</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Za omogočitev modula uporabite orodje <span class="app application">a2enmod</span>:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo a2enmod auth_mysql</span>
<span class="cmd command">sudo systemctl restart apache2.service</span>
</pre></div>
<p class="para">Z orodjem <span class="app application">a2dismod</span> lahko modul onemogočite:</p>
...
<div class="hgroup"><h2 class="title">Nastavljanje HTTPS</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
          ...
          <a class="xref" href="certificates-and-security.html.sl" title="Potrdila">Potrdila</a>
          </p>
<p class="para">Za nastavitev <span class="app application">Apache2</span> za HTTPS vnesite sledeče:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo a2ensite default-ssl</span>
</pre></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
              <p class="para">Mapi <span class="file filename">/etc/ssl/certs</span> in <span class="file filename">/etc/ssl/private</span> sta privzeti mesti. V primeru, da ste potrdilo in ključ namestili v drugo mapo, ustrezno spremenite <span class="em emphasis">SSLCertificateFile</span> in <span class="em emphasis">SSLCertificateKeyFile</span>.</p>
            </div></div></div></div>
<p class="para">Zdaj, ko je Apache2 nastavljen za HTTPS, znova zaženite storitev, da se uveljavijo nove nastavitve:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart apache2.service</span>
</pre></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
              <p class="para">Odvisno od tega, kako ste pridobili vaše potrdilo, boste morda morali ob zagonu <span class="app application">Apache2</span> vnesti geslo.</p>
            </div></div></div></div>
<p class="para">Do varnih strani strežnika lahko dostopate z vpisom https://ime-vasega/streznika v naslovno vrstico v brskalniku.</p>
</div></div>
</div></div>
...
<li class="list itemizedlist">
            <p class="para">Oglejte si <a href="http://www.modssl.org/docs/" class="ulink" title="http://www.modssl.org/docs/">dokumentacijo Mod SSL</a> za več podatkov o SSL-ju.</p>
          </li>
<li class="list itemizedlist">
            <p class="para">
