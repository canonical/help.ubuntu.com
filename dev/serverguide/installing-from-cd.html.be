...
<a class="nextlinks-prev" href="installing-live-server.html.be" title="Installing using the live server installer ">Назад</a><a class="nextlinks-next" href="installing-upgrading.html.be" title="Абнаўленьне">Наперад</a>
</div>
