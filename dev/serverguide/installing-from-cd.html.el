...
<a class="nextlinks-prev" href="preparing-to-install.html.el" title="Προετοιμασία εγκατάστασης">Προηγούμενο</a><a class="nextlinks-next" href="installing-upgrading.html.el" title="Αναβάθμιση">Επόμενο</a>
</div>
