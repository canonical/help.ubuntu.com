...
<a class="nextlinks-prev" href="installing-live-server.html.es" title="Installing using the live server installer ">Anterior</a><a class="nextlinks-next" href="installing-upgrading.html.es" title="Actualizando">Siguiente</a>
</div>
...
<li class="list itemizedlist">
          ...
          For advanced disk options see <a class="xref" href="advanced-installation.html.es" title="Instalación avanzada">Instalación avanzada</a>.
	      </p>
	    </li>
<li class="list itemizedlist">
...
<li class="list itemizedlist">
                    ...
                    of an administrator.  For more details see <a class="xref" href="automatic-updates.html.es" title="Actualizaciones automáticas">Actualizaciones automáticas</a>.
                    </p>
                  </li>
<li class="list itemizedlist">
                    <p class="para">
...
<li class="list itemizedlist">
	      <p class="para">Ahora tiene la opción de instalar o no instalar varias tareas de paquetes. Consulte <a class="xref" href="installing-from-cd.html.es#install-tasks" title="Tareas de paquetes">Tareas de paquetes</a> para más información. Además, está la opción de arrancar <span class="app application">aptitude</span> para instalar los paquetes específicos que seleccione. Para más información, consulte <a class="xref" href="aptitude.html.es" title="Aptitude">Aptitude</a>.</p>
	    </li>
<li class="list itemizedlist">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="installing-from-cd.html.es#install-tasks" title="Tareas de paquetes">Tareas de paquetes</a></li></ul></div>
