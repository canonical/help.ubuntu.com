...
<a class="nextlinks-prev" href="preparing-to-install.html.nl" title="Preparing to Install">Vorige</a><a class="nextlinks-next" href="installing-upgrading.html.nl" title="Upgrading">Volgende</a>
</div>
<div class="hgroup"><h1 class="title">Installatie</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="list itemizedlist">
          ...
          For advanced disk options see <a class="xref" href="advanced-installation.html.nl" title="Advanced Installation">Advanced Installation</a>.
	      </p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<li class="list itemizedlist">
                    ...
                    of an administrator.  For more details see <a class="xref" href="automatic-updates.html.nl" title="Automatic Updates">Automatic Updates</a>.
                    </p>
                  </li>
<li class="list itemizedlist">
                    <p class="para">
...
<li class="list itemizedlist">
	      ...
	      <a class="xref" href="installing-from-cd.html.nl#install-tasks" title="Package Tasks">Package Tasks</a> for details.  Also, there is an option to launch
          <span class="app application">aptitude</span> to choose specific packages to install.  For more
          information see <a class="xref" href="aptitude.html.nl" title="Aptitude">Aptitude</a>.
	      </p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="installing-from-cd.html.nl#install-tasks" title="Package Tasks">Package Tasks</a></li></ul></div>
