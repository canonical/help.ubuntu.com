...
<a class="nextlinks-prev" href="preparing-to-install.html.sl" title="Priprava na namestitev">Nazaj</a><a class="nextlinks-next" href="installing-upgrading.html.sl" title="Nadgrajevanje">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Namestitev</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="list itemizedlist">
	      <p class="para">Namestilnik bo nato prepoznal vašo strojno opremo in nastavil omrežne nastavitve z uporabo DHCP-ja. Če ne želite uporabiti DHCP-ja, se vrnite na prejšnji zaslon in izberite možnost "Ročno nastavi omrežje".</p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<li class="list itemizedlist">
          ...
          For advanced disk options see <a class="xref" href="advanced-installation.html.sl" title="Napredna namestitev">Napredna namestitev</a>.
	      </p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">Nameščen bo osnovni sistem Ubuntu.</p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">V naslednjem koraku namestitve se boste morali odločiti, kako želite posodobiti svoj sistem. Na voljo so tri možnosti:</p>
                <div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
                    <p class="para"><span class="em emphasis">Brez samodejnih posodobitev</span>: to zahteva, da se skrbnik prijavi na napravo in ročno namesti posodobitve.</p>
                  </li>
<li class="list itemizedlist">
                    <p class="para">
                    ...
                    of an administrator.  For more details see <a class="xref" href="automatic-updates.html.sl" title="Samodejne posodobitve">Samodejne posodobitve</a>.
                    </p>
                  </li>
<li class="list itemizedlist">
                    <p class="para">
...
<li class="list itemizedlist">
	      ...
	      <a class="xref" href="installing-from-cd.html.sl#install-tasks" title="Package Tasks">Package Tasks</a> for details.  Also, there is an option to launch
          <span class="app application">aptitude</span> to choose specific packages to install.  For more
          information see <a class="xref" href="aptitude.html.sl" title="Aptitude">Aptitude</a>.
	      </p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">Zadnji korak pred ponovnim zagonom je, da uro nastavite na UTC (GMT).</p>
	    </li>
</ul></div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="installing-from-cd.html.sl#install-tasks" title="Package Tasks">Package Tasks</a></li></ul></div>
<div class="sect2 sect" id="install-tasks"><div class="inner">
<div class="hgroup"><h2 class="title">Package Tasks</h2></div>
...
<p class="para">Ko bo namestitveno opravilo dokončano, si lahko v terminalu s sledečim ukazom ogledate seznam opravil, ki so na voljo:</p>
...
<p class="para">Z možnostjo <span class="em emphasis">--task-packages</span> lahko izpišete vse pakete, ki bodo nameščeni z določenim opravilom. Na primer, za seznam paketov, ki jih namesti opravilo <span class="em emphasis">strežnik DNS</span>, bi morali vpisati:</p>
<div class="screen"><pre class="contents "><span class="cmd command">tasksel --task-packages dns-server</span>
</pre></div>
<p class="para">Izpis ukaza bi moral navesti:</p>
