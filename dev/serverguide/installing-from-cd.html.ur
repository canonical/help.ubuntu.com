...
<a class="nextlinks-prev" href="installing-live-server.html.ur" title="Installing using the live server installer ">Previous</a><a class="nextlinks-next" href="installing-upgrading.html.ur" title="Upgrading">Next</a>
</div>
...
<li class="list itemizedlist">
          ...
          For advanced disk options see <a class="xref" href="advanced-installation.html.ur" title="Advanced Installation">Advanced Installation</a>.
	      </p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<li class="list itemizedlist">
                    ...
                    of an administrator.  For more details see <a class="xref" href="automatic-updates.html.ur" title="Automatic Updates">Automatic Updates</a>.
                    </p>
                  </li>
<li class="list itemizedlist">
                    <p class="para">
...
<li class="list itemizedlist">
	      ...
	      <a class="xref" href="installing-from-cd.html.ur#install-tasks" title="Package Tasks">Package Tasks</a> for details.  Also, there is an option to launch
          <span class="app application">aptitude</span> to choose specific packages to install.  For more
          information see <a class="xref" href="aptitude.html.ur" title="Aptitude">Aptitude</a>.
	      </p>
	    </li>
<li class="list itemizedlist">
	      <p class="para">
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="installing-from-cd.html.ur#install-tasks" title="Package Tasks">Package Tasks</a></li></ul></div>
