...
<a class="nextlinks-prev" href="preparing-to-install.html.es" title="Preparando la instalación">Anterior</a><a class="nextlinks-next" href="installing-from-cd.html.es" title="Installation using debian-installer">Siguiente</a>
</div>
