...
<a class="nextlinks-prev" href="preparing-to-install.html.ru" title="Подготовка к установке">Назад</a><a class="nextlinks-next" href="installing-from-cd.html.ru" title="Installation using debian-installer">Вперёд</a>
</div>
