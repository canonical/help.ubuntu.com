...
<a class="nextlinks-prev" href="installing-from-cd.html.ru" title="Installation using debian-installer">Назад</a><a class="nextlinks-next" href="advanced-installation.html.ru" title="Расширенная установка">Вперёд</a>
</div>
