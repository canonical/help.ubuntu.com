...
<a class="nextlinks-prev" href="chat-overview.html.be" title="Overview">Назад</a><a class="nextlinks-next" href="jabberd2-server.html.be" title="Jabber Instant Messaging Server">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="irc-server.html.be#irc-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="irc-server.html.be#irc-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="irc-server.html.be#irc-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
