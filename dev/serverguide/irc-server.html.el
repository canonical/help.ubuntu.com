...
<a class="nextlinks-prev" href="chat-overview.html.el" title="Επισκόπηση">Προηγούμενο</a><a class="nextlinks-next" href="jabberd2-server.html.el" title="Εξυπηρετητής άμεσης ανταλλαγής μηνυμάτων Jabber">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="irc-server.html.el#irc-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="irc-server.html.el#irc-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="irc-server.html.el#irc-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
