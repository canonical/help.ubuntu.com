...
<a class="nextlinks-prev" href="chat-overview.html.sl" title="Pregled">Nazaj</a><a class="nextlinks-next" href="jabberd2-server.html.sl" title="Jabber Instant Messaging Server">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Strežnik IRC</h1></div>
<div class="region">
...
<li class="links"><a class="xref" href="irc-server.html.sl#irc-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="irc-server.html.sl#irc-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="irc-server.html.sl#irc-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="irc-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Namestitev</h2></div>
<div class="region"><div class="contents">
<p class="para">Za namestitev <span class="app application">ircd-irc2</span> vnesite sledeči ukaz v ukazno vrstico:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt install ircd-irc2</span>
</pre></div>
<p class="para">Nastavitvene datoteke so shranjene v mapi <span class="file filename">/etc/ircd</span>. Dokumenti so na voljo v mapi <span class="file filename">/usr/share/doc/ircd-irc2</span>.</p>
</div></div>
</div></div>
