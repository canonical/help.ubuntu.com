...
<a class="nextlinks-prev" href="network-file-system.html.be" title="Network File System (NFS)">Назад</a><a class="nextlinks-next" href="cups.html.be" title="CUPS - Сэрвер друку">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html.be#iscsi-initiator-install" title="iSCSI Initiator Install">iSCSI Initiator Install</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.be#iscsi-initiator-config" title="iSCSI Initiator Configuration">iSCSI Initiator Configuration</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.be#iscsi-initiator-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
