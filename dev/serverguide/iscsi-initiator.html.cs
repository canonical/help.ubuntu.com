...
<a class="nextlinks-prev" href="network-file-system.html.cs" title="Network File System (NFS)">Předchozí</a><a class="nextlinks-next" href="cups.html.cs" title="CUPS - Print Server">Následující</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html.cs#iscsi-initiator-install" title="iSCSI Initiator Install">iSCSI Initiator Install</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.cs#iscsi-initiator-config" title="iSCSI Initiator Configuration">iSCSI Initiator Configuration</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.cs#iscsi-initiator-references" title="References">References</a></li>
</ul></div>
