...
<title>Aρχικοποιητής iSCSI</title>
...
<a class="nextlinks-prev" href="network-file-system.html.el" title="Σύστημα Αρχείων Δικτύου (NFS)">Προηγούμενο</a><a class="nextlinks-next" href="cups.html.el" title="CUPS - Εξυπηρετητής εκτυπώσεων">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Aρχικοποιητής iSCSI</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="iscsi-initiator.html.el#iscsi-initiator-install" title="iSCSI Initiator Install">iSCSI Initiator Install</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.el#iscsi-initiator-config" title="iSCSI Initiator Configuration">iSCSI Initiator Configuration</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.el#iscsi-initiator-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
