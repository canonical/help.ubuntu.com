...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="file-servers.html.es" title="Servidores de archivos">Servidores de archivos</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="network-file-system.html.es" title="Network File System (NFS)">Anterior</a><a class="nextlinks-next" href="cups.html.es" title="CUPS - Servidor de impresión">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Iniciador iSCI</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="iscsi-initiator.html.es#iscsi-initiator-install" title="iSCSI Initiator Install">iSCSI Initiator Install</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.es#iscsi-initiator-config" title="iSCSI Initiator Configuration">iSCSI Initiator Configuration</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.es#iscsi-initiator-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<li class="list itemizedlist"><p class="para"><span class="em emphasis">-m:</span> determina el modo en el que iscsiadm se ejecuta.</p></li>
...
<p class="para">Si el objetivo está disponible debería ver una salida similar a la siguiente:</p>
<div class="screen"><pre class="contents "><span class="output computeroutput">
192.168.0.10:3260,1 iqn.1992-05.com.emc:sl7b92030000520000-2
</span>
</pre></div>
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
          <p class="para">El número<span class="em emphasis">iqn</span> y la dirección IP siguientes variarán dependiendo de su hardware.</p>
        </div></div></div></div>
<p class="para">
...
<p class="para">Asegúrese de que el disco nuevo se detectó usando <span class="app application">dmesg</span>:</p>
...
<p class="para">Siguiente, cree una partición, formatee el sistema de archivos, y monte el disco iSCSI nuevo. En un terminal introduzca:</p>
...
<p class="para">Ahora formatee el sistema de archivos y móntelo en <span class="file filename">/srv</span> como en el ejemplo:</p>
...
<p class="para">Finalmente, añada una entrada en <span class="file filename">/etc/fstab</span> para montar el controlador iSCSI durante el arranque:</p>
<div class="code"><pre class="contents ">/dev/sdb1       /srv        ext4    defaults,auto,_netdev 0 0
</pre></div>
<p class="para">Es una buena idea asegurarse de que todo funcione como esperó reiniciando el servidor.</p>
</div></div>
</div></div>
...
<div class="region"><div class="contents">
<p class="para">
        <a href="http://www.open-iscsi.com/" class="ulink" title="http://www.open-iscsi.com/">Sitio web Open-iSCSI</a>
        </p>
<p class="para">
