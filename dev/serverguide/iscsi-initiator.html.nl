...
<a class="nextlinks-prev" href="network-file-system.html.nl" title="Network File System (NFS)">Vorige</a><a class="nextlinks-next" href="cups.html.nl" title="CUPS - Print Server">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html.nl#iscsi-initiator-install" title="iSCSI Initiator Install">iSCSI Initiator Install</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.nl#iscsi-initiator-config" title="iSCSI Initiator Configuration">iSCSI Initiator Configuration</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.nl#iscsi-initiator-references" title="References">References</a></li>
</ul></div>
