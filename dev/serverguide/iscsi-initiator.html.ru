...
<a class="nextlinks-prev" href="network-file-system.html.ru" title="Сетевая файловая система (NFS)">Назад</a><a class="nextlinks-next" href="cups.html.ru" title="CUPS — сервер печати">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html.ru#iscsi-initiator-install" title="Установка инициатора iSCSI">Установка инициатора iSCSI</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.ru#iscsi-initiator-config" title="Настройка инициатора iSCSI">Настройка инициатора iSCSI</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.ru#iscsi-initiator-references" title="Ссылки">Ссылки</a></li>
</ul></div>
