...
<a class="nextlinks-prev" href="network-file-system.html.sl" title="Network File System (NFS)">Nazaj</a><a class="nextlinks-next" href="cups.html.sl" title="CUPS - tiskalniški strežnik">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html.sl#iscsi-initiator-install" title="iSCSI Initiator Install">iSCSI Initiator Install</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.sl#iscsi-initiator-config" title="iSCSI Initiator Configuration">iSCSI Initiator Configuration</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.sl#iscsi-initiator-references" title="Sklici">Sklici</a></li>
</ul></div>
