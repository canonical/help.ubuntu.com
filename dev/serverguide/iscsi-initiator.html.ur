...
<a class="nextlinks-prev" href="network-file-system.html.ur" title="Network File System (NFS)">Previous</a><a class="nextlinks-next" href="cups.html.ur" title="CUPS - Print Server">Next</a>
</div>
...
<li class="links"><a class="xref" href="iscsi-initiator.html.ur#iscsi-initiator-install" title="iSCSI Initiator Install">iSCSI Initiator Install</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.ur#iscsi-initiator-config" title="iSCSI Initiator Configuration">iSCSI Initiator Configuration</a></li>
<li class="links"><a class="xref" href="iscsi-initiator.html.ur#iscsi-initiator-references" title="References">References</a></li>
</ul></div>
