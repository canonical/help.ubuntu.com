...
<a class="nextlinks-prev" href="irc-server.html.ru" title="IRC-сервер">Назад</a><a class="nextlinks-next" href="version-control-system.html.ru" title="Система контроля версий">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="jabberd2-server.html.ru#jabberd2-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="jabberd2-server.html.ru#jabberd2-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="jabberd2-server.html.ru#jabberd2-references" title="Ссылки">Ссылки</a></li>
</ul></div>
