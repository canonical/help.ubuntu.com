...
<a class="nextlinks-prev" href="kerberos.html.be" title="Kerberos">Назад</a><a class="nextlinks-next" href="sssd-ad.html.be" title="SSSD and Active Directory">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Kerberos і LDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="kerberos-ldap.html.be#kerberos-ldap-openldap" title="Наладка OpenLDAP">Наладка OpenLDAP</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.be#kerberos-ldap-primary-kdc" title="Primary KDC Configuration">Primary KDC Configuration</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.be#kerberos-ldap-secondary-kdc" title="Secondary KDC Configuration">Secondary KDC Configuration</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.be#kerberos-ldap-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
<div class="sect2 sect" id="kerberos-ldap-openldap"><div class="inner">
<div class="hgroup"><h2 class="title">Наладка OpenLDAP</h2></div>
...
<p class="para">
      ...
      configured between at least two servers.  For information on setting up OpenLDAP see <a class="xref" href="openldap-server.html.be" title="Сэрвер OpenLDAP">Сэрвер OpenLDAP</a>.
      </p>
<p class="para">
      ...
      See <a class="xref" href="openldap-server.html.be#openldap-tls" title="TLS">TLS</a> for details.
      </p>
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
         <p class="para">
...
<li class="list itemizedlist">
           ...
           <a class="xref" href="openldap-server.html.be#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a>.
           </p>
