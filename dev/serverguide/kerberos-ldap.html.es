...
<a class="nextlinks-prev" href="kerberos.html.es" title="Kerberos">Anterior</a><a class="nextlinks-next" href="sssd-ad.html.es" title="SSSD and Active Directory">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="kerberos-ldap.html.es#kerberos-ldap-openldap" title="Configurar OpenLDAP">Configurar OpenLDAP</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.es#kerberos-ldap-primary-kdc" title="Configuración del KDC primario">Configuración del KDC primario</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.es#kerberos-ldap-secondary-kdc" title="Configuración del KDC secundario">Configuración del KDC secundario</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.es#kerberos-ldap-resources" title="Recursos">Recursos</a></li>
</ul></div>
