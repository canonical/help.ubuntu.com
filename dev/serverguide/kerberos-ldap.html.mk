...
<a class="nextlinks-prev" href="kerberos.html.mk" title="Kerberos">Previous</a><a class="nextlinks-next" href="sssd-ad.html.mk" title="SSSD and Active Directory">Next</a>
</div>
...
<li class="links"><a class="xref" href="kerberos-ldap.html.mk#kerberos-ldap-openldap" title="Configuring OpenLDAP">Configuring OpenLDAP</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.mk#kerberos-ldap-primary-kdc" title="Primary KDC Configuration">Primary KDC Configuration</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.mk#kerberos-ldap-secondary-kdc" title="Secondary KDC Configuration">Secondary KDC Configuration</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.mk#kerberos-ldap-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para">
      ...
      configured between at least two servers.  For information on setting up OpenLDAP see <a class="xref" href="openldap-server.html.mk" title="OpenLDAP Server">OpenLDAP Server</a>.
      </p>
<p class="para">
      ...
      See <a class="xref" href="openldap-server.html.mk#openldap-tls" title="TLS">TLS</a> for details.
      </p>
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents">
         <p class="para">
...
<li class="list itemizedlist">
           ...
           <a class="xref" href="openldap-server.html.mk#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a>.
           </p>
