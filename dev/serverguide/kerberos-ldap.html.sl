...
<a class="nextlinks-prev" href="kerberos.html.sl" title="Kerberos">Nazaj</a><a class="nextlinks-next" href="sssd-ad.html.sl" title="SSSD and Active Directory">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Kerberos in LDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="kerberos-ldap.html.sl#kerberos-ldap-openldap" title="Nastavljanje OpenLDAP">Nastavljanje OpenLDAP</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.sl#kerberos-ldap-primary-kdc" title="Primary KDC Configuration">Primary KDC Configuration</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.sl#kerberos-ldap-secondary-kdc" title="Secondary KDC Configuration">Secondary KDC Configuration</a></li>
<li class="links"><a class="xref" href="kerberos-ldap.html.sl#kerberos-ldap-resources" title="Viri">Viri</a></li>
</ul></div>
<div class="sect2 sect" id="kerberos-ldap-openldap"><div class="inner">
<div class="hgroup"><h2 class="title">Nastavljanje OpenLDAP</h2></div>
...
<p class="para">
      ...
      configured between at least two servers.  For information on setting up OpenLDAP see <a class="xref" href="openldap-server.html.sl" title="Strežnik OpenLDAP">Strežnik OpenLDAP</a>.
      </p>
<p class="para">
      ...
      See <a class="xref" href="openldap-server.html.sl#openldap-tls" title="TLS">TLS</a> for details.
      </p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
         <p class="para">
...
<li class="list itemizedlist">
           ...
           <a class="xref" href="openldap-server.html.sl#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a>.
           </p>
...
<li class="steps">
                  ...
                  <p class="para">Ustvarite začasno mapo, ki bo vsebovala datoteke LDIF:</p>
...
cn: kerberos
                  ...
                  <p class="para">In odstranite sledeče vrstice z dna datoteke:</p>
...
<li class="list itemizedlist">
          <p class="para">Oglejte si tudi stran <a href="https://help.ubuntu.com/community/Kerberos#kerberos-ldap" class="ulink" title="https://help.ubuntu.com/community/Kerberos#kerberos-ldap">Kerberos in LDAP</a>na Ubuntu Wiki.</p>
        </li>
</ul></div></div></div>
</div></div>
</div>
