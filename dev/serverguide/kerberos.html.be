...
<a class="nextlinks-prev" href="samba-ldap.html.be" title="Samba і LDAP">Назад</a><a class="nextlinks-next" href="kerberos-ldap.html.be" title="Kerberos і LDAP">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="kerberos.html.be#kerberos-overview" title="Overview">Overview</a></li>
<li class="links"><a class="xref" href="kerberos.html.be#kerberos-server" title="Сэрвер Kerberos">Сэрвер Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html.be#kerberos-secondary-kdc" title="Другасны KDC">Другасны KDC</a></li>
<li class="links"><a class="xref" href="kerberos.html.be#kerberos-linux-client" title="Linux кліент Kerberos">Linux кліент Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html.be#kerberos-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<div class="hgroup"><h2 class="title">Сэрвер Kerberos</h2></div>
<div class="region">
<div class="contents"></div>
<div class="sect3 sect" id="kerberos-server-installation"><div class="inner">
<div class="hgroup"><h3 class="title">Усталёўка</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para"> 
        ...
        <a class="xref" href="dns-configuration.html.be#dns-primarymaster-configuration" title="Primary Master">Primary Master</a> of the DNS documentation.  
        </p>
<p class="para">
	...
	<span class="em emphasis">Network Time Protocol (NTP)</span> server.  For details
        on setting up NTP see <a class="xref" href="NTP.html.be" title="Time Synchronization">Time Synchronization</a>.
        </p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Настаўленьні</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
kadmin.local:</span><span class="input userinput"> выхад</span>
</pre></div>
...
<span class="output computeroutput">Пароль на steve/admin@EXAMPLE.COM:</span>
</pre></div>          
...
_kpasswd._udp.EXAMPLE.COM.      IN SRV 1  0 464 kdc01.example.com.
            ...
            <p class="para">
            See <a class="xref" href="dns.html.be" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for detailed instructions on setting up DNS.
            </p>
...
<div class="hgroup"><h2 class="title">Другасны KDC</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h2 class="title">Linux кліент Kerberos</h2></div>
<div class="region">
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
	  ...
	  <a class="xref" href="kerberos.html.be#kerberos-server-installation" title="Усталёўка">Усталёўка</a>, you 
...
<span class="output computeroutput">Пароль для steve@EXAMPLE.COM:</span>
</pre></div>
<p class="para">
