...
<a class="nextlinks-prev" href="samba-ldap.html.cs" title="Samba and LDAP">Předchozí</a><a class="nextlinks-next" href="kerberos-ldap.html.cs" title="Kerberos and LDAP">Následující</a>
</div>
...
<li class="links"><a class="xref" href="kerberos.html.cs#kerberos-overview" title="Overview">Overview</a></li>
<li class="links"><a class="xref" href="kerberos.html.cs#kerberos-server" title="Kerberos Server">Kerberos Server</a></li>
<li class="links"><a class="xref" href="kerberos.html.cs#kerberos-secondary-kdc" title="Secondary KDC">Secondary KDC</a></li>
<li class="links"><a class="xref" href="kerberos.html.cs#kerberos-linux-client" title="Kerberos Linux Client">Kerberos Linux Client</a></li>
<li class="links"><a class="xref" href="kerberos.html.cs#kerberos-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<div class="hgroup"><h3 class="title">Instalace</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para"> 
        ...
        <a class="xref" href="dns-configuration.html.cs#dns-primarymaster-configuration" title="Primary Master">Primary Master</a> of the DNS documentation.  
        </p>
<p class="para">
	...
	<span class="em emphasis">Network Time Protocol (NTP)</span> server.  For details
        on setting up NTP see <a class="xref" href="NTP.html.cs" title="Time Synchronization">Time Synchronization</a>.
        </p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Nastavení</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
_kpasswd._udp.EXAMPLE.COM.      IN SRV 1  0 464 kdc01.example.com.
            ...
            <p class="para">
            See <a class="xref" href="dns.html.cs" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for detailed instructions on setting up DNS.
            </p>
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
	  ...
	  <a class="xref" href="kerberos.html.cs#kerberos-server-installation" title="Instalace">Instalace</a>, you 
