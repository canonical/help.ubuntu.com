...
<a class="nextlinks-prev" href="samba-ldap.html.el" title="Samba και LDAP">Προηγούμενο</a><a class="nextlinks-next" href="kerberos-ldap.html.el" title="Kerberos και LDAP">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="kerberos.html.el#kerberos-overview" title="Επισκόπηση">Επισκόπηση</a></li>
<li class="links"><a class="xref" href="kerberos.html.el#kerberos-server" title="Εξυπηρετητής Kerberos">Εξυπηρετητής Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html.el#kerberos-secondary-kdc" title="Δευτερεύον KDC">Δευτερεύον KDC</a></li>
<li class="links"><a class="xref" href="kerberos.html.el#kerberos-linux-client" title="Πελάτης Kerberos για Linux">Πελάτης Kerberos για Linux</a></li>
<li class="links"><a class="xref" href="kerberos.html.el#kerberos-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para"> 
        ...
        <a class="xref" href="dns-configuration.html.el#dns-primarymaster-configuration" title="Κύριος Master">Κύριος Master</a> of the DNS documentation.  
        </p>
<p class="para">
	...
	<span class="em emphasis">Network Time Protocol (NTP)</span> server.  For details
        on setting up NTP see <a class="xref" href="NTP.html.el" title="Time Synchronization">Time Synchronization</a>.
        </p>
<p class="para">
...
_kpasswd._udp.EXAMPLE.COM.      IN SRV 1  0 464 kdc01.example.com.
            ...
            <p class="para">Δείτε το <a class="xref" href="dns.html.el" title="Υπηρεσία ονομάτων τομέα (DNS)">Υπηρεσία ονομάτων τομέα (DNS)</a> για λεπτομερείς οδηγίες ρύθμισεις του DNS.</p>
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
	  ...
	  <a class="xref" href="kerberos.html.el#kerberos-server-installation" title="Εγκατάσταση">Εγκατάσταση</a>, you 
