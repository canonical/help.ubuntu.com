...
<a class="nextlinks-prev" href="samba-ldap.html.es" title="Samba y LDAP">Anterior</a><a class="nextlinks-next" href="kerberos-ldap.html.es" title="Kerberos y LDAP">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="kerberos.html.es#kerberos-overview" title="Vista general">Vista general</a></li>
<li class="links"><a class="xref" href="kerberos.html.es#kerberos-server" title="Servidor Kerberos">Servidor Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html.es#kerberos-secondary-kdc" title="KDC secundario">KDC secundario</a></li>
<li class="links"><a class="xref" href="kerberos.html.es#kerberos-linux-client" title="Cliente Linux Kerberos">Cliente Linux Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html.es#kerberos-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para"> 
        ...
        <a class="xref" href="dns-configuration.html.es#dns-primarymaster-configuration" title="Maestro primario">Maestro primario</a> of the DNS documentation.  
        </p>
<p class="para">
	...
	<span class="em emphasis">Network Time Protocol (NTP)</span> server.  For details
        on setting up NTP see <a class="xref" href="NTP.html.es" title="Time Synchronization">Time Synchronization</a>.
        </p>
<p class="para">
...
_kpasswd._udp.EXAMPLE.COM.      IN SRV 1  0 464 kdc01.example.com.
            ...
            <p class="para">Vea <a class="xref" href="dns.html.es" title="Servicio de nombres de dominio (DNS)">Servicio de nombres de dominio (DNS)</a> para las instrucciones detalladas de configuración de DNS.</p>
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
	  ...
	  <a class="xref" href="kerberos.html.es#kerberos-server-installation" title="Instalación">Instalación</a>, you 
