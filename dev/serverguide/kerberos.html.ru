...
<a class="nextlinks-prev" href="samba-ldap.html.ru" title="Samba и LDAP">Назад</a><a class="nextlinks-next" href="kerberos-ldap.html.ru" title="Kerberos и LDAP">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="kerberos.html.ru#kerberos-overview" title="Обзор">Обзор</a></li>
<li class="links"><a class="xref" href="kerberos.html.ru#kerberos-server" title="Сервер Kerberos">Сервер Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html.ru#kerberos-secondary-kdc" title="Вторичный KDC">Вторичный KDC</a></li>
<li class="links"><a class="xref" href="kerberos.html.ru#kerberos-linux-client" title="Клиент Kerberos для Linux">Клиент Kerberos для Linux</a></li>
<li class="links"><a class="xref" href="kerberos.html.ru#kerberos-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
_kpasswd._udp.EXAMPLE.COM.      IN SRV 1  0 464 kdc01.example.com.
            ...
            <p class="para">Смотрите <a class="xref" href="dns.html.ru" title="Служба доменных имён (DNS)">Служба доменных имён (DNS)</a> для детальных инструкций по настройке DNS.</p>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
	  <p class="para">Если вы установите uid каждого вашего авторизованного в сети пользователя начиная с 5000, как предложено в <a class="xref" href="kerberos.html.ru#kerberos-server-installation" title="Установка">Установка</a>, вы затем сможете указать pam аутентифицировать с помощью Kerberos только пользователей с uid &gt; 5000:</p>
