...
<a class="nextlinks-prev" href="samba-ldap.html.sl" title="Samba in LDAP">Nazaj</a><a class="nextlinks-next" href="kerberos-ldap.html.sl" title="Kerberos in LDAP">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="kerberos.html.sl#kerberos-overview" title="Pregled">Pregled</a></li>
<li class="links"><a class="xref" href="kerberos.html.sl#kerberos-server" title="Strežnik Kerberos">Strežnik Kerberos</a></li>
<li class="links"><a class="xref" href="kerberos.html.sl#kerberos-secondary-kdc" title="Secondary KDC">Secondary KDC</a></li>
<li class="links"><a class="xref" href="kerberos.html.sl#kerberos-linux-client" title="Kerberos Linux Client">Kerberos Linux Client</a></li>
<li class="links"><a class="xref" href="kerberos.html.sl#kerberos-resources" title="Viri">Viri</a></li>
</ul></div>
...
<div class="hgroup"><h2 class="title">Strežnik Kerberos</h2></div>
<div class="region">
...
<p class="para"> 
        ...
        <a class="xref" href="dns-configuration.html.sl#dns-primarymaster-configuration" title="Primary Master">Primary Master</a> of the DNS documentation.  
        </p>
<p class="para">
	...
	<span class="em emphasis">Network Time Protocol (NTP)</span> server.  For details
        on setting up NTP see <a class="xref" href="NTP.html.sl" title="Time Synchronization">Time Synchronization</a>.
        </p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Nastavljanje</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
_kpasswd._udp.EXAMPLE.COM.      IN SRV 1  0 464 kdc01.example.com.
            ...
            <p class="para">
            See <a class="xref" href="dns.html.sl" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for detailed instructions on setting up DNS.
            </p>
...
<div class="hgroup"><h3 class="title">Nastavljanje</h3></div>
<div class="region"><div class="contents">
<p class="para">Za nastavljanje odjemalca, v terminal vpišite:</p>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
	  ...
	  <a class="xref" href="kerberos.html.sl#kerberos-server-installation" title="Namestitev">Namestitev</a>, you 
...
<li class="list itemizedlist">
          <p class="para">Stran <a href="https://help.ubuntu.com/community/Kerberos" class="ulink" title="https://help.ubuntu.com/community/Kerberos">Kerberos na Ubuntu Wiki</a> vsebuje več podrobnosti.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
