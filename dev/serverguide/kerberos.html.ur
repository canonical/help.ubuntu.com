...
<a class="nextlinks-prev" href="samba-ldap.html.ur" title="Samba and LDAP">Previous</a><a class="nextlinks-next" href="kerberos-ldap.html.ur" title="Kerberos and LDAP">Next</a>
</div>
...
<li class="links"><a class="xref" href="kerberos.html.ur#kerberos-overview" title="Overview">Overview</a></li>
<li class="links"><a class="xref" href="kerberos.html.ur#kerberos-server" title="Kerberos Server">Kerberos Server</a></li>
<li class="links"><a class="xref" href="kerberos.html.ur#kerberos-secondary-kdc" title="Secondary KDC">Secondary KDC</a></li>
<li class="links"><a class="xref" href="kerberos.html.ur#kerberos-linux-client" title="Kerberos Linux Client">Kerberos Linux Client</a></li>
<li class="links"><a class="xref" href="kerberos.html.ur#kerberos-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para"> 
        ...
        <a class="xref" href="dns-configuration.html.ur#dns-primarymaster-configuration" title="Primary Master">Primary Master</a> of the DNS documentation.  
        </p>
<p class="para">
	...
	<span class="em emphasis">Network Time Protocol (NTP)</span> server.  For details
        on setting up NTP see <a class="xref" href="NTP.html.ur" title="Time Synchronization">Time Synchronization</a>.
        </p>
<p class="para">
...
_kpasswd._udp.EXAMPLE.COM.      IN SRV 1  0 464 kdc01.example.com.
            ...
            <p class="para">
            See <a class="xref" href="dns.html.ur" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for detailed instructions on setting up DNS.
            </p>
...
<div class="note" title="Note"><div class="inner"><div class="region"><div class="contents">
	  ...
	  <a class="xref" href="kerberos.html.ur#kerberos-server-installation" title="Installation">Installation</a>, you 
