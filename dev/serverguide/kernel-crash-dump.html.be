...
<a class="nextlinks-prev" href="advanced-installation.html.be" title="Advanced Installation">Назад</a><a class="nextlinks-next" href="package-management.html.be" title="Кіраваньне пакетамі">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html.be#kernel-dump-introduction" title="Уводзіны">Уводзіны</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.be#kernel-crash-dump-mechanisms" title="Kernel Crash Dump Mechanism">Kernel Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.be#Installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.be#kernel-dump-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.be#verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.be#kdump-testing" title="Testing the Crash Dump Mechanism">Testing the Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.be#kdump-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
<div class="sect2 sect" id="kernel-dump-introduction"><div class="inner">
<div class="hgroup"><h2 class="title">Уводзіны</h2></div>
