...
<a class="nextlinks-prev" href="advanced-installation.html.cs" title="Advanced Installation">Předchozí</a><a class="nextlinks-next" href="package-management.html.cs" title="Package Management">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html.cs#kernel-dump-introduction" title="Úvod">Úvod</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.cs#kernel-crash-dump-mechanisms" title="Kernel Crash Dump Mechanism">Kernel Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.cs#Installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.cs#kernel-dump-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.cs#verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.cs#kdump-testing" title="Testing the Crash Dump Mechanism">Testing the Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.cs#kdump-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
