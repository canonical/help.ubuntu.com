...
<a class="nextlinks-prev" href="advanced-installation.html.mk" title="Advanced Installation">Previous</a><a class="nextlinks-next" href="package-management.html.mk" title="Менаџмент на пакети">Next</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html.mk#kernel-dump-introduction" title="Вовед">Вовед</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.mk#kernel-crash-dump-mechanisms" title="Kernel Crash Dump Mechanism">Kernel Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.mk#Installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.mk#kernel-dump-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.mk#verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.mk#kdump-testing" title="Testing the Crash Dump Mechanism">Testing the Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.mk#kdump-resources" title="Resources">Resources</a></li>
</ul></div>
<div class="sect2 sect" id="kernel-dump-introduction"><div class="inner">
<div class="hgroup"><h2 class="title">Вовед</h2></div>
