...
<a class="nextlinks-prev" href="advanced-installation.html.nl" title="Advanced Installation">Vorige</a><a class="nextlinks-next" href="package-management.html.nl" title="Package Management">Volgende</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html.nl#kernel-dump-introduction" title="Inleiding">Inleiding</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.nl#kernel-crash-dump-mechanisms" title="Kernel Crash Dump Mechanism">Kernel Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.nl#Installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.nl#kernel-dump-configuration" title="Configuratie">Configuratie</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.nl#verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.nl#kdump-testing" title="Testing the Crash Dump Mechanism">Testing the Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.nl#kdump-resources" title="Resources">Resources</a></li>
</ul></div>
