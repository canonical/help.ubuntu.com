...
<a class="nextlinks-prev" href="advanced-installation.html.ur" title="Advanced Installation">Previous</a><a class="nextlinks-next" href="package-management.html.ur" title="Package Management">Next</a>
</div>
<div class="hgroup"><h1 class="title">Kernel Crash Dump</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="kernel-crash-dump.html.ur#kernel-dump-introduction" title="تعارف">تعارف</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.ur#kernel-crash-dump-mechanisms" title="Kernel Crash Dump Mechanism">Kernel Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.ur#Installation" title="Installation">Installation</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.ur#kernel-dump-configuration" title="Configuration">Configuration</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.ur#verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.ur#kdump-testing" title="Testing the Crash Dump Mechanism">Testing the Crash Dump Mechanism</a></li>
<li class="links"><a class="xref" href="kernel-crash-dump.html.ur#kdump-resources" title="Resources">Resources</a></li>
</ul></div>
<div class="sect2 sect" id="kernel-dump-introduction"><div class="inner">
<div class="hgroup"><h2 class="title">تعارف</h2></div>
