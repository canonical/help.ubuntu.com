...
<a class="nextlinks-prev" href="lamp-applications.html.sl" title="Programi LAMP">Nazaj</a><a class="nextlinks-next" href="moinmoin.html.sl" title="Moin Moin">Naprej</a>
</div>
...
<p class="para">
    Fortunately, a number of <span class="em emphasis">LAMP</span> applications are already packaged for Ubuntu, and are available
