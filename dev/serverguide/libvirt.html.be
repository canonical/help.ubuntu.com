...
<a class="nextlinks-prev" href="virtualization.html.be" title="Virtualization">Назад</a><a class="nextlinks-next" href="qemu.html.be" title="Qemu">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="libvirt.html.be#virtual-networking" title="Virtual Networking">Virtual Networking</a></li>
<li class="links"><a class="xref" href="libvirt.html.be#libvirt-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="libvirt.html.be#libvirt-virt-install" title="virt-install">virt-install</a></li>
<li class="links"><a class="xref" href="libvirt.html.be#libvirt-virt-clone" title="virt-clone">virt-clone</a></li>
<li class="links"><a class="xref" href="libvirt.html.be#libvirt-management" title="Virtual Machine Management">Virtual Machine Management</a></li>
<li class="links"><a class="xref" href="libvirt.html.be#libvirt-virt-viewer" title="Virtual Machine Viewer">Virtual Machine Viewer</a></li>
<li class="links"><a class="xref" href="libvirt.html.be#libvirt-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<div class="region"><div class="contents">
<p class="para">Каб устанавіць неабходныя пакеты, увядзіце ў тэрмінале:</p>
...
<p class="para">Увядзіце ў тэрмінале:</p>
...
<p class="para">In the case of virtual machines a Graphical User Interface (GUI)
      ...
      <span class="app application">VNC</span>. See <a class="xref" href="libvirt.html.be#libvirt-virt-viewer" title="Virtual Machine Viewer">Virtual Machine Viewer</a> for more information.</p>
...
<p class="para">Yet another way to install an Ubuntu virtual machine is to use
      ...
      details see <a class="xref" href="cloud-images-and-uvtool.html.be" title="Cloud images and uvtool">Cloud images and uvtool</a>.</p>
...
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">-n:</span> імя новай віртуальнай машыны.</p>
        </li>
<li class="list itemizedlist">
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
          ...
          <span class="app application">SSH</span> see <a class="xref" href="openssh-server.html.be" title="OpenSSH Server">OpenSSH Server</a></p>
        </div></div></div></div>
</div></div>
</div></div>
</div>
...
<p class="para">Каб устанавіць <span class="app application">virt-viewer</span>, увядзіце ў тэрмінале:</p>
...
<li class="list itemizedlist">
          <p class="para">Для больш зьмястоўнай інфармацыі пра <span class="app application">libvirt</span> глядзіце <a href="http://libvirt.org/" class="ulink" title="http://libvirt.org/">хатнюю старонку libvirt</a></p>
        </li>
<li class="list itemizedlist">
