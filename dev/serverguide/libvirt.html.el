...
<a class="nextlinks-prev" href="virtualization.html.el" title="Εικονικοποίηση">Προηγούμενο</a><a class="nextlinks-next" href="qemu.html.el" title="Qemu">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="libvirt.html.el#virtual-networking" title="Εικονική Διαδικτύωση">Εικονική Διαδικτύωση</a></li>
<li class="links"><a class="xref" href="libvirt.html.el#libvirt-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="libvirt.html.el#libvirt-virt-install" title="virt-install">virt-install</a></li>
<li class="links"><a class="xref" href="libvirt.html.el#libvirt-virt-clone" title="virt-clone">virt-clone</a></li>
<li class="links"><a class="xref" href="libvirt.html.el#libvirt-management" title="Διαχείριση Εικονικής Μηχανής">Διαχείριση Εικονικής Μηχανής</a></li>
<li class="links"><a class="xref" href="libvirt.html.el#libvirt-virt-viewer" title="Πρόγραμμα Παρουσίασης Εικονικής Μηχανής">Πρόγραμμα Παρουσίασης Εικονικής Μηχανής</a></li>
<li class="links"><a class="xref" href="libvirt.html.el#libvirt-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">Σε περίπτωση εικονικών μηχανών ένα Γραφικό Περιβάλλον Εργασείας (Graphical User Interface (GUI)) είναι ανάλογο του φυσικού πληκτρολογίου και ποντικιού. Αντί να εγκαταστήσετε ένα Γραφικό Περιβάλλον Εργασίας η εφαρμογή <span class="app application">virt-viewer</span> μπορεί να χρησιμοποιηθεί για τη σύνδεση σε μια κονσόλα εικονικής μηχανής χρησιμοποιώντας το <span class="app application">VNC</span>. Δείτε το <a class="xref" href="libvirt.html.el#libvirt-virt-viewer" title="Πρόγραμμα Παρουσίασης Εικονικής Μηχανής">Πρόγραμμα Παρουσίασης Εικονικής Μηχανής</a> για περισσότερες πληροφορίες.</p>
...
<p class="para">Yet another way to install an Ubuntu virtual machine is to use
      ...
      details see <a class="xref" href="cloud-images-and-uvtool.html.el" title="Cloud images and uvtool">Cloud images and uvtool</a>.</p>
