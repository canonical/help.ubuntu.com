...
<a class="nextlinks-prev" href="virtualization.html.es" title="Virtualización">Anterior</a><a class="nextlinks-next" href="qemu.html.es" title="Qemu">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="libvirt.html.es#virtual-networking" title="Redes virtuales">Redes virtuales</a></li>
<li class="links"><a class="xref" href="libvirt.html.es#libvirt-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="libvirt.html.es#libvirt-virt-install" title="virt-install">virt-install</a></li>
<li class="links"><a class="xref" href="libvirt.html.es#libvirt-virt-clone" title="virt-clone">virt-clone</a></li>
<li class="links"><a class="xref" href="libvirt.html.es#libvirt-management" title="Gestión de máquinas virtuales">Gestión de máquinas virtuales</a></li>
<li class="links"><a class="xref" href="libvirt.html.es#libvirt-virt-viewer" title="Visor de máquinas virtuales">Visor de máquinas virtuales</a></li>
<li class="links"><a class="xref" href="libvirt.html.es#libvirt-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para">Yet another way to install an Ubuntu virtual machine is to use
      ...
      details see <a class="xref" href="cloud-images-and-uvtool.html.es" title="Cloud images and uvtool">Cloud images and uvtool</a>.</p>
