...
<a class="nextlinks-prev" href="virtualization.html.nl" title="Virtualization">Vorige</a><a class="nextlinks-next" href="qemu.html.nl" title="Qemu">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="libvirt.html.nl#virtual-networking" title="Virtual Networking">Virtual Networking</a></li>
<li class="links"><a class="xref" href="libvirt.html.nl#libvirt-installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="libvirt.html.nl#libvirt-virt-install" title="virt-install">virt-install</a></li>
<li class="links"><a class="xref" href="libvirt.html.nl#libvirt-virt-clone" title="virt-clone">virt-clone</a></li>
<li class="links"><a class="xref" href="libvirt.html.nl#libvirt-management" title="Virtual Machine Management">Virtual Machine Management</a></li>
<li class="links"><a class="xref" href="libvirt.html.nl#libvirt-virt-viewer" title="Virtual Machine Viewer">Virtual Machine Viewer</a></li>
<li class="links"><a class="xref" href="libvirt.html.nl#libvirt-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para">In the case of virtual machines a Graphical User Interface (GUI)
      ...
      <span class="app application">VNC</span>. See <a class="xref" href="libvirt.html.nl#libvirt-virt-viewer" title="Virtual Machine Viewer">Virtual Machine Viewer</a> for more information.</p>
...
<p class="para">Yet another way to install an Ubuntu virtual machine is to use
      ...
      details see <a class="xref" href="cloud-images-and-uvtool.html.nl" title="Cloud images and uvtool">Cloud images and uvtool</a>.</p>
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents">
          ...
          <span class="app application">SSH</span> see <a class="xref" href="openssh-server.html.nl" title="OpenSSH Server">OpenSSH Server</a></p>
        </div></div></div></div>
</div></div>
</div></div>
</div>
