...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="virtualization.html.sl" title="Virtualization">Virtualization</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="virtualization.html.sl" title="Virtualization">Nazaj</a><a class="nextlinks-next" href="qemu.html.sl" title="Qemu">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="libvirt.html.sl#virtual-networking" title="Virtual Networking">Virtual Networking</a></li>
<li class="links"><a class="xref" href="libvirt.html.sl#libvirt-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="libvirt.html.sl#libvirt-virt-install" title="virt-install">virt-install</a></li>
<li class="links"><a class="xref" href="libvirt.html.sl#libvirt-virt-clone" title="virt-clone">virt-clone</a></li>
<li class="links"><a class="xref" href="libvirt.html.sl#libvirt-management" title="Upravljanje navideznih naprav">Upravljanje navideznih naprav</a></li>
<li class="links"><a class="xref" href="libvirt.html.sl#libvirt-virt-viewer" title="Virtual Machine Viewer">Virtual Machine Viewer</a></li>
<li class="links"><a class="xref" href="libvirt.html.sl#libvirt-resources" title="Viri">Viri</a></li>
</ul></div>
...
<p class="para">In the case of virtual machines a Graphical User Interface (GUI)
      ...
      <span class="app application">VNC</span>. See <a class="xref" href="libvirt.html.sl#libvirt-virt-viewer" title="Virtual Machine Viewer">Virtual Machine Viewer</a> for more information.</p>
...
<p class="para">Yet another way to install an Ubuntu virtual machine is to use
      ...
      details see <a class="xref" href="cloud-images-and-uvtool.html.sl" title="Cloud images and uvtool">Cloud images and uvtool</a>.</p>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
          ...
          <span class="app application">SSH</span> see <a class="xref" href="openssh-server.html.sl" title="Strežnik OpenSSH">Strežnik OpenSSH</a></p>
        </div></div></div></div>
</div></div>
</div></div>
</div>
