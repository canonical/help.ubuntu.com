...
<a class="nextlinks-prev" href="virtualization.html.ur" title="Virtualization">Previous</a><a class="nextlinks-next" href="qemu.html.ur" title="Qemu">Next</a>
</div>
...
<li class="links"><a class="xref" href="libvirt.html.ur#virtual-networking" title="Virtual Networking">Virtual Networking</a></li>
<li class="links"><a class="xref" href="libvirt.html.ur#libvirt-installation" title="Installation">Installation</a></li>
<li class="links"><a class="xref" href="libvirt.html.ur#libvirt-virt-install" title="virt-install">virt-install</a></li>
<li class="links"><a class="xref" href="libvirt.html.ur#libvirt-virt-clone" title="virt-clone">virt-clone</a></li>
<li class="links"><a class="xref" href="libvirt.html.ur#libvirt-management" title="Virtual Machine Management">Virtual Machine Management</a></li>
<li class="links"><a class="xref" href="libvirt.html.ur#libvirt-virt-viewer" title="Virtual Machine Viewer">Virtual Machine Viewer</a></li>
<li class="links"><a class="xref" href="libvirt.html.ur#libvirt-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para">In the case of virtual machines a Graphical User Interface (GUI)
      ...
      <span class="app application">VNC</span>. See <a class="xref" href="libvirt.html.ur#libvirt-virt-viewer" title="Virtual Machine Viewer">Virtual Machine Viewer</a> for more information.</p>
...
<p class="para">Yet another way to install an Ubuntu virtual machine is to use
      ...
      details see <a class="xref" href="cloud-images-and-uvtool.html.ur" title="Cloud images and uvtool">Cloud images and uvtool</a>.</p>
...
<div class="note" title="Note"><div class="inner"><div class="region"><div class="contents">
          ...
          <span class="app application">SSH</span> see <a class="xref" href="openssh-server.html.ur" title="OpenSSH Server">OpenSSH Server</a></p>
        </div></div></div></div>
</div></div>
</div></div>
</div>
