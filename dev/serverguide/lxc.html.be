...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="virtualization.html.be" title="Virtualization">Virtualization</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="lxd.html.be" title="LXD">Назад</a><a class="nextlinks-next" href="cgroups.html.be" title="Control Groups">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html.be#lxc-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-basic-usage" title="Basic usage">Basic usage</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-global-conf" title="Global configuration">Global configuration</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-network" title="Сеціва">Сеціва</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-startup" title="LXC startup">LXC startup</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-backinstores" title="Backing Stores">Backing Stores</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-templates" title="Templates">Templates</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-autostart" title="Autostart">Autostart</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-apparmor" title="Apparmor">Apparmor</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-cgroups" title="Control Groups">Control Groups</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-cloning" title="Cloning">Cloning</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-hooks" title="Lifecycle management hooks">Lifecycle management hooks</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-consoles" title="Consoles">Consoles</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-debugging" title="Troubleshooting">Troubleshooting</a></li>
<li class="links"><a class="xref" href="lxc.html.be#python-lxc" title="LXC API">LXC API</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-security" title="Бясьпека">Бясьпека</a></li>
<li class="links"><a class="xref" href="lxc.html.be#lxc-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">This will pull in the required and recommended dependencies,
      ...
      <a class="xref" href="lxc.html.be#lxc-unpriv" title="Basic unprivileged usage">Basic unprivileged usage</a>).
      </p>
</div></div>
</div></div>
...
lxc.aa_profile = lxc-container-default-with-nesting
	...
	unprivileged container.  See <a class="xref" href="lxc.html.be#lxc-apparmor" title="Apparmor">Apparmor</a> for
	more information.
	</p></div></div>
</div></div>
</div>
...
<div class="hgroup"><h2 class="title">Сеціва</h2></div>
<div class="region"><div class="contents">
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html.be#bridging" title="Bridging">Bridging</a>).  Then, specify the host's bridge in the
...
<div class="hgroup"><h2 class="title">Бясьпека</h2></div>
<div class="region">
<div class="contents">
...
<p class="para">By default, LXC containers are started under a Apparmor policy to
      ...
      <a class="xref" href="lxc.html.be#lxc-apparmor" title="Apparmor">Apparmor</a>.  Unprivileged containers go further
