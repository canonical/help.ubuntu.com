...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.cs" title="Průvodce pro Ubuntu Server">Průvodce pro Ubuntu Server</a> » <a class="trail" href="virtualization.html.cs" title="Virtualization">Virtualization</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="lxd.html.cs" title="LXD">Předchozí</a><a class="nextlinks-next" href="cgroups.html.cs" title="Control Groups">Následující</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html.cs#lxc-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-basic-usage" title="Basic usage">Basic usage</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-global-conf" title="Global configuration">Global configuration</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-network" title="Networking">Networking</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-startup" title="LXC startup">LXC startup</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-backinstores" title="Backing Stores">Backing Stores</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-templates" title="Templates">Templates</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-autostart" title="Autostart">Autostart</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-apparmor" title="Apparmor">Apparmor</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-cgroups" title="Control Groups">Control Groups</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-cloning" title="Cloning">Cloning</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-hooks" title="Lifecycle management hooks">Lifecycle management hooks</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-consoles" title="Consoles">Consoles</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-debugging" title="Troubleshooting">Troubleshooting</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#python-lxc" title="LXC API">LXC API</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-security" title="Security">Security</a></li>
<li class="links"><a class="xref" href="lxc.html.cs#lxc-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<p class="para">This will pull in the required and recommended dependencies,
      ...
      <a class="xref" href="lxc.html.cs#lxc-unpriv" title="Basic unprivileged usage">Basic unprivileged usage</a>).
      </p>
</div></div>
</div></div>
...
lxc.aa_profile = lxc-container-default-with-nesting
	...
	unprivileged container.  See <a class="xref" href="lxc.html.cs#lxc-apparmor" title="Apparmor">Apparmor</a> for
	more information.
	</p></div></div>
</div></div>
</div>
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html.cs#bridging" title="Bridging">Bridging</a>).  Then, specify the host's bridge in the
...
<p class="para">By default, LXC containers are started under a Apparmor policy to
      ...
      <a class="xref" href="lxc.html.cs#lxc-apparmor" title="Apparmor">Apparmor</a>.  Unprivileged containers go further
