...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.el" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="virtualization.html.el" title="Εικονικοποίηση">Εικονικοποίηση</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="lxd.html.el" title="LXD">Προηγούμενο</a><a class="nextlinks-next" href="cgroups.html.el" title="Control Groups">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html.el#lxc-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-basic-usage" title="Basic usage">Basic usage</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-global-conf" title="Global configuration">Global configuration</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-network" title="Δικτύωση">Δικτύωση</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-startup" title="LXC startup">LXC startup</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-backinstores" title="Backing Stores">Backing Stores</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-templates" title="Templates">Templates</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-autostart" title="Autostart">Autostart</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-apparmor" title="Apparmor">Apparmor</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-cgroups" title="Control Groups">Control Groups</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-cloning" title="Cloning">Cloning</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-hooks" title="Lifecycle management hooks">Lifecycle management hooks</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-consoles" title="Consoles">Consoles</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-debugging" title="Επίλυση Προβλημάτων">Επίλυση Προβλημάτων</a></li>
<li class="links"><a class="xref" href="lxc.html.el#python-lxc" title="LXC API">LXC API</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-security" title="Ασφάλεια">Ασφάλεια</a></li>
<li class="links"><a class="xref" href="lxc.html.el#lxc-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">This will pull in the required and recommended dependencies,
      ...
      <a class="xref" href="lxc.html.el#lxc-unpriv" title="Basic unprivileged usage">Basic unprivileged usage</a>).
      </p>
</div></div>
</div></div>
...
lxc.aa_profile = lxc-container-default-with-nesting
	...
	unprivileged container.  See <a class="xref" href="lxc.html.el#lxc-apparmor" title="Apparmor">Apparmor</a> for
	more information.
	</p></div></div>
</div></div>
</div>
...
<div class="hgroup"><h2 class="title">Δικτύωση</h2></div>
<div class="region"><div class="contents">
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html.el#bridging" title="Γεφύρωση">Γεφύρωση</a>).  Then, specify the host's bridge in the
...
<div class="sect3 sect"><div class="inner">
<div class="hgroup"><h3 class="title">Καταγραφή</h3></div>
...
<div class="hgroup"><h2 class="title">Ασφάλεια</h2></div>
<div class="region">
<div class="contents">
...
<p class="para">By default, LXC containers are started under a Apparmor policy to
      ...
      <a class="xref" href="lxc.html.el#lxc-apparmor" title="Apparmor">Apparmor</a>.  Unprivileged containers go further
