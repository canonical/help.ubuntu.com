...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="virtualization.html.es" title="Virtualización">Virtualización</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="lxd.html.es" title="LXD">Anterior</a><a class="nextlinks-next" href="cgroups.html.es" title="Grupos de control">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html.es#lxc-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-basic-usage" title="Basic usage">Basic usage</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-global-conf" title="Global configuration">Global configuration</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-network" title="Red">Red</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-startup" title="LXC startup">LXC startup</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-backinstores" title="Backing Stores">Backing Stores</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-templates" title="Templates">Templates</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-autostart" title="Autostart">Autostart</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-apparmor" title="Apparmor">Apparmor</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-cgroups" title="Grupos de control">Grupos de control</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-cloning" title="Clonar">Clonar</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-hooks" title="Lifecycle management hooks">Lifecycle management hooks</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-consoles" title="Consolas">Consolas</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-debugging" title="Resolución de problemas">Resolución de problemas</a></li>
<li class="links"><a class="xref" href="lxc.html.es#python-lxc" title="LXC API">LXC API</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-security" title="Seguridad">Seguridad</a></li>
<li class="links"><a class="xref" href="lxc.html.es#lxc-resources" title="Recursos">Recursos</a></li>
</ul></div>
<div class="sect2 sect" id="lxc-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Instalación</h2></div>
<div class="region"><div class="contents">
<p class="para">El paquete <span class="app application">lxc</span> se puede instalar usando</p>
...
<p class="para">This will pull in the required and recommended dependencies,
      ...
      <a class="xref" href="lxc.html.es#lxc-unpriv" title="Basic unprivileged usage">Basic unprivileged usage</a>).
      </p>
</div></div>
</div></div>
...
lxc.aa_profile = lxc-container-default-with-nesting
	...
	unprivileged container.  See <a class="xref" href="lxc.html.es#lxc-apparmor" title="Apparmor">Apparmor</a> for
	more information.
	</p></div></div>
</div></div>
</div>
...
<div class="hgroup"><h2 class="title">Red</h2></div>
<div class="region"><div class="contents">
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html.es#bridging" title="Puentear (Bridging)">Puentear (Bridging)</a>).  Then, specify the host's bridge in the
...
<div class="hgroup"><h2 class="title">Grupos de control</h2></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title">Clonar</h2></div>
<div class="region">
<div class="contents">
...
<div class="hgroup"><h2 class="title">Consolas</h2></div>
<div class="region"><div class="contents">
...
<div class="sect3 sect"><div class="inner">
<div class="hgroup"><h3 class="title">Entrada</h3></div>
...
<div class="hgroup"><h2 class="title">Seguridad</h2></div>
<div class="region">
<div class="contents">
...
<p class="para">By default, LXC containers are started under a Apparmor policy to
      ...
      <a class="xref" href="lxc.html.es#lxc-apparmor" title="Apparmor">Apparmor</a>.  Unprivileged containers go further
...
<li class="list itemizedlist">
          ...
          <div class="screen"><pre class="contents "><a href="http://manpages.ubuntu.com/manpages/en/man7/capabilities.7.html" class="ulink" title="http://manpages.ubuntu.com/manpages/en/man7/capabilities.7.html">capacidades</a>
