...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.mk" title="Водич за Ubuntu Server">Водич за Ubuntu Server</a> » <a class="trail" href="virtualization.html.mk" title="Virtualization">Virtualization</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="lxd.html.mk" title="LXD">Previous</a><a class="nextlinks-next" href="cgroups.html.mk" title="Control Groups">Next</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html.mk#lxc-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-basic-usage" title="Basic usage">Basic usage</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-global-conf" title="Global configuration">Global configuration</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-network" title="Networking">Networking</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-startup" title="LXC startup">LXC startup</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-backinstores" title="Backing Stores">Backing Stores</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-templates" title="Templates">Templates</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-autostart" title="Autostart">Autostart</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-apparmor" title="Apparmor">Apparmor</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-cgroups" title="Control Groups">Control Groups</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-cloning" title="Cloning">Cloning</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-hooks" title="Lifecycle management hooks">Lifecycle management hooks</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-consoles" title="Consoles">Consoles</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-debugging" title="Troubleshooting">Troubleshooting</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#python-lxc" title="LXC API">LXC API</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-security" title="Security">Security</a></li>
<li class="links"><a class="xref" href="lxc.html.mk#lxc-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para">This will pull in the required and recommended dependencies,
      ...
      <a class="xref" href="lxc.html.mk#lxc-unpriv" title="Basic unprivileged usage">Basic unprivileged usage</a>).
      </p>
</div></div>
</div></div>
...
lxc.aa_profile = lxc-container-default-with-nesting
	...
	unprivileged container.  See <a class="xref" href="lxc.html.mk#lxc-apparmor" title="Apparmor">Apparmor</a> for
	more information.
	</p></div></div>
</div></div>
</div>
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html.mk#bridging" title="Bridging">Bridging</a>).  Then, specify the host's bridge in the
...
<p class="para">By default, LXC containers are started under a Apparmor policy to
      ...
      <a class="xref" href="lxc.html.mk#lxc-apparmor" title="Apparmor">Apparmor</a>.  Unprivileged containers go further
