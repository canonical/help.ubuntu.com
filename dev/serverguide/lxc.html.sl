...
<a class="nextlinks-prev" href="lxd.html.sl" title="LXD">Nazaj</a><a class="nextlinks-next" href="cgroups.html.sl" title="Control Groups">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="lxc.html.sl#lxc-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-basic-usage" title="Basic usage">Basic usage</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-global-conf" title="Global configuration">Global configuration</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-network" title="Networking">Networking</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-startup" title="LXC startup">LXC startup</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-backinstores" title="Backing Stores">Backing Stores</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-templates" title="Templates">Templates</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-autostart" title="Autostart">Autostart</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-apparmor" title="Apparmor">Apparmor</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-cgroups" title="Control Groups">Control Groups</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-cloning" title="Cloning">Cloning</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-hooks" title="Lifecycle management hooks">Lifecycle management hooks</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-consoles" title="Consoles">Consoles</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-debugging" title="Odpravljanje napak">Odpravljanje napak</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#python-lxc" title="LXC API">LXC API</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-security" title="Varnost">Varnost</a></li>
<li class="links"><a class="xref" href="lxc.html.sl#lxc-resources" title="Viri">Viri</a></li>
</ul></div>
...
<p class="para">This will pull in the required and recommended dependencies,
      ...
      <a class="xref" href="lxc.html.sl#lxc-unpriv" title="Basic unprivileged usage">Basic unprivileged usage</a>).
      </p>
</div></div>
</div></div>
...
lxc.aa_profile = lxc-container-default-with-nesting
	...
	unprivileged container.  See <a class="xref" href="lxc.html.sl#lxc-apparmor" title="Apparmor">Apparmor</a> for
	more information.
	</p></div></div>
</div></div>
</div>
...
<div class="screen"><pre class="contents "> iptables -t nat -A PREROUTING -p tcp -i eth0 --dport 587 -j DNAT \
 	--to-destination 10.0.3.100:587
      ...
      <a class="xref" href="network-configuration.html.sl#bridging" title="Bridging">Bridging</a>).  Then, specify the host's bridge in the
...
<div class="hgroup"><h2 class="title">Varnost</h2></div>
<div class="region">
<div class="contents">
...
<p class="para">By default, LXC containers are started under a Apparmor policy to
      ...
      <a class="xref" href="lxc.html.sl#lxc-apparmor" title="Apparmor">Apparmor</a>.  Unprivileged containers go further
