...
<a class="nextlinks-prev" href="ubuntucloud.html.be" title="Ubuntu Cloud">Назад</a><a class="nextlinks-next" href="lxc.html.be" title="LXC">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="lxd.html.be#lxd-resources" title="Online Resources">Online Resources</a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-kernel-prep" title=" Kernel preparation "> Kernel preparation </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-first-container" title=" Creating your first container "> Creating your first container </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-server-config" title=" LXD Server Configuration "> LXD Server Configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-container-config" title=" Container configuration "> Container configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-profiles" title="Профілі">Профілі</a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-nesting" title=" Nesting "> Nesting </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-limits" title=" Limits "> Limits </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-uid" title=" UID mappings and Privileged containers "> UID mappings and Privileged containers </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-aa" title=" Apparmor "> Apparmor </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-seccomp" title=" Seccomp "> Seccomp </a></li>
<li class="links"><a class="xref" href="lxd.html.be" title=" Raw LXC configuration "> Raw LXC configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.be" title=" Images and containers "> Images and containers </a></li>
<li class="links"><a class="xref" href="lxd.html.be#lxd-troubleshooting" title=" Troubleshooting "> Troubleshooting </a></li>
</ul></div>
...
<div class="hgroup"><h2 class="title">Профілі</h2></div>
<div class="region"><div class="contents">
<p class="para">
