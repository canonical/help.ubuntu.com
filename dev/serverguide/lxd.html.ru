...
<a class="nextlinks-prev" href="ubuntucloud.html.ru" title="Облако Ubuntu">Назад</a><a class="nextlinks-next" href="lxc.html.ru" title="LXC">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="lxd.html.ru#lxd-resources" title="Интернет-ресурсы">Интернет-ресурсы</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-kernel-prep" title="Подготовка ядра">Подготовка ядра</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-first-container" title="Создание вашего первого контейнера">Создание вашего первого контейнера</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-server-config" title=" LXD Server Configuration "> LXD Server Configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-container-config" title=" Container configuration "> Container configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-profiles" title="Профили">Профили</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-nesting" title="Вложенность">Вложенность</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-limits" title=" Limits "> Limits </a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-uid" title=" UID mappings and Privileged containers "> UID mappings and Privileged containers </a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-aa" title="Apparmor">Apparmor</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-seccomp" title="Seccomp">Seccomp</a></li>
<li class="links"><a class="xref" href="lxd.html.ru" title=" Raw LXC configuration "> Raw LXC configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.ru" title="Образы и контейнеры">Образы и контейнеры</a></li>
<li class="links"><a class="xref" href="lxd.html.ru#lxd-troubleshooting" title="Устранение проблем">Устранение проблем</a></li>
</ul></div>
<div class="sect2 sect" id="lxd-resources"><div class="inner">
<div class="hgroup"><h2 class="title">Интернет-ресурсы</h2></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt install lxd</span>
</pre></div>
<p class="para">Эта команда установит LXD вместе с рекомендуемыми зависимостями, включая библиотеку LXC и lxcfs.</p>
</div></div>
</div></div>
<div class="sect2 sect" id="lxd-kernel-prep"><div class="inner">
<div class="hgroup"><h2 class="title">Подготовка ядра</h2></div>
...
<p class="para">Выполнять 'lxd init' необходимо от имени root. Команды 'lxc' могут быть запущены от имени любого пользователя, являющегося членом группы lxd. Если пользователь joe не входит в группу 'lxd', можно выполнить:</p>
<div class="screen"><pre class="contents "><span class="cmd command">adduser joe lxd</span>
</pre></div>
<p class="para">от имени root для включения его в группу. Это изменение вступит силу при следующем входе в систему или после выполнения 'newgrp lxd' в текущем сеансе.</p>
<p class="para">
...
<div class="hgroup"><h2 class="title">Создание вашего первого контейнера</h2></div>
<div class="region">
<div class="contents"><p class="para">
      This section will describe the simplest container tasks.
      </p></div>
<div class="sect3 sect"><div class="inner">
<div class="hgroup"><h3 class="title">Создание контейнера</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Команда для создания и запуска контейнера:</p>
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc image list ubuntu:</span>
</pre></div>
<p class="para">
        To see more information about a particular image, including all the aliases it
        is known by, you can use:
      </p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc image info ubuntu:xenial</span>
</pre></div>
<p class="para">В общем случае вы можете указать образ Ubuntu, используя кодовое название выпуска ('xenial') или номер версии (16.04). В дополнение, 'lts' является псевдонимом для последнего поддерживаемого LTS-выпуска. Для выбора другой архитектуры можете указать необходимую:</p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc image info ubuntu:lts/arm64</span>
</pre></div>
<p class="para">Теперь запустим наш первый контейнер:</p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc launch ubuntu:xenial x1</span>
</pre></div>
<p class="para">Эта команда загрузить текущий официальный облачный образ Xenial для вашей текущей архитектуры, создаст на его основе контейнер и, наконец, запустит его. Когда выполнение команды завершится, вы сможете увидеть контейнер, используя:</p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc list lxc info x1</span>
</pre></div>
<p class="para">и открыть в нём командную оболочку с помощью:</p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc exec x1 bash</span>
</pre></div>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc list</span>
</pre></div>
<p class="para">Эта команда создаёт ваш клиентский сертификат и обращается к серверу LXD за списком контейнеров. Чтобы сделать сервер доступным по сети, можете настроить порт http с помощью:</p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc config set core.https_address :8443</span>
</pre></div>
<p class="para">
...
<div class="sect3 sect"><div class="inner">
<div class="hgroup"><h3 class="title">Аутентификация</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc remote add r1 r1.example.com:8443</span>
</pre></div>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc config trust add r1 certfile.crt</span>
</pre></div>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc config device add c1 opt disk source=/opt path=opt</span>
</pre></div>
<p class="para">
        See:
      </p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc help config</span>
</pre></div>
<p class="para">
        for more information about editing container configurations.  You may
        also use:
      </p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc config edit c1</span>
</pre></div>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc config device add c1 eth1 none</span>
</pre></div>
</div></div>
</div></div>
<div class="sect2 sect" id="lxd-nesting"><div class="inner">
<div class="hgroup"><h2 class="title">Вложенность</h2></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="sect2 sect"><div class="inner">
<div class="hgroup"><h2 class="title">Образы и контейнеры</h2></div>
<div class="region">
<div class="contents">
<p class="para">
...
<p class="para">Для просмотра образов, доступных на одном из этих серверов, можно использовать:</p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc image list ubuntu:</span>
</pre></div>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc move c1 final-beta</span>
</pre></div>
<p class="para">
...
<div class="sect3 sect"><div class="inner">
<div class="hgroup"><h3 class="title">Экспорт и импорт образов</h3></div>
<div class="region"><div class="contents">
<p class="para">
          Image can be exported as, and imported from, tarballs:
        </p>
<div class="screen"><pre class="contents "><span class="cmd command">lxc image export foo-2.0 foo-2.0.tar.gz lxc image import foo-2.0.tar.gz --alias foo-2.0 --public</span>
</pre></div>
</div></div>
</div></div>
</div>
...
<div class="screen"><pre class="contents "><span class="cmd command">journalctl -u LXD</span>
</pre></div>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">lxc info c1 --show-log</span>
</pre></div>
<p class="para">
