...
<a class="nextlinks-prev" href="ubuntucloud.html.sl" title="Ubuntu Cloud">Nazaj</a><a class="nextlinks-next" href="lxc.html.sl" title="LXC">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="lxd.html.sl#lxd-resources" title="Online Resources">Online Resources</a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-kernel-prep" title=" Kernel preparation "> Kernel preparation </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-first-container" title=" Creating your first container "> Creating your first container </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-server-config" title=" LXD Server Configuration "> LXD Server Configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-container-config" title=" Container configuration "> Container configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-profiles" title="Profili">Profili</a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-nesting" title=" Nesting "> Nesting </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-limits" title=" Limits "> Limits </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-uid" title=" UID mappings and Privileged containers "> UID mappings and Privileged containers </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-aa" title=" Apparmor "> Apparmor </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-seccomp" title=" Seccomp "> Seccomp </a></li>
<li class="links"><a class="xref" href="lxd.html.sl" title=" Raw LXC configuration "> Raw LXC configuration </a></li>
<li class="links"><a class="xref" href="lxd.html.sl" title=" Images and containers "> Images and containers </a></li>
<li class="links"><a class="xref" href="lxd.html.sl#lxd-troubleshooting" title="Odpravljanje napak">Odpravljanje napak</a></li>
</ul></div>
...
<div class="hgroup"><h2 class="title">Profili</h2></div>
<div class="region"><div class="contents">
<p class="para">
