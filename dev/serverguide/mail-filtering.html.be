...
<a class="nextlinks-prev" href="mailman.html.be" title="Mailman">Назад</a><a class="nextlinks-next" href="chat-servers.html.be" title="Chat Applications">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html.be#mail-filter-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.be#mail-filter-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.be#mail-filter-testing" title="Праверка">Праверка</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.be#mail-filter-troubleshooting" title="Troubleshooting">Troubleshooting</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.be#mail-filter-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
<div class="sect2 sect" id="mail-filter-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Усталёўка</h2></div>
<div class="region"><div class="contents">
<p class="para">
	   See <a class="xref" href="postfix.html.be" title="Postfix">Postfix</a> for instructions on installing and configuring Postfix.
	   </p>
<p class="para">
...
<li class="list itemizedlist">
	       ...
	       For instructions on <span class="app application">Postfix</span> logging see the 
               <a class="xref" href="postfix.html.be#postfix-troubleshooting" title="Troubleshooting">Troubleshooting</a> section.
	       </p>
	     </li>
<li class="list itemizedlist">
	       <p class="para">
...
<li class="list itemizedlist">
	       <p class="para">
               <a href="http://sourceforge.net/apps/trac/pyzor/" class="ulink" title="http://sourceforge.net/apps/trac/pyzor/">Хатняя старонка Pyzor</a>
	       </p>
	       </li>
<li class="list itemizedlist">
	       <p class="para">
               <a href="http://razor.sourceforge.net/" class="ulink" title="http://razor.sourceforge.net/">Хатняя старонка Razor</a>
  	       </p>
	     </li>
<li class="list itemizedlist">
	       <p class="para">
