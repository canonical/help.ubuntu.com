...
<a class="nextlinks-prev" href="mailman.html.cs" title="Mailman">Předchozí</a><a class="nextlinks-next" href="chat-servers.html.cs" title="Chat Applications">Následující</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html.cs#mail-filter-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.cs#mail-filter-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.cs#mail-filter-testing" title="Testing">Testing</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.cs#mail-filter-troubleshooting" title="Troubleshooting">Troubleshooting</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.cs#mail-filter-references" title="References">References</a></li>
</ul></div>
<div class="sect2 sect" id="mail-filter-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Instalace</h2></div>
<div class="region"><div class="contents">
<p class="para">
	   See <a class="xref" href="postfix.html.cs" title="Postfix">Postfix</a> for instructions on installing and configuring Postfix.
	   </p>
<p class="para">
...
<li class="list itemizedlist">
	       ...
	       For instructions on <span class="app application">Postfix</span> logging see the 
               <a class="xref" href="postfix.html.cs#postfix-troubleshooting" title="Troubleshooting">Troubleshooting</a> section.
	       </p>
	     </li>
<li class="list itemizedlist">
	       <p class="para">
