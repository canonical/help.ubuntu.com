...
<a class="nextlinks-prev" href="mailman.html.el" title="Mailman">Προηγούμενο</a><a class="nextlinks-next" href="chat-servers.html.el" title="Εφαρμογές συζήτησης">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html.el#mail-filter-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.el#mail-filter-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.el#mail-filter-testing" title="Δοκιμή">Δοκιμή</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.el#mail-filter-troubleshooting" title="Επίλυση Προβλημάτων">Επίλυση Προβλημάτων</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.el#mail-filter-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<p class="para">Δείτε το <a class="xref" href="postfix.html.el" title="Postfix">Postfix</a> για οδηγίες εγκατάστασης και ρύθμισης του Postfix.</p>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
	       <p class="para">Για πληροφορίες σχετικά με τις καταγραφές του <span class="app application">Postfix</span> δείτε την ενότητα <a class="xref" href="postfix.html.el#postfix-troubleshooting" title="Επίλυση Προβλημάτων">Επίλυση Προβλημάτων</a>.</p>
	     </li>
<li class="list itemizedlist">
