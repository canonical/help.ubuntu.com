...
<a class="nextlinks-prev" href="mailman.html.es" title="Mailman">Anterior</a><a class="nextlinks-next" href="chat-servers.html.es" title="Aplicaciones de charla">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html.es#mail-filter-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.es#mail-filter-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.es#mail-filter-testing" title="Comprobando">Comprobando</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.es#mail-filter-troubleshooting" title="Resolución de problemas">Resolución de problemas</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.es#mail-filter-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<p class="para">Vea <a class="xref" href="postfix.html.es" title="Postfix">Postfix</a> para conocer instrucciones sobre como instalar y configurar Postfix.</p>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
	       <p class="para">Para instrucciones sobre la entrada en <span class="app application">Postfix</span> vea la sección <a class="xref" href="postfix.html.es#postfix-troubleshooting" title="Resolución de problemas">Resolución de problemas</a>.</p>
	     </li>
<li class="list itemizedlist">
