...
<a class="nextlinks-prev" href="mailman.html.mk" title="Mailman">Previous</a><a class="nextlinks-next" href="chat-servers.html.mk" title="Chat Applications">Next</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html.mk#mail-filter-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.mk#mail-filter-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.mk#mail-filter-testing" title="Testing">Testing</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.mk#mail-filter-troubleshooting" title="Troubleshooting">Troubleshooting</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.mk#mail-filter-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
	   See <a class="xref" href="postfix.html.mk" title="Postfix">Postfix</a> for instructions on installing and configuring Postfix.
	   </p>
<p class="para">
...
<li class="list itemizedlist">
	       ...
	       For instructions on <span class="app application">Postfix</span> logging see the 
               <a class="xref" href="postfix.html.mk#postfix-troubleshooting" title="Troubleshooting">Troubleshooting</a> section.
	       </p>
	     </li>
<li class="list itemizedlist">
	       <p class="para">
