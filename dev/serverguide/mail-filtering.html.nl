...
<a class="nextlinks-prev" href="mailman.html.nl" title="Mailman">Vorige</a><a class="nextlinks-next" href="chat-servers.html.nl" title="Chat Applications">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html.nl#mail-filter-installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.nl#mail-filter-configuration" title="Configuratie">Configuratie</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.nl#mail-filter-testing" title="Testing">Testing</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.nl#mail-filter-troubleshooting" title="Troubleshooting">Troubleshooting</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.nl#mail-filter-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
	   See <a class="xref" href="postfix.html.nl" title="Postfix">Postfix</a> for instructions on installing and configuring Postfix.
	   </p>
<p class="para">
...
<li class="list itemizedlist">
	       ...
	       For instructions on <span class="app application">Postfix</span> logging see the 
               <a class="xref" href="postfix.html.nl#postfix-troubleshooting" title="Troubleshooting">Troubleshooting</a> section.
	       </p>
	     </li>
<li class="list itemizedlist">
	       <p class="para">
