...
<a class="nextlinks-prev" href="mailman.html.sl" title="Mailman">Nazaj</a><a class="nextlinks-next" href="chat-servers.html.sl" title="Chat Applications">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html.sl#mail-filter-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.sl#mail-filter-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.sl#mail-filter-testing" title="Preizkušanje">Preizkušanje</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.sl#mail-filter-troubleshooting" title="Odpravljanje napak">Odpravljanje napak</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.sl#mail-filter-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="mail-filter-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Namestitev</h2></div>
<div class="region"><div class="contents">
<p class="para">
	   See <a class="xref" href="postfix.html.sl" title="Postfix">Postfix</a> for instructions on installing and configuring Postfix.
	   </p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Amavisd-new in Spamassassin</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="list itemizedlist">
	       ...
	       For instructions on <span class="app application">Postfix</span> logging see the 
               <a class="xref" href="postfix.html.sl#postfix-troubleshooting" title="Odpravljanje napak">Odpravljanje napak</a> section.
	       </p>
	     </li>
<li class="list itemizedlist">
	       <p class="para">
