...
<a class="nextlinks-prev" href="mailman.html.ur" title="Mailman">Previous</a><a class="nextlinks-next" href="chat-servers.html.ur" title="Chat Applications">Next</a>
</div>
...
<li class="links"><a class="xref" href="mail-filtering.html.ur#mail-filter-installation" title="Installation">Installation</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.ur#mail-filter-configuration" title="Configuration">Configuration</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.ur#mail-filter-testing" title="Testing">Testing</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.ur#mail-filter-troubleshooting" title="Troubleshooting">Troubleshooting</a></li>
<li class="links"><a class="xref" href="mail-filtering.html.ur#mail-filter-references" title="References">References</a></li>
</ul></div>
<div class="sect2 sect" id="mail-filter-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Installation</h2></div>
<div class="region"><div class="contents">
<p class="para">
	   See <a class="xref" href="postfix.html.ur" title="Postfix">Postfix</a> for instructions on installing and configuring Postfix.
	   </p>
<p class="para">
...
<li class="list itemizedlist">
	       ...
	       For instructions on <span class="app application">Postfix</span> logging see the 
               <a class="xref" href="postfix.html.ur#postfix-troubleshooting" title="Troubleshooting">Troubleshooting</a> section.
	       </p>
	     </li>
<li class="list itemizedlist">
	       <p class="para">
