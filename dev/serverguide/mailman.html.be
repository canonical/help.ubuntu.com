...
<a class="nextlinks-prev" href="dovecot-server.html.be" title="Сэрвер Dovecot">Назад</a><a class="nextlinks-next" href="mail-filtering.html.be" title="Mail Filtering">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="mailman.html.be#mailman-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="mailman.html.be#mailman-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="mailman.html.be#mailman-admin" title="Administration">Administration</a></li>
<li class="links"><a class="xref" href="mailman.html.be#mailman-users" title="Карыстальнікі">Карыстальнікі</a></li>
<li class="links"><a class="xref" href="mailman.html.be#mailman-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">
                To install apache2 you refer to <a class="xref" href="httpd.html.be#http-installation" title="Усталёўка">Усталёўка</a> for details.
              </p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-postfix"><div class="inner">
<div class="hgroup"><h3 class="title">Postfix</h3></div>
<div class="region"><div class="contents"><p class="para">
	    For instructions on installing and configuring Postfix refer to <a class="xref" href="postfix.html.be" title="Postfix">Postfix</a>
	    </p></div></div>
</div></div>
...
<p class="para">
              To install Exim4 refer to <a class="xref" href="exim4.html.be" title="Exim4">Exim4</a>.
	      </p>
<p class="para">
...
<div class="region"><div class="contents">
<p class="para">Каб устанавіць <span class="app application">Mailman</span>, увядзіце наступны загад у тэрмінале:</p>
...
<p class="para">Перазапусьціце Postfix каб ужыць новыя наладкі:</p>
...
<div class="hgroup"><h2 class="title">Карыстальнікі</h2></div>
<div class="region"><div class="contents">
<p class="para">
