...
<a class="nextlinks-prev" href="dovecot-server.html.cs" title="Dovecot Server">Předchozí</a><a class="nextlinks-next" href="mail-filtering.html.cs" title="Mail Filtering">Následující</a>
</div>
...
<li class="links"><a class="xref" href="mailman.html.cs#mailman-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="mailman.html.cs#mailman-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="mailman.html.cs#mailman-admin" title="Administration">Administration</a></li>
<li class="links"><a class="xref" href="mailman.html.cs#mailman-users" title="Users">Users</a></li>
<li class="links"><a class="xref" href="mailman.html.cs#mailman-references" title="References">References</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">
                To install apache2 you refer to <a class="xref" href="httpd.html.cs#http-installation" title="Instalace">Instalace</a> for details.
              </p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-postfix"><div class="inner">
<div class="hgroup"><h3 class="title">Postfix</h3></div>
<div class="region"><div class="contents"><p class="para">
	    For instructions on installing and configuring Postfix refer to <a class="xref" href="postfix.html.cs" title="Postfix">Postfix</a>
	    </p></div></div>
</div></div>
...
<p class="para">
              To install Exim4 refer to <a class="xref" href="exim4.html.cs" title="Exim4">Exim4</a>.
	      </p>
<p class="para">
