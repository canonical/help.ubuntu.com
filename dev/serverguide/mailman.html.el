...
<a class="nextlinks-prev" href="dovecot-server.html.el" title="Εξυπηρετητής Dovecot">Προηγούμενο</a><a class="nextlinks-next" href="mail-filtering.html.el" title="Φίλτρα ηλ. αλληλογραφίας">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="mailman.html.el#mailman-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="mailman.html.el#mailman-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="mailman.html.el#mailman-admin" title="Διαχείριση">Διαχείριση</a></li>
<li class="links"><a class="xref" href="mailman.html.el#mailman-users" title="Χρήστες">Χρήστες</a></li>
<li class="links"><a class="xref" href="mailman.html.el#mailman-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">
                To install apache2 you refer to <a class="xref" href="httpd.html.el#http-installation" title="Εγκατάσταση">Εγκατάσταση</a> for details.
              </p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-postfix"><div class="inner">
<div class="hgroup"><h3 class="title">Postfix</h3></div>
<div class="region"><div class="contents"><p class="para">Για οδηγίες σχετικά με την εγκατάσταση και ρύθμιση του Postfix δείτε το <a class="xref" href="postfix.html.el" title="Postfix">Postfix</a></p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-exim4"><div class="inner">
<div class="hgroup"><h3 class="title">Exim4</h3></div>
<div class="region"><div class="contents">
<p class="para">Για την εγκατάσταση του Exim4 δείτε το <a class="xref" href="exim4.html.el" title="Exim4">Exim4</a>.</p>
<p class="para">
