...
<a class="nextlinks-prev" href="dovecot-server.html.mk" title="Dovecot Server">Previous</a><a class="nextlinks-next" href="mail-filtering.html.mk" title="Mail Filtering">Next</a>
</div>
...
<li class="links"><a class="xref" href="mailman.html.mk#mailman-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="mailman.html.mk#mailman-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="mailman.html.mk#mailman-admin" title="Administration">Administration</a></li>
<li class="links"><a class="xref" href="mailman.html.mk#mailman-users" title="Users">Users</a></li>
<li class="links"><a class="xref" href="mailman.html.mk#mailman-references" title="References">References</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">
                To install apache2 you refer to <a class="xref" href="httpd.html.mk#http-installation" title="Инсталација">Инсталација</a> for details.
              </p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-postfix"><div class="inner">
<div class="hgroup"><h3 class="title">Postfix</h3></div>
<div class="region"><div class="contents"><p class="para">
	    For instructions on installing and configuring Postfix refer to <a class="xref" href="postfix.html.mk" title="Postfix">Postfix</a>
	    </p></div></div>
</div></div>
...
<p class="para">
              To install Exim4 refer to <a class="xref" href="exim4.html.mk" title="Exim4">Exim4</a>.
	      </p>
<p class="para">
