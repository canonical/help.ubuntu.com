...
<a class="nextlinks-prev" href="dovecot-server.html.nl" title="Dovecot Server">Vorige</a><a class="nextlinks-next" href="mail-filtering.html.nl" title="Mail Filtering">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="mailman.html.nl#mailman-installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="mailman.html.nl#mailman-configuration" title="Configuratie">Configuratie</a></li>
<li class="links"><a class="xref" href="mailman.html.nl#mailman-admin" title="Administration">Administration</a></li>
<li class="links"><a class="xref" href="mailman.html.nl#mailman-users" title="Users">Users</a></li>
<li class="links"><a class="xref" href="mailman.html.nl#mailman-references" title="References">References</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">
                To install apache2 you refer to <a class="xref" href="httpd.html.nl#http-installation" title="Installatie">Installatie</a> for details.
              </p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-postfix"><div class="inner">
<div class="hgroup"><h3 class="title">Postfix</h3></div>
<div class="region"><div class="contents"><p class="para">
	    For instructions on installing and configuring Postfix refer to <a class="xref" href="postfix.html.nl" title="Postfix">Postfix</a>
	    </p></div></div>
</div></div>
...
<p class="para">
              To install Exim4 refer to <a class="xref" href="exim4.html.nl" title="Exim4">Exim4</a>.
	      </p>
<p class="para">
