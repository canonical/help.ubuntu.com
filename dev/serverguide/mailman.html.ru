...
<a class="nextlinks-prev" href="dovecot-server.html.ru" title="Dovecot Server">Назад</a><a class="nextlinks-next" href="mail-filtering.html.ru" title="Фильтрация почты">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="mailman.html.ru#mailman-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="mailman.html.ru#mailman-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="mailman.html.ru#mailman-admin" title="Администрирование">Администрирование</a></li>
<li class="links"><a class="xref" href="mailman.html.ru#mailman-users" title="Пользователи">Пользователи</a></li>
<li class="links"><a class="xref" href="mailman.html.ru#mailman-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">Чтобы установить apache2, обратитесь к соответствующему разделу <a class="xref" href="httpd.html.ru#http-installation" title="Установка">Установка</a>.</p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-postfix"><div class="inner">
<div class="hgroup"><h3 class="title">Postfix</h3></div>
<div class="region"><div class="contents"><p class="para">Для инструкций по установке и настройке Postfix смотрите раздел <a class="xref" href="postfix.html.ru" title="Postfix">Postfix</a></p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-exim4"><div class="inner">
<div class="hgroup"><h3 class="title">Exim4</h3></div>
<div class="region"><div class="contents">
<p class="para">Для установки Exim4 обратитесь к разделу <a class="xref" href="exim4.html.ru" title="Exim4">Exim4</a>.</p>
