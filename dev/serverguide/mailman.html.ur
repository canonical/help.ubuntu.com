...
<a class="nextlinks-prev" href="dovecot-server.html.ur" title="Dovecot Server">Previous</a><a class="nextlinks-next" href="mail-filtering.html.ur" title="Mail Filtering">Next</a>
</div>
...
<li class="links"><a class="xref" href="mailman.html.ur#mailman-installation" title="Installation">Installation</a></li>
<li class="links"><a class="xref" href="mailman.html.ur#mailman-configuration" title="Configuration">Configuration</a></li>
<li class="links"><a class="xref" href="mailman.html.ur#mailman-admin" title="Administration">Administration</a></li>
<li class="links"><a class="xref" href="mailman.html.ur#mailman-users" title="Users">Users</a></li>
<li class="links"><a class="xref" href="mailman.html.ur#mailman-references" title="References">References</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">
                To install apache2 you refer to <a class="xref" href="httpd.html.ur#http-installation" title="Installation">Installation</a> for details.
              </p></div></div>
</div></div>
<div class="sect3 sect" id="mailman-postfix"><div class="inner">
<div class="hgroup"><h3 class="title">Postfix</h3></div>
<div class="region"><div class="contents"><p class="para">
	    For instructions on installing and configuring Postfix refer to <a class="xref" href="postfix.html.ur" title="Postfix">Postfix</a>
	    </p></div></div>
</div></div>
...
<p class="para">
              To install Exim4 refer to <a class="xref" href="exim4.html.ur" title="Exim4">Exim4</a>.
	      </p>
<p class="para">
