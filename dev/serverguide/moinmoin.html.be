...
<a class="nextlinks-prev" href="lamp-overview.html.be" title="Overview">Назад</a><a class="nextlinks-next" href="phpmyadmin.html.be" title="phpMyAdmin">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="moinmoin.html.be#moinmoin-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="moinmoin.html.be#moinmoin-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="moinmoin.html.be#moinmoin-verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="moinmoin.html.be#moinmoin-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
<div class="sect2 sect" id="moinmoin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Усталёўка</h2></div>
<div class="region"><div class="contents">
<p class="para">Каб устанавіць <span class="app application">MoinMoin</span>, увядзіце наступны загад у тэрмінале:</p>
...
<p class="para">
       ...
       server, please refer to <a class="xref" href="httpd.html.be#http-installation" title="Усталёўка">Усталёўка</a>
       sub-section in <a class="xref" href="httpd.html.be" title="HTTPD - Apache2 Вэб сэрвер">HTTPD - Apache2 Вэб сэрвер</a> section.
       </p>
</div></div>
</div></div>
...
<li class="list itemizedlist">
        <p class="para">
        For more information see the <a href="http://moinmo.in/" class="ulink" title="http://moinmo.in/">moinmoin Wiki</a>.
        </p>
      </li>
<li class="list itemizedlist">
        <p class="para">
