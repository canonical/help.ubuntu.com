...
<a class="nextlinks-prev" href="lamp-overview.html.cs" title="Overview">Předchozí</a><a class="nextlinks-next" href="phpmyadmin.html.cs" title="phpMyAdmin">Následující</a>
</div>
...
<li class="links"><a class="xref" href="moinmoin.html.cs#moinmoin-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="moinmoin.html.cs#moinmoin-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="moinmoin.html.cs#moinmoin-verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="moinmoin.html.cs#moinmoin-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
       ...
       server, please refer to <a class="xref" href="httpd.html.cs#http-installation" title="Instalace">Instalace</a>
       sub-section in <a class="xref" href="httpd.html.cs" title="HTTPD - Apache2 Web Server">HTTPD - Apache2 Web Server</a> section.
       </p>
</div></div>
</div></div>
