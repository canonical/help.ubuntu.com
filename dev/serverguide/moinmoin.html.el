...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.el" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="lamp-applications.html.el" title="Εφαρμογές LAMP">Εφαρμογές LAMP</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="lamp-overview.html.el" title="Επισκόπηση">Προηγούμενο</a><a class="nextlinks-next" href="phpmyadmin.html.el" title="phpMyAdmin">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="moinmoin.html.el#moinmoin-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="moinmoin.html.el#moinmoin-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="moinmoin.html.el#moinmoin-verification" title="Έλεγχος">Έλεγχος</a></li>
<li class="links"><a class="xref" href="moinmoin.html.el#moinmoin-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
<div class="sect2 sect" id="moinmoin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Εγκατάσταση</h2></div>
<div class="region"><div class="contents">
<p class="para">Για να εγκαταστήσετε το <span class="app application">MoinMoin</span>, εκτελέστε την ακόλουθη εντολή στη γραμμή εντολών:</p>
...
<p class="para">
       ...
       server, please refer to <a class="xref" href="httpd.html.el#http-installation" title="Εγκατάσταση">Εγκατάσταση</a>
       sub-section in <a class="xref" href="httpd.html.el" title="HTTPD - Apache2 Διακομιστής Ιστού">HTTPD - Apache2 Διακομιστής Ιστού</a> section.
       </p>
</div></div>
</div></div>
...
<p class="para">Επίσης, κάτω από την επιλογή <span class="em emphasis">data_dir</span> προσθέστε το <span class="em emphasis">data_underlay_dir</span>:</p>
...
<div class="hgroup"><h2 class="title">Έλεγχος</h2></div>
<div class="region"><div class="contents">
<p class="para">Μπορείτε να ελέγξετε την εφαρμογή Wiki και να δείτε αν λειτουργεί πηγαίνοντας με το πρόγραμμα περιήγησής σας στο παρακάτω URL:</p>
<div class="code"><pre class="contents ">http://localhost/mywiki
</pre></div>
<p class="para">Για περισσότερες πληροφορίες παρακαλούμε επισκεφθείτε τον ιστότοπο του <a href="http://moinmo.in/" class="ulink" title="http://moinmo.in/">MoinMoin</a>.</p>
</div></div>
</div></div>
...
<li class="list itemizedlist">
        <p class="para">Για περισσότερες πληροφορίες δείτε το <a href="http://moinmo.in/" class="ulink" title="http://moinmo.in/">Wiki του moinmoin</a>.</p>
      </li>
<li class="list itemizedlist">
        <p class="para">
