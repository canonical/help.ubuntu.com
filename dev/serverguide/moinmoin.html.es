...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="lamp-applications.html.es" title="Aplicaciones LAMP">Aplicaciones LAMP</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="lamp-overview.html.es" title="Vista general">Anterior</a><a class="nextlinks-next" href="phpmyadmin.html.es" title="phpMyAdmin">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="moinmoin.html.es#moinmoin-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="moinmoin.html.es#moinmoin-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="moinmoin.html.es#moinmoin-verification" title="Verificación">Verificación</a></li>
<li class="links"><a class="xref" href="moinmoin.html.es#moinmoin-references" title="Referencias">Referencias</a></li>
</ul></div>
<div class="sect2 sect" id="moinmoin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Instalación</h2></div>
<div class="region"><div class="contents">
<p class="para">Para instalar <span class="app application">MoinMoin</span>, ejecute el siguiente comando:</p>
...
<p class="para">
       ...
       server, please refer to <a class="xref" href="httpd.html.es#http-installation" title="Instalación">Instalación</a>
       sub-section in <a class="xref" href="httpd.html.es" title="HTTPD - Servidor web Apache2">HTTPD - Servidor web Apache2</a> section.
       </p>
</div></div>
</div></div>
...
<p class="para">También, debajo de la opción <span class="em emphasis">data_dir</span> añada el <span class="em emphasis">data_underlay_dir</span>:</p>
...
<div class="hgroup"><h2 class="title">Verificación</h2></div>
<div class="region"><div class="contents">
<p class="para">Puede verificar la aplicación Wiki y ver si funciona correctamente accediendo desde su navegador web a la siguiente URL:</p>
<div class="code"><pre class="contents ">http://localhost/mywiki
</pre></div>
<p class="para">Para más detalles consulte el sitio web de <a href="http://moinmo.in/" class="ulink" title="http://moinmo.in/">MoinMoin</a>.</p>
</div></div>
</div></div>
...
<li class="list itemizedlist">
        <p class="para">Para más información vea <a href="http://moinmo.in/" class="ulink" title="http://moinmo.in/">el Wiki de moinmoin</a>.</p>
      </li>
<li class="list itemizedlist">
        <p class="para">También vea la página <a href="https://help.ubuntu.com/community/MoinMoin" class="ulink" title="https://help.ubuntu.com/community/MoinMoin">Ubuntu Wiki MoinMoin</a>.</p>
      </li>
</ul></div></div></div>
</div></div>
</div>
