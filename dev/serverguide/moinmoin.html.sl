...
<a class="nextlinks-prev" href="lamp-overview.html.sl" title="Pregled">Nazaj</a><a class="nextlinks-next" href="phpmyadmin.html.sl" title="phpMyAdmin">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="moinmoin.html.sl#moinmoin-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="moinmoin.html.sl#moinmoin-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="moinmoin.html.sl#moinmoin-verification" title="Verification">Verification</a></li>
<li class="links"><a class="xref" href="moinmoin.html.sl#moinmoin-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="moinmoin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Namestitev</h2></div>
<div class="region"><div class="contents">
<p class="para">
      To install <span class="app application">MoinMoin</span>, run the following
...
<p class="para">
       ...
       server, please refer to <a class="xref" href="httpd.html.sl#http-installation" title="Namestitev">Namestitev</a>
       sub-section in <a class="xref" href="httpd.html.sl" title="HTTPD - spletni strežnik Apache2">HTTPD - spletni strežnik Apache2</a> section.
       </p>
</div></div>
</div></div>
...
<span class="cmd command">sudo mkdir moj-wiki</span>
<span class="cmd command">sudo cp -R data moj-wiki</span>
<span class="cmd command">sudo cp -R underlay moj-wiki</span>
<span class="cmd command">sudo cp server/moin.cgi moj-wiki</span>
<span class="cmd command">sudo chown -R www-data:www-data mywiki</span>
<span class="cmd command">sudo chmod -R ug+rwX moj-wiki</span>
<span class="cmd command">sudo chmod -R o-rwx moj-wiki</span>
</pre></div>
<p class="para">
...
<div class="code"><pre class="contents ">data_dir = '/org/moj-wiki/data'</pre></div>
<p class="para">
       to
       </p>
<div class="code"><pre class="contents ">data_dir = '/usr/share/moin/moj-wiki/data'</pre></div>
<p class="para">
       Also, below the <span class="em emphasis">data_dir</span> option add the <span class="em emphasis">data_underlay_dir</span>:
       </p>
<div class="code"><pre class="contents ">data_underlay_dir='/usr/share/moin/moj-wiki/underlay'
</pre></div>
...
<div class="region"><div class="contents">
<p class="para">You can verify the Wiki application and see if it works by
    pointing your web browser to the following URL:
    </p>
<div class="code"><pre class="contents ">http://localhost/moj-wiki
</pre></div>
<p class="para">
    For more details, please refer to the <a href="http://moinmo.in/" class="ulink" title="http://moinmo.in/">MoinMoin</a> web site.
    </p>
</div></div>
</div></div>
...
<li class="list itemizedlist">
        <p class="para">Za več podatkov si oglejte <a href="http://moinmo.in/" class="ulink" title="http://moinmo.in/">moinmoin Wiki</a>.</p>
      </li>
<li class="list itemizedlist">
        <p class="para">Oglejte si tudi stran <a href="https://help.ubuntu.com/community/MoinMoin" class="ulink" title="https://help.ubuntu.com/community/MoinMoin">MoinMoin na Ubuntu Wiki</a>.</p>
      </li>
</ul></div></div></div>
</div></div>
</div>
