...
<a class="nextlinks-prev" href="multipath-dm-multipath-config-file.html.ru" title="Конфигурационный файл DM-Multipath">Назад</a><a class="nextlinks-next" href="remote-administration.html.ru" title="Удалённое администрирование">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Администрирование DM-Multipath и устранение проблем</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-resize-an-online-multipath-device" title="Изменение размера работающего множественного устройства">Изменение размера работающего множественного устройства</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-moving-rootfs-from-single-path-to-multipath-device" title="Перенос корневой файловой системы с одиночного устройства на множественное">Перенос корневой файловой системы с одиночного устройства на множественное</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-moving-swap-from-single-path-to-multipath-device" title="Перенос файловой системы подкачки с одиночного устройства на множественное">Перенос файловой системы подкачки с одиночного устройства на множественное</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-daemon-multipathd" title="Сервис Multipath">Сервис Multipath</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-issues-with-queue_if_no_path" title="Проблемы с queue_if_no_path">Проблемы с queue_if_no_path</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-command-output" title="Вывод команды multipath">Вывод команды multipath</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-queries-and-commands" title="Получение информации через команду multipath">Получение информации через команду multipath</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-command-options" title="Опции команды multipath">Опции команды multipath</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#device-mapper-entries-in-dmsetup" title="Определение меток маршрутизации устройств командой dmsetup">Определение меток маршрутизации устройств командой dmsetup</a></li>
<li class="links"><a class="xref" href="multipath-admin-and-troubleshooting.html.ru#multipath-interacting-with-multipathd" title="Решение проблем с помощью интерактивной консоли multipathd">Решение проблем с помощью интерактивной консоли multipathd</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">Процедура в точности такая же, как приведена в предыдущем разделе <a class="link" href="multipath-admin-and-troubleshooting.html.ru#multipath-moving-rootfs-from-single-path-to-multipath-device" title="Перенос корневой файловой системы с одиночного устройства на множественное">Перенос корневой файловой системы с одиночного устройства на множественное</a>.</p></div></div>
</div></div>
...
<div class="region"><div class="contents"><p class="para">Если вы испытываете трудности в настройке multipath, вам надо убедиться, что сервис multipath запущен, как описано в <a class="link" href="multipath-setting-up-dm-multipath.html.ru" title="Обзор установки DM-Multipath">"Настройка DM-Multipath"</a>. Сервис <span class="cmd command">multipathd</span> должен быть запущен для того, чтобы использовать multipathd устройства. Также смотрите раздел <a class="link" href="multipath-admin-and-troubleshooting.html.ru#multipath-interacting-with-multipathd" title="Решение проблем с помощью интерактивной консоли multipathd">Решение проблем с помощью интерактивной консоли multipathd</a> касательно взаимодействия с <span class="cmd command">multipathd</span>, как со средством отладки.</p></div></div>
</div></div>
...
<div class="region"><div class="contents">
<p class="para">Если установлены свойства <span class="em em-bold emphasis">features "1 queue_if_no_path"</span> в файле <span class="file filename">/etc/multipath.conf</span>, то любой процесс, использующий ввод-вывод, будет сбрасываться, пока восстанавливаются один или несколько маршрутов. Для предотвращения этого установите параметр <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-no_path_retry" title="">no_path_retry</a> N</span> в <span class="file filename">/etc/multipath.conf</span>.</p>
...
<div class="region"><div class="contents">
<p class="para">В таблице <a class="xref" href="multipath-admin-and-troubleshooting.html.ru#useful-multipath-command-options" title="Полезные опции команды multipath">Полезные опции команды multipath</a> описаны несколько параметров команды <span class="em em-bold emphasis">multipath</span>, которые могут быть вам полезны.</p>
<div class="table">
