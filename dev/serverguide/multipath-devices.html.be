...
<a class="nextlinks-prev" href="device-mapper-multipathing.html.be" title="Device Mapper Multipathing">Назад</a><a class="nextlinks-next" href="multipath-setting-up-dm-multipath.html.be" title="Setting up DM-Multipath Overview">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="multipath-devices.html.be#multipath-device-identifiers" title="Multipath Device Identifiers">Multipath Device Identifiers</a></li>
<li class="links"><a class="xref" href="multipath-devices.html.be#multipath-device-names-in-cluster" title="Consistent Multipath Device Names in a Cluster">Consistent Multipath Device Names in a Cluster</a></li>
<li class="links"><a class="xref" href="multipath-devices.html.be#multipath-devices-attributes" title="Multipath Device attributes">Multipath Device attributes</a></li>
<li class="links"><a class="xref" href="multipath-devices.html.be#multipath-devices-in-logical-volumes" title="Multipath Devices in Logical Volumes">Multipath Devices in Logical Volumes</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">Each multipath device has a World Wide Identifier (WWID), which is
      ...
      <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.be#attribute-user_friendly_names" title="">user_friendly_names</a>
      ...
      according to the multipath configuration. When the <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.be#attribute-user_friendly_names" title="">user_friendly_names</a></span>
...
<li class="list itemizedlist">
      ...
      defaults, including the <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.be#attribute-user_friendly_names" title="">user_friendly_names</a></span>
      configuration option, see Section , <a class="link" href="multipath-dm-multipath-config-file.html.be#multipath-config-defaults" title="Configuration File Defaults">Configuration File
      Defaults</a>. You can also set the name of a multipath device to a
      name of your choosing by using the <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.be#attribute-alias" title="">alias</a></span> option in the
      ...
      file, see Section, <a class="link" href="multipath-dm-multipath-config-file.html.be#multipath-config-multipath" title="Configuration File Multipath
...
<div class="region"><div class="contents"><p class="para">In addition to the <span class="em em-bold emphasis">user_friendly_names</span> and <span class="em em-bold emphasis">alias</span> options, a multipath device has numerous
      ...
      configuration file, see Section, "<a class="link" href="multipath-dm-multipath-config-file.html.be#multipath-config-multipath" title="Configuration File Multipath
...
<p class="para">When you create an LVM logical volume that uses active/passive
      ...
      Perform:<div class="screen"><pre class="contents ">update-initramfs -u -k all</pre></div><div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
