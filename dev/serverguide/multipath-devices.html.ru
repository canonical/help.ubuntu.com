...
<a class="nextlinks-prev" href="device-mapper-multipathing.html.ru" title="Множественное связывание устройств (Device Mapper Multipathing)">Назад</a><a class="nextlinks-next" href="multipath-setting-up-dm-multipath.html.ru" title="Обзор установки DM-Multipath">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="multipath-devices.html.ru#multipath-device-identifiers" title="Идентификаторы устройств множественного связывания">Идентификаторы устройств множественного связывания</a></li>
<li class="links"><a class="xref" href="multipath-devices.html.ru#multipath-device-names-in-cluster" title="Согласованные имена множественных устройств в кластере">Согласованные имена множественных устройств в кластере</a></li>
<li class="links"><a class="xref" href="multipath-devices.html.ru#multipath-devices-attributes" title="Атрибуты множественных устройств">Атрибуты множественных устройств</a></li>
<li class="links"><a class="xref" href="multipath-devices.html.ru#multipath-devices-in-logical-volumes" title="Множественные устройства в логических томах">Множественные устройства в логических томах</a></li>
</ul></div>
...
<div class="region"><div class="contents"><p class="para">Each multipath device has a World Wide Identifier (WWID), which is
      ...
      <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-user_friendly_names" title="">user_friendly_names</a>
      ...
      according to the multipath configuration. When the <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-user_friendly_names" title="">user_friendly_names</a></span>
...
<li class="list itemizedlist">
      ...
      defaults, including the <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-user_friendly_names" title="">user_friendly_names</a></span>
      configuration option, see Section , <a class="link" href="multipath-dm-multipath-config-file.html.ru#multipath-config-defaults" title="Значения по умолчанию в файле конфигурации">Configuration File
      Defaults</a>. You can also set the name of a multipath device to a
      name of your choosing by using the <span class="em em-bold emphasis"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-alias" title="">alias</a></span> option in the
      ...
      file, see Section, <a class="link" href="multipath-dm-multipath-config-file.html.ru#multipath-config-multipath" title="Атрибуты множественности в файле конфигурации">Multipaths Device Configuration
