...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ru" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="dm-multipath-chapter.html.ru" title="Множественное связывание устройств (DM-Multipath)">Множественное связывание устройств (DM-Multipath)</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="multipath-setting-up-dm-multipath.html.ru" title="Обзор установки DM-Multipath">Назад</a><a class="nextlinks-next" href="multipath-admin-and-troubleshooting.html.ru" title="Администрирование DM-Multipath и устранение проблем">Вперёд</a>
</div>
...
<li class="list itemizedlist">
          <p class="para"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-overview" title="Обзор файла конфигурации">Обзор файла конфигурации</a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-blacklist" title='"Чёрный список" в файле конфигурации'>"Чёрный список" в файле конфигурации</a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-defaults" title="Значения по умолчанию в файле конфигурации">Значения по умолчанию в файле конфигурации</a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-multipath" title="Атрибуты множественности в файле конфигурации">Атрибуты множественности в файле конфигурации</a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-device" title="Устройства в файле конфигурации">Устройства в файле конфигурации</a></p>
        </li>
</ul></div></p>
...
<li class="links"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-overview" title="Обзор файла конфигурации">Обзор файла конфигурации</a></li>
<li class="links"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-blacklist" title='"Чёрный список" в файле конфигурации'>"Чёрный список" в файле конфигурации</a></li>
<li class="links"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-defaults" title="Значения по умолчанию в файле конфигурации">Значения по умолчанию в файле конфигурации</a></li>
<li class="links"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-multipath" title="Атрибуты множественности в файле конфигурации">Атрибуты множественности в файле конфигурации</a></li>
<li class="links"><a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-device" title="Устройства в файле конфигурации">Устройства в файле конфигурации</a></li>
</ul></div>
...
<li class="list itemizedlist">
              <p class="para">По WWID, как описано в разделе <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-blacklist-by-wwid" title="Блокировка по WWID">Блокировка по WWID</a></p>
            </li>
<li class="list itemizedlist">
              <p class="para">По имени устройства, как описано в разделе <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-blacklist-by-device-name" title="Блокировка по имени устройства">Блокировка по имени устройства</a></p>
            </li>
<li class="list itemizedlist">
              <p class="para">По типу устройства, как описано в разделе <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-blacklist-by-device-type" title="Блокировка по типу устройства">Блокировка по типу устройства</a></p>
            </li>
</ul></div>

          <p class="para">По умолчанию множество типов устройств блокируются даже если вы комментируете изначальную секцию blacklist конфигурационного файла. Для информации смотрите <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-blacklist-by-device-name" title="Блокировка по имени устройства">Блокировка по имени устройства</a></p>
        </li></ul></div>
</div>
...
<p class="para">По умолчанию следующие метки <span class="em em-bold emphasis">devnode</span> включены в список blacklist. Устройства, определяемые в этой секции, как правило не поддерживают DM-Multipath. Чтобы разрешить любое из перечисленного при создании множественных устройств, вы можете определить их в секции <span class="em em-bold emphasis">blacklist_exceptions</span> как показано в разделе <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-blacklist-exceptions" title="Исключения блокировки">Исключения блокировки</a><div class="screen"><pre class="contents ">blacklist {
...
<p class="para">Таблица <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-defaults-table" title="Настройки Multipath по умолчанию">Настройки Multipath по умолчанию</a> определяет атрибуты, которые устанавливаются в секции <span class="em em-bold emphasis">defaults</span> файла <span class="file filename">multipath.conf</span>. Эти значения используются DM-Multipath, если они не переопределены атрибутами, заданными в секциях <span class="em em-bold emphasis">devices</span> и <span class="em em-bold emphasis">multipaths</span> в файле  <span class="file filename">multipath.conf</span>.</p>
<div class="table">
...
<div class="region"><div class="contents">
<p class="para">Таблица <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-attributes-table" title="Атрибуты множественности">Атрибуты множественности</a> содержит перечень атрибутов, которые вы можете установить для каждого отдельного множественного устройства в секции <span class="em em-bold emphasis">multipaths</span> конфигурационного файла <span class="file filename">multipath.conf</span>. Эти атрибуты применяются только к одному конкретному множественному устройству. Эти значения по умолчанию используются DM-Multipath и переопределяют атрибуты, установленные в секциях <span class="em em-bold emphasis">defaults</span> и <span class="em em-bold emphasis">devices</span> файла multipath.conf.</p>
<div class="table">
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-path_grouping_policy" title="">
          <span class="cmd parameter">path_grouping_policy</span> </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-path_selector" title="">
          <span class="cmd parameter">path_selector</span> </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-failback" title="">
          <span class="cmd parameter">failback</span> </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-prio" title=""> <span class="cmd parameter">prio</span>
          </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-prio_args" title=""><span class="cmd parameter">prio_args</span></a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-no_path_retry" title="">
          <span class="cmd parameter">no_path_retry</span> </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-rr_min_io" title="">
          <span class="cmd parameter">rr_min_io</span> </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-rr_weight" title="">
          <span class="cmd parameter">rr_weight</span> </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-flush_on_last_del" title="">
...
<p class="para">The second multipath device in the example has a WWID of
      ...
      <a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-rr_weight" title="">rr_weight</a>
...
<p class="para">Дополнительные параметры для определения зависят от специфических устройств. Если устройство активно/активное, вам, как правило, не требуется устанавливать дополнительные параметры. Возможно вы захотите установить <a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-path_grouping_policy" title="">path_grouping_policy</a> в <span class="em em-bold emphasis">multibus</span>. Другие параметры, которые вы, возможно, захотите определить — это <a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-no_path_retry" title="">no_path_retry</a> and <a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-rr_min_io" title="">rr_min_io</a>, как описано в таблице <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-attributes-table" title="Атрибуты множественности">Атрибуты множественности</a>.</p>
<p class="para">Если устройство активно/пассивное, но автоматически переключает маршруты ввода/вывода на пассивный маршрут, вам потребуется изменить функцию проверки на ту, которая не посылает поток ввода/вывода для проверки работоспособности (иначе ваше устройство будет постоянно находиться в состоянии сбоя). Это также всегда подразумевает, что вы установили <a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-path_checker" title="">path_checker</a> в <span class="em em-bold emphasis">tur</span>;  это работает для всех SCSI устройств, которые поддерживают команду Test Unit Ready, а таких большинство.</p>
...
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-getuid_callout" title="">
...
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-path_checker" title="">
          <span class="cmd parameter">path_checker</span> </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-features" title="">
...
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-fast_io_fail_tmo" title="">
          <span class="cmd parameter">fast_io_fail_tmo</span> </a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a class="link" href="multipath-dm-multipath-config-file.html.ru#attribute-dev_loss_tmo" title="">
