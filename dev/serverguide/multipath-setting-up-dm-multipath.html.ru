...
<a class="nextlinks-prev" href="multipath-devices.html.ru" title="Множественные устройства">Назад</a><a class="nextlinks-next" href="multipath-dm-multipath-config-file.html.ru" title="Конфигурационный файл DM-Multipath">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="multipath-setting-up-dm-multipath.html.ru#multipath-setup-overview" title="Настройка DM-Multipath">Настройка DM-Multipath</a></li>
<li class="links"><a class="xref" href="multipath-setting-up-dm-multipath.html.ru" title="Установка с поддержкой множественных устройств">Установка с поддержкой множественных устройств</a></li>
<li class="links"><a class="xref" href="multipath-setting-up-dm-multipath.html.ru#multipath-ignore-local-disks" title="Игнорирование локальных дисков при создании множественных устройств">Игнорирование локальных дисков при создании множественных устройств</a></li>
<li class="links"><a class="xref" href="multipath-setting-up-dm-multipath.html.ru#multipath-config-storage-devices" title="Настройка устройств массивов хранения">Настройка устройств массивов хранения</a></li>
</ul></div>
...
<li class="list orderedlist">
          ...
          command output, see Section <a class="link" href="multipath-admin-and-troubleshooting.html.ru#multipath-command-output" title="Вывод команды multipath">Multipath Command
          Output</a>.</p>
...
<li class="list orderedlist">
          ...
          -ll</span> command, see Section <a class="link" href="multipath-admin-and-troubleshooting.html.ru#multipath-queries-and-commands" title="Получение информации через команду multipath">Multipath Queries with
...
<p class="para">Для дополнительной информации смотрите раздел <a class="xref" href="multipath-dm-multipath-config-file.html.ru#multipath-config-device" title="Устройства в файле конфигурации">Устройства в файле конфигурации</a>.</p>
</div></div>
</div></div>
</div>
<div class="links nextlinks">
