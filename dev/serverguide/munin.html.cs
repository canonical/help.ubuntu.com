...
<a class="nextlinks-prev" href="nagios.html.cs" title="Nagios">Předchozí</a><a class="nextlinks-next" href="web-servers.html.cs" title="Web Servers">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Munin</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="munin.html.cs#munin-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="munin.html.cs#munin-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="munin.html.cs#munin-plugins" title="Additional Plugins">Additional Plugins</a></li>
<li class="links"><a class="xref" href="munin.html.cs#munin-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
      ...
      For more information see <a class="xref" href="httpd.html.cs" title="HTTPD - Apache2 Web Server">HTTPD - Apache2 Web Server</a>.
      </p>
<p class="para">
