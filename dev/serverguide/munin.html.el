...
<a class="nextlinks-prev" href="nagios.html.el" title="Nagios">Προηγούμενο</a><a class="nextlinks-next" href="web-servers.html.el" title="Διακομιστές Ιστού">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Munin</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="munin.html.el#munin-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="munin.html.el#munin-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="munin.html.el#munin-plugins" title="Επιπλέον πρόσθετα">Επιπλέον πρόσθετα</a></li>
<li class="links"><a class="xref" href="munin.html.el#munin-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
<div class="sect2 sect" id="munin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Εγκατάσταση</h2></div>
<div class="region"><div class="contents">
<p class="para">Πριν εγκαταστήσετε το <span class="app application">Munin</span> στον <span class="em emphasis">server01</span>, θα πρέπει να εγκαταστήσετε το <span class="app application">apache2</span>. Οι προεπιλεγμένες ρυθμίσεις επαρκούν για τη λειτουργία ενός εξυπηρετητή <span class="app application">munin</span>. Για περισσότερες πληροφορίες δείτε το <a class="xref" href="httpd.html.el" title="HTTPD - Apache2 Διακομιστής Ιστού">HTTPD - Apache2 Διακομιστής Ιστού</a>.</p>
