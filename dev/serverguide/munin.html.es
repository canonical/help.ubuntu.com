...
<a class="nextlinks-prev" href="nagios.html.es" title="Nagios">Anterior</a><a class="nextlinks-next" href="web-servers.html.es" title="Servidores web">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Munin</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="munin.html.es#munin-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="munin.html.es#munin-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="munin.html.es#munin-plugins" title="Complementos adicionales">Complementos adicionales</a></li>
<li class="links"><a class="xref" href="munin.html.es#munin-references" title="Referencias">Referencias</a></li>
</ul></div>
<div class="sect2 sect" id="munin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Instalación</h2></div>
<div class="region"><div class="contents">
<p class="para">Antes de instalar <span class="app application">Munin</span> en <span class="em emphasis">server01</span> es necesario instalar <span class="app application">apache2</span>. La configuración predeterminada es suficiente para ejecutar un servidor <span class="app application">munin</span>. Para más información, consulte <a class="xref" href="httpd.html.es" title="HTTPD - Servidor web Apache2">HTTPD - Servidor web Apache2</a>.</p>
