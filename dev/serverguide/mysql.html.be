...
<a class="nextlinks-prev" href="databases.html.be" title="Базы даньняў">Назад</a><a class="nextlinks-next" href="postgresql.html.be" title="PostgreSQL">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="mysql.html.be#mysql-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="mysql.html.be#mysql-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="mysql.html.be#mysql-engines" title="Database Engines">Database Engines</a></li>
<li class="links"><a class="xref" href="mysql.html.be#mysql-advanced" title="Advanced configuration">Advanced configuration</a></li>
<li class="links"><a class="xref" href="mysql.html.be#mysql-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
<div class="sect2 sect" id="mysql-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Усталёўка</h2></div>
<div class="region"><div class="contents">
<p class="para">Каб устанавіць MySQL, запусьціце наступны загад у тэрмінале:</p>
