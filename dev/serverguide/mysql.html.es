...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="databases.html.es" title="Bases de datos">Bases de datos</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="databases.html.es" title="Bases de datos">Anterior</a><a class="nextlinks-next" href="postgresql.html.es" title="PostgreSQL">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="mysql.html.es#mysql-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="mysql.html.es#mysql-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="mysql.html.es#mysql-engines" title="Motores de bases de datos">Motores de bases de datos</a></li>
<li class="links"><a class="xref" href="mysql.html.es#mysql-advanced" title="Configuración avanzada">Configuración avanzada</a></li>
<li class="links"><a class="xref" href="mysql.html.es#mysql-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para">Cuando ejecute este comando, deberá ver la siguiente línea o algo similar:</p>
<div class="code"><pre class="contents ">tcp 0 0 localhost:mysql  *:*  LISTEN 2556/mysqld
</pre></div>
<p class="para">Si el servidor no se está ejecutando correctamente, puede teclear la siguiente orden para arrancarlo:</p>
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
                                <p class="para">Sustituya 192.168.0.5 por la dirección adecuada.</p>
	                         </div></div></div></div>
<p class="para">Después de hacer un cambio en <span class="file filename">/etc/mysql/my.cnf</span> el demonio MySQL necesitará reiniciarse:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart mysql.service</span>
</pre></div>
<p class="para">Si desea cambiar la contraseña de <span class="em emphasis">root</span> de MySQL, introduzca en un terminal:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo dpkg-reconfigure mysql-server-5.5</span>
</pre></div>
<p class="para">El demonio MySQL se detendrá y se le solicitará que introduzca una nueva contraseña.</p>
</div></div>
</div></div>
<div class="sect2 sect" id="mysql-engines"><div class="inner">
<div class="hgroup"><h2 class="title">Motores de bases de datos</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Cada motor tienes sus propias ventajas y desventajas.</p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Crear un archivo my.cnf afinado</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="list itemizedlist">
                                <p class="para">Vea <a href="http://www.mysql.com/" class="ulink" title="http://www.mysql.com/">MySQL Home Page</a> para más información.</p>
                            </li>
<li class="list itemizedlist">
                                <p class="para">
...
<li class="list itemizedlist">
                               <p class="para">Para información general sobre SQL, vea <a href="http://www.informit.com/store/product.aspx?isbn=0768664128" class="ulink" title="http://www.informit.com/store/product.aspx?isbn=0768664128">Usando SQL Edición Especial</a> por Rafe Colburn.</p>
                           </li>
<li class="list itemizedlist">
                               <p class="para">La página <a href="https://help.ubuntu.com/community/ApacheMySQLPHP" class="ulink" title="https://help.ubuntu.com/community/ApacheMySQLPHP">Apache MySQL PHP Ubuntu Wiki</a> también tiene información útil.</p>
                           </li>
</ul></div></div></div>
</div></div>
</div>
