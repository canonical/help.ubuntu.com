...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ru" title="Руководство по Ubuntu Server">Руководство по Ubuntu Server</a> » <a class="trail" href="databases.html.ru" title="Базы данных">Базы данных</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="databases.html.ru" title="Базы данных">Назад</a><a class="nextlinks-next" href="postgresql.html.ru" title="PostgreSQL">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="mysql.html.ru#mysql-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="mysql.html.ru#mysql-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="mysql.html.ru#mysql-engines" title="Драйверы базы данных">Драйверы базы данных</a></li>
<li class="links"><a class="xref" href="mysql.html.ru#mysql-advanced" title="Расширенные настройки">Расширенные настройки</a></li>
<li class="links"><a class="xref" href="mysql.html.ru#mysql-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
