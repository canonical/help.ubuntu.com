...
<a class="nextlinks-prev" href="monitoring-overview.html.cs" title="Overview">Předchozí</a><a class="nextlinks-next" href="munin.html.cs" title="Munin">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Nagios</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="nagios.html.cs#nagios-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="nagios.html.cs#nagios-configuration-overview" title="Configuration Overview">Configuration Overview</a></li>
<li class="links"><a class="xref" href="nagios.html.cs#nagios-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="nagios.html.cs#nagios-references" title="References">References</a></li>
</ul></div>
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
        <p class="para">
        See <a class="xref" href="httpd.html.cs" title="HTTPD - Apache2 Web Server">HTTPD - Apache2 Web Server</a> for details on setting up Apache, <a class="xref" href="dns.html.cs" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for DNS, and <a class="xref" href="mysql.html.cs" title="MySQL">MySQL</a> for MySQL.
        </p>
      </div></div></div></div>
<p class="para">
