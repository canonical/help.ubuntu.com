...
<a class="nextlinks-prev" href="monitoring-overview.html.es" title="Vista general">Anterior</a><a class="nextlinks-next" href="munin.html.es" title="Munin">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Nagios</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="nagios.html.es#nagios-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="nagios.html.es#nagios-configuration-overview" title="Resumen de configuración">Resumen de configuración</a></li>
<li class="links"><a class="xref" href="nagios.html.es#nagios-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="nagios.html.es#nagios-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Vea <a class="xref" href="httpd.html.es" title="HTTPD - Servidor web Apache2">HTTPD - Servidor web Apache2</a> para más detalles de la configuración de Apache, <a class="xref" href="dns.html.es" title="Servicio de nombres de dominio (DNS)">Servicio de nombres de dominio (DNS)</a> para las DNS, y <a class="xref" href="mysql.html.es" title="MySQL">MySQL</a> para MySQL.</p>
      </div></div></div></div>
