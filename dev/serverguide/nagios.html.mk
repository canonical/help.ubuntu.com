...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.mk" title="Водич за Ubuntu Server">Водич за Ubuntu Server</a> » <a class="trail" href="monitoring.html.mk" title="Monitoring">Monitoring</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="monitoring-overview.html.mk" title="Overview">Previous</a><a class="nextlinks-next" href="munin.html.mk" title="Munin">Next</a>
</div>
<div class="hgroup"><h1 class="title">Nagios</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="nagios.html.mk#nagios-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="nagios.html.mk#nagios-configuration-overview" title="Configuration Overview">Configuration Overview</a></li>
<li class="links"><a class="xref" href="nagios.html.mk#nagios-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="nagios.html.mk#nagios-references" title="References">References</a></li>
</ul></div>
...
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents">
        <p class="para">
        See <a class="xref" href="httpd.html.mk" title="HTTPD - Apache2 Web Server">HTTPD - Apache2 Web Server</a> for details on setting up Apache, <a class="xref" href="dns.html.mk" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for DNS, and <a class="xref" href="mysql.html.mk" title="MySQL">MySQL</a> for MySQL.
        </p>
      </div></div></div></div>
<p class="para">
