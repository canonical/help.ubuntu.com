...
<a class="nextlinks-prev" href="monitoring-overview.html.ru" title="Обзор">Назад</a><a class="nextlinks-next" href="munin.html.ru" title="Munin">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Nagios</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="nagios.html.ru#nagios-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="nagios.html.ru#nagios-configuration-overview" title="Обзор конфигурации">Обзор конфигурации</a></li>
<li class="links"><a class="xref" href="nagios.html.ru#nagios-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="nagios.html.ru#nagios-references" title="Ссылки">Ссылки</a></li>
</ul></div>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Смотрите раздел <a class="xref" href="httpd.html.ru" title="HTTPD - веб сервер Apache2">HTTPD - веб сервер Apache2</a> для более детальных настроек Apache, <a class="xref" href="dns.html.ru" title="Служба доменных имён (DNS)">Служба доменных имён (DNS)</a> для настройки DNS, а также <a class="xref" href="mysql.html.ru" title="MySQL">MySQL</a> для настройки MySQL.</p>
      </div></div></div></div>
