...
<title>Διαμόρφωση Δικτύου</title>
...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.el" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="networking.html.el" title="Δικτύωση">Δικτύωση</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="networking.html.el" title="Δικτύωση">Προηγούμενο</a><a class="nextlinks-next" href="tcpip.html.el" title="TCP/IP">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Διαμόρφωση Δικτύου</h1></div>
<div class="region">
<div class="contents"><p class="para">Το Ubuntu στέλνεται με έναν αριθμό γραφικών λειτουργιών για να διαμορφώσετε τις συσκευές δικτύου σας. Αυτό το έγγραφο είναι προσανατολισμένο σε διαχειριστές διακομιστή και θα εστιάσει στη διαχείριση του δικτύου σας στη γραμμή εντολών.</p></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="network-configuration.html.el#ethernet-interfaces" title="Ethernet Interfaces">Ethernet Interfaces</a></li>
<li class="links"><a class="xref" href="network-configuration.html.el#ip-addressing" title="IP Addressing">IP Addressing</a></li>
<li class="links"><a class="xref" href="network-configuration.html.el#name-resolution" title="Name Resolution">Name Resolution</a></li>
<li class="links"><a class="xref" href="network-configuration.html.el#bridging" title="Γεφύρωση">Γεφύρωση</a></li>
<li class="links"><a class="xref" href="network-configuration.html.el#network-config-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Εισάγετε τις κατάλληλες τιμές για τη φυσική σας διεπαφή και δίκτυο.</p>
      </div></div></div></div>
<p class="para">
...
<p class="para">Η καινούρια διεπαφή γέφυρας θα πρέπει τώρα να εκτελείτε. Το <span class="app application">brctl</span> παρέχει χρήσιμες πληροφορίες για την κατάσταση της γέφυρας, ελέγχει ποιες διεπαφές είναι μέρος της γέφυρας, κλπ. Δείτε το <span class="cmd command">man brctl</span> για περισσότερες πληροφορίες.</p>
</div></div>
</div></div>
