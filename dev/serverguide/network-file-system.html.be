...
<a class="nextlinks-prev" href="ftp-server.html.be" title="Сэрвер FTP">Назад</a><a class="nextlinks-next" href="iscsi-initiator.html.be" title="iSCSI Initiator">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="network-file-system.html.be#nfs-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="network-file-system.html.be#nfs-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="network-file-system.html.be#nfs-client-configuration" title="NFS Client Configuration">NFS Client Configuration</a></li>
<li class="links"><a class="xref" href="network-file-system.html.be#nfs-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
