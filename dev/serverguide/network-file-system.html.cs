...
<a class="nextlinks-prev" href="ftp-server.html.cs" title="FTP Server">Předchozí</a><a class="nextlinks-next" href="iscsi-initiator.html.cs" title="iSCSI Initiator">Následující</a>
</div>
...
<li class="links"><a class="xref" href="network-file-system.html.cs#nfs-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="network-file-system.html.cs#nfs-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="network-file-system.html.cs#nfs-client-configuration" title="NFS Client Configuration">NFS Client Configuration</a></li>
<li class="links"><a class="xref" href="network-file-system.html.cs#nfs-references" title="References">References</a></li>
</ul></div>
