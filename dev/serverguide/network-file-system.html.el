...
<a class="nextlinks-prev" href="ftp-server.html.el" title="Εξυπηρετητής FTP">Προηγούμενο</a><a class="nextlinks-next" href="iscsi-initiator.html.el" title="Aρχικοποιητής iSCSI">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="network-file-system.html.el#nfs-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="network-file-system.html.el#nfs-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="network-file-system.html.el#nfs-client-configuration" title="Ρύθμιση πελάτη NFS">Ρύθμιση πελάτη NFS</a></li>
<li class="links"><a class="xref" href="network-file-system.html.el#nfs-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
