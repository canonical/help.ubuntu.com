...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="network-authentication.html.be" title="Network Authentication">Network Authentication</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="network-authentication.html.be" title="Network Authentication">Назад</a><a class="nextlinks-next" href="samba-ldap.html.be" title="Samba і LDAP">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Сэрвер OpenLDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-server-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-server-postinstall" title="Post-install Inspection">Post-install Inspection</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-server-populate" title="Modifying/Populating your Database">Modifying/Populating your Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-server-logging" title="Logging">Logging</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-server-replication" title="Replication">Replication</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-server-acl" title="Access Control">Access Control</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-tls" title="TLS">TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-tls-replication" title="Replication and TLS">Replication and TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-auth-config" title="LDAP Authentication">LDAP Authentication</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#ldap-usergroup-management" title="User and Group Management">User and Group Management</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#ldap-backup" title="Backup and Restore">Backup and Restore</a></li>
<li class="links"><a class="xref" href="openldap-server.html.be#openldap-server-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html.be#openldap-server-installation" title="Усталёўка">Усталёўка</a>. Make sure the slapd-config
...
<div class="hgroup"><h3 class="title">Праверка</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
	The assumption here is that you have set up replication between Provider and Consumer according to <a class="xref" href="openldap-server.html.be#openldap-server-replication" title="Replication">Replication</a>
	and have configured TLS for authentication on the Provider by following <a class="xref" href="openldap-server.html.be#openldap-tls" title="TLS">TLS</a>.
	</p>
<p class="para">
...
<p class="para">
	...
	<a class="xref" href="samba-ldap.html.be" title="Samba і LDAP">Samba і LDAP</a> for details.
	</p>
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
		<p class="para">Стварыць новага карыстальніка:</p>
...
<li class="list itemizedlist">
		<p class="para">Зьмяніць пароль карыстальніка:</p>
...
<span class="input userinput">Новы пароль: </span>
<span class="input userinput">New Password (verify): </span>
</pre></div>

	</li>
<li class="list itemizedlist">
		<p class="para">Выдаліць карыстальніка:</p>
...
<li class="list itemizedlist">
		<p class="para">Дадаць карыстальніка ў групу:</p>
...
<li class="list itemizedlist">
		<p class="para">Выдаліць карыстальніка з групы:</p>
...
<div class="hgroup"><h2 class="title">Рэсурсы</h2></div>
