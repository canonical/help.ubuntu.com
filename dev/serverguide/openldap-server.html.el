...
<title>Εξυπηρετητής OpenLDAP</title>
...
<a class="nextlinks-prev" href="network-authentication.html.el" title="Πιστοποίηση δικτύου">Προηγούμενο</a><a class="nextlinks-next" href="samba-ldap.html.el" title="Samba και LDAP">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Εξυπηρετητής OpenLDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-server-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-server-postinstall" title="Post-install Inspection">Post-install Inspection</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-server-populate" title="Modifying/Populating your Database">Modifying/Populating your Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-server-logging" title="Καταγραφή">Καταγραφή</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-server-replication" title="Αναπαραγωγή">Αναπαραγωγή</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-server-acl" title="Access Control">Access Control</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-tls" title="TLS">TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-tls-replication" title="Replication and TLS">Replication and TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-auth-config" title="Πιστοποίηση LDAP">Πιστοποίηση LDAP</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#ldap-usergroup-management" title="Διαχείριση χρηστών και ομάδων">Διαχείριση χρηστών και ομάδων</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#ldap-backup" title="Backup and Restore">Backup and Restore</a></li>
<li class="links"><a class="xref" href="openldap-server.html.el#openldap-server-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<div class="hgroup"><h2 class="title">Αναπαραγωγή</h2></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html.el#openldap-server-installation" title="Εγκατάσταση">Εγκατάσταση</a>. Make sure the slapd-config
...
<div class="hgroup"><h3 class="title">Δοκιμή</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
	The assumption here is that you have set up replication between Provider and Consumer according to <a class="xref" href="openldap-server.html.el#openldap-server-replication" title="Αναπαραγωγή">Αναπαραγωγή</a>
	and have configured TLS for authentication on the Provider by following <a class="xref" href="openldap-server.html.el#openldap-tls" title="TLS">TLS</a>.
	</p>
<p class="para">
...
<div class="hgroup"><h2 class="title">Πιστοποίηση LDAP</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Τα αποτελέσματα των επιλογών σας στο διάλογο φαίνονται στο αρχείο <span class="file filename">/etc/ldap.conf</span>. Αν ο εξυπηρετητής σας απαιτεί επιλογές που δεν περιλαμβάνονται στο μενού, θα χρειαστεί να επεξεργαστείτε αυτό το αρχείο.</p>
<p class="para">
...
<p class="para">
	...
	<a class="xref" href="samba-ldap.html.el" title="Samba και LDAP">Samba και LDAP</a> for details.
	</p>
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
...
<div class="hgroup"><h2 class="title">Διαχείριση χρηστών και ομάδων</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
		<p class="para">Δημιουργία νέου χρήστη:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapadduser george example</span>
</pre></div>

		<p class="para">Δημιουργεί χρήστη με uid <span class="em emphasis">george</span> και ορίζει την <span class="em emphasis">example</span> ως πρωτεύουσα ομάδα του χρήστη (gid).</p>
	</li>
<li class="list itemizedlist">
		<p class="para">Αλλαγή κωδικού χρήστη:</p>
...
<li class="list itemizedlist">
		<p class="para">Διαγραφή χρήστη:</p>
...
<li class="list itemizedlist">
		<p class="para">Προσθήκη ομάδας:</p>
...
<li class="list itemizedlist">
		<p class="para">Διαγραφή ομάδας:</p>
...
<li class="list itemizedlist">
		<p class="para">Προσθήκη χρήστη σε ομάδα:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapaddusertogroup george qa</span>
</pre></div>

		<p class="para">Θα πρέπει να έχει εμφανιστεί ένα γνώρισμα <span class="em emphasis">memberUid</span> για την ομάδα <span class="em emphasis">qa</span>, με τιμή <span class="em emphasis">george</span>.</p>
	</li>
<li class="list itemizedlist">
		<p class="para">Αφαίρεση χρήστη από ομάδα:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapdeleteuserfromgroup george qa</span>
</pre></div>

		<p class="para">Το γνώρισμα <span class="em emphasis">memberUid</span> θα πρέπει να έχει αφαιρεθεί από την ομάδα <span class="em emphasis">qa</span>.</p>
	</li>
<li class="list itemizedlist">
		<p class="para">Το σενάριο <span class="app application">ldapmodifyuser</span> σας επιτρέπει να προσθέτετε, να αφαιρείτε και να αντικαθιστάτε τα γνωρίσματα ενός χρήστη. The Το σενάριο αυτό χρησιμοποιεί την ίδια σύνταξη με το <span class="app application">ldapmodify</span>. Π.χ.:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapmodifyuser george</span>
<span class="output computeroutput"># Θα τροποποιηθεί η ακόλουθη εγγραφή :
...
gecos: George Carlin</span>
		...
		<p class="para">Το <span class="em emphasis">gecos</span> θα πρέπει να έχει γίνει <span class="quote">“George Carlin”</span>.</p>
	</li>
<li class="list itemizedlist">
		<p class="para">
