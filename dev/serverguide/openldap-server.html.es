...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="network-authentication.html.es" title="Autentificación de redes">Autentificación de redes</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="network-authentication.html.es" title="Autentificación de redes">Anterior</a><a class="nextlinks-next" href="samba-ldap.html.es" title="Samba y LDAP">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Servidor OpenLDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-server-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-server-postinstall" title="Post-install Inspection">Post-install Inspection</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-server-populate" title="Modifying/Populating your Database">Modifying/Populating your Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-server-logging" title="Entrada">Entrada</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-server-replication" title="Replicación">Replicación</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-server-acl" title="Control de acceso">Control de acceso</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-tls" title="TLS">TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-tls-replication" title="Replication and TLS">Replication and TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-auth-config" title="Autenticación LDAP">Autenticación LDAP</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#ldap-usergroup-management" title="Gestión de grupo y usuario">Gestión de grupo y usuario</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#ldap-backup" title="Respaldar y restaurar">Respaldar y restaurar</a></li>
<li class="links"><a class="xref" href="openldap-server.html.es#openldap-server-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
dn: olcDatabase={1}mdb,cn=config
		...
		<p class="para">Explicación de las entradas:</p>

		<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
			<p class="para"><span class="em emphasis">cn=config</span>: configuración global</p>
			</li>
<li class="list itemizedlist">
			<p class="para">
...
<p class="para">Añadir el contenido</p>
...
modifying entry "olcDatabase={1}mdb,cn=config"
	...
	<p class="para">Puede confirmar el cambio de esta manera:</p>
...
<p class="para">Cree el archivo <span class="file filename">logging.ldif</span> con el siguiente contenido:</p>
<div class="code"><pre class="contents ">dn: cn=config
changetype: modify
replace: olcLogLevel
olcLogLevel: stats
</pre></div>
<p class="para">Implemente el cambio:</p>
...
<div class="hgroup"><h2 class="title">Replicación</h2></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Configuración del proveedor</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
		<p class="para">Cree un archivo lDIF con el siguiente contenido y llámelo <span class="file filename">provider_sync.ldif</span>:</p>
...
<li class="steps">
		<p class="para">Añadir el contenido nuevo:</p>
...
<div class="hgroup"><h3 class="title">Configuración del consumidor</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html.es#openldap-server-installation" title="Instalación">Instalación</a>. Make sure the slapd-config
		database is identical to the Provider's. In particular, make sure schemas and the databse suffix are the same.
		</p>
	</li>
<li class="steps">
		<p class="para">Cree un archivo LDIF con el siguiente contenido y llámelo <span class="file filename">consumer_sync.ldif</span>:</p>
...
olcUpdateRef: ldap://ldap01.example.com
	...
	<p class="para">Asegure que los siguientes atributos tienen los valores correctos:</p>
...
<div class="hgroup"><h3 class="title">Comprobando</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h2 class="title">Control de acceso</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="steps">
		<p class="para">Haga una clave privada desde el servidor:</p>
...
<li class="steps">
		<p class="para">Cree el archivo info <span class="file filename">/etc/ssl/ldap01.info</span> que contenga:</p>
...
<li class="steps">
		<p class="para">Cree el certificado del servidor:</p>
...
<p class="para">
	The assumption here is that you have set up replication between Provider and Consumer according to <a class="xref" href="openldap-server.html.es#openldap-server-replication" title="Replicación">Replicación</a>
	and have configured TLS for authentication on the Provider by following <a class="xref" href="openldap-server.html.es#openldap-tls" title="TLS">TLS</a>.
	</p>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo certtool --generate-certificate \ --load-privkey ldap02_slapd_key.pem \ --load-ca-certificate /etc/ssl/certs/cacert.pem \ --load-ca-privkey /etc/ssl/private/cakey.pem \ --template ldap02.info \ --outfile ldap02_slapd_cert.pem</span>
                ...
                <p class="para">Obtenga una copia del certificado CA:</p>
...
<li class="steps">  
		<p class="para">En el consumidor,</p>

		<p class="para">Configurar la autenticación TLS:</p>
...
<li class="steps">
		...
		<p class="para">Cree ele archivo <span class="file filename">consumer_sync_tls.ldif</span> con el siguiente contenido:</p>
...
olcSyncRepl: rid=0 provider=ldap://ldap01.example.com bindmethod=simple
 ...
 starttls=critical tls_reqcert=demand
		...
		<p class="para">Implemente estos cambios:</p>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapmodify -Y EXTERNAL -H ldapi:/// -f consumer_sync_tls.ldif</span>
		...
		<p class="para">Y reinicie slapd:</p>
...
<div class="hgroup"><h2 class="title">Autenticación LDAP</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Los resultados del diálogo se pueden ver en <span class="file filename">/etc/ldap.conf</span>. Si su servidor requiere opciones no cubiertas en el menú, edite este archivo de manera coherente.</p>
<p class="para">Ahora configure el perfirl LDAP para NSS:</p>
...
<p class="para">
	...
	<a class="xref" href="samba-ldap.html.es" title="Samba y LDAP">Samba y LDAP</a> for details.
	</p>
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
...
<div class="hgroup"><h2 class="title">Gestión de grupo y usuario</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Instale el paquete:</p>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo sh -c "echo -n 'secreto' &gt; /etc/ldapscripts/ldapscripts.passwd"</span>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
		<p class="para">Crear un nuevo usuario:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapadduser george example</span>
</pre></div>

		<p class="para">Esto creará un usuario con el uid <span class="em emphasis">george</span> y ajustará el grupo primario del usuario (gid) a <span class="em emphasis">example</span></p>
	</li>
<li class="list itemizedlist">
		<p class="para">Cambiar la contraseña del usuario:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapsetpasswd george</span>
<span class="output computeroutput">Cambiar la contraseña para el usuario uid=george,ou=People,dc=example,dc=com</span>
<span class="input userinput">Nueva contraseña: </span>
<span class="input userinput">Nueva contraseña (verificar) </span>
</pre></div>

	</li>
<li class="list itemizedlist">
		<p class="para">Borrar un usuario:</p>
...
<li class="list itemizedlist">
		<p class="para">Añadir un grupo</p>
...
<li class="list itemizedlist">
		<p class="para">Borrar un grupo</p>
...
<li class="list itemizedlist">
		<p class="para">Añadir un usuario al grupo:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapaddusertogroup george qa</span>
</pre></div>

		<p class="para">Ahora debería ver un atributo <span class="em emphasis">memberUid</span> para el grupo <span class="em emphasis">qa</span> con un valor de <span class="em emphasis">george</span>.</p>
	</li>
<li class="list itemizedlist">
		<p class="para">Eliminar un usuario de un grupo:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapdeleteuserfromgroup george qa</span>
</pre></div>

		<p class="para">El atributo <span class="em emphasis">memberUid</span> debería ser eliminado ahora del grupo <span class="em emphasis">qa</span>.</p>
	</li>
<li class="list itemizedlist">
		<p class="para">El guión <span class="app application">ldapmodifyuser</span> permite añadir, eliminar o remplazar un atributo de usuario. El guión usa la misma sintaxis que la utilidad <span class="app application">ldapmodify</span>. Por ejemplo:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapmodifyuser george</span>
<span class="output computeroutput"># Sobre como modificar la siguiente entrada :
...
gecos: George Carlin</span>
		...
		<p class="para">El usuario <span class="em emphasis">gecos</span> debería ser ahora <span class="quote">«George Carlin»</span>.</p>
	</li>
<li class="list itemizedlist">
		<p class="para">
...
<div class="hgroup"><h2 class="title">Respaldar y restaurar</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="list itemizedlist">
	<p class="para">Other man pages:</p>
