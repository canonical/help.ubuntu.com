...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.nl" title="Handleiding Ubuntu-server">Handleiding Ubuntu-server</a> » <a class="trail" href="network-authentication.html.nl" title="Network Authentication">Network Authentication</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="network-authentication.html.nl" title="Network Authentication">Vorige</a><a class="nextlinks-next" href="samba-ldap.html.nl" title="Samba and LDAP">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-server-installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-server-postinstall" title="Post-install Inspection">Post-install Inspection</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-server-populate" title="Modifying/Populating your Database">Modifying/Populating your Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-server-logging" title="Logging">Logging</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-server-replication" title="Replication">Replication</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-server-acl" title="Access Control">Access Control</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-tls" title="TLS">TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-tls-replication" title="Replication and TLS">Replication and TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-auth-config" title="LDAP Authentication">LDAP Authentication</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#ldap-usergroup-management" title="User and Group Management">User and Group Management</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#ldap-backup" title="Backup and Restore">Backup and Restore</a></li>
<li class="links"><a class="xref" href="openldap-server.html.nl#openldap-server-resources" title="Resources">Resources</a></li>
</ul></div>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html.nl#openldap-server-installation" title="Installatie">Installatie</a>. Make sure the slapd-config
...
<p class="para">
	The assumption here is that you have set up replication between Provider and Consumer according to <a class="xref" href="openldap-server.html.nl#openldap-server-replication" title="Replication">Replication</a>
	and have configured TLS for authentication on the Provider by following <a class="xref" href="openldap-server.html.nl#openldap-tls" title="TLS">TLS</a>.
	</p>
<p class="para">
...
<p class="para">
	...
	<a class="xref" href="samba-ldap.html.nl" title="Samba and LDAP">Samba and LDAP</a> for details.
	</p>
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
