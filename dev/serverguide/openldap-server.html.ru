...
<a class="nextlinks-prev" href="network-authentication.html.ru" title="Сетевая аутентификация">Назад</a><a class="nextlinks-next" href="samba-ldap.html.ru" title="Samba и LDAP">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-server-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-server-postinstall" title="Проверка после установки">Проверка после установки</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-server-populate" title="Изменение/заполнение вашей базы данных">Изменение/заполнение вашей базы данных</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-configuration" title="Изменение базы данных настройки slapd">Изменение базы данных настройки slapd</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-server-logging" title="Ведение журнала">Ведение журнала</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-server-replication" title="Репликация">Репликация</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-server-acl" title="Управление доступом">Управление доступом</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-tls" title="TLS">TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-tls-replication" title="Репликация и TLS">Репликация и TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-auth-config" title="Установление подлинности через LDAP">Установление подлинности через LDAP</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#ldap-usergroup-management" title="Управление пользователями и группами">Управление пользователями и группами</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#ldap-backup" title="Резервное копирование и восстановление">Резервное копирование и восстановление</a></li>
<li class="links"><a class="xref" href="openldap-server.html.ru#openldap-server-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html.ru#openldap-server-installation" title="Установка">Установка</a>. Make sure the slapd-config
...
<p class="para">Если вы собираетесь использовать LDAP для хранения пользователей SAMBA, вам потребуется настроить SAMBA сервер на использование LDAP. Смотрите <a class="xref" href="samba-ldap.html.ru" title="Samba и LDAP">Samba и LDAP</a> для подробностей.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
