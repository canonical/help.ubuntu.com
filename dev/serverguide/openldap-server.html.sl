...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="network-authentication.html.sl" title="Overitev omrežja">Overitev omrežja</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="network-authentication.html.sl" title="Overitev omrežja">Nazaj</a><a class="nextlinks-next" href="samba-ldap.html.sl" title="Samba in LDAP">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Strežnik OpenLDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-server-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-server-postinstall" title="Post-install Inspection">Post-install Inspection</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-server-populate" title="Modifying/Populating your Database">Modifying/Populating your Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-server-logging" title="Logging">Logging</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-server-replication" title="Replication">Replication</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-server-acl" title="Access Control">Access Control</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-tls" title="TLS">TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-tls-replication" title="Replication and TLS">Replication and TLS</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-auth-config" title="Overitev LDAP">Overitev LDAP</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#ldap-usergroup-management" title="Upravljanje uporabnikov in skupin">Upravljanje uporabnikov in skupin</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#ldap-backup" title="Backup and Restore">Backup and Restore</a></li>
<li class="links"><a class="xref" href="openldap-server.html.sl#openldap-server-resources" title="Viri">Viri</a></li>
</ul></div>
...
<li class="steps">
		<p class="para">
		Install the software by going through <a class="xref" href="openldap-server.html.sl#openldap-server-installation" title="Namestitev">Namestitev</a>. Make sure the slapd-config
...
<div class="hgroup"><h3 class="title">Preizkušanje</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="steps">
		<p class="para">Ustvarite zasebni ključ strežnika:</p>
...
<li class="steps">
		<p class="para">Ustvarite potrdilo strežnika:</p>
...
<p class="para">
	The assumption here is that you have set up replication between Provider and Consumer according to <a class="xref" href="openldap-server.html.sl#openldap-server-replication" title="Replication">Replication</a>
	and have configured TLS for authentication on the Provider by following <a class="xref" href="openldap-server.html.sl#openldap-tls" title="TLS">TLS</a>.
	</p>
<p class="para">
...
<div class="hgroup"><h2 class="title">Overitev LDAP</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
	...
	<a class="xref" href="samba-ldap.html.sl" title="Samba in LDAP">Samba in LDAP</a> for details.
	</p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
...
<div class="hgroup"><h2 class="title">Upravljanje uporabnikov in skupin</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
		<p class="para">Ustvarite novega uporabnika</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapadduser gregor primer</span>
</pre></div>
...
<li class="list itemizedlist">
		<p class="para">Spremenite geslo uporabnika:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapsetpasswd gregor</span>
<span class="output computeroutput">Changing password for user uid=george,ou=People,dc=example,dc=com</span>
<span class="input userinput">Novo geslo: </span>
<span class="input userinput">New Password (verify): </span>
</pre></div>

	</li>
<li class="list itemizedlist">
		<p class="para">Izbrišite uporabnika:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapdeleteuser gregor</span>
</pre></div>

	</li>
<li class="list itemizedlist">
		<p class="para">Dodajte skupino:</p>
...
<li class="list itemizedlist">
		<p class="para">Odstranite skupino:</p>
...
<li class="list itemizedlist">
		<p class="para">Dodajte uporabnika skupini:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapaddusertogroup gregor qa</span>
</pre></div>
...
<li class="list itemizedlist">
		<p class="para">Odstranite uporabnika iz skupine:</p>

<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapdeleteuserfromgroup gregor qa</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo ldapmodifyuser gregor</span>
...
<div class="hgroup"><h2 class="title">Viri</h2></div>
