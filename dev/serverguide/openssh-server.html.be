...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="remote-administration.html.be" title="Remote Administration">Remote Administration</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="remote-administration.html.be" title="Remote Administration">Назад</a><a class="nextlinks-next" href="puppet.html.be" title="Puppet">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">OpenSSH Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="openssh-server.html.be#openssh-introduction" title="Уводзіны">Уводзіны</a></li>
<li class="links"><a class="xref" href="openssh-server.html.be#openssh-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="openssh-server.html.be#openssh-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="openssh-server.html.be#openssh-keys" title="Ключы SSH">Ключы SSH</a></li>
<li class="links"><a class="xref" href="openssh-server.html.be#openssh-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<li class="list itemizedlist">
	     ...
	     <span class="file filename">/etc/issue.net</span> file as a pre-login
             banner, simply add or modify the line:
               ...
               <p class="para">У файле <span class="file filename">/etc/ssh/sshd_config</span>.</p>
             </li>
</ul></div>
<p class="para">
...
<div class="hgroup"><h2 class="title">Ключы SSH</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="list itemizedlist">
          <p class="para">
          <a href="http://www.openssh.org/" class="ulink" title="http://www.openssh.org/">Вэб-старонка OpenSSH</a>
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
