...
<a class="nextlinks-prev" href="remote-administration.html.es" title="Administración Remota">Anterior</a><a class="nextlinks-next" href="puppet.html.es" title="Puppet">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Servidor OpenSSH</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="openssh-server.html.es#openssh-introduction" title="Introducción">Introducción</a></li>
<li class="links"><a class="xref" href="openssh-server.html.es#openssh-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="openssh-server.html.es#openssh-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="openssh-server.html.es#openssh-keys" title="Claves SSH">Claves SSH</a></li>
<li class="links"><a class="xref" href="openssh-server.html.es#openssh-references" title="Referencias">Referencias</a></li>
</ul></div>
