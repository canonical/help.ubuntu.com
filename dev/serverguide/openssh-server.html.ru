...
<a class="nextlinks-prev" href="remote-administration.html.ru" title="Удалённое администрирование">Назад</a><a class="nextlinks-next" href="puppet.html.ru" title="Puppet">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Сервер OpenSSH</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="openssh-server.html.ru#openssh-introduction" title="Введение">Введение</a></li>
<li class="links"><a class="xref" href="openssh-server.html.ru#openssh-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="openssh-server.html.ru#openssh-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="openssh-server.html.ru#openssh-keys" title="Ключи SSH">Ключи SSH</a></li>
<li class="links"><a class="xref" href="openssh-server.html.ru#openssh-references" title="Ссылки">Ссылки</a></li>
</ul></div>
