...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="remote-administration.html.sl" title="Oddaljeno skrbništvo">Oddaljeno skrbništvo</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="remote-administration.html.sl" title="Oddaljeno skrbništvo">Nazaj</a><a class="nextlinks-next" href="puppet.html.sl" title="Puppet">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Strežnik OpenSSH</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="openssh-server.html.sl#openssh-introduction" title="Uvod">Uvod</a></li>
<li class="links"><a class="xref" href="openssh-server.html.sl#openssh-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="openssh-server.html.sl#openssh-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="openssh-server.html.sl#openssh-keys" title="Ključi SSH">Ključi SSH</a></li>
<li class="links"><a class="xref" href="openssh-server.html.sl#openssh-references" title="Sklici">Sklici</a></li>
</ul></div>
<div class="sect2 sect" id="openssh-introduction"><div class="inner">
<div class="hgroup"><h2 class="title">Uvod</h2></div>
...
<li class="list itemizedlist">
	     ...
	     <span class="file filename">/etc/issue.net</span> file as a pre-login
             banner, simply add or modify the line:
               ...
               <p class="para">V datoteki <span class="file filename">/etc/ssh/sshd_config</span>.</p>
             </li>
</ul></div>
<p class="para">
...
<div class="hgroup"><h2 class="title">Ključi SSH</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="list itemizedlist">
          <p class="para">Stran <a href="https://help.ubuntu.com/community/SSH" class="ulink" title="https://help.ubuntu.com/community/SSH">SSH na Ubuntu Wiki</a>.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
          <a href="http://www.openssh.org/" class="ulink" title="http://www.openssh.org/">Spletna stran OpenSSH</a>
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
