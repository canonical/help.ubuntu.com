...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="vpn.html.be" title="VPN">VPN</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="vpn.html.be" title="VPN">Назад</a><a class="nextlinks-next" href="other-useful-applications.html.be" title="Other Useful Applications">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="openvpn.html.be#openvpn-server-installation" title="Server Installation">Server Installation</a></li>
<li class="links"><a class="xref" href="openvpn.html.be#openvpn-pki-setup" title="Public Key Infrastructure Setup">Public Key Infrastructure Setup</a></li>
<li class="links"><a class="xref" href="openvpn.html.be#openvpn-simple-server-configuration" title="Simple Server Configuration">Simple Server Configuration</a></li>
<li class="links"><a class="xref" href="openvpn.html.be#openvpn-simple-client-configuration" title="Simple Client Configuration">Simple Client Configuration</a></li>
<li class="links"><a class="xref" href="openvpn.html.be#openvpn-first-troubleshooting" title="First trouble shooting">First trouble shooting</a></li>
<li class="links"><a class="xref" href="openvpn.html.be#openvpn-advanced-config" title="Advanced configuration">Advanced configuration</a></li>
<li class="links"><a class="xref" href="openvpn.html.be#openvpn-client-implementations" title="Client software implementations">Client software implementations</a></li>
<li class="links"><a class="xref" href="openvpn.html.be#openvpn-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<p class="para">
      To install <span class="app application">openvpn</span> in a terminal enter:
      </p>
...
<p class="para">
        Next, edit <span class="file filename">/etc/openvpn/easy-rsa/vars</span> adjusting the following to your environment:
        </p>
...
<div class="hgroup"><h3 class="title">Server Certificates</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Client Certificates</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents"> <p class="para">
...
<div class="region"><div class="contents">
<p class="para">
        Edit <span class="file filename">/etc/openvpn/server.conf</span> changing the following options to:
        </p>
...
<p class="para">
        After configuring the server, restart <span class="app application">openvpn</span> by entering:
        </p>
...
<div class="hgroup"><h4 class="title">Client Configuration</h4></div>
<div class="region"><div class="contents">
<p class="para">
        First, install <span class="app application">openvpn</span> on the client:
        </p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt install openvpn</span>
</pre></div>
<p class="para">
        Then with the server configured and the client certificates copied to the <span class="file filename">/etc/openvpn/</span> directory, create a client configuration file by 
        copying the example.  In a terminal on the client machine enter:
        </p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo cp /usr/share/doc/openvpn/examples/sample-config-files/client.conf /etc/openvpn</span>
</pre></div>
<p class="para">
        Now edit <span class="file filename">/etc/openvpn/client.conf</span> changing the following options:
        </p>
...
<p class="para">
        Finally, restart <span class="app application">openvpn</span>:
        </p>
...
<li class="list itemizedlist">
          <p class="para">
          See the <a href="http://openvpn.net/" class="ulink" title="http://openvpn.net/">OpenVPN</a> website for additional information.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<li class="list itemizedlist">
          <p class="para">
          Also, Pakt's <a href="http://www.packtpub.com/openvpn/book" class="ulink" title="http://www.packtpub.com/openvpn/book">OpenVPN: Building and Integrating Virtual Private Networks</a> 
          is a good resource.
          </p>
        </li>
</ul></div></div></div>
