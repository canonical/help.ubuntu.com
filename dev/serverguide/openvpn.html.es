...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="vpn.html.es" title="VPN">VPN</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="vpn.html.es" title="VPN">Anterior</a><a class="nextlinks-next" href="other-useful-applications.html.es" title="Otras aplicaciones útiles">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="openvpn.html.es#openvpn-server-installation" title="Instalación del servidor">Instalación del servidor</a></li>
<li class="links"><a class="xref" href="openvpn.html.es#openvpn-pki-setup" title="Configuración de la infraestructura de clave pública">Configuración de la infraestructura de clave pública</a></li>
<li class="links"><a class="xref" href="openvpn.html.es#openvpn-simple-server-configuration" title="Configuración sencilla de servidor">Configuración sencilla de servidor</a></li>
<li class="links"><a class="xref" href="openvpn.html.es#openvpn-simple-client-configuration" title="Configuración sencilla de cliente">Configuración sencilla de cliente</a></li>
<li class="links"><a class="xref" href="openvpn.html.es#openvpn-first-troubleshooting" title="First trouble shooting">First trouble shooting</a></li>
<li class="links"><a class="xref" href="openvpn.html.es#openvpn-advanced-config" title="Configuración avanzada">Configuración avanzada</a></li>
<li class="links"><a class="xref" href="openvpn.html.es#openvpn-client-implementations" title="Implementaciones de software en el cliente">Implementaciones de software en el cliente</a></li>
<li class="links"><a class="xref" href="openvpn.html.es#openvpn-references" title="Referencias">Referencias</a></li>
</ul></div>
