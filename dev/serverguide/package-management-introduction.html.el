...
<a class="nextlinks-prev" href="package-management.html.el" title="Διαχείριση Πακέτων">Προηγούμενο</a><a class="nextlinks-next" href="dpkg.html.el" title="dpkg">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Εισαγωγή</h1></div>
<div class="region"><div class="contents">
<p class="para">Το σύστημα διαχείρισης πακέτων Ubuntu προέρχεται από το ίδιο σύστημα που χρησιμοποιείται από την έκδοση Debian GNU/Linux. Τα αρχεία πακέτων περιέχουν όλα τα κατάλληλα αρχεία, μετα-δεδομένα, και πληροφορίες για την εφαρμογή μια συγκεκριμένης λειτουργίας ή εφαρμογής λογισμικού στον υπολογιστή Ubuntu σας.</p>
<p class="para">
