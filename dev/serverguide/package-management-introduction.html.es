...
<a class="nextlinks-prev" href="package-management.html.es" title="Gestión de paquetes">Anterior</a><a class="nextlinks-next" href="dpkg.html.es" title="dpkg">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Introducción</h1></div>
<div class="region"><div class="contents">
<p class="para">El sistema de gestión de paquetes de Ubuntu está derivado del mismo sistema utilizado por la distribución Debian GNU/Linux. Los paquetes contienen todos los archivos necesarios, meta-datos e instrucciones para implementar una funcionalidad particular o una aplicación software en un equipo Ubuntu.</p>
<p class="para">
