...
<a class="nextlinks-prev" href="package-management.html.mk" title="Менаџмент на пакети">Previous</a><a class="nextlinks-next" href="dpkg.html.mk" title="dpkg">Next</a>
</div>
<div class="hgroup"><h1 class="title">Вовед</h1></div>
<div class="region"><div class="contents">
<p class="para">Системот за менаџирање со пакети на Ubuntu е изведен од истиот систем што се користи кај Debian GNU/Linux дистрибуцијата. Датотеките на пакетот ги содржат сите потребни датотеки, мета-податоци, како и инструкции за имплементирање на одредена функционалност или софтверска апликација на вашиот Ubuntu компјутер.</p>
<p class="para">
