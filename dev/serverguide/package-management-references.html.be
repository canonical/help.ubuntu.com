...
<a class="nextlinks-prev" href="configuration.html.be" title="Настаўленьні">Назад</a><a class="nextlinks-next" href="networking.html.be" title="Сеціва">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Спасылкі</h1></div>
<div class="region"><div class="contents">
<p class="para">
    Most of the material covered in this chapter is available in <span class="app application">man</span> pages, many of which are available
    online.
    </p>
...
<li class="list itemizedlist">
        <p class="para">
        The <a href="https://help.ubuntu.com/community/Repositories/Ubuntu" class="ulink" title="https://help.ubuntu.com/community/Repositories/Ubuntu">Adding Repositories HOWTO (Ubuntu Wiki)</a> page
