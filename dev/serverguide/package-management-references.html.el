...
<a class="nextlinks-prev" href="configuration.html.el" title="Ρυθμίσεις">Προηγούμενο</a><a class="nextlinks-next" href="networking.html.el" title="Δικτύωση">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Αναφορές</h1></div>
<div class="region"><div class="contents">
<p class="para">Το περισσότερο από το υλικό που καλύπτεται σε αυτό το κεφάλαιο είναι διαθέσιμο στις σελίδες <span class="app application">man</span>, πολλές από τις οποίες είναι διαθέσιμες online.</p>
...
<li class="list itemizedlist">
        <p class="para">Η σελίδα <a href="https://help.ubuntu.com/community/Repositories/Ubuntu" class="ulink" title="https://help.ubuntu.com/community/Repositories/Ubuntu">Adding Repositories HOWTO (Ubuntu Wiki)</a> περιέχει περισσότερες λεπτομέρειες για την προσθήκη αποθετηρίων.</p>
      </li>
</ul></div>
</div></div>
<div class="links nextlinks">
