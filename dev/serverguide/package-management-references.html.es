...
<a class="nextlinks-prev" href="configuration.html.es" title="Configuración">Anterior</a><a class="nextlinks-next" href="networking.html.es" title="Red">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Referencias</h1></div>
<div class="region"><div class="contents">
<p class="para">La mayoria del material expuesto en este capitulo esta disponible en la páginas de <span class="app application">man</span>, muchas de las cuales están disponibles en línea.</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
        <p class="para">La <a href="https://help.ubuntu.com/community/InstallingSoftware" class="ulink" title="https://help.ubuntu.com/community/InstallingSoftware">InstallingSoftware</a> página wiki de Ubuntu tiene más información.</p>
      </li>
<li class="list itemizedlist">
        <p class="para">
...
<li class="list itemizedlist">
        <p class="para">La página <a href="https://help.ubuntu.com/community/Repositories/Ubuntu" class="ulink" title="https://help.ubuntu.com/community/Repositories/Ubuntu">COMO añadir repositorios (Ubuntu Wiki)</a> contiene más detalles sobre como añadir repositorios.</p>
      </li>
</ul></div>
</div></div>
<div class="links nextlinks">
