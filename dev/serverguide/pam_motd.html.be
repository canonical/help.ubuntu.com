...
<a class="nextlinks-prev" href="other-useful-applications.html.be" title="Other Useful Applications">Назад</a><a class="nextlinks-next" href="etckeeper.html.be" title="etckeeper">Наперад</a>
</div>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
        <p class="para">Спачатку ўстанавіце пакет <span class="app application">weather-util</span>:</p>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="pam_motd.html.be#pam_motd-resources" title="Рэсурсы">Рэсурсы</a></li></ul></div>
