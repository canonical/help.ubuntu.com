...
<a class="nextlinks-prev" href="other-useful-applications.html.el" title="Άλλες Χρήσιμες Εφαρμογές">Προηγούμενο</a><a class="nextlinks-next" href="etckeeper.html.el" title="etckeeper">Επόμενο</a>
</div>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="pam_motd.html.el#pam_motd-resources" title="Πόροι">Πόροι</a></li></ul></div>
