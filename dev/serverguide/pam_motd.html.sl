...
<a class="nextlinks-prev" href="other-useful-applications.html.sl" title="Drugi uporabni programi">Nazaj</a><a class="nextlinks-next" href="etckeeper.html.sl" title="etckeeper">Naprej</a>
</div>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
        <p class="para">Najprej namestite paket <span class="app application">weather-util</span>:</p>
...
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="pam_motd.html.sl#pam_motd-resources" title="Viri">Viri</a></li></ul></div>
