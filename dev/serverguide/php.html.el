...
<a class="nextlinks-prev" href="httpd.html.el" title="HTTPD - Apache2 Διακομιστής Ιστού">Προηγούμενο</a><a class="nextlinks-next" href="squid.html.el" title="Squid - Διακομιστής Διαμεσολαβητή">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="php.html.el#php-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="php.html.el#php-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="php.html.el#php-testing" title="Δοκιμή">Δοκιμή</a></li>
<li class="links"><a class="xref" href="php.html.el#php-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
