...
<a class="nextlinks-prev" href="httpd.html.es" title="HTTPD - Servidor web Apache2">Anterior</a><a class="nextlinks-next" href="squid.html.es" title="Servidor proxy Squid">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="php.html.es#php-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="php.html.es#php-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="php.html.es#php-testing" title="Comprobando">Comprobando</a></li>
<li class="links"><a class="xref" href="php.html.es#php-references" title="Referencias">Referencias</a></li>
</ul></div>
<div class="sect2 sect" id="php-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Instalación</h2></div>
<div class="region"><div class="contents">
<p class="para">PHP está disponible en Ubuntu. A diferencia de Python y Perl, que se instalan como parte del sistema básico, PHP debe instalarse por separado.</p>
