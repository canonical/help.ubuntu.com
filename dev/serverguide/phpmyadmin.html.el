...
<a class="nextlinks-prev" href="moinmoin.html.el" title="Moin Moin">Προηγούμενο</a><a class="nextlinks-next" href="wordpress.html.el" title="WordPress">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="phpmyadmin.html.el#phpmyadmin-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="phpmyadmin.html.el#phpmyadmin-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="phpmyadmin.html.el#phpmyadmin-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
<div class="sect2 sect" id="phpmyadmin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Εγκατάσταση</h2></div>
<div class="region"><div class="contents">
<p class="para">Πριν εγκαταστήσετε το <span class="app application">phpMyAdmin</span> θα χρειαστείτε πρόσβαση σε μια βάση δεδομένων <span class="app application">MySQL</span> είτε στον ίδιο υπολογιστή που είναι εγκατεστημένο το phpMyAdmin, ή σε έναν υπολογιστή προσβάσιμο μέσω δικτύου. Για περισσότερες πληροφορίες δείτε εδώ: <a class="xref" href="mysql.html.el" title="MySQL">MySQL</a>. Σε ένα τερματικό πληκτρολογήστε:</p>
...
<p class="para">
      ...
      <span class="app application">Apache2</span> see <a class="xref" href="httpd.html.el" title="HTTPD - Apache2 Διακομιστής Ιστού">HTTPD - Apache2 Διακομιστής Ιστού</a>.
      </p>
</div></div>
</div></div>
