...
<a class="nextlinks-prev" href="moinmoin.html.es" title="Moin Moin">Anterior</a><a class="nextlinks-next" href="wordpress.html.es" title="WordPress">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="phpmyadmin.html.es#phpmyadmin-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="phpmyadmin.html.es#phpmyadmin-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="phpmyadmin.html.es#phpmyadmin-references" title="Referencias">Referencias</a></li>
</ul></div>
<div class="sect2 sect" id="phpmyadmin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Instalación</h2></div>
<div class="region"><div class="contents">
<p class="para">Previo a la instalación de <span class="app application">phpMyAdmin</span> necesita acceso a una base de datos de <span class="app application">MySQL</span> , ya sea en el mismo anfitrión en el que está instalada phpMyAdmin o en un anfitrión que se pueda acceder a través de la red. Para más información vea <a class="xref" href="mysql.html.es" title="MySQL">MySQL</a>. Desde una terminal escriba:</p>
...
<p class="para">
      ...
      <span class="app application">Apache2</span> see <a class="xref" href="httpd.html.es" title="HTTPD - Servidor web Apache2">HTTPD - Servidor web Apache2</a>.
      </p>
</div></div>
</div></div>
