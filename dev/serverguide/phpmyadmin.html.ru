...
<a class="nextlinks-prev" href="moinmoin.html.ru" title="Moin Moin">Назад</a><a class="nextlinks-next" href="wordpress.html.ru" title="WordPress">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="phpmyadmin.html.ru#phpmyadmin-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="phpmyadmin.html.ru#phpmyadmin-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="phpmyadmin.html.ru#phpmyadmin-references" title="Ссылки">Ссылки</a></li>
</ul></div>
<div class="sect2 sect" id="phpmyadmin-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Установка</h2></div>
<div class="region"><div class="contents">
<p class="para">Перед установкой <span class="app application">phpMyAdmin</span> вам понадобится доступ к базе данных <span class="app application">MySQL</span> либо на том же хосте, на который установлен phpMyAdmin, либо на хосте, доступном по сети. Для дополнительной информации смотрите <a class="xref" href="mysql.html.ru" title="MySQL">MySQL</a>. Наберите в терминале:</p>
...
<p class="para">
      ...
      <span class="app application">Apache2</span> see <a class="xref" href="httpd.html.ru" title="HTTPD - веб сервер Apache2">HTTPD - веб сервер Apache2</a>.
      </p>
</div></div>
</div></div>
