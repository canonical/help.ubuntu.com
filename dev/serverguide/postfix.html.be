...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="email-services.html.be" title="Email Services">Email Services</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="email-services.html.be" title="Email Services">Назад</a><a class="nextlinks-next" href="exim4.html.be" title="Exim4">Наперад</a>
</div>
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
            ...
            on Virtual Domains and other advanced configurations see <a class="xref" href="postfix.html.be#postfix-references" title="Спасылкі">Спасылкі</a>.
            </p>
          </div></div></div></div>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="postfix.html.be#postfix-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="postfix.html.be#postfix-configuration" title="Basic Configuration">Basic Configuration</a></li>
<li class="links"><a class="xref" href="postfix.html.be#postfix-smtp-authentication" title="SMTP Authentication">SMTP Authentication</a></li>
<li class="links"><a class="xref" href="postfix.html.be#postfix-sasl" title="Наладка SASL">Наладка SASL</a></li>
<li class="links"><a class="xref" href="postfix.html.be#mail-stack-delivery" title="Mail-Stack Delivery">Mail-Stack Delivery</a></li>
<li class="links"><a class="xref" href="postfix.html.be#postfix-testing" title="Праверка">Праверка</a></li>
<li class="links"><a class="xref" href="postfix.html.be#postfix-troubleshooting" title="Troubleshooting">Troubleshooting</a></li>
</ul></div>
...
<li class="list itemizedlist"><p class="para">Інтэрнэт сайт</p></li>
...
<li class="list itemizedlist"><p class="para">Не</p></li>
...
<li class="list itemizedlist"><p class="para">усе</p></li>
</ul></div>
            </p>
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
            <p class="para">
...
<li class="steps">
                <p class="para">
                Next, generate or obtain a digital certificate for TLS. See <a class="xref" href="certificates-and-security.html.be" title="Certificates">Certificates</a> for details.
                This example also uses a Certificate Authority (CA).  For information on generating a CA certificate see
                <a class="xref" href="certificates-and-security.html.be#certificate-authority" title="Certification Authority">Certification Authority</a>.
	        </p>
		<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
                <p class="para">
		...
		<a class="xref" href="certificates-and-security.html.be#creating-a-self-signed-certificate" title="Creating a Self-Signed Certificate">Creating a Self-Signed Certificate</a> for more details.
                </p>
                </div></div></div></div>
		</li>
<li class="steps">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo postconf -e 'smtpd_tls_CAfile = /etc/ssl/certs/cacert.pem'</span>
                  ...
                  <p class="para">
                  Again, for more details about certificates see <a class="xref" href="certificates-and-security.html.be" title="Certificates">Certificates</a>.
                  </p>
                </li>
</ol></div></div>
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title">Наладка SASL</h2></div>
<div class="region"><div class="contents">
<p class="para">	              
...
<p class="para">
            ...
            See <a class="xref" href="certificates-and-security.html.be" title="Certificates">Certificates</a> for more details.
            </p>
<p class="para">
...
<p class="para">Пасьля перазапусьціце Postfix:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart postfix.service</span>
</pre></div>
</div></div>
</div></div>
...
<p class="para">і зьміце наступным чынам:</p>
...
<div class="hgroup"><h3 class="title">Спасылкі</h3></div>
<div class="region"><div class="contents">
<p class="para">
