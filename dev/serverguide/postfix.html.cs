...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.cs" title="Průvodce pro Ubuntu Server">Průvodce pro Ubuntu Server</a> » <a class="trail" href="email-services.html.cs" title="Email Services">Email Services</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="email-services.html.cs" title="Email Services">Předchozí</a><a class="nextlinks-next" href="exim4.html.cs" title="Exim4">Následující</a>
</div>
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
            ...
            on Virtual Domains and other advanced configurations see <a class="xref" href="postfix.html.cs#postfix-references" title="References">References</a>.
            </p>
          </div></div></div></div>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="postfix.html.cs#postfix-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="postfix.html.cs#postfix-configuration" title="Basic Configuration">Basic Configuration</a></li>
<li class="links"><a class="xref" href="postfix.html.cs#postfix-smtp-authentication" title="SMTP Authentication">SMTP Authentication</a></li>
<li class="links"><a class="xref" href="postfix.html.cs#postfix-sasl" title="Configuring SASL">Configuring SASL</a></li>
<li class="links"><a class="xref" href="postfix.html.cs#mail-stack-delivery" title="Mail-Stack Delivery">Mail-Stack Delivery</a></li>
<li class="links"><a class="xref" href="postfix.html.cs#postfix-testing" title="Testing">Testing</a></li>
<li class="links"><a class="xref" href="postfix.html.cs#postfix-troubleshooting" title="Troubleshooting">Troubleshooting</a></li>
</ul></div>
...
<li class="steps">
                <p class="para">
                Next, generate or obtain a digital certificate for TLS. See <a class="xref" href="certificates-and-security.html.cs" title="Certificates">Certificates</a> for details.
                This example also uses a Certificate Authority (CA).  For information on generating a CA certificate see
                <a class="xref" href="certificates-and-security.html.cs#certificate-authority" title="Certification Authority">Certification Authority</a>.
	        </p>
		<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
                <p class="para">
		...
		<a class="xref" href="certificates-and-security.html.cs#creating-a-self-signed-certificate" title="Creating a Self-Signed Certificate">Creating a Self-Signed Certificate</a> for more details.
                </p>
                </div></div></div></div>
		</li>
<li class="steps">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo postconf -e 'smtpd_tls_CAfile = /etc/ssl/certs/cacert.pem'</span>
                  ...
                  <p class="para">
                  Again, for more details about certificates see <a class="xref" href="certificates-and-security.html.cs" title="Certificates">Certificates</a>.
                  </p>
                </li>
</ol></div></div>
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
...
<p class="para">
            ...
            See <a class="xref" href="certificates-and-security.html.cs" title="Certificates">Certificates</a> for more details.
            </p>
<p class="para">
