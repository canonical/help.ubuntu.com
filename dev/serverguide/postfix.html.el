...
<a class="nextlinks-prev" href="email-services.html.el" title="Υπηρεσίες Ηλ. Αλληλογραφίας">Προηγούμενο</a><a class="nextlinks-next" href="exim4.html.el" title="Exim4">Επόμενο</a>
</div>
...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
            <p class="para">Αυτός ο οδηγός δεν καλύπτει την εγκατάσταση <span class="em emphasis">Εικονικών τομέων (Virtual Domains)</span> για το Postfix. Για πληροφορίες σχετικά με τους εικονικούς τομείς και άλλες προχωρημένες δυνατότητες, δείτε το <a class="xref" href="postfix.html.el#postfix-references" title="Αναφορές">Αναφορές</a>.</p>
          </div></div></div></div>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="postfix.html.el#postfix-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="postfix.html.el#postfix-configuration" title="Βασικές ρυθμίσεις">Βασικές ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="postfix.html.el#postfix-smtp-authentication" title="Πιστοποίηση SMTP">Πιστοποίηση SMTP</a></li>
<li class="links"><a class="xref" href="postfix.html.el#postfix-sasl" title="Ρύθμιση του SASL">Ρύθμιση του SASL</a></li>
<li class="links"><a class="xref" href="postfix.html.el#mail-stack-delivery" title="Mail-Stack Delivery">Mail-Stack Delivery</a></li>
<li class="links"><a class="xref" href="postfix.html.el#postfix-testing" title="Δοκιμή">Δοκιμή</a></li>
<li class="links"><a class="xref" href="postfix.html.el#postfix-troubleshooting" title="Επίλυση Προβλημάτων">Επίλυση Προβλημάτων</a></li>
</ul></div>
...
<li class="steps">
                <p class="para">
                Next, generate or obtain a digital certificate for TLS. See <a class="xref" href="certificates-and-security.html.el" title="Πιστοποιητικά">Πιστοποιητικά</a> for details.
                This example also uses a Certificate Authority (CA).  For information on generating a CA certificate see
                <a class="xref" href="certificates-and-security.html.el#certificate-authority" title="Αρχή Πιστοποίησης">Αρχή Πιστοποίησης</a>.
	        </p>
		<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
                <p class="para">
		...
		<a class="xref" href="certificates-and-security.html.el#creating-a-self-signed-certificate" title="Δημιουργία ενός Πιστοποιητικού Υπογεγραμμένου από εσάς">Δημιουργία ενός Πιστοποιητικού Υπογεγραμμένου από εσάς</a> for more details.
                </p>
                </div></div></div></div>
		</li>
<li class="steps">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo postconf -e 'smtpd_tls_CAfile = /etc/ssl/certs/cacert.pem'</span>
                  ...
                  <p class="para">
                  Again, for more details about certificates see <a class="xref" href="certificates-and-security.html.el" title="Πιστοποιητικά">Πιστοποιητικά</a>.
                  </p>
                </li>
</ol></div></div>
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents">
...
<p class="para">
            ...
            See <a class="xref" href="certificates-and-security.html.el" title="Πιστοποιητικά">Πιστοποιητικά</a> for more details.
            </p>
<p class="para">
