...
<a class="nextlinks-prev" href="email-services.html.es" title="Servicios de correo electrónico">Anterior</a><a class="nextlinks-next" href="exim4.html.es" title="Exim4">Siguiente</a>
</div>
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
            <p class="para">Esta guía no cubre la configuración de <span class="em emphasis">Dominios virtuales</span> Postfix, para información sobre dominios virtuales y otras configuraciones avanzadas, vea <a class="xref" href="postfix.html.es#postfix-references" title="Referencias">Referencias</a>.</p>
          </div></div></div></div>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="postfix.html.es#postfix-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="postfix.html.es#postfix-configuration" title="Configuración básica">Configuración básica</a></li>
<li class="links"><a class="xref" href="postfix.html.es#postfix-smtp-authentication" title="Autentificación SMTP">Autentificación SMTP</a></li>
<li class="links"><a class="xref" href="postfix.html.es#postfix-sasl" title="Configuración de SASL">Configuración de SASL</a></li>
<li class="links"><a class="xref" href="postfix.html.es#mail-stack-delivery" title="Mail-Stack Delivery">Mail-Stack Delivery</a></li>
<li class="links"><a class="xref" href="postfix.html.es#postfix-testing" title="Comprobando">Comprobando</a></li>
<li class="links"><a class="xref" href="postfix.html.es#postfix-troubleshooting" title="Resolución de problemas">Resolución de problemas</a></li>
</ul></div>
...
<li class="steps">
                <p class="para">
                Next, generate or obtain a digital certificate for TLS. See <a class="xref" href="certificates-and-security.html.es" title="Certificados">Certificados</a> for details.
                This example also uses a Certificate Authority (CA).  For information on generating a CA certificate see
                <a class="xref" href="certificates-and-security.html.es#certificate-authority" title="Autoridad de certificación">Autoridad de certificación</a>.
	        </p>
		<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
                <p class="para">
		...
		<a class="xref" href="certificates-and-security.html.es#creating-a-self-signed-certificate" title="Creación de un certificado auto-firmado">Creación de un certificado auto-firmado</a> for more details.
                </p>
                </div></div></div></div>
		</li>
<li class="steps">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo postconf -e 'smtpd_tls_CAfile = /etc/ssl/certs/cacert.pem'</span>
                  ...
                  <p class="para">Una vez más, para tener más detalles sobre los certificados, vea <a class="xref" href="certificates-and-security.html.es" title="Certificados">Certificados</a>.</p>
                </li>
</ol></div></div>
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
...
<p class="para">
            ...
            See <a class="xref" href="certificates-and-security.html.es" title="Certificados">Certificados</a> for more details.
            </p>
<p class="para">
