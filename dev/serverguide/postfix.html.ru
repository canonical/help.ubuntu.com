...
<a class="nextlinks-prev" href="email-services.html.ru" title="Сервисы электронной почты">Назад</a><a class="nextlinks-next" href="exim4.html.ru" title="Exim4">Вперёд</a>
</div>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
            <p class="para">Это руководство не рассматривает настройку <span class="em emphasis">виртуальных доменов</span> postfix. Для получения информации по виртуальным доменам и другим расширенным настройкам смотрите <a class="xref" href="postfix.html.ru#postfix-references" title="Ссылки">Ссылки</a>.</p>
          </div></div></div></div>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="postfix.html.ru#postfix-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="postfix.html.ru#postfix-configuration" title="Базовая конфигурация">Базовая конфигурация</a></li>
<li class="links"><a class="xref" href="postfix.html.ru#postfix-smtp-authentication" title="Аутентификация SMTP">Аутентификация SMTP</a></li>
<li class="links"><a class="xref" href="postfix.html.ru#postfix-sasl" title="Настройка SASL">Настройка SASL</a></li>
<li class="links"><a class="xref" href="postfix.html.ru#mail-stack-delivery" title="Почтовый стек доставки">Почтовый стек доставки</a></li>
<li class="links"><a class="xref" href="postfix.html.ru#postfix-testing" title="Тестирование">Тестирование</a></li>
<li class="links"><a class="xref" href="postfix.html.ru#postfix-troubleshooting" title="Устранение проблем">Устранение проблем</a></li>
</ul></div>
...
<li class="steps">
                <p class="para">Далее создайте или получите цифровой сертификат для TLS. Смотрите подробности в разделе <a class="xref" href="certificates-and-security.html.ru" title="Сертификаты">Сертификаты</a>. Этот пример также использует Центр сертификации (CA). Для информации по созданию сертификатов CA смотрите раздел <a class="xref" href="certificates-and-security.html.ru#certificate-authority" title="Центр Сертификации">Центр Сертификации</a>.</p>
		<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
                <p class="para">Почтовым агентам пользователей (MUA), подключающимся к вашему почтовому серверу через TLS, потребуется распознать сертификат, используемый для TLS. Это может быть сделано либо с использованием сертификата от коммерческого центра сертификации, либо с самоподписанным сертификатом, который пользователи установили вручную. Для TLS между MTA (агентами передачи почты) сертификаты никогда не подтверждаются без дополнительного соглашения с контролирующими организациями. Поэтому для таких соединений, если локальные политики этого не требуют, нет резона не использовать самоподписанные сертификаты. Смотрите подробности в разделе <a class="xref" href="certificates-and-security.html.ru#creating-a-self-signed-certificate" title="Создание сертификата со своей подписью">Создание сертификата со своей подписью</a>.</p>
                </div></div></div></div>
		</li>
<li class="steps">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo postconf -e 'smtpd_tls_CAfile = /etc/ssl/certs/cacert.pem'</span>
                  ...
                  <p class="para">Опять же, для подробностей смотрите раздел <a class="xref" href="certificates-and-security.html.ru" title="Сертификаты">Сертификаты</a>.</p>
                </li>
</ol></div></div>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
...
<p class="para">
            ...
            See <a class="xref" href="certificates-and-security.html.ru" title="Сертификаты">Сертификаты</a> for more details.
            </p>
<p class="para">
