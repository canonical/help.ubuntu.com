...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="email-services.html.sl" title="E-poštne storitve">E-poštne storitve</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="email-services.html.sl" title="E-poštne storitve">Nazaj</a><a class="nextlinks-next" href="exim4.html.sl" title="Exim4">Naprej</a>
</div>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
            ...
            on Virtual Domains and other advanced configurations see <a class="xref" href="postfix.html.sl#postfix-references" title="Sklici">Sklici</a>.
            </p>
          </div></div></div></div>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="postfix.html.sl#postfix-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="postfix.html.sl#postfix-configuration" title="Basic Configuration">Basic Configuration</a></li>
<li class="links"><a class="xref" href="postfix.html.sl#postfix-smtp-authentication" title="Overitev SMTP">Overitev SMTP</a></li>
<li class="links"><a class="xref" href="postfix.html.sl#postfix-sasl" title="Nastavljanje SASL">Nastavljanje SASL</a></li>
<li class="links"><a class="xref" href="postfix.html.sl#mail-stack-delivery" title="Mail-Stack Delivery">Mail-Stack Delivery</a></li>
<li class="links"><a class="xref" href="postfix.html.sl#postfix-testing" title="Preizkušanje">Preizkušanje</a></li>
<li class="links"><a class="xref" href="postfix.html.sl#postfix-troubleshooting" title="Odpravljanje napak">Odpravljanje napak</a></li>
</ul></div>
...
<li class="steps">
                <p class="para">
                Next, generate or obtain a digital certificate for TLS. See <a class="xref" href="certificates-and-security.html.sl" title="Potrdila">Potrdila</a> for details.
                This example also uses a Certificate Authority (CA).  For information on generating a CA certificate see
                <a class="xref" href="certificates-and-security.html.sl#certificate-authority" title="Overitelj potrdil">Overitelj potrdil</a>.
	        </p>
		<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
                <p class="para">
		...
		<a class="xref" href="certificates-and-security.html.sl#creating-a-self-signed-certificate" title="Creating a Self-Signed Certificate">Creating a Self-Signed Certificate</a> for more details.
                </p>
                </div></div></div></div>
		</li>
<li class="steps">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo postconf -e 'smtpd_tls_CAfile = /etc/ssl/certs/cacert.pem'</span>
                  ...
                  <p class="para">
                  Again, for more details about certificates see <a class="xref" href="certificates-and-security.html.sl" title="Potrdila">Potrdila</a>.
                  </p>
                </li>
</ol></div></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
...
<p class="para">
            ...
            See <a class="xref" href="certificates-and-security.html.sl" title="Potrdila">Potrdila</a> for more details.
            </p>
<p class="para">
