...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="databases.html.be" title="Базы даньняў">Базы даньняў</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="mysql.html.be" title="MySQL">Назад</a><a class="nextlinks-next" href="lamp-applications.html.be" title="Дастасаваньні LAMP">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="postgresql.html.be#postgresql-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="postgresql.html.be#postgresql-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="postgresql.html.be#postgresql-backups" title="Backups">Backups</a></li>
<li class="links"><a class="xref" href="postgresql.html.be#postgresql-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">
	    Locate the line <span class="em emphasis">#listen_addresses = 'localhost'</span> and change it to:
	    </p>
...
<p class="para">
	    Finally, you should restart the <span class="app application">PostgreSQL</span> service to 
            initialize the new configuration.  From a terminal prompt enter the following to 
	    restart <span class="app application">PostgreSQL</span>:
            </p>
...
<div class="hgroup"><h2 class="title">Backups</h2></div>
...
<li class="list itemizedlist">
              <p class="para">
	      For general SQL information see <a href="http://www.informit.com/store/product.aspx?isbn=0768664128" class="ulink" title="http://www.informit.com/store/product.aspx?isbn=0768664128">Using SQL Special Edition</a> by 
	      Rafe Colburn.
              </p>
            </li>
<li class="list itemizedlist">
