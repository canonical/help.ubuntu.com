...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.el" title="Οδηγός Διακομιστή Ubuntu">Οδηγός Διακομιστή Ubuntu</a> » <a class="trail" href="databases.html.el" title="Βάσεις δεδομένων">Βάσεις δεδομένων</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="mysql.html.el" title="MySQL">Προηγούμενο</a><a class="nextlinks-next" href="lamp-applications.html.el" title="Εφαρμογές LAMP">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="postgresql.html.el#postgresql-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="postgresql.html.el#postgresql-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="postgresql.html.el#postgresql-backups" title="Αντίγραφα ασφαλείας">Αντίγραφα ασφαλείας</a></li>
<li class="links"><a class="xref" href="postgresql.html.el#postgresql-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">Εντοπίστε τη γραμμή <span class="em emphasis">#listen_addresses = 'localhost'</span> και αλλάξτε την σε:</p>
...
<div class="screen"><pre class="contents "><span class="cmd command">ALTER USER postgres with encrypted password 'ο_κωδικός_σας';</span>
</pre></div>
<p class="para">
...
<p class="para">Τέλος, θα πρέπει να επανεκκινήσετε την υπηρεσία <span class="app application">PostgreSQL</span> για να αρχικοποιηθούν οι νέες ρυθμίσεις. Σε ένα τερματικό πληκτρολογήστε το παρακάτω για να επανεκκινήσετε την <span class="app application">PostgreSQL</span>:</p>
...
<li class="list itemizedlist">
              <p class="para">Για γενικές πληροφορίες σχετικά με την SQL δείτε το <a href="http://www.informit.com/store/product.aspx?isbn=0768664128" class="ulink" title="http://www.informit.com/store/product.aspx?isbn=0768664128">Using SQL Special Edition</a> από τον Rafe Colburn.</p>
            </li>
<li class="list itemizedlist">
          <p class="para">
