...
<a class="nextlinks-prev" href="mysql.html.es" title="MySQL">Anterior</a><a class="nextlinks-next" href="lamp-applications.html.es" title="Aplicaciones LAMP">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="postgresql.html.es#postgresql-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="postgresql.html.es#postgresql-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="postgresql.html.es#postgresql-backups" title="Copias de seguridad">Copias de seguridad</a></li>
<li class="links"><a class="xref" href="postgresql.html.es#postgresql-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para">Localize la línea <span class="file filename">/etc/postgresql/8.3/main/postgresql.conf</span> y cámbiela por:</p>
...
<div class="screen"><pre class="contents "><span class="cmd command">ALTER USER postgres with encrypted password 'su_contraseña';</span>
</pre></div>
<p class="para">
...
<p class="para">Finalmente, usted debe reiniciar el servicio application&gt;PostgreSQL</p>
...
<div class="hgroup"><h2 class="title">Copias de seguridad</h2></div>
...
<li class="list itemizedlist">
              <p class="para">Para información general sobre SQL, vea <a href="http://www.informit.com/store/product.aspx?isbn=0768664128" class="ulink" title="http://www.informit.com/store/product.aspx?isbn=0768664128">Usando SQL Edición Especial</a> por Rafe Colburn.</p>
            </li>
<li class="list itemizedlist">
          <p class="para">También vea la página <a href="https://help.ubuntu.com/community/PostgreSQL" class="ulink" title="https://help.ubuntu.com/community/PostgreSQL">PostgreSQL Ubuntu Wiki</a> para más información.</p>
          </li>
</ul></div></div></div>
</div></div>
</div>
