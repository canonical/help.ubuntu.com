...
<a class="nextlinks-prev" href="mysql.html.ru" title="MySQL">Назад</a><a class="nextlinks-next" href="lamp-applications.html.ru" title="Приложения LAMP">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="postgresql.html.ru#postgresql-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="postgresql.html.ru#postgresql-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="postgresql.html.ru#postgresql-backups" title="Резервное копирование">Резервное копирование</a></li>
<li class="links"><a class="xref" href="postgresql.html.ru#postgresql-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
