...
<title>Рыхтуецца да ўстаноўкі</title>
...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="installation.html.be" title="Усталёўка">Усталёўка</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="installation.html.be" title="Усталёўка">Назад</a><a class="nextlinks-next" href="installing-live-server.html.be" title="Installing using the live server installer ">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Рыхтуецца да ўстаноўкі</h1></div>
<div class="region">
<div class="contents"><p class="para">
      This section explains various aspects to consider before starting the
      installation. </p></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="preparing-to-install.html.be#system-requirements" title="Сыстэмныя патрабаваньні">Сыстэмныя патрабаваньні</a></li>
<li class="links"><a class="xref" href="preparing-to-install.html.be#intro-server-differences" title="Server and Desktop Differences">Server and Desktop Differences</a></li>
<li class="links"><a class="xref" href="preparing-to-install.html.be#backing-up" title="Backing Up">Backing Up</a></li>
</ul></div>
<div class="sect2 sect" id="system-requirements"><div class="inner">
<div class="hgroup"><h2 class="title">Сыстэмныя патрабаваньні</h2></div>
...
<div class="table">
<div class="title"><h3><span class="title">Мінімальныя рэкамендаваныя патрабаваньні</span></h3></div>
<table summary="Мінімальныя рэкамендаваныя патрабаваньні" style="border: solid 1px;">
<thead>
<tr>
<th class="td-colsep" style="vertical-align: middle;" rowspan="2"><p class="para">Тып устаноўкі</p></th>
...
<th style="text-align: center;" colspan="2"><p class="para">Прастона на жорсткім дыску</p></th>
</tr>
<tr>
<th class="td-colsep"><p class="para">Base System</p></th>
<th><p class="para">Усе заданьні устаноўленыя</p></th>
</tr>
</thead>
<tbody>
<tr>
...
<div class="hgroup"><h2 class="title">Server and Desktop Differences</h2></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="hgroup"><h3 class="title">Kernel Differences:</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title">Backing Up</h2></div>
<div class="region"><div class="contents"><div class="list itemizedlist"><ul class="list itemizedlist"><li class="list itemizedlist">
        <p class="para">
	  Before installing <span class="app application">Ubuntu Server Edition</span> you should make sure all data on the system 
          is backed up. See <a class="xref" href="backups.html.be" title="Backups">Backups</a> for backup options.
	</p>
	<p class="para"> 
