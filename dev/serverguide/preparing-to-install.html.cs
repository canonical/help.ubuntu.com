...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.cs" title="Průvodce pro Ubuntu Server">Průvodce pro Ubuntu Server</a> » <a class="trail" href="installation.html.cs" title="Instalace">Instalace</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="installation.html.cs" title="Instalace">Předchozí</a><a class="nextlinks-next" href="installing-live-server.html.cs" title="Installing using the live server installer ">Následující</a>
</div>
...
<li class="links"><a class="xref" href="preparing-to-install.html.cs#system-requirements" title="System Requirements">System Requirements</a></li>
<li class="links"><a class="xref" href="preparing-to-install.html.cs#intro-server-differences" title="Server and Desktop Differences">Server and Desktop Differences</a></li>
<li class="links"><a class="xref" href="preparing-to-install.html.cs#backing-up" title="Backing Up">Backing Up</a></li>
</ul></div>
...
<div class="region"><div class="contents"><div class="list itemizedlist"><ul class="list itemizedlist"><li class="list itemizedlist">
	  ...
	  Before installing <span class="app application">Ubuntu Server Edition</span> you should make sure all data on the system 
          is backed up. See <a class="xref" href="backups.html.cs" title="Backups">Backups</a> for backup options.
	</p>
	<p class="para"> 
