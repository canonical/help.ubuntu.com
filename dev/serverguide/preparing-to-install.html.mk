...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.mk" title="Водич за Ubuntu Server">Водич за Ubuntu Server</a> » <a class="trail" href="installation.html.mk" title="Инсталација">Инсталација</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="installation.html.mk" title="Инсталација">Previous</a><a class="nextlinks-next" href="installing-live-server.html.mk" title="Installing using the live server installer ">Next</a>
</div>
<div class="hgroup"><h1 class="title">Preparing to Install</h1></div>
<div class="region">
<div class="contents"><p class="para">
      This section explains various aspects to consider before starting the
      installation. </p></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="preparing-to-install.html.mk#system-requirements" title="System Requirements">System Requirements</a></li>
<li class="links"><a class="xref" href="preparing-to-install.html.mk#intro-server-differences" title="Server and Desktop Differences">Server and Desktop Differences</a></li>
<li class="links"><a class="xref" href="preparing-to-install.html.mk#backing-up" title="Backing Up">Backing Up</a></li>
</ul></div>
<div class="sect2 sect" id="system-requirements"><div class="inner">
<div class="hgroup"><h2 class="title">System Requirements</h2></div>
...
<thead>
<tr>
<th class="td-colsep" style="vertical-align: middle;" rowspan="2"><p class="para">Install Type</p></th>
...
<th style="text-align: center;" colspan="2"><p class="para">Hard Drive Space</p></th>
</tr>
<tr>
...
<div class="region"><div class="contents"><div class="list itemizedlist"><ul class="list itemizedlist"><li class="list itemizedlist">
	  ...
	  Before installing <span class="app application">Ubuntu Server Edition</span> you should make sure all data on the system 
          is backed up. See <a class="xref" href="backups.html.mk" title="Backups">Backups</a> for backup options.
	</p>
	<p class="para"> 
