...
<title>Priprava na namestitev</title>
...
<a class="nextlinks-prev" href="installation.html.sl" title="Namestitev">Nazaj</a><a class="nextlinks-next" href="installing-live-server.html.sl" title="Installing using the live server installer ">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Priprava na namestitev</h1></div>
<div class="region">
<div class="contents"><p class="para">
      This section explains various aspects to consider before starting the
      installation. </p></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="preparing-to-install.html.sl#system-requirements" title="Sistemske zahteve">Sistemske zahteve</a></li>
<li class="links"><a class="xref" href="preparing-to-install.html.sl#intro-server-differences" title="Server and Desktop Differences">Server and Desktop Differences</a></li>
<li class="links"><a class="xref" href="preparing-to-install.html.sl#backing-up" title="Backing Up">Backing Up</a></li>
</ul></div>
<div class="sect2 sect" id="system-requirements"><div class="inner">
<div class="hgroup"><h2 class="title">Sistemske zahteve</h2></div>
...
<div class="table">
<div class="title"><h3><span class="title">Recommended Minimum Requirements</span></h3></div>
<table summary="Recommended Minimum Requirements" style="border: solid 1px;">
<thead>
<tr>
<th class="td-colsep" style="vertical-align: middle;" rowspan="2"><p class="para">Vrsta namestitve</p></th>
<th class="td-colsep" style="vertical-align: middle;" rowspan="2"><p class="para">Install Method</p></th>
<th class="td-colsep" style="vertical-align: middle;" rowspan="2"><p class="para">CPE</p></th>
<th class="td-colsep" style="vertical-align: middle;" rowspan="2"><p class="para">RAM</p></th>
<th style="text-align: center;" colspan="2"><p class="para">Prostor na trdem disku</p></th>
</tr>
<tr>
<th class="td-colsep"><p class="para">Osnovni sistem</p></th>
<th><p class="para">All Tasks Installed</p></th>
</tr>
</thead>
<tbody>
<tr>
...
<div class="hgroup"><h3 class="title">Razlike med jedri:</h3></div>
<div class="region"><div class="contents">
...
<div class="region"><div class="contents"><div class="list itemizedlist"><ul class="list itemizedlist"><li class="list itemizedlist">
	  ...
	  Before installing <span class="app application">Ubuntu Server Edition</span> you should make sure all data on the system 
          is backed up. See <a class="xref" href="backups.html.sl" title="Varnostne kopije">Varnostne kopije</a> for backup options.
	</p>
	<p class="para"> 
