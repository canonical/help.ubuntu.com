...
<a class="nextlinks-prev" href="openssh-server.html.be" title="OpenSSH Server">Назад</a><a class="nextlinks-next" href="zentyal.html.be" title="Zentyal">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="puppet.html.be#puppet-preconfiguration" title="Preconfiguration">Preconfiguration</a></li>
<li class="links"><a class="xref" href="puppet.html.be#puppet-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="puppet.html.be#puppet-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="puppet.html.be#puppet-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">
      ...
      <span class="em emphasis">Puppet Master</span>.  See <a class="xref" href="dns.html.be" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for more DNS details.
      </p>
<p class="para">
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
        ...
        benefits.  For more information see <a class="xref" href="puppet.html.be#puppet-resources" title="Рэсурсы">Рэсурсы</a>.
        </p>
      </div></div></div></div>
</div></div>
</div></div>
