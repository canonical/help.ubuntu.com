...
<a class="nextlinks-prev" href="openssh-server.html.mk" title="OpenSSH Server">Previous</a><a class="nextlinks-next" href="zentyal.html.mk" title="Zentyal">Next</a>
</div>
...
<li class="links"><a class="xref" href="puppet.html.mk#puppet-preconfiguration" title="Preconfiguration">Preconfiguration</a></li>
<li class="links"><a class="xref" href="puppet.html.mk#puppet-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="puppet.html.mk#puppet-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="puppet.html.mk#puppet-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para">
      ...
      <span class="em emphasis">Puppet Master</span>.  See <a class="xref" href="dns.html.mk" title="Domain Name Service (DNS)">Domain Name Service (DNS)</a> for more DNS details.
      </p>
<p class="para">
...
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents">
        ...
        benefits.  For more information see <a class="xref" href="puppet.html.mk#puppet-resources" title="Resources">Resources</a>.
        </p>
      </div></div></div></div>
</div></div>
</div></div>
