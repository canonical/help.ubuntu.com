...
<a class="nextlinks-prev" href="libvirt.html.nl" title="libvirt">Vorige</a><a class="nextlinks-next" href="cloud-images-and-uvtool.html.nl" title="Cloud images and uvtool">Volgende</a>
</div>
...
<p class="para">
        ...
        <a class="link" href="libvirt.html.nl" title="libvirt">Libvirt</a> provides an abstraction from specific versions and hypervisors and encapsulates some workarounds and best practices.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="qemu.html.nl#machine-type-upgrade" title="Upgrading the machine type">Upgrading the machine type</a></li></ul></div>
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="para">This also is documented along some more constraints and considerations at the <a href="https://wiki.ubuntu.com/QemuKVMMigration#Upgrade_machine_type" class="ulink" title="https://wiki.ubuntu.com/QemuKVMMigration#Upgrade_machine_type">Ubuntu Wiki</a></p></div></div></div></div>
