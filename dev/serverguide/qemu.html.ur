...
<a class="nextlinks-prev" href="libvirt.html.ur" title="libvirt">Previous</a><a class="nextlinks-next" href="cloud-images-and-uvtool.html.ur" title="Cloud images and uvtool">Next</a>
</div>
...
<p class="para">
        ...
        <a class="link" href="libvirt.html.ur" title="libvirt">Libvirt</a> provides an abstraction from specific versions and hypervisors and encapsulates some workarounds and best practices.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul><li class="links"><a class="xref" href="qemu.html.ur#machine-type-upgrade" title="Upgrading the machine type">Upgrading the machine type</a></li></ul></div>
