...
<title>Informar de errores en la edición del servidor de Ubuntu</title>
...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.es" title="Guía de Ubuntu Server">Guía de Ubuntu Server</a> » <a class="trail" href="serverguide-appendix.html.es" title="Apéndice">Apéndice</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks"><a class="nextlinks-prev" href="serverguide-appendix.html.es" title="Apéndice">Anterior</a></div>
<div class="hgroup"><h1 class="title">Informar de errores en la edición del servidor de Ubuntu</h1></div>
<div class="region">
...
<li class="links"><a class="xref" href="reporting-bugs.html.es#reporting-bugs-apport-cli" title="Reporting Bugs With apport-cli">Reporting Bugs With apport-cli</a></li>
<li class="links"><a class="xref" href="reporting-bugs.html.es#apport-crash-catching" title="Informar de roturas de las aplicaciones">Informar de roturas de las aplicaciones</a></li>
<li class="links"><a class="xref" href="reporting-bugs.html.es#reporting-bugs-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
    <p class="para">Vea <a class="xref" href="package-management.html.es" title="Gestión de paquetes">Gestión de paquetes</a> para más información sobre paquetes en Ubuntu.</p>
    </div></div></div></div>
<p class="para">
...
<div class="hgroup"><h2 class="title">Informar de roturas de las aplicaciones</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<li class="list itemizedlist">
        <p class="para">Vea la página wiki de Ubuntu <a href="https://help.ubuntu.com/community/ReportingBugs" class="ulink" title="https://help.ubuntu.com/community/ReportingBugs">Informar de errrores</a>.</p>
      </li>
<li class="list itemizedlist">
        <p class="para">También la página <a href="https://wiki.ubuntu.com/Apport" class="ulink" title="https://wiki.ubuntu.com/Apport">Apport</a> tiene información útil. Aunque algunos se refieren al uso de una interfaz gráfica de usuario.</p>
      </li>
</ul></div></div></div>
</div></div>
</div>
