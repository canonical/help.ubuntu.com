...
<a class="nextlinks-prev" href="squid.html.el" title="Squid - Διακομιστής Διαμεσολαβητή">Προηγούμενο</a><a class="nextlinks-next" href="tomcat.html.el" title="Apache Tomcat">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="ruby-on-rails.html.el#ruby-on-rails-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="ruby-on-rails.html.el#ruby-on-rails-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="ruby-on-rails.html.el#ruby-on-rails-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<p class="para">Πριν εγκαταστήσετε το <span class="app application">Rails</span> θα πρέπει να εγκαταστήσετε τα <span class="app application">Apache</span> και <span class="app application">MySQL</span>. Για να εγκαταστήσετε το πακέτο <span class="app application">Apache</span>, παρακαλώ αναφερθείτε στο <a class="xref" href="httpd.html.el" title="HTTPD - Apache2 Διακομιστής Ιστού">HTTPD - Apache2 Διακομιστής Ιστού</a>. Για οδηγίες για το πως να εγκαταστήσετε το <span class="app application">MySQL</span> αναφερθείτε στο <a class="xref" href="mysql.html.el" title="MySQL">MySQL</a>.</p>
