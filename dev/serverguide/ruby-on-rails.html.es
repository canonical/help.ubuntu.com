...
<a class="nextlinks-prev" href="squid.html.es" title="Servidor proxy Squid">Anterior</a><a class="nextlinks-next" href="tomcat.html.es" title="Apache Tomcat">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="ruby-on-rails.html.es#ruby-on-rails-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="ruby-on-rails.html.es#ruby-on-rails-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="ruby-on-rails.html.es#ruby-on-rails-references" title="Referencias">Referencias</a></li>
</ul></div>
...
<p class="para">Antes de instalar <span class="app application">Rails</span> debería instalar <span class="app application">Apache</span> y <span class="app application">MySQL</span>. Para instalar el paquete de  <span class="app application">Apache</span>, diríjase a <a class="xref" href="httpd.html.es" title="HTTPD - Servidor web Apache2">HTTPD - Servidor web Apache2</a>. Para ver las instrucciones de instalación de <span class="app application">MySQL</span> diríjase a <a class="xref" href="mysql.html.es" title="MySQL">MySQL</a>.</p>
