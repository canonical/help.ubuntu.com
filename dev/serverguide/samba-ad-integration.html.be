...
<a class="nextlinks-prev" href="samba-dc.html.be" title="As a Domain Controller">Назад</a><a class="nextlinks-next" href="backups.html.be" title="Backups">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Active Directory Integration</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-ad-integration.html.be#ad-integration-samba-share" title="Accessing a Samba Share">Accessing a Samba Share</a></li>
<li class="links"><a class="xref" href="samba-ad-integration.html.be#ad-integration-windows-share" title="Accessing a Windows Share">Accessing a Windows Share</a></li>
<li class="links"><a class="xref" href="samba-ad-integration.html.be#ad-integration-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">Пасьля, рэдагуйце <span class="file filename">/etc/samba/smb.conf</span> зьмяніўшы:</p>
...
<p class="para">Перазапусьціце <span class="app application">samba</span> каб ужыць новыя наладкі:</p>
...
<p class="para">
      ...
      the appropriate AD users or groups access to the share directory.  See <a class="xref" href="samba-fileprint-security.html.be" title="Securing File and Print Server">Securing File and Print Server</a> for 
      more details.
      </p>
</div></div>
</div></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">smbclient //fs01.example.com/share -k -c "get file.txt"</span>
          ...
          <p class="para">Гэта будзе капіяваць <span class="file filename">file.txt</span> у бягучую дырэкторыю.</p>
