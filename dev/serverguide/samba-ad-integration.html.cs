...
<a class="nextlinks-prev" href="samba-dc.html.cs" title="As a Domain Controller">Předchozí</a><a class="nextlinks-next" href="backups.html.cs" title="Backups">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Active Directory Integration</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-ad-integration.html.cs#ad-integration-samba-share" title="Accessing a Samba Share">Accessing a Samba Share</a></li>
<li class="links"><a class="xref" href="samba-ad-integration.html.cs#ad-integration-windows-share" title="Accessing a Windows Share">Accessing a Windows Share</a></li>
<li class="links"><a class="xref" href="samba-ad-integration.html.cs#ad-integration-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<p class="para">
      ...
      the appropriate AD users or groups access to the share directory.  See <a class="xref" href="samba-fileprint-security.html.cs" title="Securing File and Print Server">Securing File and Print Server</a> for 
      more details.
      </p>
</div></div>
</div></div>
