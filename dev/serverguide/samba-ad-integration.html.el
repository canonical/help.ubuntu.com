...
<a class="nextlinks-prev" href="samba-dc.html.el" title="As a Domain Controller">Προηγούμενο</a><a class="nextlinks-next" href="backups.html.el" title="Αντίγραφα ασφαλείας">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Active Directory Integration</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-ad-integration.html.el#ad-integration-samba-share" title="Πρόσβαση ενός Διαμοιρασμένου Samba">Πρόσβαση ενός Διαμοιρασμένου Samba</a></li>
<li class="links"><a class="xref" href="samba-ad-integration.html.el#ad-integration-windows-share" title="Πρόσβαση σε ένα Διαμοιρασμένο των Windows">Πρόσβαση σε ένα Διαμοιρασμένο των Windows</a></li>
<li class="links"><a class="xref" href="samba-ad-integration.html.el#ad-integration-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">Θα πρέπει τώρα να είστε ικανοί να έχετε πρόσβαση σε κάθε διαμοιρασμένο του <span class="app application">Samba</span> από έναν πελάτη των Windows. Παρόλα αυτά, σιγουρευτείτε ότι δώσατε δώσατε πρόσβαση στους στους κατάλληλους χρήστες ή ομάδες του Ενεργού Καταλόγου στον διαμοιρασμένο κατάλογο. Δείτε το <a class="xref" href="samba-fileprint-security.html.el" title="Securing File and Print Server">Securing File and Print Server</a> για περισσότερες λεπτομέρειες.</p>
</div></div>
</div></div>
