...
<a class="nextlinks-prev" href="samba-dc.html.sl" title="As a Domain Controller">Nazaj</a><a class="nextlinks-next" href="backups.html.sl" title="Varnostne kopije">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Active Directory Integration</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-ad-integration.html.sl#ad-integration-samba-share" title="Accessing a Samba Share">Accessing a Samba Share</a></li>
<li class="links"><a class="xref" href="samba-ad-integration.html.sl#ad-integration-windows-share" title="Accessing a Windows Share">Accessing a Windows Share</a></li>
<li class="links"><a class="xref" href="samba-ad-integration.html.sl#ad-integration-resources" title="Viri">Viri</a></li>
</ul></div>
...
<p class="para">Nato uredite datoteko <span class="file filename">/etc/samba/smb.conf</span> in spremenite:</p>
...
<p class="para">Znova zaženite program <span class="app application">Samba</span>, da se uveljavijo nove nastavitve:</p>
...
<p class="para">
      ...
      the appropriate AD users or groups access to the share directory.  See <a class="xref" href="samba-fileprint-security.html.sl" title="Securing File and Print Server">Securing File and Print Server</a> for 
      more details.
      </p>
</div></div>
</div></div>
...
<div class="code"><pre class="contents ">//192.168.0.5/share /mnt/windows cifs auto,username=klemen,password=skrivnost,rw 0        0
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">smbclient //fs01.primer.si/share -k -c "ls"</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">smbclient //fs01.primer.si/share -k -c "put /etc/hosts hosts"</span>
</pre></div>
