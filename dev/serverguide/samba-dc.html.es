...
<a class="nextlinks-prev" href="samba-fileprint-security.html.es" title="Securing File and Print Server">Anterior</a><a class="nextlinks-next" href="samba-ad-integration.html.es" title="Active Directory Integration">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="samba-dc.html.es#samba-pdc-smbpasswd" title="Controlador de dominio primario">Controlador de dominio primario</a></li>
<li class="links"><a class="xref" href="samba-dc.html.es#samba-bdc-smbpasswd" title="Controlador secundario de dominio">Controlador secundario de dominio</a></li>
<li class="links"><a class="xref" href="samba-dc.html.es#samba-dc-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<li class="list itemizedlist">
              ...
              <p class="para">En este ejemplo se necesitará crear el grupo <span class="em emphasis">machines</span> usando la utilidad <span class="app application">addgroup</span>. Consulte <a class="xref" href="user-management.html.es#adding-deleting-users" title="Añadir y eliminar usuarios">Añadir y eliminar usuarios</a> para más información.</p>
