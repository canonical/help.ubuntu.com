...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="samba.html.be" title="Samba">Samba</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="samba-printserver.html.be" title="Сэрвер друку">Назад</a><a class="nextlinks-next" href="samba-dc.html.be" title="As a Domain Controller">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html.be#samba-security-mode" title="Рэжымы бясьпекі Samba">Рэжымы бясьпекі Samba</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.be#samba-user-security" title="Security = User">Security = User</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.be#samba-share-security" title="Share Security">Share Security</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.be#samba-apparmor" title="Профіль Samba AppArmor">Профіль Samba AppArmor</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.be#samba-security-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
<div class="sect2 sect" id="samba-security-mode"><div class="inner">
<div class="hgroup"><h2 class="title">Рэжымы бясьпекі Samba</h2></div>
...
<li class="list itemizedlist">
          ...
          <a class="xref" href="samba-dc.html.be" title="As a Domain Controller">As a Domain Controller</a> for further information.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
          <span class="em emphasis">security = ADS:</span> allows the Samba server to join an Active Directory domain as a native
          member.  See <a class="xref" href="samba-ad-integration.html.be" title="Active Directory Integration">Active Directory Integration</a> for details.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<div class="region"><div class="contents">
<p class="para">
      This section will reconfigure the Samba file and print server, from <a class="xref" href="samba-fileserver.html.be" title="File Server">File Server</a> and
      <a class="xref" href="samba-printserver.html.be" title="Сэрвер друку">Сэрвер друку</a>, to require authentication.
      </p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Групы</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
        ...
        <a class="xref" href="user-management.html.be#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a>.
        </p>
<p class="para">
...
<p class="para">Пасьля рэдагаваньня <span class="file filename">/etc/samba/smb.conf</span>, перазапусьціце Samba каб ужыць зьмены:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart smbd.service nmbd.service</span>
</pre></div>
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
          <p class="para">
...
<div class="hgroup"><h2 class="title">Профіль Samba AppArmor</h2></div>
<div class="region"><div class="contents">
<p class="para">
      ...
      AppArmor see <a class="xref" href="apparmor.html.be" title="AppArmor">AppArmor</a>.
      </p>
<p class="para">
...
<li class="list itemizedlist">
          <p class="para"><a href="http://samba.org/samba/docs/man/Samba-HOWTO-Collection/securing-samba.html" class="ulink" title="http://samba.org/samba/docs/man/Samba-HOWTO-Collection/securing-samba.html">Разьдзел 18</a> Калекцыі Samba HOWTO зьмяшчае інфармацыю пра бясьпеку.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
