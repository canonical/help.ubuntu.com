...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.cs" title="Průvodce pro Ubuntu Server">Průvodce pro Ubuntu Server</a> » <a class="trail" href="samba.html.cs" title="Samba">Samba</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="samba-printserver.html.cs" title="Print Server">Předchozí</a><a class="nextlinks-next" href="samba-dc.html.cs" title="As a Domain Controller">Následující</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html.cs#samba-security-mode" title="Samba bezpečnostní módy">Samba bezpečnostní módy</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.cs#samba-user-security" title="Security = User">Security = User</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.cs#samba-share-security" title="Share Security">Share Security</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.cs#samba-apparmor" title="Samba AppArmor profil">Samba AppArmor profil</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.cs#samba-security-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
<div class="sect2 sect" id="samba-security-mode"><div class="inner">
<div class="hgroup"><h2 class="title">Samba bezpečnostní módy</h2></div>
...
<li class="list itemizedlist">
          ...
          <a class="xref" href="samba-dc.html.cs" title="As a Domain Controller">As a Domain Controller</a> for further information.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
          <span class="em emphasis">security = ADS:</span> allows the Samba server to join an Active Directory domain as a native
          member.  See <a class="xref" href="samba-ad-integration.html.cs" title="Active Directory Integration">Active Directory Integration</a> for details.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<div class="region"><div class="contents">
<p class="para">
      This section will reconfigure the Samba file and print server, from <a class="xref" href="samba-fileserver.html.cs" title="File Server">File Server</a> and
      <a class="xref" href="samba-printserver.html.cs" title="Print Server">Print Server</a>, to require authentication.
      </p>
<p class="para">
...
<p class="para">Upravte <span class="file filename">/etc/samba/smb.conf</span> a v sekci <span class="em emphasis">[share]</span> upravte:</p>
<div class="code"><pre class="contents ">    guest ok = no
</pre></div>
<p class="para">Nakonec restartujte Sambu, aby se nové nastavení projevilo:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart smbd.service nmbd.service</span>
</pre></div>
<p class="para">Když se nyní připojíte ke sdíleným adresářům nebo tiskárnám měli byste být vyzváni k zadání uživatelského jména a hesla.</p>
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
        <p class="para">
...
<p class="para">
        ...
        <a class="xref" href="user-management.html.cs#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a>.
        </p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Oprávnění souborů</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Pro provedení změn restartujte po úpravě <span class="file filename">/etc/samba/smb.conf</span> Sambu.</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart smbd.service nmbd.service</span>
</pre></div>
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
          <p class="para">
...
<p class="para">Poté odpojte oddíl:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo mount -v -o remount /srv</span>
</pre></div>
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
          <p class="para">Výše zmíněný příklad předpokládá, že <span class="file filename">/srv</span> se nachází na samostatném oddíle. Pokud je <span class="file filename">/srv</span> (nebo jakákoli sdílená cesta) součástí oddílu <span class="file filename">/</span>, může být vyžadován restart.</p>
        </div></div></div></div>
<p class="para">
...
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
          <p class="para">Výše vypsaný příkaz <span class="app application">setfacl</span> dává práva ke <span class="em emphasis">spouštění</span> všem souborům v adresáři <span class="file filename">/srv/samba/share</span>, což můžete ale nemusíte chtít.</p>
        </div></div></div></div>
<p class="para">Nyní byste měli z Windows klienta zjistit, že jsou nová práva implementována. Pro více informací o POSIX ACL navštivte manuálové stránky <span class="app application">acl</span> a <span class="app application">setfacl</span>.</p>
</div></div>
</div></div>
</div>
</div></div>
...
<p class="para">
      ...
      AppArmor see <a class="xref" href="apparmor.html.cs" title="AppArmor">AppArmor</a>.
      </p>
<p class="para">Výchozí profily AppArmor pro binární soubory démonů Samba <span class="file filename">/usr/sbin/smbd</span> a <span class="file filename">/usr/sbin/nmbd</span> jsou součástí balíku <span class="app application">apparmor-profiles</span>. Pro instalaci tohoto balíku zadejte do příkazové řádky:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo apt install apparmor-profiles apparmor-utils</span>
</pre></div>
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Tento balík obsahuje profily i pro některé další binární soubory.</p>
      </div></div></div></div>
<p class="para">
...
<p class="para">Nyní vložte profil do <span class="em emphasis">enforce</span> proveďte znovunačtení:</p>
...
<li class="list itemizedlist">
          <p class="para">Dalším zdrojem informací je například <a href="http://www.oreilly.com/catalog/9780596007690/" class="ulink" title="http://www.oreilly.com/catalog/9780596007690/">Using Samba</a> z nakladatelství O'Reilly.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
