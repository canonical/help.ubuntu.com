...
<a class="nextlinks-prev" href="samba-printserver.html.es" title="Servidor de impresión">Anterior</a><a class="nextlinks-next" href="samba-dc.html.es" title="As a Domain Controller">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html.es#samba-security-mode" title="Modos de seguridad en Samba">Modos de seguridad en Samba</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.es#samba-user-security" title="Seguridad = Usuario">Seguridad = Usuario</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.es#samba-share-security" title="Seguridad al compartir">Seguridad al compartir</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.es#samba-apparmor" title="Perfil Samba AppArmor">Perfil Samba AppArmor</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.es#samba-security-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">security = domain:</span> este modo permite que el servidor Samba se muestre a los clientes Windows como un controlador primario de dominio (Primary Domain Controller, PDC), un controlador secundario de dominio (Backup Domain Controller, BDC) o un servidor de miembros de dominio (Domain Member Server, DMS). Consulte <a class="xref" href="samba-dc.html.es" title="As a Domain Controller">As a Domain Controller</a> para más información.</p>
        </li>
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">security = ADS:</span> permite que el servidor Samba pueda unirse a un dominio de Active Directory como si fuera un miembro nativo. Consulte <a class="xref" href="samba-ad-integration.html.es" title="Active Directory Integration">Active Directory Integration</a> para más información.</p>
        </li>
<li class="list itemizedlist">
...
<div class="region"><div class="contents">
<p class="para">Esta sección reconfigurará el servidor Samba de archivos e impresión, desde <a class="xref" href="samba-fileserver.html.es" title="Servidor de archivos">Servidor de archivos</a> hasta <a class="xref" href="samba-printserver.html.es" title="Servidor de impresión">Servidor de impresión</a>, para que requiera autenticación.</p>
<p class="para">
...
<p class="para">De forma predeterminada, Samba comprueba los grupos del sistema local registrados en <span class="file filename">/etc/group</span> para determinar qué usuarios pertenecen a qué grupos. Para más información sobre cómo añadir a y quitar usuarios de ciertos grupos, consulte <a class="xref" href="user-management.html.es#adding-deleting-users" title="Añadir y eliminar usuarios">Añadir y eliminar usuarios</a>.</p>
...
<div class="region"><div class="contents">
<p class="para">Ubuntu incorpora el módulo de seguridad <span class="app application">AppArmor</span>, que proporciona controles de acceso obligatorios. Deberá adaptar el perfil predeterminado de AppArmor para Samba con objeto de adaptarlo a su configuración. Para más información sobre cómo usar AppArmor, consulte see <a class="xref" href="apparmor.html.es" title="AppArmor">AppArmor</a>.</p>
