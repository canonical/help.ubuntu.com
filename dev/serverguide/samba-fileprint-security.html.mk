...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.mk" title="Водич за Ubuntu Server">Водич за Ubuntu Server</a> » <a class="trail" href="samba.html.mk" title="Samba">Samba</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="samba-printserver.html.mk" title="Print Server">Previous</a><a class="nextlinks-next" href="samba-dc.html.mk" title="As a Domain Controller">Next</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html.mk#samba-security-mode" title="Samba Security Modes">Samba Security Modes</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.mk#samba-user-security" title="Security = User">Security = User</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.mk#samba-share-security" title="Share Security">Share Security</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.mk#samba-apparmor" title="Samba AppArmor Profile">Samba AppArmor Profile</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.mk#samba-security-resources" title="Resources">Resources</a></li>
</ul></div>
...
<li class="list itemizedlist">
          ...
          <a class="xref" href="samba-dc.html.mk" title="As a Domain Controller">As a Domain Controller</a> for further information.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
          <span class="em emphasis">security = ADS:</span> allows the Samba server to join an Active Directory domain as a native
          member.  See <a class="xref" href="samba-ad-integration.html.mk" title="Active Directory Integration">Active Directory Integration</a> for details.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<div class="region"><div class="contents">
<p class="para">
      This section will reconfigure the Samba file and print server, from <a class="xref" href="samba-fileserver.html.mk" title="File Server">File Server</a> and
      <a class="xref" href="samba-printserver.html.mk" title="Print Server">Print Server</a>, to require authentication.
      </p>
<p class="para">
...
<div class="region"><div class="contents">
<p class="para">Групите дефинираат колекција на компјутери или корисници кои имаат заедничко ниво на пристап до одредени мрежни ресурси и одредуваат ниво на грануларност во контролирањето на пристапот до таквите ресурси. На пример, ако групата <span class="em emphasis">qa</span> е дефинирана и содржи корисници <span class="em emphasis">freda</span>, <span class="em emphasis">danika</span>, и <span class="em emphasis">rob</span>, а втора група <span class="em emphasis">support</span> е дефинирана и составена од корисниците <span class="em emphasis">danika</span>, <span class="em emphasis">jeremy</span>, и <span class="em emphasis">vincent</span> тогаш одредени мрежни ресурси конфигурирани да ѝ дадат пристап на <span class="em emphasis">qa</span> групата ќе им дозволат пристап на freda, danika и rob, но не и на jeremy или vincent. Бидејќи корисникот <span class="em emphasis">danika</span> припаѓа и на <span class="em emphasis">qa</span> и на <span class="em emphasis">support</span> групата, таа ќе има пристап до ресурсите конфигурирани за пристап од страна на двете групи, за разлика од сите други корисници кои ќе имаат само пристап до ресурсите кои експлицитно им се дозволени во зависност од групата во која припаѓаат.</p>
<p class="para">
        ...
        <a class="xref" href="user-management.html.mk#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a>.
        </p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Дозволи на датотека</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
      ...
      AppArmor see <a class="xref" href="apparmor.html.mk" title="AppArmor">AppArmor</a>.
      </p>
<p class="para">
