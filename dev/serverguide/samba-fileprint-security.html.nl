...
<a class="nextlinks-prev" href="samba-printserver.html.nl" title="Print Server">Vorige</a><a class="nextlinks-next" href="samba-dc.html.nl" title="As a Domain Controller">Volgende</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html.nl#samba-security-mode" title="Samba Security Modes">Samba Security Modes</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.nl#samba-user-security" title="Security = User">Security = User</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.nl#samba-share-security" title="Share Security">Share Security</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.nl#samba-apparmor" title="Samba AppArmor Profile">Samba AppArmor Profile</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.nl#samba-security-resources" title="Resources">Resources</a></li>
</ul></div>
...
<li class="list itemizedlist">
          ...
          <a class="xref" href="samba-dc.html.nl" title="As a Domain Controller">As a Domain Controller</a> for further information.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
          <span class="em emphasis">security = ADS:</span> allows the Samba server to join an Active Directory domain as a native
          member.  See <a class="xref" href="samba-ad-integration.html.nl" title="Active Directory Integration">Active Directory Integration</a> for details.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<div class="region"><div class="contents">
<p class="para">
      This section will reconfigure the Samba file and print server, from <a class="xref" href="samba-fileserver.html.nl" title="File Server">File Server</a> and
      <a class="xref" href="samba-printserver.html.nl" title="Print Server">Print Server</a>, to require authentication.
      </p>
<p class="para">
...
<p class="para">
        ...
        <a class="xref" href="user-management.html.nl#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a>.
        </p>
<p class="para">
...
<p class="para">
      ...
      AppArmor see <a class="xref" href="apparmor.html.nl" title="AppArmor">AppArmor</a>.
      </p>
<p class="para">
