...
<a class="nextlinks-prev" href="samba-printserver.html.ru" title="Сервер печати">Назад</a><a class="nextlinks-next" href="samba-dc.html.ru" title="Как контроллер домена">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Защита файлового сервера и сервера печати</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ru#samba-security-mode" title="Режимы безопасности Samba">Режимы безопасности Samba</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ru#samba-user-security" title="Security = User">Security = User</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ru#samba-share-security" title="Безопасность ресурсов">Безопасность ресурсов</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ru#samba-apparmor" title="Профиль Samba для AppArmor">Профиль Samba для AppArmor</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ru#samba-security-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">security = domain:</span>. Этот режим позволяет серверу Samba представляться Windows-клиентам как первичный контроллер домена (PDC), резервный контроллер домена (BDC) или сервер-участник домена (DMS). Для подробной информации смотрите <a class="xref" href="samba-dc.html.ru" title="Как контроллер домена">Как контроллер домена</a>.</p>
        </li>
<li class="list itemizedlist">
          <p class="para"><span class="em emphasis">security = ADS:</span> позволяет серверу Samba присоединиться к сомену Active Directory как полноправный участник. Более подробно читайте <a class="xref" href="samba-ad-integration.html.ru" title="Интеграция с Active Directory">Интеграция с Active Directory</a>.</p>
        </li>
<li class="list itemizedlist">
...
<div class="region"><div class="contents">
<p class="para">В этом разделе мы настроим файловый сервер и сервер печати на Samba, описанный в <a class="xref" href="samba-fileserver.html.ru" title="Файловый сервер">Файловый сервер</a> и <a class="xref" href="samba-printserver.html.ru" title="Сервер печати">Сервер печати</a>, таким образом, чтобы он требовал аутентификации.</p>
<p class="para">
