...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="samba.html.sl" title="Samba">Samba</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="samba-printserver.html.sl" title="Tiskalniški strežnik">Nazaj</a><a class="nextlinks-next" href="samba-dc.html.sl" title="As a Domain Controller">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html.sl#samba-security-mode" title="Varnostni načini Samba">Varnostni načini Samba</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.sl#samba-user-security" title="Security = User">Security = User</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.sl#samba-share-security" title="Share Security">Share Security</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.sl#samba-apparmor" title="Profil Samba Apparmor">Profil Samba Apparmor</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.sl#samba-security-resources" title="Viri">Viri</a></li>
</ul></div>
<div class="sect2 sect" id="samba-security-mode"><div class="inner">
<div class="hgroup"><h2 class="title">Varnostni načini Samba</h2></div>
...
<li class="list itemizedlist">
          ...
          <a class="xref" href="samba-dc.html.sl" title="As a Domain Controller">As a Domain Controller</a> for further information.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
          <span class="em emphasis">security = ADS:</span> allows the Samba server to join an Active Directory domain as a native
          member.  See <a class="xref" href="samba-ad-integration.html.sl" title="Active Directory Integration">Active Directory Integration</a> for details.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<div class="region"><div class="contents">
<p class="para">
      This section will reconfigure the Samba file and print server, from <a class="xref" href="samba-fileserver.html.sl" title="File Server">File Server</a> and
      <a class="xref" href="samba-printserver.html.sl" title="Tiskalniški strežnik">Tiskalniški strežnik</a>, to require authentication.
      </p>
<p class="para">
...
<p class="para">Uredite datoteko <span class="file filename">/etc/samba/smb.conf</span> in v odseku <span class="em emphasis">[share]</span> spremenite:</p>
<div class="code"><pre class="contents ">    guest ok = no
</pre></div>
<p class="para">Za konec znova zaženite program Samba, da se uveljavijo nove nastavitve:</p>
...
<div class="hgroup"><h3 class="title">Skupine</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">
        ...
        <a class="xref" href="user-management.html.sl#adding-deleting-users" title="Dodajanje in odstranjevanje uporabnikov">Dodajanje in odstranjevanje uporabnikov</a>.
        </p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Dovoljenja datotek</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Ko uredite datoteko <span class="file filename">/etc/samba/smb.conf</span>, znova zaženite program Samba, da se uveljavijo nove nastavitve:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo systemctl restart smbd.service nmbd.service</span>
</pre></div>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
          <p class="para">
...
<p class="para">Nato ponovno priklopite razdelek:</p>
...
<p class="para">
      ...
      AppArmor see <a class="xref" href="apparmor.html.sl" title="AppArmor">AppArmor</a>.
      </p>
<p class="para">
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Ta paket vsebuje profile za nekaj drugih binarnih datotek.</p>
      </div></div></div></div>
<p class="para">
...
<li class="list itemizedlist">
          <p class="para">Vodnik je na voljo tudi v <a href="http://www.amazon.com/exec/obidos/tg/detail/-/0131882228" class="ulink" title="http://www.amazon.com/exec/obidos/tg/detail/-/0131882228">tiskani različici</a>.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<li class="list itemizedlist">
          <p class="para">Stran <a href="https://help.ubuntu.com/community/Samba" class="ulink" title="https://help.ubuntu.com/community/Samba">Samba na Ubuntu Wiki</a>.</p>
        </li>
</ul></div></div></div>
</div></div>
</div>
