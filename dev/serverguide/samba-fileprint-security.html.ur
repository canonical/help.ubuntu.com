...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.ur" title="Ubuntu Server Guide">Ubuntu Server Guide</a> » <a class="trail" href="samba.html.ur" title="Samba">Samba</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="samba-printserver.html.ur" title="Print Server">Previous</a><a class="nextlinks-next" href="samba-dc.html.ur" title="As a Domain Controller">Next</a>
</div>
<div class="hgroup"><h1 class="title">Securing File and Print Server</h1></div>
<div class="region">
<div class="contents"></div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ur#samba-security-mode" title="Samba Security Modes">Samba Security Modes</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ur#samba-user-security" title="Security = User">Security = User</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ur#samba-share-security" title="Share Security">Share Security</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ur#samba-apparmor" title="Samba AppArmor Profile">Samba AppArmor Profile</a></li>
<li class="links"><a class="xref" href="samba-fileprint-security.html.ur#samba-security-resources" title="Resources">Resources</a></li>
</ul></div>
...
<li class="list itemizedlist">
          ...
          <a class="xref" href="samba-dc.html.ur" title="As a Domain Controller">As a Domain Controller</a> for further information.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
          <span class="em emphasis">security = ADS:</span> allows the Samba server to join an Active Directory domain as a native
          member.  See <a class="xref" href="samba-ad-integration.html.ur" title="Active Directory Integration">Active Directory Integration</a> for details.
          </p>
        </li>
<li class="list itemizedlist">
          <p class="para">
...
<div class="region"><div class="contents">
<p class="para">
      This section will reconfigure the Samba file and print server, from <a class="xref" href="samba-fileserver.html.ur" title="File Server">File Server</a> and
      <a class="xref" href="samba-printserver.html.ur" title="Print Server">Print Server</a>, to require authentication.
      </p>
<p class="para">
...
<p class="para">
        ...
        <a class="xref" href="user-management.html.ur#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a>.
        </p>
<p class="para">
...
<p class="para">
      ...
      AppArmor see <a class="xref" href="apparmor.html.ur" title="AppArmor">AppArmor</a>.
      </p>
<p class="para">
