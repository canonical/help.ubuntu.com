...
<a class="nextlinks-prev" href="samba-introduction.html.be" title="Уводзіны">Назад</a><a class="nextlinks-next" href="samba-printserver.html.be" title="Сэрвер друку">Наперад</a>
</div>
...
<p class="para">
    ...
    your environment requires stricter Access Controls see <a class="xref" href="samba-fileprint-security.html.be" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html.be#samba-fileserver-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.be#samba-fileserver-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.be#samba-fileserver-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<li class="steps">
      ...
      <p class="para">Нарэшце перазапусьціце сэрвісы <span class="app application">samba</span> каб уключыць новыя настаўленьні:</p>
...
<div class="note note-warning" title="Перасцярога"><div class="inner"><div class="region"><div class="contents">
        ...
        configuration see <a class="xref" href="samba-fileprint-security.html.be" title="Securing File and Print Server">Securing File and Print Server</a>.
        </p>
      </div></div></div></div>
<p class="para">
