...
<a class="nextlinks-prev" href="samba-introduction.html.cs" title="Úvod">Předchozí</a><a class="nextlinks-next" href="samba-printserver.html.cs" title="Print Server">Následující</a>
</div>
...
<p class="para">
    ...
    your environment requires stricter Access Controls see <a class="xref" href="samba-fileprint-security.html.cs" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html.cs#samba-fileserver-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.cs#samba-fileserver-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.cs#samba-fileserver-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<div class="note note-warning" title="Varování"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Opakujeme, že výše uvedené nastavení povoluje přístup všem klientům v místní síti. Pro zabezbečnější nastavení čtěte <a class="xref" href="samba-fileprint-security.html.cs" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
      </div></div></div></div>
<p class="para">
