...
<a class="nextlinks-prev" href="samba-introduction.html.el" title="Εισαγωγή">Προηγούμενο</a><a class="nextlinks-next" href="samba-printserver.html.el" title="Διακομιστής Εκτύπωσης">Επόμενο</a>
</div>
...
<p class="para">
    ...
    your environment requires stricter Access Controls see <a class="xref" href="samba-fileprint-security.html.el" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html.el#samba-fileserver-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.el#samba-fileserver-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.el#samba-fileserver-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<div class="note note-warning" title="Προειδοποίηση"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Για άλλη μια φορά, η ανωτέρω ρύθμιση δίνει πρόσβαση σε κάθε πελάτη του τοπικού δικτύου. Για μια πιο ασφαλή ρύθμιση βλ. <a class="xref" href="samba-fileprint-security.html.el" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
      </div></div></div></div>
<p class="para">
