...
<a class="nextlinks-prev" href="samba-introduction.html.es" title="Introducción">Anterior</a><a class="nextlinks-next" href="samba-printserver.html.es" title="Servidor de impresión">Siguiente</a>
</div>
...
<p class="para">
    ...
    your environment requires stricter Access Controls see <a class="xref" href="samba-fileprint-security.html.es" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html.es#samba-fileserver-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.es#samba-fileserver-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.es#samba-fileserver-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<div class="note note-warning" title="Advertencia"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Una vez más, la configuración anterior proporciona acceso total a todos los clientes de la red local. Para una configuración más segura, consulte <a class="xref" href="samba-fileprint-security.html.es" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
      </div></div></div></div>
