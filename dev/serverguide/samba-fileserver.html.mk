...
<a class="nextlinks-prev" href="samba-introduction.html.mk" title="Вовед">Previous</a><a class="nextlinks-next" href="samba-printserver.html.mk" title="Print Server">Next</a>
</div>
...
<p class="para">
    ...
    your environment requires stricter Access Controls see <a class="xref" href="samba-fileprint-security.html.mk" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html.mk#samba-fileserver-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.mk#samba-fileserver-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.mk#samba-fileserver-resources" title="Resources">Resources</a></li>
</ul></div>
...
<div class="note note-warning" title="Предупредување"><div class="inner"><div class="region"><div class="contents">
        ...
        configuration see <a class="xref" href="samba-fileprint-security.html.mk" title="Securing File and Print Server">Securing File and Print Server</a>.
        </p>
      </div></div></div></div>
<p class="para">
