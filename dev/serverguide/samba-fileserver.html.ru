...
<a class="nextlinks-prev" href="samba-introduction.html.ru" title="Введение">Назад</a><a class="nextlinks-next" href="samba-printserver.html.ru" title="Сервер печати">Вперёд</a>
</div>
...
<p class="para">
    ...
    your environment requires stricter Access Controls see <a class="xref" href="samba-fileprint-security.html.ru" title="Защита файлового сервера и сервера печати">Защита файлового сервера и сервера печати</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html.ru#samba-fileserver-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.ru#samba-fileserver-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.ru#samba-fileserver-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<div class="note note-warning" title="Предупреждение"><div class="inner"><div class="region"><div class="contents">
        <p class="para">Повторим ещё раз, приведенная выше конфигурация даёт полный доступ любому клиенту в локальной сети. Если вам нужна более защищённая конфигурация, смотрите  <a class="xref" href="samba-fileprint-security.html.ru" title="Защита файлового сервера и сервера печати">Защита файлового сервера и сервера печати</a>.</p>
      </div></div></div></div>
