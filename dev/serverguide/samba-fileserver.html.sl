...
<a class="nextlinks-prev" href="samba-introduction.html.sl" title="Uvod">Nazaj</a><a class="nextlinks-next" href="samba-printserver.html.sl" title="Tiskalniški strežnik">Naprej</a>
</div>
...
<p class="para">
    ...
    your environment requires stricter Access Controls see <a class="xref" href="samba-fileprint-security.html.sl" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html.sl#samba-fileserver-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.sl#samba-fileserver-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.sl#samba-fileserver-resources" title="Viri">Viri</a></li>
</ul></div>
...
<p class="para">Prvi korak je, da namestite paket <span class="app application">samba</span>. V terminalu vpišite:</p>
...
<li class="steps">
        ...
        <p class="para">Zdaj ko je program <span class="app application">Samba</span> nastavljen, mora biti ustvarjena mapa in spremenjena dovoljenja. V terminalu vnesite:</p>
...
<li class="steps">
      ...
      <p class="para">Za konec znova zaženite storitve <span class="app application">samba</span>, da se uveljavijo nove nastavitve:</p>
...
<div class="note note-warning" title="Opozorilo"><div class="inner"><div class="region"><div class="contents">
        ...
        configuration see <a class="xref" href="samba-fileprint-security.html.sl" title="Securing File and Print Server">Securing File and Print Server</a>.
        </p>
      </div></div></div></div>
<p class="para">
