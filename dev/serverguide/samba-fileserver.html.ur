...
<a class="nextlinks-prev" href="samba-introduction.html.ur" title="تعارف">Previous</a><a class="nextlinks-next" href="samba-printserver.html.ur" title="Print Server">Next</a>
</div>
...
<p class="para">
    ...
    your environment requires stricter Access Controls see <a class="xref" href="samba-fileprint-security.html.ur" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-fileserver.html.ur#samba-fileserver-installation" title="Installation">Installation</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.ur#samba-fileserver-configuration" title="Configuration">Configuration</a></li>
<li class="links"><a class="xref" href="samba-fileserver.html.ur#samba-fileserver-resources" title="Resources">Resources</a></li>
</ul></div>
...
<div class="note note-warning" title="Warning"><div class="inner"><div class="region"><div class="contents">
        ...
        configuration see <a class="xref" href="samba-fileprint-security.html.ur" title="Securing File and Print Server">Securing File and Print Server</a>.
        </p>
      </div></div></div></div>
<p class="para">
