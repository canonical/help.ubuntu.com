...
<a class="nextlinks-prev" href="samba.html.be" title="Samba">Назад</a><a class="nextlinks-next" href="samba-fileserver.html.be" title="File Server">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Уводзіны</h1></div>
...
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">File and Printer Sharing Services</span>. Using the Server Message Block (SMB) 
        protocol to facilitate the sharing of files, folders, volumes, and the sharing of printers throughout the network.
        </p>
      </li>
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">Directory Services</span>. Sharing vital information about the computers and users of 
...
<li class="list itemizedlist">
        <p class="para">
        <span class="em em-bold emphasis">Authentication and Access</span>. Establishing the identity of a computer or user of 
