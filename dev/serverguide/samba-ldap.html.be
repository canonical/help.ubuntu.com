...
<a class="nextlinks-prev" href="openldap-server.html.be" title="Сэрвер OpenLDAP">Назад</a><a class="nextlinks-next" href="kerberos.html.be" title="Kerberos">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Samba і LDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html.be" title="Сэрвер OpenLDAP">Сэрвер OpenLDAP</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html.be#samba-ldap-installation" title="Software Installation">Software Installation</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.be#samba-ldap-openldap-configuration" title="LDAP Configuration">LDAP Configuration</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.be#samba-ldap-samba-configuration" title="Наладкі Samba">Наладкі Samba</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.be#samba-ldap-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
		For more information on schemas and their installation see <a class="xref" href="openldap-server.html.be#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a>.
		</p>
	</div></div></div></div>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<div class="region"><div class="contents">
<p class="para">
	There are multiple ways to configure Samba. For details on some common configurations see <a class="xref" href="samba.html.be" title="Samba">Samba</a>.      
...
<p class="para">
	...
	can be found in the <a class="xref" href="openldap-server.html.be#openldap-auth-config" title="LDAP Authentication">LDAP Authentication</a> section, but we only need the NSS part.
	</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<li class="list itemizedlist">
		<p class="para">
		For more information on installing and configuring Samba see <a class="xref" href="samba.html.be" title="Samba">Samba</a> of this Ubuntu Server Guide.
		</p>
		</li>
<li class="list itemizedlist">
		<p class="para">
