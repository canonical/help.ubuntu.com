...
<a class="nextlinks-prev" href="openldap-server.html.es" title="Servidor OpenLDAP">Anterior</a><a class="nextlinks-next" href="kerberos.html.es" title="Kerberos">Siguiente</a>
</div>
<div class="hgroup"><h1 class="title">Samba y LDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html.es" title="Servidor OpenLDAP">Servidor OpenLDAP</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html.es#samba-ldap-installation" title="Instalación de software">Instalación de software</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.es#samba-ldap-openldap-configuration" title="Configuración LDAP">Configuración LDAP</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.es#samba-ldap-samba-configuration" title="Configuración Samba">Configuración Samba</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.es#samba-ldap-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para">Instale estos paquetes ahora:</p>
...
<div class="hgroup"><h2 class="title">Configuración LDAP</h2></div>
<div class="region">
<div class="contents">
<p class="para">
...
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
		For more information on schemas and their installation see <a class="xref" href="openldap-server.html.es#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a>.
		</p>
	</div></div></div></div>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<div class="hgroup"><h3 class="title">Índices Samba</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<p class="para">Cree el archivo <span class="file filename">samba_indices.ldif</span> con el siguiente contenido:</p>
...
<div class="region"><div class="contents">
<p class="para">
	There are multiple ways to configure Samba. For details on some common configurations see <a class="xref" href="samba.html.es" title="Samba">Samba</a>.      
...
<p class="para">
	...
	can be found in the <a class="xref" href="openldap-server.html.es#openldap-auth-config" title="Autenticación LDAP">Autenticación LDAP</a> section, but we only need the NSS part.
	</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<li class="list itemizedlist">
		<p class="para">Para eliminar un usuario:</p>
...
<li class="list itemizedlist">
		<p class="para">Para añadir un grupo:</p>
...
<li class="list itemizedlist">
		<p class="para">Para hacer a un usuario existente miembro de un grupo:</p>
...
<li class="list itemizedlist">
		<p class="para">Para eliminar un usuario de un grupo:</p>
...
<li class="list itemizedlist">
		<p class="para">Para añadir una cuenta de máquina Samba:</p>
...
<li class="list itemizedlist">
		<p class="para">
		For more information on installing and configuring Samba see <a class="xref" href="samba.html.es" title="Samba">Samba</a> of this Ubuntu Server Guide.
		</p>
		</li>
<li class="list itemizedlist">
		<p class="para">
