...
<a class="nextlinks-prev" href="openldap-server.html.mk" title="OpenLDAP Server">Previous</a><a class="nextlinks-next" href="kerberos.html.mk" title="Kerberos">Next</a>
</div>
...
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html.mk" title="OpenLDAP Server">OpenLDAP Server</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html.mk#samba-ldap-installation" title="Software Installation">Software Installation</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.mk#samba-ldap-openldap-configuration" title="LDAP Configuration">LDAP Configuration</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.mk#samba-ldap-samba-configuration" title="Samba Configuration">Samba Configuration</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.mk#samba-ldap-resources" title="Resources">Resources</a></li>
</ul></div>
...
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
		For more information on schemas and their installation see <a class="xref" href="openldap-server.html.mk#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a>.
		</p>
	</div></div></div></div>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<div class="region"><div class="contents">
<p class="para">
	There are multiple ways to configure Samba. For details on some common configurations see <a class="xref" href="samba.html.mk" title="Samba">Samba</a>.      
...
<p class="para">
	...
	can be found in the <a class="xref" href="openldap-server.html.mk#openldap-auth-config" title="LDAP Authentication">LDAP Authentication</a> section, but we only need the NSS part.
	</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<li class="list itemizedlist">
		<p class="para">
		For more information on installing and configuring Samba see <a class="xref" href="samba.html.mk" title="Samba">Samba</a> of this Ubuntu Server Guide.
		</p>
		</li>
<li class="list itemizedlist">
		<p class="para">
