...
<a class="nextlinks-prev" href="openldap-server.html.ru" title="Сервер OpenLDAP">Назад</a><a class="nextlinks-next" href="kerberos.html.ru" title="Kerberos">Вперёд</a>
</div>
...
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html.ru" title="Сервер OpenLDAP">Сервер OpenLDAP</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html.ru#samba-ldap-installation" title="Установка программного обеспечения">Установка программного обеспечения</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.ru#samba-ldap-openldap-configuration" title="Конфигурация LDAP">Конфигурация LDAP</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.ru#samba-ldap-samba-configuration" title="Настройка Samba">Настройка Samba</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.ru#samba-ldap-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents">
		<p class="para">Для более детальной информации о схемах и их установке смотрите <a class="xref" href="openldap-server.html.ru#openldap-configuration" title="Изменение базы данных настройки slapd">Изменение базы данных настройки slapd</a>.</p>
	</div></div></div></div>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
		<p class="para">
...
<div class="region"><div class="contents">
<p class="para">
	There are multiple ways to configure Samba. For details on some common configurations see <a class="xref" href="samba.html.ru" title="Samba">Samba</a>.      
...
<p class="para">
	...
	can be found in the <a class="xref" href="openldap-server.html.ru#openldap-auth-config" title="Установление подлинности через LDAP">Установление подлинности через LDAP</a> section, but we only need the NSS part.
	</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<li class="list itemizedlist">
		<p class="para">Для более подробной информации об установке и настройке Samba смотрите раздел <a class="xref" href="samba.html.ru" title="Samba">Samba</a> этого руководства по Ubuntu Server.</p>
		</li>
<li class="list itemizedlist">
