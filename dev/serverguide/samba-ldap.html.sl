...
<a class="nextlinks-prev" href="openldap-server.html.sl" title="Strežnik OpenLDAP">Nazaj</a><a class="nextlinks-next" href="kerberos.html.sl" title="Kerberos">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Samba in LDAP</h1></div>
<div class="region">
<div class="contents">
<p class="para">
	...
	that can accept authentication requests. See <a class="xref" href="openldap-server.html.sl" title="Strežnik OpenLDAP">Strežnik OpenLDAP</a> for details on fulfilling this requirement. Once this
...
<li class="links"><a class="xref" href="samba-ldap.html.sl#samba-ldap-installation" title="Software Installation">Software Installation</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.sl#samba-ldap-openldap-configuration" title="LDAP Configuration">LDAP Configuration</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.sl#samba-ldap-samba-configuration" title="Nastavljanje Sambe">Nastavljanje Sambe</a></li>
<li class="links"><a class="xref" href="samba-ldap.html.sl#samba-ldap-resources" title="Viri">Viri</a></li>
</ul></div>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
		For more information on schemas and their installation see <a class="xref" href="openldap-server.html.sl#openldap-configuration" title="Modifying the slapd Configuration Database">Modifying the slapd Configuration Database</a>.
		</p>
	</div></div></div></div>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<div class="region"><div class="contents">
<p class="para">
	There are multiple ways to configure Samba. For details on some common configurations see <a class="xref" href="samba.html.sl" title="Samba">Samba</a>.      
...
<p class="para">
	...
	can be found in the <a class="xref" href="openldap-server.html.sl#openldap-auth-config" title="Overitev LDAP">Overitev LDAP</a> section, but we only need the NSS part.
	</p>
<div class="steps"><div class="inner"><ol class="steps">
<li class="steps">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo smbpasswd -a uporabniško-ime</span>
</pre></div>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo smbldap-userdel uporabniško-ime</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo smbldap-groupadd -a ime-skupine</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo smbldap-groupmod -m uporabniško-ime ime-skupine</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo smbldap-groupmod -x uporabniško-ime ime-skupine</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo smbldap-useradd -t 0 -w uporabniško-ime</span>
</pre></div>
...
<li class="list itemizedlist">
		<p class="para">
		For more information on installing and configuring Samba see <a class="xref" href="samba.html.sl" title="Samba">Samba</a> of this Ubuntu Server Guide.
		</p>
		</li>
<li class="list itemizedlist">
		<p class="para">
