...
<a class="nextlinks-prev" href="samba-fileserver.html.be" title="File Server">Назад</a><a class="nextlinks-next" href="samba-fileprint-security.html.be" title="Securing File and Print Server">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Сэрвер друку</h1></div>
<div class="region">
<div class="contents">
<p class="para">
    Another common use of Samba is to configure it to share printers installed, either locally or over the network, on 
    an Ubuntu server.  Similar to <a class="xref" href="samba-fileserver.html.be" title="File Server">File Server</a> this section will configure Samba to allow any client
    on the local network to use the installed printers without prompting for a username and password.
    </p>
<p class="para">Для больш бясьпечнай наладкі глядзіце <a class="xref" href="samba-fileprint-security.html.be" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-printserver.html.be#samba-printserver-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.be#samba-printserver-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.be#samba-printserver-resources" title="Рэсурсы">Рэсурсы</a></li>
</ul></div>
...
<p class="para">
      ...
      installation. See <a class="xref" href="cups.html.be" title="CUPS - Сэрвер друку">CUPS - Сэрвер друку</a> for details.
      </p>
<p class="para">Каб устанавіць пакет <span class="app application">samba</span>, увядзіце ў тэрмінале:</p>
...
<p class="para">Пасьля рэдагаваньня <span class="file filename">smb.conf</span> перазапусьціце Samba:</p>
...
<li class="list itemizedlist">
          <p class="para">Яшчэ глядзіце <a href="http://www.cups.org/" class="ulink" title="http://www.cups.org/">CUPS Website</a> каб прачытаць больш зьвестак пра настаўленьне CUPS.</p>
        </li>
<li class="list itemizedlist">
          <p class="para">
