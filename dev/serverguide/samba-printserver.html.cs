...
<a class="nextlinks-prev" href="samba-fileserver.html.cs" title="File Server">Předchozí</a><a class="nextlinks-next" href="samba-fileprint-security.html.cs" title="Securing File and Print Server">Následující</a>
</div>
...
<p class="para">
    ...
    an Ubuntu server.  Similar to <a class="xref" href="samba-fileserver.html.cs" title="File Server">File Server</a> this section will configure Samba to allow any client
    on the local network to use the installed printers without prompting for a username and password.
    </p>
<p class="para">Pro lépe zabezpečené nastavení čtěte <a class="xref" href="samba-fileprint-security.html.cs" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-printserver.html.cs#samba-printserver-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.cs#samba-printserver-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.cs#samba-printserver-resources" title="Zdroje">Zdroje</a></li>
</ul></div>
...
<p class="para">Před instalací a nastavením Samba je vhodném mít funkční instalaci <span class="app application">CUPS</span>. Pro více informací čtěte <a class="xref" href="cups.html.cs" title="CUPS - Print Server">CUPS - Print Server</a>.</p>
