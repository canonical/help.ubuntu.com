...
<a class="nextlinks-prev" href="samba-fileserver.html.el" title="File Server">Προηγούμενο</a><a class="nextlinks-next" href="samba-fileprint-security.html.el" title="Securing File and Print Server">Επόμενο</a>
</div>
<div class="hgroup"><h1 class="title">Διακομιστής Εκτύπωσης</h1></div>
<div class="region">
<div class="contents">
<p class="para">Μια άλλη κοινή χρήση του Samba είναι η διαμόρφωσή του ώστε να διαμοιράζει εγκατεστημένους εκτυπωτές είτε τοπικά είτε μέσω του διαδικτύου, σε έναν διακομιστή Ubuntu. Παρόμοια με το <a class="xref" href="samba-fileserver.html.el" title="File Server">File Server</a> αυτό το τμήμα θα διαμορφώσει το Samba ώστε να επιτρέπει σε κάθε πελάτη στο τοπικό δίκτυο να χρησιμοποιεί τους εγκατεστημένους εκτυπωτές χωρίς να ζητά όνομα χρήστης και κωδικό πρόσβασης.</p>
<p class="para">Για μια πιο ασφαλή διαμόρφωση βλ. <a class="xref" href="samba-fileprint-security.html.el" title="Securing File and Print Server">Securing File and Print Server</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-printserver.html.el#samba-printserver-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.el#samba-printserver-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.el#samba-printserver-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
...
<p class="para">Πριν εγκαταστήσετε και διαμορφώσετε το Samba είναι καλό να έχετε ήδη μια λειτουργική εγκατάσταση <span class="app application">CUPS</span>. Δείτε <a class="xref" href="cups.html.el" title="CUPS - Εξυπηρετητής εκτυπώσεων">CUPS - Εξυπηρετητής εκτυπώσεων</a> για λεπτομέρειες.</p>
