...
<a class="nextlinks-prev" href="samba-fileserver.html.mk" title="File Server">Previous</a><a class="nextlinks-next" href="samba-fileprint-security.html.mk" title="Securing File and Print Server">Next</a>
</div>
...
<p class="para">
    ...
    an Ubuntu server.  Similar to <a class="xref" href="samba-fileserver.html.mk" title="File Server">File Server</a> this section will configure Samba to allow any client
    on the local network to use the installed printers without prompting for a username and password.
    </p>
<p class="para">
    For a more secure configuration see <a class="xref" href="samba-fileprint-security.html.mk" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-printserver.html.mk#samba-printserver-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.mk#samba-printserver-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.mk#samba-printserver-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para">
      ...
      installation. See <a class="xref" href="cups.html.mk" title="CUPS - Print Server">CUPS - Print Server</a> for details.
      </p>
<p class="para">
