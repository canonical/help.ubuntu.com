...
<a class="nextlinks-prev" href="samba-fileserver.html.nl" title="File Server">Vorige</a><a class="nextlinks-next" href="samba-fileprint-security.html.nl" title="Securing File and Print Server">Volgende</a>
</div>
...
<p class="para">
    ...
    an Ubuntu server.  Similar to <a class="xref" href="samba-fileserver.html.nl" title="File Server">File Server</a> this section will configure Samba to allow any client
    on the local network to use the installed printers without prompting for a username and password.
    </p>
<p class="para">
    For a more secure configuration see <a class="xref" href="samba-fileprint-security.html.nl" title="Securing File and Print Server">Securing File and Print Server</a>.
    </p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-printserver.html.nl#samba-printserver-installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.nl#samba-printserver-configuration" title="Configuratie">Configuratie</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.nl#samba-printserver-resources" title="Resources">Resources</a></li>
</ul></div>
...
<p class="para">
      ...
      installation. See <a class="xref" href="cups.html.nl" title="CUPS - Print Server">CUPS - Print Server</a> for details.
      </p>
<p class="para">
