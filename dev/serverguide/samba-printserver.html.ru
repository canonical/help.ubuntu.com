...
<a class="nextlinks-prev" href="samba-fileserver.html.ru" title="Файловый сервер">Назад</a><a class="nextlinks-next" href="samba-fileprint-security.html.ru" title="Защита файлового сервера и сервера печати">Вперёд</a>
</div>
<div class="hgroup"><h1 class="title">Сервер печати</h1></div>
<div class="region">
<div class="contents">
<p class="para">Ещё одной распространенной сферой применения Samba является предоставление доступа к принтерам, установленным на сервере Ubuntu локально или в сети. Так же, как и <a class="xref" href="samba-fileserver.html.ru" title="Файловый сервер">Файловый сервер</a>, этот раздел опишет процесс настройки Samba, позволяющий любому клиенту локальной сети использовать установленный принтер без необходимости вводить имя пользователя и пароль.</p>
<p class="para">Если вам нужна более защищённая конфигурация, смотрите <a class="xref" href="samba-fileprint-security.html.ru" title="Защита файлового сервера и сервера печати">Защита файлового сервера и сервера печати</a>.</p>
</div>
<div class="links sectionlinks" role="navigation"><ul>
<li class="links"><a class="xref" href="samba-printserver.html.ru#samba-printserver-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.ru#samba-printserver-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="samba-printserver.html.ru#samba-printserver-resources" title="Ресурсы">Ресурсы</a></li>
</ul></div>
...
<p class="para">Перед установкой и настройкой Samba неплохо бы иметь уже рабочую систему <span class="app application">CUPS</span>. Для разъяснений обратитесь к разделу <a class="xref" href="cups.html.ru" title="CUPS — сервер печати">CUPS — сервер печати</a></p>
