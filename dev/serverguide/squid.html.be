...
<title>Squid - паўнамоцны паслужнік</title>
...
<a class="nextlinks-prev" href="php.html.be" title="PHP - Scripting Language">Назад</a><a class="nextlinks-next" href="ruby-on-rails.html.be" title="Ruby on Rails">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Squid - паўнамоцны паслужнік</h1></div>
<div class="region">
<div class="contents">
<p class="para">
...
<li class="links"><a class="xref" href="squid.html.be#squid-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="squid.html.be#squid-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="squid.html.be#squid-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
...
<div class="region"><div class="contents">
<p class="para">
            Squid is configured by editing the directives contained within the <span class="file filename">/etc/squid/squid.conf</span> configuration file.
...
<li class="list itemizedlist">
                  ...
                  <p class="para">
                     Add the following to the <span class="em em-bold emphasis">bottom</span> of the ACL section of your <span class="file filename">/etc/squid/squid.conf</span> file:
                  </p>
<div class="code"><pre class="contents ">acl fortytwo_network src 192.168.42.0/24
                  ...
                  <p class="para">
                     ...
                     <span class="file filename">/etc/squid/squid.conf</span> file:
                  </p>
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents">
	  <p class="para">
          After making changes to the <span class="file filename">/etc/squid/squid.conf</span> file, save the file and restart the <span class="app application">squid</span> 
...
<div class="region"><div class="contents">
<p class="para">
      <a href="http://www.squid-cache.org/" class="ulink" title="http://www.squid-cache.org/">Вэб старонка Squid</a>
      </p>
<p class="para">
      <a href="https://help.ubuntu.com/community/Squid" class="ulink" title="https://help.ubuntu.com/community/Squid">Ubuntu Wiki Squid</a> page.
      </p>
</div></div>
</div></div>
</div>
