...
<a class="nextlinks-prev" href="php.html.el" title="PHP - Scripting Language">Προηγούμενο</a><a class="nextlinks-next" href="ruby-on-rails.html.el" title="Ruby on Rails">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="squid.html.el#squid-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="squid.html.el#squid-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="squid.html.el#squid-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
