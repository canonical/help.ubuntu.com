...
<a class="nextlinks-prev" href="php.html.ru" title="PHP — язык сценариев">Назад</a><a class="nextlinks-next" href="ruby-on-rails.html.ru" title="Ruby on Rails">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="squid.html.ru#squid-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="squid.html.ru#squid-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="squid.html.ru#squid-references" title="Ссылки">Ссылки</a></li>
</ul></div>
