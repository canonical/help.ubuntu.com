...
<a class="nextlinks-prev" href="php.html.sl" title="PHP - Scripting Language">Nazaj</a><a class="nextlinks-next" href="ruby-on-rails.html.sl" title="Ruby on Rails">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="squid.html.sl#squid-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="squid.html.sl#squid-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="squid.html.sl#squid-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<li class="list itemizedlist">
                  ...
                  <p class="para">Sledeče dodajte <span class="em em-bold emphasis">na dno</span> odseka ACL v datoteki <span class="file filename">/etc/squid/squid.conf</span>:</p>
<div class="code"><pre class="contents ">acl fortytwo_network src 192.168.42.0/24
</pre></div>
                  <p class="para">Nato dodajte sledeče <span class="em em-bold emphasis">na vrh</span> odseka http_access v datoteki <span class="file filename">/etc/squid/squid.conf</span>:</p>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
	  <p class="para">Ko končate z urejanjem datoteke <span class="file filename">/etc/squid/squid.conf</span>, jo shranite in znova zaženite <span class="app application">squid</span>, da se uveljavijo nove nastavitve, z uporabo sledečega ukaza:</p>
          <p class="para">
