...
<a class="nextlinks-prev" href="git.html.be" title="Git">Назад</a><a class="nextlinks-next" href="version-control-ref.html.be" title="Спасылкі">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="subversion.html.be#subversion-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="subversion.html.be#subversion-configuration" title="Server Configuration">Server Configuration</a></li>
<li class="links"><a class="xref" href="subversion.html.be#access-methods" title="Access Methods">Access Methods</a></li>
</ul></div>
...
<div class="hgroup"><h3 class="title">Імпартаваньне файлаў</h3></div>
...
<p class="para"> 
					...
					Apache2 web server.  To use SSL with Subversion add the above
                                        ...
                                        For more information on setting up Apache2 with SSL see <a class="xref" href="httpd.html.be#https-configuration" title="Настаўленьні HTTPS">Настаўленьні HTTPS</a>.
					</p>
<p class="para">
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents"><p class="para"> You must use the full path (/path/to/repos/project) 
