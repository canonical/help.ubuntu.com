...
<a class="nextlinks-prev" href="git.html.el" title="Git">Προηγούμενο</a><a class="nextlinks-next" href="version-control-ref.html.el" title="Αναφορές">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="subversion.html.el#subversion-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="subversion.html.el#subversion-configuration" title="Διαμόρφωση Διακομιστή">Διαμόρφωση Διακομιστή</a></li>
<li class="links"><a class="xref" href="subversion.html.el#access-methods" title="Μέθοδοι Πρόσβασης">Μέθοδοι Πρόσβασης</a></li>
</ul></div>
...
<p class="para"> 
					...
					Apache2 web server.  To use SSL with Subversion add the above
                                        ...
                                        For more information on setting up Apache2 with SSL see <a class="xref" href="httpd.html.el#https-configuration" title="Διαμόρφωση HTTPS">Διαμόρφωση HTTPS</a>.
					</p>
