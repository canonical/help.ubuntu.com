...
<a class="nextlinks-prev" href="git.html.es" title="Git">Anterior</a><a class="nextlinks-next" href="version-control-ref.html.es" title="Referencias">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="subversion.html.es#subversion-installation" title="Instalación">Instalación</a></li>
<li class="links"><a class="xref" href="subversion.html.es#subversion-configuration" title="Configuración del servidor">Configuración del servidor</a></li>
<li class="links"><a class="xref" href="subversion.html.es#access-methods" title="Métodos de acceso">Métodos de acceso</a></li>
</ul></div>
...
<p class="para"> 
					...
					Apache2 web server.  To use SSL with Subversion add the above
                                        ...
                                        For more information on setting up Apache2 with SSL see <a class="xref" href="httpd.html.es#https-configuration" title="Configuración HTTPS">Configuración HTTPS</a>.
					</p>
