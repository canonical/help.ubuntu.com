...
<a class="nextlinks-prev" href="git.html.mk" title="Git">Previous</a><a class="nextlinks-next" href="version-control-ref.html.mk" title="References">Next</a>
</div>
...
<li class="links"><a class="xref" href="subversion.html.mk#subversion-installation" title="Инсталација">Инсталација</a></li>
<li class="links"><a class="xref" href="subversion.html.mk#subversion-configuration" title="Server Configuration">Server Configuration</a></li>
<li class="links"><a class="xref" href="subversion.html.mk#access-methods" title="Access Methods">Access Methods</a></li>
</ul></div>
...
<p class="para"> 
					...
					Apache2 web server.  To use SSL with Subversion add the above
                                        ...
                                        For more information on setting up Apache2 with SSL see <a class="xref" href="httpd.html.mk#https-configuration" title="HTTPS Configuration">HTTPS Configuration</a>.
					</p>
<p class="para">
...
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents"><p class="para"> You must use the full path (/path/to/repos/project) 
