...
<a class="nextlinks-prev" href="git.html.nl" title="Git">Vorige</a><a class="nextlinks-next" href="version-control-ref.html.nl" title="References">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="subversion.html.nl#subversion-installation" title="Installatie">Installatie</a></li>
<li class="links"><a class="xref" href="subversion.html.nl#subversion-configuration" title="Server Configuration">Server Configuration</a></li>
<li class="links"><a class="xref" href="subversion.html.nl#access-methods" title="Access Methods">Access Methods</a></li>
</ul></div>
...
<p class="para"> 
					...
					Apache2 web server.  To use SSL with Subversion add the above
                                        ...
                                        For more information on setting up Apache2 with SSL see <a class="xref" href="httpd.html.nl#https-configuration" title="HTTPS Configuration">HTTPS Configuration</a>.
					</p>
<p class="para">
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="para"> You must use the full path (/path/to/repos/project) 
