...
<a class="nextlinks-prev" href="git.html.ru" title="Git">Назад</a><a class="nextlinks-next" href="version-control-ref.html.ru" title="Ссылки">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="subversion.html.ru#subversion-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="subversion.html.ru#subversion-configuration" title="Настройка сервера">Настройка сервера</a></li>
<li class="links"><a class="xref" href="subversion.html.ru#access-methods" title="Методы доступа">Методы доступа</a></li>
</ul></div>
...
<p class="para"> 
					...
					Apache2 web server.  To use SSL with Subversion add the above
                                        ...
                                        For more information on setting up Apache2 with SSL see <a class="xref" href="httpd.html.ru#https-configuration" title="Настройка HTTPS">Настройка HTTPS</a>.
					</p>
