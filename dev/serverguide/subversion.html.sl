...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="version-control-system.html.sl" title="Version Control System">Version Control System</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="git.html.sl" title="Git">Nazaj</a><a class="nextlinks-next" href="version-control-ref.html.sl" title="Sklici">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="subversion.html.sl#subversion-installation" title="Namestitev">Namestitev</a></li>
<li class="links"><a class="xref" href="subversion.html.sl#subversion-configuration" title="Nastavljanje strežnika">Nastavljanje strežnika</a></li>
<li class="links"><a class="xref" href="subversion.html.sl#access-methods" title="Metode dostopa">Metode dostopa</a></li>
</ul></div>
...
<div class="hgroup"><h2 class="title">Nastavljanje strežnika</h2></div>
<div class="region">
<div class="contents"><p class="para">
...
<div class="hgroup"><h3 class="title">Ustvarite skladišče Subversion</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h3 class="title">Uvažanje datotek</h3></div>
...
<div class="hgroup"><h2 class="title">Metode dostopa</h2></div>
<div class="region">
<div class="contents">
...
<div class="table">
<div class="title"><h3><span class="title">Metode dostopa</span></h3></div>
<table summary="Metode dostopa" style="border: solid 1px;">
<thead><tr>
<th class="td-colsep"><p class="para">Schema</p></th>
<th><p class="para">Metoda dostopa</p></th>
</tr></thead>
<tbody>
<tr>
...
<td><p class="para">Enako kot http://, ampak s šifriranjem SSL</p></td>
</tr>
<tr class="shade">
...
<div class="hgroup"><h3 class="title">Neposreden dostop do skladišča (file://)</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h3 class="title">Dostop preko protokola WebDAV (http://)</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo htpasswd -c /etc/subversion/passwd uporabniško-ime</span>
</pre></div>
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">svn co http://ime-streznika/svn</span></pre></div>
...
<div class="hgroup"><h3 class="title">Dostop preko protokola WebDAV s šifriranjem SSL (https://)</h3></div>
<div class="region"><div class="contents">
<p class="para"> 
					...
					Apache2 web server.  To use SSL with Subversion add the above
                                        ...
                                        For more information on setting up Apache2 with SSL see <a class="xref" href="httpd.html.sl#https-configuration" title="Nastavljanje HTTPS">Nastavljanje HTTPS</a>.
					</p>
<p class="para">
...
<div class="hgroup"><h3 class="title">Dostop preko protokola po meri (svn://)</h3></div>
<div class="region"><div class="contents">
<p class="para"> 
...
<p class="para">Za več podrobnosti si oglejte datoteko.</p>
<p class="para">
...
<p class="para">
<div class="screen"><pre class="contents "><span class="cmd command">cd mapa-projekta ; svn update</span>
</pre></div>
                                        </p>
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="para"> You must use the full path (/path/to/repos/project) 
