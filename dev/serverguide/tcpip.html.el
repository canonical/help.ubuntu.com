...
<a class="nextlinks-prev" href="network-configuration.html.el" title="Διαμόρφωση Δικτύου">Προηγούμενο</a><a class="nextlinks-next" href="dhcp.html.el" title="Πρωτόκολλο Δυναμικής Διαμόρφωσης Κεντρικού Υπολογιστή (Dynamic Host Configuration Protocol (DHCP))">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="tcpip.html.el#tcpip-introduction" title="Εισαγωγή TCP/IP">Εισαγωγή TCP/IP</a></li>
<li class="links"><a class="xref" href="tcpip.html.el#tcpip-configuration" title="Διαμόρφωση TCP/IP">Διαμόρφωση TCP/IP</a></li>
<li class="links"><a class="xref" href="tcpip.html.el#ip-routing" title="Δρομολόγηση IP">Δρομολόγηση IP</a></li>
<li class="links"><a class="xref" href="tcpip.html.el#tcp-and-udp" title="TCP και UDP">TCP και UDP</a></li>
<li class="links"><a class="xref" href="tcpip.html.el#icmp" title="ICMP">ICMP</a></li>
<li class="links"><a class="xref" href="tcpip.html.el#daemons" title="Δαίμονες">Δαίμονες</a></li>
<li class="links"><a class="xref" href="tcpip.html.el#tcpip-resources" title="Πόροι">Πόροι</a></li>
</ul></div>
