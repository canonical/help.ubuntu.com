...
<a class="nextlinks-prev" href="network-configuration.html.es" title="Configuración de red">Anterior</a><a class="nextlinks-next" href="dhcp.html.es" title="Dynamic Host Configuration Protocol (DHCP)">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="tcpip.html.es#tcpip-introduction" title="Introducción a TCP/IP">Introducción a TCP/IP</a></li>
<li class="links"><a class="xref" href="tcpip.html.es#tcpip-configuration" title="Configuración de TCP/IP">Configuración de TCP/IP</a></li>
<li class="links"><a class="xref" href="tcpip.html.es#ip-routing" title="Encaminamiento IP">Encaminamiento IP</a></li>
<li class="links"><a class="xref" href="tcpip.html.es#tcp-and-udp" title="TCP y UDP">TCP y UDP</a></li>
<li class="links"><a class="xref" href="tcpip.html.es#icmp" title="ICMP">ICMP</a></li>
<li class="links"><a class="xref" href="tcpip.html.es#daemons" title="Demonios">Demonios</a></li>
<li class="links"><a class="xref" href="tcpip.html.es#tcpip-resources" title="Recursos">Recursos</a></li>
</ul></div>
