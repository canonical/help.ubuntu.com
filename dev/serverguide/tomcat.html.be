...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.be" title="Кіраўніцтва да паслужніка Ubuntu">Кіраўніцтва да паслужніка Ubuntu</a> » <a class="trail" href="web-servers.html.be" title="Вэб сэрверы">Вэб сэрверы</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="ruby-on-rails.html.be" title="Ruby on Rails">Назад</a><a class="nextlinks-next" href="databases.html.be" title="Базы даньняў">Наперад</a>
</div>
<div class="hgroup"><h1 class="title">Apache Tomcat</h1></div>
<div class="region">
<div class="contents">
<p class="para">Apache Tomcat is a web container that allows you to serve Java Servlets
...
<li class="links"><a class="xref" href="tomcat.html.be#tomcat-installation" title="System-wide installation">System-wide installation</a></li>
<li class="links"><a class="xref" href="tomcat.html.be#tomcat-configuration" title="Настаўленьні">Настаўленьні</a></li>
<li class="links"><a class="xref" href="tomcat.html.be#tomcat-webapps" title="Using Tomcat standard webapps">Using Tomcat standard webapps</a></li>
<li class="links"><a class="xref" href="tomcat.html.be#tomcat-user" title="Using private instances">Using private instances</a></li>
<li class="links"><a class="xref" href="tomcat.html.be#tomcat-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
<div class="sect2 sect" id="tomcat-installation"><div class="inner">
<div class="hgroup"><h2 class="title">System-wide installation</h2></div>
...
<p class="para">This will install a Tomcat server with just a default ROOT webapp
			that displays a minimal "It works" page by default.</p>
</div></div>
</div></div>
<div class="sect2 sect" id="tomcat-configuration"><div class="inner">
<div class="hgroup"><h2 class="title">Настаўленьні</h2></div>
<div class="region">
...
<div class="hgroup"><h3 class="title">Зьмяніць прадвызначаныя парты</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h3 class="title">Changing JVM used</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h3 class="title">Declaring users and roles</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title">Using Tomcat standard webapps</h2></div>
<div class="region">
<div class="contents"><p class="para">Tomcat is shipped with webapps that you can install
			for documentation, administration or demo purposes.</p></div>
<div class="sect3 sect" id="tomcat-installation-docs"><div class="inner">
<div class="hgroup"><h3 class="title">Дакумэнтацыя Tomcat</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h3 class="title">Tomcat administration webapps</h3></div>
<div class="region"><div class="contents">
...
<p class="para">The first one is the <span class="em emphasis">manager</span> webapp, which
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents"><p class="para">Access to the <span class="em emphasis">manager</span> application is
...
<p class="para">The second one is the <span class="em emphasis">host-manager</span> webapp,
...
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents"><p class="para">Access to the <span class="em emphasis">host-manager</span> application is
...
<div class="hgroup"><h3 class="title">Tomcat examples webapps</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title">Using private instances</h2></div>
<div class="region">
<div class="contents">
<p class="para">Tomcat is heavily used in development and testing scenarios
			...
			libraries.</p>
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents"><p class="para">It is possible to run the system-wide instance and the private
			instances in parallel, as long as they do not use the same TCP
			ports.</p></div></div></div></div>
</div>
<div class="sect3 sect" id="tomcat-user-install"><div class="inner">
<div class="hgroup"><h3 class="title">Installing private instance support</h3></div>
<div class="region"><div class="contents">
<p class="para">You can install everything necessary to run private instances
...
<div class="hgroup"><h3 class="title">Creating a private instance</h3></div>
<div class="region"><div class="contents">
<p class="para">You can create a private instance directory by entering the
				following command in the terminal prompt:</p>
<div class="screen"><pre class="contents "><span class="cmd command">tomcat7-instance-create my-instance</span>
</pre></div>
<p class="para">This will create a new <span class="file filename">my-instance</span> directory
				with all the necessary subdirectories and scripts.
				You can for example install your common libraries in the
				<span class="file filename">lib/</span> subdirectory and deploy your webapps in the
				<span class="file filename">webapps/</span> subdirectory. No webapps are deployed
				by default.</p>
</div></div>
</div></div>
<div class="sect3 sect" id="tomcat-user-config"><div class="inner">
<div class="hgroup"><h3 class="title">Configuring your private instance</h3></div>
<div class="region"><div class="contents"><p class="para">You will find the classic Tomcat configuration files for your
				private instance in the <span class="file filename">conf/</span>
				subdirectory. You should for
				example certainly edit the <span class="file filename">conf/server.xml</span> file
				to change the default ports used by your private Tomcat instance to
				avoid conflict with other instances that might be running.</p></div></div>
</div></div>
<div class="sect3 sect" id="tomcat-user-start"><div class="inner">
<div class="hgroup"><h3 class="title">Starting/stopping your private instance</h3></div>
<div class="region"><div class="contents">
<p class="para">You can start your private instance by entering the following
				command in the terminal prompt (supposing  your instance is located
				in the <span class="file filename">my-instance</span> directory):</p>
<div class="screen"><pre class="contents "><span class="cmd command">my-instance/bin/startup.sh</span>
</pre></div>
<div class="note" title="Нататка"><div class="inner"><div class="region"><div class="contents"><p class="para">You should check the <span class="file filename">logs/</span> subdirectory for
				any error. If you have a <span class="em emphasis">java.net.BindException: Address
				already in use&lt;null&gt;:8080</span> error, it means that the
				port you're using is already taken and that you should change it.
				</p></div></div></div></div>
<p class="para">You can stop your instance by entering the following
        command in the terminal prompt (supposing  your instance is located
        in the <span class="file filename">my-instance</span> directory):</p>
...
<div class="hgroup"><h2 class="title">Спасылкі</h2></div>
<div class="region"><div class="contents"><div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
                      <p class="para">Глядзіце вэб-старонку <a href="http://tomcat.apache.org/" class="ulink" title="http://tomcat.apache.org/">Apache Tomcat</a>для больш зьмястоўнай інфармацыі.</p>
                    </li>
<li class="list itemizedlist">
                      <p class="para">
...
<li class="list itemizedlist">
                      <p class="para">Каб знайсьці дадатковую літаратуру, глядзіце сьпіс  <a href="http://wiki.apache.org/tomcat/Tomcat/Books" class="ulink" title="http://wiki.apache.org/tomcat/Tomcat/Books">Кнігі Tomcat</a>.</p>
                    </li>
</ul></div></div></div>
</div></div>
</div>
