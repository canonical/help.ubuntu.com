...
<a class="nextlinks-prev" href="ruby-on-rails.html.el" title="Ruby on Rails">Προηγούμενο</a><a class="nextlinks-next" href="databases.html.el" title="Βάσεις δεδομένων">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="tomcat.html.el#tomcat-installation" title="Εγκατάσταση για όλο το σύστημα">Εγκατάσταση για όλο το σύστημα</a></li>
<li class="links"><a class="xref" href="tomcat.html.el#tomcat-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="tomcat.html.el#tomcat-webapps" title="Χρήση των πρότυπων εφαρμογών ιστού Tomcat">Χρήση των πρότυπων εφαρμογών ιστού Tomcat</a></li>
<li class="links"><a class="xref" href="tomcat.html.el#tomcat-user" title="Χρήση ιδιωτικών στιγμιοτύπων">Χρήση ιδιωτικών στιγμιοτύπων</a></li>
<li class="links"><a class="xref" href="tomcat.html.el#tomcat-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
