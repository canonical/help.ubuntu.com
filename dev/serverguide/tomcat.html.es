...
<a class="nextlinks-prev" href="ruby-on-rails.html.es" title="Ruby on Rails">Anterior</a><a class="nextlinks-next" href="databases.html.es" title="Bases de datos">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="tomcat.html.es#tomcat-installation" title="Instalación de todo el sistema">Instalación de todo el sistema</a></li>
<li class="links"><a class="xref" href="tomcat.html.es#tomcat-configuration" title="Configuración">Configuración</a></li>
<li class="links"><a class="xref" href="tomcat.html.es#tomcat-webapps" title="Usar las aplicaciones web estándar de Tomcat">Usar las aplicaciones web estándar de Tomcat</a></li>
<li class="links"><a class="xref" href="tomcat.html.es#tomcat-user" title="Usar instancias privadas">Usar instancias privadas</a></li>
<li class="links"><a class="xref" href="tomcat.html.es#tomcat-references" title="Referencias">Referencias</a></li>
</ul></div>
