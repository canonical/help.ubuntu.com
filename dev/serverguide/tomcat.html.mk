...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.mk" title="Водич за Ubuntu Server">Водич за Ubuntu Server</a> » <a class="trail" href="web-servers.html.mk" title="Web Servers">Web Servers</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="ruby-on-rails.html.mk" title="Ruby on Rails">Previous</a><a class="nextlinks-next" href="databases.html.mk" title="Databases">Next</a>
</div>
...
<li class="links"><a class="xref" href="tomcat.html.mk#tomcat-installation" title="System-wide installation">System-wide installation</a></li>
<li class="links"><a class="xref" href="tomcat.html.mk#tomcat-configuration" title="Конфигурација">Конфигурација</a></li>
<li class="links"><a class="xref" href="tomcat.html.mk#tomcat-webapps" title="Using Tomcat standard webapps">Using Tomcat standard webapps</a></li>
<li class="links"><a class="xref" href="tomcat.html.mk#tomcat-user" title="Using private instances">Using private instances</a></li>
<li class="links"><a class="xref" href="tomcat.html.mk#tomcat-references" title="References">References</a></li>
</ul></div>
...
<div class="hgroup"><h2 class="title">Конфигурација</h2></div>
<div class="region">
...
<div class="hgroup"><h3 class="title">Changing default ports</h3></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h3 class="title">Tomcat documentation</h3></div>
<div class="region"><div class="contents">
...
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents"><p class="para">Access to the <span class="em emphasis">manager</span> application is
...
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents"><p class="para">Access to the <span class="em emphasis">host-manager</span> application is
...
<p class="para">Tomcat is heavily used in development and testing scenarios
			...
			libraries.</p>
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents"><p class="para">It is possible to run the system-wide instance and the private
...
<div class="note" title="Забелешка"><div class="inner"><div class="region"><div class="contents"><p class="para">You should check the <span class="file filename">logs/</span> subdirectory for
...
<li class="list itemizedlist">
                      <p class="para">
                      For additional books see the <a href="http://wiki.apache.org/tomcat/Tomcat/Books" class="ulink" title="http://wiki.apache.org/tomcat/Tomcat/Books">Tomcat Books</a> list page.
                      </p>
                    </li>
</ul></div></div></div>
</div></div>
