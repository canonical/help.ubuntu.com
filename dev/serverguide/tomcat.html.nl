...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.nl" title="Handleiding Ubuntu-server">Handleiding Ubuntu-server</a> » <a class="trail" href="web-servers.html.nl" title="Web Servers">Web Servers</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="ruby-on-rails.html.nl" title="Ruby on Rails">Vorige</a><a class="nextlinks-next" href="databases.html.nl" title="Databases">Volgende</a>
</div>
...
<li class="links"><a class="xref" href="tomcat.html.nl#tomcat-installation" title="System-wide installation">System-wide installation</a></li>
<li class="links"><a class="xref" href="tomcat.html.nl#tomcat-configuration" title="Configuratie">Configuratie</a></li>
<li class="links"><a class="xref" href="tomcat.html.nl#tomcat-webapps" title="Using Tomcat standard webapps">Using Tomcat standard webapps</a></li>
<li class="links"><a class="xref" href="tomcat.html.nl#tomcat-user" title="Using private instances">Using private instances</a></li>
<li class="links"><a class="xref" href="tomcat.html.nl#tomcat-references" title="References">References</a></li>
</ul></div>
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="para">Access to the <span class="em emphasis">manager</span> application is
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="para">Access to the <span class="em emphasis">host-manager</span> application is
...
<p class="para">Tomcat is heavily used in development and testing scenarios
			...
			libraries.</p>
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="para">It is possible to run the system-wide instance and the private
...
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="para">You should check the <span class="file filename">logs/</span> subdirectory for
