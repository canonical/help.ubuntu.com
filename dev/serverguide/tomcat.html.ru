...
<a class="nextlinks-prev" href="ruby-on-rails.html.ru" title="Ruby on Rails">Назад</a><a class="nextlinks-next" href="databases.html.ru" title="Базы данных">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="tomcat.html.ru#tomcat-installation" title="Общесистемная установка">Общесистемная установка</a></li>
<li class="links"><a class="xref" href="tomcat.html.ru#tomcat-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="tomcat.html.ru#tomcat-webapps" title="Использование стандартных веб-приложений Tomcat">Использование стандартных веб-приложений Tomcat</a></li>
<li class="links"><a class="xref" href="tomcat.html.ru#tomcat-user" title="Использование частных сущностей">Использование частных сущностей</a></li>
<li class="links"><a class="xref" href="tomcat.html.ru#tomcat-references" title="Ссылки">Ссылки</a></li>
</ul></div>
