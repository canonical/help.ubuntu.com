...
<a class="nextlinks-prev" href="ruby-on-rails.html.sl" title="Ruby on Rails">Nazaj</a><a class="nextlinks-next" href="databases.html.sl" title="Podatkovne baze">Naprej</a>
</div>
...
<li class="links"><a class="xref" href="tomcat.html.sl#tomcat-installation" title="System-wide installation">System-wide installation</a></li>
<li class="links"><a class="xref" href="tomcat.html.sl#tomcat-configuration" title="Nastavljanje">Nastavljanje</a></li>
<li class="links"><a class="xref" href="tomcat.html.sl#tomcat-webapps" title="Using Tomcat standard webapps">Using Tomcat standard webapps</a></li>
<li class="links"><a class="xref" href="tomcat.html.sl#tomcat-user" title="Using private instances">Using private instances</a></li>
<li class="links"><a class="xref" href="tomcat.html.sl#tomcat-references" title="Sklici">Sklici</a></li>
</ul></div>
...
<div class="hgroup"><h3 class="title">Spreminjanje privzetih vrat</h3></div>
<div class="region"><div class="contents">
...
<div class="code"><pre class="contents ">&lt;role rolename="skrbnik"/&gt;
...
<div class="hgroup"><h3 class="title">Dokumentacija Tomcat</h3></div>
<div class="region"><div class="contents">
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="para">Access to the <span class="em emphasis">manager</span> application is
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="para">Access to the <span class="em emphasis">host-manager</span> application is
...
<p class="para">Tomcat is heavily used in development and testing scenarios
			...
			libraries.</p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="para">It is possible to run the system-wide instance and the private
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="para">You should check the <span class="file filename">logs/</span> subdirectory for
...
<li class="list itemizedlist">
                      <p class="para">
                      See the <a href="http://tomcat.apache.org/" class="ulink" title="http://tomcat.apache.org/">Apache Tomcat</a> website for more information.
                      </p>
                    </li>
<li class="list itemizedlist">
                      <p class="para">
...
<li class="list itemizedlist">
                      <p class="para">Za dodatne knjige si oglejte spletno stran <a href="http://wiki.apache.org/tomcat/Tomcat/Books" class="ulink" title="http://wiki.apache.org/tomcat/Tomcat/Books">knjig Tomcat</a></p>
                    </li>
</ul></div></div></div>
</div></div>
</div>
