...
<a class="nextlinks-prev" href="cloud-images-and-uvtool.html.es" title="Cloud images and uvtool">Anterior</a><a class="nextlinks-next" href="lxd.html.es" title="LXD">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="ubuntucloud.html.es#ubuntu-cloud-installation" title="Installation and Configuration">Installation and Configuration</a></li>
<li class="links"><a class="xref" href="ubuntucloud.html.es#ubuntu-cloud-troubleshooting" title="Soporte y resolución de problemas">Soporte y resolución de problemas</a></li>
<li class="links"><a class="xref" href="ubuntucloud.html.es#ubuntu-cloud-resources" title="Recursos">Recursos</a></li>
</ul></div>
...
<p class="para">Soporte comunitario</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
          <p class="para"><a href="https://launchpad.net/~openstack" class="ulink" title="https://launchpad.net/~openstack">Lista de correo de OpenStack</a></p>
        </li>
<li class="list itemizedlist">
...
<li class="list itemizedlist">
          <p class="para">Únase al canal IRC de#openstack en freenode.</p>
        </li>
</ul></div>
</div></div>
</div></div>
...
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
          <p class="para"><a href="http://en.wikipedia.org/wiki/Cloud_computing#Service_Models" class="ulink" title="http://en.wikipedia.org/wiki/Cloud_computing#Service_Models">Computación en la nube - modelos de servicios</a></p>
        </li>
<li class="list itemizedlist">
          <p class="para"><a href="http://www.openstack.org/software/openstack-compute/" class="ulink" title="http://www.openstack.org/software/openstack-compute/">OpenStack Compute</a></p>
        </li>
<li class="list itemizedlist">
