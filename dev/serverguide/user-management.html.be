...
<a class="nextlinks-prev" href="security.html.be" title="Бясьпека">Назад</a><a class="nextlinks-next" href="console-security.html.be" title="Console Security">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="user-management.html.be#where-is-root" title="Where is root?">Where is root?</a></li>
<li class="links"><a class="xref" href="user-management.html.be#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a></li>
<li class="links"><a class="xref" href="user-management.html.be#user-profile-security" title="User Profile Security">User Profile Security</a></li>
<li class="links"><a class="xref" href="user-management.html.be#password-policy" title="Password Policy">Password Policy</a></li>
<li class="links"><a class="xref" href="user-management.html.be#other-security-considerations" title="Other Security Considerations">Other Security Considerations</a></li>
</ul></div>
...
<div class="screen"><pre class="contents "><span class="output computeroutput">[sudo] password for username:</span> <span class="input userinput">(увядзіце ваш асабісты пароль)</span>
<span class="output computeroutput">Enter new UNIX password:</span> <span class="input userinput">(увядзіце новы пароль адміністратара)</span>
<span class="output computeroutput">Retype new UNIX password:</span> <span class="input userinput">(паўтарыце новы пароль адміністратара)</span>
...
<div class="hgroup"><h3 class="title">Мінімальная даўжыня пароля</h3></div>
<div class="region"><div class="contents">
<p class="para">
