...
<a class="nextlinks-prev" href="security.html.cs" title="Security">Předchozí</a><a class="nextlinks-next" href="console-security.html.cs" title="Console Security">Následující</a>
</div>
...
<li class="links"><a class="xref" href="user-management.html.cs#where-is-root" title="Where is root?">Where is root?</a></li>
<li class="links"><a class="xref" href="user-management.html.cs#adding-deleting-users" title="Adding and Deleting Users">Adding and Deleting Users</a></li>
<li class="links"><a class="xref" href="user-management.html.cs#user-profile-security" title="User Profile Security">User Profile Security</a></li>
<li class="links"><a class="xref" href="user-management.html.cs#password-policy" title="Password Policy">Password Policy</a></li>
<li class="links"><a class="xref" href="user-management.html.cs#other-security-considerations" title="Other Security Considerations">Other Security Considerations</a></li>
</ul></div>
