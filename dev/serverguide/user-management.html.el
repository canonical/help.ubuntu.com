...
<a class="nextlinks-prev" href="security.html.el" title="Ασφάλεια">Προηγούμενο</a><a class="nextlinks-next" href="console-security.html.el" title="Ασφάλεια Κονσόλας">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="user-management.html.el#where-is-root" title="Που είναι η βάση;">Που είναι η βάση;</a></li>
<li class="links"><a class="xref" href="user-management.html.el#adding-deleting-users" title="Προσθήκη και Διαγραφή Χρηστών">Προσθήκη και Διαγραφή Χρηστών</a></li>
<li class="links"><a class="xref" href="user-management.html.el#user-profile-security" title="Ασφάλεια Προφίλ Χρήστη">Ασφάλεια Προφίλ Χρήστη</a></li>
<li class="links"><a class="xref" href="user-management.html.el#password-policy" title="Πολιτική Κωδικού">Πολιτική Κωδικού</a></li>
<li class="links"><a class="xref" href="user-management.html.el#other-security-considerations" title="Άλλα Θέματα Ασφάλειας">Άλλα Θέματα Ασφάλειας</a></li>
</ul></div>
