...
<a class="nextlinks-prev" href="security.html.es" title="Seguridad">Anterior</a><a class="nextlinks-next" href="console-security.html.es" title="Seguridad de consola">Siguiente</a>
</div>
...
<li class="links"><a class="xref" href="user-management.html.es#where-is-root" title="¿Dónde está root?">¿Dónde está root?</a></li>
<li class="links"><a class="xref" href="user-management.html.es#adding-deleting-users" title="Añadir y eliminar usuarios">Añadir y eliminar usuarios</a></li>
<li class="links"><a class="xref" href="user-management.html.es#user-profile-security" title="Perfil de seguridad de usuario">Perfil de seguridad de usuario</a></li>
<li class="links"><a class="xref" href="user-management.html.es#password-policy" title="Política de contraseñas">Política de contraseñas</a></li>
<li class="links"><a class="xref" href="user-management.html.es#other-security-considerations" title="Otras consideraaciones de seguridad">Otras consideraaciones de seguridad</a></li>
</ul></div>
