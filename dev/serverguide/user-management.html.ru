...
<a class="nextlinks-prev" href="security.html.ru" title="Защита">Назад</a><a class="nextlinks-next" href="console-security.html.ru" title="Безопасность консоли">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="user-management.html.ru#where-is-root" title="Где root?">Где root?</a></li>
<li class="links"><a class="xref" href="user-management.html.ru#adding-deleting-users" title="Добавление и удаление пользователей">Добавление и удаление пользователей</a></li>
<li class="links"><a class="xref" href="user-management.html.ru#user-profile-security" title="Безопасность пользовательских профилей">Безопасность пользовательских профилей</a></li>
<li class="links"><a class="xref" href="user-management.html.ru#password-policy" title="Политики паролей">Политики паролей</a></li>
<li class="links"><a class="xref" href="user-management.html.ru#other-security-considerations" title="Иные предложения по безопасности">Иные предложения по безопасности</a></li>
</ul></div>
...
<div class="region"><div class="contents">
<p class="para">Процесс управления локальными пользователями и группами мало отличается от большинства других операционных систем GNU/Linux. Ubuntu и другие основанные на Debian дистрибутивы рекомендуют использовать для управления учётными записями пакет "adduser".</p>
<div class="list itemizedlist"><ul class="list itemizedlist">
<li class="list itemizedlist">
		<p class="para">
