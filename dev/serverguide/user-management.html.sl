...
<a href="../../18.04" class="trail">Ubuntu 18.04</a> » <a class="trail" href="index.html.sl" title="Vodnik po strežniku Ubuntu">Vodnik po strežniku Ubuntu</a> » <a class="trail" href="security.html.sl" title="Varnost">Varnost</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks">
<a class="nextlinks-prev" href="security.html.sl" title="Varnost">Nazaj</a><a class="nextlinks-next" href="console-security.html.sl" title="Console Security">Naprej</a>
</div>
<div class="hgroup"><h1 class="title">Upravljanje uporabnikov</h1></div>
<div class="region">
...
<li class="links"><a class="xref" href="user-management.html.sl#where-is-root" title="Kje je skrbnik?">Kje je skrbnik?</a></li>
<li class="links"><a class="xref" href="user-management.html.sl#adding-deleting-users" title="Dodajanje in odstranjevanje uporabnikov">Dodajanje in odstranjevanje uporabnikov</a></li>
<li class="links"><a class="xref" href="user-management.html.sl#user-profile-security" title="User Profile Security">User Profile Security</a></li>
<li class="links"><a class="xref" href="user-management.html.sl#password-policy" title="Password Policy">Password Policy</a></li>
<li class="links"><a class="xref" href="user-management.html.sl#other-security-considerations" title="Other Security Considerations">Other Security Considerations</a></li>
</ul></div>
<div class="sect2 sect" id="where-is-root"><div class="inner">
<div class="hgroup"><h2 class="title">Kje je skrbnik?</h2></div>
...
<div class="screen"><pre class="contents "><span class="output computeroutput">[sudo] password for username:</span> <span class="input userinput">(vnesite svoje geslo)</span>
<span class="output computeroutput">Enter new UNIX password:</span> <span class="input userinput">(vnesite novo geslo skrbnika)</span>
<span class="output computeroutput">Retype new UNIX password:</span> <span class="input userinput">(ponovno vnesite novo geslo skrbnika)</span>
...
<div class="hgroup"><h2 class="title">Dodajanje in odstranjevanje uporabnikov</h2></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo adduser uporabniško-ime</span>
</pre></div>
		</li>
<li class="list itemizedlist">
		<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo deluser uporabniško-ime</span>
</pre></div>
		<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo chown -R root:root /home/uporabniško-ime/</span>
<span class="cmd command">sudo mkdir /home/arhivirani_uporabniki/</span>
<span class="cmd command">sudo mv /home/uporabniško-ime /home/arhivirani_uporabniki/</span>
</pre></div>
		</li>
<li class="list itemizedlist">
		<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo passwd -l uporabniško-ime</span>
<span class="cmd command">sudo passwd -u uporabniško-ime</span>
</pre></div>
		</li>
<li class="list itemizedlist">
		<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo addgroup ime-skupine</span>
<span class="cmd command">sudo delgroup ime-skupine</span>
</pre></div>
		</li>
<li class="list itemizedlist">
		<p class="para">Če želite dodati uporabnika v skupino, uporabite sledečo skladnjo:</p>
<div class="screen"><pre class="contents "><span class="cmd command">sudo adduser ime-uporabnika ime-skupine</span>
</pre></div>
		</li>
</ul></div>
</div></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">ls -ld /home/uporabniško-ime</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo chmod 0750 /home/uporabniško-ime</span>
</pre></div>
		<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents">
		<p class="para">
...
<div class="screen"><pre class="contents "><span class="output computeroutput">drwxr-x---   2 uporabniško-ime uporabniško-ime    4096 2007-10-02 20:03 uporabniško-ime</span>
</pre></div>
		</li>
</ul></div>
</div></div>
...
<div class="hgroup"><h3 class="title">Najkrajša dolžina gesla</h3></div>
<div class="region"><div class="contents">
<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo chage -l uporabniško-ime</span>
</pre></div>
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo chage uporabniško-ime</span>
</pre></div>
		<p class="para">
...
<div class="screen"><pre class="contents "><span class="cmd command">sudo adduser uporabniško-ime sshlogin</span>
