...
<a class="nextlinks-prev" href="phpmyadmin.html.cs" title="phpMyAdmin">Předchozí</a><a class="nextlinks-next" href="file-servers.html.cs" title="File Servers">Následující</a>
</div>
...
<li class="links"><a class="xref" href="wordpress.html.cs#wordpress-installation" title="Instalace">Instalace</a></li>
<li class="links"><a class="xref" href="wordpress.html.cs#wordpress-configuration" title="Nastavení">Nastavení</a></li>
<li class="links"><a class="xref" href="wordpress.html.cs#wordpress-references" title="References">References</a></li>
</ul></div>
...
<p class="para">
           ...
           sub-section in <a class="xref" href="httpd.html.cs" title="HTTPD - Apache2 Web Server">HTTPD - Apache2 Web Server</a> section.
            ...
            to <a class="xref" href="mysql.html.cs#mysql-installation" title="Instalace">Instalace</a> sub-section in 
            <a class="xref" href="mysql.html.cs" title="MySQL">MySQL</a> section.
           </p>
</div></div>
</div></div>
