...
<a class="nextlinks-prev" href="phpmyadmin.html.el" title="phpMyAdmin">Προηγούμενο</a><a class="nextlinks-next" href="file-servers.html.el" title="Εξυπηρετητές αρχείων">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="wordpress.html.el#wordpress-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="wordpress.html.el#wordpress-configuration" title="Ρυθμίσεις">Ρυθμίσεις</a></li>
<li class="links"><a class="xref" href="wordpress.html.el#wordpress-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
...
<p class="para">
           ...
           sub-section in <a class="xref" href="httpd.html.el" title="HTTPD - Apache2 Διακομιστής Ιστού">HTTPD - Apache2 Διακομιστής Ιστού</a> section.
            ...
            to <a class="xref" href="mysql.html.el#mysql-installation" title="Εγκατάσταση">Εγκατάσταση</a> sub-section in 
            <a class="xref" href="mysql.html.el" title="MySQL">MySQL</a> section.
           </p>
</div></div>
</div></div>
