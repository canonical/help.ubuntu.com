...
<a class="nextlinks-prev" href="phpmyadmin.html.ru" title="phpMyAdmin">Назад</a><a class="nextlinks-next" href="file-servers.html.ru" title="Файл-серверы">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="wordpress.html.ru#wordpress-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="wordpress.html.ru#wordpress-configuration" title="Конфигурация">Конфигурация</a></li>
<li class="links"><a class="xref" href="wordpress.html.ru#wordpress-references" title="Ссылки">Ссылки</a></li>
</ul></div>
<div class="sect2 sect" id="wordpress-installation"><div class="inner">
<div class="hgroup"><h2 class="title">Установка</h2></div>
<div class="region"><div class="contents">
<p class="para">Чтобы установить <span class="app application">WordPress</span>, выполните следующую команду в терминале:</p>
<div class="screen"><pre class="contents ">    <span class="cmd command">sudo apt install wordpress</span>
</pre></div>
<p class="para">Следует также установить веб-сервер <span class="app application">apache2</span> и сервер <span class="app application">mysql</span>. Для установки веб-сервера <span class="app application">apache2</span> обратитесь к подразделу <a class="xref" href="httpd.html.ru#http-installation" title="Установка">Установка</a> раздела <a class="xref" href="httpd.html.ru" title="HTTPD - веб сервер Apache2">HTTPD - веб сервер Apache2</a>. Для установки сервера <span class="app application">mysql</span> обратитесь к подразделу <a class="xref" href="mysql.html.ru#mysql-installation" title="Установка">Установка</a> раздела <a class="xref" href="mysql.html.ru" title="MySQL">MySQL</a>.</p>
</div></div>
</div></div>
<div class="sect2 sect" id="wordpress-configuration"><div class="inner">
<div class="hgroup"><h2 class="title">Конфигурация</h2></div>
<div class="region"><div class="contents">
<p class="para">Для настройки вашего первого приложения <span class="app application">WordPress</span> сконфигурируйте сайт apache. Откройте <span class="file filename">/etc/apache2/sites-available/wordpress.conf</span> и добавьте следующие строки:</p>
...
<p class="para">После того, как вы настроили веб-сервер <span class="app application">apache2</span> и подготовили его для вашего приложения <span class="app application">WordPress</span>, нужно перезагрузить его. Можете выполнить следующую команду для перезапуска веб-сервера <span class="app application">apache2</span>:</p>
...
<p class="para">Теперь настройте <span class="app application">WordPress</span> для использования базы данных MySQL. Откройте файл <span class="file filename">/etc/wordpress/config-localhost.php</span> и вставьте следующие строки:</p>
...
<p class="para">Теперь создайте эту базу данных MySQL. Откройте временный файл с командами MySQL <span class="file filename">wordpress.sql</span> и вставьте следующие строки:</p>
...
<p class="para">Выполните эти команды.</p>
