...
<a class="nextlinks-prev" href="puppet.html.be" title="Puppet">Назад</a><a class="nextlinks-next" href="network-authentication.html.be" title="Network Authentication">Наперад</a>
</div>
...
<li class="links"><a class="xref" href="zentyal.html.be#zentyal-installation" title="Усталёўка">Усталёўка</a></li>
<li class="links"><a class="xref" href="zentyal.html.be#zentyal-firststeps" title="First steps">First steps</a></li>
<li class="links"><a class="xref" href="zentyal.html.be#zentyal-modules" title="Modules">Modules</a></li>
<li class="links"><a class="xref" href="zentyal.html.be#zentyal-references" title="Спасылкі">Спасылкі</a></li>
</ul></div>
