...
<a class="nextlinks-prev" href="puppet.html.el" title="Puppet">Προηγούμενο</a><a class="nextlinks-next" href="network-authentication.html.el" title="Πιστοποίηση δικτύου">Επόμενο</a>
</div>
...
<li class="links"><a class="xref" href="zentyal.html.el#zentyal-installation" title="Εγκατάσταση">Εγκατάσταση</a></li>
<li class="links"><a class="xref" href="zentyal.html.el#zentyal-firststeps" title="First steps">First steps</a></li>
<li class="links"><a class="xref" href="zentyal.html.el#zentyal-modules" title="Modules">Modules</a></li>
<li class="links"><a class="xref" href="zentyal.html.el#zentyal-references" title="Αναφορές">Αναφορές</a></li>
</ul></div>
