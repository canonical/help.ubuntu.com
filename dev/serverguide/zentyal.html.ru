...
<a class="nextlinks-prev" href="puppet.html.ru" title="Puppet">Назад</a><a class="nextlinks-next" href="network-authentication.html.ru" title="Сетевая аутентификация">Вперёд</a>
</div>
...
<li class="links"><a class="xref" href="zentyal.html.ru#zentyal-installation" title="Установка">Установка</a></li>
<li class="links"><a class="xref" href="zentyal.html.ru#zentyal-firststeps" title="Первые шаги">Первые шаги</a></li>
<li class="links"><a class="xref" href="zentyal.html.ru#zentyal-modules" title="Modules">Modules</a></li>
<li class="links"><a class="xref" href="zentyal.html.ru#zentyal-references" title="Ссылки">Ссылки</a></li>
</ul></div>
