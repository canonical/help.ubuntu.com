...
<div class="region"><div class="contents"><p class="p">Puede activar y desactivar el contraste alto pulsando en el <span class="link"><a href="a11y-icon.html.es" title="Encontrar el menú de acceso universal">icono de accesibilidad</a></span> en la barra superior y seleccionando <span class="gui">Alto contraste</span>.</p></div></div>
</div></div>
</div>
