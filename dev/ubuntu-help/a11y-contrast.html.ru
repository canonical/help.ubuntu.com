...
<div class="region"><div class="contents"><p class="p">Можно включить или отключить высокую контрастность, нажав на <span class="link"><a href="a11y-icon.html" title="Найдите меню универсального доступа">значок специальных возможностей</a></span> в верхней панели и выбрав <span class="gui">Высокая контрастность</span>.</p></div></div>
</div></div>
</div>
