...
<p class="p">Als u <span class="link"><a href="mouse-mousekeys.html.nl" title="De muisaanwijzer met behulp van het numerieke toetsenbord klikken en bewegen.">Muistoetsen</a></span> gebruikt, dan kunt u ook rechtsklikken door de toets <span class="key"><kbd>5</kbd></span> op uw numerieke toetsenbord in te drukken.</p>
