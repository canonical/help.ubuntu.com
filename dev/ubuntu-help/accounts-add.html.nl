...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Add an account</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Adding an account will help link your online accounts with your GNOME
...
<li class="steps"><p class="p">Click the <span class="gui">+</span> button in the lower-left corner of the
      window.</p></li>
<li class="steps"><p class="p">Select the type of account which you want to add.</p></li>
...
<li class="steps"><p class="p">All services that are offered by an account provider will be enabled
      by default. <span class="link"><a href="accounts-disable-service.html" title="Control which online services an account can be used to access">Switch</a></span>
...
<p class="p">After you have added accounts, applications can use those accounts for
  the services you have chosen to allow. See <span class="link"><a href="accounts-disable-service.html" title="Control which online services an account can be used to access">Control which online services an account can be used to access</a></span>
  for information on controlling which services to allow.</p>
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents"><p class="p">Many online services provide an authorization token which GNOME stores
    instead of your password. If you remove an account, you should also revoke
    that certificate in the online service. See <span class="link"><a href="accounts-remove.html" title="Remove an account">Remove an account</a></span>
