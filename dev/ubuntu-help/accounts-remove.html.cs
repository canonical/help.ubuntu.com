...
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents"><p class="p">Místo úplného vymazání účtu je možné jen <span class="link"><a href="accounts-disable-service.html" title="Řízení, který účet služby on-line může být použit k přístupu">omezit služby</a></span>, ke kterým bude z uživatelského prostředí přístup.</p></div></div></div></div>
</div>
