...
<p class="p">You may also wish to remove software that does not have a GUI.
    ...
    <span class="link"><a href="addremove-install-synaptic.html" title="Použití Synaptic pro pokročilejší správu softwaru">Synaptic</a></span>. Note that <span class="app">Synaptic</span> does not list snaps.
  </p>
