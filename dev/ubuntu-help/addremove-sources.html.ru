...
<div class="region"><ul><li class="links ">
<a href="addremove-ppa.html" title="Добавление персонального архива пакетов (PPA)">Добавление персонального архива пакетов (PPA)</a><span class="desc"> — Добавьте PPA, чтобы расширить список источников, которые Ubuntu использует для установки и обновления приложений.</span>
</li></ul></div>
</div></div>
</div>
</div>
