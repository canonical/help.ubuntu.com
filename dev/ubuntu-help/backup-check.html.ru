...
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">Если вы регулярно выполняете резервное копирование больших объёмов данных, может быть проще использовать специальную программу для резервного копирования, например, <span class="app">Déjà Dup</span>. Подобные программы обладают большими возможностями и более надёжны, чем простое копирование и вставка файлов.</p></div></div></div></div>
</div>
