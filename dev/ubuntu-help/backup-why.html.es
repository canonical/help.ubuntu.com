...
<div class="region">
<div class="contents">
<p class="p"><span class="em">Respaldar</span> sus archivos significa, sencillamente, hacer una copia de todos sus archivos para su custodia. Esto se hace en caso de que los archivos originales queden inutilizables en caso de pérdida o deterioro. Esas copias pueden usarse para restaurar los datos originales si se perdieran. Las copias deberían almacenarse en un dispositivo distinto al de los archivos originales. Por ejemplo, puede usar una unidad USB, un disco duro externo, un CD o DVD o un servicio externo.</p>
