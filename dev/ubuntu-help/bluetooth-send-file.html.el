...
<div class="region">
<div class="contents">
<p class="p">Μπορείτε να στείλετε αρχεία σε συνδεμένες συσκευές Bluetooth, όπως μερικά κινητά τηλέφωνα ή υπολογιστές. Μερικοί τύποι συσκευών δεν επιτρέπουν τη μεταφορά αρχείων, ή συγκεκριμένων τύπων αρχείων. Μπορείτε να στείλετε αρχεία με έναν από τους τρεις τρόπους: χρησιμοποιώντας το εικονίδιο Bluetooth στη γραμμή μενού, από το παράθυρο ρυθμίσεων Bluetooth, ή άμεσα από τον διαχειριστή αρχείων.</p>
