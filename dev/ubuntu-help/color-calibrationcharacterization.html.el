...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents"><p class="p">Σημειώστε ότι ένας χαρακτηρισμός (προφίλ) θα είναι έγκυρος μόνο για μια συσκευή εάν είναι στην ίδια κατάσταση βαθμονόμησης όπως ήταν όταν χαρακτηρίστηκε.</p></div></div></div></div>
