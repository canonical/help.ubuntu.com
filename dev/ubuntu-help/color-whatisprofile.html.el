...
<div class="region"><ul>
<li class="links ">
<a href="color-canshareprofiles.html" title="Μπορώ να κάνω διαμοιραστώ το προφίλ χρώματός μου;">Μπορώ να κάνω διαμοιραστώ το προφίλ χρώματός μου;</a><span class="desc"> — Η κοινή χρήση προφίλ χρώματος δεν είναι ποτέ καλή ιδέα καθώς το υλικό αλλάζει με τον χρόνο.</span>
</li>
<li class="links ">
...
<li class="links ">
<a href="color-whatisspace.html" title="Τι είναι χρωματικός χώρος;">Τι είναι χρωματικός χώρος;</a><span class="desc"> — Ένας χρωματικός χώρος είναι μια ορισμένη περιοχή χρωμάτων.</span>
</li>
</ul></div>
</div></div>
</div>
