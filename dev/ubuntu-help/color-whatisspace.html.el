...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Τι είναι χρωματικός χώρος;</span></h1></div>
<div class="region">
<div class="contents">
...
<p class="p">Τώρα, εάν το PhoPhoto είναι σαφώς καλύτερο, γιατί δεν το χρησιμοποιούμε για τα πάντα; Η απάντηση είναι ο <span class="em">κβαντισμός</span>. Εάν έχετε μόνο 8 δυαδικά (256 επίπεδα) για κωδικοποίηση κάθε καναλιού, τότε μια μεγαλύτερη περιοχή πρόκειται να έχει μεγαλύτερα βήματα μεταξύ κάθε τιμής.</p>
