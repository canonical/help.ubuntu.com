...
<p class="p">Ahora, si PhoPhoto es claramente mejor, ¿por qué no usarlo para todo? La respuesta tiene que ver con la <span class="em">cuantización</span>. Si sólo tiene 8 bits (256 niveles) para codificar cada canal, entonces un mayor rango requerirá tener pasos más grandes entre cada valor.</p>
