...
<span class="link"><a href="shell-apps-open.html" title="Start applications">search for applications</a></span>.
</p>
</div>
...
double-click or <span class="link"><a href="mouse-middleclick.html" title="Middle-click">middle-click</a></span> any file to
...
or new window.</p>
<p class="p">When looking through the files in a folder, you can quickly <span class="link"><a href="files-preview.html" title="Preview files and folders">preview each file</a></span> by pressing the space bar
...
properties.</p>
<p class="p">If you want to quickly <span class="link"><a href="files-search.html" title="Search for files">search for a file</a></span>,
