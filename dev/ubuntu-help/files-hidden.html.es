...
<p class="p">Si quiere ver todos los archivos ocultos de una carpeta, vaya a esa carpeta y pulse el botón de opciones de la vista en la barra de herramientas y elija <span class="gui">Mostrar los archivos ocultos</span> o bien pulse <span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>H</kbd></span></span>. Se mostrarán todos los archivos ocultos junto con los que no estaban ocultos.</p>
<p class="p">Para volver a ocultar estos archivos, pulse  pulse el botón de opciones de la vista en la barra de herramientas y elija <span class="gui">Mostrar archivos ocultos</span> o pulse <span class="guiseq"><span class="gui">Ctrl</span> ▸ <span class="gui">H</span></span> de nuevo.</p>
</div></div>
</div></div>
<div id="unhide" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Mostrar un archivo oculto</span></h2></div>
<div class="region"><div class="contents">
