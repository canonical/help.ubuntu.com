...
<a href="nautilus-preview.html" title="Předvolby náhledů ve správci souborů">Předvolby náhledů ve správci souborů</a><span class="desc"> — Jak nastavit, kdy se mají pro soubory použít miniatury.</span>
</li></ul></div>
</div></div>
</div>
</div>
