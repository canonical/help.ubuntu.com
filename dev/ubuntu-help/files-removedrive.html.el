...
<div class="hgroup"><h2 class="title"><span class="title">Ασφαλής αφαίρεση μιας συσκευής που χρησιμοποιείται</span></h2></div>
...
<div class="note note-warning" title="Προειδοποίηση"><div class="inner"><div class="region"><div class="contents"><p class="p">Μπορείτε επίσης να επιλέξετε <span class="gui">εξαγωγή ούτως ή άλλως</span> για να αφαιρέσετε τη συσκευή χωρίς να κλείσετε τα αρχεία. Αυτό μπορεί να προκαλέσει σφάλματα σε εφαρμογές που έχουν αυτά τα αρχεία ανοικτά.</p></div></div></div></div>
</div></div>
</div></div>
