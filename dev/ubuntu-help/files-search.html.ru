...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Instead of typing words directly to bring up the search bar, you can
...
<li class="steps">
<p class="p">Можно сузить результаты поиска, указав местоположение и тип файла.</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Нажмите <span class="gui">Домашняя папка</span> чтобы ограничить результаты поиска только вашим <span class="file">Домашним</span> каталогом, или же нажмите <span class="gui">Все файлы</span> для поиска по всей файловой системе.</p></li>
...
<li class="steps"><p class="p">Снова нажмите на значок с лупой на панели инструментов, чтобы выйти из режима поиска и вернуться к содержимому папки.</p></li>
</ol></div>
</div></div>
</div>
