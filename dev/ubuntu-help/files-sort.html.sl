...
<p class="p">As an example, if you select <span class="gui">By Name</span>, the files will be sorted
  by their names, in alphabetical order. See <span class="link"><a href="#ways" title="Načini razvrščanja datotek">Načini razvrščanja datotek</a></span> for other
  options.</p>
