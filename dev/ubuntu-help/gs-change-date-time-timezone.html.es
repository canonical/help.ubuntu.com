...
<li class="steps"><p class="p">Cierre la ventana del mapa mundial para volver a la <span class="gui">Fecha y hora</span>.</p></li>
...
<li class="steps"><p class="p">Cierre la ventana para volver a la <span class="gui">Fecha y hora</span> y cierre el panel.</p></li>
</ol></div></div></div>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="gs-connect-online-accounts.html.es" title="Conectarse a cuentas en línea">Anterior</a><a class="nextlinks-next" href="gs-change-wallpaper.html.es" title="Cambiar el fondo de pantalla">Siguiente</a>
