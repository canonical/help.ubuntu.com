...
<title>Připojení k účtům on-line</title>
...
<div class="steps"><div class="inner"><div class="region"><ol class="steps" start="3"><li class="steps"><p class="p">Klikněte na panel <span class="gui">Účty on-line</span> a následně klikněte na tlačítko <span class="gui">Přidat účet on-line</span>.</p></li></ol></div></div></div>
<div class="note" title="Upozornění"><div class="inner"><div class="region"><div class="contents"><p class="p">V případě, že jste nějaký účet on-line již dříve nastavili, můžete další přidat kliknutím na tlačítko <span class="gui">+</span> v levém dolním rohu okna.</p></div></div></div></div>
<div class="media media-image"><div class="inner"><img src="gs-goa3.svg" width="100%" class="media media-block" alt=""></div></div>
<div class="steps"><div class="inner"><div class="region"><ol class="steps" start="4"><li class="steps"><p class="p">Klikněte na účet on-line, který chcete použít. Tím se otevře nové okno, ve kterém se můžete k účtu přihlásit.</p></li></ol></div></div></div>
...
<li class="steps"><p class="p">Ve většině případů budete muset po příhlášení udělit přístup k on-line službě, aby se mohla začít používat.</p></li>
<li class="steps"><p class="p">Například, když se připojujete ke svému účtu Google, budete muset kliknout na tlačítko <span class="gui">Udělit přístup</span>.</p></li>
</ol></div></div></div>
<div class="media media-image"><div class="inner"><img src="gs-goa5.svg" width="100%" class="media media-block" alt=""></div></div>
<div class="steps"><div class="inner"><div class="region"><ol class="steps" start="7"><li class="steps"><p class="p">Řada účtů on-line umožňuje zvolit služby, které ve spojitosti s tímto účtem chcete používat. Pokud některou službu používat nechcete, zakažte ji kliknutím na přepínač <span class="gui">❙/○</span> na pravé straně okna.</p></li></ol></div></div></div>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="gs-browse-web.html" title="Brouzdání po webu">Předchozí</a><a class="nextlinks-next" href="gs-change-date-time-timezone.html" title="Změna data, času a časového pásma">Následující</a>
</div>
