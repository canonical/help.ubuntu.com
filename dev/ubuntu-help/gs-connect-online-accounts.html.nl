...
<title>Verbinding maken met online-accounts</title>
...
<div class="steps"><div class="inner"><div class="region"><ol class="steps" start="3"><li class="steps"><p class="p">Klik op het <span class="gui">Online-accounts</span>paneel en klik dan op de knop <span class="gui">Een online-account toevoegen</span>.</p></li></ol></div></div></div>
<div class="note" title="Opmerking"><div class="inner"><div class="region"><div class="contents"><p class="p">Als u al eerder een online-account heeft aangemaakt, dan kunt u een andere online-account toevoegen door te klikken op de knop <span class="gui">+</span> linksonder in het scherm.</p></div></div></div></div>
<div class="media media-image"><div class="inner"><img src="gs-goa3.svg" width="100%" class="media media-block" alt=""></div></div>
<div class="steps"><div class="inner"><div class="region"><ol class="steps" start="4"><li class="steps"><p class="p">Klik op de online-account die u wilt gebruiken. Hiermee opent u een nieuw venster waar u zich aan kunt melden bij uw online-account.</p></li></ol></div></div></div>
...
<li class="steps"><p class="p">Bijvoorbeeld, als u verbinding maakt met uw Google-account, moet u klikken op de knop <span class="gui">Toegang verlenen</span></p></li>
</ol></div></div></div>
<div class="media media-image"><div class="inner"><img src="gs-goa5.svg" width="100%" class="media media-block" alt=""></div></div>
<div class="steps"><div class="inner"><div class="region"><ol class="steps" start="7"><li class="steps"><p class="p">Bij veel online-accounts kunt u de diensten kiezen die u met uw online-account wilt gebruiken. Als u een dienst niet wilt gebruiken, schakel die dan uit door te klikken op de <span class="gui">ON/OFF</span>-schakelaar aan de rechterkant van het venster.</p></li></ol></div></div></div>
</div>
<div class="links nextlinks">
<a class="nextlinks-prev" href="gs-browse-web.html" title="Surfen op het web">Vorige</a><a class="nextlinks-next" href="gs-change-date-time-timezone.html" title="Datum, tijd en tijdszone wijzigen">Volgende</a>
</div>
