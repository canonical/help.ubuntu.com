...
<a class="nextlinks-prev" href="gs-use-system-search.html" title="Использование системного поиска">Назад</a><a class="nextlinks-next" href="gs-browse-web.html" title="Путешествие по Интернету">Вперёд</a>
</div>
