...
<div class="desc"><span class="desc"><span class="link"><a href="printing-setup.html" title="Instalace místní tiskárny">Nastavení místní tiskárny</a></span>, <span class="link"><a href="printing-order.html" title="Tisk stránek v jiném pořadí">pořadí a řazení</a></span>, <span class="link"><a href="printing-2sided.html" title="Tisk oboustranných a vícestránkových rozvržení">oboustranný a vícestránkový tisk</a></span>…</span></div>
</div>
<div class="links-grid ">
<div class="links-grid-link"><a href="hardware-auth.html" title="Čtečky otisků prstů a čipových karet">Čtečky otisků prstů a čipových karet</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="session-fingerprint.html" title="Přihlašování pomocí otisku prstu">Čtečky otisků prstů</a></span>, čipové karty…</span></div>
</div>
</div></div></div>
...
<li class="links ">
<a href="hardware-cardreader.html" title="Problémy s čtečkami paměťových karet">Problémy s čtečkami paměťových karet</a><span class="desc"> — Jak řešit problémy s čtečkami paměťových karet.</span>
</li>
<li class="links ">
