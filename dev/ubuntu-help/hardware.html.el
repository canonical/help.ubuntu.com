...
<div class="desc"><span class="desc"><span class="link"><a href="bluetooth-connect-device.html" title="Συνδέστε τον υπολογιστή σας σε μια συσκευή Bluetooth">Σύνδεση</a></span>, <span class="link"><a href="bluetooth-send-file.html" title="Αποστολή αρχείων σε μια συσκευή Bluetooth">Αποστολή αρχείων</a></span>, <span class="link"><a href="bluetooth-turn-on-off.html" title="Ενεργοποίηση ή απενεργοποίηση του bluetooth">Ενεργοποίηση και απενεργοποίηση</a></span>…</span></div>
</div>
<div class="links-grid ">
<div class="links-grid-link"><a href="hardware-auth.html" title="Αποτυπώματα &amp; έξυπνες κάρτες">Αποτυπώματα &amp; έξυπνες κάρτες</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="session-fingerprint.html" title="Είσοδος με δακτυλικό αποτύπωμα">Αναγνώστες αποτυπωμάτων</a></span>, έξυπνες κάρτες…</span></div>
</div>
<div class="links-grid ">
<div class="links-grid-link"><a href="disk.html" title="Δίσκοι &amp; αποθήκευση">Δίσκοι &amp; αποθήκευση</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="disk-capacity.html" title="Ελέγξτε πόσος χώρος έχει απομείνει στον δίσκο">Χώρος δίσκου</a></span>, <span class="link"><a href="disk-benchmark.html" title="Δοκιμάστε την απόδοση του σκληρού σας δίσκου">Απόδοση</a></span>, <span class="link"><a href="disk-check.html" title="Έλεγχος του σκληρού σας δίσκου για προβλήματα">Προβλήματα</a></span>, <span class="link"><a href="disk-partitions.html" title="Διαχείριση τόμων και κατατμήσεων">Τόμοι και κατατμήσεις</a></span>…</span></div>
</div>
<div class="links-grid ">
...
<div class="links-grid ">
<div class="links-grid-link"><a href="printing.html" title="Εκτύπωση">Εκτύπωση</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="printing-setup.html" title="Ρύθμιση τοπικού εκτυπωτή">Τοπική διαμόρφωση</a></span>, <span class="link"><a href="printing-order.html" title="Κάντε τις σελίδες να εκτυπωθούν με διαφορετική σειρά">σειρά και συρραφή</a></span>, <span class="link"><a href="printing-2sided.html" title="Εκτύπωση διπλής όψης και διατάξεις πολλαπλών σελίδων">διπλή όψη και πολυσέλιδο</a></span>…</span></div>
</div>
<div class="links-grid ">
...
<li class="links ">
<a href="hardware-cardreader.html" title="Προβλήματα αναγνώστη κάρτας μέσων">Προβλήματα αναγνώστη κάρτας μέσων</a><span class="desc"> — Ανιχνεύστε και διορθώστε προβλήματα σχετικά με αναγνώστες καρτών πολυμέσων</span>
</li>
<li class="links ">
<a href="printing.html#problems" title="Προβλήματα εκτυπωτή">Προβλήματα εκτυπωτή</a><span class="desc"> — Εκτυπωτές που δεν ανιχνεύτηκαν, κολλημένα χαρτιά, αντίτυπα που φαίνονται εσφαλμένα…</span>
</li>
<li class="links ">
