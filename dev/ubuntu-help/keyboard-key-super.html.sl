...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">What is the <span class="key"><kbd>Super</kbd></span> key?</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">If you have an Apple keyboard, you will have a <span class="key"><kbd>⌘</kbd></span> (Command)
...
<li class="steps"><p class="p">Open the <span class="gui"><a href="shell-introduction.html#activities" title="Activities overview">Activities</a></span> overview, then
      open the <span class="app">Settings</span>.</p></li>
<li class="steps"><p class="p">Kliknite <span class="gui">Tipkovnica</span>.</p></li>
<li class="steps"><p class="p">Click the <span class="gui">Shortcuts</span> tab.</p></li>
<li class="steps"><p class="p">Izberite <span class="gui">Sistem</span> na levi strani okna in <span class="gui">Pokaži pregled dejavnosti</span> na desni.</p></li>
<li class="steps"><p class="p">Držite želeno kombinacijo tipk.</p></li>
</ol></div></div></div>
</div>
