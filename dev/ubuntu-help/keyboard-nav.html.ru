...
<td style="border-top-style: solid;"><p class="p">Передаёт фокус верхней панели. В <span class="gui">Обзоре</span> переключает фокус клавиатуры между верхней панелью, боковой панелью, обзором окон, списком приложений, полем поиска и панелью сообщений. Для навигации используйте клавиши со стрелками.</p></td>
</tr>
<tr>
