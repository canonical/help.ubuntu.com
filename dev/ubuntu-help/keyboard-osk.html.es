...
<p class="p">Puede pulsar el icono <span class="gui"><span class="media"><span class="media media-image"><img src="figures/input-keyboard-symbolic.png" height="16" width="16" class="media media-inline" alt="teclado"></span></span></span> para ocultar el teclado temporalmente. El teclado se mostrará automáticamente otra vez cuando vuelva a pulsar en algún elemento donde pueda usarlo. Para mostrar el teclado otra vez, abra la <span class="link"><a href="shell-notifications.html.es" title="Notificaciones y la bandeja de mensajes">bandeja de mensajes</a></span> (moviendo el ratón a la parte inferior derecha de la pantalla) y pulse el icono del teclado.</p>
</div>
