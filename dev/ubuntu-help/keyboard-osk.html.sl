...
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">The on-screen keyboard is automatically enabled if you use a
...
<p class="p">You can press the
  ...
  the keyboard show again, open the <span class="link"><a href="shell-notifications.html" title="Obvestila in vrstica sporočanja">message
