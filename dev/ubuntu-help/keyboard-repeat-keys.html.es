...
<li class="steps"><p class="p">Pulse <span class="gui">Repetir teclas</span> en la sección <span class="gui">Escritura</span>.</p></li>
<li class="steps">
<p class="p">Desactive la <span class="gui">Repetición de teclas</span> (<span class="gui">Desactivado</span>).</p>
<p class="p">Alternativamente, ajuste el deslizador <span class="gui">Retardo</span> para controlar cuánto tiene que mantener pulsada una tecla hasta que se empiece a repetir y ajuste la <span class="gui">Velocidad</span> para controlar cómo de rápido se repiten las pulsaciones de teclas.</p>
</li>
</ol></div></div></div>
</div>
