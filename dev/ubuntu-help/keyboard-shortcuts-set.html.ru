...
<li class="steps"><p class="p">Выберите вкладку <span class="gui">Комбинации клавиш</span>.</p></li>
<li class="steps"><p class="p">Выберите категорию в левой прямоугольной секции и строку с нужным действием в правой. Текущая комбинация клавиш заменится на надпись <span class="gui">Создать ускоритель…</span></p></li>
<li class="steps"><p class="p">Нажмите выбранную комбинацию клавиш или <span class="key"><kbd>Backspace</kbd></span> для удаления комбинации.</p></li>
</ol></div></div></div>
</div>
...
<tr>
<td><p class="p">Вызов справки</p></td>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Домашняя папка</p></td>
...
<div class="region"><table class="table" style="border-top-style: solid;border-bottom-style: solid;">
<tr>
<td><p class="p">Переместить окно на рабочее место 1</p></td>
<td><p class="p">Отключено</p></td>
</tr>
<tr>
...
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Shift</kbd></span>+<span class="key"><a href="keyboard-key-super.html.ru" title="Что такое клавиша Super?"><kbd>Super</kbd></a></span>+<span class="key"><kbd>Page Up</kbd></span></span></p></td>
</tr>
<tr>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Скрыть все обычные окна</p></td>
<td style="border-top-style: solid;"><p class="p">Отключено</p></td>
</tr>
<tr>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Переместить на рабочее место влево</p></td>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Переместить на рабочее место вправо</p></td>
<td style="border-top-style: solid;"><p class="p"><span class="keyseq"><span class="key"><kbd>Ctrl</kbd></span>+<span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>→</kbd></span></span></p></td>
</tr>
<tr>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Скопировать снимок окна в буфер обмена</p></td>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Запись скринкаста</p></td>
...
<div class="region"><table class="table" style="border-top-style: solid;border-bottom-style: solid;">
<tr>
<td><p class="p">Отключить звук</p></td>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Извлечь</p></td>
...
<div class="region"><table class="table" style="border-top-style: solid;border-bottom-style: solid;">
<tr>
<td><p class="p">Показать диалог запуска команды</p></td>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Показать панель сообщений</p></td>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Выделить активное уведомление</p></td>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Клавиша-модификатор переключает источник ввода</p></td>
<td style="border-top-style: solid;"><p class="p">Отключено</p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p">Клавиша Compose</p></td>
<td style="border-top-style: solid;"><p class="p">Отключено</p></td>
</tr>
<tr>
<td style="border-top-style: solid;"><p class="p">Клавиша альтернативных символов</p></td>
<td style="border-top-style: solid;"><p class="p">Отключено</p></td>
</tr>
</table></div>
</div>
...
<div class="region"><table class="table" style="border-top-style: solid;border-bottom-style: solid;">
<tr>
<td><p class="p">Включить или выключить увеличение</p></td>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Уменьшить размер текста</p></td>
<td style="border-top-style: solid;"><p class="p">Отключено</p></td>
</tr>
<tr>
...
<tr>
<td style="border-top-style: solid;"><p class="p">Свернуть/развернуть из заголовка</p></td>
<td style="border-top-style: solid;"><p class="p">Отключено</p></td>
</tr>
<tr>
...
<li class="steps"><p class="p">Type a <span class="gui">Name</span> to identify the shortcut, and a
      ...
      command.</p></li>
<li class="steps"><p class="p">Нажмите <span class="gui">Выключен</span> в только что добавленной строке. Когда надпись изменится на <span class="gui">Новая комбинация клавиш…</span>, нажмите на клавиатуре желаемую комбинацию клавиш.</p></li>
</ol></div></div></div>
...
<p class="p">Если вы хотите изменить команду, связанную с определённой комбинацией клавиш, выполните двойное нажатие на <span class="em">названии</span> комбинации. Должно появиться окно <span class="gui">Дополнительные комбинации клавиш</span>, где вы сможете внести изменения в команду.</p>
</div></div>
</div></div>
