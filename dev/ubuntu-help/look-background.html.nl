...
<li class="steps"><p class="p"><span class="link"><a href="shell-workspaces-switch.html" title="Wisselen tussen werkbladen">Switch to an empty
...
<div class="region"><ul><li class="links "><a href="gs-change-wallpaper.html" title="De achtergrond wijzigen">Een handleiding over het wijzigen van de bureaubladachtergrond</a></li></ul></div>
</div></div>
</div>
</div>
</div>
