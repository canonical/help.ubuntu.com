...
<li class="steps"><p class="p">Выберите нужное разрешение и ориентацию экрана.</p></li>
...
<div class="region"><div class="contents"><p class="p">На некоторых ноутбуках есть возможность физически поворачивать экран в разных направлениях. Возможность изменять ориентацию экрана очень удобна. Поворачивать изображение на экране можно с помощью клавиш со стрелками.</p></div></div>
</div></div>
