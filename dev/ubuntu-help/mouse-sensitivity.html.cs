...
<li class="steps"><p class="p">Posouvejte táhlem <span class="gui">Rychlost ukazatel</span>, dokud si pohyb ukazatele nepřizpůsobíte tak, aby vám vyhovoval. Pro každé ukazovací zařízení, například myš a touchpad, uvidíte samostatné táhlo.</p></li>
</ol></div></div></div>
<p class="p">Můžete nastavit různou rychlost ukazatele pro jednotlivá zařízení. Například můžete mít jednu rychlost posuvu pro touchpad notebooku a jinou pro myš. To proto, že někdy nejvhodnější nastavení pro jeden typ zařízení není nejlepší pro jiné.</p>
