...
<div class="region">
<div class="contents"><p class="p">Puede controlar cómo el gestor de archivos muestra leyendas debajo de los iconos. Pulse <span class="gui">Archivos</span> en la barra superior, elija <span class="gui">Preferencias</span> y seleccione la pestaña <span class="gui">Mostrar</span>.</p></div>
<div id="icon-captions" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Títulos de iconos</span></h2></div>
...
<div class="region"><div class="contents"><p class="p">Al ver archivos como una lista, puede <span class="gui">Navegar por las carpetas en un árbol</span>. Esto muestra expansores en cada carpeta en la lista de archivos, por lo que se puede mostrar el contenido de varias carpetas a la vez. Esto es útil si la estructura de carpetas es relevante, como si su música estuviera organizada en una carpeta por artista, y una subcarpeta por álbum.</p></div></div>
</div></div>
