...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Параметры вкладки <span class="gui">Отображение</span> менеджера файлов</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Пользователь может настраивать порядок сведений, показываемый под именами значков менеджера файлов. Нажмите <span class="gui">Nautilus</span> в верхней панели, выберите пункт <span class="gui">Параметры</span> и вкладку <span class="gui">Просмотр</span>.</p></div>
...
<p class="p">В подписях к значкам можно отобразить ту же информацию, что и в столбцах при просмотре в виде списка. Подробнее смотрите <span class="link"><a href="nautilus-list.html.ru" title="Files list columns preferences">Files list columns preferences</a></span>.</p>
</div></div>
</div></div>
