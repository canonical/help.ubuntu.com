...
<div class="region"><ul>
<li class="links ">
<a href="net-chat-empathy.html.sl" title="Hipno sporočanje na Ubuntuju">Hipno sporočanje na Ubuntuju</a><span class="desc"> — Z <span class="app">Empathy</span> lahko klepetate, vzpostavljate zvočne in video klice s prijatelji in znanci na številnih omrežjih.</span>
</li>
<li class="links ">
<a href="net-chat-skype.html.sl" title="Kako lahko na Ubuntuju uporabljam Skype?">Kako lahko na Ubuntuju uporabljam Skype?</a><span class="desc"> — <span class="app">Skype</span> je lastniški program, zato ga je treba na Ubuntuju ročno namestiti.</span>
</li>
</ul></div>
</div></div>
</div>
