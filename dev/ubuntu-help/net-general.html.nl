...
<div class="linkdiv "><a class="linkdiv" href="net-proxy.html.nl" title="Proxy-instellingen definiëren"><span class="title">Proxy-instellingen definiëren</span><span class="linkdiv-dash"> — </span><span class="desc">A proxy is an intermediary for web traffic, it can be used for accessing web services anonymously, for control or security purposes.</span></a></div>
