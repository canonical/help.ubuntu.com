...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Подключение к мобильному Интернету</span></h1></div>
<div class="region">
<div class="contents">
...
<li class="steps"><p class="p">Open the <span class="gui"><a href="shell-introduction.html.ru#yourname" title="Вы и ваш компьютер">system menu</a></span> from the right
...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Если пункт <span class="gui">Мобильное подключение</span> отсутствует в меню, проверьте, не подключено ли ваше устройство как устройство хранения данных.</p></div></div></div></div>
</li>
...
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">Some phones have a setting called <span class="em">USB tethering</span> that requires
