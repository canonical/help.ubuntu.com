...
<li class="links ">
<a href="net-othersconnect.html.nl" title="Other users can’t connect to the internet">Other users can’t connect to the internet</a><span class="desc"> — U kunt instellingen (zoals het wachtwoord) voor een netwerkverbinding opslaan, zodat iedereen die de computer gebruikt er verbinding mee kan maken.</span>
</li>
</ul></div>
</div></div>
</div>
