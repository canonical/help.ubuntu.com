...
<div class="linkdiv "><a class="linkdiv" href="net-antivirus.html" title="Нужна ли мне антивирусная программа?"><span class="title">Нужна ли мне антивирусная программа?</span><span class="linkdiv-dash"> — </span><span class="desc">Вирусов для Linux мало, поэтому антивирусная программа, скорее всего, не нужна.</span></a></div>
