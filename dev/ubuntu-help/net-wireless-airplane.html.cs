...
<div class="note note-tip" title="Tip"><div class="inner"><div class="region"><div class="contents"><p class="p">Své WiFi připojení můžete vypnout přes <span class="gui"><a href="shell-introduction.html.cs#yourname" title="Vy a váš počítač">systémovou nabídku</a></span> kliknutím na název připojení a zvolením <span class="gui">Vypnout</span>.</p></div></div></div></div>
</div>
