...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Отключение беспроводной связи (режим для авиаперелётов)</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">If you have your computer on an airplane (or some other area where wireless
 ...
 for example).</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Using <span class="em">Airplane Mode</span> will completely turn off all wireless
...
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">You can turn off your WiFi connection from the 
    <span class="gui"><a href="shell-introduction.html.ru#yourname" title="Вы и ваш компьютер">system menu</a></span> by clicking on 
