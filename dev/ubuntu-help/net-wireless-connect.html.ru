...
<p class="p">If the name of the network is not in the list, try clicking
    ...
    <span class="link"><a href="net-wireless-hidden.html" title="Подключение к скрытой беспроводной сети">might be hidden</a></span>.</p>
</li>
<li class="steps">
<p class="p">Если сеть защищена паролем (<span class="link"><a href="net-wireless-wepwpa.html" title="Что такое WEP и WPA?">ключом шифрования</a></span>), введите пароль по запросу системы и нажмите <span class="gui">Подключиться</span>.</p>
...
<p class="p">If the connection is not successful, you may be asked for your password
  ...
  <span class="link"><a href="net-wireless-troubleshooting.html" title="Устранение неполадок с беспроводной сетью">Устранение неполадок с беспроводной сетью</a></span> for more help.</p>
...
<div class="region"><ul>
<li class="links ">
<a href="net-wireless-disconnecting.html" title="Почему беспроводное соединение постоянно прерывается?">Почему беспроводное соединение постоянно прерывается?</a><span class="desc"> — Сигнал может быть слабым, или настройки сети не позволяют установить корректное соединение.</span>
</li>
<li class="links ">
