...
<div class="trail">
<span style="color: #333">Ubuntu 17.10</span> » <a class="trail" href="index.html" title="Guía del escritorio de Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="net.html" title="Red, weby correo-e">Red, weby correo-e</a> » <a class="trail" href="net-wireless.html" title="Conexiones inalámbricas">Conexiones inalámbricas</a> » <a class="trail" href="net-wireless-troubleshooting.html" title="Solucionador de problemas de red inalámbrica">Solucionador de problemas de red inalámbrica</a> » </div>
</div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="links nextlinks"><a class="nextlinks-prev" href="net-wireless-troubleshooting-hardware-check.html" title="Resolución de problemas en conexiones inalámbricas">Anterior</a></div>
<div class="hgroup">
...
<p class="p">En general, no puede usar un controlador de dispositivo diseñado para otro sistema operativo (como Windows) en otro sistema operativo (como Linux). Esto es porque manejan los dispositivos de maneras distintas. Sin embargo, para los adaptadores inalámbricos puede instalar una capa de compatibilidad llamada <span class="em">NDISwrapper</span> que le permite usar en Linux algunos controladores inalámbricos para Windows. Esto es útil porque la mayoría de los adaptadores inalámbricos siempre tienen controladores para Windows, pero algunas veces no hay los controladores disponibles para Linux . Puede aprender cómo usar NDISwrapper <span class="link"><a href="http://sourceforge.net/apps/mediawiki/ndiswrapper/index.php?title=Main_Page" title="http://sourceforge.net/apps/mediawiki/ndiswrapper/index.php?title=Main_Page">aquí</a></span>. Tenga en cuenta que no todos los controladores inalámbricos se pueden usar mediante NDISwrapper.</p>
</li>
</ul></div></div></div>
