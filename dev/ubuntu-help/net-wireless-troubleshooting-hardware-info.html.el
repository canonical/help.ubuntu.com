...
<li class="list"><p class="p">Οτιδήποτε στον δίσκο οδηγού που ταυτοποιεί είτε την ίδια τη συσκευή, ή το "υλικολογισμικό" του, ή τα συστατικά (πλακέτα, τύπος τσιπ) που χρησιμοποιεί.</p></li>
</ul></div></div></div>
