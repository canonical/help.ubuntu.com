...
<li class="list"><p class="p">Un disco con el controlador de su adaptador inalámbrico (incluso si solo contiene el controlador para Windows)</p></li>
<li class="list"><p class="p">Los fabricantes y los números de modelo de su equipo, adaptador inalámbrico y enrutador. Generalmente, esta información se puede encontrar en la parte inferior/trasera del dispositivo.</p></li>
<li class="list"><p class="p">Cualquier número de versión que aparezca impreso en sus dispositivos inalámbricos o sus cajas. Pueden ser especialmente útiles, así que mire cuidadosamente.</p></li>
<li class="list"><p class="p">Cualquier cosa que haya en el disco del controlador y que identifique el dispositivo en sí, la versión de su «firmware» o los componentes (chipset) que usa.</p></li>
</ul></div></div></div>
