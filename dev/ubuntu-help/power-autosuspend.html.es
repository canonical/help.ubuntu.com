...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Configurar la suspensión automática</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">Puede configurar su equipo para que se suspenda automáticamente cuando esté inactivo. Se pueden definir diferentes intervalos para cuando se trabaja con batería o enchufado.</p>
...
<li class="steps"><p class="p">En la sección <span class="gui">Botón de apagar y suspender</span>, pulse en <span class="gui">Suspender automáticamente</span>.</p></li>
<li class="steps">
<p class="p">Elija <span class="gui">Usando batería</span> o <span class="gui">Enchufado</span>, <span class="gui">Active</span> el interruptor, y elija un <span class="gui">Retardo</span>. Se pueden configurar ambas opciones.</p>
<div class="note note-tip" title="Sugerencia"><div class="inner"><div class="region"><div class="contents"><p class="p">En un equipo de escritorio, hay una opción etiquetada como <span class="gui">Cuando esté inactivo</span>.</p></div></div></div></div>
</li>
</ol></div></div></div>
</div>
...
<div class="region"><ul><li class="links "><a href="power.html.es#saving" title="Configuración de ahorro de energía">Configuración de ahorro de energía</a></li></ul></div>
</div></div>
