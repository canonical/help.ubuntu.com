...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Snižte spotřebu a prodlužte výdrž baterie</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Počítač může mít celkem velkou spotřebu. Použitím pár jednoduchých postupů šetření energií můžete snížit svůj účet za elektřinu a pomoci životnímu prostředí.</p></div>
...
<li class="list">
<p class="p">Když po nějakou dobu nepotřebujete internetové připojení, vypněte bezdrátovou kartu, případně Bluetooth. Tato zařízení pravidelně vysílají, i když po síti zrovna nekomunikujete, což také spotřebuje trochu energie.</p>
...
<div class="hgroup"><h2 class="title"><span class="title">Pokročilejší rady</span></h2></div>
