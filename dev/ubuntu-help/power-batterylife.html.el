...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Χρησιμοποιήστε λιγότερη ισχύ και βελτιώστε τη ζωή της μπαταρίας</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Οι υπολογιστές μπορούν να χρησιμοποιήσουν πολύ ισχύ. Χρησιμοποιώντας μερικές απλές στρατηγικές αποθήκευσης, μπορείτε να μειώσετε τον λογαριασμό ενέργειας και να βοηθήσετε το περιβάλλον.</p></div>
...
<div class="hgroup"><h2 class="title"><span class="title">Περισσότερο προχωρημένες συμβουλές</span></h2></div>
