...
<li class="steps"><p class="p">Si la red inalámbrica sigue sin funcionar, <span class="gui">active</span> el <span class="gui">Modo avión</span> y <span class="gui">desactívelo</span> de nuevo.</p></li>
</ol></div></div></div>
