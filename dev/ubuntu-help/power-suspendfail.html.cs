...
<div class="note note-warning" title="Varování"><div class="inner"><div class="region"><div class="contents"><p class="p">Když váš počítač ztratí napájení a nemá alternativní zdroj energie (jako třeba funkční nabitou baterii), tak se vypne.</p></div></div></div></div>
</div></div>
</div></div>
