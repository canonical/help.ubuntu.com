...
<p class="p">Εάν αυτό ακόμα δεν έχει αποτέλεσμα, βεβαιωθείτε ότι η οθόνη του υπολογιστή σας είναι αναμμένη και δοκιμάστε να πατήσετε ένα πλήκτρο στο πληκτρολόγιο πάλι.</p>
...
<div class="note note-warning" title="Προειδοποίηση"><div class="inner"><div class="region"><div class="contents"><p class="p">Εάν ο υπολογιστής σας χάνει ισχύ και δεν έχει μια εναλλακτική παροχή ισχύος (όπως μια λειτουργική μπαταρία), θα κλείσει.</p></div></div></div></div>
</div></div>
</div></div>
