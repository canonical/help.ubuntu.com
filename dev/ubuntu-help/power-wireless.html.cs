...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Vypnutí nepoužívaných bezdrátových technologií</span></h1></div>
<div class="region">
<div class="contents">
...
<li class="steps"><p class="p">V části <span class="gui">Šetření energií</span> najdete vypínače pro <span class="gui">Wi-Fi</span>, <span class="gui">Mobilní připojení</span> a <span class="gui">Bluetooth</span>. Nepoužívané věci přepněte na <span class="gui">○</span> (vypnuto). Až je budete potřebovat, znovu je přepněte na <span class="gui">❙</span> (zapnuto).</p></li>
</ol></div></div></div>
</div>
