...
<div class="linkdiv "><a class="linkdiv" href="power-closelid.html" title="Γιατί ο υπολογιστής μου απενεργοποιείται όταν κλείνω το καπάκι;"><span class="title">Γιατί ο υπολογιστής μου απενεργοποιείται όταν κλείνω το καπάκι;</span><span class="linkdiv-dash"> — </span><span class="desc">Οι φορητοί υπολογιστές αδρανοποιούνται όταν κλείνετε το καπάκι, για να αποθηκεύσουν ισχύ.</span></a></div>
</div>
<div class="links-twocolumn">
<div class="linkdiv "><a class="linkdiv" href="power-batteryoptimal.html" title="Πάρτε το περισσότερο από την μπαταρία του φορητού υπολογιστή σας"><span class="title">Πάρτε το περισσότερο από την μπαταρία του φορητού υπολογιστή σας</span><span class="linkdiv-dash"> — </span><span class="desc">Συμβουλές όπως "Μην αφήνετε τη φόρτιση της μπαταρίας να πέσει υπερβολικά".</span></a></div>
...
<div class="linkdiv "><a class="linkdiv" href="power-suspend.html" title="Τι συμβαίνει όταν αναστέλλω τον υπολογιστή μου;"><span class="title">Τι συμβαίνει όταν αναστέλλω τον υπολογιστή μου;</span><span class="linkdiv-dash"> — </span><span class="desc">Η αναστολή στέλνει τον υπολογιστή σας σε ύπνο, έτσι ώστε χρησιμοποιεί λιγότερη ισχύ.</span></a></div>
<div class="linkdiv "><a class="linkdiv" href="power-batterylife.html" title="Χρησιμοποιήστε λιγότερη ισχύ και βελτιώστε τη ζωή της μπαταρίας"><span class="title">Χρησιμοποιήστε λιγότερη ισχύ και βελτιώστε τη ζωή της μπαταρίας</span><span class="linkdiv-dash"> — </span><span class="desc">Συμβουλές για μείωση της κατανάλωσης ισχύος του υπολογιστή σας.</span></a></div>
</div>
</div></div></div></div>
...
<div class="linkdiv "><a class="linkdiv" href="power-nowireless.html" title="Δεν έχω ασύρματο δίκτυο όταν εκκινώ τον υπολογιστή μου"><span class="title">Δεν έχω ασύρματο δίκτυο όταν εκκινώ τον υπολογιστή μου</span><span class="linkdiv-dash"> — </span><span class="desc">Μερικές ασύρματες συσκευές έχουν προβλήματα χειρισμού όταν ο υπολογιστής σας αναστέλλεται και δεν συνεχίζει σωστά.</span></a></div>
<div class="linkdiv "><a class="linkdiv" href="power-othercountry.html" title="Θα δουλέψει ο υπολογιστής μου με μια παροχή σε άλλη χώρα;"><span class="title">Θα δουλέψει ο υπολογιστής μου με μια παροχή σε άλλη χώρα;</span><span class="linkdiv-dash"> — </span><span class="desc">Ο υπολογιστής σας θα δουλέψει, αλλά μπορεί να χρειαστείτε ένα διαφορετικό καλώδιο παροχής ή προσαρμογέα ταξιδιού.</span></a></div>
</div>
<div class="links-twocolumn">
<div class="linkdiv "><a class="linkdiv" href="power-constantfan.html" title="Ο ανεμιστήρας του φορητού υπολογιστή εκτελείται πάντα"><span class="title">Ο ανεμιστήρας του φορητού υπολογιστή εκτελείται πάντα</span><span class="linkdiv-dash"> — </span><span class="desc">Μπορεί να λείπει κάποιο λογισμικό ελέγχου του ανεμιστήρα, ή ο φορητός υπολογιστής σας ενδέχεται να έχει ζεσταθεί.</span></a></div>
<div class="linkdiv "><a class="linkdiv" href="power-hotcomputer.html" title="Ο υπολογιστής μου γίνεται πραγματικά καυτός"><span class="title">Ο υπολογιστής μου γίνεται πραγματικά καυτός</span><span class="linkdiv-dash"> — </span><span class="desc">Οι υπολογιστές συνήθως θερμαίνονται, αλλά εάν γίνουν υπερβολικά ζεστοί μπορούν να υπερθερμανθούν, που μπορεί να προκαλέσει ζημιά.</span></a></div>
