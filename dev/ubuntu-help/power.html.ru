...
<div class="linkdiv "><a class="linkdiv" href="power-batterylife.html" title="Уменьшение потребляемой мощности и увеличение времени работы от аккумулятора"><span class="title">Уменьшение потребляемой мощности и увеличение времени работы от аккумулятора</span><span class="linkdiv-dash"> — </span><span class="desc">Советы по уменьшению энергопотребления компьютера</span></a></div>
<div class="linkdiv "><a class="linkdiv" href="power-suspend.html" title="Что происходит при переходе компьютера в ждущий режим?"><span class="title">Что происходит при переходе компьютера в ждущий режим?</span><span class="linkdiv-dash"> — </span><span class="desc">В ждущем режиме компьютер «засыпает» и потребляет меньшую мощность.</span></a></div>
</div>
</div></div></div></div>
...
<div class="region"><div class="contents"><div class="links topiclinks"><div class="inner"><div class="region">
<div class="links-twocolumn">
<div class="linkdiv "><a class="linkdiv" href="power-lowpower.html" title="Why did my computer turn off when the battery got to 10%?"><span class="title">Why did my computer turn off when the battery got to 10%?</span><span class="linkdiv-dash"> — </span><span class="desc">Доводить аккумулятор до полной разрядки вредно для него.</span></a></div>
<div class="linkdiv "><a class="linkdiv" href="power-batteryestimate.html" title="Неправильная оценка времени работы от аккумулятора"><span class="title">Неправильная оценка времени работы от аккумулятора</span><span class="linkdiv-dash"> — </span><span class="desc">Оставшееся время работы, отображаемое при нажатии на <span class="gui">значок аккумулятора</span>, является приблизительным.</span></a></div>
</div>
<div class="links-twocolumn">
<div class="linkdiv "><a class="linkdiv" href="power-batteryslow.html" title="Почему работа моего ноутбука замедляется при питании от аккумулятора?"><span class="title">Почему работа моего ноутбука замедляется при питании от аккумулятора?</span><span class="linkdiv-dash"> — </span><span class="desc">Некоторые ноутбуки намеренно замедляют работу при питании от аккумулятора.</span></a></div>
...
<div class="links-twocolumn">
<div class="linkdiv "><a class="linkdiv" href="power-hotcomputer.html" title="Компьютер сильно нагревается"><span class="title">Компьютер сильно нагревается</span><span class="linkdiv-dash"> — </span><span class="desc">Компьютеры обычно нагреваются при работе, но сильный перегрев может повредить их.</span></a></div>
...
<div class="linkdiv "><a class="linkdiv" href="power-nowireless.html" title="При «пробуждении» компьютера отсутствует беспроводное соединение"><span class="title">При «пробуждении» компьютера отсутствует беспроводное соединение</span><span class="linkdiv-dash"> — </span><span class="desc">У некоторых беспроводных устройств возникают проблемы с обработкой состояния компьютера, если компьютер входил в спящий режим и потом вышел из спящего режима некорректным образом.</span></a></div>
</div>
</div></div></div></div>
