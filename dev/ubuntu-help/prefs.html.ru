...
<div class="links-grid ">
<div class="links-grid-link"><a href="clock.html" title="Дата и время">Дата и время</a></div>
<div class="desc"><span class="desc">
...
<div class="links-grid ">
<div class="links-grid-link"><a href="media.html#sound" title="Основы работы со звуком">Звук</a></div>
...
<div class="desc"><span class="desc"><span class="link"><a href="look-background.html" title="Изменение фонов рабочего стола и экрана блокировки">Фон</a></span>, <span class="link"><a href="look-resolution.html" title="Изменение разрешения или ориентации экрана">размер и ориентация</a></span>, яркость…</span></div>
</div>
<div class="links-grid ">
...
<div class="links-grid ">
<div class="links-grid-link"><a href="privacy.html" title="Параметры конфиденциальности">Параметры конфиденциальности</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="privacy-screen-lock.html" title="Автоматическая блокировка экрана">Блокировка экрана</a></span>, <span class="link"><a href="privacy-history-recent-off.html" title="Turn off or limit file history tracking">Статистика использования</a></span>, <span class="link"><a href="privacy-purge.html" title="Очистка корзины и удаление временных файлов">Очистка корзины и удаление временных файлов</a></span>…</span></div>
</div>
<div class="links-grid ">
<div class="links-grid-link"><a href="prefs-sharing.html" title="Параметры общего доступа">Параметры общего доступа</a></div>
<div class="desc"><span class="desc"><span class="link"><a href="sharing-bluetooth.html" title="Управление общим доступом по Bluetooth">Общий доступ по Bluetooth</a></span>, <span class="link"><a href="sharing-personal.html" title="Сделайте общими ваши личные файлы">Общий доступ к личным файлам</a></span>, <span class="link"><a href="sharing-desktop.html" title="Общий доступ к рабочему столу">Общий доступ к экрану</a></span>, <span class="link"><a href="sharing-media.html" title="Сделать общими музыку, фото и видео.">Общий доступ к мультимедиа</a></span>…</span></div>
</div>
<div class="links-grid ">
...
<div class="desc"><span class="desc"><span class="link"><a href="user-add.html" title="Добавление новой учётной записи пользователя">Добавление пользователя</a></span>, <span class="link"><a href="user-changepassword.html" title="Изменение пароля">изменения пароля</a></span>, <span class="link"><a href="user-admin-change.html" title="Назначение административных полномочий">администраторы</a></span>…</span></div>
</div>
<div class="links-grid ">
