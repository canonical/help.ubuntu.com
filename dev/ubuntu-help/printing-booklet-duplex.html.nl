...
<a href="printing-booklet.html" title="Print a booklet">Print a booklet</a><span class="desc"> — How to print a folded, multi-page booklet using A4 or Letter-sized
    paper.</span>
</li></ul></div>
</div></div></div>
</div>
