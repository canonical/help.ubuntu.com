...
<div class="region">
<div class="contents">
<p class="p">Система автоматически распознаёт многие типы принтеров при их подключении. Большинство принтеров подключаются к компьютеру с помощью кабеля USB.</p>
<div class="note note-tip" title="Подсказка"><div class="inner"><div class="region"><div class="contents"><p class="p">Больше не нужно указывать тип устанавливаемого принтера — сетевой или локальный. Теперь они отображаются в одном окне.</p></div></div></div></div>
