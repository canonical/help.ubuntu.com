...
<div class="region">
<div class="contents">
<p class="p">If your print-outs are streaky, faded, have lines on them that should not be
...
<dt class="terms">Pojemajoče besedilo ali slike</dt>
<dd class="terms"><p class="p">You may be running out of ink or toner. Check your ink or toner supply
       and buy a new cartridge if necessary.</p></dd>
<dt class="terms">Proge in črte</dt>
...
<dt class="terms">Napačne barve</dt>
...
<dd class="terms"><p class="p">V primeru da so črte, ki bi morale biti ravne nazobčene, morate morda poravnati glavo tiskalnika. Za podrobnosti o tem si oglejte priročnik tiskalnika.</p></dd>
</dl></div></div></div>
</div>
...
<div class="region"><ul><li class="links ">
<a href="printing-inklevel.html" title="How can I check my printer's ink or toner levels?">How can I check my printer's ink or toner levels?</a><span class="desc"> — Preverite količino preostalega črnila ali tonerja v kartušah tiskalnika.</span>
</li></ul></div>
</div></div>
</div>
</div>
