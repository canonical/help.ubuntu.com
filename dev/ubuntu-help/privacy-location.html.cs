...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Řízení služeb určování polohy</span></h1></div>
<div class="region">
<div class="contents">
...
<li class="steps">
<p class="p">Přepněte vypínač <span class="gui">Služby určování polohy</span> na <span class="gui">○</span> (vypnuto).</p>
<p class="p">Opětovně tuto funkci povolíte přepnutím vypínače <span class="gui">Služby určování polohy</span> na <span class="gui">❙</span> (zapnuto).</p>
</li>
</ol></div>
</div></div>
</div>
