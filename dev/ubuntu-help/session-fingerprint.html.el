...
<div class="region">
<div class="contents"><p class="p">Εάν το σύστημά σας έχει έναν σαρωτή που υποστηρίζει δακτυλικό αποτύπωμα, μπορείτε να γράψετε το δακτυλικό σας αποτύπωμα και να το χρησιμοποιήσετε για σύνδεση.</p></div>
<div id="record" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Εγγραφή δακτυλικού αποτυπώματος</span></h2></div>
...
<div class="hgroup"><h2 class="title"><span class="title">Ελέγξετε ότι το δακτυλικό αποτύπωμα δουλεύει</span></h2></div>
<div class="region"><div class="contents">
