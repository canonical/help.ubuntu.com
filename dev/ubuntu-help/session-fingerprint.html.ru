...
<span style="color: #333">Ubuntu 17.10</span> » <a class="trail" href="index.html" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="hardware.html" title="Оборудование и драйверы">Аппаратное обеспечение</a> » <a class="trail" href="hardware-auth.html" title="Отпечатки пальцев и смарт-карты">Отпечатки пальцев и смарт-карты</a> » </div></div>
...
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Сохраните изменения в любых открытых файлах и затем <span class="link"><a href="shell-exit.html" title="Завершение сеанса, выключение компьютера или переключение пользователей">выйдите из системы</a></span>.</p></li>
...
<a href="hardware-auth.html" title="Отпечатки пальцев и смарт-карты">Отпечатки пальцев и смарт-карты</a><span class="desc"> — <span class="link"><a href="session-fingerprint.html" title="Вход в систему по отпечатку пальца">Считыватели отпечатков пальцев</a></span>, смарт-карты…</span>
</li></ul></div>
</div></div></div>
</div>
</div>
