...
<div class="region"><ul><li class="links ">
<a href="session-formats.html" title="Изменение форматов даты и единиц измерения">Изменение форматов даты и единиц измерения</a><span class="desc"> — Выберите региональный формат даты и времени, чисел, валюты и единиц измерения.</span>
</li></ul></div>
</div></div>
</div>
</div>
