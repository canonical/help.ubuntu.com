...
<div class="region"><div class="contents">
<p class="p">Puede desconectar a alguien que esté viendo su escritorio usando el <span class="gui">icono de la notificación</span> en la bandeja de mensajes. Para hacerlo:</p>
<div class="steps"><div class="inner"><div class="region"><ol class="steps">
<li class="steps"><p class="p">Abra la bandeja de mensajes pulsando <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>M</kbd></span></span> o moviendo el cursor del ratón a la parte inferior de la pantalla.</p></li>
<li class="steps"><p class="p">Pulse en el icono de <span class="gui">Escritorio</span> en la <span class="gui">Bandeja de mensajes</span>. Esto abrirá el panel de <span class="app">Compartición</span>.</p></li>
<li class="steps"><p class="p">Seleccione <span class="gui">Compartición de la pantalla</span>.</p></li>
<li class="steps"><p class="p">Mueva el deslizador de <span class="gui">Compartición de pantalla</span> a <span class="gui">Apagado</span>.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
