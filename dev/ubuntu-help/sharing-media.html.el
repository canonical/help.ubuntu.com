...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Κοινή χρήση της μουσικής, των φωτογραφιών και των βίντεό σας</span></h1></div>
<div class="region">
<div class="contents">
...
<div class="region"><div class="contents"><p class="p">Η ενότητα <span class="gui">Δίκτυα</span> εμφανίζει τα δίκτυα στα οποία είσαστε προς το παρόν συνδεμένοι. Χρησιμοποιήστε τον διακόπτη <span class="gui">ΝΑΙ | ΟΧΙ</span> δίπλα στο κάθε δίκτυο για να επιλέξετε που μπορούν να διαμοιραστούν τα πολυμέσα σας.</p></div></div>
</div></div>
