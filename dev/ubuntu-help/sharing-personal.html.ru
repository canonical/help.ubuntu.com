...
<p class="p">You can allow access to the <span class="file">Public</span> folder in your
  ...
  the folder.</p>
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Чтобы параметр <span class="gui">Общий доступ к личным файлам</span> стал видимым, в системе должен быть установлен пакет<span class="app">gnome-user-share</span>.</p></div></div></div></div>
