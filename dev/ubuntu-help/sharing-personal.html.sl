...
<p class="p">You can allow access to the <span class="file">Public</span> folder in your
  ...
  the folder.</p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">You must have the <span class="app">gnome-user-share</span> package installed for
...
<p class="p">Switch <span class="gui">Personal File Sharing</span> to <span class="gui">ON</span>. This means
      ...
      folder.</p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">A <span class="em">URI</span> is displayed by which your <span class="file">Public</span> folder
