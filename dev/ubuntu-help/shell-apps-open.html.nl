...
<p class="p">Move your mouse pointer to the
  ...
  <span class="gui"><a href="shell-introduction.html.nl#activities" title="Activiteiten-overzicht">Activities</a></span> overview. This is where you
  can find all of your applications. You can also open the overview by pressing
  the <span class="key"><a href="keyboard-key-super.html.nl" title="Wat is de Super-toets?"><kbd>Super</kbd></a></span> key.</p>
...
<p class="p">If you have applications that you use very frequently, you can
      <span class="link"><a href="shell-apps-favorites.html.nl" title="Pin your favorite apps to the dash">add them to the dash</a></span>
      yourself.</p>
</li>
<li class="list"><p class="p">Click the grid button at the bottom of the dash. You will see the
      ...
      <span class="gui">All</span> button at the bottom to view all the
...
<p class="p">You can launch an application in a separate
      ...
      workspace.</p>
<p class="p">You can launch an application in a <span class="em">new</span> workspace by dragging
...
<div class="title title-note"><h2><span class="title">Quickly running a command</span></h2></div>
<div class="region"><div class="contents">
<p class="p">Another way of launching an application is to press
    <span class="keyseq"><span class="key"><kbd>Alt</kbd></span>+<span class="key"><kbd>F2</kbd></span></span>, enter its
...
<li class="links ">
<a href="shell-apps-favorites.html.nl" title="Pin your favorite apps to the dash">Pin your favorite apps to the dash</a><span class="desc"> — Add (or remove) frequently-used program icons on the dash.</span>
</li>
</ul></div>
</div></div>
</div>
