...
<p class="p">If you have applications that you use very frequently, you can
      <span class="link"><a href="shell-apps-favorites.html" title="Pin your favorite apps to the dash">add them to the dash</a></span>
      yourself.</p>
</li>
...
<p class="p">You can launch an application in a separate
      <span class="link"><a href="shell-workspaces.html" title="Wat is een werkblad en hoe kan ik het gebruiken?">workspace</a></span> by dragging its icon from
...
<div class="region"><ul>
<li class="links "><a href="gs-use-system-search.html" title="Gebruik de systeemzoekfunctie">Een handleiding over het gebruik van de systeemzoekfunctie</a></li>
<li class="links "><a href="gs-launch-applications.html" title="Toepassingen starten">Een handleiding over het starten van toepassingen</a></li>
<li class="links ">
<a href="shell-apps-favorites.html" title="Pin your favorite apps to the dash">Pin your favorite apps to the dash</a><span class="desc"> — Add (or remove) frequently-used program icons on the dash.</span>
</li>
</ul></div>
</div></div>
</div>
