...
<p class="p">Για <span class="gui">Αποσύνδεση</span> ή <span class="gui">Αλλαγή χρήστη</span>, πατήστε το <span class="link"><a href="shell-terminology.html" title="shell-terminology">μενού συστήματος</a></span> στα δεξιά της πάνω γραμμής, κάντε κλικ στο όνομά σας και επιλέξτε έπειτα την κατάλληλη επιλογή.</p>
...
<div class="region"><ul>
<li class="links ">
<a href="privacy-screen-lock.html" title="Αυτόματο κλείδωμα της οθόνης">Αυτόματο κλείδωμα της οθόνης</a><span class="desc"> — Αποτρέψτε άλλα άτομα από τη χρήση της επιφάνειας εργασίας όταν φεύγετε από τον υπολογιστή σας.</span>
</li>
<li class="links ">
...
<div class="note note-tip" title="Συμβουλή"><div class="inner"><div class="region"><div class="contents"><p class="p">Μπορεί να θελήσετε να κλείσετε τον υπολογιστή σας, εάν επιθυμείτε να τον μετακινήσετε και δεν έχετε μπαταρία, εάν η μπαταρία σας είναι χαμηλή ή δεν κρατά φορτίο καλά. Επίσης ένας απενεργοποιημένος υπολογιστής χρησιμοποιεί <span class="link"><a href="power-batterylife.html" title="Χρησιμοποιήστε λιγότερη ισχύ και βελτιώστε τη ζωή της μπαταρίας">λιγότερη ενέργεια</a></span> από έναν που είναι σε αναστολή.</p></div></div></div></div>
</div>
<div class="sect sect-links" role="navigation">
<div class="hgroup"></div>
<div class="contents"><div class="links seealsolinks"><div class="inner">
...
<div class="region"><ul><li class="links ">
<a href="user-autologin.html" title="Αυτόματη σύνδεση">Αυτόματη σύνδεση</a><span class="desc"> — Ρύθμιση αυτόματης σύνδεσης όταν ενεργοποιείτε τον υπολογιστή σας.</span>
</li></ul></div>
</div></div>
</div>
</div>
