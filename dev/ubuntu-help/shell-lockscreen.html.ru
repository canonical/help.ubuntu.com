...
<li class="list"><p class="p">возможность управления воспроизведением — регулировка громкости, пропуск дорожки или приостановка воспроизведения музыки без необходимости вводить пароль.</p></li>
</ul></div></div></div>
