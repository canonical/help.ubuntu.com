...
<title>Upozornění a pořadač zpráv</title>
...
<p class="p">Například, když obdržíte novou zprávu v diskuzi nebo nový e-mail, objeví se upozornění, které vás o tom informuje.</p>
...
<p class="p">Kliknutí na zavírací tlačítko u některých upozornění způsobí jejích zmizení z pořadače. Jiné, jako jsou od přehrávače Rhythmbox nebo od diskuzních aplikací, zůstanou skryté v pořadači zpráv.</p>
</div></div>
</div></div>
