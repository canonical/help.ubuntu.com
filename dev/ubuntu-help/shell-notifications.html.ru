...
<span style="color: #333">Ubuntu 18.04</span> » <a class="trail" href="index.html.ru" title="Руководство пользователя Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="shell-overview.html.ru" title="Your desktop">Рабочий стол</a> › <a class="trail" href="shell-overview.html.ru#desktop" title="Customize your desktop">Customize your desktop</a> » </div></div>
<div id="cwt-content" class="clearfix content-area"><div id="page">
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Панель для уведомлений и сообщений</span></h1></div>
<div class="region">
<div class="contents"></div>
<div id="what" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Что такое уведомление?</span></h2></div>
...
<p class="p">Нажатие кнопки закрытия в некоторых уведомлениях заставляет их исчезнуть навсегда. Но некоторые другие уведомления, например от Rhythmbox или приложений для обмена мгновенными сообщениями, останутся скрытыми в панели сообщений.</p>
</div></div>
</div></div>
<div id="messagetray" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Панель сообщений</span></h2></div>
<div class="region"><div class="contents">
<p class="p">The message tray gives you a way to get
  ...
  <span class="keyseq"><span class="key"><a href="keyboard-key-super.html.ru" title="Что такое клавиша Super?"><kbd>Super</kbd></a></span>+<span class="key"><kbd>M</kbd></span></span>. The
  message tray contains all the notifications that you have not acted upon or
  that permanently reside in it.</p>
<p class="p">Чтобы просмотреть уведомление, выберите элемент из панели сообщений. Обычно, сообщения отправляются приложениями. Однако уведомления о сообщениях в чате обрабатываются в зависимости от того, кто отправляет вам сообщения.</p>
<p class="p">Панель сообщений можно закрыть, нажав ещё раз <span class="keyseq"><span class="key"><kbd>Super</kbd></span>+<span class="key"><kbd>M</kbd></span></span> или клавишу <span class="key"><kbd>Esc</kbd></span>.</p>
</div></div>
</div></div>
...
<li class="steps"><p class="p">Нажмите <span class="gui">Уведомления</span>, чтобы открыть панель.</p></li>
...
<div class="region"><ul><li class="links "><a href="shell-overview.html.ru#desktop" title="Customize your desktop">Customize your desktop</a></li></ul></div>
</div></div></div>
</div>
</div>
<div class="clear"></div>
