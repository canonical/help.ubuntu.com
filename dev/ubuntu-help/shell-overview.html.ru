...
<div class="linkdiv "><a class="linkdiv" href="shell-notifications.html.ru" title="Панель для уведомлений и сообщений"><span class="title">Панель для уведомлений и сообщений</span><span class="linkdiv-dash"> — </span><span class="desc">Messages drop down from the top of the screen telling you when
    certain events happen.</span></a></div>
</div>
<div class="links-twocolumn"><div class="linkdiv "><a class="linkdiv" href="clock-calendar.html.ru" title="События календаря"><span class="title">События календаря</span><span class="linkdiv-dash"> — </span><span class="desc">Display your appointments in the calendar area at the top of the
