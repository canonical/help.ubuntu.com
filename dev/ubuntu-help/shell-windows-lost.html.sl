...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Iskanje izgubljenega okna</span></h1></div>
<div class="region">
<div class="contents">
<p class="p">A window on a different workspace, or hidden behind another window, is
  easily found using the <span class="gui"><a href="shell-introduction.html#activities" title="Activities overview">Activities</a></span>
  overview:</p>
<div class="list"><div class="inner"><div class="region"><ul class="list">
<li class="list"><p class="p">Open the <span class="gui">Activities</span> overview. If the missing window is on
      the current
      <span class="link"><a href="shell-windows.html#working-with-workspaces" title="Delo z delovnimi površinami">workspace</a></span>, it
...
<li class="list"><p class="p">Click different workspaces in the
      <span class="link"><a href="shell-workspaces.html" title="Kaj je delovna površina in kako mi bo pomagala?">workspace selector</a></span> at the
...
<li class="list"><p class="p">Press
      ...
      to display the <span class="link"><a href="shell-windows-switching.html" title="Preklop med okni">window switcher</a></span>.
