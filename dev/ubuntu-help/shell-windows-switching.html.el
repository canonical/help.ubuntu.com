...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents"><p class="p">Στον εναλλάκτη παραθύρου, εφαρμογές από διαφορετικούς χώρους εργασίας διαιρούνται από κάθετους διαχωριστές.</p></div></div></div></div>
