...
<div class="note" title="Примечание"><div class="inner"><div class="region"><div class="contents"><p class="p">Окна приложений, находящиеся на разных рабочих местах, в переключателе окон разделяются вертикальными линиями.</p></div></div></div></div>
