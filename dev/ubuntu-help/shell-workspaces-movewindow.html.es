...
<li class="steps"><p class="p">Aparecerá el <span class="link"><a href="shell-workspaces.html.es" title="¿Qué es un área de trabajo y cómo me ayudará?">selector de áreas de trabajo</a></span>.</p></li>
