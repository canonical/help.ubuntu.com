...
<div class="trail">
<span style="color: #333">Ubuntu 17.10</span> » <a class="trail" href="index.html" title="Guía del escritorio de Ubuntu"><span class="media"><span class="media media-image"><img src="figures/ubuntu-logo.png" height="16" width="16" class="media media-inline" alt="Help"></span></span> Ubuntu Desktop Guide</a> » <a class="trail" href="prefs.html" title="Usuario y configuración del sistema">Configuración</a> » <a class="trail" href="media.html#sound" title="Sonido básico">Sonido</a> » <a class="trail" href="sound-broken.html" title="Problemas de sonido">Problemas de sonido</a> » </div>
<div class="trail">
...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">No puedo oír ningún sonido del equipo</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Si no puede escuchar ningún sonido en su equipo, por ejemplo, cuando intenta reproducir música, siga estos pasos para ver si puede solucionar el problema.</p></div>
...
<li class="steps"><p class="p">Abra la <span class="app">Configuración</span> desde la vista de <span class="gui">Actividades</span>.</p></li>
<li class="steps"><p class="p">Pulse <span class="gui">Sonido</span>.</p></li>
<li class="steps"><p class="p">Vaya a la pestaña <span class="gui">Aplicaciones</span> y compruebe que su aplicación está silenciada.</p></li>
</ol></div></div></div>
</div></div>
</div></div>
<div id="speakers" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Compruebe que los altavoces estén encendidos y conectados adecuadamente</span></h2></div>
<div class="region"><div class="contents">
...
<div class="hgroup"><h2 class="title"><span class="title">Compruebe que está seleccionado el dispositivo de sonido correcto</span></h2></div>
<div class="region"><div class="contents">
...
<p class="p">Si eso no funciona, puede intentar hacer lo mismo con cualquiera de los dispositivos que se muestran.</p>
</li>
</ol></div></div></div>
</div></div>
</div></div>
<div id="hardware-detected" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Compruebe que la tarjeta de sonido se detectó correctamente.</span></h2></div>
<div class="region"><div class="contents">
