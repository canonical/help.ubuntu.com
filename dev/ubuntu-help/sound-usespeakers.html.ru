...
<div class="region"><ul><li class="links ">
<a href="sound-usemic.html" title="Использование различных микрофонов">Использование различных микрофонов</a><span class="desc"> — Использование аналогового или USB-микрофона и выбор входного звукового устройства по умолчанию.</span>
</li></ul></div>
</div></div>
</div>
</div>
