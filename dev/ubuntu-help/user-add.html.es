...
<li class="steps">
<p class="p">Puede elegir entre establecer una contraseña para el nuevo usuario o dejar que la establezca la primera vez que inicie sesión.</p>
<p class="p">Si elige establecer ahora la contraseña, puede pulsar el icono <span class="gui"><span class="media"><span class="media media-image"><img src="figures/system-run-symbolic.svg" height="16" width="16" class="media media-inline" alt="generar contraseña"></span></span></span> para generar automáticamente una contraseña aleatoria.</p>
</li>
<li class="steps"><p class="p">Pulse <span class="gui">Añadir</span>.</p></li>
</ol></div></div></div>
<p class="p">Si quiere cambiar la contraseña después de crear la cuenta, seleccione la cuenta, <span class="gui">desbloquee</span> el panel y pulse sobre el estado actual de la contraseña.</p>
<div class="note" title="Nota"><div class="inner"><div class="region"><div class="contents"><p class="p">En en panel <span class="gui">Usuarios</span> puede pulsar la imagen junto al nombre del usuario, a la derecha, para establecer una imagen para la cuenta. Esta imagen se mostrará en la ventana de inicio de sesión. GNOME proporciona algunos conjuntos de imágenes que puede usar, o puede seleccionar su propia imagen o hacer una foto con su cámara web.</p></div></div></div></div>
</div>
