...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Dodajanje novega uporabniškga računa</span></h1></div>
<div class="region">
<div class="contents">
...
<p class="p">If you want the new user to have
      <span class="link"><a href="user-admin-explain.html" title="Kako delujejo skrbniška dovoljenja?">administrative access</a></span> to the
...
<p class="p">If you want to change the password after creating the account, select the
  ...
  password status.</p>
<div class="note" title="Opomba"><div class="inner"><div class="region"><div class="contents"><p class="p">In the <span class="gui">Users</span> panel, you can click the image next to the
