...
<a href="video-dvd.html" title="Proč se nechtějí DVD přehrávat?">Proč se nechtějí DVD přehrávat?</a><span class="desc"> — Možná nemáte nainstalované správné kodeky nebo může být DVD pro nesprávný region.</span>
</li></ul></div>
</div></div>
</div>
</div>
