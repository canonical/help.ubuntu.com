...
<div id="content">
<div class="hgroup"><h1 class="title"><span class="title">Почему не воспроизводятся DVD?</span></h1></div>
<div class="region">
<div class="contents"><p class="p">Если вы вставили DVD в компьютер, но он не воспроизводится, возможно, не установлены нужные <span class="em">кодеки</span> или DVD относится к другому <span class="em">региону</span>.</p></div>
<div id="codecs" class="sect"><div class="inner">
<div class="hgroup"><h2 class="title"><span class="title">Установка кодеков для воспроизведения DVD</span></h2></div>
