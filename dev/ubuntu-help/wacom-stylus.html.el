...
<div class="note" title="Σημείωση"><div class="inner"><div class="region"><div class="contents"><p class="p">Εάν έχετε περισσότερες από μία γραφίδες, όταν η πρόσθετη γραφίδα πλησιάζει στην πινακίδα, ένας σελιδοποιητής θα εμφανιστεί δίπλα στο όνομα συσκευής της γραφίδας. Χρησιμοποιήστε τον σελιδοποιητή για να επιλέξτε ποια γραφίδα να ρυθμίσετε.</p></div></div></div></div>
</div>
